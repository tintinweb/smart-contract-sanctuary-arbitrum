...
contract GulperDeployer
{
    ...
    EthGulper public ethGulper;
    dEthGulper public dethGulper;
    DaiGulper public daiGulper;

    constructor()
    {
        ethGulper = new EthGulper();
        dethGulper = new dEthGulper();
        daiGulper = new DaiGulper();
