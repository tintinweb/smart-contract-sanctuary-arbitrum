...
contract SmolvibesMarket is Ownable, ReentrancyGuard {
    ...
    function createListing(
        ...
        // if tokenIndex[_nftAddress] is [1,2,3] then it contains rows 0-2 
        // tokenIndex[_nftAddress].length will be 3 which will also be the
        // index of the next token we push 
    ...
    function _deleteToken(address _nftAddress, uint256 _tokenId) internal {
        ...
        console.log("tokenIndex 0 before: %s", tokenIndex[_nftAddress][0]);
        console.log("tokenIndex 1 before: %s", tokenIndex[_nftAddress][1]);
        console.log("tokenIndex 2 before: %s", tokenIndex[_nftAddress][2]);
        console.log("tokenIndex 3 before: %s", tokenIndex[_nftAddress][3]);

        console.log("listings tokenId 1 index before: %s", listings[_nftAddress][1].index);
        console.log("listings tokenId 2 index before: %s", listings[_nftAddress][2].index);
        console.log("listings tokenId 3 index before: %s", listings[_nftAddress][3].index);
        console.log("listings tokenId 4 index before: %s", listings[_nftAddress][4].index);
        
        console.log("starting _deleteToken");
        ...
        console.log("rowToDelete is %s", rowToDelete);
        ...
        console.log("tokenIndex 0 after: %s", tokenIndex[_nftAddress][0]);
        console.log("tokenIndex 1 after: %s", tokenIndex[_nftAddress][1]);
        console.log("tokenIndex 2 after: %s", tokenIndex[_nftAddress][2]);

        // finally delete the listing from the mapping

        delete (listings[_nftAddress][_tokenId]);

        console.log("listings tokenId 1 index after: %s", listings[_nftAddress][1].index);
        console.log("listings tokenId 2 index after: %s", listings[_nftAddress][2].index);
        console.log("listings tokenId 3 index after: %s", listings[_nftAddress][3].index);
        console.log("listings tokenId 4 index after: %s", listings[_nftAddress][4].index);
    }
