...
// File: contracts/v1/traders/P1TraderConstants.sol
...
// File: contracts/lib/BaseMath.sol
...
// File: contracts/lib/SignedMath.sol
...
// File: contracts/v1/lib/P1Types.sol
...
// File: contracts/lib/Storage.sol
...
// File: contracts/v1/impl/P1Storage.sol
...
// File: contracts/v1/impl/P1Getters.sol
...
// File: contracts/v1/impl/P1Settlement.sol
...
// File: contracts/v1/impl/P1Trade.sol
    ...
    P1Settlement
{
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < words.length; i++) {
            ...
            if (sm.state == 0) {
                ...
                sm.symbolsInaddr = uint256(uint8(word[31]));
                sm.symbolCounter = 0;
                ...
                marginCache = marginCache.signedAdd(td.funding).signedAdd(td.fee).signedSub(SignedMath.Int({value:td.amount.baseMul(td.fillPrice), isPositive:td.isBuy}));
        ...
        private
    {
        ...
        if (td.isBuy) {
            marginChange = marginChange.sub(amountPrice);
        } else {
            marginChange = marginChange.add(amountPrice);
        }
...
// File: contracts/v1/impl/P1Admin.sol
...
// File: contracts/v1/PerpetualV1.sol
