...
contract CorruptionCryptsDiamondInitializer is CorruptionCryptsDiamondState {
    function initialize(
        ...
        //Initialize the first temples.
        templeIdToTemples[0] = Temple(Coordinate(0, 0), 0, true);
        templeIdToTemples[1] = Temple(Coordinate(0, 0), 1, true);
        templeIdToTemples[2] = Temple(Coordinate(0, 0), 2, true);
    ...
    function addressToCurrentBoard(address _user, uint256 _cell, uint256 _row) public view returns(Cell memory){
