...
contract QuestV1 is IQuest, ManagerModifier, ReentrancyGuard {
  ...
  constructor(
    ...
    quests[0] = Quest({ xp: 1, traitId: 4, traitAmount: 1, level: 1 });
    quests[1] = Quest({ xp: 1, traitId: 3, traitAmount: 1, level: 1 });
    quests[2] = Quest({ xp: 2, traitId: 2, traitAmount: 1, level: 2 });
    quests[3] = Quest({ xp: 2, traitId: 7, traitAmount: 1, level: 3 });
    quests[4] = Quest({ xp: 3, traitId: 6, traitAmount: 1, level: 4 });
    quests[5] = Quest({ xp: 3, traitId: 5, traitAmount: 1, level: 5 });
