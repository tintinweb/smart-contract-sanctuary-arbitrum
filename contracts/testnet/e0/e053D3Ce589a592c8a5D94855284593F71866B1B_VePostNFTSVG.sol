...
contract VePostNFTSVG {
    ...
    function _buildInformation(
        ...
        return
            string(
                abi.encodePacked(
                    '<g filter="url(#filter5_b_544_23454)"><g clip-path="url(#clip1_544_23454)" font-family="Arial" font-size="20"><text fill="#E2E8F0" xml:space="preserve" style="white-space:pre" letter-spacing="0em"> <tspan x="36" y="408.817">ID: </tspan> </text><text fill="#F1F5F9" xml:space="preserve" style="white-space:pre" font-weight="bold" letter-spacing="-.005em" text-anchor="end"> <tspan x="380" y="408.934">#',
                    _toString(tokenId),
                    ...
                    '</tspan></text></g><g clip-path="url(#clip3_544_23454)" font-family="Arial" font-size="20"><text fill="#E2E8F0" xml:space="preserve" style="white-space:pre" letter-spacing="0em"><tspan x="36" y="489.817">Par Value: </tspan></text><text fill="#F1F5F9" xml:space="preserve" style="white-space:pre" font-weight="bold" letter-spacing="-.005em" text-anchor="end"><tspan x="380" y="489.817">',
