...
contract Reader {
    ...
    function adjustForDecimals(
        ...
        uint256 decimalsDiv_ = _tokenDiv == usdw_ ? USDW_DECIMALS : vault_.tokenDecimals(_tokenDiv);
        uint256 decimalsMul_ = _tokenMul == usdw_ ? USDW_DECIMALS : vault_.tokenDecimals(_tokenMul);
