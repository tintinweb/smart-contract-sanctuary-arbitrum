...
uint256 constant ID = uint256(
    keccak256("game.piratenation.animationurlcomponent.v1")
);
...
library AnimationUrlComponentStorage {
...
/**
 * @title AnimationUrlComponent
 * @dev The default animation url for an entity
 */
contract AnimationUrlComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getValue(
        ...
        value = AnimationUrlComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = AnimationUrlComponentStorage
            .layout()
    ...
    function getBytes(
        ...
        Layout memory s = AnimationUrlComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        delete AnimationUrlComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete AnimationUrlComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
