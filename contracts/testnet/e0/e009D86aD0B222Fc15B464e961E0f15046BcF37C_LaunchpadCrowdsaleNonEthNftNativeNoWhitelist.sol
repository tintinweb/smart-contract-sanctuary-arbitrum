...
import "./interfaces/ILaunchpadCrowdsaleNonEthNftNativeNoWhitelist.sol";

/**
 * @title LaunchpadCrowdsaleNonEthNftNativeNoWhitelist
 * @author Enjinstarter
 * @dev Launchpad crowdsale with non ETH address collection where there is no delivery of tokens in each purchase.
 */
contract LaunchpadCrowdsaleNonEthNftNativeNoWhitelist is
    NoDeliveryCrowdsale,
    CappedTokenSoldCrowdsaleHelper,
    IndividuallyCappedCrowdsaleHelper,
    TimedCrowdsaleHelper,
    Pausable,
    ILaunchpadCrowdsaleNonEthNftNativeNoWhitelist
{
    ...
    modifier onlyBy(address account) {
        require(msg.sender == account, "LCNENNNW: sender unauthorized");
        _;
    }
        ...
        override
    {
        require(
            ...
            "LCNENNNW: empty non ETH address"
        );
    ...
    {
        require(account != address(0), "LCNENNNW: zero account");
        ...
        tokenCapNotExceeded(tokensSold, tokenAmount)
    {
        ...
        if (
            ...
            revert("LCNENNNW: beneficiary cap exceeded");
        }
...
/**
 * @title ILaunchpadCrowdsaleNonEthNftNativeNoWhitelist
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNonEthNftNativeNoWhitelist is ICrowdsale {
