...
// File: VaultImplementationV1.sol
...
contract VaultImplementation is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    bool public vaultInitialised;  // proxy's call
    ...
    modifier isVaultInitialised() {
        require(!vaultInitialised, "Vault already Initialised");
        _;
    }
    ...
    function setParams(bytes32 _name, address _keeper, address _vaultFactory, uint256 _managementFee) public isVaultInitialised{
        name = _name;
        keeper = _keeper;
...
contract VaultFactory {
    ...
    event Trader(address indexed vault, address indexed trader, bool inverseCopyTrade, uint16 copySizeBPS, address defaultCollateral);
    ...
    function fireVaultEvent(address caller, bytes32 name, address trader, bool inverseCopyTrade, uint16 copySizeBPS, address defaultCollateral) public {
        ...
        emit Trader(msg.sender, trader, inverseCopyTrade, copySizeBPS, defaultCollateral);
   }
}

// "vaultImplementation": "0x18bfF3b399EAcBBcFea6709053ad1709fc073690",
// 			"vaultProxy": "0x1Eae946CaB3Cfa4cAf87226bf6886208619C0948"