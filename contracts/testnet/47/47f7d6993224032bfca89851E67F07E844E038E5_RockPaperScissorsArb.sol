 ...
 */
contract RockPaperScissorsArb is CommonArb {
    using SafeERC20 for IERC20;
    ...
    function randomizerCallback(uint256 _id, bytes32 _value) external {
        ...
        address playerAddress = rockPaperScissorsIDs[_id];
        ...
        for (i = 0; i < game.numBets; i++) {
            ...
            randomActions[i] = uint8(
                uint256(keccak256(abi.encodePacked(_value, i))) % 3
            );
        ...
        delete (rockPaperScissorsIDs[_id]);
