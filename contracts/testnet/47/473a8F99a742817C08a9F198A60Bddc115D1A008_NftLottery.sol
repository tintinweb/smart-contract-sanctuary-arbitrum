...
contract Fortunatemon is ERC721Enumerable, ReentrancyGuard, Pausable, SignatureLens{
    ...
    constructor(uint cap, uint airdropCap, uint firstSaleCap, uint perSaleCap, uint fee, address feeTo, address signer, string memory tokenBaseURI) ERC721("Fortunatemon", "FT") SignatureLens(signer){
...
import "./interfaces/ITicketLottery.sol";
