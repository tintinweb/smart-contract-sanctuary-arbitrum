...
contract StakingSystem is Ownable, ERC721Holder {
    ...
    function _stake(address _user, uint256 _tokenId) internal {
        ...
        IERC721(nft).transferFrom(_user, address(this), _tokenId);
    ...
    function _unstake(address _user, uint256 _tokenId) internal {
        ...
        IERC721(nft).approve(address(this), _tokenId);
        IERC721(nft).transferFrom(address(this), _user, _tokenId);
    ...
    function claimReward(address _user) public {
        ...
        ITombsToken(rewardsToken).mint(_user, rewardAmount);
    ...
    function claimAllRewards() public {
        ...
        ITombsToken(rewardsToken).mint(msg.sender, rewardAmount);
