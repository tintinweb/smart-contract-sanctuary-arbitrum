...
contract VestEROSXV2_2 is OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _claimableToken, address _esToken) public reinitializer(2) {
