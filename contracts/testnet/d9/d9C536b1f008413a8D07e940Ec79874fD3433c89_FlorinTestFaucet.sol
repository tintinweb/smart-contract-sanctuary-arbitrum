...
contract FlorinTestFaucet is OwnableUpgradeable {
    ...
    function hasAlreadyReceivedFlorin(address _userWallet) external view returns (bool) {
        return alreadyReceivedFlorin[_userWallet];
    }

    function ownerRemovesFLR() external onlyOwner {
