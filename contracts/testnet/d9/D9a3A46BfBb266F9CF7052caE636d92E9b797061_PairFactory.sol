...
/// @title Permissionless creation of LendingPairs
/// @author 0xdev & flora.loans
/// @notice the pairFactory enables anyone to permissionlessly create new LendingPairs
/// @dev will automatically increase the cardinality of a unipool to ~30mins
...
contract PairFactory is IPairFactory, SafeOwnable {
    ...
    /// @dev todo before deployment: update BeaconProxyPayable.sol WETH address
    constructor(
    ...
    /// @dev will be depreceated (deleted or ownable) in final release
