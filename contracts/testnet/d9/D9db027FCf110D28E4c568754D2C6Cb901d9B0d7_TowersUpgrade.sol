...
import "../cityclash/CityClashTypes.sol";
...
contract TowersUpgrade is Ownable {
    ...
    function upgradeCityImageAndBurnTower(uint _cityTokenId, uint _towerTokenId, string memory _imageBaseUrl) external whenNotPaused {
        CityClashInterface cityClash = CityClashInterface(cityClashAddress);
