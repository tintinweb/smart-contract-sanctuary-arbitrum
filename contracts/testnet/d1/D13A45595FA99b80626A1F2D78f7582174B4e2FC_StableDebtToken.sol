 ...
 * at stable rate mode
 * @author Natrium, inspiration from Aave
 **/
contract StableDebtToken is IStableDebtToken, DebtTokenBase {
  ...
  INatriumIncentivesController internal _incentivesController;
  ...
  function initialize(
    ...
    INatriumIncentivesController incentivesController,
   ...
   **/
  function getIncentivesController() external view override returns (INatriumIncentivesController) {
   ...
   * @return The address of the lending pool
   **/
  function _getIncentivesController() internal view override returns (INatriumIncentivesController) {
