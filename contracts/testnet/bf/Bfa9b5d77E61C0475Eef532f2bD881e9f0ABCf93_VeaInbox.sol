...
contract VeaInbox is IVeaInbox {
     ...
     */
    event MessageSent(uint64 _nonce, address indexed _to, address indexed _msgSender, bytes _data);
     ...
     */
    function sendStaterootSnapshot(uint64 _epochSnapshot) external virtual {
...
interface IChallengeResolver {
     ...
     */
    function resolveChallenge(uint64 _epoch, bytes32 _stateRoot) external;
}
