...
interface IRouterParams {
    ...
    struct AddParams {
        ...
        address to;
        address pool;
        address lp; // old pools have lp contract and doesn't have public getter for it 
    ...
    struct RemoveParams {
        ...
        uint256 minAmountOut;
        uint8 i;
        address tokenOut; // in case with underlying pools no way to get correct tokenOut couse underlying flag is not present in this struct
        address emergencyTo;
    }
