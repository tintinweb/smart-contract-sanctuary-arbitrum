...
interface IUnilimitFactory {
    ...
    /// @param pairAddress The address of the newly created pair
    /// @param poolAddress The address of the underlying UniV3 pool
    /// @param settlerAddress The address of the settling entity for the pair
    event PairCreated(address pairAddress, address poolAddress, address settlerAddress);
