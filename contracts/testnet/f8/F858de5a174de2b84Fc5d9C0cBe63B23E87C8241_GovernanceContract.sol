...
contract GovernanceContract {
    ...
    event VoteCasted(bytes32 indexed  proposalId, address indexed  voter, uint256 vote,uint256 amount, uint256 date);
    event TokensWithdrawn(bytes32 indexed  proposalId, address voter, uint256 amount);
    ...
    function vote(
        ...
        emit VoteCasted(_proposalId, msg.sender, _vote, weightAmount, block.timestamp);
    }
