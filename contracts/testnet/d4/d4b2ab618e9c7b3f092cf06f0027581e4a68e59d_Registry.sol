...
contract Registry is Ownable2Step, IRegistry {
    ...
    /// @notice EnnumarableSet where all the approved pools are stored
    EnumerableSet.AddressSet private pools;
    /**
     * @notice EnnumarableSet where all the pending pools are stored
...
interface IRegistry {
     ...
     *  @param _index The index of a pool stored in the EnnumerableSet
