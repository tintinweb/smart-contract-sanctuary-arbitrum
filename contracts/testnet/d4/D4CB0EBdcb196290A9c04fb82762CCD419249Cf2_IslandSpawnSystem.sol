...
uint256 constant ID = uint256(keccak256("game.piratenation.accountstarterislandcomponentv1"));

/**
 * @title AccountStarterIslandComponent
 * @dev This component is used to mark the starter island for a player.
 */
contract AccountStarterIslandComponent is BaseComponent {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The island id of the starter island.
        keys[0] = "value";
     ...
     * @param value uint256 The island id of the starter island.    
     */
    function setValue(
        uint256 entity,
        uint256 value
