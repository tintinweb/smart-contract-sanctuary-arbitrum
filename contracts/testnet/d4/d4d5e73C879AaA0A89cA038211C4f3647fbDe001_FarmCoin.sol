...
contract FarmCoin is ERC20Permit, IFarmCoin, FarmCoinAccessControlled {
    ...
    ERC20("FarmCoin", "FarmCoin", 18) 
    ERC20Permit("FarmCoin") 
  ...
  function mintPresale(uint256 presaleAmount) public  onlyGovernor {
    require(isPresaleAddr, "add presale contract address");
    _mint(presaleContracAddr, presaleAmount * 1e18);      
  }

	function setContractAddress(address contractAddr) external onlyGovernor(){
