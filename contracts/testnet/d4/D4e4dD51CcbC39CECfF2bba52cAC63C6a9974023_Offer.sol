...
contract Offer is Collectible {
    ...
    address public orderDispatcher; // Address of contract that dispatches orders for this Offer
    ...
    constructor(
        ...
        rewards = offerDetails.price / offerDetails.pricePerToken; // Note: decimals are truncated
    ...
    function completeOrder(uint256 _offerId) external {
        require(_msgSender() == orderDispatcher, "UNAUTHORIZED");
