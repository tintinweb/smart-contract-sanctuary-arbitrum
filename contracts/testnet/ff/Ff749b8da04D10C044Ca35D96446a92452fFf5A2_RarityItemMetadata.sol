...
interface IRarityItemDataStorage is IItemDataStorage {
  ...
  function getPackedCharacteristics(uint256 _tokenId) external view returns (uint256);
}
  ...
  ManagerModifier
{
  ...
  constructor(address _manager) ManagerModifier(_manager) {
    ...
    _characteristics = ITEM_CHARACTERISTICS;
    // Set initial characteristics values
    _characteristicValues = new string[][](6);
    _characteristicValues[ITEM_CHARACTERISTIC_RARITY] = ITEM_RARITIES;
    _characteristicValues[ITEM_CHARACTERISTIC_SLOT] = ITEM_SLOTS;
    _characteristicValues[ITEM_CHARACTERISTIC_CATEGORY] = ITEM_CATEGORIES;
    _characteristicValues[ITEM_CHARACTERISTIC_TYPE] = ITEM_TYPES;
    _characteristicValues[ITEM_CHARACTERISTIC_PREFIX] = ITEM_PREFIXES;
    _characteristicValues[ITEM_CHARACTERISTIC_SUFFIX] = ITEM_SUFFIXES;
  }
  ...
  function characteristicNames(
    ...
    return _characteristics[_characteristic];
  }
  ...
  function characteristicValues(
    ...
    return _characteristicValues[_characteristic][_id];
  }

  function characteristicValuesCount(
    uint16 _characteristic
  ) external view returns (uint16) {
    return uint16(_characteristicValues[_characteristic].length);
  }

  function allCharacteristicValues(
    uint16 _characteristic
  ) external view returns (string[] memory) {
    return _characteristicValues[_characteristic];
  }

  function characteristicCount() external view returns (uint16) {
    return uint16(_characteristics.length);
  }
  ...
  function updateCharacteristicValues(
    ...
    _characteristicValues[_characteristic] = _newValues;
  }
}
...
contract RarityItemMetadata is IItemMetadata, ManagerModifier {
  ...
  IRarityItemDataStorage itemData;
  ...
  constructor(
    ...
    itemData = IRarityItemDataStorage(_itemDataStorage);
  ...
  function name(uint256 _tokenId) external view returns (string memory) {
    uint16[16] memory itemCharacteristics = itemData.characteristics(_tokenId);
  ...
  function setCharacteristicDefinitions(
    ...
    characteristicDefinitions = IRarityItemCharacteristicDefinitions(_newCharacteristics);
  }
  ...
  function _generateName(
    ...
    string memory base = characteristicDefinitions.characteristicValues(
      ITEM_CHARACTERISTIC_TYPE,
      _characteristics[ITEM_CHARACTERISTIC_TYPE]
    );
    string memory prefix = characteristicDefinitions.characteristicValues(
      ITEM_CHARACTERISTIC_PREFIX,
      _characteristics[ITEM_CHARACTERISTIC_PREFIX]
    );
    string memory suffix = characteristicDefinitions.characteristicValues(
      ITEM_CHARACTERISTIC_SUFFIX,
