...
// File contracts/price-aggregator/interfaces/IAggregatorV3.sol
...
// File contracts/price-aggregator/interfaces/IGlpManager.sol
...
// File contracts/price-aggregator/common/GlpPriceAggregator.sol

pragma solidity ^0.8.10;

contract GlpPriceAggregator is IAggregatorV3 {
    IERC20 public constant GLP =
        IERC20(0xE539a6616862EC35530435A098F53bf01f8572af);
    IGlpManager public constant GLP_MANAGER =
        IGlpManager(0x76D2d93B6409ab2c02bE01F8bF48C7c416fA39aA);
