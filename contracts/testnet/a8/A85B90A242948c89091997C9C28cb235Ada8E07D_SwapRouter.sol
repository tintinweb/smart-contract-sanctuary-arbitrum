...
library SwapLibrary {
    ...
    function quote(
        ...
        require(amountA > 0 || reserveA > 0 && reserveB > 0, "SwapLibrary: INSUFFICIENT_AMOUNT OR LIQUIDITY");
    ...
    function getAmountOut(
        ...
        require(amountIn > 0 || reserveIn > 0 && reserveOut > 0, "SwapLibrary: INSUFFICIENT_INPUT_AMOUNT OR LIQUIDITY");
    ...
    function getAmountIn(
        ...
        require(amountOut > 0 || reserveIn > 0 && reserveOut > 0, "SwapLibrary: INSUFFICIENT_OUTPUT_AMOUNT OR LIQUIDITY");
