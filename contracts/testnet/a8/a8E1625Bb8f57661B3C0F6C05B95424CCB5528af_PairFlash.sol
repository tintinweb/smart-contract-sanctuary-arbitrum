...
/// @title Flash exchange contract implementation
/// @notice Contract using the Uniswap V3 flash function to perform arbitrage
contract PairFlash is IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        // swap token1 for token0 in pool with fee2
        ...
        // swap token0 for token 1 in pool with fee3
        ...
        // if there are profits, pay it to payer 
    ...
    /// @param params Required data for flash and callback, passed as FlashParams
    /// @notice Calls the pools flash function with data that needed for 'uniswapV3FlashCallback'
