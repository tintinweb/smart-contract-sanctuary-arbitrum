...
contract Claim is Ownable, ReentrancyGuard {
    ...
    IERC20 public RELAY = IERC20(0x43aE94CaA6d573a33d740D72e9135678BbA08d94);
    IPresale public Presale =IPresale(0xE674d9E5F05ABaAd082CcD69e27a5A2CeEc1c4E8);
    ...
    function claim(address _beneficiary) external nonReentrant {
        ...
        RELAY.transfer(_beneficiary, claiming);
        emit TokenClaimed(_beneficiary, claiming);
    }

    function _unlocked(address _beneficiary) public view returns (uint256) {
        uint256 contributed = Presale.userInfo(_beneficiary).contributed;
        uint256 claimable = ((contributed * 1e18) / (0.0000056 * 1e18));
