...
import "../../core/components/BoolComponent.sol";

uint256 constant ID = uint256(
    keccak256("game.piratenation.bountyenabledcomponent")
);

/**
 * @dev maps bounty id → boolean: true indicates if a bounty is enabled.
 */
contract BountyEnabledComponent is BoolComponent {
    /** SETUP **/
