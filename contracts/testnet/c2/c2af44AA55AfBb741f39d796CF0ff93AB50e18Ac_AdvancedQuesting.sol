...
contract AdvancedQuesting is Initializable, AdvancedQuestingSettings {
    ...
    function clearLegion(uint256 _tokenId) external {
        delete legionIdToLegionQuestingInfoV1[_tokenId].startTime;
        delete legionIdToLegionQuestingInfoV2[_tokenId].startTime;
    }
