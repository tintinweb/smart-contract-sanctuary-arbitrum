...
contract Wheel is Core {
  ...
  /// @notice height of every single unit 10000 total height of wheel 500000
  Configuration public config = Configuration(20, 30, 100000000, 5000000000);
