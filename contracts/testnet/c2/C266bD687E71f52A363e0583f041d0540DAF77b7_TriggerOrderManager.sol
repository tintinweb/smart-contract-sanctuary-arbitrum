...
contract TriggerOrderManager is ITriggerOrderManager, BasePosition, ReentrancyGuard {
    ...
    constructor(address _priceManager, address _settingsManager) BasePosition(_settingsManager, _priceManager) {
    ...
    function triggerPosition(
        ...
        require(txn.status == TRANSACTION_PENDING, "Invalid txStatus");
