...
contract NametagSocialFi is Ownable {
    ...
    // SharesSubject ID => Is supply minted
    mapping(uint256 => bool) public isSupplyMinted;

    // SharesSubject ID => Fee Balance
    ...
    function addSharesSubject(uint256 sharesId, bytes calldata signature) external checkSignature(abi.encode(sharesId), signature) {
