...
contract DualFactory is MPCManageable, IDualFactory {
  ...
  function _replay(Dual memory dual, Tariff calldata tariff, ReplayInput memory input) internal {
    ...
    Dual memory newDual = _dual(tariff, _input);
