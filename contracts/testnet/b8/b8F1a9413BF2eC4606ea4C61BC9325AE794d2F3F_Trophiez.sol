...
import "./TrophiezContracts.sol";

contract Trophiez is Initializable, TrophiezContracts {

    function initialize() external initializer {
        TrophiezContracts.__TrophiezContracts_init();
    }
    ...
    override
    {
        ...
        require(isAdmin(msg.sender) || isOwner(), "Trophiez: Only admin or owner can transfer trophiez");
    }
...
import "./TrophiezState.sol";

abstract contract TrophiezContracts is Initializable, TrophiezState {

    function __TrophiezContracts_init() internal initializer {
        TrophiezState.__TrophiezState_init();
    }
}
...
import "./ITrophiez.sol";
import "../../shared/ERC1155OnChainBaseUpgradeable.sol";
import "../../shared/AdminableUpgradeable.sol";

abstract contract TrophiezState is Initializable, ITrophiez, ERC1155OnChainBaseUpgradeable {

    function __TrophiezState_init() internal initializer {
