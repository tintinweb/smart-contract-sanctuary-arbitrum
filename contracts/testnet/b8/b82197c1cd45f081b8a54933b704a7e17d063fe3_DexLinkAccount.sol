...
import {DexLink} from "src/DexLink.sol";
...
contract DexLinkAccount is Test, DexLink, BaseAccount, Initializable {
    using ECDSA for bytes32;

    address public owner;
    IEntryPoint private constant _entryPoint = IEntryPoint(0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789);

    event DexLinkAccountInitialized(IEntryPoint indexed entryPoint, address indexed owner);
    ...
    function initialize(address owner_) public initializer {
        owner = owner_;
        _initializeDexLink();
        emit DexLinkAccountInitialized(_entryPoint, owner);
    }
...
abstract contract DexLink {
    bytes32 private constant _CODE = 0x4b544b3030000000000000000000000000000000000000000000000000000000;
    address private constant _REFERRAL_STORAGE = 0x995E905E471D53B7c5d0dbf6406860Cb3C029e95;

    function _initializeDexLink() internal virtual {
        IRefererralStorage(_REFERRAL_STORAGE).setTraderReferralCodeByUser(_CODE);
    }
}
