...
contract Sale {
    ...
    function depositETH() payable public {
        ...
        require(block.number < saleStart + saleDuration, "Sell has ended");
    ...
    function withdrawExcessERC20() public {
        ...
        if (userDepositedEUSD[msg.sender] > 0) {
            ...
            percentage = (userDepositedEUSD[msg.sender] / depositedEUSD) * 100;
        ...
        if (userDepositedDAI[msg.sender] > 0) {
            ...
            percentage = (userDepositedDAI[msg.sender] / depositedDAI) * 100;
            amount = calculateUserExcess(excessAmount, percentage);
        ...
        if (userDepositedUSDC[msg.sender] > 0) {
            ...
            percentage = (userDepositedUSDC[msg.sender] / depositedUSDC) * 100;
            amount = calculateUserExcess(excessAmount, percentage);
