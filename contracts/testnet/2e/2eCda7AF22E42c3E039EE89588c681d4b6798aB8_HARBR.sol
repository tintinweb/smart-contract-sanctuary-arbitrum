...
// File contracts/HARBR.sol


pragma solidity 0.8.20;

contract HARBR is IHARBR, Initializable {
    mapping(address => uint256) private _balances;

    uint256 private _totalSupply;
    address private _admin;
    address private _arborStakingContract;
    ...
    function _onlyAuthorized() private view {
        if (msg.sender != _arborStakingContract && msg.sender != _admin) {
    ...
    /**
     * @dev Function to set arbor staking contract
     */
    function setArborStakingContract(address arborStakingContract_) external onlyAdmin {
        if (arborStakingContract_ == address(0)) {
            revert InvalidAddress();
        }
        _arborStakingContract = arborStakingContract_;
    }
    ...
    /**
     * @dev Returns address of the arbor staking contract
     */
    function arborStakingContract() external view returns (address) {
        return _arborStakingContract;
    }
