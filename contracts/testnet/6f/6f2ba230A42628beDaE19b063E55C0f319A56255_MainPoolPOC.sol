...
contract MainPoolPOC is NonblockingLzApp {
    uint public counter;
    ...
    //     destPoolId = _destPoolId;
    // }

    function performStargateSwap(
        uint16 chainId,
        ...
        IStargateRouter.lzTxObj memory lzTxObject = IStargateRouter.lzTxObj(
            0,
            0,
            "0x"
        );
