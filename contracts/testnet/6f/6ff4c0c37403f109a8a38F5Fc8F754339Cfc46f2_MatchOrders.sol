...
contract MatchOrders is OwnableUpgradeable {
    ...
    function linkVertexSigner(address externalAccount, uint64 nonce, bytes12 _subaccountName) internal {
    ...
    function setLinkerSigner(address externalAccount, uint64 nonce, bytes12 _subaccountName) external onlyOwner {
        linkVertexSigner(externalAccount, nonce, _subaccountName);
    }
