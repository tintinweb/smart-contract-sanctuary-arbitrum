...
abstract contract BaseGame is BaseRandomizer {
    ...
    function viewGameInfos(address user_, uint8 startIndex_, uint8 endIndex_) external view returns (GameInfo[] memory gameInfos){
 ...
 * @notice 孵化
 */
contract L2UnicornHatcher is BaseGame {
