...
import "../library/ContextUpgradeable.sol";
import "../library/StringsUpgradeable.sol";
import "../interfaces/ERC165Upgradeable.sol";
import "../proxy/Initializable.sol";
...
// Signature utils
import "../library/ECDSAUpgradeable.sol";
import "../library/draft-EIP712Upgradeable.sol";

// Access Control + security
import "../library/AccessControlEnumerableUpgradeable.sol";
import "../library/ReentrancyGuardUpgradeable.sol";

// Meta transactions
import "../library/ERC2771ContextUpgradeable.sol";

// Utils
import "../library/StringsUpgradeable.sol";
import "../library/MulticallUpgradeable.sol";
import "../library/CurrencyTransferLib.sol";
import "../library/FeeType.sol";

// Helper interfaces
import "../interfaces/IERC2981Upgradeable.sol";

// OpenSea operator filter
import "../library/DefaultOperatorFiltererUpgradeable.sol";

contract PachiERC721T2 is
    Initializable,
    IThirdwebContract,
    IOwnable,
    IRoyalty,
    ...
    ITokenERC721
{
    ...
    /**
        TODO
        1. logic for updating tokenUri (EIP712)
        2. logic for updating character Status (EIP712) - not sure for now
     */
    ...
    function verifyUpdate(
        ...
        address signer = recoverAddressForUpdate(_req, _signature);
        return (!updated[_req.uid] && hasRole(MINTER_ROLE, signer), signer);
    }
    ...
    function initialize() external initializer {
        ...
        address _saleRecipient = _msgSender();
        address _royaltyRecipient = _msgSender();
        uint128 _royaltyBps = 0;
        uint128 _platformFeeBps = 0;
        address _platformFeeRecipient = _msgSender();
        string memory _name = "PACHI721-T2";
        string memory _symbol = "P721T2";
        string memory _contractURI = "";
    ...
    /**
        TODO
        1. struct NFT status 
        2. logic for updating character Status
     */
