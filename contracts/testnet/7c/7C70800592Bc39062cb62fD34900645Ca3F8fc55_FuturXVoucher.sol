...
// File: contracts/FuturXVoucher.sol
...
contract FuturXVoucher is ERC721, Ownable {
    ...
    function distriuteVoucher(
        address _to, 
        uint8  _typeVoucher, 
        uint256 _value, 
        uint256 _expiredDate, 
        uint256 _maxDiscountValue  
        ) public returns(Voucher memory)  {
            voucherID++;
            _mint(_to, voucherID);
            ...
            emit VoucherDistributed(_to, _value, _expiredDate, _maxDiscountValue, _typeVoucher);
