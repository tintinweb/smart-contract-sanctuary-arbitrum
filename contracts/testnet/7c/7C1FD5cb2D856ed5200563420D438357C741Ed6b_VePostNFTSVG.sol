...
contract VePostNFTSVG {
    function buildVePost(
        ...
        return
            string(
                abi.encodePacked(
                        '<svg width="202" height="278" viewBox="0 0 202 278" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="202" height="278" fill="#ECECEC"/><g clip-path="url(#clip0_544_23454)">',
