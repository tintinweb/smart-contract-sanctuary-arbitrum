...
contract DummyProtocol {
  ...
  event OrderInitiated(uint256 indexed orderId, uint256 indexed amount, address indexed exchange); // keccak(OrderInitiated(uint256,uint256,address)) => 0xd1ffe9e45581c11d7d9f2ed5f75217cd4be9f8b7eee6af0f6d03f46de53956cd
  ...
  function initiateOrder(uint256 orderId, uint256 amount, address exchange) public {
    // execute a limit order
    emit OrderInitiated(orderId, amount, exchange);
  }
