...
contract CorruptionCryptsDiamondInitializer is CorruptionCryptsDiamondState {
    ...
    function updateBoardTreasureTier(uint8 _newTreasureTier) public onlyAdminOrOwner {
        boardTreasure.treasureTier = _newTreasureTier;
        emit TreasureTierChanged(_newTreasureTier);
    }
