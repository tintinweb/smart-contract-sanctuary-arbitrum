  ...
  ERC1155Holder
{
  ...
  function stake(
    ...
    emit ReactorStaked(_realmId, address(reactor), _structureId, _kind);
  }
  ...
  function stakeBatch(
    ...
    emit ReactorBatchStaked(_realmIds, addresses, _structureIds, _kinds);
  }
  ...
  function unstake(
    ...
    emit ReactorUnstaked(_realmId, address(reactor), _structureId, _kind);
  }
  ...
  function unstakeBatch(
    ...
    emit ReactorBatchUnstaked(_realmIds, addresses, _structureIds, _kinds);
  }
