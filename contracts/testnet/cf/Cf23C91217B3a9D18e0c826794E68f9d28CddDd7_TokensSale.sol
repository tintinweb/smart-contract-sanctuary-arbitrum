...
contract TokensSale is ReentrancyGuard, AccessControlEnumerable {
    ...
    modifier onlySupportedParticipant(ITokensVesting.Participant participant) {
        require(
            _supportedParticipants.contains(uint256(participant)),
    ...
    {
        require(
            tgePercentage_ <= 100 * 100 ** percentageDecimals_,
            "TokensSale: bad args"
        );
