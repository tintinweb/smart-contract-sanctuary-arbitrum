...
contract ShardexERC20Factory {
    ...
    function createToken(
        ...
        ShardexERC20PegToken token = new ShardexERC20PegToken{salt : salt}(name, symbol, decimals, minter, pauser, blacklister);
    ...
    function changeTokenRole(
        ...
        ShardexERC20PegToken token = ShardexERC20PegToken(token_address);
...
contract ShardexERC20PegToken is Context, AccessControl, ERC20Burnable, ERC20Pausable, ERC20BlackListAble {
