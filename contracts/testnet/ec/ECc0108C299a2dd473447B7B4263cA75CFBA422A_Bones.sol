...
contract Bones is ContractControl{
    ...
    function _stake(address from, address to, uint256 amount) external onlyStakingContract returns(bool){
    ...
    function _unStake(address from, address to, uint256 amount) external onlyStakingContract returns(bool) {
        balanceOf[from] -= amount;
