...
import "./lib/SafeERC20.sol";
import "./bond/MultiVestingTokens.sol";
import "./bond/Treasury.sol";

contract MultiVestingTokensFactory is Ownable {
    ...
    /**
     * @notice deploys treasury and bond contracts and returns address of both
     *     @param _payoutToken address the token paid out from the bond
     *     @param _payinToken address the token used to open a bond position
    ...
    function createBondAndTreasury(
        ...
        MultiVestingTokens bond =
        new MultiVestingTokens(address(treasury), _payoutToken, _payinToken, _initialOwner, MizuRegistry, _affiliate, _quoteToken,  _router);
    ...
    /**
     * @notice deploys bond contract for an existing treasury and returns address of both
    ...
    function createBond(
        ...
        MultiVestingTokens bond =
        new MultiVestingTokens(_customTreasury, _payoutToken, _payinToken, _initialOwner, MizuRegistry, _affiliate, _quoteToken, _router);
