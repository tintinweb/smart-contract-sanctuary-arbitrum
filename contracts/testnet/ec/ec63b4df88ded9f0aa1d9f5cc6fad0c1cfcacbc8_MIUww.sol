...
// File: contracts/token/MIUww.sol
...
contract MIUww is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256 _totalSupply = 210_000_000 * 1e6;
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'MIUWW: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "MIUWW: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "MIUWW: index out of bounds");
