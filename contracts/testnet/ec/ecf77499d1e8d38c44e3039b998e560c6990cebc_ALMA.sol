...
contract ALMA is ERC20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "ALMA";
    string constant _symbol = "ALMA";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); 
    
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 500) / 1000;
    uint256 public _maxTxSize = (_totalSupply * 500) / 1000;
