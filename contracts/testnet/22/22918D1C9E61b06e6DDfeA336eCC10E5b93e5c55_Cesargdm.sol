...
contract Cesargdm is ERC721X {
	constructor()
		ERC721X(
			...
			10,
			5000,
			'https://cesargdm.com/nft/metadata.json',
			'https://cesargdm.com/nft/contract.json'
		)
	{
		/*
...
contract ERC721X is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
	...
	*/
	...
	function mint(
		uint256 _amount
	) external payable nonReentrant phaseCompliance(MintPhase.Public) {
		//// INTERACTIONS ////
