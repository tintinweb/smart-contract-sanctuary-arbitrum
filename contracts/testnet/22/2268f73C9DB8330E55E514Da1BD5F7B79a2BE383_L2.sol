...
import "../interfaces/IL2.sol";

contract L2 is IL2, ERC20VotesUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("L2 Coin", "L2");
        __ERC20Permit_init("L2 Coin");
        __ERC20Votes_init();
        __Pausable_init();
        __Ownable_init();
        //
        maxMintAmount = 1000000 * 10 ** decimals();
    }
    ...
    function mintToTreasury(uint256 amount) external override {
        require(treasury == _msgSender(), "L2: caller is not the treasury");
        require(amount > 0 && amount < maxMintAmount, "L2: mint amount invalid");
    ...
    function _mint(address to, uint256 amount) internal override(ERC20VotesUpgradeable) whenNotPaused nonReentrant {
