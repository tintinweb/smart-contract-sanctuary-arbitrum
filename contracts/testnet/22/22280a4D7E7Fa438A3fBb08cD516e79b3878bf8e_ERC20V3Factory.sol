/**
 *Submitted for verification at Arbiscan on 2022-06-30
*/
...
contract ERC20V3Factory is InitializableOwnable {
    ...
    function updateCustomTemplate(address newCustomTemplate)
        external
        onlyOwner
    {
    ...
    function updateCustomMintableTemplate(address newCustomMintableTemplate)
        external
        onlyOwner
    {
