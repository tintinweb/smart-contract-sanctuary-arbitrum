...
abstract contract SuperCertsClaimable is TokenHelper {
    ...
    function getCertsInfo() public view returns (address certsAddress, address teamAddress, bool enabled, bool vestFund) {
    ...
    function _claimTeamCerts() internal returns (bool success) {
