...
contract Ambrosia is MintableERC20 {
    // constructor sets up access control and initial supply
    constructor(
        address _gov,
...
contract MintableERC20 is OFTV2 {
    ...
    function setHandler(address _handler, bool _isHandler) external onlyGov {
        handlers[_handler] = _isHandler;
    }

    function setMinter(address _minter, bool _isMinter) external onlyGov {
