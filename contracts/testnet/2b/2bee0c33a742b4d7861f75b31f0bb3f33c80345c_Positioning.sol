...
interface IVolmexPerpPeriphery {
    ...
    function depositToVault(uint256 _index, address _token, uint256 _amount) external payable;
    function withdrawFromVault(uint256 _index, address _token, address payable _to, uint256 _amount) external;
