...
contract Greeter {
    ...
    address ArbSysAddr = 0x0000000000000000000000000000000000000064;
    ...
    function callSendTxToL1(address destination, bytes calldata calld) public returns (uint256) {
        // (bool success, bytes memory data) = 
                ...
                //     calld));
        // return success;
        return ArbSys(ArbSysAddr).sendTxToL1(destination, calld);
