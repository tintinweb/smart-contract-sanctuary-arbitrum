...
contract QarbCodes is ERC721URIStorage, Ownable {
    ...
    bytes private constant tokenDescription =
    ...
    function generateBuf(
        uint8[] memory data
    ) public pure returns (uint256[44] memory) {
    ...
    function pack(
        ...
        uint256 n,
        uint256 index
    ) public pure returns (uint256[44] memory, uint256, uint256) {
    ...
    function generateQRURIByteVersion(
        QRMatrix memory _qrMatrix
    ) public pure returns (string memory) {
        bytes memory svgBytes = DynamicBuffer.allocate(1024 * 128);
        DynamicBuffer.appendSafe(
            svgBytes,
            '<svg viewBox="0 0 296 296" width="296" height="296" xmlns="http://www.w3.org/2000/svg"><style>.bg{fill:#FCF}.fg{fill:#000}</style><rect class="bg" x="0" y="0" width="296" height="296"></rect>'
        );
