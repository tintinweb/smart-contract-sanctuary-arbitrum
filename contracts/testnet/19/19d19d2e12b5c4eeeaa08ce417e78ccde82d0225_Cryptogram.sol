...
contract Cryptogram is ERC1155PresetMinterPauserUpgradeable {
    ...
    function initialize(
        ...
        string memory epicUri,
        string memory legendaryUri
    ) public virtual initializer {
        __ERC1155PresetMinterPauser_init("");
        _setBaseURI(baseUri);
        _setURI(COMMON, commonUri);
        _setURI(RARE, rareUri);
        _setURI(EPIC, epicUri);
        _setURI(LEGENDARY, legendaryUri);
    }
