...
contract Toadz is Initializable, ToadzMintable {
    ...
    function setBaseURI(string memory _baseURItoSet) external onlyAdminOrOwner {
...
abstract contract ToadzState is Initializable, IToadz, ERC721EnumerableUpgradeable, AdminableUpgradeable {
