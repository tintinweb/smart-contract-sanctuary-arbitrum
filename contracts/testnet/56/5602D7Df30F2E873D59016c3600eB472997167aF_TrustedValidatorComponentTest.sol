...
uint256 constant ID = uint256(
    keccak256("game.piratenation.trustedvalidatorcomponenttest.dev1")
);
...
struct Layout {
    ...
    string serverPublicAddressStr;
}

library TrustedValidatorComponentTestStorage {
...
/**
 * @title TrustedValidatorComponentTest
 * @dev A public trusted validators
 */
contract TrustedValidatorComponentTest is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // Public addresses for a trusted validator
        keys[5] = "server_public_address_str";
     ...
     * @param serverPublicAddressStr Public addresses for a trusted validator
     */
    function setValue(
        uint256 entity,
        ...
        bool hasSsl,
        address serverPublicAddress,
        string calldata serverPublicAddressStr
    ) external virtual onlyRole(GAME_LOGIC_CONTRACT_ROLE) {
        _setValue(
            entity,
            Layout(
    ...
    function getLayoutValue(
        ...
        value = TrustedValidatorComponentTestStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     * @return serverPublicAddressStr Public addresses for a trusted validator
     */
    function getValue(
        uint256 entity
    )
        ...
        returns (
            ...
            bool hasSsl,
            address serverPublicAddress,
            string memory serverPublicAddressStr
        )
    {
        if (has(entity)) {
            Layout memory s = TrustedValidatorComponentTestStorage
                .layout()
            ...
            (
                ...
                _getEncodedValues(s),
                (string, uint16, bool, bool, address, string)
            );
        }
    }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = TrustedValidatorComponentTestStorage
            .layout()
            .entityIdToStruct[entity];
        ...
        values[5] = abi.encode(s.serverPublicAddressStr);
    }
    ...
    function setBytes(
        ...
        (
            ...
            s.serverPublicAddressStr
        ) = abi.decode(value, (string, uint16, bool, bool, address, string));
    ...
    function remove(
        ...
        delete TrustedValidatorComponentTestStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete TrustedValidatorComponentTestStorage
                .layout()
    ...
    function _setValueToStorage(uint256 entity, Layout memory value) internal {
        ...
        s.serverPublicAddressStr = value.serverPublicAddressStr;
    }
