    ...
    BeefyDepositoryStorage
{
    ...
    /// @param _factoryWrapper the address of the BeefyWrapperFactory contrat. It is used to instantiate new BeefyWrapper for existing beefy vaults.
    ...
    function initialize(
        ...
        // }
        // if (!_factoryWrapper.isContract()) {
        //     revert NotContractAddress(_factoryWrapper);
        // }
        ...
        //     BeefyWrapperFactory(_factoryWrapper).clone(_vault)
        // );
        ...
        returns (uint256)
    {
        ...
        IERC20(assetToken).approve(
            address(BeefyVaultV7(vaultWrapper.vault())),
            assetAmount
        );
        uint256 shares = vaultWrapper.deposit(assetAmount, address(this));
