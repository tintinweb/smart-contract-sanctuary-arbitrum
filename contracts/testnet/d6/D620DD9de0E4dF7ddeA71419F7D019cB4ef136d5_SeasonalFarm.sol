    ...
    ReentrancyGuardUpgradeable
{
        ...
        external whenNotPaused nonReentrant
    {
        ...
        if(exitFee > 0) {
            ...
            emit ExitFeeTransferred(address(this), msg.sender, to, exitFee, managerFee, adminFee);
            ...
            if(_penaltyFee > 0) {
                ...
                emit PenaltyFeeTransferred(address(this), msg.sender, _penaltyFee);
        ...
        external payable onlyManager whenNotPaused nonReentrant
    {
        ...
        emit Invested(address(this), msg.sender, _newOrder, _asset, _amount, _info);
    }

    function divest(uint256 _orderId, bytes memory _info)
        external onlyManager whenNotPaused nonReentrant
    {
        ...
        if(order.isOpenning) {
            ...
            emit Divested(address(this), msg.sender, _orderId, order.asset, allowanceAmount, _info);
        }
    }
