...
//        executionFee = _executionFee;
    ...
    function createIncreasePositionRequest(
        ...
        uint256 amountInAfterFeeUsd = _amountInUsd.add(totalFeeUsd);
        if (_voucherId > 0) {
            amountInAfterFeeUsd -= IGatewayUtils(gatewayUtils)
                .calculateDiscountValue(_voucherId, amountInAfterFeeUsd);
        }
    ...
    function createIncreaseOrderRequest(
        ...
        uint256 amountInAfterFeeToken;
        {
            ...
            amountInAfterFeeToken = _usdToTokenMin(
                _path[0],
                amountInAfterFeeUsd
            );
        }
