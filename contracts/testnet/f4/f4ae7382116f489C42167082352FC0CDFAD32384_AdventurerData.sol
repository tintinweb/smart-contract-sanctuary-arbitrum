  ...
  Pausable
{
  ...
  mapping(address => mapping(uint256 => address)) public override metadata;

  //=======================================
  // Events
  //=======================================
  event Created(address addr, uint256 id);
  // TODO: should we pass the metadata address?
  ...
  function createFor(
    ...
    metadata[_addr][_id] = _metadataAddress;
