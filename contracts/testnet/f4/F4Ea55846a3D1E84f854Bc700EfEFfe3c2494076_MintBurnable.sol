...
/**
 * @title Mint_BurnableERC20
 * @dev Implementation of the Mint_BurnableERC20
 */
contract MintBurnable is
    ERC20Capped,
    ERC20Mintable,
    ERC20Burnable,
    Ownable,
    Services
{
    ...
    event MintBurnableTokenCreated(
