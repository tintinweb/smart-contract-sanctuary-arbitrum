...
contract SettingsManagerV2_4 is ISettingsManagerV2, Constants, Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _RUSD) public reinitializer(4) {
