...
contract AimagineERC721Drop is ERC721A, IERC2981, ReentrancyGuard, AccessControl, IAimagineERC721Drop, Ownable {
    ...
    /**
     * @notice Allows users to purchase tokens from the public sale with a comment.
     * @param quantity The quantity of tokens to purchase.
    ...
    /**
     * @notice Allows whitelisted users to purchase tokens from the presale with a comment.
     * @param quantity The quantity of tokens to purchase.
     * @param maxQuantity The maximum quantity of tokens a user can purchase in the presale.
     * @param pricePerToken The price per token in the presale.
     * @param merkleProof The Merkle proof for the presale whitelist.
