 ...
 */
contract ERC721TokenDistributor is AccessControl, ReentrancyGuard, ITokenDistributor {
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN");
    bytes32 public constant STAKING_ROLE = keccak256("STAKING");

    ITestERC721 public erc721;
    ...
    constructor(
        ...
        require(erc721_ != address(0), "ERC721TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        require(admin_ != address(0), "ERC721TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        require(staking_ != address(0), "ERC721TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        erc721 = ITestERC721(erc721_);
    ...
    modifier onlyAdmin() {
        require(hasRole(ADMIN_ROLE, msg.sender), "ERC721TOKENDISTRIBUTOR:ACCESS_DENIED");
        _;
    }

    modifier onlyStaking() {
        require(hasRole(STAKING_ROLE, msg.sender), "ERC721TOKENDISTRIBUTOR:ACCESS_DENIED");
        _;
    }
    ...
    function payout(address payee, uint256 amount) public nonReentrant onlyStaking {
        ...
        for (uint256 i = 0; i < realAmount; i++) {
            erc721.mint(payee);
        }
    }
}
