...
abstract contract BarnMintable is Initializable, BarnContracts {
    ...
    function mintBatch (address _to, uint256 _amount, uint256 tokens) 
        external
        override
        whenNotPaused
        onlyMinter
...
interface IBarn {
	...
	function mintBatch (address _to, uint256 _amount, uint256 tokens) external;
...
abstract contract BarnContracts is Initializable, BarnState {
	...
	function setContracts(address _barnMetadata) external onlyAdminOrOwner {
