    ...
    TokensRescuer
{
    ...
    function __Parallax_init(
        ...
        IERC20Upgradeable initialRewardsToken
        ...
        __Parallax_init_unchained(initialFeesReceiver, initialRewardsToken);
    }
    ...
    function __Parallax_init_unchained(
        ...
        rewardsToken = initialRewardsToken;
    }
    ...
    function _deposit(
        ...
        if (positionId == 0) {
            ...
            UserPosition memory position = positions[strategyId][_msgSender()][
                positionId
            ];

            require(
                position.created && !position.closed,
        ...
        positions[strategyId][_msgSender()][positionId].shares += shares;
        positions[strategyId][_msgSender()][positionId].lastStaked = block
            .timestamp;
    ...
    function _withdraw(
        ...
        uint256 amount = (strategies[strategyId].totalStaked * shares) /
            strategies[strategyId].totalShares;
        bool closed;
        ...
        if (positions[strategyId][_msgSender()][positionId].shares == 0) {
            positions[strategyId][_msgSender()][positionId].closed = true;

            _burn(positions[strategyId][_msgSender()][positionId].tokenId);
