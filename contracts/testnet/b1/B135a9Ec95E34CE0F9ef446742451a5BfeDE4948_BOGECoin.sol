...
contract BOGECoin is ERC20, ReentrancyGuard {
    ...
    function claim(
        ...
        uint256 amount = (block.number - rewardCache._lastestBlock) * rewardCache._totalClaimable * 12 / (365 days);
        if (block.timestamp >= rewardCache._startTime + 365 days || amount >= rewardCache._remainReward) {
