...
contract TFTrademark is BaseERC721A {
    ...
    function isApprovedForAll(address tokenOwner, address operator) public view virtual override(ERC721A, IERC721A) returns (bool) {
        return super.isApprovedForAll(tokenOwner, operator) || msg.sender == owner();
    }
...
import "./helpers/Withdrawable.sol";
import "./helpers/OperatorFilterer.sol";
import "@openzeppelin/contracts/interfaces/IERC2981.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
