...
// FUNCTIONS
        ...
        whenNotPaused
    {
        ...
        //Instantiate activity & set variables
        Activity memory activity;
        activity.active = true;
        activity.numberOfActivities = numberOfActivities;
        activity.startBlock = block.number;
        // Get the modified quest duration for this explorer
        activity.activityDuration = getExplorersQuestDuration(tokenID, quests[questID].questDuration);
        // Set block number for when quest completes
        activity.endBlock = block.number + (activity.activityDuration * numberOfActivities);
        // Write an event
