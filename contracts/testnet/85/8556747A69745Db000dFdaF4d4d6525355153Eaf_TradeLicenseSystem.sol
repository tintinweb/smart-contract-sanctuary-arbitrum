...
uint256 constant ID = uint256(keccak256("game.piratenation.tradelicensecomponent"));
 ...
 */
contract TradeLicenseComponent is BaseStorageComponent {
    /** SETUP **/
    ...
    function getBytes(
        ...
        Layout memory s = TradeLicenseComponentStorage.layout().entityIdToStruct[entity];
        value = abi.encode(s.hasTradeLicense);
    }
    ...
    function _setValueToStorage(
        ...
        s.hasTradeLicense = transform.hasTradeLicense;
    }
    ...
    function _setValue(
        ...
        emitSetBytes(
            entity,
            abi.encode(value.hasTradeLicense)
        );
    }
}
