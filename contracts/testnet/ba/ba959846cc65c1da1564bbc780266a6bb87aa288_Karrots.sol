...
contract Karrots is Context, AccessControlEnumerable, ERC20Burnable, Ownable {
    ...
    CORRECTIONS:
        tax value should be in terms of 1e24 like the balances
        event value should be in terms of 1e18 for events...
        uint256 thisTaxValue = computeTax(to, karrotsValue);
        emit Transfer(msg.sender, to, value.sub(_karrotsToFragment(thisTaxValue)));
     */
