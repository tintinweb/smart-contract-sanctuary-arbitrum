...
contract RyzeDistributor is Ownable, ReentrancyGuard {
    ...
    constructor(address _signer, address _underlyingToken, address _treasuryReferrals) {
        signer = _signer;
    ...
    function claim(
        ...
        if (allocation > claimedAmount[msg.sender]) {
            ...
            if (availableAmount != 0) {
                ...
                IERC20(underlyingToken).safeTransferFrom(treasuryReferrals, msg.sender, availableAmount);
    ...
    function verifySigner(address sender, uint256 fee, bytes calldata signature) public view  returns (bool)
    {
