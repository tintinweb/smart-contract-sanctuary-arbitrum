...
contract GUSDC is ERC2771Recipient, ERC20 {
  IERC20 USDC;

  constructor(string memory name_, string memory symbol_, address _USDC, address forwarder_) ERC20(name_, symbol_) {
  ...
  function wrap(uint256 amount) external { 
      // do a bunch of require approvals 
      // and make sure amt is higher balance
