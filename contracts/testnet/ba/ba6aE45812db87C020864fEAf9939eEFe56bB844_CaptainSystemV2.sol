...
contract CaptainComponent is BaseComponent {
    ...
    function setValue(
        ...
        _set(entity, abi.encode(tokenContract, tokenId, lastSetCaptainTime));
    }
...
import {ITraitsProvider, ID as TRAITS_PROVIDER_ID} from "../interfaces/ITraitsProvider.sol";
import {CaptainComponent, ID as CAPTAIN_COMPONENT_ID} from "./CaptainComponent.sol";
...
contract CaptainSystemV2 is ICaptainSystem, GameRegistryConsumerUpgradeable {
    ...
    function setCaptainNFT(
        ...
        CaptainComponent captainComponent = CaptainComponent(
    ...
    function getCaptainNFT(
        ...
        (tokenContract, tokenId, ) = captainComponent.getValue(entity);
    }
