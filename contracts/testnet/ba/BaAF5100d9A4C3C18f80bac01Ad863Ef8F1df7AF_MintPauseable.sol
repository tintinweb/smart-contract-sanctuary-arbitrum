...
/**
 * @title MintPauseableERC20
 * @dev Implementation of the MintPauseableERC20
 */
contract MintPauseable is
    ERC20Capped,
    ERC20Mintable,
    ERC20Pausable,
    Ownable,
    Services
{
    ...
    event MintPauseableTokenCreated(
    ...
    constructor(
        ...
        emit MintPauseableTokenCreated(
            _msgSender(),
            address(this),
            "Mint_Pauseable",
            serviceFee
