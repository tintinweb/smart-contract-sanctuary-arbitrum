...
import "../../interfaces/tokens/ILoot8ERC20.sol";
...
contract Loot8ERC20 is ILoot8ERC20, ERC20PermitUpgradeable, DAOAccessControlled {
    ...
    function initialize(address _authority) public initializer {
        ERC20Upgradeable.__ERC20_init("LOOT8 Purchase Token", "LOOT-8");
        ERC20PermitUpgradeable.__ERC20Permit_init("LOOT8 Purchase Token");
    ...
    function _msgSender() internal view virtual override(ContextUpgradeable, DAOAccessControlled) returns (address sender) {
