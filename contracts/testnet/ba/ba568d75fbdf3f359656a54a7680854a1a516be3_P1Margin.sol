...
contract P1Margin
{
    ...
    mapping(string => address) public _TOKEN_MAP_;
    ...
    {
        //check token address
        address token_address = _TOKEN_MAP_[token_symbol];
        require(
            token_address != address(0),
            "Aboard: Not in the Tokens map"
        );
        ...
        //yt: test1 event especially string
        emit LogDeposit(
            account,
            token_symbol,
            amount
     ...
     * @param  gasfee       The gas fee of the tx
        ...
        nonReentrant
    {
        ...
        //check signature
        // bytes32 applyhash = _getApplyHash(account, destination, token_symbol, amount, withdrawid);
        // require(
        ...
        //SignedMath.Int memory signedChange = funding.sub((amount + gasfee).mul(DECIMAL_ADJ)); //Ethernet 3/3
        //SignedMath.Int memory signedChange = funding.sub(amount + gasfee);
    ...
    function _getApplyHash(
        ...
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(account, destination, token_symbol, amount, withdrawid));
    }
        ...
        nonReentrant
    {
        ...
        _TOKEN_MAP_[token_symbol] = token_address;
        emit LogSetTokenMap(token_symbol, token_address);
    }
