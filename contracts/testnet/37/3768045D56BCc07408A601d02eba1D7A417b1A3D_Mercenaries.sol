...
// VIEWS
        ...
        returns (string memory uri) 
    {
        ...
        if (collectionAddress == address(this)) {
            ...
            string memory url = string(abi.encodePacked(_url,".json"));
            string memory json1 = Base64.encode(bytes(string(abi.encodePacked(
                '{',
                '"name": "',                name(), '",',
            ...
            return string(abi.encodePacked('data:application/json;base64,', json1, encodeStats(underlyingTokenHash), encodeTraits(wrappedTokenID)));   // Return the result
        } else {
        ...
        returns (string memory)
    {
        ...
        string memory json2 = Base64.encode(bytes(string(abi.encodePacked(
        ...
        returns (string memory)
    {
        ...
        string memory json1 = Base64.encode(bytes(string(abi.encodePacked(
            '{ "id": 0, "trait_type": "background", "value": "' ,traits[0], '" },',
            '{ "id": 0, "trait_type": "base", "value": "'       ,traits[1], '" },',
            '{ "id": 0, "trait_type": "gender", "value": "'     ,traits[2], '" },',
            '{ "id": 0, "trait_type": "hair", "value": "'       ,traits[3], '" },',
            '{ "id": 0, "trait_type": "eyes", "value": "'       ,traits[4], '" },',
            '{ "id": 0, "trait_type": "mouth", "value": "'      ,traits[5], '" },',
            '{ "id": 0, "trait_type": "clothing", "value": "'   ,traits[6], '" },',
            '{ "id": 0, "trait_type": "feature", "value": "'    ,traits[7], '" }',
            ']',
            '}'
        ))));
        return string(abi.encodePacked(json1));   // Return the result
    }
