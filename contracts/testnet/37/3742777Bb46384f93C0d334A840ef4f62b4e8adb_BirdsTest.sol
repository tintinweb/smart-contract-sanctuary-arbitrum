...
contract BirdsTest is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    using SafeMath for uint256;
    bytes32 public merkleRoot = 0x7337390021c0c862796c4edcfc6a0350401de3f430a8b1e7fcb81f0d4e02aca2;
    uint16 public maxPerTransaction = 8; 
    uint16 public maxPerWallet = 8;
    uint256 public price = 0.01 ether; 
    uint16 private constant totalCollectionSize = 3333;
    uint16 private freebies;
    uint16 private freebieLimit = 3333;
    ...
    constructor() ERC721A("BirdsTest", "BT", 8, totalCollectionSize) { 
        setBaseURI("ipfs://QmZE4vBcpGsRoJUHstqXhUwJ6uL3NowEXR5Cm1TQUxLp6p/");
        setHiddenMetadataUri("ipfs://QmdzyxzEZyAdqGkGGLZ8LEMDqiN9RnvnzmvspHeFT3Voi8/Hidden.json");   
    }
    ...
    function isFreebieTime(bool _state) public onlyOwner {
        isFree = _state;
    }
    function setFreebieLimit(uint16 _quantity) public onlyOwner {
        freebieLimit = _quantity;
    }
