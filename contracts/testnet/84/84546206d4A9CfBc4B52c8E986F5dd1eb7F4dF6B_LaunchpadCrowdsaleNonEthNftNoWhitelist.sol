...
import "./interfaces/ILaunchpadCrowdsaleNonEthNftNoWhitelist.sol";

/**
 * @title LaunchpadCrowdsaleNonEthNftNoWhitelist
 * @author Enjinstarter
 * @dev Launchpad crowdsale with non ETH address collection where there is no delivery of tokens in each purchase.
 */
contract LaunchpadCrowdsaleNonEthNftNoWhitelist is
    NoDeliveryCrowdsale,
    CappedTokenSoldCrowdsaleHelper,
    IndividuallyCappedCrowdsaleHelper,
    TimedCrowdsaleHelper,
    Pausable,
    ILaunchpadCrowdsaleNonEthNftNoWhitelist
{
    ...
    constructor(
        ...
        IndividuallyCappedCrowdsaleHelper(
            lotsInfo.maxLots.mul(lotsInfo.lotSize)
        )
    ...
    modifier onlyBy(address account) {
        require(
            msg.sender == account,
            "LaunchpadCrowdsaleNonEthNftNoWhitelist: sender unauthorized"
        );
        _;
    }
    ...
    function buyTokens(
        ...
        require(
            ...
            "LaunchpadCrowdsaleNonEthNftNoWhitelist: empty non ETH address"
        );
        ...
        onlyBy(governanceAccount)
    {
        require(
            account != address(0),
            "LaunchpadCrowdsaleNonEthNftNoWhitelist: zero account"
        );
        ...
        tokenCapNotExceeded(tokensSold, tokenAmount)
    {
        ...
        if (
            ...
            revert(
                "LaunchpadCrowdsaleNonEthNftNoWhitelist: beneficiary cap exceeded"
            );
        }
...
contract IndividuallyCappedCrowdsaleHelper {
        ...
        returns (uint256 tokenCap)
    {
        require(
            ...
            "IndividuallyCappedCrowdsaleHelper: zero beneficiary address"
        );
...
/**
 * @title ILaunchpadCrowdsaleNonEthNftNoWhitelist
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNonEthNftNoWhitelist is ICrowdsale {
    function buyTokens(
        address paymentToken,
        uint256 lots,
        string calldata nonEthAddress
