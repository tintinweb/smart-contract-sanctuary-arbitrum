...
contract CoreRouter {
    ...
    address private constant _CCIP_RECEIVER_MODULE = 0xA9BF849fEdFcBc681F9121CEB9035045c90D38B2;
    ...
    address private constant _CROSS_CHAIN_USDMODULE = 0xda21c57Edf6c9a4CAF8c64aCa6b4B7bf72188926;
    ...
    address private constant _UTILS_MODULE = 0xb20d72431Ff1A0c1423d0D87CcED5311b2A0391e;
        ...
        assembly {
            ...
            function findImplementation(sig) -> result {
                if lt(sig,0x830e23b5) {
                    if lt(sig,0x3593bbd2) {
                        if lt(sig,0x183231d7) {
