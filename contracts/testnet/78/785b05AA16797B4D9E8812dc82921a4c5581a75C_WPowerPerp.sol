...
contract WPowerPerp is ERC20, Initializable, IWPowerPerp, Ownable {
    ...
    bool public initialMintFinished = false;
    /**
     ...
     */
    function initialMint(address _account, uint256 _amount) external override onlyOwner {
        require(initialMintFinished == false, "Initial Mint Finished");
        _mint(_account, _amount);
        initialMintFinished = true;
    }
