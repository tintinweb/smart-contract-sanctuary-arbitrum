...
contract Reader {
    ...
    function getUserOldVelaInfo(address _account) external view returns (uint256, uint256, uint256) {
        ...
        return (esVelaBalance, userVelaStakedAmount, userEsVelaStakedAmount);
    }
}
