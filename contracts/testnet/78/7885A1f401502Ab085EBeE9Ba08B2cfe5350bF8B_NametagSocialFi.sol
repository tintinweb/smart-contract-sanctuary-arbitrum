...
contract NametagSocialFi is Ownable {
    ...
    * @param _feeDestination - destination address
    */
    function setFeeDestination(address _feeDestination) public onlyOwner {
        require(_feeDestination != address(0), "Invalid address");
        protocolFeeDestination = _feeDestination;
    }

    /**
    * @dev Set service fee percent
    * @param _feePercent. 100% = 10e18. The percentage must be greater than 0% and less than 10%
    */
    function setProtocolFeePercent(uint256 _feePercent) public onlyOwner {
        require(_feePercent > 0 && _feePercent <= 1 ether / 10, "Invalid fee value");
