...
contract ThemisTeam is Ownable, IThemisTeam {
    ...
    modifier onlyExecutor() {
        require(
            isExecutor(_msgSender()),
            "Themis: Only executors"
        );
        _;
    }
     ...
     * @param member Address of personnel to be operated
     * @param isEntered  choose true to join the team, and choose false to remove the team
     */
    function manageMember(address member, bool isEntered) external {
        ...
        emit MemberManaged(teamId, teamOwner, member, isEntered);
    }
