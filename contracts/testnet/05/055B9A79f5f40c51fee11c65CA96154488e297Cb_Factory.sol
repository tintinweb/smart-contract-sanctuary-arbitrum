...
contract Exchange is Ownable {
    ...
    function newSellOrder(
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (sellAmount == 0) {
                ...
                IERC20(tokenB).transfer(msg.sender, o.amount * largeNumber);
                ...
                IERC20(tokenB).transfer(
                    msg.sender,
                    (price * sellAmount * largeNumber) / 100
                );
    ...
    function newBuyOrder(
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (buyAmount == 0) {
                ...
                IERC20(tokenB).transfer(o.seller, (price * o.amount * largeNumber) / 100);
                buyAmount -= o.amount;
                ...
                IERC20(tokenB).transfer(o.seller, (price * buyAmount * largeNumber) / 100);
                buyAmount = 0;
            }
        }
        // new buy order
    ...
    function collectFees() external onlyOwner returns (bool) {
        ...
        IERC20(tokenB).transfer(msg.sender, tokenBaccumulatedFee * largeNumber);
