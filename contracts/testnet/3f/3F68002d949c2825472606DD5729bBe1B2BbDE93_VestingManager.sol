...
contract VestingManager is ReentrancyGuard {
    ...
    */
    function createVestingSchedule(
        ...
        uint256 cliffEndTime = _startTime + _cliffPeriodInSeconds;
        ...
        emit VestingScheduleCreated(tx.origin, _recipient, _token, _startTime, _cliffPeriodInSeconds, _totalVestingDuration, _unlockInterval, _amountTotal, _revocable, vestingScheduleId);
    }
    ...
    */
    ...
    function _computeReleasableAmount(VestingSchedule memory vestingSchedule) internal view returns(uint256){
        ...
        if ((currentTime < vestingSchedule.cliffEndTime) || vestingSchedule.revoked == true) {
            return 0;
            ...
            uint256 timeFromStart = currentTime - vestingSchedule.cliffEndTime;
