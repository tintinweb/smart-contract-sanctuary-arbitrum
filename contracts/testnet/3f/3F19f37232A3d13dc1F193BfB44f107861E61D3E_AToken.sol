...
/**
 * @title Poisson ERC20 AToken
 * @dev Implementation of the interest bearing token for the Poisson protocol
  ...
  IAToken
{
  ...
  /**
   * @dev Returns the address of the Poisson treasury, receiving the fees on this aToken
   **/
