...
contract VestingManager is Ownable, ReentrancyGuard {
    ...
    function getVestingSchedulesCountByBeneficiary(address _recipient) external view returns(uint256){
    ...
    */
    function release(
        ...
        bool isBeneficiary = msg.sender == vestingSchedule.recipient;
