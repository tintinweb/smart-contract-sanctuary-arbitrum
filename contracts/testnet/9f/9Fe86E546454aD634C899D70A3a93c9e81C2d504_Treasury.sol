...
contract Treasury is IRewardsManager, OwnableUpgradeable {
    ...
    function initialize(address rewardsToken_) initializer public {
    ...
    function withdrawRewards() external onlyOwner {
        IERC20Metadata(rewardsToken).transfer(_msgSender(), IERC20Metadata(rewardsToken).balanceOf(address(this)));
    }
    ...
    function distributionRewards(address rewardPool_, uint256 amount_) external onlyOwner {
        ...
        IERC20Metadata(rewardsToken).transfer(rewardPool_, amount_);
    }
