...
import "../Utils/Math/ABDKMath64x64.sol";
...
import "../Utils/Uniswap/V3/libraries/FixedPoint96.sol";
import "../Utils/Uniswap/V3/libraries/SqrtPriceMath.sol";
...
contract Pegging {
    ...
    IUniswapV3Factory public constant uniswap_factory =
        IUniswapV3Factory(0x4893376342d5D7b3e31d4184c08b265e5aB2A3f6);
    ...
    function amountToPeg_UsingConstantProduct() public view returns (uint256 amount) {
        ...
        amount = getQuoteAtTick(tickCurrent, uint128(sweep_to_peg), address(USDX), address(SWEEP));
    }
...
interface ISweep {
    ...
    function is_minting_allowed(uint256 mint_amount) external view returns (bool);

    function margin_sweep_amount() external view returns (uint256);
...
import '../../../../Common/ERC721/IERC721Metadata.sol';
import '../../../../Common/ERC721/IERC721Enumerable.sol';
import '../../../../Common/ERC721/IERC721Permit.sol';
