 ...
 * @notice This contract handles minting Test NFT Heymint tokens.
 */
contract TestNFTHeymint is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc15d059882aC142F1fECBA295fe6ADf54F28b721;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x638fF813e2e9e33Bd96A9B948eFe443dDaC9525C;
    address[] public payoutAddresses = [
        0x638fF813e2e9e33Bd96A9B948eFe443dDaC9525C
    ];
    ...
    string public name = "Test NFT Heymint";
    string public symbol = "TNH";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeia4wonu37s353n4xa5mo4bfhf544z3wexbwlzjocfzgpdqpbaatky/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[111] = 20000;
        tokenPublicPrice[111] = 0.0001 ether;
        tokenPublicMintsPerAddress[111] = 20000;
        require(
