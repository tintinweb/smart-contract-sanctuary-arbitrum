...
// File: contracts/Games/BSCCoinFlipFast.sol
...
contract BSCCoinFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0x41b429144Bd4E983d71a538813565D03BDC5F19B);
    uint8 public _houseFeePercentage = 40; // In 0.1% increments

    address public _devFeeReceiver = address(0x41b429144Bd4E983d71a538813565D03BDC5F19B);
    ...
    function enterGame(uint256 wager, uint8 outcome, address token, address referrer) external payable {
        ...
        if (referrer != address(0x0) && referrer != _msgSender()) {
