...
contract Entity is IEntity, Initializable, DAOAccessControlled {
    ...
    */
    function addEntityAdmin(address _entAdmin) external onlyGovernor {
        ...
        uint256[1] memory __gap;
        //bytes[] memory _newOperatorBytes = new bytes[](2);
        uint256[] memory _newOperatorIntDynamic = new uint256[](2);
        entityAdminDetails[_entAdmin] = Operator({
            ...
            newOperatorString: '',
            //newOperatorBytes: _newOperatorBytes,
            newOperatorIntDynamic: _newOperatorIntDynamic,
    ...
    function updateOperatorString(address _entAdmin) public {
        entityAdminDetails[_entAdmin].newOperatorString = 'lskffjffhtjtsjdkslsksjdnghgkgogpgkdmdndjdjdjdjd';
    }
...
interface IEntity is ILocationBased {
    ...
    struct Operator {
        ...
        //bytes[] newOperatorBytes;
        uint256[] newOperatorIntDynamic;
