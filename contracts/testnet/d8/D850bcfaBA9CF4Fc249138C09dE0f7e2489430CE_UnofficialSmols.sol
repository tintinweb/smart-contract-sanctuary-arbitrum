...
contract UnofficialSmols is ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor(address _marketplaceAddress, address _keyAddress, uint256 maxNftSupply) ERC721("UnofficialSmols", "USMOL") {
