...
/** @notice The  DEV contracts have the responceblity for Minting NFTs , transferring , burning NFTs from the wallets
...
//@title DEV having the nature of ERC721A with Royalties.
//@dev see{ERC721A, ERC2981, ReentrancyGuard, AccessControl}.

contract DEVEcosystem is ERC721A, ERC2981, ReentrancyGuard, AccessControl {
    ...
    //@notice DEVProxy holds current DEVProxy address.

    address public DEVProxy;
    ...
    constructor(address _DEVProxyAddress) ERC721A("DEV Ecosystem", "CLE") {
        owner = _msgSender();
        signer = _msgSender();
        DEVProxy = _DEVProxyAddress;
    ...
    */
    ...
    function _beforeTokenTransfers(
        ...
        require(from == address(0)|| to == address(0) || _msgSender() == DEVProxy || !isDirectTransferBlocked, "DEV: Transfer not Allowed");
    }
