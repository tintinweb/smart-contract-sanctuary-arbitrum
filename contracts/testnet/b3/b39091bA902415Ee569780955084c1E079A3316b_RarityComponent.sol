...
uint256 constant ID = uint256(keccak256("game.piratenation.raritycomponent.dev1"));

struct Layout {
    uint256 value;
}

library RarityComponentStorage {
...
/**
 * @title RarityComponent
 * @dev The rarity of an entity
 *
 * @dev Generated with component version 1.
 */
contract RarityComponent is BaseStorageComponent {
    /** SETUP **/
    ...
    function getValue(
        ...
        value = RarityComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = RarityComponentStorage
           .layout()
    ...
    function getBytes(
        ...
        Layout memory s = RarityComponentStorage.layout().entityIdToStruct[entity];
    ...
    function remove(uint256 entity) public virtual {
        ...
        delete RarityComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(uint256[] calldata entities) public virtual {
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete RarityComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
