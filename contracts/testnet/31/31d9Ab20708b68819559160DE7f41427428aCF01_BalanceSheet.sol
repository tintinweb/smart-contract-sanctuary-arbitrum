...
contract BalanceSheet is IBalanceSheet, AccessControl {
     ...
     */
    function removeCollateral(address _userAddress, uint256[] memory _tokenIds)
        public
        onlyAssetManager
    {
     ...
     */
    function setPayment(address _userAddress, uint256 _paymentAmount)
        public
        onlyAssetManager
        returns (uint256)
    {
     ...
     */
    function getLoanBasics(address _userAddress)
        public
        view
        returns (
     ...
     * @return liquidatable
     */
    function getLoanMetrics(address _userAddress)
        public
        view
        returns (
     ...
     * @return tokenIds
     */
    function getTokenIds(address _userAddress)
        public
        view
     ...
     * @return accruedFees
     */
    function getAccruedFees(address _userAddress)
        public
        view
     ...
     * @return borrowedAmount
     */
    function getBorrowedAmount(address _userAddress)
        public
        view
     ...
     * @return paymentsAmount
     */
    function getPaymentsAmount(address _userAddress)
        public
        view
        returns (uint256 paymentsAmount)
    {
     ...
     */
    function getCurrentPremium(uint256 _numberOfTokens, uint256 _strikePrice)
        public
        view
        returns (uint256 currentPremium)
    {
     ...
     * @return collateralValue
     */
    function getCollateralValue(address _userAddress)
        public
        view
     ...
     * @return outstandingLoan
     */
    function getOutstandingLoan(address _userAddress)
        public
        view
        returns (uint256 outstandingLoan)
    {
        return
            getBorrowedAmount(_userAddress) +
            getAccruedFees(_userAddress) -
     ...
     */
    function getBorrowingPower(address _userAddress)
        public
        view
        returns (uint256 borrowingPower)
    {
     ...
     */
    function getCollateralizationRatio(address _userAddress)
        public
        view
        returns (uint256 collateralizationRatio)
    {
        if (getOutstandingLoan(_userAddress) > 0) {
            uint256 collateralValue = getCollateralValue(_userAddress);
            uint256 outstandingLoan = getOutstandingLoan(_userAddress);
     ...
     */
    function getClaimableFees(address _userAddress)
        public
        view
        returns (uint256 claimableFees)
    {
     ...
     */
    function getLiquidationCount(address _userAddress)
        public
        view
        returns (uint256 liquidationCount)
    {
     ...
     */
    function _addBorrowedAmount(address _userAddress, uint256 _borrowedAmount)
        private
    {
     ...
     * @param _tokenIds - token ID array
     */
    function _addCollateral(address _userAddress, uint256[] memory _tokenIds)
        private
    {
        for (uint256 i = 0; i < _tokenIds.length; i++) {
...
interface IPricingOracle {
    ...
    function setTreasureNFTPriceTracker(address _treasureNFTPriceTracker)
        external;
...
interface IBalanceSheet {
    ...
    function nullifyLoan(address _userAddress) external;
