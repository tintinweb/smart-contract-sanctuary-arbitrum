...
import {IRwaxMaster} from "../interfaces/IRwaxMaster.sol";
...
contract RwaxZap is Ownable, ReentrancyGuard {
    ...
    function zap(
        ...
        address _lp = rwaxMaster.lpToken(_info.pid);
        ...
        approveToken(_lp, address(rwaxMaster), _liquidity);
        rwaxMaster.deposit(_info.pid, _liquidity, msg.sender);
