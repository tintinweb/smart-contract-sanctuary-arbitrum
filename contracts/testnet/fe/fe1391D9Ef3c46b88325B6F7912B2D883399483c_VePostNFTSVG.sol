    ...
    function _buildInformation(
        ...
        return
            ...
            abi.encodePacked(
                ...
                _toString(tokenId),
                '</tspan></text></g><g clip-path="url(#l)" font-family="Arial" font-size="20"><text fill="#E2E8F0" xml:space="preserve" style="white-space:pre" letter-spacing="0em"><tspan x="36" y="412.627">Boost: </tspan></text><text fill="#F1F5F9" xml:space="preserve" style="white-space:pre" font-weight="bold" letter-spacing="-.005em" text-anchor="end"><tspan x="380" y="412.627">',
                _buildBoost(startTimeLock, endTimeLock, boost),
                '%</tspan></text></g><g clip-path="url(#m)" font-family="Arial" font-size="20"><text fill="#E2E8F0" xml:space="preserve" style="white-space:pre" letter-spacing="0em"><tspan x="36" y="454.627">Par Value: </tspan></text><text fill="#F1F5F9" xml:space="preserve" style="white-space:pre" font-weight="bold" letter-spacing="-.005em" text-anchor="end"><tspan x="380" y="454.627">',
                _buildNumberDecimal(_pairValue),
                '</tspan></text></g><g clip-path="url(#n)" font-family="Arial" font-size="20"><text fill="#E2E8F0" xml:space="preserve" style="white-space:pre" letter-spacing="0em"><tspan x="36" y="496.627">Current Power: </tspan></text><text fill="#F1F5F9" xml:space="preserve" style="white-space:pre" font-weight="bold" letter-spacing="-.005em" text-anchor="end"><tspan x="380" y="496.627">',
