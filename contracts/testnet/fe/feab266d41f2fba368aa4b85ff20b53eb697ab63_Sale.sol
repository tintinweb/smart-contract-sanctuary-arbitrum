...
contract Sale {
    ...
    mapping(address => uint256) userDepositedETH;
    mapping(address => uint256) userDepositedDAI;
    mapping(address => uint256) userDepositedEUSD;
    mapping(address => uint256) userDepositedUSDC;
