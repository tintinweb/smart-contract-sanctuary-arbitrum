...
contract DPSPlunderersGuild is ERC1155Holder, Ownable, ReentrancyGuard {
     ...
     */
    function recoverNFT(address _nft, address _destination, uint256 _tokenId) external onlyOwner {
     ...
     */
    function recover1155NFT(address _nft, address _destination, uint256 _tokenId, uint256 _amount) external onlyOwner {
        if (_destination == address(0)) revert AddressZero();
