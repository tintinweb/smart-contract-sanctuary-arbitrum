...
contract TurboETH {
    ...
    uint256 public constant MIN_AMOUNT = 0.000000000000000001 ether;
    ...
    function deposit(
        ...
        user.deposits.push(
            Deposit(plan, percent, amount, profit, block.timestamp, finish, false)
        );
    ...
    function reinvest() public {
        ...
        user.deposits.push(
            Deposit(REINVEST_PLAN_INDEX, percent, totalAmount, profit, block.timestamp, finish, false)
        );
    ...
    function emergencyWithdraw(uint256 index) public {
        ...
        require(totalAmount +  pfWithdrawTax < getContractBalance() , "Sorry at  this moment system is unable to withdraw emergency funds");
