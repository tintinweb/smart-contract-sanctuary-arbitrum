...
interface ICIPADDREFREE {
    function addReferee(address user,address ref) external returns (bool);
...
contract CIPAddRefreeContract is ICIPADDREFREE {
    ...
    function addReferee(address wallet,address ref) public override returns(bool) {
        ...
        for (uint i = 0; i < 20; i++) {
                if (upline == address(0)) break;
                    if(user.userId == 0){
                        if(i==0){referrals_level_1[upline].push(wallet);}
                        else if(i==1){referrals_level_2[upline].push(wallet);}
                        else if(i==2){referrals_level_3[upline].push(wallet);}
                        else if(i==3){referrals_level_4[upline].push(wallet);}
                        else if(i==4){referrals_level_5[upline].push(wallet);}
                        else if(i==5){referrals_level_6[upline].push(wallet);}
                        else if(i==6){referrals_level_7[upline].push(wallet);}
                        else if(i==7){referrals_level_8[upline].push(wallet);}
                        else if(i==8){referrals_level_9[upline].push(wallet);}
                        else if(i==9){referrals_level_10[upline].push(wallet);}
                        else if(i==10){referrals_level_11[upline].push(wallet);}
                        else if(i==11){referrals_level_12[upline].push(wallet);}
                        else if(i==12){referrals_level_13[upline].push(wallet);}
                        else if(i==13){referrals_level_14[upline].push(wallet);}
                        else if(i==14){referrals_level_15[upline].push(wallet);}
                        else if(i==15){referrals_level_16[upline].push(wallet);}
                        else if(i==16){referrals_level_17[upline].push(wallet);}
                        else if(i==17){referrals_level_18[upline].push(wallet);}
                        else if(i==18){referrals_level_19[upline].push(wallet);}
                        else if(i==19){referrals_level_20[upline].push(wallet);}
                    }
