...
contract Axolotl_AI is ERC20, Ownable { //IsIBEP20 ?
    ...
    */
    ...
    function swapBack() internal swapping {
        ...
        if (addLiquidityEnabled) { //Todo: Does this take the proper amount?
            _doAddLp();
        }
    ...
    function _doAddLp() internal {
        ...
        if(half < 1000) return; //Todo: What does this 1000 do? Maybe needs to be adapted because of different tokenamount generally. Why does it not add lp when its more then 2000 tokens overall?
    ...
    function launch() public onlyOwner {
        ...
        _mint(flexWallet,  (_targettotalSupply * 30) / 100); //Presale 30%
    ...
    function launch_burn() public onlyOwner {
        require(!launchburn, "You already burnt 20% of the supply.");
        launchburn = true;
