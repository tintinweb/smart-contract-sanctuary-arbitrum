...
contract Harvester is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        recyclingFee = 1000000000000000;        //input in wei 
    ...
    function addToWhitelist(address _nftContract) public onlyOwnerOrManager {
        ...
        collectionInformation[_nftContract].sharePerSecond = 386000000;
    ...
    function setGaugeAddress(address _vesselAddress) public onlyOwner {
        vesselAddress = _vesselAddress;
    }
