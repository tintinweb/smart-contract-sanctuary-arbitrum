...
interface ISmolTraitShop {
    ...
    /// @param _smolIds Array of nft ids that will be reciving the airdrop.
    ...
    /// @dev Price (in IQ points) should be input as whole numbers. Contract adds necessary zeros during prchase. (ex: 20 IQ => price = 20 NOT 20000000000000000000)
