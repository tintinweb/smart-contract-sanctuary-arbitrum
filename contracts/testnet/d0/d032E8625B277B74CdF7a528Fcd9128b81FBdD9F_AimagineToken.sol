...
/**
 * @title Aimagine ERC20 Token
 * @author Stanislav Trenev - <[email protected]>
 * @dev This is an ERC20 compliant contract for the Aimagine ($AIMG) token.
 */
contract AimagineToken is ERC20Burnable, ERC20Capped, Ownable {
