...
contract ClaimPortal is Ownable, Pausable {
     ...
     */
    function userInfo(address _address) public view returns (UserInPool.User memory) {
        return _MetaversePoolInterface.userInfo(_address);
    }
    ...
    function _calculateClaimableToken(address _address) private view returns (uint256) {
        uint256 _totalAllocation = userInfo(_address).totalAllocation;
