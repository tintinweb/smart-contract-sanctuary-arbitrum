...
contract MintableERC721 is ERC721URIStorage, Ownable {
    // 需求：通过合约的 owner 去 mint 新的 NFT，可以置顶 NFT 接收者地址以及 NFT 对应的 tokenId 和 url
    // 由于需要快速通过 tokenId 设置 url，普通的 ERC721 是没有 set 方法的，符合我们要求的在 extension/ERC721URIStorage.sol 合约中它本身也是继承了 ERC721
