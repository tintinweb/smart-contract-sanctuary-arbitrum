...
/**
 * @title GFC is an ERC20-compliant token.
 * - GFC can only be exchanged to xGFC in the GalahadFund contract.
 * - Apart from the initial production, GFC can only be produced by destroying xGFC in the fund contract.
 */
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract GFC is Ownable, AccessControl, ERC20 {
  ...
  constructor() ERC20("Galahad Finance", "GFC") {
