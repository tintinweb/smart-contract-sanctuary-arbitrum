...
contract PairexTradingStorageV5 is Initializable{
    ...
    uint public maxSlP;                             // %
    uint public defaultLeverageUnlocked;            // x
    uint public nftSuccessTimelock;                 // 50 blocks
    ...
    struct OpenLimitOrder{
        ...
        uint pairIndex;
        uint index;
        uint positionSize;          // 1e18 (USDT or PAIREX2)
    ...
    mapping(uint => uint[3]) public openInterestUsdt; // 1e18 [long,short,max]
