 ...
 *  @title Deployer for a gm Fam! contract
 *  @author jistro.eth && Ariutokintumi.eth
 *  @dev This contract is used to deploy a GmFam contract with the ERC1967 Proxy design pattern
 */

import { ERC1967Proxy } from "./Proxy.sol";
...
contract DeployerProxy {
    ...
    constructor(address _owner, address _logicContract) {
        owner = _owner;
    ...
    function deployContract(
        ...
        ERC1967Proxy newContract = new ERC1967Proxy(logicContract);
        GmFam(payable(address(newContract))).initialize(
            _initialOwner,
            _oldContract,
            _nameOfToken,
            _symbolOfToken,
...
contract ERC1967Proxy is Proxy {
     ...
     * but we need to set the fee to make a contract to 0.02 eth
     */
...
contract GmFam is ERC721Upgradeable, OwnableUpgradeable,ERC721RoyaltyUpgradeable, ERC721BurnableUpgradeable {
    ...
    function initialize(
        ...
        __ERC721_init(_nameOfToken, _symbolOfToken);
