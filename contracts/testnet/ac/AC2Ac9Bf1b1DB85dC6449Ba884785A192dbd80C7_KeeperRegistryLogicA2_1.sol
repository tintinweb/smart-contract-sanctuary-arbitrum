...
interface IKeeperRegistryMaster {
  ...
  function setUpkeepAdminOffchainConfig(uint256 upkeepId, bytes memory newAdminOffchainConfig) external;

  function setUpkeepGasLimit(uint256 id, uint32 gasLimit) external;

  function setUpkeepManager(address newUpkeepManager) external;
