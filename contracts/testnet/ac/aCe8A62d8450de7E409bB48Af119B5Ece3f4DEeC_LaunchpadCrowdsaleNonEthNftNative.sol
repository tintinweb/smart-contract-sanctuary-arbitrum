    ...
    ILaunchpadCrowdsaleNonEthNftNative
{
    ...
    constructor(
        ...
        Crowdsale(wallet_, DEAD_ADDRESS, lotsInfo, paymentTokensInfo, true)
    ...
    modifier onlyBy(address account) {
        require(
            msg.sender == account,
            "LaunchpadCrowdsaleNonEthNftNative: sender unauthorized"
        );
        _;
    }
     ...
     */
    function nativeBuyTokens(string calldata nonEthAddress)
        external
        payable
        override
    {
        require(
            ...
            "LaunchpadCrowdsaleNonEthNftNative: empty non ETH address"
        );

        _nativeBuyTokensFor(msg.sender, nonEthAddress);
    }
    ...
    function nativeBuyTokensFor(
        ...
        _nativeBuyTokensFor(beneficiary, nonEthAddress);
    }
        ...
        onlyBy(governanceAccount)
    {
        require(
            account != address(0),
            "LaunchpadCrowdsaleNonEthNftNative: zero account"
        );
        ...
        isWhitelisted(beneficiary)
    {
        ...
        if (
            ...
            revert(
                "LaunchpadCrowdsaleNonEthNftNative: beneficiary cap exceeded"
            );
        }
...
/**
 * @title ILaunchpadCrowdsaleNonEthNftNative
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNonEthNftNative is ICrowdsale {
    function nativeBuyTokens(string calldata nonEthAddress) external payable;
