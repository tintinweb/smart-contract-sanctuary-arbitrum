 ...
 */
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20, IERC20MetadataUpgradeable {
    ...
    ReentrancyGuardUpgradeable 
{
        ...
        override(ERC20Upgradeable)
    {
        ...
        if(isStakingContract[from]) {
            uint256 newAmountSub = staked[to] >= amount ? staked[to] - amount : 0;
