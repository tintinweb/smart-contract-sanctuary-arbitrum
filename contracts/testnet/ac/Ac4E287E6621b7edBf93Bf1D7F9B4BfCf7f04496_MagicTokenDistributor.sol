    ...
    ITokenDistributor
{
    ...
    function setMagicDistributor(address _magicDistibutor) public onlyAdmin {
        require(_magicDistibutor != address(0), "MAGICTOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        magicDistributor = IMasterOfCoin(_magicDistibutor);
    }

    function setMagic(address _magic) public onlyAdmin {
        require(_magic != address(0), "MAGICTOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
