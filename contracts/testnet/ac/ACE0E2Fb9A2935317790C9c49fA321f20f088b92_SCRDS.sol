...
contract SCRDS is OwnableUpgradeable, PausableUpgradeable, ERC20Upgradeable {
    ...
    function exchange(uint amount, uint timestamp, bytes memory signature) external whenNotPaused {
