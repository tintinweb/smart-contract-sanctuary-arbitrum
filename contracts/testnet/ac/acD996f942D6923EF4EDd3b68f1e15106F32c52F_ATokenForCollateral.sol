...
/**
 * @title Natrium ERC20 AToken
 * @dev Implementation of the interest bearing token for the Natrium protocol
 * @author Natrium
 */
  ...
  IAToken
{
  ...
  /**
   * @dev Returns the address of the Natrium treasury, receiving the fees on this aToken
   **/
