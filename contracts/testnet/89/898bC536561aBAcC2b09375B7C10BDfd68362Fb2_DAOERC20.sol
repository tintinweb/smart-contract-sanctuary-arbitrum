...
contract DAOERC20 is IDAOERC20, ERC20, DAOAccessControlled {
    ...
    function decimals() public view override(IDAOERC20, ERC20) returns (uint8) {
        return ERC20.decimals();
    }

    function mint(address account_, uint256 amount_) external onlyOrderDispatcher {
