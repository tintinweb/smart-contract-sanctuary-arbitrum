...
contract RealmLock is ReentrancyGuard, ManagerModifier {
  ...
  // Events
  //=======================================
  event Locked(uint256 realmId, uint256 _hours, uint256 lockedUntil);
    ...
    isRealmOwner(_realmId)
  {
    ...
    require(
      block.timestamp > locked[_realmId],
      "RealmLock: Locked time has not elapsed"
    );
    ...
    emit Locked(_realmId, _hours, locked[_realmId]);
  }
