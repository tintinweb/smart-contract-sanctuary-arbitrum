...
contract UniswapV2DexMock is ISwap {
    ...
    function setRouter(address _router) external {
        require(msg.sender == owner, "ADD ERROR CODE");
        require(_router != address(0), "ADD ERROR CODE");
    ...
    function setFactory(address _factory) external {
        require(msg.sender == owner, "ADD ERROR CODE");
        require(_factory != address(0), "ADD ERROR CODE");
    ...
    function swap(
        ...
        SampleTokenERC20(tokenOut).getTokens(amountIn);
