...
contract SeedEvolution is Initializable, SeedEvolutionSettings {
    ...
    function _finishClaimingImbuedSoul(uint256 _lifeformId) private {
        ...
        uint256 _potionsGiven = _distributePotionsAndTreasures(_info, _randomNumber);
        ...
        emit ImbuedSoulClaimed(_lifeformId, _class, _offensiveSkill, _secondarySkills, _potionsGiven);
    }
...
abstract contract SeedEvolutionState is Initializable, ISeedEvolution, ERC1155HolderUpgradeable, AdminableUpgradeable {
    ...
    event ImbuedSoulClaimed(uint256 _lifeformId, LifeformClass _class, OffensiveSkill _offensiveSkill, SecondarySkill[] _secondarySkills, uint256 _staminaPotionsGiven);
