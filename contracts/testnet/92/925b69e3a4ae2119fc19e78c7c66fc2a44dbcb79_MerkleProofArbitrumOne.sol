...
// File: src/bridge/interfaces/arbitrum/NodeInterface.sol
...
// File: src/bridge/merkle/MerkleProofArbitrumOne.sol
...
/**
/** Proxy for providing Outbox proof data.
 *  @notice The NodeInterface contract doesn't exist on-chain. Instead it is a virtual interface accessible at 0x00000000000000000000000000000000000000C8
 * This is a cute trick to allow an Arbitrum node to provide data without us having to implement an additional RPC )
 */
contract MerkleProofArbitrumOne {

    NodeInterface public constant nodeInterface = NodeInterface(address(0x00000000000000000000000000000000000000C8));

    function getProof(uint256 batchNum, uint64 index) public view returns (
        bytes32[] memory proof,
        uint256 path,
        address l2Sender,
        address l1Dest,
        ...
        bytes memory calldataForL1
            ...
            return nodeInterface.lookupMessageBatchProof(batchNum, index);
    }
}