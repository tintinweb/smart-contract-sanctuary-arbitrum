...
contract CorruptionCryptsDiamondInitializer is CorruptionCryptsDiamondState {
    ...
    function addressToCurrentBoard(
        ...
        uint256 _cell,
        uint256 _row
    ) public view returns (Cell memory) {
        ...
        returns (uint256)
    {
        ...
        uint256 epochsPassed = ICorruptionCryptsInternal(address(this)).currentEpoch() - lastEpochClaimed;
        ...
        returns (MapTile[] memory)
    {
        ...
        MapTile[] memory pendingMapTiles = ICorruptionCryptsInternal(address(this)).generateMapTiles(numToClaim, _user);
