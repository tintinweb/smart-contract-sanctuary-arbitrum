...
/**
 * @title Aimagine Staking Rewards
 * @dev A contract for staking and earning rewards with $AIMG.
 */
contract AimagineStakingRewards is StakingRewards {
    constructor(address _rewardsToken, address _stakingToken, uint256 _rewardsDuration, uint256 _lockPeriod)
        StakingRewards(_rewardsToken, _stakingToken, _rewardsDuration, _lockPeriod)
    {}
}
