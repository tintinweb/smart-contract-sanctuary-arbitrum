...
contract SmartChefPYE is Ownable, ReentrancyGuard, ERC20 {
    ...
    function createAndFundPresaleToken(
        ...
        // deposit the token
        IERC20(_presaleTokenAddress).transferFrom(msg.sender, address(this), _amount);
    ...
    function fundExistingToken(
        ...
        IERC20(presaleTokenList[_index].presaleTokenAddress).transferFrom(msg.sender, address(this), _amount);
        _snapshot();
    ...
    function withdrawExistingToken(uint256 _index) external onlyOwner {
        ...
        // do the transfer
        IERC20(presaleTokenList[_index].presaleTokenAddress).transfer(
            msg.sender, 
    ...
    function claimPresaleToken(uint256 _index) external nonReentrant {
        ...
        // transfer
        IERC20(presaleTokenList[_index].presaleTokenAddress).transfer(msg.sender, entitledTokenReward[msg.sender]);    
    }
