...
uint256 constant DUNGEON_MAP_ID_TRAIT_ID = uint256(keccak256("dungeon.map_id"));
...
import {DUNGEON_END_TIME_TRAIT_ID, DUNGEON_MAP_ID_TRAIT_ID, DUNGEON_START_TIME_TRAIT_ID, IS_DUNGEON_TRIGGER_TRAIT_ID, MANAGER_ROLE, MINTER_ROLE, GAME_LOGIC_CONTRACT_ROLE} from "../Constants.sol";
...
contract DungeonTriggerSystem is GameRegistryConsumerUpgradeable {
    ...
    /**
     * @dev Returns the dungeon map entity for a dungeon trigger.
     * @param dungeonTriggerEntity Entity ID of the dungeon trigger to get.
     * @param tokenTemplateSystem TokenTemplateSystem contract.
     */
    function getDungeonMapEntity(
    ...
    /**
     * @dev Returns the dungeon trigger valid start and end times.
     * @param dungeonTriggerEntity Entity ID of the dungeon trigger to get.
     * @param tokenTemplateSystem TokenTemplateSystem contract.
     * @return startAt is the start time of the dungeon trigger.
     * @return endAt is the end time of the dungeon trigger.
     */
    function getTimeRange(
        uint256 dungeonTriggerEntity,
        ITokenTemplateSystem tokenTemplateSystem
    ) external view returns (uint256 startAt, uint256 endAt) {
        (address tokenContract, uint256 tokenId) = EntityLibrary.entityToToken(
            dungeonTriggerEntity
        );
