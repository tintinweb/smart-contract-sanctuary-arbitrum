...
contract Panda is ERC20, Ownable, ERC20Burnable {
    ...
    uint256 public constant totalAddresses = 300000;
    uint256 public constant totalTokens = 470000000000000;
    uint256 public constant tokenPerAddressMin = 1500000000;
    uint256 public constant tokenPerAddressMax = 1600000000;
    ...
    constructor(
        ...
        uint256 _totalSupply = 500_000_000_000_000 * 10 ** 18;
    ...
    function addWhitelist(address[] memory _whitelist) public {
