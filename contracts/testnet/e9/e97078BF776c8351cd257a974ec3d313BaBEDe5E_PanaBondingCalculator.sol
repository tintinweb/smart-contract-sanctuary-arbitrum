...
contract PanaBondingCalculator is IBondingCalculator {
    ...
    function valuation(address _pair, uint256 amount_) external view override returns (uint256 _value) {
        ...
        _value = totalValue.mul(FixedPoint.fraction(amount_, totalSupply).decode112with16()).mul(100).div(1e16);
    }
...
library FixedPoint {
    ...
    function decode112with16(uq112x112 memory _obj) internal pure returns (uint) {
         return uint(_obj._x) / 519229685853482762;
     }
