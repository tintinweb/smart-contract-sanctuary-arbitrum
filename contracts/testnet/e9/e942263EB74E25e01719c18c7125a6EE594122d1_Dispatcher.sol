...
contract Dispatcher is IDispatcher, Initializable, DAOAccessControlled {
    ...
    */
    ...
    function _mintAvailableCollectibles(address _patron) internal {
        ...
        IExternalCollectionManager.ContractDetails[] memory allLoot8Collections = ICollectionManager(authority.getAuthorities().collectionManager).getAllCollections(CollectionType.PASSPORT, true);
