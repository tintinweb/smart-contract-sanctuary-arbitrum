...
contract BountySystem is IBountySystem, GameRegistryConsumerUpgradeable {
    ...
    function setBountyDefinition(
        ...
        ).setLayoutValue(definition.bountyId, genCheck);
    }
    ...
    function startBounty(
        ...
        _verifyNftInputs(account, entities, activeBountyId, bountyId);
        ...
        if (generationCheckComponent.required) {
            ...
            if (
                traitsProvider.getTraitUint256(
                    ...
                    tokenId,
                    GENERATION_TRAIT_ID
                ) != generationCheckComponent.generation
            ) {
