...
contract AIW is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBackTokenDev = (amountBackToken * devFee) / backTokenTotalFee;
        ...
        emit SwapBack(amountWagmiBurn, amountWagmiLp, amountBackTokenDev, block.timestamp);
    }
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'AIWagmi: ETH_TRANSFER_FAILED');
    }
    ...
    function setBuyFees(
        ...
        devFeeBuy = _devFee;
        burnFeeBuy = _burnFee;
        totalFeeBuy = _liquidityFee + _devFee + _burnFee;
    }
    ...
    function setSellFees(
        ...
        totalFeeSell = _liquidityFee + _devFee + _burnFee;
    }
