...
contract DistributionContract {
    ...
    function tokenFallback(address, uint256, bytes calldata) external {
        require(msg.sender == address(arbotToken), "Only accept ARBOT tokens");
        distributeTokens();
    }
    ...
    function distributeETH() private {
        ...
        for (uint i = 0; i < holdersCount; i++) {
            ...
            uint256 proportion = arbotToken.balanceOf(holder) / totalSupply;
            uint256 amount = value * proportion;
