...
contract GTokenOpenPnlFeed is ChainlinkClient, IOpenTradesPnlFeed {
    ...
    event RequestMedianValueSet(uint indexed currEpoch, uint indexed requestId, int[] requestValues, int medianValue);
    ...
    function makeOpenPnlRequest() private {
        ...
        uint linkFeePerNode = IERC20(chainlinkTokenAddress()).balanceOf(address(this)) /
