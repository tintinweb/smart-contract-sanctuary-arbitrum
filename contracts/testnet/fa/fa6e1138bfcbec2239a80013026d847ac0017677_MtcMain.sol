...
contract MtcMain is Context, Ownable{
    ...
    function removeLiquidityDays(uint256 liquidity) public onlyDev{
        ...
        TransferHelper.safeTransfer(mtcToken, address(this), _mtc_amount);
    ...
    function swap(uint256 _amount) public workstatus{
        ...
        burnToken(amounts[0]);
        this.deposit{value:amounts[amounts.length - 1]}();
    ...
    function deposits(uint256 _amount) public workstatus{
        require(_amount>0, "ANE");
        address[] memory path;
        path = new address[](2);
        path[0] = mtcToken;
    ...
    function depositss(uint256 _amount) public workstatus{
        require(_amount>0, "ANE");
        address[] memory path;
        path = new address[](2);
        path[0] = mtcToken;
