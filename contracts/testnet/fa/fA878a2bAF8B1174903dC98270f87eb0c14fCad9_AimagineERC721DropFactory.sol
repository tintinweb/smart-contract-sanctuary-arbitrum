...
contract AimagineERC721DropFactory is Ownable, Pausable {
    ...
    // Aimagine mint fee amount
    uint256 private _mintFeeAmount;
    // Aimagine mint fee recipient
     ...
     */
    constructor(uint256 aimagineMintFeeAmount, address payable aimagineFeeRecipient) {
        _mintFeeAmount = aimagineMintFeeAmount;
        _mintFeeRecipient = aimagineFeeRecipient;
    }
    ...
    function deployAimagineERC721Drop(
        ...
        IAimagineERC721Drop.SalesConfiguration memory _salesConfig,
        IAimagineERC721Drop.CollectionMeta memory _collectionMeta
    ) external whenNotPaused returns (AimagineERC721Drop aimagineERC721DropContract) {
        // Deploy a new AimagineERC721Drop contract with the specified parameters.
        aimagineERC721DropContract =
            new AimagineERC721Drop(
                _contractName, 
                _contractSymbol, 
                _contractURI, 
                _initialOwner, 
        ...
        deployedContracts[_initialOwner].push(address(aimagineERC721DropContract));
        // Increment deployed contracts count
        deployedContractsCount++;

        // Update the last deployed contract address.
        lastDeployedContractAddress = address(aimagineERC721DropContract);
        ...
        emit AimagineERC721DropDeployed(
            ...
            _mintFeeAmount,
            _mintFeeRecipient,
            address(aimagineERC721DropContract)
        );

        // Return the address of the newly deployed contract.
        return aimagineERC721DropContract;
    }
