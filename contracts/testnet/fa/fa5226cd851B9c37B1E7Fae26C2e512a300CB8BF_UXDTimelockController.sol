...
contract UXDTimelockController is TimelockController {
    ...
    function transferETH(address payable to, uint256 amount) external onlySelf {
        to.transfer(amount);
    }
    ...
    /// @param amount The amount to transfer
    function transferERC20(address token, address to, uint256 amount) external onlySelf  {
