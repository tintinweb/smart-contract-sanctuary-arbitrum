...
contract CCIPProtocolFacet is IAny2EVMMessageReceiver, Events, Setters {
    ...
    */
    function ccipReceive(Client.Any2EVMMessage memory message) external override {
        ...
        require(msg.sender == LibInternalGetters.bytesToAddress(destChainProtocol.endPoint), "Invalid CCIP Router");
        ...
        INexa(contractAddress).nexaReceive(receivePayload.payloadSender, receivePayload.srcChain, receivePayload.payload, hash);
