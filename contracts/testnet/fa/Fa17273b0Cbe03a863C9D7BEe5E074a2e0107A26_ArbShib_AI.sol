...
contract ArbShib_AI is ERC721A, Ownable{
    using Strings for uint256;
    string public baseURI;
    string public hiddenMetadataURI = "";

    uint256 public mintPrice = 0.00099 ether;
    uint256 public maxFreeMint = 10000;
    uint256 public maxSupply = 48000;
    uint256 public maxPerWallet = 3;
    uint256 public teamAllocation = 1000;
    ...
    constructor() ERC721A("ArbShib AI", "ASAI") {}
    ...
    function Mint(uint256 _quantity) external payable mintCompliance(_quantity) {
        require(mintPhase == MintStatus.LIVE, "Mint is not live");
