...
contract LucianSouls is ERC1155LazyMint, PermissionsEnumerable {
    ...
    function openChests(
        ...
        for (uint256 i = 0; i < _chestIds.length; i++) {
            ...
            require(chest.balanceOf(msg.sender, _chestId) >= _amountToOpen, "You don't own enough Chest NFTs");

            emit ChestOpened(_chestId, msg.sender, _amountToOpen, _chestIds, _amountsToOpen);

            //this.openChest(_chestId, _amountToOpen);
        }
    }
