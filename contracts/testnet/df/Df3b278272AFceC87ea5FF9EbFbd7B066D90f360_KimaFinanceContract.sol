...
contract KimaFinanceContract is Ownable, AccessControl {
    // Create a new role identifier for the caller role
    ...
    function callFunction(string memory _param) public {
        // Check that the calling account has the caller role
        require(hasRole(CALLER_ROLE, msg.sender), "Caller is not a caller");
