    ...
    IOFTCoreUpgradeable
{
    ...
    function __OFTCoreUpgradeable_init(address _endpoint)
        internal
        onlyInitializing
    {
    ...
    function __OFTCoreUpgradeable_init_unchained(address _endpoint)
        internal
        onlyInitializing
    {
        __NonblockingLzAppUpgradeable_init_unchained(_endpoint);
    ...
    {
        return
            interfaceId == type(IOFTCoreUpgradeable).interfaceId ||
...
contract FbOFTUpgradeable is OFTUpgradeable {
    function initialize(
        string memory _name,
        string memory _symbol,
        ...
        OFTUpgradeable.__OFTUpgradeable_init(_name, _symbol, _lzEndpoint);
