...
contract Forest is Basic {
    ...
    function buyLand() public payable {
        token.transferFrom(msg.sender, address(this), getNextPrice(msg.sender));
    ...
    function plantTree(uint256 _nftId, uint256 _index) public {
        ...
        emit PlantTree(msg.sender, _nftId, block.timestamp, _index);
    }
    ...
    function sprayTree(uint256 _landIndex) public {
        ...
        emit SprayTree(msg.sender, land.nftId, _landIndex, block.timestamp);
    }
