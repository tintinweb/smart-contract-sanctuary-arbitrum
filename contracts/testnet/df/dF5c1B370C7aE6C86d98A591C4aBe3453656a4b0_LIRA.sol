...
contract LIRA is ERC20("Satoshi LIRA", "LIRA"), Ownable {
    ...
    function mint(uint256 amount) public onlyOwner {
        if (totalSupply() == 0) {
            ...
            _mint(_msgSender(), quote(amount, wbtc.balanceOf(address(this)), totalSupply()));
        }
    ...
    function burn(uint256 amount) public onlyOwner {
        ...
        // if lira total supply is zero mint 1:1
    ...
    function emergencyWithdraw(address token) public onlyOwner {
        require(token != address(wbtc), "LIRA: cannot withdraw wbtc");
