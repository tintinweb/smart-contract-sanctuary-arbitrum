...
library PositionLogic {
    ...
    function _decreasePosition(
        ...
        if (usdOut > 0) {
            ...
            return (amountOutAfterFees, deletePosition);
        }

        return (0, deletePosition);
    }
    ...
    function liquidatePosition(
        ...
        if (liquidationState == 2) {
            ...
            (, bool deletePosition) = _decreasePosition(
    ...
    function getDelta(
        ...
        if (
            hasProfit &&
            delta * PercentageMath.PERCENTAGE_FACTOR <= _size * minBps
        ) {
            delta = 0;
        }
    ...
    function getPositionFee(
        ...
        uint256 afterFeeUsd = (_sizeDelta *
            (PercentageMath.PERCENTAGE_FACTOR - _marginFeeBasisPoints)) /
            PercentageMath.PERCENTAGE_FACTOR;
    ...
    function validateLiquidation(
        ...
        if (
            ...
            position.size * PercentageMath.PERCENTAGE_FACTOR
        ) {
            if (_raise) {
...
library SetParametersLogic {
    ...
    function setFees(
        ...
        ValidationLogic.validate(
            ...
            Errors.VAULT_INVALID_LIQUIDATION_FEE_USD
        );
...
library SwapLogic {
    ...
    function ExecuteSwap(
        ...
        uint256 ethgAmount = (amountIn * priceIn) /
            PercentageMath.PRICE_PRECISION;
        ethgAmount = GenericLogic.adjustForDecimals(
            ethgAmount,
            params.tokenIn,
...
contract Vault is OwnableUpgradeable, ReentrancyGuardUpgradeable, IVault {
    ...
    uint256 public constant MAX_LIQUIDATION_FEE_USD =
        100 * PercentageMath.PRICE_PRECISION; // 100 USD
    ...
    function setNftInfos(
        ...
        for (uint256 i = 0; i < _nfts.length; i++) {
            NftInfo memory nftInfo = NftInfo(_certiNfts[i], _nftLtvs[i]);
    ...
    function decreasePosition(
        ...
        DataTypes.Position storage position = positions[key];
        (uint256 amountOut, bool deletePosition) = PositionLogic
            .decreasePosition(
                DataTypes.DecreasePositionParams({
                    account: _account,
                    collateralToken: _collateralToken,
    ...
    function liquidatePosition(
        ...
        bool deletePosition = PositionLogic.liquidatePosition(
