...
contract VaultUtils is IVaultUtils, Constants, Ownable {
    ...
    event TestValidateTriggerEvent(bytes32 key, OrderStatus orderStatus, uint256 positionType, uint8 isValidate);
    ...
    function validateTrigger(
        ...
        emit TestValidateTriggerEvent("0x", _order.status, _order.positionType, statusFlag);
        return statusFlag;
    }
