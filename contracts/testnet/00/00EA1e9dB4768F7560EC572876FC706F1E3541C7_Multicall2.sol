...
contract Multicall2 {
    ...
    function tryBlockAndAggregate(bool requireSuccess, Call[] memory calls) public payable returns (uint256 blockNumber, bytes32 blockHash, Result[] memory returnData) {
        blockNumber = block.number;
