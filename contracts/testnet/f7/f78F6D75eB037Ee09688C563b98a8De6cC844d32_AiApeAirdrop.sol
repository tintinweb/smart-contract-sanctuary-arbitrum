...
contract AiApeAirdrop is Ownable, ReentrancyGuard {
    ...
    uint256 public totalAirdorps = 21_000_000_000_000_000 * 10 ** investmentTokenDecimals;
    uint256 public totalAirdorpsFromNFT = 186_900_000_000_000_000 * 10 ** investmentTokenDecimals;
    ...
    function getAirdropNumber(
        ...
        if (isQualified() && referrer != address(0) && referrer != msg.sender) {
    ...
    function getAirdropByNft(uint256[] memory tokenIds) external nonReentrant {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) { 
            ...
            if (!exists1[tokenIds[i]] && getNftOwner(tokenIds[i]) == msg.sender) {
