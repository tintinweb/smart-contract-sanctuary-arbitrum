...
contract PachiTokenV2 is ERC20Base {
    constructor(
        string memory _name,
    ...
    // initially set to 0
    address public XPACHI = address(0);

    // metadata image
    // string public constant image = "https//pachi.finance/images/pachi.png";
    ...
    function _canMint() internal view override returns (bool) {
        return msg.sender == owner() || msg.sender == address(XPACHI);
    }
    ...
    function setXachi(address _xPachi) external onlyOwner {
        XPACHI = _xPachi;
    }
}