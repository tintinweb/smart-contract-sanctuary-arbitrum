...
contract Orderbook is ReentrancyGuard{
    ...
    function createAsk(uint256 _USDCPerOPTION, uint256 _OPTIONSize) public returns (Ask) {
        ...
        Ask ask = new Ask(OPTION, USDC, AORISEATSADD, msg.sender, _USDCPerOPTION, fee_, _OPTIONSize);
        asks.push(ask);
    ...
    function createBid(uint256 _OPTIONPerUSDC, uint256 _USDCSize) public returns (Bid) {
        ...
        Bid bid = new Bid(USDC, OPTION, AORISEATSADD, msg.sender, _OPTIONPerUSDC, fee_, _USDCSize);
        bids.push(bid);
        //transfer before storing the results
...
contract Bid {
    ...
    */
    function fill(address receiver, uint256 amountOfOPTION, uint256 seatId) public  {
