...
// File: CrossChain/utils/ExcessivelySafeCall.sol
...
// File: CrossChain/utils/BytesLib.sol
...
// File: CrossChain/interfaces/ILayerZeroReceiver.sol
...
// File: CrossChain/interfaces/ILayerZeroUserApplicationConfig.sol
...
// File: CrossChain/interfaces/ILayerZeroEndpoint.sol
...
// File: CrossChain/NonblockingLzApp.sol
...
// File: CrossChain/CrossChainNFT.sol
...
contract CrossChainNFT is Ownable, ERC721, NonblockingLzApp {
    ...
    function crossChain(string memory _msg, uint16 dstChainId, uint256 tokenId, address _dstAddress) public payable {
        ...
        bytes memory payload = abi.encode(msg.sender, tokenId,_msg);
        uint16 version = 1;
        ...
        _lzSend({
            ...
            _zroPaymentAddress: _dstAddress, 
    ...
    function estimateFees(uint16 dstChainId, uint256 tokenId)
        external
        view
        returns (uint256)
    {
