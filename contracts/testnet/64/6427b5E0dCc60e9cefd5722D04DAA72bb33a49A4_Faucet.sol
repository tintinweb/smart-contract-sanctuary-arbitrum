...
// File contracts/token/Faucet.sol
...
contract Faucet {
    ...
    function claim(address _token) external {
        require(lastClaimed[_token][msg.sender] + claimInterval < block.timestamp, "Faucet: too early");
        lastClaimed[_token][msg.sender] = block.timestamp;
