...
contract SynthesisV2 is EndPoint  {
    ...
    function mint(
        ...
        address from,
        address to
    ) external onlyRouter returns (uint256 amountOut) { // TODO reentr
        // TODO locked 6 decimals - mint????? synthesis must calc correct in\out amount
        uint256 fee = amount * IWhitelist(whitelist).bridgeFee(otoken) / 10000;
    ...
    function burn(
        ...
        _burn(stoken, amount, from, to, chainIdTo);
