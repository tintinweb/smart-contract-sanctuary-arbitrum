...
contract DEGGSPresaleV2 {
    ...
    function getRequestDEGGSAmount() public view returns (uint256 amount) {
        ...
        uint256 presaleDEGGSAmount = (totalAvailable * presalePrice) / 1e18;
        amount = lpDEGGSAmount + presaleDEGGSAmount;
    }
...
// File contracts/fake/FakeToken.sol
...
// File contracts/interfaces/IZyberFactory.sol
...
// File contracts/interfaces/IZyberPair.sol
