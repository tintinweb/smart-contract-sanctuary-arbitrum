...
// File contracts/external/gmx/contracts/libraries/math/SafeMath.sol
...
// File contracts/external/gmx/contracts/libraries/token/IERC20.sol
...
// File contracts/external/gmx/contracts/libraries/utils/Address.sol
...
// File contracts/external/gmx/contracts/libraries/token/SafeERC20.sol
...
// File contracts/external/gmx/contracts/libraries/utils/ReentrancyGuard.sol
...
// File contracts/external/gmx/contracts/tokens/interfaces/IUSDG.sol
...
// File contracts/external/gmx/contracts/core/interfaces/IVaultUtils.sol
...
// File contracts/external/gmx/contracts/core/interfaces/IVault.sol
...
// File contracts/external/gmx/contracts/core/interfaces/IVaultPriceFeed.sol
...
// File contracts/external/gmx/contracts/core/Vault.sol
...
contract Vault is ReentrancyGuard, IVault {
  ...
  function getPositionKey(
    ...
    return
      keccak256(
        abi.encodePacked(_account, _collateralToken, _indexToken, _isLong)
      );
  }
  ...
  function updateCumulativeFundingRate(
    ...
    if (
      lastFundingTimes[_collateralToken].add(fundingInterval) > block.timestamp
    ) {
      return;
    }
  ...
  function getEntryFundingRate(
    ...
    return
      vaultUtils.getEntryFundingRate(_collateralToken, _indexToken, _isLong);
  }
