...
interface IOptionsConfig {
    ...
    event UpdateMinSafeStrikePercent(uint256 minSafeStrikePercent);
    event UpdateMaxSafeStrikePercent(uint256 maxSafeStrikePercent);
    ...
    function minSafeStrikePercent() external view returns (uint256);

    function maxSafeStrikePercent() external view returns (uint256);
}
