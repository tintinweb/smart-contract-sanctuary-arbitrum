    ...
    IStableCoinDecimals
{
    ...
    function hotfixSharetoAssetsPricePrecision() external {
        // check price is between 0.8e6 and 1.2e6 (USDC) or 0.8e18 and 1.2e18 (USDC)
        require(
            shareToAssetsPrice > ((10 ** usdcDecimals()) * 80) / 100 &&
                shareToAssetsPrice < ((10 ** usdcDecimals()) * 120) / 100,
            "price range mismatch"
        );
        shareToAssetsPrice = shareToAssetsPrice * (1e18);
    }
}
