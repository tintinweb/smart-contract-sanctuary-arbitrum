...
contract ARBI_CompoundFund  is UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function supply(uint amount) public nonReentrant() onlyGovernor(){
