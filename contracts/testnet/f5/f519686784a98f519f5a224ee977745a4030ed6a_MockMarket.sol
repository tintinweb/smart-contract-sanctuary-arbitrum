...
contract MockMarket is AccessControlledAndUpgradeable {
  ...
  function pushOraclePricesToUpdateSystemState(int256[] memory newPrices, uint80[] memory indecies) public {
    ...
    // if (indecies[0] != latestExecutedEpochIndex + 1) {
    //   console.log("Index is incorrect");
    //   emit IncorrectLatestExecutedEpochIndex(latestExecutedEpochIndex, indecies[0]);
    //   return;
    // }

    // console.log("Emitting event");
    // emit PriceUpdated(newPrices[0], indecies[0]);
    // console.log("saving price");
    // prices[indecies[0]] = newPrices[0];
    // console.log("saving latest index");
    // latestExecutedEpochIndex = indecies[0];
