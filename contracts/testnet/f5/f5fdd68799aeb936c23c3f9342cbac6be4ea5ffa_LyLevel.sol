...
contract LyLevel is Initializable, OwnableUpgradeable, IERC20 {
    ...
    IERC20 public constant LVL = IERC20(0xc9023E8D5430cE47d100E5221B927189A7F725A6);
    IERC20 public constant PRE_LVL = IERC20(0x6749B64866479Bc08136bC61de1C520D87ffbc30); // address on ARB
    uint256 public constant START_BATCH_USING_PRE_LVL = 1; // arb
    ...
    function addReward(uint256 _rewardAmount) external {
        ...
        IERC20 _rewardToken = _getRewardToken(currentBatchId);
    ...
    function allocate() external {
        ...
        if (currentBatchId < START_BATCH_USING_PRE_LVL) {
    ...
    function setCurrentBatch() external onlyOwner {
        lastEpochTimestamp = lastEpochTimestamp + 1 hours;
    }
}