...
contract Magnetar is Ownable {
    ...
    uint32 internal constant PermitAll = 1;
    uint32 internal constant Permit = 2;
    uint32 internal constant TOFTWrap = 5;
    uint32 internal constant TOFTSendFrom = 6;
    uint32 internal constant YieldBoxDeposit = 7;
    uint32 internal constant SGLAddCollateral = 8;
    uint32 internal constant SGLBorrow = 9;
    uint32 internal constant SGLWithdrawTo = 10;

    struct PermitData {
        address target; //TODO: remove
