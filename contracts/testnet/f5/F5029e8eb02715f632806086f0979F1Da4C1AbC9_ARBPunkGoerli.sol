...
contract ARBPunkGoerli is EIP712WhitelistTyped, ERC721Extended, MintSetup {
        ...
        isFreeMintActive
    {
        ...
        freeMintConfig.freeMintGroupAMinted++;
        ...
        isFreeMintActive
    {
        ...
        freeMintConfig.freeMintGroupBMinted++;
        ...
        isFreeMintActive
    {
        ...
        freeMintConfig.freeMintGroupCMinted++;
...
contract MintSetup is Adminable {
    ...
    constructor () {
        ...
        mintConfig.freeMintStartTime = 1680015600;
        mintConfig.freeMintEndTime = 200000000;
        mintConfig.freeMintPerWallet = 1;

        // Public Mint
        mintConfig.publicMintPrice = 0.00666 ether;
        mintConfig.publicMintStartTime = 1680015600;
        mintConfig.publicMintEndTime = 1679756400;
        mintConfig.publicMintPerWallet = 3;

        // Public Mint by ERC20
        mintConfig.token = 0x912CE59144191C1204E64559FE8253a0e49E6548;
    ...
    function checkGroupAOwner(address _owner) public view returns (bool) {
        ...
        uint256 bal3 = IERC721(0x17DaCAD7975960833f374622fad08b90Ed67D1B5).balanceOf(_owner);
    ...
    function checkGroupBOwner(address _owner) public view returns (bool) {
        ...
        uint256 bal = IERC721(0x17f4BAa9D35Ee54fFbCb2608e20786473c7aa49f).balanceOf(_owner);
        return bal > 0;
    }

    function checkGroupCOwner(address _owner) public view returns (bool) {
        // Group C - Diamond Pepes
        uint256 bal = IERC721(0xede855ceD3e5A59Aaa267aBdDdB0dB21CCFE5072).balanceOf(_owner);
        return bal > 0;
    }
