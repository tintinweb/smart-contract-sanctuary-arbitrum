...
contract ElleriaTreasureFragments is Ownable, ReentrancyGuard {
  ...
  constructor(address _signatureAddr, address _signerAddr, address _masterOfInflationAddr, 
  uint256 _tryCount)
  {
    ...
    ///      In the offchain server- Offchain lootbox balance is first deducted before the signature is generated to prevent stacking.
