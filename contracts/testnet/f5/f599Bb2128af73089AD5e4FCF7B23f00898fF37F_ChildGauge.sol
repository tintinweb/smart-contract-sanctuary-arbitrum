...
//    bool public isKilled;
    ...
    */
    ...
    function decreaseAllowance(address _spender, uint256 _subtractedValue) external returns (bool) {
        ...
        require(currentAllowance >= _subtractedValue, "CG003");
        unchecked {
    ...
    function _claimRewards(address _addr, address _receiver) private {
        if (_receiver != address(0)) {
            require(_addr == msg.sender, "CG011");
    ...
    function addReward(address _rewardToken, address _distributor) external {
        ...
        require(_rewardCount < _MAX_REWARDS, "CG004");
        require(rewardData[_rewardToken].distributor == address(0), "CG005");
    ...
    function setRewardDistributor(address _rewardToken, address _distributor) external {
        ...
        require(msg.sender == currentDistributor || msg.sender == IChildGaugeFactory(factory).owner(), "CG006");
        require(currentDistributor != address(0), "CG007");
        require(_distributor != address(0), "CG008");
        rewardData[_rewardToken].distributor = _distributor;
    ...
    function depositRewardToken(address _rewardToken, uint256 _amount) external payable nonReentrant {
        require(msg.sender == rewardData[_rewardToken].distributor, "CG009");
