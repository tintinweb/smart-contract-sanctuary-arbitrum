...
contract BarnMetadata is Initializable, BarnMetadataState, IBarnMetadata {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        return string(
            ...
            ', "attributes": ',
            _getAttributesForTokenId(_tokenId),
            '}')
        );
    }
    ...
    function _getAttributesForTokenId(uint256 _tokenId) private view returns (string memory) {
        BarnType barnType = tokenIdToBarnType[_tokenId];
        // return string(
    ...
    function getBarnTypeImageUri(BarnType _barnType) external returns (string memory) {
        return barnTypeToImageURI[_barnType];
    }
}
...
abstract contract BarnMetadataState is Initializable, AdminableUpgradeable {
    ...
    function initialize_state() private {
        ...
        weights[0] = 135; //SHAMBHALA_SUPER    | Region weight: 2.5% | Super barn: 5% *
        ...
        //Set BarnType to Image URL mapping
        _setImageURIs();
    }

        //TODO: Call this at initialization
    function _setImageURIs() private {
        //https://thelostdonkeys.mypinata.cloud/ipfs/Qmdry86TXwyi3T4mGa9BHGMDUURG1nRkPLs5hzN5LnxYgk/arid.png

        //https://thelostdonkeys.mypinata.cloud/ipfs/Qmdry86TXwyi3T4mGa9BHGMDUURG1nRkPLs5hzN5LnxYgk/super-arid.gif
        ...
        for(uint8 i = 0; i < weights.length;i++) {
            ...
            barnTypeToImageURI[barnInfo.barnType] =  string(abi.encodePacked(baseURI, '/', getBarnTypeText(barnInfo.barnType), filetype));
        }
    }
