...
contract MockSynthToken is Ownable, ERC20 {
    ...
    constructor(IRewardsDistribution _rewardsDistribution, ISupplySchedule _supplySchedule) ERC20("Synth Token", "SYNTH") {
        rewardsDistribution = _rewardsDistribution;
        supplySchedule = _supplySchedule;
    }

    function setAssociatedContracts(IRewardsDistribution _rewardsDistribution, ISupplySchedule _supplySchedule)
        external
        onlyOwner
    {
