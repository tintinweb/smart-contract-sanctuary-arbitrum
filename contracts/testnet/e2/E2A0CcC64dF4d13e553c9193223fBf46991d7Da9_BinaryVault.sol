    ...
    IBinaryVault
{
    ...
    function executeWithdrawalRequest(
        ...
        // Send money to user
        underlyingToken.safeTransfer(user, redeemAmount);
    ...
    function cancelExpiredWithdrawalRequest(uint256 tokenId) external onlyOwner {
        WithdrawalRequest memory request = withdrawalRequests[tokenId];
        require(block.timestamp > request.timestamp + withdrawalDelayTime * 2, "INVALID");
        _cancelWithdrawalRequest(tokenId);
    }
