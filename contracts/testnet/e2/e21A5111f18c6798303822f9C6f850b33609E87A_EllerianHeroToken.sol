...
contract EllerianHeroToken is Ownable {
    ...
    event MintUsingTokens(address recipient, uint256 summoningId, uint256 variant, uint256 amount);
    ...
    function GetVariantMintCost(uint256 _variant) public view returns (uint256[] memory) {
     ...
     function GetMintingPair(uint256 _variant) public view returns (uint256[] memory) {
        return tokenMintPrice[_variant];
    }
    ...
    */
    ...
    function AttemptMint(uint256 _variant, uint256 _amount) external {
        ...
        require (mintingLimits[summoningId][msg.sender] + _amount < summonMintLimit + 1, "39");
        ...
        emit MintUsingTokens(msg.sender, summoningId, _variant, _amount);
    }
