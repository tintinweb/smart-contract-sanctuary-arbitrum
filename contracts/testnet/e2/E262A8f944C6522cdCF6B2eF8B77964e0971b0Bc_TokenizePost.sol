...
import "./interfaces/ITokenizePost.sol";
    ...
    ITokenizePost
{
    ...
    function publishPost(
        ...
        require(sellPrice != 0, "InitPrice is zero");
    ...
    function buyPost(
        ...
        uint256 tokenDecimals = 10 ** tokenPayToPriceFeed[tokenPay].decimals();
        ...
        if (tokenPay == Type.NATIVE_ADDRESS) {
            ...
            tokenDecimals = Price.PRICE_PRECISION;
        } else {
            require(
