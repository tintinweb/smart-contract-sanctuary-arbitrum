...
contract NeanderSmol is ContractControl, ERC721EnumerableUpgradeable {
    ...
    function mint(bytes32[] calldata _merkleProof) external payable{
        ...
        require(_tokenIdTracker.current() < 5000, "SmolNeander: No mints after 5000");
    ...
    function publicMint(uint256 amount) external payable{
        ...
        require(_tokenIdTracker.current() < 5000, "SmolNeander: No mints after 5000");
        require(publicMinted[msg.sender] + amount <= 30, "SmolNeander: Can only mint up to 30 from public sale");
    ...
    function magicMint(uint256 amount) external {
        require(magic.balanceOf(msg.sender) >= magicPrice * amount, "SmolNeander: Not enough balance");
        require(publicActive, "SmolNeander: Public mint not active");
        require(_tokenIdTracker.current() < 5000, "SmolNeander: No mints after 5000");
        require(magicMinted[msg.sender] + amount <= 30, "SmolNeander: Can only mint up to 30 using magic");
