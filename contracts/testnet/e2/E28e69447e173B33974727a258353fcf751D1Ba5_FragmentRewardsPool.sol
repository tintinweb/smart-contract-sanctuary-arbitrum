...
contract RarityItemFragment is ERC1155, ReentrancyGuard, ManagerModifier {
  //=======================================
  // Constructor
  //=======================================
...
import "../../Item/RarityItemFragment.sol";
import "../../Manager/ManagerModifier.sol";
...
contract FragmentRewardsPool is
  IRewardsPool,
  ReentrancyGuard,
  Pausable,
  ManagerModifier
{
  RarityItemFragment public fragmentContract;
  ...
  constructor(address _manager, address _fragments) ManagerModifier(_manager) {
    fragmentContract = RarityItemFragment(_fragments);
  }
