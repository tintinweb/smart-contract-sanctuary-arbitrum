    ...
    function decreaseLiquidityStake(uint128 liquidityAmount, uint256 amount0Min, uint256 amount1Min) public
        ...
        if (collectAmount0 > 0 || collectAmount1 > 0) {
            ...
            if (collectAmount0 > 0) {
                ...
                } else if (collectAmount0.sub(decreaseLiquidityAmount0) > 0) {
                    IERC20(token0).safeTransfer(recipient, collectAmount0.sub(decreaseLiquidityAmount0));
                } else {
            ...
            if (collectAmount1 > 0) {
                ...
                } else if (collectAmount1.sub(decreaseLiquidityAmount1) > 0) {
                    IERC20(token1).safeTransfer(recipient, collectAmount1.sub(decreaseLiquidityAmount1));
                } else {
