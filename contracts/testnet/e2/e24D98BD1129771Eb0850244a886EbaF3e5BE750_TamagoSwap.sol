...
contract TamagoSwap is Ownable, ERC721Holder, ERC1155Holder {
  ...
  uint64 public _swapsHistoryCounter;
  uint64[] private swapIDs;
  uint64[] public swapHistoryIDs;
  ...
  mapping (uint64 => SwapHistory) public _swapsHistory;
  ...
  */
  ...
  function recordSwapHistory(uint64 swapId) internal {
    uint64 swapsHistoryCounter = _swapsHistoryCounter + 1;
    _swapsHistoryCounter = swapsHistoryCounter;
    swapHistoryIDs.push(swapsHistoryCounter);
    SwapHistory storage swapHistory = _swapsHistory[swapsHistoryCounter];
        swapHistory.initiator = _swaps[swapId].initiator;
        swapHistory.initiatorEtherValue = _swaps[swapId].initiatorEtherValue;
        swapHistory.initiatorErc20Amount = _swaps[swapId].initiatorErc20Amount;
        swapHistory.initiatorNftIds = _swaps[swapId].initiatorNftIds;
        swapHistory.initiatorNftAmounts = _swaps[swapId].initiatorNftAmounts;
        swapHistory.secondUser = _swaps[swapId].secondUser;
        swapHistory.secondUserEtherValue = _swaps[swapId].secondUserEtherValue;
        swapHistory.secondUserErc20Amount = _swaps[swapId].secondUserErc20Amount;
        swapHistory.secondUserNftIds = _swaps[swapId].secondUserNftIds;
        swapHistory.secondUserNftAmounts = _swaps[swapId].secondUserNftAmounts;
  }
