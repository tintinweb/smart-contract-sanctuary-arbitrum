...
contract DebtToken is IDebtToken, ERC4626, Ownable {
  ...
  mapping(address => bool) override public okHolders;

  constructor(
    address underlyingAsset_, 
    string memory name_, 
    string memory symbol_
  ) ERC4626(IERC20(underlyingAsset_)) ERC20(name_, symbol_) Ownable() {}

  // /// @dev for simplicity, upgradeable features and timelock are taken out.
  // function initialize(
  ...
  //   IERC20 token = new ERC20(_name, _symbol);
  //   // timelock = _timelock;
  // }
...
interface IDebtToken {
  ...
  function okHolders(address _okHolders) external view returns (bool);
