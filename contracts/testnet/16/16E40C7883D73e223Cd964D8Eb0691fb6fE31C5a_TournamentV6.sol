...
contract TournamentV6 is ReentrancyGuard, ITournamentV6, Ownable, ERC721Holder {
    ...
    function _cancelTournament(uint256 _gameId) internal {
        ...
        for (uint256 index = 0; index < _gameInfo.nPlayers; index++) {
            ...
            if( useVoucher[_gameId][index] != 0){
                ...
                IERC721(voucher).safeTransferFrom(address(this), _player, _gameInfo.vouchers[_voucherId++]);
            }
            IERC20(_gameInfo.buyInToken).safeTransferFrom( address(this) , _player, _gameInfo.buyInAmount - _discount);
        }
    }
