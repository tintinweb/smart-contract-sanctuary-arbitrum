 ...
 */
contract SlotsArb is CommonArb {
    using SafeERC20 for IERC20;
    ...
    function viewSlotsMultipliers() external view returns (uint16[] memory) {
    ...
    function randomizerCallback(uint256 _id, bytes32 _value) external {
        ...
        address playerAddress = slotsIDs[_id];
        ...
        for (i = 0; i < game.numBets; i++) {
            ...
            slotID[i] = uint16(
                uint256(keccak256(abi.encodePacked(_value, i))) % numOutcomes
            );
