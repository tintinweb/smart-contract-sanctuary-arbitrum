...
contract ThemisRaffleTicket is ERC1155, Ownable, IThemisRaffleTicket {
    ...
    function setPermission(address addr, bool isPermitted) external onlyOwner {
        permissions[addr] = isPermitted;
    }

    function mint(address to, uint256 id, uint256 amount) external {
        require(permissions[msg.sender], "No Permission");
        _mint(to, id, amount, "");
    }
    ...
    function replace(address to, uint256 id, uint256 amount) external {
        require(permissions[msg.sender], "No Permission");
