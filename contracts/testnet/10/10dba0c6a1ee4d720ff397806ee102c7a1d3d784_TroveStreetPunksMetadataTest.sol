...
contract TroveStreetPunksMetadataTest is Ownable {

    using Strings for uint256;
    using ECDSA for bytes32;

    address public constant SIGNER_ADDRESS = 0x5dda0122488782433730C11d722543Eb32F67c99;
...
interface ITroveStreetPunksStaking {

    function breedable(uint256 _tokenId) external view returns (bool);
