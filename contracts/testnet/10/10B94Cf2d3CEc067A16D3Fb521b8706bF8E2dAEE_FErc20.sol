...
contract FErc20 is TokenBase, FErc20Storage, IFErc20 {
    ...
    function delegateRepayBorrow(
        ...
        delegateRepayBorrowInternal(_user, msg.sender, _repayAmount);
    }
    ...
    function doTransferIn(address payable _from, uint256 _amount) internal override {
    ...
    ITokenBase
{
    ...
    function supplyInternal(address _supplier, uint256 _supplyAmount) internal {
         ...
         */
        doTransferIn(payable(_supplier), _supplyAmount);
    ...
    function delegateSupplyInternal(
         ...
         *  an additional `_supplyAmount` of cash.
         */
        doTransferIn(payable(_delegator), _supplyAmount);
    ...
    function delegateRepayBorrowInternal(
        ...
        doTransferIn(payable(_delegator), actualRepayAmount);
    ...
    function repayBorrowInternal(
        ...
        // We fetch the amount the borrower owes, with accumulated interest
        // Same as borrowBalanceCurrent() but with manual {index} param
         ...
         */
        doTransferIn(payable(_payer), actualRepayAmount);
     ...
     */
    function doTransferIn(address payable _from, uint256 _amount) internal virtual;
