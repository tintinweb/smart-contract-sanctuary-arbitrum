	...
	MagicPrinterSettings
{
	...
	*/
    ...
    function increaseDonkeyAllowance()
        public
        nonReentrant
        contractsAreSet
        treasuryIsSet
		...
		returns (uint256 depositId)
	{
        ...
        // twoWeeks = 1 min
        // other = 5 min
        uint256 testLock = _lock == IAtlasMine.Lock.twoWeeks ? testingDuration_1 : testingDuration_5;
		...
		returns (bool withdrawable)
	{
        ...
        UserDeposit memory userDeposit = deposits[_depositId];
        uint256 lockAt = userDeposit.lockAt;
        return (block.timestamp - lockAt) > userDeposit.lock;
	}
	...
	ReentrancyGuardUpgradeable
{
    ...
    uint256 public testingDuration_5; //setting to 5 minutes
    uint256 public testingDuration_1; //setting to 1 minute
	...
	function __MagicPrinterState_init() internal initializer {
		...
		FEE = 500;
        testingDuration_5 = 300;
        testingDuration_1 = 60;
	}
}
...
struct UserDeposit {
	...
	uint256 depositId;
	uint256 amount;
	uint256 lock; // IAtlasMine.Lock lock;
    uint256 lockAt;
}
