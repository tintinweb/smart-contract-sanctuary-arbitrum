...
contract FuturXGatewayStorage is IFuturXGatewayStorage, OwnableUpgradeable {
    ...
    event PendingUpdated(address account, address indexToken, uint256 count, address colaeteral, bytes32 key);
    ...
    function updatePendingCollateral(
        ...
        emit PendingUpdated(param.account, param.indexToken, pendingCollaterals[key].count , pendingCollaterals[key].collateral, key );
        return key;
    }
