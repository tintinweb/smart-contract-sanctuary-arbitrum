...
contract XMY is IERC20, Ownable {
    ...
    uint256 public oneLPNum = 1;
    uint256 public twoLPNum = 1;
    uint256 public threeLPNum = 1;
    uint256 public fourLPNum = 1;
    uint256 public fiveLPNum = 1;
    ...
    constructor() {
        ...
        address ReceiveAddress = address(0x7F3299Fe4a34C3EBED078a3Bfa42e0D7f48A1309);

        _owner = address(0x7F3299Fe4a34C3EBED078a3Bfa42e0D7f48A1309);
