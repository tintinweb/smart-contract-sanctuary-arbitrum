...
// File: contracts/uyux/UxuyToken.sol
 ...
 * @title UxuyToken
 */
contract UxuyToken is ERC20, ERC20Burnable, ERC20Snapshot, Pausable {
    ...
    constructor() ERC20("Uxuy", "Uxuy") {
        superOperators[msg.sender] = true;
    }

    /// @notice Proof Of Link (POL)
    function reward(uint256 amount, address toUser) public isSuperOperator {
    ...
    function burn(uint256 amount) public override isSuperOperator {
        super.burn(amount);
    }
