...
interface IERC721Cloneable is IERC721Upgradeable {
  ...
  function mintMMT(address minter) external;
}
...
contract MetaMarket is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function mintMMT(address nftContract) public nonReentrant {
        IERC721Cloneable(nftContract).mintMMT(msg.sender);
    }
}