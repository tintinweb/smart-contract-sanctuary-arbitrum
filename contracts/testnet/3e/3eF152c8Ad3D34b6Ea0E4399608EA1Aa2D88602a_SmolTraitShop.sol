...
// -------------------------------------------------------------
    ...
    function addTraitsToLimitedOfferGroup(
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            _checkTraitId(id);
            imitedOfferToGroupToIds[_limitedOfferId][_subgroupId].add(id);
        }
    }
    ...
    function removeTraitsFromLimitedOfferGroup(
        ...
        imitedOfferToGroupToIds[_limitedOfferId][_subgroupId].remove(_traitId);
    }
...
// -------------------------------------------------------------
    ...
    mapping (uint256 => mapping (uint256 => EnumerableSetUpgradeable.UintSet))
        internal imitedOfferToGroupToIds;
...
abstract contract SmolTraitShopView is Initializable, SmolTraitShopAdmin {
    ...
    function getAllTieredTraitsPerEvent(
        ...
        subgroup1 = imitedOfferToGroupToIds[_limitedOfferId][1].values();
        subgroup2 = imitedOfferToGroupToIds[_limitedOfferId][2].values();
        subgroup3 = imitedOfferToGroupToIds[_limitedOfferId][3].values();
    }
