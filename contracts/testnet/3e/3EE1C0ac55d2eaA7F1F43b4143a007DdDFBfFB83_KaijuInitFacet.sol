...
contract KaijuInitFacet is UsingDiamondOwner, WithStorage {
    ...
    function init(address spellcasterPayments) external onlyOwner {
        ...
        _constants().usdPriceToPackType[25 * 10**6] = LibToken.PioneerPackType.SINGLE;
        _constants().usdPriceToPackType[60 * 10**6] = LibToken.PioneerPackType.HERO;
        _constants().usdPriceToPackType[100 * 10**6] = LibToken.PioneerPackType.LEGENDARY;
