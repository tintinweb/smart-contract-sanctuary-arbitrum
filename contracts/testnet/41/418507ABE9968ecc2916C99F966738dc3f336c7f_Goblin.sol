 ...
 */
contract Goblin is ERC721A,ERC2981, Ownable,DefaultOperatorFilterer {

    constructor(address payable royaltyReceiver) ERC721A("Goblin", "Goblin") {
        _setDefaultRoyalty(royaltyReceiver, 500);
    }
    bool public sales_locked=false;
    uint8 public MAX_PUBLIC_TX=20;
    uint8 public MAX_ALLOWLIST_MINT=3;
    uint32 public ALLOWLIST_START = 0;
    uint32 public ALLOWLIST_END = 0;
    uint32 public PUBLIC_START = 1682784211;
    uint32 public PUBLIC_END = 1684022400;
    uint64 public ALLOWLIST_MINT_PRICE= 0.0004 ether;//TODO CHANGE THIS LATER
    uint64 public PUBLIC_MINT_PRICE= 0.0005 ether;//TODO CHANGE THIS LATER
