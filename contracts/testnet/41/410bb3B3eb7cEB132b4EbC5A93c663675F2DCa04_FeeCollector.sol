...
import {FeeCollectorBase} from "./FeeCollectorBase.sol";
import {
    IERC20,
    SafeERC20
...
contract FeeCollector is FeeCollectorBase {
    ...
    function bridgeViaLifi(
        ...
        isNative ? LIFI.call{value: _amount}(_data) : LIFI.call(_data);
    }
...
abstract contract FeeCollectorBase is Proxied {
    ...
    modifier senderIsOwnerOrManager() {
        require(
            ...
            "FeeCollectorBase.senderIsOwnerOrManager"
        );
        _;
    }
