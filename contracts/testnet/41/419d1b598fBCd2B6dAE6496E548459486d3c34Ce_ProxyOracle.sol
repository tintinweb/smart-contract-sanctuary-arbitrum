...
contract ProxyOracle is OwnableUpgradeable, IProxyOracle {
    ...
    /**
     * @notice The batch version of {IPrematchCore-changeConditionSettings}.
     * @param  core the address of the Core using for creating conditions
     * @param  data an array of input data structures for changing conditions settings using {IPrematchCore-changeConditionSettings}
     */
