...
/**
 * @title MintBurnBlacklistableERC20
 * @dev Implementation of the MintBurnBlacklistableERC20
 */
contract MintBurnBlacklistable is
    ERC20Capped,
    ERC20Mintable,
    ERC20Burnable,
    Ownable,
    Services
{
    ...
    event Mint_Burn_Blacklistable_TokenCreated(
    ...
    constructor(
        ...
        emit Mint_Burn_Blacklistable_TokenCreated(
            _msgSender(),
            address(this),
            "Mint_Burn_Blacklistable",
            serviceFee
        );
    }
