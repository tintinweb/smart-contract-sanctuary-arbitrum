...
contract PerpetualOracle is AccessControlUpgradeable, IPerpetualOracle {
    ...
    uint256 markPriceEpochCount; // TODO: Make it public and store in mapping with index
    uint256 indexPriceEpochCount; // TODO: Make it public and store in mapping with index
    uint256 public smInterval;
    uint256 public markSmInterval;
    uint256 public initialTimestamp; // TODO: Store in mapping with index
    ...
    function setStateAfterUpdates(uint256 _index, uint256 _initialTimestamp, uint256 _markPriceEpochCount, uint256 _indexPriceEpochCount) external {
        _requireOracleAdmin();
        initialTimestamps[_index] = _initialTimestamp;
        markPriceEpochsCount[_index] = _markPriceEpochCount;
        indexPriceEpochsCount[_index] = _indexPriceEpochCount;
    }
