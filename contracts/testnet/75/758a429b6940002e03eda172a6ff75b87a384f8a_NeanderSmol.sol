...
contract NeanderSmol is ContractControl, ERC721EnumerableUpgradeable {
    ...
    // constructor() ERC721("Neander Smol", "NeanderSmol") {
    // }
    ...
    function mint(bytes32[] calldata _merkleProof) external payable{
        require(mintActive && wlActive, "SmolNeander: WL mint not active");
        ...
        require(msg.value >= amount * wlPrice);
        for(uint256 i=0; i<amount; i++) {
            _mint(msg.sender);
        }
    }
    ...
    function publicMint(uint256 amount) external payable{
        ...
        require(mintActive && !wlActive, "SmolNeander: Public mint not active");
    ...
    function teamMint() external {
        require(mintActive, "SmolNeander: Mint not active");
