...
import "./LivsAccessControl.sol";

contract LivNFTUpgradeable is ERC721Upgradeable, LivsAccessControl {
    /*** EVENTS ***/
    ...
    function getAllDinoes() external view returns(Dino[] memory){
        return dinos;
    }
...
abstract contract LivsAccessControl {
