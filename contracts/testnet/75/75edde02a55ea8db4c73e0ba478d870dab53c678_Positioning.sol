...
library LibFill {
    ...
    function fillRight(
        ...
        console.log("Values: ", makerValue, rightMakeValue);
...
library LibOrder {
    ...
    function calculateRemaining(Order memory order, uint256 fill) internal view returns (uint256 baseValue, uint256 quoteValue) {
        baseValue = order.makeAsset.value - fill;
        console.log("calculateRemaining ", order.makeAsset.value, fill, baseValue);
