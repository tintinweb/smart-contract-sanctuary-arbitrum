...
contract VestingTransfer is Access {
    ...
    constructor(IGEMB _Gemb, IGEMB _vGemb, address _admin) Access(_admin) {
        ...
        categoryDetails[Category.GEMB_LABS] = CategoryDetail(180, 1080);
    ...
    function withdrawTokens() external onlyInvestor initialized {
        ...
        if (
            ...
            IERC20(GEMB).safeTransfer(investor.gembWallet, tokensAvailable / 2);
            IERC20(vGEMB).safeTransfer(
                investor.vGembWallet,
                tokensAvailable / 2
            );
            ...
            if (investor.gembWallet != address(0)) {
                IERC20(GEMB).safeTransfer(investor.gembWallet, tokensAvailable);
