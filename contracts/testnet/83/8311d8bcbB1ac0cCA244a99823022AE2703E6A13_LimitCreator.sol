    ...
    LimitOrdersStorage
{
        ...
        returns (uint256)
    {
        ...
        // Create order.
        (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1) = nftPositionManager.mint(
        ...
        require(amount0 == _params.amountOfToken0 && amount1 == _params.amountOfToken1, "123123123");
        // Save order data.
...
contract LimitOrdersStorage {
    ...
    uint256 public SWAP_FEE_PERCENTAGE;
    uint256 public SWAP_FEE_PERCENTAGE_ACCURACY;
    ...
    event SetNewSwapFeePercentage(
        uint256 _newSwapFeePercentage,
        uint256 _newSwapFeePercentageAccuracy
    );
    // event SetNewFeeCollector(address _newFeeCollector);
