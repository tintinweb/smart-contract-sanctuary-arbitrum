...
contract IngredientsERC11155 is ERC1155, ERC1155Burnable,ReentrancyGuard, Ownable, Pausable {
    ...
    mapping (address => bool) isStakeContract;
    ...
    function mint(address to, uint tokenId, uint amount) public onlyStakeContract  returns(address){
