...
contract MatchOrders is AccessControl {
    ...
    function linkVertexSigner(address externalAccount) internal {
        ...
        LinkSigner memory linkSigner = LinkSigner(contractSubaccount, externalSubaccount, 0);
    ...
    function setLinkerSigner(address externalAccount) external onlyAdmin {
        linkVertexSigner(externalAccount);
    }
