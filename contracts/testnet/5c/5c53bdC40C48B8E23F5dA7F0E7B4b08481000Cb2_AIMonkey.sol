...
// File: sol/interfaces/IMonkeyJackpot.sol


pragma solidity >=0.5.0;

interface IMonkeyJackpot {
    function tradeEvent(address sender, uint256 amount) external;
}
// File: sol/interfaces/IWETH.sol
...
// File: sol/interfaces/IMonkeyBonusPool.sol


pragma solidity >=0.5.0;

interface IMonkeyBonusPool {
...
// File: sol/interfaces/IUniswapV2Router01.sol
...
// File: sol/interfaces/ICamelotRouter.sol
...
// File: sol/interfaces/ICamelotFactory.sol
...
contract AIMonkey is ERC20, Ownable {
    ...
    IMonkeyJackpot public jackpotWallet;
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        return _monkeyTransfer(_msgSender(), to, amount);
    }

    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        address spender = _msgSender();
        _spendAllowance(sender, spender, amount);
        return _monkeyTransfer(sender, recipient, amount);
    }

    function _monkeyTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        if (inSwap) {
            _transfer(sender, recipient, amount);
            return true;
        }
        if (!canAddLiquidityBeforeLaunch[sender]&&!canAddLiquidityBeforeLaunch[recipient]) {
    ...
    function swapBack() internal swapping {
        ...
        IMonkeyBonusPool(bonusWallet).injectRewards(amountBonus);
        ...
        emit SwapBack(amountBurn, amountBackTokenGov1, amountBackTokenGov2, amountLp, amountBackTokenJackpot, amountBonus, amountBackTokenDev, block.timestamp);
    }
    ...
    function setCanAddLiquidityBeforeLaunch(address _address,bool enable) public onlyOwner {
            canAddLiquidityBeforeLaunch[_address] = enable;
    }
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'AIMONGE: ETH_TRANSFER_FAILED');
    }
    ...
    function setFeeReceivers(
        ...
        jackpotWallet = IMonkeyJackpot(_jackpotWallet);
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AIMONGE: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "AIMONGE: index out of bounds");
