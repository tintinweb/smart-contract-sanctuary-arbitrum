...
contract TroveBadges is Initializable, TroveBadgesAdmin {
    ...
    function _beforeTokenTransfer(
        ...
        require(_from != address(0) || _to != address(0), "TroveBadges: from or to need to be non-zero addresses.");
...
abstract contract TroveBadgesAdmin is Initializable, TroveBadgesState {
    function __TroveBadgesAdmin_init() internal onlyInitializing {
...
import "../interfaces/ITroveBadges.sol";
...
abstract contract TroveBadgesState is Initializable, ITroveBadges, ERC1155BaseUpgradeable {
    ...
    function __TroveBadgesState_init() internal onlyInitializing {
