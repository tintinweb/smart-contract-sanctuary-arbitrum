...
contract AoriLens {
    ...
    function tableData(OrderbookFactory orderbookFactory) public view returns (Orderbook[] memory, address[] memory, uint256[] memory, string[] memory, bool[] memory, uint256[] memory, uint256[] memory) {
