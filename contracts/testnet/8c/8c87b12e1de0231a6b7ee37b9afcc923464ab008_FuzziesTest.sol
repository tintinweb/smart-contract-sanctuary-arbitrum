...
contract FuzziesTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping (address => uint256) public splitWeights;
    mapping (address => uint256) public freeMint;
    mapping (address => bool) public whitelist;

    constructor() ERC721A("fuzzies!", "FUZZ") {
        _currentBaseURI = "ipfs://bafybeihnocjqbc6cn7ztkv2resmargpcji65cqewgwa7klnii5xggbks2e/";
