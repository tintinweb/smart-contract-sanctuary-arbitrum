...
contract Leverager {
    ...
    function getAvailableBorrows(address account) external view returns(
    ...
    function withdrawable(address account) public view returns(
        uint256 totalCollateral,
        uint256 totalDebt,
    ...
    function loop(
        ...
        for (uint256 i = 0; i < loopCount; i += 1) {
            amount = amount.mul(borrowRatio).div(BORROW_RATIO_DECIMALS);
