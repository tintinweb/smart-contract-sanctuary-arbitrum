...
contract FairSwapRouter is IPancakeRouter02 {
        ...
        if (reserveA == 0 && reserveB == 0) {
            ...
            if (amountBOptimal <= amountBDesired) {
                require(
                    ...
                    "FairSwapRouter: INSUFFICIENT_B_AMOUNT"
                );
                ...
                require(
                    ...
                    "FairSwapRouter: INSUFFICIENT_A_AMOUNT"
                );
        ...
        returns (uint[] memory amounts)
    {
        ...
        require(
            ...
            "FairSwapRouter: EXCESSIVE_INPUT_AMOUNT"
        );
        TransferHelper.safeTransferFrom(
            path[0],
            msg.sender,
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'67b40289cf77ba2faa17b81c2a94ae2bafda09facebfa4896b1e1174bc2748d2' // init code hash
            ))));
    }
