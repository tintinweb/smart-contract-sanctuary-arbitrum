...
ReentrancyGuard
{
    ...
    ILuckyZoneTreasury internal treasury;
    ...
    uint256 public ticketPrice = 1000 ether; // 1000 LUCKY
    ...
    constructor(
        ...
        ILuckyZoneTreasury _treasury
    ) ERC721("LuckyLucky", "LUCKY") {
        ERC20 = _erc20;
         ...
         */
       generationCounts[CardResult.WIN100000] = 60;
        generationCounts[CardResult.WIN30000] = 40;
        generationCounts[CardResult.WIN24000] = 50;
        generationCounts[CardResult.WIN20000] = 100;
        generationCounts[CardResult.WIN16000] = 120;
        generationCounts[CardResult.WIN14000] = 200;
        generationCounts[CardResult.WIN12000] = 250;
        generationCounts[CardResult.WIN10000] = 2160;
        generationCounts[CardResult.WIN6000] = 2880;
        generationCounts[CardResult.WIN4000] = 5040;
        generationCounts[CardResult.WIN2000] = 10800;

        rewardAmounts[CardResult.WIN100000] = 100000;
        rewardAmounts[CardResult.WIN30000] = 30000;
        rewardAmounts[CardResult.WIN24000] = 24000;
        rewardAmounts[CardResult.WIN20000] = 20000;
        rewardAmounts[CardResult.WIN16000] = 16000;
        rewardAmounts[CardResult.WIN14000] = 14000;
        rewardAmounts[CardResult.WIN12000] = 12000;
        rewardAmounts[CardResult.WIN10000] = 10000;
        rewardAmounts[CardResult.WIN6000] = 6000;
        rewardAmounts[CardResult.WIN4000] = 4000;
        rewardAmounts[CardResult.WIN2000] = 2000;
    ...
    function setTreasury(ILuckyZoneTreasury _treasury) external onlyOwner {
        treasury = _treasury;
    }
