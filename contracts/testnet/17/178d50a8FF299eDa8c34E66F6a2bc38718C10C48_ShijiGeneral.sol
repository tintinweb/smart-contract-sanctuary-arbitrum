...
contract ShijiGeneral is ERC1155, ERC1155URIStorage, IDapp, Ownable {
  ...
  mapping(address => uint256[]) public userToShijiIds;
  ...
  function iReceive(
    ...
    userToShijiIds[toAddress(transferParams.recipient)].push(transferParams.shijiId);
    emit ShijiMinted(transferParams.shijiId, toAddress(transferParams.recipient), block.timestamp);
