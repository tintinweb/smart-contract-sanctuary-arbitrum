...
// FUNCTIONS
    ...
    /// @param tokenID Characters ID
    function endQuest(uint256 tokenID)
        external
        nonReentrant
        onlyIfCharacterAvailable(tokenID)
        onlyQuestExpired(tokenID)
...
// ADMIN FUNCTIONS
    ...
    function createQuest(string calldata name, uint256 itemSet, uint256 questPrice, address paymentAddress, uint256 chanceOfFindingLand, uint256 questDuration, uint256 maxNumberOfQuestsBase, bool active, uint256[5] calldata rarityPercentages)
        external
        onlyOwner
    {
    ...
    /// @param active set the status of the quest
    /// @param rarityPercentages an array of the rarity percentage for item distribution eg [400, 150, 50, 10, 0]
    function updateQuest(uint256 questID, string calldata name, uint256 itemSet, uint256 questPrice, address paymentAddress, uint256 chanceOfFindingLand, uint256 questDuration, uint256 maxNumberOfQuestsBase, bool active, uint256[5] calldata rarityPercentages)
        public
        onlyOwner
    {
        require(rarityPercentages.length == 5,                       "Requires 5 rarity values");
