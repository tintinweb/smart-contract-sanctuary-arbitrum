...
// File: ebb-token/contracts/interfaces/IBinTokenAmount.sol
...
// File: ebb-token/contracts/interfaces/IHodorLuckyDrop.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolEvents.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolOwnerActions.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolActions.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolDerivedState.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolState.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/pool/IUniswapV3PoolImmutables.sol
...
// File: ebb-token/contracts/uni-v3/interfaces/IUniswapV3Pool.sol
...
// File: ebb-token/contracts/uni-v2/interfaces/IUniswapV2Pair.sol
...
// File: ebb-token/contracts/interfaces/IHodorController.sol
...
// File: ebb-token/contracts/solmate/utils/FixedPointMathLib.sol
...
// File: ebb-token/contracts/solmate/tokens/ERC20.sol
...
// File: ebb-token/contracts/solmate/utils/SafeTransferLib.sol
...
// File: ebb-token/contracts/solmate/mixins/ERC4626.sol
...
// File: ebb-token/contracts/UltraHodor.sol
...
contract UltraHodor is ERC4626 {
    ...
    constructor(
        address asset_
    ) ERC4626(ERC20(asset_), "ULTRA HODOR", "uHODOR") {
...
// File: ebb-token/contracts/openzeppelin/utils/introspection/IERC165.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBLegacyToken.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/IPendingOwnable.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBToken.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/IJoeFactory.sol
...
// File: ebb-token/contracts/joe-v2/libraries/math/SafeCast.sol
...
// File: ebb-token/contracts/joe-v2/libraries/math/Uint256x256Math.sol
...
// File: ebb-token/contracts/joe-v2/libraries/math/BitMath.sol
...
// File: ebb-token/contracts/joe-v2/libraries/Constants.sol
...
// File: ebb-token/contracts/joe-v2/libraries/math/Uint128x128Math.sol
...
// File: ebb-token/contracts/joe-v2/libraries/PriceHelper.sol
...
// File: ebb-token/contracts/openzeppelin/utils/Context.sol
...
// File: ebb-token/contracts/openzeppelin/access/Ownable.sol
...
// File: ebb-token/contracts/openzeppelin/token/ERC20/IERC20.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/IWNATIVE.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBLegacyPair.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBLegacyFactory.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBPair.sol
...
// File: ebb-token/contracts/Hodor.sol
...
contract Hodor is ERC20 {
    ...
    IHodorController public immutable controller;
    ...
    uint256 internal constant PRECISION = 1e18;
    uint256 public constant MAX_TOTAL_SUPPLY = 1000_000_000 * 1e18;
    ...
    function mint(address to_, uint256 amount_) external {
        if ((totalSupply + amount_) > MAX_TOTAL_SUPPLY) revert OutOfMint();
    ...
    function _chargeTax(
        ...
        if (!isRebalancing) {
            if (!feeWhitelist[from] && !feeWhitelist[to]) {
                ...
                // Buy tax
                if (_isSwap(from)) {
                    require(!fusing, "HODOR: Fusing now.");
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBFactory.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBLegacyRouter.sol
...
// File: ebb-token/contracts/joe-v2/interfaces/ILBRouter.sol
...
// File: ebb-token/contracts/HodorController.sol
...
contract HodorController is Ownable {
    ...
    IERC20 public immutable weth = IERC20(0xaE4EC9901c3076D0DdBe76A520F9E90a6227aCB7); // WETH

    Hodor public hodor;
    UltraHodor public uHodor;

    // External contract dependencies
    ILBRouter public immutable router = ILBRouter(payable(0x095EEe81B0eC73797424d67e24adab20D5A5D307));
    ILBPair public pair;
    ...
    address public communityAddress; // 0xC4Ab937643851209AaaB253d7Fd9245A4521096a
    uint24 public constant INITIAL_BIN_ID = 8385728; // SET at 0.00000608307667088 eth
    ...
    constructor (
        ...
        uHodor = new UltraHodor(address(hodor));

        hodor.setVault(address(uHodor));
        hodor.setOwner(msg.sender);
