...
contract Passport is Collectible {
    ...
    constructor(
        ...
        string memory _name,
        string memory _symbol
    ) Collectible(_entity, CollectibleType.PASSPORT, _area, _authority, _dataURI, _name, _symbol)  {  
...
contract PassportFactory is IPassportFactory, DAOAccessControlled {
    ...
    mapping(address => address[]) entityPassports;
    ...
    mapping(address => PassportCreationConfig) currentCreationConfig;
