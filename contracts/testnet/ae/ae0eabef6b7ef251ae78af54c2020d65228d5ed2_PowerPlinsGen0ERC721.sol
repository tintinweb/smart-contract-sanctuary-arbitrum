...
contract PowerPlinsGen0ERC721 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint maxWhitelistMintPerUser = 3;
  ...
  function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable nonReentrant{
    ...
    if(whitelistMintEnabled){
      ...
      require(whitelistClaimed[_msgSender()] + _mintAmount > maxWhitelistMintPerUser, 'Insufficient mints left');
      whitelistClaimed[_msgSender()] = whitelistClaimed[_msgSender()] ++;
  ...
  function setMaxMintAmountAllow(uint256 _maxMintAmountPerUser) public onlyOwner {
