...
// input  /Users/fwj/ethereum/summer/contracts/RentFun/RentFun.sol
// flattened :  Sunday, 16-Jul-23 08:33:36 UTC
...
contract RentFun is IRentFun {
    ...
    event Rented(address indexed renter, address indexed collection, uint256 tokenId,
        address indexed payment, uint256 tokenAmount, uint8 timeBase, uint8 timeAmount, uint256 rentalIdx);
    ...
    function rent(RentBid[] calldata rents) external payable override {
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            emit Rented(msg.sender, rentBid.collection, rentBid.tokenId, rentBid.payment, rentBid.tokenAmount, rentBid.timeBase, rentBid.timeAmount, totalRentCount);
        }
    }
