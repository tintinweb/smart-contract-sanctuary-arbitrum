...
import '@thirdweb-dev/contracts/infra/TWStatelessFactory.sol';

contract MinimalDeployer is TWStatelessFactory {
    constructor(address _trustedForwarder) TWStatelessFactory(_trustedForwarder) {}

    function deployProxy(
        address _implementation,
        bytes memory _data,
        bytes32 _salt
    ) public virtual returns (address deployedProxy) {
        deployedProxy = deployProxyByImplementation(_implementation, _data, _salt);
    }
}