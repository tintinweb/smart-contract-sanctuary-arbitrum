...
contract ShellMultiSig {
    ...
    function updateOwners(address[] memory _owners) public {
        require(msg.sender == address(this), "Only contract can update its owners");
        require(_owners.length == owners.length, "Must be same number of owners");
