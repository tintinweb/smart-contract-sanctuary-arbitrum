...
abstract contract CommonSolo is Core {
  ...
  function _computeMultiplier(uint256 _rnd) internal pure returns (uint256 multiplier_) {
    // 0,001 = 1
    // 1 = 1000
    _rnd = _rnd % 1000 + 1;

    // multiplier_ = 0.01 / _rnd;
    return 1e20 / _rnd;
  }
  ...
  function shareEscrow(
    ...
    uint256 wagerWithMultiplier_ = _computeMultiplier(_rnd) * usedWager_ / 1e18;
