...
uint256 constant ID = uint256(
    keccak256("game.piratenation.trustedvalidatorcomponent.v1")
);
...
contract TrustedValidatorComponent is BaseStorageComponentV2 {
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        keys[4] = "has_ssl";
        values[4] = TypesLibrary.SchemaValue.BOOL;
    }
    ...
    function getByteValues(
        ...
        values = new bytes[](5);
        values[0] = abi.encode(s.serverPublicAddress);
        values[1] = abi.encode(s.host);
        values[2] = abi.encode(s.port);
