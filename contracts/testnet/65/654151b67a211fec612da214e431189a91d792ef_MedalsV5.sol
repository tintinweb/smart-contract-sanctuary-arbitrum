...
//import "../.deps/npm/@openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155URIStorageUpgradeable.sol";
//import "../.deps/npm/@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
//, ERC1155BurnableUpgradeable, ERC1155URIStorageUpgradeable

/// @custom:oz-upgrades-from Medals3
contract MedalsV5 is  Medals,  ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable{
    ...
    function initialize(string memory _uri) override initializer  public {
   ...
   // function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function setBaseURI(string memory newuri) internal virtual {
        _setURI(newuri);
    }
...
contract Medals is ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
   //废弃
    ...
    function initialize(string memory _uri) initializer virtual public {
        __ERC1155_init(_uri);
        __Ownable_init();
