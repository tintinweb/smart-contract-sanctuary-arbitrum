...
import "../Support/VRFConsumerBaseV2Upgradeable.sol";
...
contract RaidHandler is  Initializable, UUPSUpgradeable, VRFConsumerBaseV2Upgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        __VRFConsumerBaseV2Upgradeable_init(_vrfCons);
        __Ownable_init();
    }
    ...
    function raidPool(uint256 tokenId, address _raider, uint256 noOfStakers, uint256 localBuds, uint256 globalBuds) external onlyStakingContract returns (uint256 requestId){
        if (tokenId != 0) {
