...
uint256 constant ID = uint256(keccak256("game.piratenation.box3dcomponent"));

/**
 * Stores the dimensions of an entity representing a physical object of some kind.
 */
contract Box3DComponent is Vector3Component {
    /** SETUP **/
