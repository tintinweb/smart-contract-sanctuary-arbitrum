...
// File contracts/NashRewardClaim.sol
// License-Identifier: MIT
    ...
    ERC2771ContextUpgradeable
{
    ...
    bytes32 private constant _CLAIM_TYPEHASH =
        keccak256(
            "Claim(address operator,address to,uint256 rewardTotal,uint256 rewardTime,uint256 nonce,uint256 deadline)"
        );
    ...
    function initialize(
        ...
        __EIP712_init("NashRewardClaim", "1");
    ...
    function claim(
        ...
        require(
            ...
            "NashRewardClaim: deadline expired"
        );

        address to = _msgSender();
        require(
            claimedTotal[to] < rewardTotal,
            "NashRewardClaim: invalid rewardTotal"
        );

        {
            ...
            require(
                signer == operator(0),
                "NashRewardClaim: invalid signature"
            );
        }
        ...
        claims[count].rewardTime = rewardTime;
    ...
    function _splitSignature(
        ...
        require(sig.length == 65, "NashRewardClaim: invalid signature length");
