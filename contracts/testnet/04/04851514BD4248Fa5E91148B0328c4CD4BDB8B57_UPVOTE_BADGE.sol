...
contract UPVOTE_BADGE is ERC721,AccessControl,Pausable {
    ...
    constructor() ERC721("Content Upvote Badge", "UPVOTE_BADGE") {
    ...
    function safeMintView(uint256 tokenId, bytes memory signature)
        public view returns (bool)
    {
        return verifySignature(tokenId.toString(),signature);
    }
