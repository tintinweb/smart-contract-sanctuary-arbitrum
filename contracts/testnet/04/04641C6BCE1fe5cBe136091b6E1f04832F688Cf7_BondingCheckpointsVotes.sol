 ...
 */
contract BondingCheckpointsVotes is Manager, IVotes, IERC20Upgradeable, IERC20MetadataUpgradeable {
    // Indicates that the called function is not supported.
    error Unsupported();
    ...
    /**
     * @notice Delegation through this contract is not supported.
     */
    ...
    function totalSupply() external view returns (uint256) {
        return getPastTotalSupply(clock());
    }
    ...
    /**
     * @notice Transferring not supported through this contract.
     */
    function transfer(address, uint256) external returns (bool) {
        revert MustCallBondingManager("transferBond");
    }

    /**
     * @notice Allowances are not supported for bonds.
     */
