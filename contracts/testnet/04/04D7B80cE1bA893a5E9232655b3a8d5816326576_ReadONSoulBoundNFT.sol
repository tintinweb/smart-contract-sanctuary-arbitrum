...
contract ReadONSoulBoundNFT is Initializable, ERC721Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        _transferable = true;
        __ERC721_init("ReadON Soul Bound", "SBD");
        __Pausable_init();
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://readon-api.xiequan.info/v1/nft/bsc/sbd/";
    }
