...
contract Loot8Collection is ERC721, ERC721Royalty, ILoot8Collection, ILoot8BurnableCollection, NonblockingLzApp {
    ...
    */
    ...
    {
        require(_msgSender() == manager || _msgSender() == subscriptionManager, "UNAUTHORIZED");
    ...
    function burn(uint256 tokenId) external {
        require(
            ...
            (
                (_msgSender() == manager || _msgSender() == subscriptionManager) && 
                !disabled
...
import "../../interfaces/collections/ILoot8TieredPOAPCollection.sol";
...
import "../collections/Loot8TieredCouponCollection.sol";
import "../../interfaces/factories/ITieredCouponCollectionFactory.sol";
