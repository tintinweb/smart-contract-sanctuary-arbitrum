...
import "../Utils/Uniswap/V3/ISwapRouter02.sol";
import "../Utils/Uniswap/V3/libraries/TransferHelper.sol";

contract UniswapAMM is Owned {
    // Uniswap v3
    ISwapRouter02 public constant uniV3Router =
        ISwapRouter02(0xab7664500b19a7a2362Ab26081e6DfB971B6F1B0);
    ...
    function swapExactInput(
        ...
        IV3SwapRouter.ExactInputSingleParams memory swap_params = IV3SwapRouter.ExactInputSingleParams({
            tokenIn: _tokenA,
            tokenOut: _tokenB,
            fee: 3000,
