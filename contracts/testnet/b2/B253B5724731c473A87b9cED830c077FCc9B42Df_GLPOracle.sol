...
contract GLPOracle is Exponential {
    ...
    function getGLPPrice() public view returns (uint256) {
        ...
        uint256 price = glpAUM.div(glpSupply);
    ...
    function getPlutusExchangeRate() public view returns (uint256) {
        ...
        uint256 totalAssets = plvGLPInterface(plvGLP).totalAssets().mul(1e18);
        ...
        uint256 exchangeRate = totalAssets.div(totalSupply);
    ...
    function getPlvGlpPrice() public view returns (uint256) {
        ...
        uint256 price = exchangeRate.mul(glpPrice).div(1e18);
