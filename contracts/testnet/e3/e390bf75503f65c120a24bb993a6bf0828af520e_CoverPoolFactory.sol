    ...
    CoverPoolStructs
{
    ...
    address immutable public twapSource;
    ...
    function syncLatestTick(
        ...
        constants.inputPool  = ITwapSource(twapSource).getPool(constants.token0, constants.token1, params.feeTier);
