...
contract MasterChef is Ownable, ReentrancyGuard {
  ...
  uint256 public constant EMISSION = 330_000 ether;
  ...
  struct PoolInfo {
    ...
    uint256 lastRewardSecond; // Last block number that PLS distribution occurs.
    uint256 accPlsPerShare; // Accumulated PLS per share, times 1e18. See below.
    uint256 lpSupply;
  }

  // PLS tokens emitted per second.
  uint256 public plsPerSecond = EMISSION.div(EPOCH_DURATION);
  ...
  // The block number when PLS mining starts.
