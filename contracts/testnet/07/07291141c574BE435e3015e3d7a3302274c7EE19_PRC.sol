...
contract PRC is IERC20, Auth {
    ...
    constructor() Auth(msg.sender) {
        ...
        WETH = 0x087Ca4449eCC6Db4954ffD3231e217b9deFbd614;
    ...
    function getPair() public onlyOwner {
        pair = IFactory(router.factory()).getPair(
            address(this),
            0xCF14353d125b256fB2b03403A37F7aB9f5311c53
        );
        if (pair == address(0)) {
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(
            amount <= _maxTxSize || isTxLimitExempt[sender],
            "TX Limit Exceeded"
        );
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    // TODO change me USDC
    IERC20 ARB = IERC20(0xCF14353d125b256fB2b03403A37F7aB9f5311c53);
    address WETH;
    IDexRouter router;
