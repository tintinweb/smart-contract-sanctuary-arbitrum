...
contract OptionsConfig is IOptionsConfig, AccessControl {
    ...
    uint256 public override sf;
    uint32 public ivFactorITM = 2e2;
    uint32 public ivFactorOTM = 50;
    uint256 public override strikeStepSize = 500e8;
    ...
    function setSf(uint256 _sf) external checkRole(FEE_UPDATOR) {
        sf = _sf;
        emit UpdateSf(_sf);
    }
