...
contract L2UnicornMinter {
    ...
    constructor(address randomizer_, address randomizer_1, address randomizer2_) {
    ...
    function flip() external {
        uint256 id = randomizer.request(5000000);
    ...
    function randomizerCallback(uint256 id, bytes32 value) external {
        ...
        CoinFlipGameInfo storage game = coinFlipGameInfos[id];
        uint256 seed = uint256(value);
        game.seed = seed;
        emit FlipResult(game.player, id, seed);
    }
