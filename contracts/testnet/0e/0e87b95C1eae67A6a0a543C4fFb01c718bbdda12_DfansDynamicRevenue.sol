...
contract DfansDynamicRevenue is ERC721, ERC721Royalty, ERC721Pausable, Ownable, Initializable, DefaultOperatorFilterer {
    ...
    // address set which need to revenue
    EnumerableSet.AddressSet internal revenueAddressSet;

    function addToSet(address _address) public onlyOwner {
        revenueAddressSet.add(_address);
    }

    function removeFromSet(address _address) public onlyOwner {
        revenueAddressSet.remove(_address);
    }

    function contains(address _address) public view returns (bool) {
        return revenueAddressSet.contains(_address);
    }

    function getAddressNum() public view returns (uint256) {
        return revenueAddressSet.length();
    }
    ...
    function release() public onlyOwner { 
        ...
        uint256 totalCount = getAddressNum();
        require(totalCount != 0, "no revenue address to release");
