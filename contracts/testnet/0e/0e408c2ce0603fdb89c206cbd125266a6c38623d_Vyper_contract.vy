...
math: constant(address) = 0x6F2194E34917F9e8ff0e787A15E39538EF5242BD
token: constant(address) = 0x22c97827415F10b462784Eb68a818A9De9045EC7
views: constant(address) = 0x7e2145b0eeB2A13Cf0b7E682FD3C86F42cC7466F

coins: constant(address[N_COINS]) = [
    0x45d35Ec9B36229F676Ad34BbAACa5a6670bd9684,
    0xC5CBca3b25e8bB05d36D90941E93e68FE6Cd6996,
    0xDa472238ae937a0B3c4fd2166182247a2b20022B,
]
...
def get_dy(i: uint256, j: uint256, dx: uint256) -> uint256:
    ...
    price_scale: uint256[N_COINS-1] = empty(uint256[N_COINS-1])
    for k in range(N_COINS-1):
        price_scale[k] = PRECISION * precisions[k]
    xp: uint256[N_COINS] = empty(uint256[N_COINS])
    xp = self.balances
    xp[i] += dx
    xp[0] *= precisions[0]
