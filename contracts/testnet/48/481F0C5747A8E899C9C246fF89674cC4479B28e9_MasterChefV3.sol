...
contract MasterChefV3 is Ownable {
    ...
    struct UserInfo {
        ...
        uint256 lockEndTime;
        uint256 reward;  // Record user's lock reward.
    }
    ...
    function add(
        ...
        poolInfo.push(
            PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardTime: lastRewardTime, accArbsPerShare: 0,lock:_lock,maxLockDuration:_maxDuration,minLockDuration:_minLockDuration,durationFactor:_durationFactor,boostWeight:_boostWeight,boostAmount:0})
        );
    }
