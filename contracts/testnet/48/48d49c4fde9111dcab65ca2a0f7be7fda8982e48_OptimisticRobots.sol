...
/**
 * @title ERC721Altitude
 * @dev Matt Carter, degendeveloper.eth
 * 30 March 2023
 *
 * This ERC-721 contract implements a level system for tokens.
 * Each token mints at level 0. The contract owner or permitted
 * operators may increase and decrease these levels.
 *
 * Levels will always by >= 0.
 */
contract OptimisticRobots is ERC721November {
 ...
 * 30 March, 2023
 *
 * @dev This contract extends the ERC721A contract built by chiru labs to add
 * additional functionality and management, using a simplified version of the PermitControl
...
contract ERC721November is ERC721A, Managerial {
  ...
  function isApprovedForAll(
    ...
    /// @dev If the proxy registry is set, check it
 ...
 * contract written by Tim Clancy, removing circumstances.
 */
