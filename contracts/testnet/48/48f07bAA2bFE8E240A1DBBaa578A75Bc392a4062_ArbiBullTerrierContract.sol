/**
 *Submitted for verification at Arbiscan on 2022-08-24
*/

//*********************************************************************//
//*********************************************************************//
//
//     ___         __    _ ____        __________               _          
//    /   |  _____/ /_  (_) __ )__  __/ / /_  __/__  __________(_)__  _____
//   / /| | / ___/ __ \/ / __  / / / / / / / / / _ \/ ___/ ___/ / _ \/ ___/
//  / ___ |/ /  / /_/ / / /_/ / /_/ / / / / / /  __/ /  / /  / /  __/ /    
// /_/  |_/_/  /_.___/_/_____/\__,_/_/_/ /_/  \___/_/  /_/  /_/\___/_/     
//                                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xa3088F81e181E1d62d9722CE617a239824A81500];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xa3088F81e181E1d62d9722CE617a239824A81500;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifnlo57d6hfzrpens5cg6nzbidfvj4o5mlwfbmnshqzyqourrgi5m/";
...
// File: contracts/ArbiBullTerrierContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbiBullTerrierContract is RamppERC721A {
    constructor() RamppERC721A("ArbiBullTerrier", "ARBIBLT"){}
}
