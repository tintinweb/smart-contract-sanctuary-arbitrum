...
contract Evm721StarterUSDC is ERC721, Ownable {
    ...
    uint256 public ethPrice = 0.0001 ether;
    uint256 public arbPrice = 1 * 10 ** 6; // 1200 USDC (because usdc is a 6 decimal ERC20 token)
    string public baseUri = "https://bafkreifyb5jetemu2qf2pbid7246kvsumzsqim5z3jabr5zrb3fukh35ki.ipfs.nftstorage.link";

    constructor() payable ERC721("EVM 721 Starter USDC", "USDCXMPL") {
        usdc = IERC20(0x38C644109a3C399EfBD2B429159AE6552e660D2C);
    }
    ...
    // PUBLIC
        ...
        function mintArb(address _to, uint256 _quantity) 
        external  
        isAvailable(_quantity) 
        payable
    {
        require(msg.value == ethPrice * _quantity, "Must send correct amount of ETH");
    ...
    function mint(address _to, uint256 _quantity) 
        external  
    {
        usdc.transferFrom(msg.sender, address(this), arbPrice * _quantity);
    ...
    function setArbPrice(uint256 _newPrice) external onlyOwner {
        arbPrice = _newPrice;
    }
