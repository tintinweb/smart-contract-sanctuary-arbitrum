...
// File: contracts/CrachtestClub.sol
...
contract CrachtestClub is ERC721, ERC721Enumerable, Ownable {
    bool public saleIsActive = false;
    string private _baseURIextended;

    bool public isAllowListActive = false;
    uint256 public constant MAX_SUPPLY = 50;
    uint256 public constant MAX_PUBLIC_MINT = 30;
    uint256 public constant WL_PRICE_PER_TOKEN = 0.005 ether;
    uint256 public constant PRICE_PER_TOKEN = 0 ether;


    mapping(address => uint8) private _allowList;

    constructor() ERC721("Crachtest Club", "CRC") {
    }
