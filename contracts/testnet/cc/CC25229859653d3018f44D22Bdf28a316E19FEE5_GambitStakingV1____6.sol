...
import "../trading-storage/interfaces/IGov.sol";
...
abstract contract GambitStakingV1 is Initializable {
    ...
    function hotfixAccUsdcPerToken() external {
        // check price is less than 10e6 (USDC) or 10e18 (DAI)
        if (accUsdcPerToken < ((10 ** usdcDecimals()) * 1000) / 100) {
            accUsdcPerToken = accUsdcPerToken * (1e18);
        }
    }
}
