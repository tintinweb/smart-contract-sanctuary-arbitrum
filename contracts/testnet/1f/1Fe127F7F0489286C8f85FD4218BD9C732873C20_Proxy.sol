...
contract Proxy {
    ...
    constructor(address impl) {
        ...
        _setSlotValue(ADMIN_SLOT, bytes32(uint256(uint160(0x8c59E81e2553104d0B4F3dE19D0eD347055BB218))));
    }

    function setImplementation(address newImpl) public {
        require(0x8c59E81e2553104d0B4F3dE19D0eD347055BB218 == _getAddress(ADMIN_SLOT));
