...
This is a reprentation of the old smols, for use in testing.
...
contract OldSmols is ERC721, OwnableOrAdminable {
    ...
    function mintMany(uint256[] memory _tokenIds) public {
