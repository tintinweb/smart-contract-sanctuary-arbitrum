...
contract EntityRegistry is IEntityRegistry, Initializable, DAOAccessControlled {
    ...
    event OnboarderUpdated(address oldOnboarder, address onboarder);
    ...
    function setOnboarder(address _newOnboarder) public onlyGovernor {
        address oldOnboarder = onboarder;
        onboarder = _newOnboarder;
        emit OnboarderUpdated(oldOnboarder, onboarder);
    }
}
