    ...
    ETHFee
{
    ...
    event FarmCreated(
        ...
        IHasSupportedAsset.Asset[] supportedAssets,
        uint256 endTime,
        address operator
    );
    ...
    function initialize(
        ...
        __Makeable_init();
        __ProtocolInfo_init(FEE_DENOMINATOR.mul(1).div(100)); // default: 1%
        __ETHFee_init();
    ...
    function createFarm(
        ...
        /* if (_info.fundraisingPeriod < 15 minutes) revert BelowMin(15 minutes, _info.fundraisingPeriod);
        if (_info.fundraisingPeriod > maxFundraisingPeriod) {
            revert AboveMax(maxFundraisingPeriod, _info.fundraisingPeriod);
        } */
        ...
        emit FarmCreated(
            ...
            _info,
            _fees,
            IHasSupportedAsset(address(farmManagement)).getSupportedAssets(),
            farm.endTime(),
            _operator
        );
