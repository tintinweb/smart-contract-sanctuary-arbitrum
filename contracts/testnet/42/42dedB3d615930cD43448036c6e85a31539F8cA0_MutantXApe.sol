...
contract MutantXApe is ERC721A, Ownable {
	...
	bytes32 public root = 0xd7accc35b74a02ec0819f20b9c03aa865a5871c261e76bf99cab8dd10b63f389;

	string public _contractBaseURI = "ipfs://xxxx/zzzz/";
	string public _unrevealedURI = "ipfs/xxxxxxxxxxxxxx";
	string public _contractURI = "ipfs://xxxxxxxxxxxxxx";

	uint256 public maxSupply = 10000;
	uint256 public preSaleSupply = 7000;
	...
	uint256 private whitelistStartTime = block.timestamp; //TODO: update to latest

	mapping(address => uint256) public usedAddresses; //for whitelist

	address private devActionsWallet;
	address private ownerWallet = 0x189D370Db009646038fA75C5C3a284215BD311Dc;
	...
	function presaleBuy(
		...
		require(usedAddresses[msg.sender] + qty <= 2, "max 2 per wallet");
	...
	//change the whitelist start time
	function setWhitelistStartTime(uint256 newStartTime) external onlyDev {
		whitelistStartTime = newStartTime;
	}
