...
contract PEXTradingCallbacksV1 is Initializable {
    ...
    function registerTrade(
        ...
        v.referralSaveFee = referralStorage.distributeReferralAndSaveFee(trade.trader, v.levPosUsdt, v.reward2);
    ...
    function unregisterTrade(
        ...
        if(trade.positionSizeUsdt > 0){
            ...
            v.referralSaveFee = referralStorage.distributeReferralAndSaveFee(trade.trader, v.levPosUsdt, fees.closingFee);
            storageT.transferUsdt(address(storageT), storageT.gov(), v.reward2 - v.referralSaveFee);
