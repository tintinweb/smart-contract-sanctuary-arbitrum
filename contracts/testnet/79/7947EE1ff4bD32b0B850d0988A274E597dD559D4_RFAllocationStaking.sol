...
contract RFAllocationStaking is IRFAllocationStaking, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    /**
        ...
        @param _withUpdate Update or not to update pools.
     */
    function set(uint256 _pid, uint256 _allocPoint, uint256 _minStakingPeriod, bool _withUpdate) override virtual public onlyAdmin onlyValidPoolID(_pid) {
     ...
     */
    function fund(uint256 _amount) override virtual public {
     ...
     */
    function deposit(uint256 _pid, uint256 _amount) override virtual public onlyValidPoolID(_pid) whenNotPaused {
        // massUpdatePools();
