...
abstract contract ChainlinkClient {
  ...
  address private constant LINK_TOKEN_POINTER = 0x01157439f6133Dd36e48603ec1f2087A345e62aC;
...
abstract contract TWAPPriceGetter {
    ...
    constructor(
        ...
        isMmtToken0InLp = uniV3Pool.token0() == _token;

        //thangtestcmt
        //isMmtToken0InLp = true;
    }
    ...
    function _updateUniV3Pool(IUniswapV3Pool _uniV3Pool) internal {
        ...
        uniV3Pool = _uniV3Pool;
        isMmtToken0InLp = uniV3Pool.token0() == token;
