...
contract VaultUtils is IVaultUtils, BasePositionConstants, Constants, Ownable {
    ...
    function _validateRemoveCollateral(
        ...
        _validateLiquidation(true, _indexPrice, _position);
    }
    ...
    function _reduceCollateral(
        ...
        //Scope to avoid stack too deep error
        {
            ...
            fee = _calculateMarginFee(_sizeDelta, _position);
    ...
    function calculatePNL(
        ...
        uint totalFee = _calculateMarginFee(position.size, position) + position.openedFee;
        pnl -= int256(totalFee);
