 ...
 * @notice This contract handles minting gegge tokens.
 */
contract Gegge is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeid5uwgu5eavhriuzbn5rtwcpquoukxwt5q3w4nkf2u6nrpfd6u6p4/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 850;
    uint256 public publicMintsAllowedPerAddress = 850;
    uint256 public publicMintsAllowedPerTransaction = 850;
