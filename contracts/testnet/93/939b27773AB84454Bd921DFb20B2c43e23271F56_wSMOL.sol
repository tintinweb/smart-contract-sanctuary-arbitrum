...
contract wSMOL is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    function wrap(uint _tokenid) external {
        SMOLBRAINS.safeTransferFrom(msg.sender, address(this), _tokenid);   // test this - should revert if caller isnt owner
    ...
    function unwrap(uint _tokenid) external {
        defaultEpisode[_tokenid] = 0;
        safeTransferFrom(msg.sender, address(this), _tokenid);              // test this - should revert if caller isnt owner
        _burn(_tokenid);
