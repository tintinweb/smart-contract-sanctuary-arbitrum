...
library StakingLib {
    ...
    function updateMinStakeAmount(stakingVar storage self, uint _minStakeAmount) internal {
        requireGov(self);
        self.minNewRewardAmount = _minStakeAmount;
    }
...
contract RewardRouter is Initializable {
    ...
    function initialize(
        ...
        pexStakingVar.minNewRewardAmount = 10 ** 6;
        pexStakingVar.minStakeAmount = 1 * 1e18;
        ...
        esPEXStakingVar.minNewRewardAmount = 10 ** 6;
        esPEXStakingVar.minStakeAmount = 1 * 1e18;
