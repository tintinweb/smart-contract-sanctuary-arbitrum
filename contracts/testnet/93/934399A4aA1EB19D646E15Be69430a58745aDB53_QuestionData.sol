...
contract QuestionData is Ownable
{
    ...
    constructor()
    {
        grantRole(msg.sender, "moderator");
    }

    modifier onlyRole(string memory role)
    {
        require(keccak256(abi.encodePacked(Roles[msg.sender])) == keccak256(abi.encodePacked(role)), "Access deined");
        _;
    }
    ...
    function CreateQuestion(
        ...
        uint256 answerResult) public onlyRole("moderator")
    {
    ...
    function GetQuestion(uint256 indexQuestion) public onlyRole("Viewer") view returns(
        string memory question,
        ...
        uint256 answerResult)
        {
            question = ListQuestionsContract[indexQuestion].Question;
            answer0 = ListQuestionsContract[indexQuestion].Answer0;
            answer1 = ListQuestionsContract[indexQuestion].Answer1;
            answer2 = ListQuestionsContract[indexQuestion].Answer2;
            answer3 = ListQuestionsContract[indexQuestion].Answer3;
            answerResult = ListQuestionsContract[indexQuestion].AnswerResult;
        }
}
