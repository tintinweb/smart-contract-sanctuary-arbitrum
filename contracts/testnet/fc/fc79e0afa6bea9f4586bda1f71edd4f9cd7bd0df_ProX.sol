...
contract ProX is ERC721A, VRFConsumerBaseV2, ReentrancyGuard, Ownable {
    ...
    bytes32 keyHash =
        0x83d1b6e3388bed3d76426974512bb0d270e9542a765cd667242ea26c0cc0b730; //todo
    string private _baseTokenURI;

    VRFCoordinatorV2Interface COORDINATOR;

    uint256 private constant _collectionSize = 100;
    uint256 public constant amountForFreeMint = 29;
    uint256 public constant amountForSale = 70;
    uint256 public constant amountForTeam = 10;
    ...
    constructor(
        ...
        ERC721A("ProX", "ProX")
        VRFConsumerBaseV2(0x6D80646bEAdd07cE68cab36c27c626790bBcf17f) //todo
    {
        startTime = _startTime;
        COORDINATOR = VRFCoordinatorV2Interface(
            0x6D80646bEAdd07cE68cab36c27c626790bBcf17f //todo
        );
    ...
    function mint(
        ...
        require(
            buyNum[msg.sender] + quantity <= maxPerAddressDuringMint,
    ...
    function lotteryOpen() public nonReentrant {
        require(
            lotteryBlock != 0 && block.number >= lotteryBlock,
            "wait for block"
        );
        require(!isAlreadyPrize, "AlreadyPrize");
        uint256 randomNum = _requestRandomWords();
        lotteryTokenID = randomNum % _collectionSize;
        isAlreadyPrize = true;
