...
interface ISettingsManager {
    ...
    function getBorrowRate (uint256 _tokenId) external view returns (uint256);
...
contract Reader is Constants, Initializable {
    ...
    function validateMaxOILimit(address _account, bool _isLong, uint256 _size, uint256 _tokenId) external view returns (uint8) {
