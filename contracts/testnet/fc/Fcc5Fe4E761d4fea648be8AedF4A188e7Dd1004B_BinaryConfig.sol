...
contract BinaryConfig is Ownable, IBinaryConfig {
    ...
    function setBinaryVaultImageTemplate(string memory _newValue) external onlyOwner {
        binaryVaultImageTemplate = _newValue;
    }

    function setTokenLogo(address _token, string memory _logo) external onlyOwner {
