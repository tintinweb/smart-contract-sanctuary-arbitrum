...
// File: contracts/OmniChainNFT-LayerZero.sol



// pragma solidity ^0.8.7;

contract OmniChainNFTLayerZero is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 3885;
    uint256 MAX_MINT_ETHEREUM = 4222;
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        payload1 = abi.encode(msg.sender, tokenId);
