    ...
    MulticallUpgradeable
{
    ...
    event Deposit_(address indexed sender, address indexed owner, uint256 assets, uint256 tax, uint256 shares);
    ...
    function initialize(address GRT_, address theGraphStaking_, address owner_, address operator_) public initializer {
        ...
        __ERC20_init("stGRT", "stGRT");
        __ERC20Permit_init("stGRT");
    ...
    function _deposit(address caller, address receiver, uint256 assets, uint256 shares) internal override {
        ...
        emit Deposit_(caller, receiver, assets_, tax, shares);
    }
        ...
        override
    {
        ...
        _burn(owner, shares);
        $.withdrawDebt = $.withdrawDebt + assets;
    ...
    function updateRewardAllIndexer() public {
        ...
        $.stakedGRT += totalReward / E27_PRECISION_BASE;
    }
