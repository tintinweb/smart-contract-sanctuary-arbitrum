...
contract BridgePortal is ReentrancyGuard, Governable {
    ...
    event SendTokenEvent(address receiver, uint256 amount);
    ...
    function sendToken(address payable _receiver, uint256 _outAmount) external onlyGov nonReentrant {
        ...
        emit SendTokenEvent(_receiver, _outAmount);
    }
