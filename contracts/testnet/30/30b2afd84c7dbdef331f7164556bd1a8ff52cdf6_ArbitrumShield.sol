...
contract ArbitrumShield is ERC721, SismoConnect {
    ...
    bytes16 private constant COINBASE_HOLDER_GROUP_ID =
    ...
    function verifySismoConnectResponse(bytes memory response) public {
        SismoConnectVerifiedResult memory result = verify({
            ...
            claim: buildClaim({
                groupId: COINBASE_HOLDER_GROUP_ID,
    ...
    function getCoinbaseHolderGroupId() public pure returns (bytes16) {
        return COINBASE_HOLDER_GROUP_ID;
    }
}
