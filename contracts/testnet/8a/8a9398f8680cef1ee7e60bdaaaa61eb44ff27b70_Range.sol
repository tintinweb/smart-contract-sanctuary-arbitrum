...
contract Range is Common {
    ...
    uint256 public constant RTP = 85000000000; // 85% return to player
    ...
    function Dice_Play(
        ...
        if (!(multiplier >= 10625 && multiplier <= 9900000)) {
            revert('Range : Invalid multiplier, must be between 10625 and 9900000');
        }
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal {
        ...
        uint256 winChance = RTP / game.multiplier;
    ...
    function _kellyWager(uint256 wager, address tokenAddress, uint256 multiplier) internal view {
        ...
        if (wager > maxWager) {
            revert('Range : wager too high for current bankroll');
        }
    }
}
