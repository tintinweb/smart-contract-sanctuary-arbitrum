...
contract LIRA is ERC20("Satoshi LIRA", "LIRA"), Ownable {
    ...
    function mint(uint256 amount) public onlyOwner {
        if (totalSupply() == 0) {
            ...
            _mint(_msgSender(), quote(amount, totalSupply(), wbtc.balanceOf(address(this)).mul(10**8)));
        }
    ...
    function burn(uint256 amount) public onlyOwner {
        ...
        wbtc.safeTransferFrom(address(this), _msgSender(), quote(amount, wbtc.balanceOf(address(this)).mul(10**8), totalSupply()));
    }
    ...
    function quote(uint amountA, uint reserveA, uint reserveB) public pure returns (uint amountB) {
        ...
        require (amountB > 1, "LIRA: INSUFFICIENT_AMOUNT");

        amountB = SafeMath.div(amountA.mul(reserveB), reserveA, "LIRA: DIVISION_ERROR");
    }
