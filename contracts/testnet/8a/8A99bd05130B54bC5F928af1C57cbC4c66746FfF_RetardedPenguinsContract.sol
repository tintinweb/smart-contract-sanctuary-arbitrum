...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x0d1556049481E29Bc9bB4E284534a93a4AdF1644];
  address public erc20Payable = 0x0d1556049481E29Bc9bB4E284534a93a4AdF1644;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 69) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibfgzcszmvsthploto46ievd5rddvm2jbbkeghh575kjpaj7q6qpq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/R2fCH0ukEjiZKu8rySNM/contract-metadata";
  }
...
// File: contracts/RetardedPenguinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RetardedPenguinsContract is ERC721APlus {
    constructor() ERC721APlus("Retarded Penguins", "rtrdpngn"){}
}
  /*******************************************************/
  /*                                                     */
