...
import '../masterofcoin/IMasterOfCoin.sol';
...
contract AtlasMine is Initializable, AccessControlEnumerableUpgradeable, ERC1155HolderUpgradeable {
    ...
    bool public isDepositingDisabled;
    ...
    function deposit(uint256 _amount, Lock _lock) public virtual updateRewards {
        require(!isDepositingDisabled, "Depositing is enabled.");
    ...
    function toggleIsDepositingDisabled() external onlyRole(ATLAS_MINE_ADMIN_ROLE) {
