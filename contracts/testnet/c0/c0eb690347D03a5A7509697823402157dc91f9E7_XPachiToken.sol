 ...
 */
contract XPachiToken is
    Ownable,
    ReentrancyGuard,
    ERC20("Pachi escrowed token", "xPACHI"),
    IXPachiToken
{
    ...
    uint256 public minRedeemDuration = 1 minutes; // 7 days //
    uint256 public maxRedeemDuration = 3 minutes; // 3 months //
