...
contract Quest is Ownable
{
    ...
    function DoQuestOnDay(address user) public
    {
        ...
        uint256 from1 = 0;
        uint256 to1 = TotalQuestionContract/TotalQuestionOnDay;

        uint256 from2 = to1+1;
        uint256 to2 = from2 + TotalQuestionContract/TotalQuestionOnDay;

        uint256 from3 = to2+1;
        uint256 to3 = TotalQuestionContract - 1;
