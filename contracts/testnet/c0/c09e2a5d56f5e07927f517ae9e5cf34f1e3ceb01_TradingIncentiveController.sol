...
contract TradingIncentiveController is Initializable, OwnableUpgradeable, ITradingIncentiveController {
    ...
    function resetInit() external onlyOwner {
        LVL = IERC20(0xc9023E8D5430cE47d100E5221B927189A7F725A6);
        PRE_LVL = IERC20(0x6749B64866479Bc08136bC61de1C520D87ffbc30);
        MIN_EPOCH_DURATION = 1 hours;
        MAX_REWARD_TOKENS = 15_000e18;
        STEP_REVENUE = 50_000e30;
        BASE_REVENUE = 100_000e30;
        STEP_REWARD = 10_000e30;
        AMOUNT_LOYALTY_REWARD = 5_000e18;
        START_EPOCH_USING_PRE_LVL = 1;
    }
}