...
import {ERC721ContractURI} from "../../lib/erc721-extensions/src/ERC721ContractURI.sol";
...
import {ERC721ContractURI} from "../../../lib/erc721-extensions/src/ERC721ContractURI.sol";
import {ERC721MirroredL2} from "../../../lib/erc721-extensions/src/L2/ERC721MirroredL2.sol";
...
contract GameNFTV2 is IERC165, ERC721, IGameNFTV2, ERC721MirroredL2, ERC721ContractURI, TraitsConsumer {
    ...
    function _beforeTokenTransfer(
        ...
        uint256 firstTokenId,
        uint256 batchSize
    ) internal virtual override(ERC721, ERC721MirroredL2) {
    ...
    function _checkRole(bytes32 role, address account) virtual internal view override(GameRegistryConsumer, ERC721MirroredL2) {
        GameRegistryConsumer._checkRole(role, account);
    }

    function getLastTransfer(uint256 tokenId) external view override returns (uint32) {
 ...
 */
interface IGameNFTV2 is IERC721 {
    /**
     * @param account Account to check hold time of
     * @param tokenId Id of the token
     * @return The time in seconds a given account has held a token
    ...
    function getLastTransfer(uint256 tokenId)
        external
        view
        returns (uint32);
}
