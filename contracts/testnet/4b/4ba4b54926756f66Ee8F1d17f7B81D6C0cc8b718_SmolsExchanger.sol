...
contract SmolsExchanger is OwnableOrAdminable, SmolsAddressRegistryConsumer {
    ...
    function onChainMySmolsPlease(
        ...
        for(uint256 i =0;i<_smolIds.length;i++){
            ...
            bytes32[] memory _thisProof = _proofs[i];

            address oldSmolsAddress = smolsAddressRegistry.getAddress(SmolAddressEnum.OLDSMOLSADDRESS);
            ...
            //Set the smol data
            ISmolsState(smolsStateAddress).setInitialSmol(_smolId, Smol(
                _thisSmol.background,
                _thisSmol.body,
                _thisSmol.clothes,
                _thisSmol.mouth,
    ...
    function setMerkleRoot(bytes32 _merkleRoot) external onlyOwnerOrAdmin {
