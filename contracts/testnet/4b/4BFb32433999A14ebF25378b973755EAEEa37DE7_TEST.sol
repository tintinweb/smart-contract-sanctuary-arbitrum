/**
 *Submitted for verification at Arbiscan on 2022-04-24
*/
...
contract TEST is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 9068;
    uint256 MAX_MINT_ARBITRUM = 9128;
    ...
    //This is here for illustrative purposes -- teaching a friend. You may ignore the onlyOwner isOwner on the functions.
    modifier isOwner(){
        require(_owner == msg.sender);
        _;
    }

    function setSaleIsActive(bool saleIsActive) external onlyOwner isOwner {
      _saleIsActive = saleIsActive;
    }

    function getFeatures(uint256 _tokenId) public view returns(uint256 , uint256 , uint256[4] memory, uint256[4] memory) {
        return (features[_tokenId].data1, features[_tokenId].data2, features[_tokenId].colors, features[_tokenId].colorSelectors);
    }

    function mint() external payable {
        require(nextTokenId < MAX_MINT_ARBITRUM, "SUPPLY LIMIT REACHED!");
    ...
    function kustomize(uint256 _data1, uint256 _data2, uint256[4] memory _colors, uint256[4] memory _colorSelectors, uint256 _itemID) public {
        ...
        require((_colorSelectors[0] < 138) && (_colorSelectors[1] < 138) && (_colorSelectors[2] < 138) && (_colorSelectors[3] < 138), "NO SUCH COLOR!");
    ...
    function getSVG(uint256 _tokenId) public view returns (string memory) {
        ...
        string memory imageURI = string(abi.encodePacked('<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1600.000000pt" height="800.000000pt" viewBox="0 0 1600.000000 800.000000" preserveAspectRatio="xMidYMid meet" xmlns:xlink="http://www.w3.org/1999/xlink">  <defs> <polygon points="24.8,22 37.3,29.2 37.3,43.7 24.8,50.9 12.3,43.7 12.3,29.2" id="hex" transform="scale(1.8,1.8)" /> </defs><g transform="translate(0.000000,800.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M0 4000 l0 -4000 8000 0 8000 0 0 4000 0 4000 -8000 0 -8000 0 0 -4000z" fill="', svgBackgroundColor[svgBackgroundColorSelector[_tokenId]], '</g>', CREATE(artData, colorData, colorData2, feature.colorSelectors), finality[_tokenId] == false ? '<g transform="translate(0.000000,800.000000) scale(0.100000,-0.100000)" fill="#F5F5F5" stroke="none"> <path d="M14720 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z M15440 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z"/></g></svg>' : '<g transform="translate(0.000000,800.000000) scale(0.100000,-0.100000)" fill="#F5F5F5" stroke="none"> <path d="M14720 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z m200 -20 l0 -110 110 0 110 0 0 -90 0 -90 -110 0 -110 0 0 -220 0 -220 -90 0 -90 0 0 220 0 220 -110 0 -110 0 0 90 0 90 110 0 110 0 0 110 0 110 90 0 90 0 0 -110z M14760 850 l0 -110 -110 0 -110 0 0 -70 0 -70 110 0 110 0 0 -220 0 -220 70 0 70 0 0 220 0 220 110 0 110 0 0 70 0 70 -110 0 -110 0 0 110 0 110 -70 0 -70 0 0 -110z m120 -20 l0 -110 110 0 110 0 0 -50 0 -50 -110 0 -110 0 0 -220 0 -220 -50 0 -50 0 0 220 0 220 -110 0 -110 0 0 50 0 50 110 0 110 0 0 110 0 110 50 0 50 0 0 -110z M14800 810 l0 -110 -110 0 -110 0 0 -30 0 -30 110 0 110 0 0 -220 0 -220 30 0 30 0 0 220 0 220 110 0 110 0 0 30 0 30 -110 0 -110 0 0 110 0 110 -30 0 -30 0 0 -110z m40 -20 l0 -110 110 0 c67 0 110 -4 110 -10 0 -6 -43 -10 -110 -10 l-110 0 0 -220 c0 -140 -4 -220 -10 -220 -6 0 -10 80 -10 220 l0 220 -110 0 c-67 0 -110 4 -110 10 0 6 43 10 110 10 l110 0 0 110 c0 67 4 110 10 110 6 0 10 -43 10 -110z M15440 890 l0 -110 -110 0 -110 0 0 -110 0 -110 110 0 110 0 0 -220 0 -220 110 0 110 0 0 220 0 220 110 0 110 0 0 110 0 110 -110 0 -110 0 0 110 0 110 -110 0 -110 0 0 -110z m200 -20 l0 -110 110 0 110 0 0 -90 0 -90 -110 0 -110 0 0 -220 0 -220 -90 0 -90 0 0 220 0 220 -110 0 -110 0 0 90 0 90 110 0 110 0 0 110 0 110 90 0 90 0 0 -110z M15480 850 l0 -110 -110 0 -110 0 0 -70 0 -70 110 0 110 0 0 -220 0 -220 70 0 70 0 0 220 0 220 110 0 110 0 0 70 0 70 -110 0 -110 0 0 110 0 110 -70 0 -70 0 0 -110z m120 -20 l0 -110 110 0 110 0 0 -50 0 -50 -110 0 -110 0 0 -220 0 -220 -50 0 -50 0 0 220 0 220 -110 0 -110 0 0 50 0 50 110 0 110 0 0 110 0 110 50 0 50 0 0 -110z M15520 810 l0 -110 -110 0 -110 0 0 -30 0 -30 110 0 110 0 0 -220 0 -220 30 0 30 0 0 220 0 220 110 0 110 0 0 30 0 30 -110 0 -110 0 0 110 0 110 -30 0 -30 0 0 -110z m40 -20 l0 -110 110 0 c67 0 110 -4 110 -10 0 -6 -43 -10 -110 -10 l-110 0 0 -220 c0 -140 -4 -220 -10 -220 -6 0 -10 80 -10 220 l0 220 -110 0 c-67 0 -110 4 -110 10 0 6 43 10 110 10 l110 0 0 110 c0 67 4 110 10 110 6 0 10 -43 10 -110z"/></g></svg>'));
    ...
    function CREATE(bytes memory artData, bytes memory colorData, bytes memory colorData2, uint256[4] memory colors) internal view returns (string memory) {
        bytes memory knoxs = DynamicBuffer.allocate(2**16);
        for (uint i = 0; i < 512; i+=8) {
            ...
            for (uint256 ii=0; ii < 8; ii++) {
                if ((workingByte >> (7 - ii)) & 1 == 1) {
                        knoxs.appendSafe(abi.encodePacked('<use xlink:href="#hex" x="',y%2==1 ? toString((x*46) + (ii*46) + 31) : toString((x*46) + (ii*46) + 23 + 31) ,'" y="',
                            toString((y*40)+34),'" fill="',svgBackgroundColor[colors[0]]));
                } else {
                    if ((colorByte >> (7 - ii)) & 1 == 1) {
                        knoxs.appendSafe(abi.encodePacked('<use xlink:href="#hex" x="',y%2==1 ? toString((x*46) + (ii*46) + 31) : toString((x*46) + (ii*46) + 23 + 31),'" y="',
                            toString((y*40)+34),'" fill="',svgBackgroundColor[colors[1]]));
                    } else {
                        if ((colorByte2 >> (7 - ii)) & 1 == 1) {
                            knoxs.appendSafe(abi.encodePacked('<use xlink:href="#hex" x="',y%2==1 ? toString((x*46) + (ii*46) + 31) : toString((x*46) + (ii*46) + 23 + 31),'" y="',
                                toString((y*40)+34),'" fill="',svgBackgroundColor[colors[2]]));
                        } else {
                            knoxs.appendSafe(abi.encodePacked('<use xlink:href="#hex" x="',y%2==1 ? toString((x*46) + (ii*46) + 31) : toString((x*46) + (ii*46) + 23 + 31),'" y="',
                                toString((y*40)+34),'" fill="',svgBackgroundColor[colors[3]]));
                        }
                    }
                }
            }
