...
import { ComposeCorePermissions } from "./ComposeCorePermissions.sol";
import { ComposeCoreStorage } from "./ComposeCoreStorage.sol";
import { IComposeCore } from "./IComposeCore.sol";

/// @notice ComposeCore maintains global parameters, instances of protocol
/// contracts, and access control across the Rift protocol
/// @author Recursive Research Inc
contract ComposeCore is IComposeCore, ComposeCorePermissions, ComposeCoreStorage {
    ...
    /// @notice Sets up the Composecore with the initial access roles, and sets
    ...
    function initialize(
        ...
        __ComposeCore_init(_protocolFee, _feeTo, _wrappedNative, governor, guardian, pauser, strategist);
    }

    function __ComposeCore_init(
        uint256 _protocolFee,
        address _feeTo,
        address _wrappedNative,
        address governor,
        ...
        __ComposeCorePermissions_init(governor, guardian, pauser, strategist);
        __ComposeCore_init_unchained(_protocolFee, _feeTo, _wrappedNative);
    }

    function __ComposeCore_init_unchained(
        uint256 _protocolFee,
        address _feeTo,
        address _wrappedNative
    ) internal onlyInitializing {
...
import { IAccessControlUpgradeable, AccessControlUpgradeable } from "@openzeppelin/contracts-upgradeable/access/AccessControlUpgradeable.sol";
import { IComposeCorePermissions } from "./IComposeCorePermissions.sol";

/// @title Access control module for ComposeCore
/// @author Recursive Research Inc
abstract contract ComposeCorePermissions is IComposeCorePermissions, AccessControlUpgradeable {
    ...
    /// @param pauser initial pauser
    /// @param strategist initial strategist
    function __ComposeCorePermissions_init(
        address governor,
        address guardian,
        address pauser,
        address strategist
        ...
        __ComposeCorePermissions_init_unchained(governor, guardian, pauser, strategist);
    }

    function __ComposeCorePermissions_init_unchained(
        address governor,
        address guardian,
        address pauser,
        address strategist
...
/// @notice Storage for ComposeCore
/// @author Recursive Research Inc
abstract contract ComposeCoreStorage is IComposeCore {
    bool public override paused;

    /// @notice The initial fee to be taken from the use of the Rift protocol out of Composecore.MAX_FEE()
