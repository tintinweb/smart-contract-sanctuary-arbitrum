...
abstract contract StorageERC1155ArmoryAdapter is SingleERC1155ArmoryAdapter {
  constructor(
    address _manager,
    address _actionPermit,
    address _collectionAddress,
  ...
  function _transfer(address from, address to, uint256 _ids, uint256 _amounts) internal virtual {}
  ...
  function _doStake(address _staker, uint256 _id, uint256 _amount) internal override {
    _transfer(_staker, address(this), _id, _amount);
  }
  ...
  function _doStakeBatch(
    ...
    _transferBatch(_staker, address(this), _ids, _amounts);
  }
  ...
  function _doUnstake(address _staker, uint256 _id, uint256 _amount) internal override {
    _transfer(address(this), _staker, _id, _amount);
  }
  ...
  function _doUnstakeBatch(
    ...
    _transferBatch(address(this), _staker, _ids, _amounts);
  }
...
import "./StorageERC1155ArmoryAdapter.sol";
import "../ERC1155/IRealmBaseERC1155Token.sol";

abstract contract StorageRealmBaseERC1155TokenAdapter is StorageERC1155ArmoryAdapter {
  ...
  function _transfer(address from, address to, uint256 _ids, uint256 _amounts) internal override {
    TOKEN.safeTransferFrom(from, to, _ids, _amounts, "");
  }
  ...
  function _transferBatch(
    ...
    TOKEN.safeBatchTransferFrom(from, to, _ids, _amounts, "");
  }
...
import "../Armory/StorageRealmBaseERC1155TokenAdapter.sol";
import "../Action/Actions.sol";

contract LabAdapter is StorageRealmBaseERC1155TokenAdapter {
  constructor(
    address _manager,
    address _actionPermit,
    address _collectionAddress,
    ...
    StorageRealmBaseERC1155TokenAdapter(
      _manager,
      _actionPermit,
      _collectionAddress,
      ACTION_ARMORY_STAKE_LAB,
      ACTION_ARMORY_UNSTAKE_LAB,
      true,
      _breakHandler
    )
  {}
