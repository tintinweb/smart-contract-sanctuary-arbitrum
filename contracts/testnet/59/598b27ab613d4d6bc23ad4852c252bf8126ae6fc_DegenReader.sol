...
contract DegenReader is IDegenReader {
  ...
  IDegenBase public immutable degenBase;
  ...
  constructor(address _degenMain, address _targetToken) {
    ...
    degenBase = IDegenBase(_degenMain);
  ...
  function calculateInterestPosition(
    ...
    interestAccrued_ = degenMain.calculateInterestPosition(_positionKey, _timestampAt);
  }
  ...
  function netPnlOfPositionWithInterest(
    ...
    pnlWithInterest_ = _netPnlOfPosition(_positionKey, _assetPrice, _timestampAt);
  }
  ...
  function netPnlOfPositionWithInterestUpdateData(
    ...
    pnlWithInterest_ = _netPnlOfPosition(_positionKey, assetPrice_, _timestampAt);
  }
  ...
  function getFundingRate(bool _long) external view returns (uint256 fundingRate_) {
    fundingRate_ = degenBase.getFundingRate(_long);
  }
  ...
  function _netPnlOfPosition(
    ...
    uint256 _assetPrice,
    uint256 _timestampAt
  ) internal view returns (int256 pnl_) {
    pnl_ = degenMain.netPnlOfPositionWithInterest(_positionKey, _assetPrice, _timestampAt);
  }
