...
contract LzNameRegistry is Ownable, ReentrancyGuard, IERC2981, ILzNameRegistry, ONFT721 {
    ...
    bytes32 constant ROOT = 0xd1b0d8d72a344815839b8ed3b62f7743913962fe82524d2e9c59674353a8fa3f;
    ...
    constructor(address _treasury, uint256 _fee, uint256 _minGasToTransfer, address _lzEndpoint) 
            ONFT721("LzNameRegistry", "ZID", _minGasToTransfer, _lzEndpoint) {
        treasury = _treasury;
        fee = _fee;

        _safeMint(msg.sender, uint256(ROOT));
        records[ROOT].expiry = type(uint64).max;
    } 
