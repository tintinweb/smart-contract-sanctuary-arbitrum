...
contract MintableERC20 is ERC20, Ownable2Step {
    // access control with multiple admin addresses
    ...
    modifier onlyHandler() {
        require(handlers[msg.sender], "Caller is not a handler");
        _;
    }
...
// Photon ERC20 Token
// prototype for testing layerzero proxy contract bridging

contract Photon is MintableERC20 {
    constructor(
        address _gov,
        address[] memory _admins
    )
