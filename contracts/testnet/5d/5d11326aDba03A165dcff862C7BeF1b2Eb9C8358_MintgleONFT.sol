...
// File @openzeppelin/contracts/utils/cryptography/[email protected]4.8.0
...
contract MintgleONFT is ReentrancyGuard, EIP712, IERC2981, ONFT721, IMintgleONFT {
    ...
    function setRemoteAddress(uint16 _remoteChainId, bytes calldata _remoteAddress) external onlyOwner {
        trustedRemoteLookup[_remoteChainId] = abi.encodePacked(_remoteAddress, address(this));
        emit SetTrustedRemoteAddress(_remoteChainId, _remoteAddress);
    }
