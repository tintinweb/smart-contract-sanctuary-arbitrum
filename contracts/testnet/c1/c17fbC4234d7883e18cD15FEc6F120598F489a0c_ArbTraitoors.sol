...
import {ERC721AQueryableMetadata} from "./tokens/ERC721/extensions/ERC721AQueryableMetadata.sol";
import {Paid} from "./access/Paid.sol";
import {ReentrancyGuard} from "./utils/ReentrancyGuard.sol";
import {TwoStepOwnable} from "./access/TwoStepOwnable.sol";
import {IERC721AEnumerable} from "./interfaces/IERC721AEnumerable.sol";

contract ArbTraitoors is 
    ERC721AQueryableMetadata, 
    ReentrancyGuard,
    Paid 
{
    ...
    constructor(
        ...
        ERC721AQueryableMetadata(name_, symbol_)
    {        
 ...
 */
abstract contract ERC721AQueryableMetadata is 
    ERC721A, 
    TwoStepOwnable,
    ISeaDropTokenContractMetadata
{
