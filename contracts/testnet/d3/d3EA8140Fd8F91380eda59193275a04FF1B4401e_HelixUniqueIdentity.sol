...
contract HelixUniqueIdentity is ERC1155PresetPauserUpgradeable, IHelixUniqueIdentity {
  ...
  uint256 public constant ID_TYPE_0 = 0; // KYC completed
  uint256 public constant ID_TYPE_1 = 1; // KYC completed + accredited individual
  ...
  uint256 public constant DEFAULT_MINT_COST_PER_TOKEN = 830000 gwei;
  ...
  uint256 public mintCostPerToken = DEFAULT_MINT_COST_PER_TOKEN;
