...
@dev This is a guard for the Uniswap V3 vault. It allows vault owners to submit the following transactions:
...
contract VaultGuard is TokenAuthorizer, IERC165, BaseGuard {
    ...
    constructor(address _uniswapV3PositionManager, address[] memory _authorizedTokens)
