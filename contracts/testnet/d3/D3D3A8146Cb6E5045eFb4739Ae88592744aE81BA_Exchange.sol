...
abstract contract ILever {
    ...
    function mintAllowed(address cToken, address minter, uint mintAmount) virtual external view returns (uint);
    function mintVerify(address cToken, address minter, uint mintAmount, uint mintTokens) virtual external;

    function redeemAllowed(address cToken, address redeemer, uint redeemTokens) virtual external view returns (uint);
    ...
    function seizeAllowed(
        ...
        address liquidator,
        address borrower,
        uint seizeTokens) virtual external view returns (uint);
    function seizeVerify(
        address cTokenCollateral,
        address cTokenBorrowed,
        address liquidator,
    ...
    function transferAllowed(address cToken, address src, address dst, uint transferTokens) virtual external view returns (uint);
