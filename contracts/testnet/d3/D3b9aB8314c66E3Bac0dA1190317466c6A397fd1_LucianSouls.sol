...
contract LucianSouls is ERC1155LazyMint, PermissionsEnumerable {
    ...
    function _transferTokensOnClaim(
        ...
        if (_tokenId == 0) {
            ...
            ids[0] = 0;
            ids[1] = 1;
            amounts[0] = _quantity * 5;
            amounts[1] = _quantity * 25;
            ...
            if (_tokenId == 1) {
                v = 3;
                amounts[0] = 10 * _quantity; //soul
            } else if (_tokenId == 2) {
                v = 6;
                amounts[0] = 25 * _quantity; //soul
                amounts[5] = 4 * _quantity; //orb
            } else if (_tokenId == 3) {
                v = 12;
                amounts[0] = 100 * _quantity; //soul
                amounts[5] = 8 * _quantity; //orb
            }
            amounts[2] = v * 3 * _quantity; //horn
            amounts[3] = v * _quantity; //scale
            amounts[4] = v * _quantity; //tear
