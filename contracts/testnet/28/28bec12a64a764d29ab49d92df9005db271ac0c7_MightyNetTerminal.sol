...
import "../extensions/interfaces/IMightyNetERC1155Assets.sol";
import "../extensions/interfaces/IMightyNetERC721Assets.sol";
	...
	AccessControlUpgradeable
{
	...
	function receiveFromGameRequestERC721(
		address contractAddress,
		address tokenOwner,
	...
	function receiveFromGameRequestERC1155(
		address contractAddress,
		address tokenOwner,
		uint256[] memory tokenIds,
		...
		isRegisteredContract(contractAddress, ERC721_CONTRACT_TYPE)
	{
		...
		emit ReceiveERC721(contractAddress, tokenOwner, tokenIds);
	}
		...
		isRegisteredContract(contractAddress, ERC1155_CONTRACT_TYPE)
	{
		...
		emit ReceiveERC1155(contractAddress, tokenOwner, tokenIds, quantities);
	}
