...
contract Leverager {
    ...
    /**
     * @dev Get available borrow info of an account
     * @param account address of the user
     * @return totalCollateral the total collateral of the user
     * @return availableBorrows the borrowing power left of the user
     * @return priceETH price of eth
     * @return available
     * @return _ltv the loan to value of the user
     * @return hf the current health factor of the user
     **/
     ...
     * @param asset The address of the underlying asset of the reserve
     * @return aToken address of the asset
     **/
    ...
    /**
     * @dev Returns withrawable amount of the user
     * @param account address of the user
     * @return totalCollateral the total collateral of the user
     * @return totalDebt the total debt of the user
     * @return currentLiquidationThreshold the liquidation threshold of the user
     * @return hf the current health factor of the user
     * @return surplusedHF of the user
     * @return limitCollateral of the user
     * @return withdrawableCollateral withdrawable collateral of the user
     **/
