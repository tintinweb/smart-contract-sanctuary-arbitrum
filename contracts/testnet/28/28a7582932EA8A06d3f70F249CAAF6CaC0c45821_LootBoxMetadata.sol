...
contract LootBoxMetadata is IItemMetadata, ManagerModifier {
  ...
  ILootBoxCharacteristicDefinitions characteristicDefinitions;
  ILootBoxDataStorage lootBoxData;
  ...
  function _attributeValues(
    ...
    values[count] = string.concat(values[LOOTBOX_CHARACTERISTIC_TYPE], " LootBox");
  ...
  function name(uint256 _tokenId) external view returns (string memory) {
    ...
    return string.concat(characteristicDefinitions.types(lootBoxType), " LootBox");
  }
