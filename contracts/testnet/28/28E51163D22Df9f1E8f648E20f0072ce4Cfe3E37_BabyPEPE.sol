...
contract BabyPEPE is ERC20, Ownable {
    ...
    function claim(address referral) external {
        ...
        if (referral != address(0) && referral != msg.sender) {
            ...
            if (referrer == address(0)) {
                _referral[msg.sender] = referral;
                referrer = referral;
            }
            _mint(referrer, amountToClaim / 10); // give 10% to the referrer
        }
    ...
    function claimWithFee(address referral) external payable {
