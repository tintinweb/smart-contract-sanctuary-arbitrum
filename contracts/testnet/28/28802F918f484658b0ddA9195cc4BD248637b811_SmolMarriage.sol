...
contract SmolMarriage is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, ISmolMarriage {
    ...
    function requestMarriage(
        ...
        require(
            !areCreaturesEqual(creature1,creature2),
            "SMOLMARRIAGE:CANNOT_MARRY_YOURSELF"
        );
        require(
            ring1 != ring2,
            "SMOLMARRIAGE:CANNOT_USE_THE_SAME_RING"
        );
...
interface ISmolMarriage {
    event Married(ICreatureOwnerResolverRegistry.Creature creature1, ICreatureOwnerResolverRegistry.Creature creature2, uint256 ring1, uint256 ring2, uint256 timestamp);
    event Divorced(
