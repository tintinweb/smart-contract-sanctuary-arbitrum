...
abstract contract ContrastPairBase is IContrastPair, Ownable, Clone, ERC1155Supply {
    /// -----------------------------------------------------------------------
    /// Dependencies
    /// -----------------------------------------------------------------------
    ...
    function withdrawFees(address to) external onlyOwner returns (uint256 amountOut) {
