...
import "./interfaces/ILaunchpadCrowdsaleNftNativeNoWhitelist.sol";

/**
 * @title LaunchpadCrowdsaleNftNativeNoWhitelist
 * @author Enjinstarter
 * @dev Launchpad crowdsale where there is no delivery of tokens in each purchase.
 */
contract LaunchpadCrowdsaleNftNativeNoWhitelist is
    NoDeliveryCrowdsale,
    CappedTokenSoldCrowdsaleHelper,
    IndividuallyCappedCrowdsaleHelper,
    TimedCrowdsaleHelper,
    Pausable,
    ILaunchpadCrowdsaleNftNativeNoWhitelist
{
    ...
    modifier onlyBy(address account) {
        require(
            msg.sender == account,
            "LaunchpadCrowdsaleNftNativeNoWhitelist: sender unauthorized"
        );
        _;
    }
        ...
        onlyBy(governanceAccount)
    {
        require(
            account != address(0),
            "LaunchpadCrowdsaleNftNativeNoWhitelist: zero account"
        );
        ...
        tokenCapNotExceeded(tokensSold, tokenAmount)
    {
        ...
        if (
            ...
            revert(
                "LaunchpadCrowdsaleNftNativeNoWhitelist: beneficiary cap exceeded"
            );
        }
...
/**
 * @title ILaunchpadCrowdsaleNftNativeNoWhitelist
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNftNativeNoWhitelist is ICrowdsale {
