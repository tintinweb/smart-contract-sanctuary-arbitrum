...
contract ComplexRewarder is IRewarder, Ownable, ReentrancyGuard {
    ...
    function createChild(IERC20Ext _rewardToken, uint256 _rewardPerSecond) external onlyOwner {
    ...
    function popChildren(uint256 amount) external onlyOwner {
    ...
    function onReward(
        ...
        uint256,
        uint256 _amt
    ) external override onlyMCV2 nonReentrant {
        ...
        uint256 len = childrenRewarders.length;
    ...
    function pendingTokens(
        ...
        rewardAmounts = new uint256[](len + 1);
