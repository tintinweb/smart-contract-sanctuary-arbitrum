...
contract BoardManager is Ownable, IBoardManager {
    ...
    uint256 public minBB = 10;
    uint256 public minPlayer = 2;
    ...
    function setMinPlayer(uint256 minPlayer_) public onlyOwner {
        require(minPlayer_ > 0, "invalid players");
        minPlayer = minPlayer_;
    }
    ...
    function createBoard(
        ...
        require(
            numPlayers >= minPlayer && bigBlindSize >= minBB,
