...
contract LucianSouls is ERC1155LazyMint, PermissionsEnumerable {
    ...
    function verifyClaim(
        ...
        if(_tokenId <= 5){
            ...
            //Gem
            require(this.balanceOf(_claimer, 0) >= _quantity * 50, "You don't own enough Soul NFTs");
        }else{
            //Monster
            ...
            if (_tokenId <= 9) {
                require(this.balanceOf(_claimer, 6) >= _quantity, _gemCaution);
            }else if (_tokenId <= 12) {
            ...
            require(this.balanceOf(_claimer, 0) >= _quantity * _multiplier, "You don't own enough Soul NFTs");
