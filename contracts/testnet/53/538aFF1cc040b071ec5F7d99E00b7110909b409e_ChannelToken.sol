...
interface IReceiverToken {
  function receiverChannelInitialMint(address to, uint tokenId, uint amount) external;
 }
...
contract ChannelToken is ERC1155, Ownable {
  ...
  /* ========== EVENTS ========== */
  event ChannelMint(address indexed to, uint tokenId, string name, string desc, bool gated, uint chainId, bool _isErc1155, uint _minHolding, address gated_contract, bool reply_allowed, uint timestamp);
  ...
  function channelMint(string memory _name, string memory _desc, bool _gated, uint _chainId, bool _isErc1155, uint _minHolding, address _gated_contract, bool _reply_allowed) external {
    ...
    receiverContract.receiverChannelInitialMint(msg.sender, _tokenId, 1);

    // administrative stuff
    tokens[_tokenId] = Token(1, _name, _desc, _gated, _chainId, _isErc1155, _minHolding, _gated_contract, _reply_allowed, msg.sender);

    emit ChannelMint(msg.sender, _tokenId, _name, _desc, _gated, _chainId, _isErc1155, _minHolding, _gated_contract, _reply_allowed, block.timestamp);
  }
