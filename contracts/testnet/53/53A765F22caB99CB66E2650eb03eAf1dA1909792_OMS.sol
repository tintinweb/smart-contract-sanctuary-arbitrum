...
contract OMS is OFTV2 {
    constructor(address _layerZeroEndpoint, bool _isBase) OFTV2("Omnisea", "OMS", 8, _layerZeroEndpoint) {
        _mint(_msgSender(), _isBase ? (1000000000 * 10 ** decimals()) : 0);
    }
}
