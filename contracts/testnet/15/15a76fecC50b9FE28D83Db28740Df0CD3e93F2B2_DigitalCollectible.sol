...
contract DigitalCollectible is Collectible {
    ...
    constructor(
        ...
        string memory _name,
        string memory _symbol,
        int256 _minRewardBalance,
        uint256 _minVisits,
        uint256 _minFriendVisits,
        address _passport,
        address _daoToken
    ) Collectible(_entity, CollectibleType.DIGITALCOLLECTIBLE, _area, _authority, _dataURI, _name, _symbol, _daoToken) {
        
        minRewardBalance = _minRewardBalance;
        minFriendVisits = _minFriendVisits;
        minVisits = _minVisits;
        passport = _passport;
    ...
    function mint (
        ...
        require(ICollectible(passport).getNFTDetails(patronPassport).visits >= minVisits, "Not enough visits");
        require(ICollectible(passport).getNFTDetails(patronPassport).rewardBalance >= minRewardBalance, "Not enough reward balance");
        require(ICollectible(passport).getNFTDetails(patronPassport).friendVisits >= minFriendVisits, "Not enough friend visits");
    ...
    function completeOrder(uint256 _offerId) external pure {
