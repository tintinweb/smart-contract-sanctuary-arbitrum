...
contract TournamentV5 is ReentrancyGuard, ITournamentV5, Ownable {
    ...
    function create(
        ...
        require(_startTime - block.timestamp <= limitStart, "PredictionV3: Too late");
        address[] memory _new;
        currentGameId++;
    ...
    function join(uint256 _gameId) external nonReentrant {
        ...
        require(_gameInfo.startTime - previousTime > block.timestamp, "PredictionV5: !time");
    ...
    function setPreviousTime( uint256 _previousTime) external onlyOwner {
