...
uint256 constant ID = uint256(keccak256("game.piratenation.generatorcountdowntimestampcomponent.dev2"));
...
uint256 constant ID = uint256(keccak256("game.piratenation.generatorobjectdefinitioncomponent.dev2"));
...
contract GeneratorSceneObjectSystem is GameRegistryConsumerUpgradeable {
     ...
     *
     * @param instanceEntity The entity of the scene object instance being removed
    ...
    function checkIfSceneObjectCanBeRemoved(
        ...
        uint256 lastHarvestTimestamp = _getCooldown(instanceEntity);
...
abstract contract SceneSystem is OwnerSystem, ISceneSystem {
    ...
    function _removeSceneObject(
        ...
        (bool isRemovable, uint256 cooldownEnd) = generatorSceneObjectSystem
            .checkIfSceneObjectCanBeRemoved(instanceEntity);
        if (!isRemovable) {
