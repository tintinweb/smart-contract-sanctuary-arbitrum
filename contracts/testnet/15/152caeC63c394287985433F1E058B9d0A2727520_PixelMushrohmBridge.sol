...
interface IPixelMushrohmERC721 is IERC721Enumerable {
    ...
    function adjustSporePower(uint256 _tokenId, uint256 _sporePower) external;

    function adjustLevelPower(uint256 _tokenId, uint256 _levelPower) external;

    function mintFirstGen(uint256 _tokenId) external;
