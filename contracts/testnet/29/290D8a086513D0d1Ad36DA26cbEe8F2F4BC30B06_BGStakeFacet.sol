...
// Library imports
import { LibStakeUtils } from "../libraries/LibStakeUtils.sol";
...
interface IBattleflyGame {
    ...
    function pay(uint256[] calldata currency, uint256[] calldata assets, uint256[] calldata pricePerAsset,uint256[] calldata amounts) external;
...
interface ISoulboundBattlefly is IERC721EnumerableUpgradeable {
    event Minted(address indexed receiver, uint256 indexed tokenId, uint256 battleflyType, bool stake);
    event MintedWhitelist(address indexed receiver, uint256 indexed tokenId, uint256 battleflyType, bool stake);
