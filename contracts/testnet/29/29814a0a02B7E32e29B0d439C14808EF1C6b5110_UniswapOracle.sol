...
import "../Common/ERC20/IERC20_Detailed.sol";
...
contract UniswapOracle is Owned {
    ...
    IERC20_Detailed public base_token;
    IERC20_Detailed public pricing_token;
    ...
    {
        base = base_token._symbol();
        pricing = pricing_token._symbol();
    }
    ...
    function getPrice() public view returns (uint256 amount_out) {
        ...
        amount_out = getQuote(
            sqrtRatioX96,
            uint128(10**pricing_token._decimals()),
    ...
    {
        return (
            IERC20_Detailed(pricing_token).balanceOf(address(pool)),
            IERC20_Detailed(base_token).balanceOf(address(pool))
        );
    }
    ...
    function _setUniswapPool(address _pool_address) internal {
        ...
        base_token = IERC20_Detailed(pool.token0());
        pricing_token = IERC20_Detailed(pool.token1());
    }
    ...
    function toggleTokenForPricing() external onlyAdmin {
        IERC20_Detailed aux = base_token;
