...
contract TradingContest is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ITradingContest {
    ...
    IERC20 public constant PRE_LVL = IERC20(0x6749B64866479Bc08136bC61de1C520D87ffbc30);

    uint64 public constant START_BATCH_USING_PRE_LVL = 0;

    uint64 public constant MAX_BATCH_DURATION = 300 days;
