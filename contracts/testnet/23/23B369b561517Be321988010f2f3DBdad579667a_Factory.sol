...
contract Factory is Basic {
    event BuySeed(address buyer, uint256 fee, uint256[] nfts);
    IERC721 public nft;
    IGene public gene;
    IERC20 public token;
    ...
    function change(uint256 _maxBuy, uint256 _maxSupply) public onlyOwner {
        maxBuy = _maxBuy;
    ...
    function _generatorPlant(
        ...
        counter++;
        require(counter <= maxSupply + 1, "!max");
        return counter - 1;
    }
    ...
    function buySeed(uint256 _amount) public {
        require(_amount <= maxBuy, "Can't buy more than 10");
        ...
        seedSold += _amount;
        emit BuySeed(msg.sender, _amount * price, nfts);
    }
