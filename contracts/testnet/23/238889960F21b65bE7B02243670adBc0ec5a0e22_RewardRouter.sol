...
contract RewardRouter is Initializable {
    ...
    function withdrawPEX() external {
        ...
        emit StakerEvent(msg.sender, "withdrawPEX", 0);
    }

    function claimPEX() external {
        PEXStakingVar.claim();
        emit StakerEvent(msg.sender, "claimPEX", 0);
    }
    ...
    function withdrawEsPEX() external {
        ...
        emit StakerEvent(msg.sender, "withdrawEsPEX", 0);
    }

    function claimEsPEX() external {
        esPEXStakingVar.claim();
        emit StakerEvent(msg.sender, "claimEsPEX", 0);
    }
