...
contract PoolHook is Ownable, IPoolHook {
    ...
    IMintableErc20 public immutable lyRwax;
    ...
    constructor(address _lyRwax, address _pool) {
        require(_lyRwax != address(0), "PoolHook:invalidAddress");
        require(_pool != address(0), "PoolHook:invalidAddress");
        lyRwax = IMintableErc20(_lyRwax);
        pool = _pool;
    }
