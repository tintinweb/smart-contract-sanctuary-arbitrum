    ...
    function distributeRewardsToHolders(uint256 ethAmount) internal {
        ...
        for (uint256 i = 0; i < token.holdersCount(); i++) {
            ...
            if (isEligible(holder)) {
                ...
                uint256 holderShareArbot = (holderBalance * remainingDistributionEth) / token.totalSupply();
                uint256 holderShareEth = (remainingDistributionEth * holderShareArbot) / holderBalance;
