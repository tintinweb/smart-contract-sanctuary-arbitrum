 ...
 */
contract MintableERC20 is ERC20Capped, ERC20Mintable, Ownable, Services {
    uint8 private _decimals;
    address private tokenOwner;

    event MintableTokenCreated(
        ...
        ERC20Capped(cap)
    {
        ...
        require(initialBalance <= cap, "MintableERC20: cap exceeded");
        require(msg.value >= serviceFee, "MintableERC20: Insufficient service fee");
        ...
        emit MintableTokenCreated(_msgSender(), address(this),TokenType.MINTABLE, serviceFee);
    }
