...
contract LIRA is ERC20("Satoshi LIRA", "LIRA"), Ownable {
    ...
    function mint(uint256 amount) public onlyOwner {
        if (totalSupply() == 0) {
            ...
            require(quoteAmount > 0, "LIRA: UNMINTABLE");
    ...
    function burn(uint256 amount) public onlyOwner {
        ...
        uint256 quoteAmount = quote(amount, wbtc.balanceOf(address(this)), totalSupply());
        
        wbtc.safeTransferFrom(address(this), _msgSender(), quoteAmount);
    }
