...
import { IPYESlice } from "./interfaces/IPYESlice.sol";
...
contract SmartChefPYE is Ownable, ReentrancyGuard, ERC20 {
    ...
    function safeRewardTransfer(address _to, uint256 _amount) internal {
        ...
        if (_amount > tokenBalance) {
            rewardToken.safeTransfer(_to, tokenBalance);
        } else {
...
contract PYESlice is ERC20 {
    ...
    constructor() ERC20("PYES Slice", "PYES SLICE") {
