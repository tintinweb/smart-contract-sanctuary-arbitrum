...
contract Diamond {
    constructor(
        ...
        ds.liquidityFeeBasisPoints = 100;
        ds.teamFeeBasisPoints = 200;
        ds.dividendFeeBasisPoints = 600;
        ds.claimTimeout = 3600;
        ds.minDividendBalance = 10**18;
        ds.numTokensToSwap = 100000 * 10**18;

        ds.dividendContract = _args.dividendContract;

        ds.liquidityWallet = _args.multisigWallet;
        ds.teamWallet = _args.multisigWallet;

        ds.uniswapRouter = _args.uniswapRouter;
        ds.sushiRouter = _args.sushiRouter;
        ds.magicswapRouter = _args.magicswapRouter;

        ds.methodsExposureFacetAddress = _args.methodsExposureFacetAddress;
    }

    function implementation() public view returns (address) {
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        return ds.methodsExposureFacetAddress;
    }
