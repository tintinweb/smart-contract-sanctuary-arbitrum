...
contract MarginBank is IMarginBank, Initializable, Ownable2StepUpgradeable {
    ...
    uint256 constant public LIQUIDATION_FEE = 1e6; // $1
    uint256 constant public WITHDRAW_FEE = 1e6; // $1
    ...
    function withdrawCollateral(IEndpoint.WithdrawCollateral memory _txn) external onlyEndpoint {
    ...
    function depositInsuranceFund(address _accountDeposit, uint256 _amount) external onlyEndpoint {
        insuranceFund += int256(_amount);
        emit InsuranceFundDeposited(_accountDeposit, _amount);
    }
...
interface IMarginBank {
    ...
    function depositInsuranceFund(address _accountDeposit, uint256 _amount) external;
    ...
    event InsuranceFundDeposited(address indexed accountDeposit, uint256 amount);
