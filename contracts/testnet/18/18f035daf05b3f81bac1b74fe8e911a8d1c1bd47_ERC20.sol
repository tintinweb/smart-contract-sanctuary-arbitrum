...
// File: contracts/interfaces/AINUBonusPool.sol


pragma solidity >=0.5.0;

interface AINUBonusPool {
...
contract AINU is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        AINUBonusPool(bonusWallet).injectRewards(amountDogBonus);
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'AINU: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AINU: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "AINU: index out of bounds");
