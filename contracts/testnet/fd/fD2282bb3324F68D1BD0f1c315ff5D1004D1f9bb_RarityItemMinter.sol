  ...
  Pausable
{
  ...
  IRarityItemDataStorage dataStorage;
  ...
  constructor(
    ...
    slots = toIndexesArray(
      1,
      characteristicDefinitions.characteristicValuesCount(
    ...
    categories[0] = [ITEM_SLOT_HEAD];
    types[0] = new uint16[][](1);
    types[0][0] = toIndexesArray(1, 4);
    //
    categories[1] = [ITEM_SLOT_CHEST];
    types[1] = new uint16[][](1);
    types[1][0] = toIndexesArray(4, 7);

    categories[2] = [ITEM_SLOT_HAND];
    types[2] = new uint16[][](1);
    types[2][0] = toIndexesArray(7, 10);

    categories[3] = [ITEM_SLOT_JEWELRY];
    types[3] = new uint16[][](1);
    types[3][0] = toIndexesArray(10, 13);

    prefixes = new uint16[][](7);
    suffixes = new uint16[][](7);
    prefixes[0] = [0];
    suffixes[0] = [0];
    ...
    //
    prefixes[ITEM_RARITY_RARE] = [1];
    suffixes[ITEM_RARITY_RARE] = [0];
    //
    prefixes[ITEM_RARITY_EPIC] = [1];
    suffixes[ITEM_RARITY_EPIC] = [0];
    //
    prefixes[ITEM_RARITY_LEGENDARY] = [1];
    suffixes[ITEM_RARITY_LEGENDARY] = [0];
  }

  //=========================================
  // Generate a particular tokenId
  //=========================================
  function mintSpecific(
    ...
    string memory name = dataStorage.name(_tokenId);
  ...
  //=========================================
  // Generate a random item of a given Rarity
  //=========================================
  function mintRandom(
    uint16 _rarity,
    uint256 _randomBase,
    ...
    ) = randomBaseCharacteristics(_randomBase, _rarity);
  ...
  function randomBaseCharacteristics(
    uint256 _randomBase,
    uint16 _rarity
  )
    internal
  ...
  function randomPrefixSuffix(
    uint16 _rarity,
    uint256 _randomBase
  ) internal view returns (uint256, uint16, uint16) {
    (uint256 prefixBase, uint16 itemPrefix) = randomPrefix(
      _randomBase,
      _rarity
    );
    (uint256 suffixBase, uint16 itemSuffix) = randomSuffix(prefixBase, _rarity);
  ...
  function toIndexesArray(
    uint16 startInclusive,
    uint16 endExclusive
  ) internal pure returns (uint16[] memory) {
    uint16[] memory arr = new uint16[](endExclusive - startInclusive);
    for (uint16 i = startInclusive; i < endExclusive; i++) {
