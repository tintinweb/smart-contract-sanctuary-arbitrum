...
contract AntiBotLiquidityGeneratorToken is IERC20Upgradeable, OwnableUpgradeable, BaseToken {
...
contract AntiBotLiquidityGeneratorTokenFactory is TokenFactoryBase {
    using Address for address payable;
    AntiBotLiquidityGeneratorToken[] public liquidityTokens;
    ...
    function create(
        ...
        AntiBotLiquidityGeneratorToken tokenContract = new AntiBotLiquidityGeneratorToken();
        tokenAddress = address(tokenContract);
        AntiBotLiquidityGeneratorToken(payable(tokenAddress)).initialize(
        msg.sender,
        name,
        symbol,
        totalSupply,
        ...
        liquidityTokens.push(AntiBotLiquidityGeneratorToken(payable(tokenAddress)));
        assignTokenToOwner(msg.sender, tokenAddress, 2);
        emit TokenCreated(msg.sender, tokenAddress, TokenType.liquidityGenerator, 1);
    }

    function getTokens() public view returns(AntiBotLiquidityGeneratorToken[] memory) {
