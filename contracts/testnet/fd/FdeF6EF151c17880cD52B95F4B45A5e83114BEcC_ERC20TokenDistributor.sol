 ...
 */
contract ERC20TokenDistributor is AccessControl, ReentrancyGuard, ITokenDistributor {
    using SafeERC20 for IERC20;

    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN");
    bytes32 public constant STAKING_ROLE = keccak256("STAKING");

    ITestERC20 public erc20;
    ...
    constructor(
        ...
        require(erc20_ != address(0), "ERC20TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        require(admin_ != address(0), "ERC20TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        require(staking_ != address(0), "ERC20TOKENDISTRIBUTOR:ILLEGAL_ADDRESS");
        erc20 = ITestERC20(erc20_);
    ...
    modifier onlyAdmin() {
        require(hasRole(ADMIN_ROLE, msg.sender), "ERC20TOKENDISTRIBUTOR:ACCESS_DENIED");
        _;
    }

    modifier onlyStaking() {
        require(hasRole(STAKING_ROLE, msg.sender), "ERC20TOKENDISTRIBUTOR:ACCESS_DENIED");
        _;
    }

    function payout(address payee, uint256 amount) public nonReentrant onlyStaking {
        erc20.mint(amount, payee);
    }
}
