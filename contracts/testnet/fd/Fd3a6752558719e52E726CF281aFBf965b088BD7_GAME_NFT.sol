...
abstract contract ERC721Lib is
    ERC721ABurnable,
    ERC721AQueryable,
    ERC4907A,
    ERC2981,
    Ownable
{
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC4907A, ERC2981, ERC721A)
        returns (bool)
    {
    ...
    function tokenURI(uint256 tokenId) public view virtual override( ERC721A) returns (string memory) {
        ...
        // console.log("base:%s tokenId:%s",base,tokenId);
...
/**
 * @title GAME_NFT contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract GAME_NFT is ERC721Lib {
