...
contract Star is StarState {
    ...
    function tokenURI(
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Star ', unicode"★", tokenId.toString(), '",',
                '"tokenId": ', tokenId.toString(), ',',
                '"image": "', _placeholderURI(), '",',
                '"description": "This Star is a virgin. He needs to join the Story to gain metadata. Check our website: https://www.imstarving.lol",',
