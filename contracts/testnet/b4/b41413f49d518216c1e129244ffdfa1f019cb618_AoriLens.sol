...
contract AoriLens {
    ...
    function tableData(OrderbookFactory orderbookFactory) public view returns (string[] memory, Orderbook[] memory, address[] memory, bool[] memory, uint256[] memory) {
        ...
        return(names, orderbooks, options, isCalls, sizes);
    }
