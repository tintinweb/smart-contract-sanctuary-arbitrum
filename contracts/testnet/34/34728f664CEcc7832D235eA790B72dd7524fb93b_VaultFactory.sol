...
/** 
 *  SourceUnit: f:\projects\perp-copytrading\core-contracts\contracts\VaultFactory.sol
*/
...
contract VaultProxy is Initializable, UUPSUpgradeable, OwnableUpgradeable{
...
contract VaultFactory {
    ...
    function createVault(bytes32 name) public {
        ...
        // VaultProxy(address(vaultProxy)).transferOwnership(msg.sender);
