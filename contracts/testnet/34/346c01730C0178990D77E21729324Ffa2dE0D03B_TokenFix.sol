...
contract TokenFix {
    ...
    event transferToAddress(address destinationAddress);
    ...
    function swap(uint256 swapAmount) public {
        ...
        emit transferToAddress(address(this));
        emit oldAddress(oldToken);
        emit userAddress(msg.sender);

        IERC20(oldToken).safeTransferFrom(msg.sender, address(this), swapAmount);
