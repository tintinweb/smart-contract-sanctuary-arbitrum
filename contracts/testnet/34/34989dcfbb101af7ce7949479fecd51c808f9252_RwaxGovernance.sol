...
/**
 * @notice implementation of the RwaxGovernance token contract
 * @author Rwax
 * Inspired from AAVE v2
 */
contract RwaxGovernance is Initializable, GovernancePowerDelegationERC20 {
    ...
    function initialize() external initializer {
        __ERC20_init("Rwax Governance Token", "VE_RWAX");
