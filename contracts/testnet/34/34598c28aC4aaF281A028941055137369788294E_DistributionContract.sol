...
contract DistributionContract {
    ...
    uint256 public constant ELIGIBILITY_EPOCHS = 10;
    ...
    mapping(address => mapping(uint256 => UnclaimedRewards)) public unclaimedRewards;
    ...
    function distributeRewardsToHolders(uint256 ethAmount) internal {
        ...
        for (uint256 i = 0; i < token.holdersCount(); i++) {
            ...
            if (isEligible(holder)) {
                ...
                unclaimedRewards[holder][currentEpoch].arbot += holderShareArbot;
                unclaimedRewards[holder][currentEpoch].eth += holderShareEth;
            }
        }
    }
    ...
    function claimArbot() external {
        ...
        unclaimedRewards[msg.sender][currentEpoch].arbot = 0;
    ...
    function claimEth() external {
        ...
        unclaimedRewards[msg.sender][currentEpoch].eth = 0;
        holders[msg.sender].lastClaimEpoch = currentEpoch;
        holders[msg.sender].lastClaimTime = block.timestamp;
