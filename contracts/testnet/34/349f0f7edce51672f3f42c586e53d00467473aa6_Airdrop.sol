...
contract AIBullBear is ERC20, Ownable {
    ...
    constructor() ERC20("BullBear AI", "AIBB") {
...
contract Airdrop {
    ...
    function burn(uint256 _amount) public onlyOwner {
        ...
        token.burnFromContract(_amount);
        emit Burn(_amount);
    }
    ...
    function calculateTokensToClaim() private view returns (uint256) {
        ...
        if(user.percentClaimed==100 || user.totalClaimed==MAX_PER_ADDRESS) return 0;
