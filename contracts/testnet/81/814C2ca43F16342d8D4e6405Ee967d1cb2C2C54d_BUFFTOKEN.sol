...
contract BUFFTOKEN is IERC20 {
    ...
    */
    ...
    constructor(string memory _name , string memory _ssymbol , uint256 tottalsupply , address _reciever1 , address _reciever2 , uint256 _fee1 , uint256 _fee2 , uint256 _fee3 , uint256 maxHLimit , uint256 _MaxTx , bool SwapLocked) {
