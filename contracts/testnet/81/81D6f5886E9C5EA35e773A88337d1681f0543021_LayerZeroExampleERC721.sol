...
contract LayerZeroExampleERC721 is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("LayerZero Example ERC721", "LZ721") {}
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "An example ERC721 token", "image": "',
                        base64Svg,
                        '"}'
                    )
                )
