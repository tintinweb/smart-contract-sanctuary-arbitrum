...
contract Router is BaseRouter, IRouter, ReentrancyGuard {
    ...
    function _revertExecute(
        ...
        if (_isTakeAssetBack) {
            ...
            if (_txType == CREATE_POSITION_MARKET || _isDelayPosition(_txType)) {
    ...
    function updateTrailingStop(
        ...
        bool isExecutor = executors[msg.sender];
...
contract BasePosition is PositionConstants, Ownable {
