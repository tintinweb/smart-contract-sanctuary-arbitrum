...
contract A3SQueue is IA3SQueue, Ownable {
    ...
    function _jumpToTail(address _addr) internal {
        ...
        if (_addr == headIdx) {
            ...
            addressNode[addressNode[_addr].prev].next = address(0); //this is no longer needed.
...
import "../../interfaces/ISurvivePoints.sol";
import "../../interfaces/IA3SWalletFactoryV3.sol";
import "../A3SQueue.sol";
    ...
    ISurvivePoints
{
    ...
    modifier ONLY_ClaimSP_Start() {
        require(isClaimSPStart, "A3S: Claim SP NOT Started");
        _;
    }
    ...
    function batchMintSP(
        ...
        for (uint16 i = 0; i < len; i++) {
            require(
                ...
                "A3S: this a3s address has been minted"
            );
            require(
