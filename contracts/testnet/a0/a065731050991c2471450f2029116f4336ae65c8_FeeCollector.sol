...
contract FeeCollector is ReentrancyGuard, AccessControlBase, IFeeCollector {
    ...
    function getSwapDistribution() external view returns(SwapDistributionRation memory swapDistributionConfig_) {
        swapDistributionConfig_ = swapDistributionConfig;
    }

    function getWagerDistribution() external view returns(WagerDistributionRation memory wagerDistributionConfig_) {
