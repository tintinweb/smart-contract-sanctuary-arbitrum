...
contract CARROT is ICARROT, ERC20, Ownable {
     ...
     * @param to_ the recipient of the $CARROT
     * @param amount_ the amount of $CARROT to mint
     */
     ...
     * @param from_ the holder of the $CARROT
     * @param amount_ the amount of $CARROT to burn
     */
