...
contract Quiz is Ownable
{
    ...
    uint256 public BonusAnswerCorrect = 10e18;
        ...
        mapping(uint256 => QuestionInfo) public ListQuestionsContract;
        ...
        uint256 answerResult) public onlyOwner
    {
        ...
        QuestionInfo storage questionInfo = ListQuestionsContract[indexQuest];
        ...
        questionInfo.AnswerResult = answerResult;
    }
    ...
    function SubmitQuestions(uint256[] calldata results) public
    {
        ...
        if(ListQuestionsContract[ListQuestionsUser[user][0]].AnswerResult == results[0])
        {
            ListResultAnswersUser[user][0] = 1; // 1: true, 0: false;
            totalAnswerCorrect = totalAnswerCorrect.add(1);
        }

        if(ListQuestionsContract[ListQuestionsUser[user][1]].AnswerResult == results[1])
        {
            ListResultAnswersUser[user][1] = 1; // 1: true, 0: false;
            totalAnswerCorrect = totalAnswerCorrect.add(1);
        }

        if(ListQuestionsContract[ListQuestionsUser[user][2]].AnswerResult == results[2])
        {
