...
contract PoolAdapter {
     ...
     * @param tokenOut The token out address (no way to detect underlying asset only by i);
     * @param emergencyTo Emergency to address in case of inconsistency.
     */
    function removeLiquidity(
        ...
        amountOut = poolImpl.remove_liquidity_one_coin(amountIn, int128(uint128(i)), minAmountOut, to);
    }
}