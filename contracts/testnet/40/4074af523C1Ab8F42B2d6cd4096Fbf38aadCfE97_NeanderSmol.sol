...
contract NeanderSmol is ContractControl, ERC721Enumerable{
    ...
    mapping(address => uint) private teamAddresses;
    ...
    function addTeam(address member, uint256 amount) external onlyOwner {
        teamAddresses[member] = amount;
    }

    function removeTeam(address member) external onlyOwner {
