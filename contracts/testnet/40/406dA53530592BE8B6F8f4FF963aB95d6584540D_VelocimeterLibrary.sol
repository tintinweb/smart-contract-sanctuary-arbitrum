...
contract Minter is IMinter {
    uint256 internal constant WEEK = 120; // allows minting once per week (reset every Thursday 00:00 UTC)
    ...
    uint256 internal constant LOCK = 86400 * 4;
...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes {
    ...
    uint internal constant MAXTIME = 86400;
    int128 internal constant iMAXTIME = 86400;
