...
contract Exchange is Ownable {
    ...
    function getAllowance(address userAddress,address tokenAddress) external view returns (uint256) {
        return IERC20(tokenAddress).allowance(userAddress, address(this));
    }
