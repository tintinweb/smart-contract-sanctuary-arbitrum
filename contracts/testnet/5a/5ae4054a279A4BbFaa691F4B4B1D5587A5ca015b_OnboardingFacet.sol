...
contract OnboardingFacet is AppFacet {
    ...
    function setSigner(
        ...
        OnboardingStorage.layout()._signer = signer_;
    }

    function getSigner() external view returns (address) {
        return OnboardingStorage.layout()._signer;
    }
    ...
    function _verifySignature(
        ...
        require(
            !layout._verifiedSignature[signature],
        ...
        require(
            ...
            ).toEthSignedMessageHash().recover(signature) == layout._signer,
            "Invalid signature"
        );

        layout._verifiedSignature[signature] = true;
    }
}
...
library OnboardingStorage {
    ...
    struct Layout {
        mapping(bytes => bool) _verifiedSignature;
        address _signer;
    }
