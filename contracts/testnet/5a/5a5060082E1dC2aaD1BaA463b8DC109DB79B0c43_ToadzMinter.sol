...
contract ToadzMinter is Initializable, ToadzMinterSettings {
    ...
    onlyEOA
    {
        ...
        // Get trophy for whitelist
        trophiez.mintIfNeeded(msg.sender, whitelistTrophyId);
...
abstract contract ToadzMinterSettings is Initializable, ToadzMinterContracts {
    ...
    function setWhitelistTrophyId(
        uint256 _whitelistTrophyId)
    external
    onlyAdminOrOwner
    {
        whitelistTrophyId = _whitelistTrophyId;
    }
...
abstract contract ToadzMinterState is Initializable, IToadzMinter, AdminableUpgradeable {
    ...
    uint256 public whitelistTrophyId;
