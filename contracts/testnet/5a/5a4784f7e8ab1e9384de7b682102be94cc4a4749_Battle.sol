...
//		data.nextBattleConfig[msg.sender].enemyCards[0] = Battle.CardOrHireling(true, tokenIds[0]);
//		data.nextBattleConfig[msg.sender].enemyCards[1] = Battle.CardOrHireling(true, tokenIds[1]);
//		data.nextBattleConfig[msg.sender].enemyCards[2] = Battle.CardOrHireling(true, tokenIds[2]);
//		data.nextBattleConfig[msg.sender].enemyCards[3] = Battle.CardOrHireling(true, tokenIds[3]);
//
//		// check for duplicate cards
//		uint8[] memory hirelingRarities = new uint8[](4);
//		uint8[] memory hirelingHouses = new uint8[](4);
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[1] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 7)) % data.hirelingPool[hirelingRarities[0]][hirelingHouses[0]].length) * 10000) + (hirelingHouses[0] * 100) + hirelingRarities[0]);
//		}
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[2] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 10)) % data.hirelingPool[hirelingRarities[1]][hirelingHouses[1]].length) * 10000) + (hirelingHouses[1] * 100) + hirelingRarities[1]);
//		}
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[3] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 13)) % data.hirelingPool[hirelingRarities[2]][hirelingHouses[2]].length) * 10000) + (hirelingHouses[2] * 100) + hirelingRarities[2]);
//		}
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[2] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 16)) % data.hirelingPool[hirelingRarities[3]][hirelingHouses[3]].length) * 10000) + (hirelingHouses[3] * 100) + hirelingRarities[3]);
//		}
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[3] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 19)) % data.hirelingPool[hirelingRarities[4]][hirelingHouses[4]].length) * 10000) + (hirelingHouses[4] * 100) + hirelingRarities[4]);
//		}
//
...
//			data.nextBattleConfig[msg.sender].enemyCards[3] = Battle.CardOrHireling(false, ((uint(blockhash(block.number - 22)) % data.hirelingPool[hirelingRarities[5]][hirelingHouses[5]].length) * 10000) + (hirelingHouses[5] * 100) + hirelingRarities[5]);
//		}
//
