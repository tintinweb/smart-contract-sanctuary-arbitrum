...
contract ArbswapToken is ERC20, Ownable {
    ...
    uint256 public LiquidityMiningMaxSupply = 4e8 ether;
    uint256 public StakingMaxSupply = 3e8 ether;
    uint256 public CommunityMaxSupply = 15e7 ether;
    uint256 public PartnershipMaxSupply = 3e7 ether;
    uint256 public InitialLiquidityMaxSupply = 2e7 ether;
    uint256 public TeamMaxSupply = 1e8 ether;
    ...
    function mintByStaking(address _to, uint256 _amount)
        external
        onlyStaking
    {
    ...
    function mintByCommunity(address _to, uint256 _amount)
        ...
        onlyCommunity
    {
        if (communityTotalSupply < CommunityMaxSupply) {
    ...
    function mintByPartnership(address _to, uint256 _amount)
        ...
        onlyPartnership
    {
        if (partnershipTotalSupply < PartnershipMaxSupply) {
    ...
    {
        if (initialLiquidityTotalSupply < InitialLiquidityMaxSupply) {
    ...
    function mintByTeam(address _to, uint256 _amount)
        external
        onlyTeam
    {
        if (teamTotalSupply < TeamMaxSupply) {
            uint256 mintAmount = (teamTotalSupply + _amount) <
            TeamMaxSupply
                ? _amount
