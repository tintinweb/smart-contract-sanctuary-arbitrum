...
contract SynthUtil {
    ...
    bytes32 internal constant CONTRACT_WRAPPED_SYNTHR = "WrappedSynthr";
    ...
    function _wrappedSynthr() internal view returns (IWrappedSynthr) {
        return
            IWrappedSynthr(addressResolverProxy.requireAndGetAddress(CONTRACT_WRAPPED_SYNTHR, "Missing WrappedSynthr address"));
    }

    function _issuer() internal view returns (IIssuer) {
        return IIssuer(addressResolverProxy.requireAndGetAddress(CONTRACT_ISSUER, "Missing SynthrIssuer address"));
    }
