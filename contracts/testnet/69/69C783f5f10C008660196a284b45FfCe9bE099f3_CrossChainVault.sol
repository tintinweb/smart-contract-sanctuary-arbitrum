...
abstract contract CrossChainMsg is Ownable, ICrossChainMsgReceive {
    ...
    function receiveMsg(
        ...
        require(
            ...
            "CrossChainMessaging: invalid source sending contract"
        );
    ...
    function handleNonblockingReceive(
        ...
        _handleNonblockingReceive(_srcChainId, _srcAddress, _payload);
    }
    ...
    function sendMessage(
        ...
        require(
            trustedRemote.length != 0,
            "CrossChainMessaging: destination chain is not a trusted source"
        );
    ...
    function getTrustedRemoteAddress(
        ...
        require(
            path.length != 0,
            "CrossChainMessaging: no trusted path record"
        );
        return path;
    }
...
contract CrossChainVault is Ownable, Pausable, CrossChainMsg {
    ...
    function _handleNonblockingReceive(
        ...
        require(supportedChains[_srcChainId], "unsupported chain");
