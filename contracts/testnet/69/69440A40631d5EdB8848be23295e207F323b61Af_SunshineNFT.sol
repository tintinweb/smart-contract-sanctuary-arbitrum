...
import { PullPayment } from "lib/openzeppelin-contracts/contracts/security/PullPayment.sol";
import { Strings } from "lib/openzeppelin-contracts/contracts/utils/Strings.sol";
    ...
    ISunshineNFT
{
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI_).length > 0 ? string(abi.encodePacked(baseURI_, tokenId.toString(),".gif")) : "";
    }
