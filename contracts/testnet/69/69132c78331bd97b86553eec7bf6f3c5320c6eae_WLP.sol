...
abstract contract BasicFDT is IBaseFDT, ERC20 {
    ...
    */
    function _distributeFunds_WLP(uint256 value) internal {
        ...
        // pointsPerShare_WLP = pointsPerShare_WLP.add(value.mul(pointsMultiplier) / totalSupply());
    ...
    function _distributeFunds_VWINR(uint256 value) internal {
        ...
        // pointsPerShare_VWINR = pointsPerShare_VWINR.add(value.mul(pointsMultiplier) / totalSupply());
