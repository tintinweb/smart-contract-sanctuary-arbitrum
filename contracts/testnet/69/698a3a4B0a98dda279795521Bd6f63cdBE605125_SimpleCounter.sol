...
contract SimpleCounter {
    ...
    event intAdded(address indexed usrAddress,uint indexed intToAdd, uint curcount,uint blocknbr);
    event intReset(address indexed usrAddress,uint blocknbr, uint curcount);
