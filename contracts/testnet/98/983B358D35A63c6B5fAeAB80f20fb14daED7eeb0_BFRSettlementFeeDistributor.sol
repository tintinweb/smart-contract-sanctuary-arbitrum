...
contract BFRSettlementFeeDistributor is AccessControl {
    ...
    constructor(ERC20 _tokenX, address _treasury, address _burnAddress) {
        tokenX = _tokenX;
        treasury = _treasury;
    ...
    function distribute() external {
        ...
        uint256 amount = (contractBalance * 5000) / 10000;
        tokenX.safeTransfer(burnAddress, amount);
        contractBalance -= amount;
        tokenX.safeTransfer(treasury, contractBalance);
