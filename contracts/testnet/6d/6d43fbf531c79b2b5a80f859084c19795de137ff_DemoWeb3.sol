...
contract DemoWeb3 is ERC721, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("DEMOWEB3", "DEB3") {}
   
   function totalSupply() public view returns(uint) {
     return _tokenIds.current() + _reserveTokenId - maxPublicSupply;
   }
      ...
      function mint(uint _mintAmount) public payable {
        ...
        require(_tokenIds.current() + _mintAmount <= maxPublicSupply, "Max public supply exceeded");
