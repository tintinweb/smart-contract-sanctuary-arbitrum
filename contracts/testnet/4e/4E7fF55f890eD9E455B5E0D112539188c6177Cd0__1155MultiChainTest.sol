 ...
 * @notice This contract handles minting 1155 multi-chain test tokens.
 */
contract _1155MultiChainTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xf9E16a2DF99E02b750606e66cB19859838F978d4;
    ...
    string public name = "1155 multi-chain test";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeibuoshr526i5z3esdm3kn7vkmgwbit5bzgt62ua37i7fngphzndiu/{id}"
        )
    {
