...
contract Kong is ERC20, Ownable {
    ...
    AggregatorV3Interface internal priceFeed =
        ...
        AggregatorV3Interface(0x62CAe0FA2da220f43a51F86Db2EDb36DcA9A5A08); // ETH/USD Arbitrum Goerli Testnet

    address public camelotPair;
    address public distributionPool;
    address public futureUsePool;
    address public marketing;
    address public team; // == owner
    ...
    uint256 public nodesPrice = 40;
    uint16 public maxNodePresaleWhitelist = 64;
    uint16 public presalePriceWhitelist = 35;
    ...
    constructor(
        ...
        // [teamFee, rewardsFee, liquidityPoolFee, rewardSwapFee, pumpDumpTax, sellTax, transferTax]
        // [2, 60, 10, rewardSwapFee, 50, 5, 1]
        ERC20("KONG", "BNA")
    {
    ...
    function addLiquidity(uint256 _tokenAmount, uint256 _ethAmount) private {
        ...
        camelotRouter.addLiquidityETH{value: _ethAmount}(
            ...
            0, // slippage is unavoidable
            owner(), // poolHandler, address(zero) ???
            block.timestamp
        );
    }
    ...
    function swapTokensForEth(uint256 _tokenAmount) private {
        ...
        camelotRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            path,
            address(this), // Receiver == the contract
            address(0), // à changer par l'adresse referal de Camelot
            block.timestamp
        );
...
contract Node is Ownable {
    ...
    function getAllNodes() external view returns (NodeEntity[] memory) {
        NodeEntity[] memory nodes = new NodeEntity[](totalNodesCreated);
        for (uint256 i; i < totalNodesCreated; ++i) {
            nodes[i] = nodesById[i];
        }
        return nodes;
    }
