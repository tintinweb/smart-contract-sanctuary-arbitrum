...
contract FoxifyVestedNFT is Ownable, ERC721Enumerable {
    ...
    function mint(uint256 quantity) external returns (bool) {
        ...
        stableToken.safeTransferFrom(msg.sender, paymentsRecipient, wave.stablePrice * quantity);
    ...
    function startMint(uint256 startTimestamp, uint256 count, uint256 stablePrice) external onlyOwner returns (bool) {
