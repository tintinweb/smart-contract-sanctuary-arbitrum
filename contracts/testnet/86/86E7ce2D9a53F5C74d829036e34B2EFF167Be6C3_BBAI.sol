 ...
 * allowances. See {IERC20-approve}.
 */
contract BBAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Bluebird AI";
    ...
    uint256 public maxTxAmount = 100000001 * 10 ** _decimals;
    uint256 public maxWalletAmount = 100000001 * 10 ** _decimals;
    address public marketingWallet = 0x8DbE5a1D7F370aF01538CAfdD0D2D37cfbC53EDE;
    ...
    function postLaunch() external onlyOwner {
        taxForLiquidity = 1;
        taxForMarketing = 2;
        maxTxAmount = 100000001 * 10 ** _decimals;
        maxWalletAmount = 100000001 * 10 ** _decimals;
    }
    ...
    uint public channelCostTokens = 1000000 * 10 ** _decimals;
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x81cD91B6BD7D275a7AeebBA15929AE0f0751d18C
        ); //arb testnet
