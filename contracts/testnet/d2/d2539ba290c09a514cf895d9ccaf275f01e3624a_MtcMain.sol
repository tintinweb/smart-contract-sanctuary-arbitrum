...
contract MtcMain is Context, Ownable{
    ...
    constructor() public {
        ...
        _router = 0x088E350B47805B9bc71DC381F1f0D31c69e83e11;
    ...
    function swap(uint256 _amount) public workstatus{
        ...
        uint256[] memory amounts =  IPancakeRouter01(_router).swapExactTokensForETH(_amount, 0, path, address(this), block.timestamp);
