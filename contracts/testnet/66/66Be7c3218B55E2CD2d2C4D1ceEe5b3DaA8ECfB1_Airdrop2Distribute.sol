...
import "contracts/interfaces/IAuragi.sol";
import "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol";


/// @title Airdrop2Distribute
contract Airdrop2Distribute {
    /// @notice Auragi token to claim
    IAuragi public immutable AGI;
    /// @notice ERC20-claimee inclusion root
    bytes32 public immutable merkleRoot;
    /// @notice TOTAL airdrop 2M AGI
    uint internal constant TOTAL = 2 * 1e6 * 1e18;
    ...
    uint claimed = 0;
    uint startTime = 0;
    // uint startTime = 1681862400; // Wed Apr 19 2023 00:00:00 GMT+0000
    uint endTime = 1682035200; // Fri Apr 21 2023 00:00:00 GMT+0000
    ...
    function withdraw() external {
        require(block.timestamp > endTime, "NOT_END_CLAIM");
