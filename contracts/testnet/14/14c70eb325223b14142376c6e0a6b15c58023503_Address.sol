...
contract Ahora is Context, IERC20, Ownable {
    using Address for address;

    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;

    address public safuDeployer = 0x50BDa0Cb8E10E3af18BAa7dc230177d50469A8a0; //This should be the updated by the SAFU Developer to confirm he deployed the contract.
    ...
    string private constant _name = "Ahora";
    string private constant _symbol = "AHORA";
    ...
    uint256 public constant minAmountDEXSwap = 0; //default is 0 to accept any amount of ETH, this can be updated based on the Oracle Price.
    ...
    constructor() {
        require(msg.sender == safuDeployer, "Your not the SAFU deployer of this contract");
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0x4169Db906fcBFB8b12DbD20d98850Aee05B7D889; //Tres Leches Swap
        } else if (block.chainid == 137) {
            currentRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Polygon Ropsten
        } else if (block.chainid == 421611) {
            currentRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //Arbiscan Rinkeby
        ...
        _isExcludedFromFee[safuDeployer] = true;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            minAmountDEXSwap, // accept any amount of ETH unless the Oracle Update the price, this to avoid sandwich attack.
            path,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            deadWallet, //Liquidity goes to Dead Wallet since is a SAFU Requirement.
            block.timestamp
        );
    }
   ...
   //Define the minimun amount to swap and liquify, this is done in wei.
    ...
    //By default the swap is manual, you will need to enable this function to have autoSwap of the contract.
    ...
    function recoverETHfromContract(address _recoveryWallet) public virtual onlyOwner {
        require( _recoveryWallet != address(0), "recoverETHfromContract: ZERO");
    ...
    require( _recoveryWallet != address(0), "recoverTokensFromContract: ZERO"); 
    require(_tokenAddress != address(this), "Owner can't claim contract's balance of its own tokens");	
    require(_tokenAddress != uniswapV2Pair, "Owner can't claim LP Tokens balance of its own tokens");
