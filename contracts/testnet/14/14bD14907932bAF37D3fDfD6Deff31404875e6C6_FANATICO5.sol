...
contract FANATICO5 is ERC20, ERC20Burnable, ERC20FlashMint, AccessControl, ReentrancyGuard {
    constructor(
        string memory _name,
    ...
    ERC20(_name, _symbol) {
        ...
        _setupRole(REWARDS_MANAGER_ROLE, msg.sender);
        _setupRole(REWARDS_MANAGER_ROLE, _rewardsManager);
    ...
    function giveSignupBonus(address account) public onlyRole(REWARDS_MANAGER_ROLE) nonReentrant {
    ...
    function giveDailyBonus(address account) public onlyRole(REWARDS_MANAGER_ROLE) nonReentrant {
