...
contract PositionRouter is BaseRouter, IPositionRouter, ReentrancyGuard {
    ...
    function openNewPosition(
        ...
        //Scope to avoid stack too deep error
        {
            key = _getAndCheckPositionKey(msg.sender, _getFirstPath(_path), _isLong, posId);
        }
    ...
    function addOrRemoveCollateral(
        ...
        _modifyPosition(
            _getAndCheckPositionKey(msg.sender, _getFirstPath(_path), _isLong, _posId),
            _isPlus ? true : false,
    ...
    function updateTrailingStop(
        ...
        _modifyPosition(
            _getAndCheckPositionKey(msg.sender, _indexToken, _isLong, _posId),
            false,
    ...
    */
    ...
    function closePosition(
        ...
        _modifyPosition(
            _getAndCheckPositionKey(msg.sender, _path[0], _isLong, _posId),
            false,
            CLOSE_POSITION,
            _params,
            prices,
    ...
    function _createPrepareTransaction(
        ...
        bytes32 key = _getAndCheckPositionKey(_account, _getFirstPath(_path), _isLong, _posId);
    ...
    function _getAndCheckPositionKey(
        address _account, 
        address _indexToken,
        bool _isLong,
        uint256 _posId
