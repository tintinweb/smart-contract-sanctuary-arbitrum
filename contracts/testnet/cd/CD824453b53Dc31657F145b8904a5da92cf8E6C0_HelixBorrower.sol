...
contract HelixBorrower is BaseUpgradeablePausable, IHelixBorrower {
    ...
    function directDividendPayment(
        ...
        fund.directDividendPayment(msg.sender, investors, amounts);
    }
    ...
    function directDividendPaymentWithPermit(
        ...
        fund.directDividendPaymentWithPermit(msg.sender, investors, amounts, deadline, v, r, s);
    }
    ...
    function indirectDividendPayment(
        ...
        fund.indirectDividendPayment(root, msg.sender, totalAmount);
    }
    ...
    function indirectDividendPaymentWithPermit(
        ...
        fund.indirectDividendPaymentWithPermit(root, msg.sender, totalAmount, deadline, v, r, s);
    }

    function toggleFund(
        IHelixFund fund,
        bool status // false: close, true: open again
    ) public onlyAdmin {
