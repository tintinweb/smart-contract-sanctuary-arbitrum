...
contract OptionsConfig is Ownable, IOptionsConfig {
    ...
    uint256 public override minSafeStrikePercent;
    uint256 public override maxSafeStrikePercent;
    ...
    function setMinSafeStrikePercent(
        uint256 _minSafeStrikePercent
    ) external onlyOwner {
        minSafeStrikePercent = _minSafeStrikePercent;
        emit UpdateMinSafeStrikePercent(minSafeStrikePercent);
    }

    function setMaxSafeStrikePercent(
        uint256 _maxSafeStrikePercent
    ) external onlyOwner {
        maxSafeStrikePercent = _maxSafeStrikePercent;
        emit UpdateMaxSafeStrikePercent(maxSafeStrikePercent);
    }
}
