...
contract S1PositionNFT is ERC721,DefaultOperatorFilterer,OwnableAdmins
  {
    ...
    function setValue(uint tokenId, uint _value) public onlyAdmins {
    ...
    function mint(address to,uint _value) public onlyAdmins {
        mintCounter += 1;
