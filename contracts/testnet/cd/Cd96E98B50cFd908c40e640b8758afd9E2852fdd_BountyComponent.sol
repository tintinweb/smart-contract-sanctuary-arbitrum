 ...
 * Ex: "WOOD_BOUNTY_1" , "WOOD_BOUNTY_2", "IRON_BOUNTY_1", "IRON_BOUNTY_2", etc.
 */
contract BountyComponent is BaseComponent {
    ...
    {
        keys = new string[](8);
        values = new TypesLibrary.SchemaValue[](8);
        ...
        // Bounty Input Loot component namespace GUID defined in the SoT, ex: "WOOD_BOUNTY_1_INPUT_LOOT"
        keys[5] = "input_loot_set_entity";
        values[5] = TypesLibrary.SchemaValue.UINT256;

        // Base Loot component GUID, unique namespace GUID defined in the SoT, ex: "WOOD_BOUNTY_1_BASE_LOOT"
        keys[6] = "base_loot_set_entity";
        values[6] = TypesLibrary.SchemaValue.UINT256;

        // Bonus Loot component GUID, unique namespace GUID defined in the SoT, ex: "WOOD_BOUNTY_1_BONUS_LOOT"
        keys[7] = "bonus_loot_set_entity";
        values[7] = TypesLibrary.SchemaValue.UINT256;
    }
    ...
    function setValue(
        ...
        uint256 baseLootEntity,
        uint256 bonusLootEntity
    ) external virtual {
        _set(
            entity,
            abi.encode(
