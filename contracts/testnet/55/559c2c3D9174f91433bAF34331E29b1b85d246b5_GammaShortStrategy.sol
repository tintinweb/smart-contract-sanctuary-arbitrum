...
library Perp {
    ...
    function reallocate(
        ...
        if (totalLiquidityAmount == 0) {
            (_sqrtAssetStatus.tickLower, _sqrtAssetStatus.tickUpper) = Reallocation.getNewRange(_assetStatusUnderlying, _assetStatusStable, currentTick);
            return (false, 0);
        }
    ...
    function rebalanceForInRange(
        ...
        (_sqrtAssetStatus.tickLower, _sqrtAssetStatus.tickUpper) = Reallocation.getNewRange(_assetStatusUnderlying, _assetStatusStable, _currentTick);
    ...
    function computeRequiredAmounts(
        ...
        require(
            Reallocation.isInRange(_underlyingAssetStatus.sqrtAssetStatus),
            "P2"
        );
...
library Reallocation {
    ...
    function _isInRange(
        ...
        return (
            _sqrtAssetStatus.tickLower <= _currentTick
                && _currentTick < _sqrtAssetStatus.tickUpper
        );
    }
    ...
    function calculateMinLowerTick(
        ...
        uint160 sqrtPrice = calculateAmount1ForLiquidity(
    ...
    function calculateMaxUpperTick(
        ...
        uint160 sqrtPrice = calculateAmount0ForLiquidity(
...
library Trade {
    ...
    function settleFee(
        ...
        Perp.updateRebalanceFeeGrowth(_underlyingAssetStatus, _stableAssetStatus.tokenStatus, _underlyingAssetStatus.sqrtAssetStatus);
