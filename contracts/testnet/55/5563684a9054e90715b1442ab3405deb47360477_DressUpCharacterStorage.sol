...
contract DressUpCharacterStorage is Ownable, StatusHandler, ImageDataHandler {
    ...
    function setImageDatas(bytes memory data, uint256 imageId, uint256 categoryId, uint256 transformId)
        ...
        onlyOwner
    {
        _setImageDatas(data, imageId, categoryId, transformId);
    }
    ...
    function updateImageDatas(address pointer, uint256 imageId, uint256 categoryId, uint256 transformId)
        ...
        onlyOwner
    {
        _updateImageDatas(pointer, imageId, categoryId, transformId);
    }
    ...
    function secondConcatCharacterRender_(uint256 characterId, uint256 slot) public view returns (string memory data) {
        return secondConcatCharacterRender(characterId, slot);
    }
}
...
abstract contract ImageDataHandler {
    ...
    function _setImageDatas(bytes memory data, uint256 imageId, uint256 categoryId, uint256 transformId) internal {
    ...
    function _updateImageDatas(address pointer, uint256 imageId, uint256 categoryId, uint256 transformId) internal {
        assembly {
            categoryId := and(categoryId, _MASK_UINT8)
            transformId := and(transformId, _MASK_UINT16)
    ...
    function characterRender(uint256 characterId, uint256 slot) internal view returns (string memory) {
        ...
        for (uint256 i = 1; i < len + 1;) {
            unchecked {
                ...
                symbol = string.concat(symbol, createPrefixGrope(categoryId_), string(pointer_.read()), suffixGrope);
    ...
    function iconCharacterRender(uint256 characterId, uint256 slot) internal view returns (string memory) {
        string memory symbol = createBg(characterId);
    ...
    function firstConcatCharacterRender(uint256 characterId, uint256 slot) internal view returns (string memory) {
        string memory symbol = createBg(characterId);
        ...
        string memory packedSVG = string.concat(prefix, symbol);
        return packedSVG;
    }

    // for special character
    function secondConcatCharacterRender(uint256 characterId, uint256 slot) internal view returns (string memory) {
        ...
        string memory packedSVG = string.concat(symbol, useContent, createUseContentCharacter(characterId), suffix);
        return packedSVG;
    }
    ...
    function getCharacterTransformDatas(uint256 characterId, uint256 index)
        internal
        view
    ...
    function createUseContentCharacter(uint256 characterId) internal view returns (string memory) {
        string memory useContent;
        for (uint256 i = 3; i < 9;) {
            unchecked {
                useContent = string(
                    abi.encodePacked(useContent, createUseContent(i, getCharacterTransformDatas(characterId, i - 3)))
                );
                i++;
            }
        }
    ...
    function createPrefixGrope(uint256 categoryId) internal pure returns (string memory) {
        return string.concat('<symbol id="', categoryId.toString(), '">');
    }

    function createUseContent(uint256 categoryId, uint256 transformId) internal view returns (string memory) {
        return string.concat(
            '<use href="#', categoryId.toString(), '" x="0" y="0" transform="', getTransformDatas(transformId), '" />'
        );
    }

    function createUseContentForIcon(uint256 categoryId, uint256 transformId) internal view returns (string memory) {
        return string.concat(
            '<use href="#',
            categoryId.toString(),
            '" x="0" y="0" transform="',
    ...
    function createBg(uint256 characterId) internal view returns (string memory) {
        return string.concat(
    ...
    function getTransformDatas(uint256 index) internal view returns (string memory data) {
