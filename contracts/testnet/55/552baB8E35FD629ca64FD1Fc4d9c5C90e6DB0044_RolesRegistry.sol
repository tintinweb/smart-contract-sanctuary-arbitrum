...
contract RolesRegistry is IRoles, AccessControlEnumerable {
    ...
    bytes32 private constant REPORTER_ROLE = keccak256("REPORTER_ROLE");
    ...
    function setReporter(address user, bool on) external {
        _setRole(REPORTER_ROLE, user, on);
    }
    ...
    function isReporter(address user) view override external returns (bool) {
