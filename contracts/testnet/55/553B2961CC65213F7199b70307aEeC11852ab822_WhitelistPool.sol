...
contract WhitelistPool is ERC20, AccessControlEnumerable {
    ...
    /*====================================== Constructor ============================================= */
    constructor(IERC20 _USDC) ERC20("Genesis GEMLP", "gGEMLP") {
        require(address(_USDC) != address(0), "WP: Address zero");
        USDC = _USDC;
        dueDate = block.timestamp + 30 days; // default
     ...
     * @notice it takes USDC and mints gGEMLP equivalent amount of USDC
     */
    ...
    function updateDueDate(
        ...
        require(
            newDueDate > dueDate,
            "WP: Due Date must be greater the old one"
        );
        dueDate = newDueDate;
