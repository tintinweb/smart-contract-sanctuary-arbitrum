 ...
 */
contract YAYToken is Ownable, ERC20Pausable, ERC20Burnable, ERC20BlackListable, ERC20Capped, EmergencyWithdrawable {
    /**
     ...
     */
    constructor(string memory name_, string memory symbol_, uint256 totalSupply) ERC20(name_, symbol_) ERC20Capped(totalSupply) {
     ...
     * - total supply after mint can not exceed token cap.
     */
