...
contract SmolverseLand is
    Initializable,
    SmolverseLandContracts,
    ERC721Upgradeable
{
    ...
    function privilegedMint(
        address _to,
        uint256 _tokenId
    ) external requiresEitherRole(OWNER_ROLE, LAND_PRIVILIGED_MINTER_ROLE) {
    ...
    function migrate(uint256 _tokenId) external {
        ...
        address randomDeadAddress = address(
            uint160(0xdEad000000000000000000000000000000000000) +
                uint160(_tokenId)
        );
    ...
    function setBaseURI(
        string memory _baseLandURI
    ) external requiresEitherRole(OWNER_ROLE, ADMIN_ROLE) {
...
abstract contract SmolverseLandState is
    Initializable,
    ISmolverseLand,
    UtilitiesV2Upgradeable
{
    bytes32 internal constant LAND_PRIVILIGED_MINTER_ROLE =
        keccak256("LAND_PRIVILIGED_MINTER");
