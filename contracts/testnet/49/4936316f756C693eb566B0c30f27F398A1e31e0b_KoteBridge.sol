...
contract KoteBridge is Ownable, ReentrancyGuard {
    ...
    address KOTE_ITEMS;
    address SIGNER = 0x471ca92b32f0D38a72b5CB2037ce4C07eaD8AFC3;

    mapping(address wallet => uint256 nonce) depositNonce;
    mapping(address wallet => mapping(uint256 nonce => bool used)) withdrawalNonceUsed;
