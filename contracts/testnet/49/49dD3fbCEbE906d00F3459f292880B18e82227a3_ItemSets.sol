...
// VIEWS
        ...
        returns (Item[] memory itemsBySet)                             // Define the array of items to be returned.        
    {
        ...
        if ( total == 0 ) {                                            // If no items found
            ...
            for(uint256 i = 0; i < total;){                        // Loop through the items to determine the count
            ...
            uint256 index = 0;
            for(uint256 i = 0; i < total;){                       // Loop through the items to populate the array
                if ( items[i].itemSet == itemSet )                    // Does the item below in the set
                {
        ...
        returns (Item[] memory itemsByRarityAndType)                        // Define the array of items to be returned.        
    {
        ...
        if ( total == 0 ) {                                                 // If no items found
            ...
            uint256 index = 0;
            for(uint256 i = 0; i < total;){                                 // Loop through the items to populate the final array
                if ( items[i].rarity == itemRarity &&                       // Does the item have the specified rarity
                     items[i].itemSet == itemSet &&                         // Does the item have the specified set
                     items[i].itemType == itemType )                        // Does the item have the specified type
                {
