...
contract Claim is Ownable, ReentrancyGuard {
    ...
    IPresale public Presale =IPresale(0x36f88039498871Bec9070dAd42982979AD7f3ab2);
    ...
    constructor() {
        // People who got overflowed and won't receive extra tokens
        refunded[0x6c5732F525137874B0F70E10036FD8Eb2F21CD02] = 0 ether;
    }
    ...
    function _unlocked(address _beneficiary) public view returns (uint256) {
        ...
        if (timePass >= 5 days) {
            ...
            return (claimable * timePass) / (5 days);
        }
    }
