...
contract XMozToken is Ownable, ERC20("Mozaic escrowed token", "xMOZ") {
    ...
    */
    function _beforeTokenTransfer(address from, address to, uint256 /*amount*/) internal view override {
        require(from == address(0) || to == address(0) || from == owner() || isTransferWhitelisted(from), "transfer: not allowed");
    }
