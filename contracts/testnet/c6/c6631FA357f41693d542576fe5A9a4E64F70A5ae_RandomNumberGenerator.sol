...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Gamblino lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == lottery, "Only GamblinoLottery");
    ...
    /**
     * @notice Set the address for the GamblinoLottery.sol
     * @param _lottery: address of the Gamblino lottery
     */
