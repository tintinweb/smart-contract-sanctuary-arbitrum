...
contract DeltaGovernor is Governor,
                          GovernorSettings,
                          ...
                          GovernorTimelockControl
{
    ...
    constructor(IVotes _token,
        ...
        Governor("DeltaGovernor")
        GovernorSettings(initialVotingDelay,
                         initialVotingPeriod,
                         0)
    ...
    {
        require(initialVotingDelay >= 0, 'Initial supply has to be greater than or equal to 0');
        require(initialVotingPeriod > 0, 'Voting period has to be greater than 0');
    }
    ...
    function _cancel(address[] memory targets,
                     uint256[] memory values,
                     bytes[] memory calldatas,
                     bytes32 descriptionHash)
        internal
