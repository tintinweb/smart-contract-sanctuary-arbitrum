...
contract GenesisNFT is ERC721, Ownable{
    ...
    uint256[3] private mintPrice = [0.001 ether, 0.002 ether, 0.003 ether];
    uint256[3] private mintTime = [1681948800, 1682035200, 1682121600];
    uint private mintInterval = 1 days;
    uint256[3] private mintRound = [1000, 2000, 7000];
    uint256 public TOTAL_SUPPLY = 10000;
    uint256[3] private soldRound;
    ...
    mapping (address => uint256) private whiteListLevel;

    mapping (address => bool) private waitList;

    mapping (address => uint256) private ownerToGenesis;
