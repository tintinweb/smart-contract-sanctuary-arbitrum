...
// test
    ...
    uint256 public from2;
    uint256 public from3;
    ...
    function DoQuestOnDay(address user) public
    {
        ...
        from1 = 0;
         to1 = TotalQuestionContract.div(TotalQuestionOnDay).sub(1);

         from2 = to1.add(1);
         to2 = from2.add(TotalQuestionContract.div(TotalQuestionOnDay).sub(1));

         from3 = to2.add(1);
         to3 = TotalQuestionContract.sub(1);
