    ...
    INexa
{
    ...
    function bridgeOut(
        ...
        ICATERC721.CATPayload memory transfer = ICATERC721.CATPayload({
            uri: uriString,
            tokenId: tokenId,
    ...
    function bridgeIn(ICATERC721.CATPayload memory transfer) internal {
        ...
        _mint(protocolPayloadRecipient, transfer.tokenId);
    ...
    function nexaReceive(bytes32 payloadSender, uint256 srcChain, bytes memory payload, bytes32) external override {
        ICATERC721.CATPayload memory transfer = abi.decode(payload, (ICATERC721.CATPayload));
...
contract CATNFTFacet is Context {
    ...
    */
	function deployNFT(
		...
		CATERC721(tokenAddress).initialize(diamondStorage.routingEngine, protocolPriority, diamondStorage.chainId , totalSupply, baseUri);
