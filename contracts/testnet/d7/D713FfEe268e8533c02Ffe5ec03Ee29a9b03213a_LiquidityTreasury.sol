...
contract LiquidityTreasury is OwnableAdmin {
    /* ======== DEPENDENCIES ======== */
     ...
     *  @param _amountPayoutToken uint amount of tokens needed as payout for bonder
    ...
    function toggleBondContract(address _bondContract) external onlyAdmin {
        require(IMultiVesting(_bondContract).payoutToken() == payoutToken, "different payout");
