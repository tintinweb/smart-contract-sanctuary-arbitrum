...
contract IsTokenAddrContract {
    ...
    function isTokenAddress(address token, address account) public view returns(bool isToken, TokenInfoStructs.TokenInfo memory info) {
    ...
    function isLPAddress(address token) public view returns(bool isLP) {
