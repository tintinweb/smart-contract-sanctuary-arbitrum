...
contract KEIManager is Owned {
    ...
    function getStablecoinReserve(address _stablecoin) public returns(uint256) {
        return stablecoinReserves[_stablecoin];
    }

    function getTotalUserDeposits() public returns(uint256) {
        return totalUserDeposits;
    }

    function getSupportedStablecoins() public returns(address[] memory) {
...
contract ReserveController is Owned {
    ...
    function calculatePenalty(address _stablecoin, uint256 depositAmount) public returns (uint256) {
    ...
    function maxDepositWithoutPenalty(address _stablecoin, uint256 totalReserves) public returns (uint256) {
    ...
    function calculatePercentage(address _stablecoin) public returns (uint256) {
        uint256 totalReserves = KEIMgr.getTotalUserDeposits();
