    ...
    IGameRegistry
{
    ...
    uint256 public constant OPERATOR_MESSAGE_TIME_LIMIT = 60 * 60; // 1 hour
    ...
    /// @notice Invalid block timestamp (future block)
    error InvalidBlockTimestamp();

    /// @notice Expired block timestamp (time to send has passed)
    error ExpiredBlockTimestamp();
     ...
     * @param timestamp the message was signed at
     */
    ...
    function registerOperator(
        ...
        // }
        // if (block.timestamp > (timestamp + OPERATOR_MESSAGE_TIME_LIMIT)) {
        //     revert ExpiredBlockTimestamp();
        // }
