...
contract AIHuman is ERC1155, Ownable, Pausable, ERC1155Supply {
    uint256 public publicPrice = 0.01 ether;
    uint256 public allowListPrice = 0.001 ether;
    uint256 public allCollectionUniqueSupply = 4;
    uint256 public singleNftMaxSupply = 10000;
    uint256 public singleNftCurrentSupply;
    bool public mintOpen = true;
    bool public allowListMintOpen = false;
    mapping(address => bool) public allowList;

    constructor()
        ERC1155("ipfs://QmPRasNbwA7kezEwXdhHZaesqwVmo6r9F5sCsndEYPYzHX/")
    {}
    ...
    function _mintToken(
        ...
        require(id >= 0 && id < allCollectionUniqueSupply, "Nft not found");
        require(
    ...
    function withdraw(address _addr) external onlyOwner {
        ...
        payable(_addr).transfer(contractBalance);
    }
