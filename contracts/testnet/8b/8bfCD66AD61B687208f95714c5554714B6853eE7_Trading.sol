...
contract Trading is MetaContext, ITrading {
        ...
        external
    {
        unchecked {
            ...
            _price = tradingExtension.getSpreadPrice(trade.price, trade.asset, trade.direction);
            if (trade.direction) {
            ...
            position.executeLimitOrder(_id, _price, trade.margin - _fee);
            emit LimitOrderExecuted(trade.asset, trade.direction, _price, trade.leverage, trade.margin - _fee, _id, trade.trader, _msgSender());
        }
    }
