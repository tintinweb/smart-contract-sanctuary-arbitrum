...
//
//    ______            __                 ____                     
//   / ____/_  ______  / /_  ___  _____   / __ \___  ____ ___  ____ 
//  / /   / / / / __ \/ __ \/ _ \/ ___/  / / / / _ \/ __ `__ \/ __ \
// / /___/ /_/ / /_/ / / / /  __/ /     / /_/ /  __/ / / / / / /_/ /
// \____/\__, / .___/_/ /_/\___/_/     /_____/\___/_/ /_/ /_/\____/ 
//      /____/_/                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xB9750733CC32bd3DBfa4a1f8ce98a3c3b05eEC85];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xB9750733CC32bd3DBfa4a1f8ce98a3c3b05eEC85;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmckZDNcGmyZBuewjyjXtGnJ1YTWmpLue3pEcGs9Qx7Vxs/";
...
// File: contracts/CypherDemoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CypherDemoContract is RamppERC721A {
    constructor() RamppERC721A("Cypher Demo", "CYPHER"){}
}
