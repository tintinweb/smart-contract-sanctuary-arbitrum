...
// ADMIN FUNCTIONS
    ...
    function registerItem(uint256 itemID, uint256 itemSet, uint256 itemValue1, uint256 itemValue2)
        ...
        onlyOwner
    {
        // Store the item rarity & type in local variable
        ItemType memory item = itemsContract.getItem(itemID);
        // Write the items to mappings
        itemSetByRarity[itemSet][item.rarity].push(Item(itemID, item.itemType, itemSet, item.rarity, itemValue1, itemValue2));
        itemsBySet[itemSet].push(Item(itemID, item.itemType, itemSet, item.rarity, itemValue1, itemValue2));
        ...
        // Write an event
        emit ItemRegistered (_msgSender(), itemID, item.itemType, item.rarity, itemSet);
    }
...
// VIEWS
    ...
    /// @dev Retrieve list of Items sets
        function getAllItemSets()
        external
        view
