...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an ANS node.
    ...
    /**
     * Returns the ABI associated with an ANS node.
     * Defined in EIP205.
    ...
    ResolverBase
{
    ...
    /**
     * Sets the address associated with an ANS node.
     * May only be called by the owner of that node in the ANS registry.
     * @param node The node to update.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an ANS node.
     * May only be called by the owner of that node in the ANS registry.
     * @param node The node to update.
    ...
    /**
     * Returns the contenthash associated with an ANS node.
     * @param node The ANS node to query.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an ANS node, for reverse records.
     * May only be called by the owner of that node in the ANS registry.
     * @param node The node to update.
     */
    ...
    /**
     * Returns the name associated with an ANS node, for reverse records.
     * Defined in EIP181.
     * @param node The ANS node to query.
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an ANS node.
     * @param node The ANS node to query
    ...
    /**
     * Returns the SECP256k1 public key associated with an ANS node.
     * Defined in EIP 619.
     * @param node The ANS node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an ANS node and key.
     * May only be called by the owner of that node in the ANS registry.
     * @param node The node to update.
    ...
    /**
     * Returns the text data associated with an ANS node and key.
     * @param node The ANS node to query.
...
abstract contract ResolverBase is ERC165, IVersionableResolver {
    ...
    /**
     * Increments the record version associated with an ANS node.
     * May only be called by the owner of that node in the ANS registry.
     * @param node The node to update.
     */
