...
contract Evm721StarterUSDC is ERC721, Ownable {
    ...
    uint256 price = 10 * 10 ** 6; // 1200 USDC (because usdc is a 6 decimal ERC20 token)
    string public baseUri = "https://bafkreifyb5jetemu2qf2pbid7246kvsumzsqim5z3jabr5zrb3fukh35ki.ipfs.nftstorage.link";
    uint256 public arbPrice = 1 * 10**6; // 1 ERC20 token with 6 decimals
    ...
    // PUBLIC
        ...
        payable
    {
        require(msg.value == arbPrice * _quantity, "Must send correct amount of ETH");
