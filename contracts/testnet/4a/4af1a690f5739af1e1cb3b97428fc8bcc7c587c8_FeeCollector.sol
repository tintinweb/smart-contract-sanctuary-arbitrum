...
contract FeeCollector is Pausable, ReentrancyGuard, AccessControlBase, IFeeCollector {
    ...
    constructor(
        ...
        whitelistedDestinations[_buyburnContract] = true;
    }
    ...
    function setClaimContract(
        ...
        whitelistedDestinations[wlpClaimContract] = false;
        wlpClaimContract = _wlpClaimContract;
        whitelistedDestinations[_wlpClaimContract] = true;
    ...
    function setBuyBackContract(
        ...
        whitelistedDestinations[buybackContract] = false;
    ...
    function setStakingContract(
        ...
        whitelistedDestinations[winrStakingContract] = false;
        winrStakingContract = _winrStakingContract;
        whitelistedDestinations[_winrStakingContract] = true;
    ...
    function setCoreDevelopment(
        ...
        whitelistedDestinations[coreDevelopment] = false;
        coreDevelopment = _coreDevelopment;
        whitelistedDestinations[_coreDevelopment] = true;
    ...
    /**
     * @notice collect the wagerFees from the vault manually
     * @param _tokenToCollect address of the token
     */
    ...
    /**
     * @notice collect the swap fees from the vault manually
     * @param _tokenToCollect address of the token
     */
    ...
    function emergencyDistributionToTimelock() external onlyManager {
        ...
        for (uint256 i = 0; i < wlTokens_.length; i++) {
            ...
            uint256 bal_ = ERC20(wlTokens_[i]).balanceOf(address(this));
    ...
    function manualDistributionTo(
        ...
        SafeTransferLib.safeTransfer(ERC20(_targetToken), _destination, _amount);
    ...
    /**
     * @notice calculates what is a percentage portion
     * @param _amountToDistribute amount to charge the fee over
     * @param _ratio basis point percentage scaled 1e4
     */
