 ...
 *
 * Bluebird AI : Powered by Stability AI's Stable Diffusion
 *
 * Telegram: https://t.me/bluebirdAI_chat
 * Twitter: https://twitter.com/Bluebird_AI
 * Homepage: https://bluebirdai.io/
 * Discord: 
 * 
 * Total Supply: 10 Billion Tokens
 * Unlock rendering & Add our AI Bot to your Telegram channel at our homepage!
 *
 * Set slippage to 3-4% : 1% to LP for buy tax, 2% to LP for sell tax, 1% tax for Marketing & GPU Hosting costs.
 */
...
contract BBAI is ERC20, Ownable {
    ...
    uint256 public sellTaxForLiquidity = 47; //sniper protection, to be lowered to 1% after launch
    uint256 public buyTaxForLiquidity = 47; //sniper protection, to be lowered to 1% after launch
    ...
    function launchpad() external onlyOwner {
        sellTaxForLiquidity = 2;
    ...
    function _transfer(
        ...
        if (
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                marketingShare = ((amount * taxForMarketing) / 100);
    ...
    function changeTaxForLiquidityAndMarketing(
        ...
        require(
            (_buyTaxForLiquidity + _sellTaxForLiquidity +  _taxForMarketing) <= 10,
