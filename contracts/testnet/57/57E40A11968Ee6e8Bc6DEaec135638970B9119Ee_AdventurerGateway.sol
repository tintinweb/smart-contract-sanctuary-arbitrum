...
contract AdventurerGateway is ManagerModifier {
  //=======================================
  // Bytes
  //=======================================
  ...
  // External
  //=======================================
  function checkAddress(address _addr, bytes32[] calldata _proof)
    external
    view
    onlyManager
  {
    ...
    require(isValidLeaf, "AdventurerGateway: Address not supported");
  }
