...
contract GigaSBTV2 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    function initialize(string memory uri) initializer public {
        ...
        __Ownable_init();
        __EIP712_init("GigaSpace Achievement", "1");
        __ERC721Votes_init();

        _baseTokenURI = uri;
    }

    function setsbtAttribute(string memory attr) external onlyOwner {
        _sbtAttribute = attr;
    }
