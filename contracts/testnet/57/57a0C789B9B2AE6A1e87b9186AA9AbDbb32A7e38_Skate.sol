...
abstract contract SkateAdmin is Initializable, SkateState {
    ...
    function __SkateAdmin_init() internal initializer {
        price = 25;
    ...
    modifier contractsAreSet() {
        require(areContractsSet(), "SkateAdmin: Contracts aren't set");
        _;
    }

    function areContractsSet() public view returns (bool) {
        return
            address(skateMetadata) != address(0) &&
