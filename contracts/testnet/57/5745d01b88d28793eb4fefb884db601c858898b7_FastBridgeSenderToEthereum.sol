...
// File: bridge/interfaces/IFastBridgeSender.sol
...
// File: bridge/interfaces/ISafeBridgeSender.sol
...
// File: bridge/interfaces/arbitrum/AddressAliasHelper.sol
...
// File: bridge/interfaces/arbitrum/IArbSys.sol
...
// File: bridge/SafeBridgeSenderToEthereum.sol
...
// File: bridge/FastBridgeSenderToEthereum.sol
...
contract FastBridgeSenderToEthereum is SafeBridgeSenderToEthereum, IFastBridgeSender {
    ...
    function sendFast(address _receiver, bytes memory _calldata) external override {
        ...
        emit MessageReceived(_receiver, messageHash, _calldata);
    }
     ...
     */
    function sendSafeFallback(uint _epoch) external payable override {
    ...
    function _encode(
        ...
        bytes memory messageData = abi.encodePacked(_receiver, abi.encodeWithSelector(functionSelector, msg.sender, _args));
