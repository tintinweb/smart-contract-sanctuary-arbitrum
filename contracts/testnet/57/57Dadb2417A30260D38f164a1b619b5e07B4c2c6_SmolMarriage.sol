 ...
 */
contract SmolMarriage is ReentrancyGuard, AccessControl, ISmolMarriage {
    ...
    function requestMarriage(
        ...
        require(
            ...
            "SMOLMARRIAGE:CREATURES_OF_SAME_OWNER_CANNOT_MARRY"
        );
    ...
    function divorce(
        ...
        staking.unstake(redeemRing, creature1, creature2, msg.sender);
