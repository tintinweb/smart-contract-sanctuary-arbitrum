...
contract PancakePredictionV2 is Ownable, Pausable, ReentrancyGuard {
     ...
     * @param _keeperAddress: keeper address
     ...
     */
    function executeRound(uint80 currentRoundId, int256 currentPrice) external whenNotPaused onlyKeeper {
        require(
     ...
     * @dev Callable by operator
     */
    function genesisLockRound(uint80 currentRoundId, int256 currentPrice) external whenNotPaused onlyKeeper {
     ...
     * @dev Callable by admin
     */
    function setMinBetAmount(uint256 _minBetAmount) external whenPaused onlyAdminOrOperator {
     ...
     * @dev Callable by admin
     */
    function setKeeper(address _keeperAddress) external onlyAdminOrOperator {
     ...
     * @dev Callable by admin
     */
    function setOracleUpdateAllowance(uint256 _oracleUpdateAllowance) external whenPaused onlyAdminOrOperator {
        oracleUpdateAllowance = _oracleUpdateAllowance;
     ...
     * @dev Callable by admin
     */
    function setTreasuryFee(uint256 _treasuryFee) external whenPaused onlyAdminOrOperator {
        require(_treasuryFee <= MAX_TREASURY_FEE, "Treasury fee too high");
        treasuryFee = _treasuryFee;
     ...
     */
    function recoverToken(address _token, uint256 _amount) external onlyAdminOrOperator {
     ...
     * @dev Callable by owner
     */
    function setAdmin(address _adminAddress) external onlyAdminOrOperator {
