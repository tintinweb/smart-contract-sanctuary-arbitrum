...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Todo Trade: What router is this?
    ...
    constructor (address _router) { //Todo Trade: On deployment
...
contract Axolotl_AI is ERC20, Ownable { //IsIBEP20 ?
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Todo Trade: whats this, Uniswap likely. Seems to already be testnet sushiswap
    ...
    constructor(
        ...
        address _factory, //0x6eccab422d763ac031210895c81787e87b43a652      //Testnet: 0x659fd9F4536f540bd051c2739Fc8b8e9355E5042
        address _swapRouter, //0xc873fecbd354f5a56e00e710b90ef4201db2448d //testnet: 0xA91527e5a4CE620e5a18728e52572769DcEcdb99
    ...
    function _axoTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = shouldTakeFee ? takeFee(sender, amount) : amount; //Calculate after fee amount to send; maybe refactor
