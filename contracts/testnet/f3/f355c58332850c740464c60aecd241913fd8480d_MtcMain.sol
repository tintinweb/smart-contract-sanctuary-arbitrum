...
contract MtcMain is Context, Ownable{
    ...
    constructor() public {
        ...
        IERC20(mtcToken).approve(_router, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
    ...
    function swap(uint256 _amount) public workstatus{
        ...
        path[0] = mtcToken;
        path[1] = wbnbToken;
        IERC20(mtcToken).transferFrom(msg.sender, address(this),_amount);
