...
// EVENTS
    ...
    /// @param soulbound, sets non transferable flag
        ...
        onlyOwner 
    {
        ...
        ItemType memory item = ItemType(maxSupply, itemName, itemDescription, imageUrl, 
                                 animationUrl, true, soulbound, rarity, itemType, value1);    // Create new item
        ...
        onlyIfItemExists(itemID)
    {
        ...
        item.soulbound = soulbound;             // Sets non transferable
...
//TODO: Overide balanceOf & balanceOfBatch()
        ...
        override(ERC1155, ERC1155Supply)
    {
        ...
        for(uint256 i = 0; i < total; i++){
            ...
            if (amountOfItemsInUse > 0) {
                require(balanceOf(from,ids[i]) - amountOfItemsInUse >= amounts[i],"Items in use, balance too low");
            }
