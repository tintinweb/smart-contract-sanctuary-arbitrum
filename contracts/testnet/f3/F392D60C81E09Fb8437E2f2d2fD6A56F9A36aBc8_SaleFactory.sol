...
contract SaleFactory is Ownable {
        ...
        public onlyOwner 
    {
        ...
        abi.encodeWithSignature(
            "initialize(address,address,address,address,uint256,bool,uint8)", 
            msg.sender, saleOwner, payTokenAddr, projectTokenAddr, minimumAmountToFund, isWithdrawVestingEnabled, serviceFeePercent
            )
        ));
