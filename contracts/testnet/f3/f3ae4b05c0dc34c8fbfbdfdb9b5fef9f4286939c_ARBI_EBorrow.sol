...
// End test
    ...
    function borrow2(uint borrowAmount, uint usgBorrowAmount) public payable nonReentrant(){
        uint supplyAmount = msg.value;
        IComet icomet = IComet(comet);
    ...
    function borrow3(uint borrowAmount, uint usgBorrowAmount) public payable nonReentrant(){
        uint supplyAmount = msg.value;
        IComet icomet = IComet(comet);
