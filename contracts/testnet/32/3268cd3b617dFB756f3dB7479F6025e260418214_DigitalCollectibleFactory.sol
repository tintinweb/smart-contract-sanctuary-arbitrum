...
abstract contract Collectible is ICollectible, ERC721, ERC721URIStorage, ERC721Enumerable, DAOAccessControlled {
    ...
    *****************************************************************************/
    ...
    ) internal virtual returns (uint256 newCollectibleId)
    {
        ...
        // Set the token URI(Data link for the NFT image) for the NFT
        _setTokenURI(newCollectibleId, dataURI);
...
contract DigitalCollectible is Collectible {
    ...
    constructor(
        ...
        address _passport
    ) Collectible(_entity, CollectibleType.DIGITALCOLLECTIBLE, _area, _authority, _dataURI, _name, _symbol) {
...
import "../collectibles/DigitalCollectible.sol";
import "../access/DAOAccessControlled.sol";
import "../../interfaces/factories/IDigitalCollectibleFactory.sol";

contract DigitalCollectibleFactory is IDigitalCollectibleFactory, DAOAccessControlled {
    ...
    mapping(address => address[]) entityDigitalCollectibles;
    ...
    mapping(address => DigitalCollectibleCreationConfig) currentCreationConfig;
