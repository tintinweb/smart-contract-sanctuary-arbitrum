...
contract DegenLotto is Context, ERC20, Ownable {
    address public constant uniswapRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Update this address if necessary
    address public constant WETH_ADDRESS = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // Update this address if necessary
    ...
    function _convertLotteryTaxToWETH(uint256 lotteryTax) private {
    // Approve the Uniswap router to spend the lottery tax amount
    _approve(address(this), uniswapRouterAddress, lotteryTax);
    ...
    // Swap tokens
    uniswapRouter.swapExactTokensForTokens(lotteryTax, 0, path, lotteryWallet, deadline);
}
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        _convertLotteryTaxToWETH(lotteryTax);
