 ...
 */
contract EMPLToken is Ownable, ERC20Pausable, ERC20Burnable, ERC20BlackListable, AccessControl, EmergencyWithdrawable, OFT {
     ...
     */
    constructor(string memory _name, string memory _symbol, uint256 initialSupply, address _lzEndpoint) OFT(_name, _symbol, _lzEndpoint) {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControl, OFT) returns (bool) {
        return AccessControl.supportsInterface(interfaceId) || OFT.supportsInterface(interfaceId);
    }
}
