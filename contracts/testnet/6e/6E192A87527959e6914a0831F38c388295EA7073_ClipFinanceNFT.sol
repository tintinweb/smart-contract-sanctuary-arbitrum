...
contract ClipFinanceNFT is ERC721Enumerable, AccessControl {
     ...
     */
    function reserveNFT(uint256 _amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(totalSupply() + _amount <= maxNFTs, "Maximum Supply Reached!");
    ...
    function inviteListMint(
        ...
        require(
            totalSupply() + _numberOfTokens <= maxNFTs,
            "Max Supply Reached"
        );
        require(
     ...
     */
    function mintNFTs(uint256 _numberOfTokens) public payable {
