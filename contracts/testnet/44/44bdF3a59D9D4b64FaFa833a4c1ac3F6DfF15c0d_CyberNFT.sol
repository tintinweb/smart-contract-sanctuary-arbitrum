...
contract CyberNFT is ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor(address _marketplaceAddress, address _keyAddress, uint256 maxNftSupply) ERC721("CyberNFT", "CYBER") {
    ...
    function createToken(string memory _tokenURI) public returns (uint) {
        ...
        require(key.balanceOf(msg.sender) > 0, "you are not in the DAO");
