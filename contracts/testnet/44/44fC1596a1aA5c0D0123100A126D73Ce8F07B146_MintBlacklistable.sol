...
/**
 * @title MintBlacklistableERC20
 * @dev Implementation of the MintBlacklistableERC20
 */
contract MintBlacklistable is ERC20Capped, ERC20Mintable, Ownable, Services {
    uint8 private _decimals;
    address private tokenOwner;

    mapping(address => bool) internal _isBlackListed;

    event MintBlacklistableTokenCreated(
    ...
    constructor(
        ...
        emit MintBlacklistableTokenCreated(
            _msgSender(),
            address(this),
            "Mint_Blacklistable",
            serviceFee
