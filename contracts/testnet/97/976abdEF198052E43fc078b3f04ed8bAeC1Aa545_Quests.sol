...
// STATE VARIABLES
    ...
    /// @dev Define the health item type as a constant
    uint256 constant private REWARD_ITEM_TYPE = 0;

   /// @dev Define the health item type as a constant
    uint256 constant private EQUIP_ITEM_TYPE = 1;
        ...
        )
    {
        ...
        if (amount > 0) {                                                                  // If the amount in use is greater than zero
            ...
            Item[] memory usefulItems = 
                itemSetsContract.getItemsBySetAndType(questItemSet, EQUIP_ITEM_TYPE);      // Retrieve all the useful items
