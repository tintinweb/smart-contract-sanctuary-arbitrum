...
import {ILyLevel} from "../interfaces/ILyLevel.sol";
...
contract TradingIncentiveController is Initializable, OwnableUpgradeable, ITradingIncentiveController {
    ...
    IERC20 public LVL = IERC20(0xc9023E8D5430cE47d100E5221B927189A7F725A6);
    IERC20 public PRE_LVL = IERC20(0x6749B64866479Bc08136bC61de1C520D87ffbc30);

    uint256 public MIN_EPOCH_DURATION = 1 hours;
    uint256 public MAX_REWARD_TOKENS = 15_000e18;
    uint256 public STEP_REVENUE = 50_000e30;
    uint256 public BASE_REVENUE = 100_000e30;
    uint256 public STEP_REWARD = 10_000e30;
    uint256 public AMOUNT_LOYALTY_REWARD = 5_000e18;
    uint256 public START_EPOCH_USING_PRE_LVL = 1; // arb
