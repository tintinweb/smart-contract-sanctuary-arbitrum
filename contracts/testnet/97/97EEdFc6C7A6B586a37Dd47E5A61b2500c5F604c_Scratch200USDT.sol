    ...
    ReentrancyGuard
{
    ...
    uint256 public ticketPrice = 10 * 10 ** DECIMALS; // 10 USDT (USDT has 6 decimals)
    uint256 public totalTicketCount = 159000;
    uint256 private emptyTickets = 141800;
    enum CardResult {
        LOSS,
        WIN50,
        WIN100,
    ...
    constructor(
         ...
         */
        generationCounts[CardResult.WIN200] = 890;
        generationCounts[CardResult.WIN100] = 4000;
        generationCounts[CardResult.WIN50] = 12310;

        rewardAmounts[CardResult.WIN200] = 200;
        rewardAmounts[CardResult.WIN100] = 100;
        rewardAmounts[CardResult.WIN50] = 50;
