...
contract FinalFormCards is ERC721URIStorageUpgradeable, ERC721EnumerableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_, string memory baseUri_, address mintOracleAddress_, address chromosAddress_) initializer public {
    ...
    function burnLegendary(uint256 tokenId, address who) external {
