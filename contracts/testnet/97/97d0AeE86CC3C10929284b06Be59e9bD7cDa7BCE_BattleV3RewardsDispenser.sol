...
contract BattleVersusV3 is ReentrancyGuard, Pausable, ManagerModifier {
  ...
  function fight(FightRequest calldata _request) external nonReentrant whenNotPaused {
    ...
    uint256 currentEpoch = ACTION_PERMIT.checkAndMarkActionCompleteMany(
      msg.sender,
  ...
  function _fight(
    ...
    result.overallWin = result.wins >= REQUIRED_WINS;
