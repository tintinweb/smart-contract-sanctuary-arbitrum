...
contract VaultUtils is IVaultUtils, BasePositionConstants, Constants, Ownable {
    ...
    function validateRemoveCollateral(
        ...
        _position.previousFee += borrowFee;
    ...
    function calculatePnl(
        ...
        {
            priceDiff = _indexPrice >= _position.averagePrice ? _indexPrice - _position.averagePrice 
                : _position.averagePrice - _indexPrice;
            multiplier = _position.isLong ? (_indexPrice >= _position.averagePrice ? int256(1) : int256(-1)) 
        ...
        {
            (tradingFee, fundingFee) = _calculateFees(_sizeDelta, _loanDelta, _isApplyBorrowFee, _isApplyFundingFee, _position);
