...
contract Registry is IRegistry, UUPSUpgradeable, SafeOwnableUpgradeable {
    ...
    function getDegen() public view returns (address) {
        return _degen;
    }

    function getPortal() public view returns (address) {
        return _portal;
    }

    function getShovel() public view returns (address) {
        return _shovel;
    }

    function getPiggyBank() public view returns (address) {
        return _piggyBank;
    }
}