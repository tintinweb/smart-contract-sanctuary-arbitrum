...
contract LBPGWOMint is Ownable {
    address public LBPGWO = 0x5d15dE0142Cf1A9c524c7e426C85aD74Ba4A3E53;
    mapping(address => uint256) public usermint;
    mapping(address => bool) public userclaim;
    uint256 public userClaimedAmount;
    bytes32 private _merkleRoot =
        0xae92f88c3e2ad76498d1526607eb1fdbd0add8036101e06a97ddfc980dc489fc;
    ...
    function mintLBPGWO(uint256 _quantity) external payable {
        ...
        require(
            msg.value >= _quantity * LBPGWOmintPrice,
            "Ether is not enough"
        );
    ...
    function claimLBPGWO(
        ...
        require(
            IERC20(LBPGWO).balanceOf(address(this)) > 0,
            "claim has ended."
        );
    ...
    function changeLBPGWOmintPrice(
        uint256 LBPGWOmintPrice_
    ) external onlyOwner {
        LBPGWOmintPrice = LBPGWOmintPrice_;
    }

    function changeSingleMintAmount(
        uint256 SingleMintAmount_
    ) external onlyOwner {
    ...
    function changeSingleClaimAmount(
        uint256 SingleClaimAmount_
    ) external onlyOwner {
