...
contract MerkleDistributor {
  ...
  function claim(address to, uint256 amount, bytes32[] calldata proof) public virtual {
...
contract MerkleDistributorWithDeadline is MerkleDistributor, Ownable {
    ...
    function claim(address to, uint256 amount, bytes32[] calldata proof) public override {
      if (block.timestamp > endTime) revert ClaimWindowFinished();
      super.claim(to, amount, proof);
}
