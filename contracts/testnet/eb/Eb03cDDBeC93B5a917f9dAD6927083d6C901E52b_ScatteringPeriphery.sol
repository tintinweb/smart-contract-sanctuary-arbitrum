...
contract ScatteringGetter {
    ...
    {
        uint256 val = uint256(_scattering.extsload(keccak256(abi.encode(TRIAL_DAYS_SLOT))));
    ...
    function getPayment() public view returns (address paymentToken, uint256 paymentAmount) {
        ...
        paymentAmount = uint256(_scattering.extsload(keccak256(abi.encode(PAYMENT_AMOUNT_SLOT))));
    }
