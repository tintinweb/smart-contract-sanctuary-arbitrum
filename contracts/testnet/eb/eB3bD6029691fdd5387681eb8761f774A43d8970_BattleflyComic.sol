...
contract BattleflyComic is ERC1155Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC1155SupplyUpgradeable, IBattleflyComic {
    ...
    */
     ...
     */
    function uri(uint256 _comicId) public view virtual override(ERC1155Upgradeable, IBattleflyComic) returns (string memory) {
