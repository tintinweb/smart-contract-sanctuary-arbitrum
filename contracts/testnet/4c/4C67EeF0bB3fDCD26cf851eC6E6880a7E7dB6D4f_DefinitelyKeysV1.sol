...
contract DefinitelyKeysV1 is Ownable, ReentrancyGuard  {
    ...
    function createSubject(bytes32 inviteCode, bytes32 myInviteCode) public payable {
        ...
        emit Trade(msg.sender, msg.sender, true, 100, 0, 100, 100);
        (bool success, ) = protocolFeeDestination.call{value: 0.001 ether}("");
