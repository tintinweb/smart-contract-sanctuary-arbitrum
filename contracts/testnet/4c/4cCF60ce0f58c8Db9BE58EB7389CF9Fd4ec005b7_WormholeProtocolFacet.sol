...
contract WormholeProtocolFacet is IWormholeReceiver, Events, Setters {
    ...
    function wormholeSend(
        ...
        if (LibInternalGetters.bytesToAddress(protocol.endPoint).isContract()) {
            ...
            IWormholeRelayer(LibInternalGetters.bytesToAddress(protocol.endPoint)).sendPayloadToEvm{
                value: cost
            }(
    ...
    function receiveWormholeMessages(
        ...
        require(
            msg.sender == LibInternalGetters.bytesToAddress(chainProtocol.endPoint),
        ...
        bytes32 hash = keccak256(abi.encodePacked(deliveryHash, srcChain, srcAddress, payload));
