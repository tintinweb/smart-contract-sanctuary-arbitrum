...
contract WINRBlackJackV1 is IWINRBlackJackV1, CoreLight {
        ...
        returns (uint256 gameIndex_, uint32 handIndex_)
    {
        unchecked {
            ...
            // require(game_.status == GameStatus.FINISHED, "Blackjack: Game is not finished");
            require(game_.status == GameStatus.NONE || game_.status == GameStatus.FINISHED, "Blackjack: Game is not finished");
