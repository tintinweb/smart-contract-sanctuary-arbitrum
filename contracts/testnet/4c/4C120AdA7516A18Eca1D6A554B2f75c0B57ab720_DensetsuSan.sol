...
import "./DensetsuTraits.sol";
import "./Tsan.sol";

contract DensetsuSan is ERC721A,Ownable,AccessControl,ERC1155Holder {

    using Strings for uint256;
    //Traits
    //add trait contract address
    DensetsuTraits public traits = DensetsuTraits(address(0x8e964564EfC66344C4fbCEf6Fa2219F77A1328F0));
    ...
    string baseURI =  "https://densetsu-server.fra1.cdn.digitaloceanspaces.com/tamagosanMetadata/";
    ...
    traits = DensetsuTraits(_newTraitsAddress);
    }
...
import '@openzeppelin/contracts/utils/Strings.sol';
import './Tsan.sol';
import './DensetsuSan.sol';

contract DensetsuTraits is ERC1155, Ownable, AccessControlEnumerable, ERC1155Supply{
    ...
    string _baseURI = "https://densetsu-server.fra1.cdn.digitaloceanspaces.com/traitMetadata/";
