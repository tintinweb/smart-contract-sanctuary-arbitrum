...
contract PePeARB is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
       ...
       try swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(taxAmount,0,path,address(this),block.timestamp) {
        ...
        IAAPPBonus(bonusWallet).injectRewards(amountDogBonus);
        ...
        backToken.transfer(gov1Wallet, amountBackTokenGov);
        ...
        emit SwapBack(amountDogBurn, amountBackTokenGov, amountDogLp, amountDogBonus, amountBackTokenDev, block.timestamp);
    }
