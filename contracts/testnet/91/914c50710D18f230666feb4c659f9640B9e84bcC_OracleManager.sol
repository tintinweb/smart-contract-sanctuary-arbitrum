...
contract Oracle is AccessControl, IOracle {
        ...
        returns (uint256 price)
    {
        ...
        // FIXME so we are using close timestamp rounded from backend not actual block.timestamp, you need to take care that every time you will ask this oracle with close timestamp
        // I standardize time at exact minute from binary market.
