 ...
 * @notice 进化
 */
contract L2UnicornEvolutor is BaseGame {
    ...
    constructor(address randomizer_, address l2Unicorn_, address l2UnicornRule_, address recipient_) BaseGame(randomizer_) {
        maximum = 80;
