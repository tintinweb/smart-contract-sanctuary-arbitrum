...
contract SaleFactory is Ownable {
        ...
        public onlyOwner 
    {
        ...
        (bool success, ) = newSale.call(abi.encodeWithSignature(
            "initialize(address,address,address,address,bool,uint8)", 
            msg.sender, saleOwner, saleTokenAddr, tokenToSellAddr, isWithdrawVestingEnabled, serviceFeePercent
            )
        );
