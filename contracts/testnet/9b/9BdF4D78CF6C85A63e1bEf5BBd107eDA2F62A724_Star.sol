...
contract Star is StarState {
    ...
    function whitelistMint(
        ...
        for (uint256 i = 0; i < _count; i++) {
            ...
            _initStarMetadata(tokenIdCounter.current());
    ...
    function tokenURI(
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "Star #', tokenId.toString(), '",',
                '"tokenId": ', tokenId.toString(), '",',
                '"image": ', _placeholderURI(), '",',
                '"description": ', unicode"I’m Starving is an on-chain, story driven community experience and game on Arbitrum.", '",',
