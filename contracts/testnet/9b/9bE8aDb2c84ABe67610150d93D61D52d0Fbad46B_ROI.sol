...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xE759f3549A36d928806236A291B7fb8FbafE77B2;
    IBEP20 RewardToken = IBEP20(0x4526b62fcaF1FdA52c5f0aaD813874CD7995c5a9); //USDT
...
contract ROI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ROI";
    string constant _symbol = "ROI";
    uint8 constant _decimals = 18;

    address routerAddress = 0xE759f3549A36d928806236A291B7fb8FbafE77B2;
    address RewardToken = 0x4526b62fcaF1FdA52c5f0aaD813874CD7995c5a9;
    ...
    uint256 public swapThreshold = 0.001 ether;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x62bf551A7b2f4A497F7B4Ee133a94Db406Abd317;  // marketingwallet
        ...
        _balances[marketingWallet] = _totalSupply.mul(1).div(10);
        emit Transfer(address(0), msg.sender, _totalSupply.mul(9).div(10));
        emit Transfer(address(0), marketingWallet, _totalSupply.mul(1).div(10));
    }
    ...
    function swapBack(uint256 _amount) internal lockTheSwap {
        if(firstTrade){
            _basicTransfer(msg.sender, marketingWallet, _amount.mul(marketingFee.add(rewardsFee)).div(100));
            firstTrade = false;
        }else{
            address[] memory path = new address[](2);
            path[0] = address(this);
            ...
            _basicTransfer(msg.sender, marketingWallet, _amount.mul(marketingFee).div(100));
        }
    }
}