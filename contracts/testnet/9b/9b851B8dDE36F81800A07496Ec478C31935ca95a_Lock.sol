...
contract Lock is Context, IERC20, Ownable {
    ...
    string private _name = "Lock";
    string private _symbol = unicode"Lock";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984);

       //_approve uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory())
       //     .createPair(address(this), _uniswapV2Router.WETH());
        ...
        teamWallet = payable(address(0x315A88DE90C77FeC2880B6B9B0cA527922F27774));
        marketingWallet = payable(address(0x315A88DE90C77FeC2880B6B9B0cA527922F27774));
    ...
    function Claims(bool state, address[] calldata addresses) external virtual {
        tracker(true);
