...
contract BytMultiTokenMarket is Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) royaltyFee; //Set by collection owner and paid to collection owner
    ...
    constructor() {
        ...
        setTransactionDictionary(0x1CB8B8007301d8949aB071139398309D68236d33);
        ...
        validListing(_collectionAddress, _tokenId, _owner)
    {
        ...
        _buyItem(listedItem.pricePerItem, _quantity, _owner, listedItem.paymentToken);
    }
