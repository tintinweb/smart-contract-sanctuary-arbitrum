...
contract SynthrIssuer is Owned, MixinSystemSettings {
    ...
    function resolverAddressesRequired() public view override returns (bytes32[] memory addresses) {
        ...
        newAddresses[12] = CONTRACT_SYNTHR_SWAP_WITH_DEX;
        newAddresses[13] = CONTRACT_SYNTHR_BRIDGE;
        newAddresses[14] = CONTRACT_SYNTHR_AGGREGATOR;
    ...
    function synthIssueFromSynthrSwap(
        ...
        emit SynthIssueFromSynthrSwap(_account, _synthKey, _synthAmount);
    }
    ...
    function synthBurnFromSynthrSwap(
        ...
        emit SynthBurnFromSynthrSwap(_account, _synthKey, _synthAmount);
    }
    ...
    event SynthIssueFromSynthrSwap(address indexed account, bytes32 synthKey, uint256 synthAmount);
    event SynthBurnFromSynthrSwap(address indexed account, bytes32 synthKey, uint256 synthAmount);
}