...
contract dairyFarm is Ownable {
    ...
    uint256 public claimTaxCarrot = 15;
    ...
    function buyNode(uint256 _amount) external payable {  
        ...
        _transferFrom(carrot, msg.sender, address(this), toPool);
        _transferFrom(carrot, msg.sender, address(treasury), toTreasury);
        _transferFrom(carrot, msg.sender, address(dev), toDev);
    ...
    function claim() external payable {
		...
		if (reward > 0) {
            ...
            _transfer(carrot, address(treasury), toTreasury);
		}
	}
