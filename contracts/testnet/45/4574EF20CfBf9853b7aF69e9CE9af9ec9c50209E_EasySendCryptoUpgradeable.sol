...
contract EasySendCryptoUpgradeable is Initializable, AccessControlUpgradeable {
    ...
    uint16 public transfer_fee_rate;
    uint16 public swap_fee_rate;
    ...
    /// @param _transfer_fee_rate The uint16 number for transfer fee rate (0 ~ 10000) (10000 = 100%)
    /// @param _swap_fee_rate The uint16 number for swap fee rate (0 ~ 10000) (10000 = 100%)
    ...
    function initialize(
        uint16 _transfer_fee_rate,
        uint16 _swap_fee_rate,
        ...
        require(
            _transfer_fee_rate <= FEE_RATE_BASE,
            "EasySendCryptoUpgradeable.sol: Cannot set transfer_fee_rate more than 10000."
        );

        require(
            _swap_fee_rate <= FEE_RATE_BASE,
            "EasySendCryptoUpgradeable.sol: Cannot set swap_fee_rate more than 10000."
        );

        transfer_fee_rate = _transfer_fee_rate;
        swap_fee_rate = _swap_fee_rate;
    ...
    /// @param _new_transfer_fee_rate The new fee_rate value
    /// @param _new_swap_fee_rate The new fee_rate value
    function set_fee_rate(uint16 _new_transfer_fee_rate, uint16 _new_swap_fee_rate) external onlyAdmin {
        require(
            _new_transfer_fee_rate <= FEE_RATE_BASE,
            "EasySendCryptoUpgradeable.sol: Cannot set transfer_fee_rate more than 10000."
        );
        require(
            _new_swap_fee_rate <= FEE_RATE_BASE,
            "EasySendCryptoUpgradeable.sol: Cannot set swap_fee_rate more than 10000."
        );
        transfer_fee_rate = _new_transfer_fee_rate;
        swap_fee_rate = _new_swap_fee_rate;
    }
