...
contract Exploration is Initializable, ExplorationSettings {
    ...
    function ownerForUnstakedDonkey(uint256 _tokenId) external override returns(address) {
...
interface IExploration {
	...
	function ownerForUnstakedDonkey(uint256 _tokenId) external returns(address);
