...
// File: Neander/ContractControl.sol
...
contract NeanderSmol is ContractControl, ERC721Enumerable{
    ...
    function mint(bytes32[] calldata _merkleProof) external {
        ...
        require(MerkleProof.verify(_merkleProof, merkleRoot, leaf), "SmolNeander: Sender is not WL");
    ...
    function publicMint(uint256 amount) external{
        ...
        require(publicMinted[msg.sender] + amount <= 2, "SmolNeander: Max amount already minted");
