    ...
    LimitOrdersStorage
{
        ...
        returns (uint256)
    {
        ...
        if (_params.orderType == OrderType.TAKE_PROFIT) {
            ...
            if(_params.token0 == nftPositionManager.WETH9()){
                require(msg.value >= _params.amountOfToken0, "Not enough ETH");
                ITriadaWETH(nftPositionManager.WETH9()).deposit{value: _params.amountOfToken0}();
                if(msg.value - _params.amountOfToken0 > 0){
                    weth.depositFor(_msgSender(), msg.value - _params.amountOfToken0);
                }
            }
            else{
                ...
                if(msg.value > 0){
                    weth.depositFor(_msgSender(), msg.value);
                }
            }
            ...
            // Transfer tokens from user to us.
            if(_params.token1 == nftPositionManager.WETH9()){
                require(msg.value >= _params.amountOfToken1, "Not enough ETH");
                ITriadaWETH(nftPositionManager.WETH9()).deposit{value: _params.amountOfToken1}();
                if(msg.value - _params.amountOfToken1 > 0){
                    weth.depositFor(_msgSender(), msg.value - _params.amountOfToken1);
                }
            }
            else{
