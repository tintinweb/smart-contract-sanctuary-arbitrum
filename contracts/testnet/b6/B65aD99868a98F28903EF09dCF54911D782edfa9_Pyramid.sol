...
interface IWalletObserver {
  ...
  function isExcludedFromObserver(address account) external view returns (bool);
  ...
  PyramidsManagerPointer
{
  ...
  constructor() ERC20("Pyramid", "PRMD") {
    isSwapping = true;
    _mint(owner(), 10_000_000_000 * (10**18));
    isSwapping = false;
    setBuyFee(0); // 0% buy tax
    setSellFee(50); // 5% sell tax
  }
...
abstract contract WalletObserverPointer is Ownable {
