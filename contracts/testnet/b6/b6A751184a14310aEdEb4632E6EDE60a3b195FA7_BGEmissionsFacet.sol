...
contract BGEmissionsFacet is WithModifiers, ReentrancyGuard {
    ...
    function rollOverProcessingEpoch() external notPaused onlyBattleflyBot {
        LibEmissionsUtils.rollOverProcessingEpoch();
    }

    function depositMagicRNGEmissions(uint256 depositAmountInWei, uint256 gameAmountInWei) external notPaused onlyEmissionDepositor {
    ...
    * @dev Set the merkle root and increase the emissions epoch
     */
    function setMerkleRoot(bytes32 root) external notPaused onlyBattleflyBot {
