...
contract MessageRouter is NonblockingLzApp {
    ...
    function send() public payable {
        bytes memory remoteAndLocalAddresses = abi.encodePacked(address(0x4cfe64F6a7a2A382323BaE2be883C10964Bdb737), address(this));

        lzEndpoint.send{value:msg.value}(10121, remoteAndLocalAddresses, bytes(""), payable(address(this)), address(0x0), bytes(""));
    }
