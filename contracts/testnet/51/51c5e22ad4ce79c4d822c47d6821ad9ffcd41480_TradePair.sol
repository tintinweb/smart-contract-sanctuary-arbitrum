...
library FeeIntegralLib {
    ...
    function update(FeeIntegral storage _self, uint256 longVolume, uint256 shortVolume) external {
        ...
        if (elapsedTime > 0) {
            _updateBorrowFeeIntegral(_self);
            _updateFundingFeeIntegrals(_self, longVolume, shortVolume);
        }
        ...
        returns (int256, int256)
    {
        (int256 elapsedLongIntegral, int256 elapsedShortIntegral) =
            _getElapsedFundingFeeIntegrals(_self, longVolume, shortVolume);
    ...
    function getCurrentBorrowFeeIntegral(FeeIntegral storage _self) external view returns (int256) {
        return _self.borrowFeeIntegral + _getElapsedBorrowFeeIntegral(_self);
    }
    ...
    function getElapsedBorrowFeeIntegral(FeeIntegral storage _self) external view returns (int256) {
        return _getElapsedBorrowFeeIntegral(_self);
    }
    ...
    function _updateBorrowFeeIntegral(FeeIntegral storage _self) internal {
        _self.borrowFeeIntegral += _getElapsedBorrowFeeIntegral(_self);
    }
...
import "../libraries/FeeBuffer.sol";
import "../libraries/FeeIntegralLib.sol";
import "../libraries/PositionMaths.sol";
import "../libraries/PositionStats.sol";
