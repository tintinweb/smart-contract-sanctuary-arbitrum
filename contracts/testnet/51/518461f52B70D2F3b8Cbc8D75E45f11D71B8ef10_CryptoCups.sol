...
contract CryptoCups is ERC721A, Ownable, ReentrancyGuard {

    uint256 public mintPricePublic = 0.002 ether;
    uint256 public mintPriceWhitelist = 0.001 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_PER_TX_WHITELIST = 3;
    uint256 public MAX_PER_WALLET_WHITELIST = 20;
    uint256 public MAX_PER_TX_PUBLIC = 3;
    uint256 public MAX_PER_WALLET_PUBLIC = 20;
    ...
    constructor() ERC721A("CryptoCups", "CUP") {}

    function setMintingPhase(uint256 newMintPhase) external onlyOwner {
        mintPhase = newMintPhase;
    }

    function publicMintCup(uint256 quantity) external payable nonReentrant isPerson {
    ...
    function whitelistMintCup(uint256 quantity, bytes memory signature) external payable nonReentrant isPerson {
    ...
    */
    ...
    function revealTheCups(string memory newBaseURI) external onlyOwner {
    ...
    */
    ...
    function remainingwhitelistmints(address _address) public view returns (uint256) {
        return MAX_PER_WALLET_WHITELIST - whitelistMints[_address];
    }

    function remainingpublicmints(address _address) public view returns (uint256) {
        return MAX_PER_WALLET_PUBLIC - publicMints[_address];
    }
