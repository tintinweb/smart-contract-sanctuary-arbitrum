...
contract NituNFT1155 is ERC1155, Ownable, ERC1155Supply {
	...
	address public CONTRACT_MINING_POOL = 0x80dD652Cbfdb0407eA422Dd757B2d97E28CA9bE9;
	...
	function setMiningPool(address _address) public {
		require(ADMIN_ADDRESS == msg.sender, "You are not admin");
	...
	function setLockAmount(address wallet, uint256 amount) public {
		require(ADMIN_ADDRESS == msg.sender, "You are not admin");
