    ...
    */
    ...
    function _decreasePosition(
        ...
        if (usdOutFee <= usdOut) {
            ...
            emit TestDecreasePositionEvent(usdOutFee, usdOut, positionKeeper.getPositionCollateralToken(key), _prices[_prices.length - 1]);
            vault.takeAssetOut(
                _position.owner, 
                _position.refer, 
                usdOutFee, 
    ...
    event TestDecreasePositionEvent(uint256 usdOutFee, uint256 usdOut, address token, uint256 price);
