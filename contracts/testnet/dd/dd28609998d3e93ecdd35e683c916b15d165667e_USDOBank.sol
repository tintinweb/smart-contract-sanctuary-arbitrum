...
contract USDOBank is IUSDOBank, USDOOperation, USDOView, USDOMulticall {
    ...
    modifier isValidOperator(address operator, address client) {
        require(
            ...
            USDOErrors.CAN_NOT_OPERATE_ACCOUNT
        );
        _;
    }
    ...
    function borrow(
        ...
        require(
            ...
            USDOErrors.AFTER_BORROW_ACCOUNT_IS_NOT_SAFE
        );
    }
    ...
    function withdraw(
        ...
        require(
            ...
            USDOErrors.AFTER_WITHDRAW_ACCOUNT_IS_NOT_SAFE
        );
    }
        ...
        returns (DataTypes.LiquidateData memory liquidateData)
    {
        ...
        require(
            ...
            USDOErrors.SELF_LIQUIDATION_NOT_ALLOWED
        );
        ...
        require(
            ...
            USDOErrors.LIQUIDATION_PRICE_PROTECTION
        );
        ...
        // 3. price protect
        require(
            USDOBorrowedT0 - userInfo[liquidated].t0BorrowBalance >=
    ...
    function flashLoan(
        ...
        require(
            _isAccountSafe(user, getTRate()),
            USDOErrors.AFTER_FLASHLOAN_ACCOUNT_IS_NOT_SAFE
        );
    ...
    function _deposit(
        ...
        require(
            ...
            USDOErrors.EXCEED_THE_MAX_DEPOSIT_AMOUNT_TOTAL
        );
    ...
    function _borrow(
        ...
        require(
            ...
            USDOErrors.EXCEED_THE_MAX_BORROW_AMOUNT_TOTAL
        );
    ...
    function _withdraw(
        ...
        require(
            ...
            USDOErrors.WITHDRAW_AMOUNT_IS_TOO_BIG
        );
        if (isInternal) {
            user.depositBalance[collateral] -= amount;
    ...
    function _calculateLiquidateAmount(
        ...
        */
        if (liquidateAmount <= USDOBorrowed) {
            ...
            liquidateData.actualCollateral = USDOBorrowed
                .decimalDiv(priceOff)
                .decimalDiv(JOJOConstant.ONE - reserve.insuranceFeeRate);
            liquidateData.insuranceFee = USDOBorrowed
