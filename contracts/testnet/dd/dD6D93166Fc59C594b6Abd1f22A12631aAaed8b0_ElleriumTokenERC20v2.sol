...
contract ElleriumTokenERC20v2 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    /// @dev 1-way Blacklisting Mechanism: One-time enabling of trading after LP is set up.
    /// Blacklists all wallets transferring tokens before this flag is enabled.
    ...
    /// @dev (Owner Only) One-time function to enable trades. Trades cannot be disabled hereafter.
    ...
    function _transfer(
        ...
        // Allows us time to distribute funds and set up announcements.
        if (!isInitialized && _msgSender() != owner()) {
