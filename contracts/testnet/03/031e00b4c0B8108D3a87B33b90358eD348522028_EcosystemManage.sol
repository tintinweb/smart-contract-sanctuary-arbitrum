...
contract EcosystemManage is Initializable{
    ...
    function CancelApprovePERMIT2(address _PERMIT2, IAllowanceTransfer.TokenSpenderPair[] calldata approvals) public onlyGov{
        IAllowanceTransfer(_PERMIT2).lockdown(approvals);
    }
