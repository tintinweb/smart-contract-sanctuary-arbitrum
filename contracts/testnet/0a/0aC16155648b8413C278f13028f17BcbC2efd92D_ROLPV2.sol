...
contract BaseTokenV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20BurnableUpgradeable {
...
contract MintableBaseTokenV2 is BaseTokenV2, IMintable {
...
contract ROLPV2 is MintableBaseTokenV2, IROLPV2 {
    mapping(address => uint256) public override cooldownDurations;

    function initialize() public initializer {
        super.initialize("Roseon LP", "ROLP", 0);
    }
