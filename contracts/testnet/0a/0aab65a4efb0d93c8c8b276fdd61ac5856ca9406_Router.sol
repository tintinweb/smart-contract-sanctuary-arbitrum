...
contract Router is BaseRouter, IRouter, ReentrancyGuard {
    ...
    */
    ...
    function revertExecution(
        ...
        require(transactions[_key].status == TRANSACTION_STATUS_PENDING, "IVLPTS/NPND"); //Invalid preapre transaction status, must pending
        ...
        transactions[_key].status == TRANSACTION_STATUS_EXECUTE_FAILED;
    ...
    function _createPrepareTransaction(
        ...
        require(transaction.status == TRANSACTION_STATUS_NONE, "IVLPTS/NN"); //Invalid prepare transaction status, must be none
