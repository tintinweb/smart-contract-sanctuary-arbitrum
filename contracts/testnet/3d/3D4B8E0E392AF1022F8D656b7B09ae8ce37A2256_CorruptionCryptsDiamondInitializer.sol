...
contract CorruptionCryptsDiamondInitializer is CorruptionCryptsDiamondState {
    ...
    function getCharacterInfoByLegionSquadIdAndCharacterIndex(uint64 legionSquadId, uint8 _index) public view returns(CharacterInfo memory) {
        return legionSquadIdToLegionSquadInfo[legionSquadId].indexToCharacterInfo[_index];
    }
