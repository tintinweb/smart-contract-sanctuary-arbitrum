...
import "./interfaces/IGenesisOwnership.sol";
...
contract GenesisOwnership is LzApp, IGenesisOwnership {
    ...
    constructor(address _endpoint, uint16 _srcChainId) LzApp(_endpoint) {
    ...
    function _blockingLzReceive(
        ...
        // uint256 nextTokenId = startTokenId + quantity;
        // if (_currentIndex < nextTokenId) {
        //     // This transaction contains mint()
        //     _currentIndex = nextTokenId;
        // }

        // address nextSlot = _ownerships[nextTokenId];
        // if (nextSlot == address(0)) {
        ...
        emit GenesisOwnershipTransferred(address(0), address(0), 0, 1);
    }
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        revert("GenesisOwnership: owner query for nonexistent token");
    }
}
