...
contract Pachi721V7 is ERC721SignatureMint {
    /** =================================================================================================
        Setup
        =================================================================================================
     */
    ...
    function birthWithSignature(
        ...
        nftManager.initiateNFTStatus(
            ...
            0,
            false,
            [_req.parentsTokenId[0], _req.parentsTokenId[1]],
            _req.jackpotBoost,
            _req.dividendsPoint
        );
...
abstract contract SignatureMintERC721 is EIP712, ISignatureMintERC721 {
    ...
    bytes32 private constant BIRTH_TYPEHASH =
        keccak256(
            "BirthRequest(address to,string uri,uint256 pricePerToken,address currency,uint128 validityStartTimestamp,uint128 validityEndTimestamp,bytes32 uid,uint256[2] parentsTokenId,bool isMale,uint256 generation,uint256 jackpotBoost,uint256 dividendsPoint,uint256 matingId)"
        );
