  ...
  ERC1155Holder
{
  ...
  uint256[] public defaultTreasureAmounts;
  ...
  constructor(
    ...
    uint256[4] memory _treasureAmounts
    ...
    defaultTreasureAmounts = _treasureAmounts;
  }
  ...
  function stakeBatch(
    ...
    uint256 j = 0;
    uint256 length = _structureIds.length;
  ...
  function setTreasureAmounts(uint256[4] calldata _treasureAmounts)
    external
    onlyAdmin
  {
    defaultTreasureAmounts = _treasureAmounts;
