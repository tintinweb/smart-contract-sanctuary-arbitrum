...
contract XMY is IERC20, Ownable {
    ...
    mapping(address => uint256) private mineReward;
    mapping(address => uint256) private invitorReward;
    ...
    uint256 oneMineReward = 100;
    uint256 twoMineReward = 200;
    uint256 threeMineReward = 300;
    uint256 fourMineReward = 400;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if(presaleList[from] || presaleList[from]){
    ...
    // function checkMineLv2(address account) public view returns(uint8){
    //     uint256 accLPBalance = IERC20(_mainPair).balanceOf(account);
    //     uint256 lowerCount =  _binders[account].length;
    //     uint256 lowerLPCount;
    //     uint256 lowerHoldCount;
    //     (lowerHoldCount,lowerLPCount) = checkLowerCount(account);
    //     if(accLPBalance < oneLPNum){
    //         return 0 
    //     }else if(oneLPNum <= accLPBalance < twoLPNum){
    //         if (lowerHoldCount < 20 ){
    //             return 0 
    //         }else{
    //             if(lowerLPCount >= 10){
    //                 return 1;
    ...
    //         }
    //     }else if(twoLPNum <= accLPBalance < threeLPNum){
    //         if (lowerHoldCount < 20 ){
    //             return 0 
    //         }else if(20 <= lowerHoldCount < 30){
    ...
    //         }
    //     }else if(threeLPNum <= accLPBalance < fourLPNum){
    //         if (lowerHoldCount < 20 ){
    //             return 0 
    //         }else if(20 <= lowerHoldCount < 30){
    ...
    //         }
    //     }else if(fourLPNum <= accLPBalance < fiveLPNum){
    //         if (lowerHoldCount < 20 ){
    //             return 0 
    //         }else if(20 <= lowerHoldCount < 30){
    ...
    //             }else if(30 <= lowerLPCount < 40){
    //                 return 3;
    //             }else{ //lowerLPCount>>40
    //                 return 4;
    //             }


    //         }else{ //lowerHoldCount >> 60
    //             if(lowerLPCount < 10){
    //                 return 0;
    //             }else if(10 <= lowerLPCount < 20){
    //                 return 1;
    ...
    //             }else if(30 <= lowerLPCount < 40){
    //                 return 3;
    //             }else if(40 <= lowerLPCount < 50){
    //                 return 4;
    //             }else{ //lowerLPCount>>50
    //                 return 5;
    //             }
        ...
        while (gasUsed < gas && iterations < lpProviders.length) {
            ...
            if (!excludeLpProvider[shareHolder]) {
                ...
                if (block.timestamp > _lastMineLPRewardTimes[shareHolder] + _mineTimeDebt) {
                    amount = cycleMineAmount * pairBalance / totalPair;
                    if (amount > 0) {
                        if(mineLv == 0){
                            amount = 0;
                        }
    ...
    function procesInvitorReward(address current, uint256 reward) private {
        ...
        for (uint256 i; i < 5;i++) {
            ...
            if (address(0) == invitor || deadAddress == invitor || cycleInvitorAmount < 100) {
                break;
            }
            ...
            cycleInvitorAmount -= upInviterAmount + invitorAmount ;
