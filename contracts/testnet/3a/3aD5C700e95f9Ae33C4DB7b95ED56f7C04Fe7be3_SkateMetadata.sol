...
import "./SkateMetadataState.sol";

contract SkateMetadata is Initializable, SkateMetadataState, ISkateMetadata {
    using StringsUpgradeable for uint256;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;

    function initialize() external initializer {
        SkateMetadataState.__SkateMetadataState_init();
    }
...
import "./SkateMetadata.sol";

abstract contract SkateMetadataState is Initializable, AdminableUpgradeable {
    string public baseURI;
    string public provenance;

    function __SkateMetadataState_init() internal initializer {
