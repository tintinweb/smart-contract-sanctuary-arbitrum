    ...
    ReentrancyGuardUpgradeable
{
    ...
    function setToken(address _case, address _glasses) external onlyOwner {
        caseToken = _case;
    ...
    function recruit(uint256 caseTokenId) public nonReentrant {
        require(block.timestamp > openTime, "ReadON:not recruit open time!");
        require(
            IERC721Upgradeable(caseToken).ownerOf(caseTokenId) == msg.sender,
            "ReadON:not owner!"
        );
