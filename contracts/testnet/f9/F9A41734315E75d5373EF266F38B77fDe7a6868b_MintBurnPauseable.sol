...
/**
 * @title MintBurnPauseableERC20
 * @dev Implementation of the MintBurnPauseableERC20
 */
contract MintBurnPauseable is
    ERC20Capped,
    ERC20Mintable,
    ERC20Burnable,
    ERC20Pausable,
    ...
    Services
{
    ...
    event MintBurnPauseableTokenCreated(
    ...
    constructor(
        ...
        require(initialBalance <= cap, "ERC20: cap exceeded");
        ...
        emit MintBurnPauseableTokenCreated(
            _msgSender(),
            address(this),
            "Mint_Burn_Pauseable",
            serviceFee
    ...
    function _mint(
        address account,
        uint256 amount
    ) internal override(ERC20, ERC20Capped) onlyOwner {
        super._mint(account, amount);
    }
