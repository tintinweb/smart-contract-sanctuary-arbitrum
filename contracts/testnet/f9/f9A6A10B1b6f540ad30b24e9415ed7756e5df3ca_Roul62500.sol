    ...
    ReentrancyGuard
{
    ...
    uint constant DECIMALS = 18; // Should be updated
    ...
    uint256 public ticketPrice = 1250 * 10 ** 18; // 1250 ROUL (ROUL has 18 decimals)
    uint256 public totalTicketCount = 180000;
    uint256 private emptyTickets = 160920; // Should be updated
    enum CardResult {
        LOSS,
        WIN6250,
        WIN12500,
    ...
    constructor(
         ...
         */
        generationCounts[CardResult.WIN6250] = 14400;
        generationCounts[CardResult.WIN12500] = 4500;
        generationCounts[CardResult.WIN62500] = 180;

        rewardAmounts[CardResult.WIN6250] = 6250;
        rewardAmounts[CardResult.WIN12500] = 12500;
        rewardAmounts[CardResult.WIN62500] = 62500;
