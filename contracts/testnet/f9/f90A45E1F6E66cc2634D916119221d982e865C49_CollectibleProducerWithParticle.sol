  ...
  ManagerModifier
{
  ...
  constructor(
    ...
    cooldowns = [86400, 86400, 129600, 129600, 259200, 259200, 259200];
    costs = [
      500000000000000000,
      750000000000000000,
      1500000000000000000,
  ...
  function collect(
    ...
    for (uint256 h = 0; h < _realmIds.length; h++) {
      ...
      // If not productive, set to maximum productivity
      if (!PRODUCTION.isProductive(realmId)) {
        PRODUCTION.setProduction(realmId, block.timestamp - maxSeconds);
      }
