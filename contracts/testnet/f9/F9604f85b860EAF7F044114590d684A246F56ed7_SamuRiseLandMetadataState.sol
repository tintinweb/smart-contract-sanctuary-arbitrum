...
contract SamuRiseLandMetadataState is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function increaseTokenIdToDojoRarityBonus(uint256 _tokenId, uint256 _bonusAmount) public {
        emit TokenMetadataUpdated(_tokenId); 
        tokenIdToDojoLeveledUpAmount[_tokenId] += _bonusAmount;
    }
    
    function setLandTokenIdFactionAndProvince(uint256 _tokenId, uint256 _faction, uint256 _province) public {
        emit TokenMetadataUpdated(_tokenId); 
