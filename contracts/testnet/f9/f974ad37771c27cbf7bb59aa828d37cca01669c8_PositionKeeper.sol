...
contract PositionKeeper is BasePositionConstants, IPositionKeeper, ReentrancyGuard, Ownable {
    ...
    mapping(bytes32 => address) public collaterals;
    ...
    function openNewPosition(
        ...
        bool isExist = positions[_key].size > 0;
        ...
        if (collaterals[_key] == address(0)) {
            collaterals[_key] = _path[_collateralIndex];
        }
