...
// this secondary collection is based on the main collection 721
// it will be used to mint the secondary collection by checking if they have the previous collection
contract SecondaryCollection721 is ERC721AQueryable, Ownable, AccessControl {
    using Strings for uint256;

    string public baseURI;
    address public vault;
    ERC721AQueryable public mainCollection721;
    ...
    constructor(
        ...
        baseURI = _baseURI;
        mainCollection721 = ERC721AQueryable(_mainCollection721);
    }
    ...
    function claim(uint256 _tokenId) external payable {
        require(
            mainCollection721.ownerOf(_tokenId) == msg.sender,
            "You need to own a main collection NFT to mint this one."
        );
        require(!claimed[_tokenId], "This token ID has already been claimed.");
