 ...
 */
contract PausableERC20 is ERC20Pausable, Ownable, Services {
    uint8 private _decimals;
    address private tokenOwner;

    event PauseableTokenCreated(
    ...
    constructor(
        ...
        require(initialBalance > 0, "PauseableERC20: supply cannot be zero");
        require(msg.value >= serviceFee, "PauseableERC20: Insufficient service fee");
        ...
        emit PauseableTokenCreated(_msgSender(), address(this),TokenType.BURNABLE, serviceFee);
    }
