...
contract CityMinter is ReentrancyGuard, Pausable, ManagerModifier {
  ...
  function stakeBatch(
    ...
    // TODO: Make sure this is what you need
    emit StakedCities(_realmIds, address(CITY), _cityIds, _amounts);
  }
  ...
  function unstakeBatch(
    ...
    // TODO: Make sure this is what you need
    emit UnstakedCities(_realmIds, address(CITY), _cityIds, _amounts);
  }
  ...
  function updateCollectibleAmounts(uint256 _collectibleAmount)
    external
    onlyAdmin
  {
