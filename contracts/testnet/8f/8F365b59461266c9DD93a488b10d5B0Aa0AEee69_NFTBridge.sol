...
contract NFTBridge is NFTBridgeData {
    ...
    function ccipReceive(
        ...
        uint256 modeswitch = uint256(bytes32(message.data[0:32])); // only works for type 4, rest return 32
        if (modeswitch > 4)
            modeswitch = uint256(bytes32(message.data[32:64]));
