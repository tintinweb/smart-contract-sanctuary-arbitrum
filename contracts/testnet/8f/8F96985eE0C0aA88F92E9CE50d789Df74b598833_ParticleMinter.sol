...
contract ParticleMinter is ManagerModifier, ReentrancyGuard, Pausable {
  ...
  // Events
  //=======================================
  event Init(uint256 _realmId, address _addr, uint256 adventurerId);
  event Captured(
    uint256 realmId,
    address addr,
    ...
    returns (uint256)
  {
    ...
    uint256 currentRealm = PARTICLE_TRACKER.currentRealm(_addr, _adventurerId);
