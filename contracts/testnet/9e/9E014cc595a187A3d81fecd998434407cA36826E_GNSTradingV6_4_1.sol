...
contract GNSTradingV6_4_1 is Delegatable {
    ...
    GNSBorrowingFeesInterfaceV6_5 public immutable borrowingFees;
    ...
    constructor(
        ...
        GNSBorrowingFeesInterfaceV6_5 _borrowingFees,
        uint _maxPosDai,
    ...
    function executeNftOrder(uint256 packed) external notContract notDone {
        ...
        IGNSOracleRewardsV6_4_1.TriggeredLimitId memory triggeredLimitId = checkNoPendingTrigger(
            trader,
            pairIndex,
            index,
            orderType
        ...
        if (isOpenLimit) {
            ...
            if (orderType == StorageInterfaceV5.LimitOrder.LIQ && t.sl > 0) {
                uint liqPrice = borrowingFees.getTradeLiquidationPrice(
                    GNSBorrowingFeesInterfaceV6_5.LiqPriceInput(
                        t.trader,
                        t.pairIndex,
                        t.index,
                        t.openPrice,
