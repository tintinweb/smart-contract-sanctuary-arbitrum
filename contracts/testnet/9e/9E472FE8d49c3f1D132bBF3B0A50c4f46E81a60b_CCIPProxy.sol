...
contract CCIPProxy {
    ...
    function addPseudorandomNumber() public {
        _forwardCCIPMessage("addPseudorandomCharacter()"); // Passing the entire signature directly
    }

    function addPseudorandomCharacter() public {
        _forwardCCIPMessage("addPseudorandomNumber()"); // Passing the entire signature directly
    }
