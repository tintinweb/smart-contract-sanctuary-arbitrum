    ...
    TokensRescuer
{
    ...
    function deposit(
        IParallax.Deposit0 memory depositParams
    )
        external
        nonReentrant
    ...
    function deposit(
        IParallax.Deposit1 memory depositParams
    )
        external
        nonReentrant
        onlyExistingStrategy(depositParams.strategyId)
    ...
    function deposit(
        IParallax.Deposit2 memory depositParams
    )
        external
        payable
        nonReentrant
    ...
    function deposit(
        IParallax.Deposit3 memory depositParams
    )
        external
        nonReentrant
        onlyExistingStrategy(depositParams.strategyId)
    ...
    function withdraw(
        IParallax.Withdraw0 memory withdrawParams
    )
        external
        nonReentrant
    ...
    function withdraw(
        IParallax.Withdraw1 memory withdrawParams
    )
        external
        nonReentrant
        onlyExistingStrategy(withdrawParams.strategyId)
    ...
    function withdraw(
        IParallax.Withdraw2 memory withdrawParams
    )
        external
        nonReentrant
        onlyExistingStrategy(withdrawParams.strategyId)
    ...
    function withdraw(
        IParallax.Withdraw3 memory withdrawParams
    )
        external
        nonReentrant
        onlyExistingStrategy(withdrawParams.strategyId)
    ...
    function getClaimableRewards(
        ...
        uint256 claimableRewords = position.reward +
            (((_getStakedBySharesAmount(strategyId, position.shares) *
                strategies[strategyId].rewardPerShare) / ACCURACY) -
                position.former);
