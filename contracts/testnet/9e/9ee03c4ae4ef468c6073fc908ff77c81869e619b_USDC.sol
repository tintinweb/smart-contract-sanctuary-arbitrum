...
import {ICustomToken} from "../../../interfaces/arbStack/ICustomToken.sol";
import {ICustomGateway} from "../../../interfaces/arbStack/ICustomGateway.sol";
import {IGatewayRouter} from "../../../interfaces/arbStack/IGatewayRouter.sol";

import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/extensions/draft-ERC20Permit.sol";

contract USDC is ICustomToken, ERC20Permit, Ownable {
    ...
    ) payable ERC20("Syndr Test USDC", "USDC") ERC20Permit("Syndr Test USDC") {
        bridge = _bridge;
        router = _router;
