    ...
    ERC2771ContextUpgradeable
{
    ...
    modifier relayByAdmin() {
        if (_msgSender() != admin) revert RelayNotCalledByAdmin();
    ...
    ) public onlyTrustedForwarder relayByAdmin whenNotPaused {
    ...
    function claimUsername(
        ...
        uint256 _tokenId,
        string memory _username
    ) public onlyTrustedForwarder whenNotPaused relayByAdmin {
