...
contract QFSCollection is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 max_supply = 1000;

    string public baseURI = "ipfs://bafybeiax66qsifctzfrgo56mezsdsscqn7n4nce36jch6hpqy7drzw7wde/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("Cosmos Quantum Collective", "QFSC") {
    }
