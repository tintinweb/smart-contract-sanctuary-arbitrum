    ...
    AutomationCompatible
{
    ...
    function getPortalSum() public view returns (PortalSum memory portalSum) {
        if (!_getPiggyBank().checkIsSeasonEnd(_season) && !paused()) {
            portalSum.running = true;
        }
        portalSum.currentSeason = _season;
    }
