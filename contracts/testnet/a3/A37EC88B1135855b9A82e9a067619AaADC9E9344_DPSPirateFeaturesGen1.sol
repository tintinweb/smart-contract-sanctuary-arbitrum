...
contract DPSPirateFeaturesGen1 is Ownable {
    ...
    mapping(uint16 => string[16]) traitsPerPirate;
    ...
    function getTraitsAndSkills(uint16 _dpsId) external view returns (string[16] memory, uint16[3] memory) {
