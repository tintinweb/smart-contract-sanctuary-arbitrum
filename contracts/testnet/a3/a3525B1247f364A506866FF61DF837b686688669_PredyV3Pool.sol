...
contract PredyV3Pool is IPredyV3Pool, Ownable, Constants {
    ...
    function borrowTokens(
        ...
        tokenState1.addDebt(accountState1[_vaultId], _amount1);
    }
    ...
    function getMarginValue(uint256 _vaultId) public view returns (uint256 marginValue) {
        return vaults[_vaultId].getMarginValue(ranges);
    }
...
library VaultLib {
    ...
    function getMarginValue(Vault memory _vault, mapping(bytes32 => PerpStatus) storage ranges) external view returns(uint256 marginValue) {
