    ...
    ERC20VotesUpgradeable
{
    ...
    // Staking started
    mapping(address => uint256) public stakingStarted;
    ...
    function initialize(
        ...
        __ERC20_init("VeFACTOR", "veFACTOR");
    ...
    function stake(uint256 amount) public nonReentrant whenNotPaused {
        ...
        stakingStarted[msg.sender] = block.timestamp;
    ...
    function _claim() internal {
        // reward calculated by 1 minute
        uint256 rewardAmount = ((block.timestamp - stakingStarted[msg.sender]) /
            60) * rewardRate;
        stakingStarted[msg.sender] = block.timestamp;
