...
contract Fiat24GBP is Fiat24Token {
  ...
  function initialize(address fiat24AccountProxyAddress, uint256 limitWalkin,uint256 chfRate, uint256 withdrawCharge) public initializer {
      __Fiat24Token_init_(fiat24AccountProxyAddress, "Fiat24 GBP", "GBP24", limitWalkin, chfRate, withdrawCharge);
  }
}
...
contract Fiat24Account is ERC721EnumerableUpgradeable, ERC721PausableUpgradeable, AccessControlUpgradeable {
    ...
    function mint(address _to, uint256 _tokenId, bool _isMerchant, uint256 _merchantRate, uint256 _walletProvider) public {
