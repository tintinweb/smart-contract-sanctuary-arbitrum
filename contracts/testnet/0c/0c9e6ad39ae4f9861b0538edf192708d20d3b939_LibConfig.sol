...
library LibConfig {
    ...
    //this is the percent of time elapsed. It is used in the calcualtion of the a(t) and b(t) values. 
...
contract EvolvingProteus is ILiquidityPoolImplementation {
    ...
    constructor(
        ...
        require(uint8(SpecifiedToken.X) == 0);
        require(uint8(SpecifiedToken.Y) == 1);
    }
