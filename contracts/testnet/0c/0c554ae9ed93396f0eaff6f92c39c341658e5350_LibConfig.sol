...
library LibConfig {
    ...
    function a(Config storage self) public view returns (int128) {
        return self.a_init.mul(ABDKMath64x64.divu(1e18,1e18).sub(t(self))).add(self.a_final.mul(t(self)));
    }
    ...
    function b(Config storage self) public view returns (int128) {
        return self.b_init.mul(ABDKMath64x64.divu(1e18,1e18).sub(t(self))).add(self.b_final.mul(t(self)));
    }
