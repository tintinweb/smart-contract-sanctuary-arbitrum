    ...
    WithModifiers
{
    ...
    function unlockNft(uint256 id, address owner)
        external
        roleOnly(LibAccessControl.Roles.BOT)
        pausable
    {
    ...
    function mintCharacter(
        ...
        bool lock,
        string memory apiId
    ) external roleOnly(LibAccessControl.Roles.BOT) pausable returns (uint256) {
        uint256 characterId = _generateNftTokenId();

        _mint(owner, characterId, 1, "");
...
library LibTokens {
    ...
    uint64 public constant SEED_PETS_BASE_ID = 0;
