...
contract Range is CommonSolo {
  ...
  modifier isChoiceInsideLimits(bytes memory _gameData) {
    ...
    require(choice_ >= 500000 && choice_ <= 9500000, "Choice isn't allowed");
    _;
  }

  /*==================================================== State Variables ====================================================*/

  uint32 public mod = 9900001;
  uint32 public range = 10000000;
  uint256 public houseEdgeMultiplier = 98e21;
  ...
  function calcReward(uint256 _choice, bool _over, uint256 _wager) public view returns (uint256 reward_) {
    reward_ = (_wager * calcWinMultiplier(_choice, _over)) / 1e23;
  }
