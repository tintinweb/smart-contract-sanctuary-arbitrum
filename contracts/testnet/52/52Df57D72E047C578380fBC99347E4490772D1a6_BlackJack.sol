...
contract Deck {
    ...
    constructor(uint256 _numberOfDecks) {
    ...
    function shuffleDeck() internal {
        ...
        totalCards = uint16(numberOfDecks * 52);
...
contract BlackJack is Game, Deck {
    ...
    constructor(address _casino, uint256 _numberOfDecks)
        Game(_casino)
        Deck(_numberOfDecks)
    {
    ...
    uint48 public bettingPeriod = 600;
    uint48 public lastHandTime;
    address public actingPlayer;
    uint48 public playerActionPeriod = 300;
