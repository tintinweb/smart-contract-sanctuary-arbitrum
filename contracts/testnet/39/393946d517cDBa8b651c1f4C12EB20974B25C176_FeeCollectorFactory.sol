...
contract FeeCollector is ArcBaseWithRainbowRoad, IFeeCollector
{
    ...
    */
    ...
    function deposit(address account, uint amount) external onlyAuthorized nonReentrant()
    {
    ...
    function withdraw(address account, uint amount) external onlyAuthorized nonReentrant()
    {
...
interface IFeeCollector {
    function deposit(address owner, uint amount) external;
    function withdraw(address owner, uint amount) external;
