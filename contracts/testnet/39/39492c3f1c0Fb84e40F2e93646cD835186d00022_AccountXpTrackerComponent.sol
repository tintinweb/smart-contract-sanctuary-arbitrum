...
uint256 constant ID = uint256(keccak256("game.piratenation.accountxptrackercomponent"));
 ...
 */
contract AccountXpTrackerComponent is BaseStorageComponent {
    /** SETUP **/
    ...
    function getValue(
        ...
        value = AccountXpTrackerComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getBytes(
        ...
        Layout memory s = AccountXpTrackerComponentStorage.layout().entityIdToStruct[entity];
        value = abi.encode(s.currentAccountXp);
    }
    ...
    function remove(uint256 entity) public virtual {
        ...
        delete AccountXpTrackerComponentStorage.layout().entityIdToStruct[entity];
    ...
    function _setValueToStorage(
        ...
        s.currentAccountXp = transform.currentAccountXp;
    }
    ...
    function _setValue(
        ...
        emitSetBytes(
            entity,
            abi.encode(value.currentAccountXp)
        );
    }
}