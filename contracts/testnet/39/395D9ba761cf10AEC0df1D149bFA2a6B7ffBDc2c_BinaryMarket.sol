    ...
    AccessControl
{
    ...
    */
        ...
        returns (bool)
    {
        ...
        if (block.timestamp >= rounds[timeframeId][epoch].startBlockTime + timeframes[timeframeId].interval - bufferTime) {
            return false;
        }
        ...
        return
            ...
            rounds[timeframeId][epoch].startBlockTime <= block.timestamp + futureBettingTimeUpTo;
    }
