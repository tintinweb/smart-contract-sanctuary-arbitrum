...
contract Twitterdogelon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TwitterDogElon", "twitterdogelon") {
        ...
        marketingWallet = address(0xaCB4BEA6d73D7051F7a91A997442fc9176B8f0AA); // set as marketing wallet
        devWallet = address(0xb08f62E9Ee0D5f8a2F63BA8E9EECb566Fae69863); // set as dev wallet
