...
/**
 * @title MintPauseBlacklistableERC20
 * @dev Implementation of the MintPauseBlacklistableERC20
 */
contract MintPauseBlacklistable is
    ERC20Capped,
    ERC20Mintable,
    ERC20Pausable,
    Ownable,
    Services
{
    ...
    event Mint_Pause_Blacklist_TokenCreated(
    ...
    constructor(
        ...
        emit Mint_Pause_Blacklist_TokenCreated(
            _msgSender(),
            address(this),
            "Mint_Pause_Blacklistable",
            serviceFee
        );
    }
    ...
    function addToBlackList(
        ...
        require(
            !_isBlackListed[user],
            "Blacklist: User already _isBlackListed"
        );
