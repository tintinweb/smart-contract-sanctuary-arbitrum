...
contract Airdrop is Ownable {
    ...
    IERC20 public constant TOKEN = IERC20(0x3d6d636878435474E96CE470624aA1c2Ad258667);
    uint256 public constant TOKEN_AMOUNT = (666_999_666_999_666e18 * 66) / 1000;
    ...
    constructor() {
        //test
        claimable = true;
        baseAmount = TOKEN_AMOUNT / 100;
        arbMerkleRoot = 0xb1f024c979c204963f393566ab470cf48285d9f9dd4486f1f51cfc4c72b8e966;
        ethMerkleRoot = 0x44b8aa2279864daeb0b7ad7d3ea2a637442c3e846f4fd60b14f104aadf366e25;
        memeMerkleRoot = 0x1f53f7c23a8542a0158ec1a5c5009838cb834d98683772271bc36fe456db9a75;
    }
    ...
    function claim(bytes32[] calldata arbProof, bytes32[] calldata ethProof, bytes32[] calldata memeProof) external {
        ...
        if (weight == 0) return;
        //TOKEN_AMOUNT每领取1/10, baseAmount减少1/10
