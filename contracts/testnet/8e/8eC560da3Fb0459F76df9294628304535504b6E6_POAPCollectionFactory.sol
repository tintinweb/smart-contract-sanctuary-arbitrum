...
import "../../interfaces/collections/ILoot8POAPCollection.sol";
...
contract Loot8POAPCollection is ERC721, ERC721Royalty, ILoot8POAPCollection, ILoot8BurnableCollection, NonblockingLzApp {
    ...
    */
    ...
    ) public virtual
    {
        ...
        _safeMint(_patron, nextTokenId);
        setTokenURI(nextTokenId, _tokenURI);
        collectionCollectibleIds.increment();
    }
    ...
    function setTokenURI(uint256 _tokenId, string memory _tokenURI) public virtual {
        require(_msgSender() == governor || _msgSender() == address(this), "UNAUTHORIZED");
    ...
    function getNextTokenId() public view returns(uint256 _collectionCollectibleId) {
...
import "../collections/Loot8POAPCollection.sol";
import "../../interfaces/factories/IPOAPCollectionFactory.sol";
...
interface ILoot8POAPCollection {
     ...
     * - `tokenId` must not exist.
     */
    function mint(address _patron, string memory _tokenURI) external;
