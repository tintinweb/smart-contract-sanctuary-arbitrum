    ...
    ContractVersion
{
    ...
    function initialize(
        ...
        // Init contracts
        __ERC721A_init("Sample POAP A", "SPOAPA");
        __Context_init();
    ...
    /// Returns the poap ID from the `tokenId`
    ...
    /// Returns the poap URI from the `poapId`
    ...
    /// Returns total recent poap IDs
    function getTotalPoapId() public view virtual returns (uint256) {
        return _totalPoapId;
    }

    /// Returns total supply by the `poapId`
    ...
    /// @dev {ERC721AUpgradeable-_beforeTokenTransfer}
    ...
    /// @dev {ERC2981Upgradeable-_feeDenominator}
    ...
    /// @dev {UUPSUpgradeable - _authorizeUpgrade}
