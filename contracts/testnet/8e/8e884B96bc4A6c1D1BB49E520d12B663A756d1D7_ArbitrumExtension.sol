...
import "./Initializable.sol";
import "../USDT/ERC20Upgradeable.sol";
import "../interfaces/IERC20PermitUpgradeable.sol";
import "./EIP712Upgradeable.sol";
import "../library/CountersUpgradeable.sol";
...
import "../abstract/Initializable.sol";
import "../abstract/ERC20PermitUpgradeable.sol";
import "../abstract/OwnableUpgradeble.sol";
import "./WithBlockedList.sol";

contract TetherTokenL2 is Initializable, ERC20PermitUpgradeable, OwnableUpgradeable, WithBlockedList {
...
import "./TetherTokenL2.sol";

contract ArbitrumExtension is TetherTokenL2, IArbToken {
  ...
  function initialize(
    ...
    TetherTokenL2.initialize(_name, _symbol, _decimals);
  }
