...
contract ShibaPinuArbi is ERC20, ERC20Burnable, Ownable{
//This is a bsc version
...
address private s_owner = 0x0F4b8f37B4c0edcea6053c9A80f80c45852aDcbD; 



error onlyOwnerCanMint(); 

    constructor(uint256 initialSupply)ERC20("ShibaPinuMumbai", "SPMB"){
...
function trasnferOwnerShipFunction(address newOwner)public onlyOwner{
