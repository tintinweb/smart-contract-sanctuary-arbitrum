...
contract MagicVault is Initializable, ContextUpgradeable, ERC20Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function test(uint256 _amountUSDC) external nonReentrant {
        IStargateRouter stargate = IStargateRouter(0xb850873f4c993Ac2405A1AdD71F6ca5D4d4d6b4f);
        // Transfer USDC from user to contract
        IERC20(0x6aAd876244E7A1Ad44Ec4824Ce813729E5B6C291).transferFrom(msg.sender, address(this), _amountUSDC);
        stargate.addLiquidity(1, _amountUSDC, address(this));
    }
}
