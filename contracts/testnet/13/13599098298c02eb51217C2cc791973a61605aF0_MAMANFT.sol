...
contract MAMANFT is ERC721Enumerable, Ownable {
    ...
    uint256 public wlMamaMintAmount = 0;
    ...
    function setWlMamaMintAmount(uint256 _wlMamaMintAmount) public onlyOwner {
        wlMamaMintAmount = _wlMamaMintAmount;
    }
    ...
    function mintMamaToWl(uint64 _amount, bytes32[] calldata _proof) public payable {
        ...
        wlMamaMintAmount = wlMamaMintAmount + _amount;
        require(wlMamaMintAmount <= wlMamaAmountLimit, "total amount limit");
