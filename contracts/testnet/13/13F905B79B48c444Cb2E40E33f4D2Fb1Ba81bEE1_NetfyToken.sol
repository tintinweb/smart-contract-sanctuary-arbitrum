...
contract NetfyToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 public constant hardCap = 3_000_000_000 * (10**_decimals); //3 billion
    uint256 public constant mintHardCap = 2_000_000_000 * (10**_decimals); //2 billion
    uint256 public constant lockedSupply = hardCap - mintHardCap; //1 billion
