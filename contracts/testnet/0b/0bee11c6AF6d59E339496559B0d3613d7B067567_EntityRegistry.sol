...
contract EntityRegistry is IEntityRegistry, Initializable, DAOAccessControlled {
    ...
    function initializer2(address _onboarder) public reinitializer(2) {
        onboarder = _onboarder;
    }
    ...
    function getAllEntities(bool _onlyActive, FetchEntityTypes _entityType) public view returns(address[] memory _entities) {
...
interface IEntityRegistry {
    ...
    function getAllEntities(bool _onlyActive, FetchEntityTypes _entityType) external view returns(address[] memory);
