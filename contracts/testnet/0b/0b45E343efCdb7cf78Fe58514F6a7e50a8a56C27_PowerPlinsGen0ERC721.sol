/**
 *Submitted for verification at Arbiscan on 2022-08-08
*/
...
contract PowerPlinsGen0ERC721 is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid mint amounts!');
