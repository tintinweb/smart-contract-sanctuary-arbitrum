...
contract Blackmarket is ERC1155, Ownable {
    ...
    constructor(address _admin, address _gameManager, string memory collectionName, string memory collectionSymbol) ERC1155("https://dopewarz.io/api/item/{id}.json") {
        admin = _admin;
