...
contract HelixBorrower is BaseUpgradeablePausable, IHelixBorrower {
    ...
    function cancelInvestment(IHelixFund fund, address account, uint256 subscriptionDate, uint256 amount, uint256 signingTime) external onlyAdmin{
        fund.cancelInvestment(account, subscriptionDate, amount, signingTime);
    }
