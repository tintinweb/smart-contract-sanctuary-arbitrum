...
contract Exchanger is Owned, MixinSystemSettings {
    ...
    bytes32 private constant CONTRACT_SYNTHR_DEBTSHARE = "SynthrDebtShare";
    ...
    function resolverAddressesRequired() public view override returns (bytes32[] memory addresses) {
        ...
        newAddresses[6] = CONTRACT_CIRCUIT_BREAKER;
        newAddresses[7] = CONTRACT_ISSUED_SYNTH_AGGREGATOR;
        newAddresses[8] = CONTRACT_SYNTHR_BRIDGE;
        newAddresses[9] = CONTRACT_SYNTHR_DEBTSHARE;
    ...
    function synthrDebtShare() internal view returns (ISynthrDebtShare) {
        return ISynthrDebtShare(requireAndGetAddress(CONTRACT_SYNTHR_DEBTSHARE));
    }
    ...
    function exchange(
        ...
        if (trackingCode != bytes32(0)) {
            emit ExchangeTracking(trackingCode, args.destCurrencyKey, amountReceived, fee);
        }
    }
