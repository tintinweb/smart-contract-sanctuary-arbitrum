...
// File: contracts/Astro Mvp/IERC4626.sol
...
// File: contracts/Astro Mvp/xAstro.sol
...
contract xAstro is IERC4626, ERC20, ReentrancyGuard, Ownable {
     ...
     * @param receiver_ | Who is receiving xAstro
     */
     ...
     * @param receiver_ address receiving Astro tokens
     * @param owner_ owner of the Astro tokens
     * @dev it is currently set up so that the owner will also
     * receive the rewards, even if they are not receiving the Astro tokens
     */
    function withdraw(
        uint256 assets_,
        address receiver_,
    ...
    ///@notice claims fees, swaps them for Astro, and stakes that Astro
    ///@param amountOutMin the minimum Astro back you want to get for your rewards.
    function compound(uint256 amountOutMin) external updateReward(msg.sender) {
        ...
        //buys Astro, and stakes it for them.
    }
    ...
    function totalAssets()
        ...
        view
        override
        returns (uint256 totalManagedAstro, uint256 totalManagedReward)
    {
