...
// File contracts/interfaces/IDeltaVaultV1.sol

// SPDX-License-Identifier: GPL-3.0
pragma solidity 0.8.16;

interface IDeltaVaultV1 {
    /* ========== EVENTS ========== */
    event Deposit(
    ...
    function depositCap(address account) external view returns (uint256);
...
// File contracts/mocks/DeltaVaultV1Empty.sol
...
contract DeltaVaultV1Empty is IDeltaVaultV1, ERC20, Ownable {
    struct DepositType {
        uint256 assets;
        uint40 timestamp;
    }
    ...
    function updateParams(
        uint256 __depositCap,
        uint256 _totalDepositCap,
        uint16 _slippageBPS,
        uint32 _slippageInterval,
        uint16 _maxLtv,
        uint16 _rangeLtv
    ) external onlyOwner {
