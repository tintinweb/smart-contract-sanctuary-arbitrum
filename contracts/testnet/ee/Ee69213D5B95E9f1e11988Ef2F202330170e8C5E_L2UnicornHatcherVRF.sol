...
abstract contract BaseVRFConsumer is VRFConsumerBaseV2, Ownable {
    ...
    function estimateCostGas() public view returns (uint256){
        return 0;
    }
 ...
 * @notice 独角兽孵化(VRF)
 */
contract L2UnicornHatcherVRF is L2UnicornHatcherPermit, BaseVRFConsumer, BaseMaximum, BaseL2, BaseL2Unicorn, BaseL2UnicornRule, BaseRecipient, BaseCommissionManager, Pausable {
