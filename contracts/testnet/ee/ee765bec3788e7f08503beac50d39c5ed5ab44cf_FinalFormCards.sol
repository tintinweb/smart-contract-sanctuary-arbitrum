...
contract FinalFormCards is ERC721URIStorageUpgradeable, ERC721EnumerableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_, string memory baseUri_, address mintOracleAddress_) initializer public {
