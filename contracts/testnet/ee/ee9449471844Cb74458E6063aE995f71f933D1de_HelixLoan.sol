...
contract HelixLoan is HelixBaseUpgradeablePausable, EIP712Upgradeable, IHelixLoan, IVersioned {
  ...
  /**
    ...
    * @param expirationTime How long the signature from loan manager will be valid 
    * @param salt Random identifier for generating unique investment hash 
    * @param investSignature The signature that has been signed by LoanManager to allow sender to invest
  */
  function invest(
    uint256 investmentDate,
    uint256 amount,
    ...
    // Check signatures which come from loan manager owners
  ...
  */
  ...
  function cancelInvestment(
    ...
    uint256 expirationTime,
    uint256 salt
  ) public onlyManager override isNotClosed {
