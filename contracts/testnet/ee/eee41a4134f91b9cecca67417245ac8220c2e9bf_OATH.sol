...
contract OATH is ERC721Enumerable, ReentrancyGuard, DefaultOperatorFilterer, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 700 700"><style>.base { fill: #fff; font-family: Roboto; font-size: 22px; font-weight: bold;}</style><rect width="100%" height="100%" fill="#000" /><text transform="translate(400.000000,150.000000)" fill="#9e9e9e" font-size="90" font-family="Roboto" ><tspan x="0" y="0">OATH</tspan></text><text transform="translate(455.000000,200.000000)" fill="#9e9e9e" font-size="45" font-family="Roboto" ><tspan x="0" y="0">GENESIS</tspan></text><text x="50" y="460" class="base">';
