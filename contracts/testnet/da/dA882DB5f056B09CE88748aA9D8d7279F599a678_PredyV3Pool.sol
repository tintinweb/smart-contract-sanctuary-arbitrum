...
contract PredyV3Pool is IPredyV3Pool, Ownable, Constants {
    ...
    mapping(bytes32 => VaultLib.PerpStatus) public ranges;

    uint256 public vaultIdCount;

    mapping(uint256 => VaultLib.Vault) public vaults;
    mapping(uint256 => ExtraVaultParam) public extraVaultParams;
    ...
    function depositTokens(
        ...
        if (_withEnteringMarket) {
            ...
            tokenState1.addCollateral(accountState1[_vaultId], _amount1);
        } else {
            VaultLib.Vault storage vault = vaults[_vaultId];
