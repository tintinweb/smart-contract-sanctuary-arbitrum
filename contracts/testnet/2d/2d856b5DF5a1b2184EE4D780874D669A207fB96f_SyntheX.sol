...
abstract contract IPool {
    ...
    /*                              Internal Functions                            */
    /* -------------------------------------------------------------------------- */
    function mint(address _synth, uint _amount) external virtual returns(uint);
    function burn(address _synth, uint _amount) external virtual returns(uint);
    function swapExactAmountIn(address _synthIn, uint _amountIn, address _synthOut) external virtual returns(uint);
    function swapExactAmountOut(address _synthIn, uint _amountOut, address _synthOut) external virtual returns(uint);
    function liquidate(address _synthIn, address _account, uint _amountIn, address _outAsset) external virtual returns(uint);
 ...
 * @author SyntheX ([email protected])
 * 
