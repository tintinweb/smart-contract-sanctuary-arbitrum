...
contract LiquidateProxy is ERC1967Proxy {
    constructor(address logicAddress, bytes memory data) ERC1967Proxy(logicAddress, data) {
    ...
    function upgradeProxy(address newBeacon, bytes memory data)
        ...
        onlyContractOwner
    {
        _upgradeToAndCall(newBeacon, data, false);
    }
