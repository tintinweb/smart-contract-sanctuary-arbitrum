...
contract DummyProtocol {
  ...
  event OrderInitiated(uint256 indexed orderId, uint256 indexed amount, address indexed exchange); // keccak(OrderInitiated(uint256,uint256,string)) => 0xd1ffe9e45581c11d7d9f2ed5f75217cd4be9f8b7eee6af0f6d03f46de53956cd
