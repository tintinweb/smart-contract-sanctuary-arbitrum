...
contract TDCCertificates is ERC721, ERC721Enumerable, Ownable, 
    ...
    constructor() ERC721("TDC Certificates", "TDCCert") {
    ...
    function mintCertificates(address to, uint tokensNumber) public onlyMinter {
        require(tokensNumber > 0, "Wrong number of tokens.");
