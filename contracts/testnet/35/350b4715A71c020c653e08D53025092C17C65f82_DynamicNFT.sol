...
contract DynamicNFT is ERC721, ERC721Enumerable, Ownable, ERC721URIStorage {
    using Strings for uint256;
    ...
    string baseUri =
        "https://raw.githubusercontent.com/ann1712/nft_project/main/metadata/";
    ...
    function mintAll() public payable {
        ...
        require(
            soldRound[round - 1] < MAX_SUPPLY_ROUND[round - 1],
            "NFT sold out!"
        );
    ...
    function _buildImage(uint256 tokenId) private view returns (string memory) {
        string memory buri = baseUri;
        return
            bytes(buri).length > 0
                ? string(abi.encodePacked(buri, tokenId.toString(), ".png"))
                : "";
    }
    ...
    function buildMetadata(
        ...
        string memory url = string(
            abi.encodePacked(buri, _tokenId.toString(), ".png")
        );
        return
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Dynamic NFT", "description":"Dynamic NFT Test","image": url, "attributes": ',
                                "[",
                                '{"trait_type": "UpdateAt",',
                                '"value":"',
