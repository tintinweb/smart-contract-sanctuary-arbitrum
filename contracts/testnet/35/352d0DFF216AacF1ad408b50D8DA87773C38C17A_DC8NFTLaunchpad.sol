    ...
    ReentrancyGuardUpgradeable
{
    ...
    ///////////////// ROLES /////////////////
    bytes32 public constant SETTING_ROLE = keccak256("ADMIN_ACTION_ROLE");
        ...
        whenNotPaused
    {
        ...
        require(
            launches[_launchIndex].sold + launches[_launchIndex].multiTimes <
        ...
        for (uint256 i = 0; i < launches[_launchIndex].multiTimes; ) {
            ...
            uint256 tokenId = DC8NFT.safeMint(msg.sender);
            emit LaunchpadMint(
                msg.sender,
                tokenId,
                _launchIndex,
        ...
        whenInWhiteList(_launchIndex)
    {
        ...
        require(launches[_launchIndex].status, "Launchpad is disable");
        require(
            launches[_launchIndex].sold + launches[_launchIndex].multiTimes < launches[_launchIndex].amount,
            "Launchpad is sold off"
        );
        require(msg.value == launches[_launchIndex].price, "Invalid ETH value");
    ...
    function pause() public onlyRole(SETTING_ROLE) {
        _pause();
    }

    function unpause() public onlyRole(SETTING_ROLE) {
        _unpause();
    }
}