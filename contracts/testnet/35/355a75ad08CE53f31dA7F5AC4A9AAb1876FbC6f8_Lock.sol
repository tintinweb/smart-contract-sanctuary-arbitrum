...
contract Lock  is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x315A88DE90C77FeC2880B6B9B0cA527922F27774); 
    address payable private _marketingAddress = payable(0x315A88DE90C77FeC2880B6B9B0cA527922F27774);
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xab7664500b19a7a2362Ab26081e6DfB971B6F1B0);
