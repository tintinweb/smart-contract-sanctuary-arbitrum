...
contract LucidLonghorns is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 89;
    uint256 MAX_MINT_ARBITRUM = 119;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("LucidLonghorns", "ll") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "LL: Max 2 NFTs per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_ARBITRUM, "LL: Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, "LL: msg.value not enough to cover messageFee. Send gas for message fees");
    ...
    function withdraw(uint amt) external onlyOwner {
        ...
        require(sent, "LL: Failed to withdraw Ether");
    }
