    ...
    IERC2981Upgradeable
{
    ...
    function mintETH(bytes calldata data) external payable virtual nonReentrant {
    ...
    function mintNIL(bytes calldata data) external virtual nonReentrant {
        require(publicSaleOpen(), "NIL:PUBLIC_SALE_NOT_OPEN");
    ...
    function mintWithNETH(uint256[] calldata tokenIds, bytes calldata data) external payable virtual nonReentrant {
    ...
    function mintWithNNIL(uint256[] calldata tokenIds, bytes calldata data) external virtual nonReentrant {
        require(nftParameters.nAllowance > 0 && nSaleOpen(), "NIL:N_SALE_NOT_OPEN");
        require(nftParameters.isNilSale, "NIL:ONLY_POSSIBLE_TO_PAY_WITH_NIL");
        (uint256 amount, uint256 expiry, uint256 random, bytes memory signature) = abi.decode(
            data,
