...
// File contracts/core/Profile.sol
...
contract Profile is Ownable {
  ...
  function setProfile(string memory profile) public {
  ...
  function updateProfile(address user, string memory profile) public onlyOwner {
    users[user] = profile;
  }
