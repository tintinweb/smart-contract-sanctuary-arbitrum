...
contract MultiVestingTokens is OwnableAdmin {
    using SafeERC20 for IERC20;

    /* ======== EVENTS ======== */

    event BondCreated(uint256 deposit, uint256 payout, uint256 expires, uint256 vestingID);
    ...
    ITreasury public immutable customTreasury; // pays for and receives payinToken
...
interface ITreasury {
    ...
    function deposit(address _payinTokenAddress, uint256 _amountpayinToken, uint256 _amountPayoutToken) external;
