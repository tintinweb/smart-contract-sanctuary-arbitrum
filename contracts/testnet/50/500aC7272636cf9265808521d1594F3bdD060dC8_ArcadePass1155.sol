...
*/
contract ArcadePass1155 is ERC1155, ERC1155Burnable, Ownable, Pausable, NonblockingReceiver {
    ...
    *************/
    ...
    modifier correctPrice(uint256 _quantity) {
        require((ETH_PRICE * _quantity) == msg.value, 'Incorrect ETH value Sent');
        _;
    }
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        require(balanceOf(msg.sender, tokenId) > 0, "You must own the token to traverse");
