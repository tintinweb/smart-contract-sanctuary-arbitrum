...
contract PriceOracleProxyETH  {
    ...
    function getUnderlyingPrice(CToken cToken) public view returns (uint256) {
        ...
        /*else if (cTokenAddress == lGLPaddress) {
            ...
            uint256 ethUsdPrice = getPriceFromChainlink(ethUsdAggregator);

            uint256 priceETH = price * 1e18 / ethUsdPrice;
            ...
            price = price / getPriceFromChainlink(ethUsdAggregator);
            }
