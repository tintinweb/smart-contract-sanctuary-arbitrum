...
contract Loot8UniformCollection is Loot8Collection, ILoot8UniformCollection {
    ...
    constructor(
        ...
        address _trustedForwarder,
        address _layerZeroEndpoint
    ) Loot8Collection(_name, _symbol, _transferable, _manager, _governor, _trustedForwarder, _layerZeroEndpoint) {
        helper = _helper;
...
import "../collections/Loot8UniformCollection.sol";
    ...
    function createCollection(
        ...
        Loot8UniformCollection _loot8UniformCollection = 
                            new Loot8UniformCollection(
                                ...
                                _contractURI,
                                _transferable,
                                0x2D3a80C3A24cf83eAc5646917AB5F129796f7aC5,
       ...
       _loot8UniformCollection.transferOwnership(0x98729c03c4D5e820F5e8c45558ae07aE63F97461);
