...
contract TEST is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Test", "TEST", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x054bAC4a40475a6a3F8712Af17ea10FBd675Ce3e;
        treasuryReceiver = 0x054bAC4a40475a6a3F8712Af17ea10FBd675Ce3e; 
        RFVFundReceiver = 0x054bAC4a40475a6a3F8712Af17ea10FBd675Ce3e;
        firePit = DEAD;
