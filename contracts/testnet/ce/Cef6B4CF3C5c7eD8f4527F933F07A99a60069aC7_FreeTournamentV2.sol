...
contract FreeTournamentV2 is ReentrancyGuard, IFreeTournament, Ownable {
    ...
    constructor (IGamePolicy _gamePolicy, IPrizeManagerV3 _prizeManager, IFreeTicket _freeTicket, uint256 _currentGameId) {
    ...
    function _createPrize(uint256 _gameId, address[] memory _winners, address _proposer, uint256 _option) internal {
        ...
        if (_option == 2 || _option == 3) {
            ...
            prizeManager.createPrize(_gameId, _winners, _newVouchers, _gameInfo.prizeToken, (_prizeAmount - _penalty) / _winners.length);
