...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0557D5aEEC6F2DBFFDc2a4CdCE59AE3286a2E896];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafkreigiyciwmh67f5gkv3fkhjepfenwlijg5vk5rmoaxebjtgtipzm6ni/";
...
// File: contracts/TestertkrContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestertkrContract is RamppERC721A {
    constructor() RamppERC721A("tester tkr", "tkr"){}
}
