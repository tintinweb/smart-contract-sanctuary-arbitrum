...
contract SaleERC20 is Pausable, Initializable {
    ...
    struct Round {
        ...
        uint256 saleTokensReceived;
        uint256 saleTokensWithdrawed;
        uint256 deadline; 
        uint256 tokenPrice;
    }
        ...
        public onlyOwner 
    {
        ...
        rounds.push(Round({
            ...
            saleTokensReceived: 0,
            saleTokensWithdrawed: 0,
            deadline: deadline,
    ...
    function buy(uint256 saleTokenAmount) public whenNotPaused {
        ...
        rounds[ongoingRound.id].saleTokensReceived += saleTokenAmount;
    ...
    function withdrawRoundProfit(uint256 roundId) public onlyOwner {
        Round storage round = rounds[roundId];
        uint256 amountToWithdraw = round.saleTokensReceived - round.saleTokensWithdrawed;
        round.saleTokensWithdrawed = round.saleTokensReceived;
