...
contract FuturXGatewayStorage is IFuturXGatewayStorage, OwnableUpgradeable {
    ...
    event PendingUpdated(address account, address indexToken, uint256 count, address colaeteral);
    ...
    function updatePendingCollateral(
        ...
        emit PendingUpdated(param.account, param.indexToken, pendingCollaterals[key].count ,pendingCollaterals[key].collateral );
        return key;
    }
