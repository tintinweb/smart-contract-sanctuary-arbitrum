...
contract DogeLeverage is ERC20, Ownable {
  ...
  address WETH9 = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // TODO eth blockchaine weth
  address DEAD = 0x000000000000000000000000000000000000dEaD;
  address ZERO = 0x0000000000000000000000000000000000000000;


  address tradingFundAddress; // TODO add wallet / contract 
  IbToken bToken;
  ...
  constructor() ERC20("DogeLeverage", "DOGELEV") {
  ...
  //   router = ISwapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564); //Mainnet Uniswap v3
  //   address pair = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984)
  //     .createPool(WETH9, address(this), 10000); // ETH pair - 1%
  //   // pairs[pair] = true;
  //   // isFundExempt[pair] = true;
