...
contract SignupVerifier {
    ...
    function verifyingKey() internal pure returns (VerifyingKey memory vk) {
        ...
        vk.IC[0] = Pairing.G1Point(uint256(95466415993280419279237448448028656379814766911483937644752768385142401270),uint256(20774421148532672242130035553456360532052645783265581259467922757007748233447));
        vk.IC[1] = Pairing.G1Point(uint256(21505637884267903370785467619110379770571665010714810594181404504243106950940),uint256(4497641149901336050496752220497191082210753211567008518814664805116285184981));
        vk.IC[2] = Pairing.G1Point(uint256(16484588364501769602591692095640567682303100773900011184640717006736274838770),uint256(17085548825503299294435511979482070256638178169358318840838961117144764374056));
        vk.IC[3] = Pairing.G1Point(uint256(9554152219798709349479829899295296709493338624367897947273525185519539568106),uint256(4468023239222522971914747041204788260321827362370810077748431453550295724444));
