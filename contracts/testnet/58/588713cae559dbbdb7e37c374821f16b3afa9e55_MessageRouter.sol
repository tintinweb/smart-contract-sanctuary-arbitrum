...
contract MessageRouter is NonblockingLzApp {
    ...
    function estimateFee(uint16 chainId, address destination, bytes memory payload, bytes memory params) external view {
        lzEndpoint.estimateFees(chainId, destination, payload, false, params);
    }
