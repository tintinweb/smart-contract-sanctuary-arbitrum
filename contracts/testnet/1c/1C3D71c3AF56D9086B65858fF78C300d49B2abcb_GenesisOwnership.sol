...
contract GenesisOwnership is NonblockingLzApp, IGenesisOwnership {
    ...
    event GenesisOwnershipTransferred(address from, address to, uint256 startTokenId, uint256 quantity);
    ...
    function _nonblockingLzReceive(
        ...
        TokenOwnership memory prevOwnership = _ownershipOf(
            startTokenId
        );
