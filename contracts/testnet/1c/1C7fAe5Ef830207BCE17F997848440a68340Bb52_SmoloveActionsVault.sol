    ...
    ISmoloveActionsVault
{
    ...
    function claimAllToTreasury() public nonReentrant {
        uint256 totalReward = BattleflyStaker.claimAll();
    ...
    function getTotalClaimableAmount() external view returns (uint256) {
        return BattleflyStaker.pendingRewardsAll(address(this));
    }
    ...
    function _withdraw(uint256 stakeId) internal returns (uint256, uint256) {
        ...
        require(s.unlockAt < block.timestamp, "SMOLOVE_ACTIONS_VAULT:CANNOT_WITHRAW_BEFORE_LOCKTIME");
