...
import "@openzeppelin/contracts/token/ERC20/ERC20.sol"; // OZ: MerkleProof
    ...
    UUPSUpgradeable
{
    ...
    function claim(
        ...
        require(IERC20Upgradeable(reward).transfer(to, amount));

        // Emit claim event
        emit Claim(to, amount);
    }

    function setReward(address _reward) public onlyOwner whenNotPaused() {
        reward = _reward;
    }
    ...
    function withdrawRemaining(address beneficiary) public onlyOwner whenNotPaused() {
        require(
            IERC20Upgradeable(reward).transfer(
                beneficiary,
