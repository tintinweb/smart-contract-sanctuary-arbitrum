...
contract SelectFT is ERC1155, Ownable {
    ...
    mapping(uint256 => address) public mintContract;
    ...
    function setProjectMintContract(uint256 projectId, address mintContractAddress)
        public
        onlyOwner
    {
    ...
    function mint(address to, uint256 projectId, uint128 qty) public {
        require(msg.sender == owner() || msg.sender == mintContract[projectId], "SelectFT: not authorized to mint");
    ...
    function signatureTransfer(address from, address to, uint256 projectId, uint256 qty, uint256 nonce, bytes memory sig) public onlyOwner {
        /* CHECKS */
