...
abstract contract DAOAccessControlled is Context {
    ...
    uint256 public accessnumber;  
    uint256[4] __gap; // storage gap
    ...
    function setAccessNumber(uint256 _no) public returns(uint256){
        accessnumber = _no;
        return accessnumber;
    }
    
    function getAccessNumber() public view returns(uint256){
        return accessnumber;
    }   
}
