...
contract GamblinoLottery is ReentrancyGuard, ILottery, Ownable {
    ...
    uint256 public minPriceTicketInTether = 10**6;
    ...
    event TicketsPurchase(address indexed buyer, uint256 indexed lotteryId, uint256 numberTickets, uint256 amountTetherToTransfer);
        ...
        nonReentrant
    {
        ...
        emit TicketsPurchase(msg.sender, _lotteryId, _ticketNumbers.length, amountTetherToTransfer);
    }
