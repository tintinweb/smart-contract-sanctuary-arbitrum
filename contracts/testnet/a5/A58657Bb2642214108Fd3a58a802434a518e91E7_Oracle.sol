...
contract Oracle is AccessControl, IOracle {
    ...
    */
    ...
    function _writePrice(
        ...
        require(price != 0, "INVALIDE_PRICE");
    ...
    {
        // fixme can we compute valid close timestamp from given timestamp? I mean each 1m we have price at 0:00:00 if we Ask at 30s in a minute you should give me that previous one..
        // legendary: I see what you mean. I need to think about what we will use record timestamp. timestamp from backend? or block.timestamp? we need to choose either one.
