...
uint256 constant ID = uint256(keccak256("game.piratenation.timerangecomponent"));

/**
 * @title TimeRangeComponent
 * @dev Time Range Component
 */
contract TimeRangeComponent is BaseComponent {
    /** SETUP **/
     ...
     * @param startTime uint32 Start time of the range    
     * @param endTime uint32 End time of the range    
     */
    function setValue(
        uint256 entity,
        uint32 startTime,
        ...
        setBytes(entity, abi.encode(startTime, endTime));
    }
