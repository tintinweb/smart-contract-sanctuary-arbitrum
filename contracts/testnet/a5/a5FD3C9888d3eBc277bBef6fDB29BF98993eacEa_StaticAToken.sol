...
/**
 * @title StaticAToken
 * @dev Wrapper token that allows to deposit tokens on the Calculus protocol and receive
  ...
  IInitializableStaticAToken
{
  ...
  /**
   * @dev Deposits `ASSET` in the Calculus protocol and mints static aTokens to msg.sender
   ...
   * @param recipient The address that will receive the amount of `ASSET` withdrawn from the Calculus protocol
  ...
  /**
   * @dev Allows to deposit on Calculus via meta-transaction
   * https://github.com/ethereum/EIPs/blob/8a34d644aacf0f9f8f00815307fd7dd5da07655f/EIPS/eip-2612.md
  ...
  /**
   * @dev Allows to withdraw from Calculus via meta-transaction
   * https://github.com/ethereum/EIPs/blob/8a34d644aacf0f9f8f00815307fd7dd5da07655f/EIPS/eip-2612.md
   * @param owner Address owning the staticATokens
   * @param recipient Address that will receive the underlying withdrawn from Calculus
   ...
   * using the current liquidity index on Calculus
  ...
  /**
   * @dev Returns the Calculus liquidity index of the underlying aToken, denominated rate here
