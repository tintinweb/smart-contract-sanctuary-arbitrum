...
contract SamuRiseAllies is ERC1155Upgradeable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    using ECDSAUpgradeable for bytes32;
    using StringsUpgradeable for uint256;

    string public constant name = "SamuRiseAllies"; 
    string public constant symbol = "SAMURISE_ALLIES";
    ...
    function mint(bytes memory _signature, uint256 _collectionId, uint256 _numberToClaim, uint256 _maxAllocation, uint256 _nonce) 
        ...
        hasValidSignature(_signature, abi.encodePacked(msg.sender, _collectionId, _numberToClaim, _maxAllocation, _nonce)) 
    {
    ...
    function addCollection(uint256 _totalSupply, string memory _collectionName) external onlyOwner {
