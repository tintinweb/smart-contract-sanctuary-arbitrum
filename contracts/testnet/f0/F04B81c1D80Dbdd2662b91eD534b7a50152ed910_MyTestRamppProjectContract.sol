...
//
//   ______          __     ______          __ 
//  /_  __/__  _____/ /_   /_  __/__  _____/ /_
//   / / / _ \/ ___/ __/    / / / _ \/ ___/ __/
//  / / /  __(__  ) /_     / / /  __(__  ) /_  
// /_/  \___/____/\__/    /_/  \___/____/\__/  
//                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0CFd8F4E80dBb95F44665F713B948e186F53Ff1F];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigiiezxbm4rc4462rcudds5f5byhjztzm7bzurzwyvfggzsdhnfaq/";
...
// File: contracts/MyTestRamppProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyTestRamppProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Test Rampp Project", "TESTT"){}
}
