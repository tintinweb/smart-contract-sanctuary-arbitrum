...
library LibTradingCore {
    ...
    // todo: Replace with "apollox.trading.core.storage" for mainnet deployment
    bytes32 constant TRADING_CORE_POSITION = keccak256("apollox.trading.core.storage.20230809");
