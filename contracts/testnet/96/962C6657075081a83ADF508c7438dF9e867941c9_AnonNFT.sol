...
contract AnonNFT is ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor(address _marketplaceAddress, address _keyAddress, uint256 maxNftSupply) ERC721("AnonNFT", "USMOL") {
    ...
    function createToken(string memory _tokenURI) public returns (uint) {
        ...
        IERC721 key = IERC721(keyAddress);
            
        require(key.balanceOf(msg.sender) > 0, "your not a Artist, dude");
