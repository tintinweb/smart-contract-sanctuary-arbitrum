...
contract ApolloxExchangeTreasury is Ownable, Pausable {
    ...
    mapping(uint256 => uint256) public claimPerHours;
    ...
    function addToken(
        ...
        if (fixedPrice) {
            ...
            require(priceFeed != address(0), "when the price is not fixed, the priceFeed cannot be zero address");
