...
contract Fiat24CryptoTopUp is Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    //     address(0xB26E32b98FbA7b0E04A58f32CE69AB63fAA36B0d),
    //     0xf670Ca96167471BC1aA512e69417d79Ed8CBD550,
    //     0xB6297df68aD3035335B2df19820eb4e3da075De9,
    //     0x25e56eE3Dfc72AAa18E275BF946Dd301455Cbc6A
    // ];
    ...
    function initialize(address fiat24AccountAddress_, 
        ...
        outputTokens =  [
            ...
            0x92c5484555f4fF3db93568EcEd826329D65e7d01,
    ...
    function topUpCryptoViaETH(address tokenIn, address tokenOut, uint256 amount) external returns(uint256){
        ...
        //USDC->USD24
        uint256 usd24Amount = getTopUpAmount(tokenId, msg.sender, outputAmount);
