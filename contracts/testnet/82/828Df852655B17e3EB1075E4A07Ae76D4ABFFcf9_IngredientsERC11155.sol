...
contract IngredientsERC11155 is ERC1155, ERC1155Burnable,ReentrancyGuard, Ownable, Pausable {
    ...
    mapping (address => bool) isGen0Contract;
    mapping (address => bool) isGen1Contract;

    modifier onlyStakeContract {
        require(isGen0Contract[msg.sender] || isGen1Contract[msg.sender]);
        _;
    }
    ...
    function setGen0MintCaller(address _address, bool _value) public{
        isGen0Contract[_address] = _value;
    }
    function setGen1MintCaller(address _address, bool _value) public{
        isGen1Contract[_address] = _value;
    }
