...
contract Krakatoa is Initializable, OwnableUpgradeable, EIP712Upgradeable {
...
//    bytes32 private constant OFFER_TYPE = keccak256("Offer(uint8 quantity,uint64 offerId,uint64 productId,uint256 price,uint256 finalTimestamp,address buyer)");
    ...
    function getAi() public view returns(uint256) {
        return ai;
    }
     ...
     */
    function initCommission(uint16 commission_) internal onlyOwner {
