...
contract UniswapOracle is Owned {
    ...
    string public description = "Uniswap v3 Oracle";
    ...
    {
        (uint256 sweep_amount, uint256 usdx_amount) = getLiquidity();
        price = (usdx_amount * 1e6) / (sweep_amount / 1e12);
    }
    ...
    {
        uint256 global0FeeAmount = pool.feeGrowthGlobal0X128();
        uint256 global1FeeAmount = pool.feeGrowthGlobal1X128();
