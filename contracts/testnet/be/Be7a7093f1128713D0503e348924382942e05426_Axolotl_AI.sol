...
contract Axolotl_AI is ERC20, Ownable { //IsIBEP20 ?
    ...
    */
    ...
    function launch() public onlyOwner {
        ...
        _burn(address(this), (_totalSupply * 20) / 100);          //Burn 20%
        _transfer(flexWallet, address(this), (_totalSupply * 31) / 100); //Presale 31%
        _transfer(liqWallet, address(this), (_totalSupply * 20) / 100); // Liquidity 20%
        _transfer(devWallet, address(this), (_totalSupply * 5) / 100); // Development 5%
        _transfer(marketingWallet, address(this), (_totalSupply * 5) / 100); // Marketing/Partnerships 5%
        _transfer(flexWallet, address(this), (_totalSupply * 4) / 100); // Cex Listings 4%
        _transfer(flexWallet, address(this), (_totalSupply * 3) / 100); // Advisors 3%
        _transfer(airdropWallet, address(this), (_totalSupply * 9) / 100); // Unlocked 9%
        _transfer(airdropWallet, address(this), (_totalSupply * 3) / 100); // Airdrop 3%
