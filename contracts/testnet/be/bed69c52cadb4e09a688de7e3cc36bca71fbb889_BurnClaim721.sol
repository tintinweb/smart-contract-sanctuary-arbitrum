...
import {MainCollection1155} from "./MainCollection1155.sol";

import {ERC721AQueryable} from "./ERC721A/ERC721AQueryable.sol";
import {ERC721A} from "./ERC721A/ERC721A.sol";
import {IERC721A} from "./ERC721A/IERC721A.sol";

contract BurnClaim721 is ERC721AQueryable, Ownable, AccessControl {
    using Strings for uint256;

    string public baseURI;
    address public vault;
    MainCollection1155 public immutable mainCollection;
    ...
    constructor(
        ...
        baseURI = _baseURI;
        mainCollection = MainCollection1155(_mainCollection);
    }

    function claim() external payable {
        require(
            mainCollection.balanceOf(msg.sender, 0) > 0,
            "You need to own at least one token from the main collection to claim a token"
        );

        mainCollection.burn(msg.sender, 0, 1);
    ...
    function setMintPrice(uint256 _mintPrice) external onlyRole(minterRole) {
...
contract MainCollection1155 is ERC1155, Ownable {
    uint256 public mintPrice = 0.0001 ether;
    address public vault;
