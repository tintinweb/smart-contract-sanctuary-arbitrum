...
// File: contracts/governance/governor/GovernorDelegate.sol
...
contract GovernorJohnnyDelegate is GovernorJohnnyDelegateStorage, GovernorJohnnyEvents, IGovernorJohnnyDelegate {
  /// @notice The name of this contract
  string public constant name = "Uplend Protocol Governor";
   ...
   * @param upt_ The address of the UPT token
  ...
  function propose(
    ...
    require(quorumVotes != 0, "Johnny not active");
    // Allow addresses above proposal threshold and whitelisted addresses to propose
    require(
      upt.getPriorVotes(_msgSender(), (block.number - 1)) >= proposalThreshold || isWhitelisted(_msgSender()),
  ...
  function cancel(uint256 proposalId) external override {
    ...
    if (_msgSender() != proposal.proposer) {
      ...
      if (isWhitelisted(proposal.proposer)) {
        require(
          (upt.getPriorVotes(proposal.proposer, (block.number - 1)) < proposalThreshold) &&
  ...
  function castVoteInternal(
    ...
    uint96 votes = upt.getPriorVotes(voter, proposal.startBlock);
