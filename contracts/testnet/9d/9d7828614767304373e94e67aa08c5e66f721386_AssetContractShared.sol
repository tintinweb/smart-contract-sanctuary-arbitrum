...
// File: marketContract/nftcontract/TokenIdentifiers.sol
...
// File: marketContract/nftcontract/meta-transactions/Initializable.sol
...
// File: marketContract/nftcontract/meta-transactions/EIP712Base.sol
...
// File: marketContract/nftcontract/meta-transactions/NativeMetaTransaction.sol
...
// File: marketContract/nftcontract/meta-transactions/ContentMixin.sol
...
// File: marketContract/nftcontract/ERC1155Tradable.sol
...
Pausable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's holygun proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist holygun proxy contracts for easy trading.
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by holygun.
     */
    function _msgSender() internal view override returns (address sender) {
        return ContextMixin.msgSender();
    }
}
// File: marketContract/nftcontract/AssetContract.sol
...
/**
 * @title AssetContract
 * AssetContract - A contract for easily creating non-fungible assets on holygun.
 */
contract AssetContract is ERC1155Tradable {
    ...
    function holygunVersion() public pure returns (string memory) {
        return "2.1.0";
    }
    ...
    /**
     * Compat for factory interfaces on holygun
...
// File: marketContract/nftcontract/AssetContractShared.sol
 ...
 * holygun shared asset contract - A contract for easily creating custom assets on holygun
 */
