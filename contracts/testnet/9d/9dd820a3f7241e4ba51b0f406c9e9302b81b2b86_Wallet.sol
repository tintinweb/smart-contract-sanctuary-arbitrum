...
abstract contract BaseWallet is IAccount, UUPSUpgradeable, UniversalReceiver {
    struct Signature {
        uint8 v;
        bytes32 r;
        bytes32 s;
    ...
    uint256 public constant COMMIT_DURATION = 45 minutes;
    ...
    function _afterMultiCall(Call[] calldata calls) internal virtual {}
        ...
        public override onlyEntryPoint returns (uint256 validationData)
    {
        ...
        require(selector != IAccount.validateUserOp.selector, "Reentrancy into validateUserOp not allowed");
