...
contract PanikKalm is Ownable {
    ...
    constructor(IPanikToken _panik, uint256 _lockDuration, bool _depositsEnabled) {
        panik = _panik;
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC20(address(panik)).safeTransferFrom(address(msg.sender), address(this), _amount);
        panik.burn(_amount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        user.amount -= _amount;
        totalStaked -= _amount;
        panik.mint(address(msg.sender), _amount);
