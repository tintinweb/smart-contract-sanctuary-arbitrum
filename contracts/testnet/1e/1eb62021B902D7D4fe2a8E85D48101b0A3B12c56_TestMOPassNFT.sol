...
interface IMOPassMetaDataRender {
    function constructTokenURI(address PassContract, uint256 PassId) external view returns (string memory);
}
...
contract TestMOPassNFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("MOPN PASS", "MOPN") {}
    ...
    function tokenURI(uint256 id) public view override returns (string memory tokenuri) {
        ...
        if (mopMetaDataRenderAddress != address(0)) {
            ...
            tokenuri = metaDataRender.constructTokenURI(address(this), tokenIdToIndex[id]);
        }
    }
}
