...
// File: contracts/interfaces/IBlocksBonusPool.sol


pragma solidity >=0.5.0;

interface IBlocksBonusPool {
...
// File: contracts/token/Blocks.sol
...
contract Blocks is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        IBlocksBonusPool(bonusWallet).injectRewards(amountDogBonus);
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'BLOCKS: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "BLOCKS: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "BLOCKS: index out of bounds");
