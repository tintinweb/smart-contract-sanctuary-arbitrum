 ...
 */
contract BancorFormula is IBondingCurve{
...
//  maxExpArray[31] = 0x1d6bd8b2ebffffffffffffffffffffffff;
  ...
  */
  ...
  function calculatePurchaseReturn(
    ...
    uint256 _depositAmount) external virtual view returns (uint256)
  {
    // validate input
    require(_reserveBalance > 0 && _reserveRatio > 0 && _reserveRatio <= MAX_RESERVE_RATIO);
  ...
  function calculateSaleReturn(
    ...
    uint256 _reserveBalance,
    uint32 _reserveRatio,
    uint256 _sellAmount) external virtual view returns (uint256)
  {
    // validate input
...
/// @title Interface for a bonding curve
/// @author @miazn
/// @dev Code could be better, could be worse


// total shares staked, or total shares counterstaked
interface IBondingCurve {
  ...
  function calculateSaleReturn(
    ...
    uint256 _reserveBalance,
    uint32 _reserveRatio,
    uint256 _sellAmount) external view returns (uint256);
}
