    ...
    ERC2771Context
{
    ...
    // uint256 public constant LOCK_PERIOD = 10 minutes; //For development
    uint256 public constant BPS = 1e6;
    ...
    uint256 public liquidityShare = 500000; //70%
    ...
    function deposit(uint256 amount)
        ...
        returns (uint256)
    {
        return _deposit(_msgSender(), amount);
    }
        ...
        returns (uint256)
    {
        ...
        return _deposit(gasLess.owner, amount);
    }
    ...
    function withdraw(uint256 _amountLP)
        ...
        returns (uint256)
    {
        return _withdraw(_msgSender(), _amountLP);
    }
        ...
        returns (uint256)
    {
        ...
        _useNonce(gasLess.owner);
        return _withdraw(gasLess.owner, amountLp);
    }

    function _withdraw(address owner, uint256 amountLP)
        internal
        returns (uint256)
    {
        ...
        usdc.safeTransfer(owner, amountUSDC);
