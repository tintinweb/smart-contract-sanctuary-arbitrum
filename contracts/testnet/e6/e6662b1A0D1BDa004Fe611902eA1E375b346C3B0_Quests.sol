...
// MODIFIERS
    ...
    modifier onlyIfEnoughHealth(uint256 tokenID, uint256 numberOfQuests) {
        ...
        farmlandCharacters.setHealthTo(tokenID, uint16(health));
...
// FUNCTIONS
        ...
        onlyQuestActive(tokenID)
    {
        ...
        // farmlandCharacters.decreaseHealth(tokenID, numberOfActivities);                     // Update the characters health
...
// INTERNAL HELPER FUNCTIONS
    ...
    {
        //TODO: Increase courage sometimes
