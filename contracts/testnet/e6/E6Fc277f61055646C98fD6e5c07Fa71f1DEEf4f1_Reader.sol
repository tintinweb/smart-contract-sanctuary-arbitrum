...
import "../interfaces/tokens/gemLp/IPancakeFactory.sol";
...
contract Reader {
    ...
    /**
     * @notice returns the maximum amount of tokenIn that can be sold in the GEMLP
    ...
    function getAmountOut(
        ...
        uint256 feeBasisPoints;
        {
            ...
            uint256 feesBasisPoints0 = IVaultUtils(vaultUtilsAddress)
                .getFeeBasisPoints(_tokenIn, usdwAmount, baseBps, taxBps, true);
            uint256 feesBasisPoints1 = IVaultUtils(vaultUtilsAddress)
                .getFeeBasisPoints(
                    _tokenOut,
                    usdwAmount,
                    baseBps,
    ...
    function getSwapFeeBasisPoints(
        ...
        uint256 feesBasisPoints0 = IVaultUtils(vaultUtilsAddress)
            .getFeeBasisPoints(_tokenIn, usdwAmount, baseBps, taxBps, true);
        uint256 feesBasisPoints1 = IVaultUtils(vaultUtilsAddress)
            .getFeeBasisPoints(_tokenOut, usdwAmount, baseBps, taxBps, false);
        // use the higher of the two fee basis points
    ...
    function getVaultTokenInfo(
        ...
        IOracleRouter priceOracleRouter = IOracleRouter(
            vault.priceOracleRouter()
        );
    ...
    {
        wagerFeeToken_ =
            (_amountWager * IVault(vaultAddress).wagerFeeBasisPoints()) /
            1e18;
    ...
    function getSwapBasisPoints(
        ...
        external
        view
        returns (uint256 swapBasisPoints_, uint256 amountToBeSwapped_)
    {
     ...
     * @param _usdValueOfSwapAsset USD value of the asset that is considered to be traded into the GEMLP - scaled 1e30!!
    ...
    function whatIsTheCheapestWagerWinningLeg(
        ...
        external
        view
        returns (address wagerAsset_, address winAsset_, uint256 basisPoint_)
    {
