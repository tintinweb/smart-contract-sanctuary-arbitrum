...
contract Skills {
    ...
    function stake(uint endDate, uint256 submissionsAllotted, uint256 numberOfWinners) payable external returns(uint256) {
        ...
        require(numberOfWinners >= submissionsAllotted, "The number of winners must be grater than or equal to the submissions allotted.");
        ...
        require(fundsNeeded > unallocatedFunds, "There is not enough reward to fulfill this order.");
