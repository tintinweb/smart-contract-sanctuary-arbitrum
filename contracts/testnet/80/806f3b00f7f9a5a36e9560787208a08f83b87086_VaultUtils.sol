...
contract VaultUtils is IVaultUtils, AccessControlBase {
    ...
    function getBuyUsdwFeeBasisPoints(
        address _token, 
        uint256 _usdwAmount) external override view returns (uint256) {
    ...
    function getSwapFeeBasisPoints(
        address _tokenIn, 
        address _tokenOut, 
        uint256 _usdwAmount) external override view returns (uint256 effectiveSwapFee_) {
    ...
    function getFeeBasisPoints(
         ...
         */
        uint256 initialDiff_ = initialAmount_ > targetAmount_ ? (initialAmount_ - targetAmount_)  : (targetAmount_ - initialAmount_);

        /**
         * calculate the balance of the pool after the swap/deposit/mutation is processed
         */
        uint256 nextDiff_ = nextAmount_ > targetAmount_ ? (nextAmount_ - targetAmount_) : (targetAmount_ - nextAmount_);
