...
contract OrderAndTradeHistoryFacet is IOrderAndTradeHistory, OnlySelf {
    ...
    function _saveActionInfo(
        ...
        actionInfos.push(ActionInfo(hash, uint40(Chain.currentTimestamp()), aType));
    }
...
library LibOrderAndTradeHistory {
    ...
    bytes32 constant ORDER_TRADE_HISTORY_POSITION = keccak256("shardex.order.trade.history.storage");
