...
import "./IFood.sol";
import "./FoodState.sol";

contract Food is Initializable, IFood, FoodState {

    string public name = "Food";
    string public symbol = "FOOD";

    function initialize() external initializer {
        FoodState.__FoodState_init();
    }
    ...
    function setURI(string memory _newuri) external onlyAdminOrOwner {
        _setURI(_newuri);
    }
    ...
    function burn(
        ...
        uint256 id,
        uint256 value
    ) public override(IFood, ERC1155BurnableUpgradeable) {
...
interface IFood is IERC1155Upgradeable {
...
abstract contract FoodState is Initializable, AdminableUpgradeable, ERC1155BurnableUpgradeable {

    function __FoodState_init() internal onlyInitializing {
