...
contract CctpBridgeAdapter is IBridgeAdapter, Ownable
{
	using SafeERC20 for IERC20Metadata;

	ICrossLedgerVault public immutable crossLedgerVault;

	ITokenMessendger public immutable tokenMessendger;
