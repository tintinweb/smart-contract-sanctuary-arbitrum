...
import {CountingSystemV2, ID as COUNTING_SYSTEM_V2} from "../counting/CountingSystemV2.sol";
...
contract BountySystem is IBountySystem, GameRegistryConsumerUpgradeable {
    ...
    function hasPendingBounty(
        ...
        CountingSystemV2 countingSystem = CountingSystemV2(
            _gameRegistry.getSystem(COUNTING_SYSTEM_V2)
        );
    ...
    function _setActiveBountyCompleted(
        ...
        CountingSystemV2(_gameRegistry.getSystem(COUNTING_SYSTEM_V2)).setCount(
            groupId,
            EntityLibrary.addressToEntity(account),
            0
        );
    ...
    function _verifyStartBounty(
        ...
        CountingSystemV2(_gameRegistry.getSystem(COUNTING_SYSTEM_V2))
            .incrementCount(groupId, EntityLibrary.addressToEntity(account), 1);
    }
