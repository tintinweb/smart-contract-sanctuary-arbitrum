...
contract ArbiGobblers is ERC721, IArbiGobblers,LogisticVRGDA, Ownable, Pausable, PaymentSplitter {
  ...
  function prepareMintFromDA() external whenNotPaused onlyEOA whenDAisStarted {
    require(userRandTicket[msg.sender] == 0, "Must use ticket first");
  ...
  function mintFromDA() payable external whenNotPaused onlyEOA  whenDAisStarted{
  ...
  function mintFromAstro() external whenNotPaused onlyEOA {
    ...
    astroToken.burnForArbiGobbler(msg.sender, ArbiGobblerPrice());
