...
contract BlocksDistributor is OwnableUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;
    using SignatureChecker for EnumerableSet.AddressSet;

    uint256 public constant MAX_ADDRESSES = 625143;
    uint256 public constant MAX_TOKEN = 420_000_000_000_000 * 1e6;
    uint256 public constant INIT_CLAIM = 69_000_000_000 * 1e6;
    ...
    function addSigner(address val) public onlyOwner() {
        require(val != address(0), "Blocks: val is the zero address");
        _signers.add(val);
    }

    function delSigner(address signer) public onlyOwner returns (bool) {
        require(signer != address(0), "Blocks: signer is the zero address");
