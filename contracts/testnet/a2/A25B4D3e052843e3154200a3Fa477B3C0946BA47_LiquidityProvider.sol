...
contract LiquidityProvider is ILiquidityProvider, BlockContext, ClearingHouseCallee, LiquidityProviderStorageV1 {
    ...
    function _getPendingFee(address baseToken, Account.LPInfo memory order) internal view returns (uint256) {
        ...
        console.log("order.lastExchangeFeeIndex", order.lastExchangeFeeIndex);
        console.log("_feeGrowthPerLiquidityUnitIndexMap[baseToken]", _feeGrowthPerLiquidityUnitIndexMap[baseToken] - 1);
        console.log("latest", _feeGrowthPerLiquidityUnitMap[baseToken][uint256(11748)]);
    ...
    function setLPCalcFeeRatio1(address baseToken, uint256 index) external {
        _feeGrowthPerLiquidityUnitIndexMap[baseToken] = index;
    }
