...
// RewardsDistribution struct holds information about the chances of each item rarity within the subpool
...
// Handles the rewards pool for a loot box system for Realm Peripherals.
// It utilizes the RarityItemMinter contract to mint and dispense rewards based on predefined chances for each rarity.
  ...
  ManagerModifier
{
  ...
  mapping(uint64 => RarityItemRewardsDistribution) rewardDistributions;
