...
contract LIRA is ERC20("Satoshi LIRA", "LIRA"), Ownable {
    ...
    function mint(uint256 amount) public onlyOwner {
        if (totalSupply() == 0) {
            ...
            uint256 quoteAmount = quote(amount, totalSupply(), wbtc.balanceOf(address(this)));

            _mint(_msgSender(), quoteAmount);
        }
    ...
    function quote(uint amountA, uint reserveA, uint reserveB) public pure returns (uint amountB) {
        ...
        amountB = SafeMath.div((amountA * 10 ** 8).mul(reserveB), (reserveA * 10 ** 8), "LIRA: DIVISION_ERROR");
    }
