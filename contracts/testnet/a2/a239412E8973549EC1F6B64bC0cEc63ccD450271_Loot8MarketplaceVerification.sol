...
contract Loot8MarketplaceVerification is ILoot8MarketplaceVerification, Initializable, EIP712Upgradeable {
    ...
    bytes32 private constant _TYPEHASH =
        keccak256('RequestValidated(address patron,address collection,uint256 tokenId,address paymentToken,uint256 price,string action,unit256 listingType,string message,uint256 nonce,uint256 expiry)');
...
interface ICollectionData {
    ...
    struct CollectionDataAdditional {
        ...
        PassportType passportType; // The type of passport. Used for passports only
...
interface ILoot8Marketplace is ICollectionData {
    ...
    function checkItemValidity(address _passport, address _collection) external;
    function checkTraderEligibility(address _patron, address _passport, address _collection, ListingType _listingType) external view;
