    ...
    ReentrancyGuard
{
     ...
     */
    function claim(address user, uint8 timeframeId, uint256 epoch) external nonReentrant {
     ...
     */
    function claimBatch(address user, uint8[] memory timeframeIds, uint256[][] memory epochs)
        external
        nonReentrant
    {
