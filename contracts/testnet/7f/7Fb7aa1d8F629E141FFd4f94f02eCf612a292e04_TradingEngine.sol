...
library PositionLib {
    ...
    function increase(
        ...
        uint256 prevCollateralValue = position.collateralValue;
        uint256 nextCollateralValue = prevCollateralValue +
            params.collateralValue +
            fundingPayout -
            fundingDebt;
        uint256 collateralValueDelta = nextCollateralValue - prevCollateralValue;
        ...
        result.collateralValueDelta = collateralValueDelta;
    ...
    function decrease(
        ...
        console.log("funding payout", result.fundingPayout);
        console.log("funding Debt", result.fundingDebt);
        console.log("PNL");
        ...
        console.log("collateralReduced===================", result.collateralReduced);
        console.log("collateralAmount", position.collateralAmount);
        console.log("position.collateralValue", position.collateralValue);
...
contract Validator is Storage {
    ...
    function validateExceedMaxOpenInterest(
        ...
        require(
            size <= collateralValue * marketParams[marketId].maxLeverage,
            "Validator:: invalid leverage"
        );
    }
...
contract TradingEngine is Storage, Validator, FundingManager, ReentrancyGuard {
    ...
    function decreasePosition(DecreasePositionParams calldata params) external onlyExchange {
        ...
        console.log(
            "DEcrease POSITION ========= collateral amount left",
