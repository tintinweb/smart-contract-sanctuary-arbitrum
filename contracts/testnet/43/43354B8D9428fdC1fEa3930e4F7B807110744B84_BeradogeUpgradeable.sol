...
contract BeradogeUpgradeable is ERC721A__Initializable, ERC721AUpgradeable, ERC721A__OwnableUpgradeable, ERC2981Upgradeable{
    ...
    uint256 public TWO_DOLLARS_ETH;
    ...
    address public KPA; //THIS IS OUR HARDCODED FEE ADDRESS 

    //Add as many payout addresses as they want as lines here;
    address public OPA1; //OPA is owner payout address set this depending on what they put
    ...
    function initialize(string memory name, string memory symbol) public initializerERC721A {
        ...
        TWO_DOLLARS_ETH = 0.00108 ether;
        mintLive = false;
        baseURI = "ipfs://QmawAiRBuFCbww2Lqi1tqTcHL1L8tru8sF5KTQ8SHc6xRa/";
        KPA = 0xb009dfBE748Cf46fa5aa88eE9Ab7743dAdeB13F3;
        OPA1 = 0x3E92A58F789087e3FAd68F563386eCf5EcbE1D8D;
        royaltyAddress = 0x3E92A58F789087e3FAd68F563386eCf5EcbE1D8D;
...
// <------------------------------------- Main Functions ------------------------------------->
    ...
    function _baseURI() internal view override returns (string memory) {
        if(reveal == false) {
            return "ipfs://QmawAiRBuFCbww2Lqi1tqTcHL1L8tru8sF5KTQ8SHc6xRa/";
        } else {
            return baseURI;
        }
    }
