...
import "./TesttokenP.sol";


contract PowarbLottery is ReentrancyGuard, Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    enum Status {
        Open, // the Lotto draw is open for ticket sales
        Close,  // the Lotto draw is closed
        Claimable  // the Lotto draw is open for ticket sales
    }
    ...
    function buyTickets(uint[6] calldata numbers) public payable nonReentrant {
        ...
        */
        ...
        uint256 powarbEarn = ticketPrice - commisionFee;
        _lotteries[currentLotteryId].transferJackpot += powarbEarn;
...
contract TesttokenP is ERC20, Ownable {
    constructor() ERC20("TesttokenP", "TTP") {
        _mint(0xABbDB842294a098083b23cB660cCDd7F02d5f18b, 100);
    }
