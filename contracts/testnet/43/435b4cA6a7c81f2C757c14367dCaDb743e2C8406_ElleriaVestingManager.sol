...
contract ElleriaVestingManager is Ownable, ReentrancyGuard{
    ...
    uint256 private vestingSchedulesReleased;
    uint256 private contractTotalBalance;
    ...
    function deposit(uint256 _amountInWEI) external nonReentrant {
        _token.transferFrom(msg.sender, address(this), _amountInWEI);
        contractTotalBalance = contractTotalBalance + _amountInWEI;
    }
    ...
    */
    ...
    function createVestingSchedule(
        ...
        require( this.getWithdrawableAmount() >= _amountTotal, "TokenVesting: insufficient tokens for vesting schedule");
    ...
    */
    function release(
        ...
        vestingSchedule.amountReleased = vestingSchedule.amountReleased + amount;
        vestingSchedulesTotalAmount = vestingSchedulesTotalAmount - amount;
        vestingSchedulesReleased = vestingSchedulesReleased + amount;
        _token.safeTransfer(vestingSchedule.recipient, amount);
    }
    ...
    function getWithdrawableAmount() public view returns(uint256){
        return contractTotalBalance - vestingSchedulesTotalAmount;
    }
    ...
    function amountExcludedFromCirculatingSupply() external view returns(uint256) {
        return vestingSchedulesTotalAmount - vestingSchedulesReleased;
    }
}
