...
contract Vault is IVault, Ownable, ReentrancyGuard {
    ...
    function increasePosition(
        ...
        if (_isLong) {
            ...
            _increasePoolAmountWithAdjustment(
                _collateralToken,
                collateralDeltaToken
            );
            // fees need to be deducted from the pool since fees are deducted from position.collateral
            // and collateral is treated as part of the pool
            _decreasePoolAmountWithAdjustment(
                _collateralToken,
    ...
    function _decreasePosition(
        ...
        if (_isLong) {
            ...
            _decreasePoolAmountWithAdjustment(_collateralToken, amountOutToken);
        }
    ...
    function addCollateral(
        ...
        _increasePoolAmountWithAdjustment(_collateralToken, _amountInToken);
        _updateCumulativeBorrowingRate(_collateralToken, _indexToken);
    }
    ...
    function removeCollateral(
        ...
        _decreasePoolAmountWithAdjustment(_collateralToken, _amountInToken);
        _updateCumulativeBorrowingRate(_collateralToken, _indexToken);
    ...
    function _increasePoolAmountWithAdjustment(address _token, uint256 _amount)
        private
    {
        _amount = adjustDecimalToToken(_token, _amount);
    ...
    function _decreasePoolAmountWithAdjustment(address _token, uint256 _amount)
        private
    {
        _amount = adjustDecimalToToken(_token, _amount);
