...
contract RFSale is IRFSale, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    // Checking if FAN round was already set.
    ...
    function initialize(address _admin, address _saleFactory, address _allocationStaking) external initializer {
        require(_admin != address(0));
    ...
    /**
        ...
        Must be provided as 1000 per 1% i.e. 2450 for 24.5% of total tokens amount.
    ...
    function claimTokens(bytes32[] calldata _merkleProof) external override nonReentrant whenNotPaused {
