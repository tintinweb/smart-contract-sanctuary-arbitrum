...
contract GNSReferralsV6_2 is Initializable {
    ...
    function distributePotentialReward(
        ...
        uint referrerRewardValueDai = (volumeDai * getReferrerFeeP(pairOpenFeeP, r.volumeReferredDai)) /
            PRECISION /
            100;
        ...
        if (a.active) {
            ...
            emit AllyRewardDistributed(r.ally, trader, volumeDai, allyRewardToken, allyRewardValueDai);
        }
        ...
        emit ReferrerRewardDistributed(referrer, trader, volumeDai, referrerRewardToken, referrerRewardValueDai);
    ...
    function getReferrerFeeP(uint pairOpenFeeP, uint volumeReferredDai) public view returns (uint) {
        ...
        uint feeP = minFeeP + ((maxReferrerFeeP - minFeeP) * volumeReferredDai) / 1e18 / targetVolumeDai;
