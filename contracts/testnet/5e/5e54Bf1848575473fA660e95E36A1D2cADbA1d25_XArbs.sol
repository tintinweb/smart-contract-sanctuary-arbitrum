...
contract XArbs is Ownable, Pausable, ERC20 {
    ...
    uint256 public constant maxArbsPerSecond = 10e18; // Max arbs per second.

    uint256 public withdrawFee = 100; // 1%
    uint256 public withdrawFeePeriod = 3 days; // 3 days
    uint256 public arbsPerSecond; // arbs tokens created per block.
     ...
     * @param _admin: address of the dev
    ...
    function withdraw(uint256 _shares) public whenNotPaused {
        ...
        uint256 currentAmount = (available() * _shares) / totalShares;
    ...
    function getPricePerFullShare() external view returns (uint256) {
        return totalShares == 0 ? 1e18 : (available() * (1e18)) / totalShares;
    }
