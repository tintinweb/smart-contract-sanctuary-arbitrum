...
contract EtherWars1v1VRFConsumer is VRFV2WrapperConsumerBase, ConfirmedOwner {
    uint256 private tester1;

    IEtherWars1v1 public etherWars1v1Contract;
    ...
    constructor(
        address _etherWars1v1
    ) ConfirmedOwner(msg.sender) VRFV2WrapperConsumerBase(linkAddress, wrapperAddress) {
        etherWars1v1Contract = IEtherWars1v1(_etherWars1v1);
        authorizedContracts[_etherWars1v1] = true;
    }
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        etherWars1v1Contract.beginCombat(
            s_requests[_requestId].attacker,
            s_requests[_requestId].defender,
            s_requests[_requestId].wager,
            _randomWords
        );
    ...
    function setEtherWars1v1Address(address _address) external onlyOwner {
        etherWars1v1Contract = IEtherWars1v1(_address);
    }
    ...
    function deauthorizeContract(address _contractAddress) external onlyOwner {
