...
contract PlennyOceanV2 is PlennyBasePausableV2, PlennyOceanStorage {
    ...
    function addNewMaker(string calldata name, string calldata serviceUrl, uint256 nodeIndex, uint256 providingAmount, uint256 priceInPl2) external whenNotPaused {
