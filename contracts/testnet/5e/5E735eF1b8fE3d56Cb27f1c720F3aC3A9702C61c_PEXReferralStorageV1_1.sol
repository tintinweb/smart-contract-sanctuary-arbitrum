...
contract PEXReferralStorageV1_1 is IReferralStorage {
    ...
    constructor(IStorageT storage_) {
        storageT = storage_;
        usdt = storageT.usdt();
    ...
    modifier onlyCallback() {
        require(msg.sender == storageT.callbacks(), "CALLBACK_ONLY");
        _;
    }
    ...
    function _setTraderReferralCode(address _account, bytes32 _code) private {
        ...
        (bytes32 _skip,  address traderRefferAddr) = getTraderReferralInfo(owner);
