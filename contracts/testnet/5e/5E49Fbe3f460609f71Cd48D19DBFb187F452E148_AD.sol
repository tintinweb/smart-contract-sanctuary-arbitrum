...
contract AD is ERC721, Ownable {
    ...
    uint256 public price = 0.00027 ether;
    uint256 public MAX_MINT_PER_TX = 10;
    uint256 public MAX_MINT_PER_WALLET = 50;
    ...
    // Run on deploy
    constructor() ERC721("AdrenalinNFT", "AD") {
        baseUri = "ipfs://bafybeiedptvu6xtbzqwwel3q7uxt6mbab7ghnttcbh67ewqirtpjrndeem/";
    ...
    function whitelistMint(bytes32[] memory proof, uint256 _amount) external payable {
        ...
        require(_amount <= MAX_MINT_PER_TX, "You can only mint a maximum of 10 per transaction.");
        require(mintedPerWallet[msg.sender] + _amount <= MAX_MINT_PER_WALLET, "You can only mint 50 per wallet.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x0aA4139d0C9EaC1c2D1e9379F1c33A10e9f6f26e).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x2A38a29687bE7E969cFfe252786B00754c4Bb005).call{value: balanceTwo}("");
