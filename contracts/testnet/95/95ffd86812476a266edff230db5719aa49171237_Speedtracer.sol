...
/// @title  Speedtracer Track NFTs
/// Owning a Speedtracer Track NFT grants token holders the ability to customize their generated onchain track.
/// Every day, Speedtracer renders a track that all players race on.

contract Speedtracer is ERC721Base, ISpeedtracer {
    ...
    constructor(address renderer)
        ERC721Base("Speedtracer Tracks", "SPDTRCR", 0.02 ether, 365)
    {
        super._setRenderer(IRenderer(renderer));
    }
    ...
    function setTrack(uint256 id, bytes calldata trackData) external {
        require(
            ...
            "TrackRenderer: Only owner can set custom track"
        );
...
abstract contract ERC721Base is ERC721A, Ownable, IERC2981 {
    ...
    function _setRenderer(IRenderer _renderer) internal {
