    ...
    ReentrancyGuard
{
    ...
    uint256 public ticketPrice = 10 * 10 ** DECIMALS; // 10 ERC20
    uint256 public totalTicketCount = 240000;
    uint256 private emptyTickets = 169900;

    uint256 public minMintable = 2;
    uint256 public maxMintable = 20;
    enum CardResult {
        LOSS,
        WIN10,
        WIN15,
    ...
    string internal baseURI =
        "ipfs://bafybeidmrlcittyibiyeqlpkphac4vhusx7tz7irtw4rqzium4qv37gmae/";

    string internal unscratchedURI =
        "ipfs://bafkreiea5tesi2iokklt6lqyo2xqz5yljb34ixhocnp7y3fq3btbjz6spq/";
    ...
    constructor(
         ...
         */
        generationCounts[CardResult.WIN10] = 43000;
        generationCounts[CardResult.WIN15] = 12000;
        generationCounts[CardResult.WIN20] = 8000;
        generationCounts[CardResult.WIN50] = 5000;
        generationCounts[CardResult.WIN100] = 800;
        generationCounts[CardResult.WIN250] = 600;
        generationCounts[CardResult.WIN500] = 200;
        generationCounts[CardResult.WIN1000] = 500;

        rewardAmounts[CardResult.WIN10] = 10;
        rewardAmounts[CardResult.WIN15] = 15;
        rewardAmounts[CardResult.WIN20] = 20;
        rewardAmounts[CardResult.WIN50] = 50;
        rewardAmounts[CardResult.WIN100] = 100;
        rewardAmounts[CardResult.WIN250] = 250;
        rewardAmounts[CardResult.WIN500] = 500;
        rewardAmounts[CardResult.WIN1000] = 1000;
