...
contract NFT is ERC721, Ownable, ReentrancyGuard, ERC721Pausable {
    using Counters for Counters.Counter;
    using SafeERC20 for IERC20;
    Counters.Counter private _tokenIdCounter;

    uint public cost = 25e18;
    address public stableCoinAddress;
    address public treasuryAddress;

    constructor() ERC721("Umay NFT", "UmayNFT") {}

    function _beforeTokenTransfer(address from, address to, uint amount) override (ERC721, ERC721Pausable) internal {
    ...
    function safeMint() whenNotPaused public nonReentrant {
        require(this.balanceOf(msg.sender) == 0, 'Already has NFT');
        IERC20 stableCoin = IERC20(stableCoinAddress);
        stableCoin.safeTransferFrom(msg.sender, treasuryAddress, cost);
