...
contract AssetManager {
    ...
    event DepositedNFT(address _from, address _nftAddress, uint256 _tokenID);
    ...
    function depositNFTinVault(uint256 _tokenId) public returns (address addr) {
        ...
        emit DepositedNFT(msg.sender, nftCollectionAddress, _tokenId);
