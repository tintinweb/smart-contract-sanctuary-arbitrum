...
contract MerkleDistributor is ReentrancyGuard {
    ...
    */
    ...
    @param index proof index
    @param account user address trying to claim
    @param amount amount to claim
    @param merkleProof merkel proof to verify
    */
    function claim(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) public nonReentrant {
        ...
        // transfer tokens
        IERC1155(ocean).safeTransferFrom(address(this), account, collabOceanId, amount, "");
