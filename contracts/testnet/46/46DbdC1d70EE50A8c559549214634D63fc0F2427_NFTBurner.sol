...
contract NFTBurner is Ownable, Pausable {
    ...
    constructor(IERC20 _token, address _burnaddress, address _bribingAddress, address _teamAddress, uint256 _portion, uint256 _distribution_Bribe, uint256 _distribution_Team, uint256 _distribution_manual_Bribe ) {
        token = _token;
        burnAddress = _burnaddress;
        bribingAddress = _bribingAddress;
        teamAddress = _teamAddress;
        portion = _portion;                                             // value/100000 * remaining Token
        distribution_Bribe = _distribution_Bribe;                       // value/100000 * portion
        distribution_Team = _distribution_Team;                         // value/100000 * portion

        distribution_manual_Bribe = _distribution_manual_Bribe;         // value/100000 * remaining Token

        // token = IERC20(address(0x31eE90AE37EB85F32966Da4C3DeeF1283481652f));
        // burnAddress = 0x000000000000000000000000000000000000dEaD;
        // bribingAddress = 0xbD582572164ABEfd270B99A0B0884cF925b4d837;
        // teamAddress = 0x87fC83A1607AC6F0F26F247D786698ed27EBCb5b;

        // portion = 50;                    // value/100000 * remaining Token
        // distribution_Bribe = 15000;        // value/100000 * portion
    ...
    function burnMultipleNFTs(address _nftContract, uint256[] memory _tokenIds) public whenNotPaused {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            amount = amount * (collectionInformation[_nftContract].limit - collectionInformation[_nftContract].alreadyBurned + 1) / collectionInformation[_nftContract].limit;
    ...
    function getEstimatedAmount(address _nftContract, uint256 _selectedNFTs) public view returns (uint256 _estimation){
        ...
        for (uint256 i = 0; i < _selectedNFTs; i++) {
            ...
            amount = amount * (limit - alreadyBurned + 1) / limit;
    ...
    function sendTokenForBribing() public onlyOwner {
        ...
        uint256 tokenForManualBribing = remainingToken * distribution_manual_Bribe / 100000;
