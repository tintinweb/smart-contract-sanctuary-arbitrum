...
contract Gen1ERC1155 is ERC1155, Ownable, ReentrancyGuard {
    ...
    mapping(address => bool) private isStakeContract;
    
    
    modifier onlyStakeContract(){
        require(isStakeContract[msg.sender]);
        _;
    }

    constructor() ERC1155("https://ipfs.io/ipfs/bafybeidctpfhj2bxf7x5vafhekbxer37stvvwes5qjy5nh7iccvpuqmksm/{id}.json") {
        isStakeContract[msg.sender] = true;
    }
    ...
    function setMintCaller(address _address, bool _value) public{
        isStakeContract[_address] = _value;
    }

    function uri(uint _tokenId) override public pure returns(string memory){
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/bafybeidctpfhj2bxf7x5vafhekbxer37stvvwes5qjy5nh7iccvpuqmksm/",
