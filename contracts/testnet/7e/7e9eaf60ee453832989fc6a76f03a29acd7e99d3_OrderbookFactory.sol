...
contract OrderbookFactory is Ownable {
    ...
    */
    function createOrderbook(
        ...
        emit AoriOrderbookCreated(address(orderbook), OPTION_, USDC, getTradingFee());
    ...
    */
    function fill(address receiver, uint256 amountOfOPTION, uint256 seatId) public  {
        ...
        if(receiver == AORISEATSADD.ownerOf(seatId)) {
            ...
            USDC.transfer(Ownable(AORISEATSADD).owner(), ownerTxFee);
...
contract Ask {
    ...
    function fill(address receiver, uint256 amountOfUSDC, uint256 seatId) public {
        ...
        if(receiver == AORISEATSADD.ownerOf(seatId)) {
            ...
            //Transfers from the msg.sender
            USDC.transferFrom(msg.sender, Ownable(AORISEATSADD).owner(), ownerTxFee);
