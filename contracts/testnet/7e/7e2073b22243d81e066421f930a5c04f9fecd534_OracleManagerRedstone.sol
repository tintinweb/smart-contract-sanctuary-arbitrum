...
/// @author float
contract OracleManagerRedstone is IOracleManagerRedstone, AccessControlledAndUpgradeableModifiers {
  /*╔═════════════════════════════╗
    ║        Global state         ║
    ╚═════════════════════════════╝*/
  ...
  function pushPriceWithSignaturePrewiew(
    uint256 epochIndex,
    uint256 price,
    uint256 timestampSeconds,
    uint8 v,
  ...
  function pushPriceWithValidation(
    uint256 epochIndex,
    uint256 price,
    uint256 timestampSeconds
  ) external {
  ...
  function pushPriceNoValidation(uint256 epochIndex, uint256 price) external {
    uint32 latestExecutedEpochIndex = market.get_epochInfo().latestExecutedEpochIndex;
