 ...
 * Tales of Elleria
*/
contract ElleriaHeroBridge is Ownable, IERC721Receiver {
   ...
   */
  function SetAddresses(address _ellerianHeroAddr, address _signatureAddr, address _signerAddr) external onlyOwner {
  ...
  */
  function BridgeIntoGame(uint256[] memory _tokenIds) external {
    for (uint i = 0; i < _tokenIds.length; i++) {
      ...
      if (ellerianHeroAbi.ownerOf(_tokenIds[i]) == address (this)) {
