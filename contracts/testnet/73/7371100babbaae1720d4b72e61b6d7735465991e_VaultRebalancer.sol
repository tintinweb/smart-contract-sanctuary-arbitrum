...
contract VaultRebalancer is IVaultRebalancer, AccessControlBase, ReentrancyGuard {
    ...
    uint256 public constant MINIMUM_EXCESS = 1;

    /*==================== State Variabes *====================*/
    address public gmxVault;
    IVault public vault;
    address public winrVault;
    address public routerWinr;
    address public routerGMX;
     ...
     * @param _routerGMX address of the GMX router contract
     * @param _routerWinr address of the WINR router contract
     */
    function configureContract(
        ...
        _checkIfZero(_routerGMX);
        _checkIfZero(_routerWinr);
        gmxVault = _gmxVault;
        winrVault = _winrVault;
        routerWinr = _routerWinr;
    ...
    /**
     * TAKE NOTE: THIS CONTRACT IS WORK IN PROGRESS!
     */
    ...
    // ) public onlyManager nonReentrant returns(uint256, uint256) {
        ...
        // todo check if the vault ahs this amount available (also considering potentially the reserves / max/min pool amounts?)
        ...
        // return (amountAfterFees_, feebasisPoints_);
     ...
     * @param _rebalanceTokenTarget xxx
     * @param _rebalanceTokenToUse xxx
     * @param _usdValueToReplenish xxx
     * @param _maxSplippageBasisPoint xxx
    ...
    function rebalanceVaultByUsdSimple(
        ...
        require(
            ERC20(_rebalanceTokenToUse).balanceOf(address(this)) == 0,
            "Balance not null 0"
        );
        ...
        require(
            ERC20(_rebalanceTokenTarget).balanceOf(address(this)) == 0,
            "Balance not null"
        );

        // note: potentially check if the balance of the vault is better or worse?
    ...
    // removed re-entranprintRebalancingDeltaNewcy here?
    // function rebalanceSimple() external onlyManager returns(uint) {
