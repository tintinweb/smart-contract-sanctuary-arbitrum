...
contract LIRA is ERC20("Satoshi LIRA", "LIRA"), Ownable {
    ...
    function mint(uint256 amount) public onlyOwner {
        if (totalSupply() == 0) {
            ...
            _mint(_msgSender(), quote(amount, totalSupply(), wbtc.balanceOf(address(this))));
        }
    ...
    function burn(uint256 amount) public onlyOwner {
        ...
        wbtc.safeTransferFrom(address(this), _msgSender(), quote(amount, wbtc.balanceOf(address(this)), totalSupply()));
    }
