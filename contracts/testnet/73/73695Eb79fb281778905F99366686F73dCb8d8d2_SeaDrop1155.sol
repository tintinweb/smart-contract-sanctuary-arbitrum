    ...
    DefaultOperatorFilterer
{
     ...
     *
     * @param seaDropImpl   The allowed SeaDrop contract.
     * @param privateDrop The white list datas.
     */
     ...
     *
     * @param seaDropImpl   The allowed SeaDrop contract.
     * @param whiteList       The air drop datas.
     */
...
interface ISeaDrop1155 is SeaDrop1155ErrorsAndEvents {
     ...
     * @param privateMintPrice        private mint price.
     * @param publicMintPrice        public mint price.
     * @param config        The configuration struct.
     */
    function initialize(
        string memory _uri,
...
/**
 * @notice A struct defining air drop data.
 *         Designed to fit efficiently in one storage slot.
 * 
 * @param maxTotalMintableByWallet Maximum total number of mints a user is
 *                                 allowed.
...
contract SeaDrop1155 is ISeaDrop1155, ReentrancyGuard, Ownable {
    ...
    /**
     * @notice Returns the white list drops for the nft contract.
     *
     * @param nftContract The nft contract.
     */
    function getPrivateDrop(address nftContract)
