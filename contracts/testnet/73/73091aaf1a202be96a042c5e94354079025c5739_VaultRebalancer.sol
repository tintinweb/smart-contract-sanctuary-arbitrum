...
//             getMinPrice(_tokenToRebalanceWith), 
//             PRICE_PRECISION, 
//             tokenDecimals[_tokenToRebalanceWith], 
//             USDW_DECIMALS
//         );
...
//         require(
//             tokenAmount_ >= _amountDeposited,
//             "Insufficient token amount rebalance"
//         );
//         // adjust usdwAmounts by the same usdwAmount as debt is shifted between the assets

//         uint256 usdwAmount_ =_adjustForDecimals(
//             _amountDeposited, 
//             getMinPrice(_tokenInDeposited), 
//             PRICE_PRECISION, 
//             tokenDecimals[_tokenInDeposited], 
//             USDW_DECIMALS
//         );
