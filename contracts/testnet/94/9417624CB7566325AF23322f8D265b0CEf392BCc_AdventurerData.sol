  ...
  Pausable
{
  ...
  // Events
  //=======================================
  event Created(address _addr, uint256 id);
  event CreatedAoV(address _addr, uint256 id, uint256 archetype);
  ...
  function createFor(
    ...
    require(_archetype > 0, "AdventurerData: Archetype must be greater than 0");
