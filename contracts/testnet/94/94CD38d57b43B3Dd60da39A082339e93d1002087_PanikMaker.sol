...
contract PanikMaker is Ownable, ReentrancyGuard {
    ...
    // The block number when PANIK mining starts.
    ...
    // Deposit tokens to PanikChef for PANIK allocation.
    function deposit(
        uint256 _pid,
        uint256 _amount,
        address _account
    ...
    // Withdraw tokens from PanikMaker.
