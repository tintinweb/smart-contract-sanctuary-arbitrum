...
contract KaijuFacet is SolidStateERC1155, IERC2981, WithStorage, WithModifiers {
    ...
    function _purchasePioneerKaiju(
        ...
        if (_paymentType == PaymentType.ETH_IN_USD && msg.value != _paymentAmount) {
            revert LibMeta.IncorrectPaymentAmount(msg.value, _paymentAmount);
        }

        LibToken.PioneerPackType expectedPackType = _constants()
            .usdPriceToPackType[_paymentAmount];
