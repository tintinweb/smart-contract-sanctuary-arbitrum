...
contract PixelMushrohmERC721 is IPixelMushrohmERC721, ERC721Enumerable, PixelMushrohmAccessControlled {
    ...
    function whitelistMint(uint256 _amount, bytes32[] calldata _merkleProof) external override {
        ...
        require(isWhitelisted(msg.sender, _merkleProof), "PixelMushrohm: Not in whitelist");
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        uint256 sporePowerLevel = Math.min(getSporePower(_tokenId).div(sporePowerCost), maxSporePowerLevel);
        return
    ...
    function isWhitelisted(address _owner, bytes32[] calldata _merkleProof) public view override returns (bool) {
        require(merkleRoot != 0, "PixelMushrohm: Whitelist not set");
...
interface IPixelMushrohmERC721 is IERC721Enumerable {
    ...
    function isWhitelisted(address _owner, bytes32[] calldata _merkleProof) external view returns (bool);
}
