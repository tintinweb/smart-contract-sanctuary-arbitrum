...
contract Loot8Collection is ERC721, ILoot8Collection, NonblockingLzApp {
...
contract Loot8UniformCollection is Loot8Collection {
    ...
    constructor(
        ...
        address _trustedForwarder,
        address _layerZeroEndpoint
    ) Loot8Collection(_name, _symbol, _transferable, _manager, _trustedForwarder, _layerZeroEndpoint) {
        dataURI = _dataURI;
    }
...
contract CollectionFactory is ICollectionFactory, Initializable, DAOAccessControlled {
    ...
    function createCollection(
        ...
        Loot8Collection _loot8Collection = 
        ...
        emit CreatedCollection(_entity, address(_loot8Collection));

        return address(_loot8Collection);
