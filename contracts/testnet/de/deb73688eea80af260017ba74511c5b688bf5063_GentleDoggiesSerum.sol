...
// File: contracts/GentleDoggiesSerum.sol
...
contract GentleDoggiesSerum is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "GDS: Max 2 NFTs per transaction");
    ...
    function crossChains(uint16 _chainId, uint tokenId, uint _destination) public payable {
