...
contract CyberCredit is ERC20Burnable, Ownable 
{
    ...
    function SetQuestionAddress(address newQuestionAddress) public onlyOwner
    {
        QuestionAddress = newQuestionAddress;
    }
    ...
    function ClaimToken(uint256 amount) public onlyOwner
    {
        ...
        _mint(QuestionAddress, amount);

        emit EventClaimToken(QuestionAddress, amount);
    }
