...
contract Trading is Roles, ERC2771Context, ITrading {
    ...
    function closePosition(
        ...
        uint256 price,
        uint16 closeType
    ) external virtual override hasRole(ORACLE) returns (uint256) {
        return _excutePostion(id, price, false, closeType);
    }
    ...
    function _excutePostion(
        ...
        if (position.amount == 0 || position.leverage == 0) return 1;
