...
import "./GSWhitelistTypes.sol";

contract GenesisSpirit is Initializable, AdminableUpgradeable, ERC721URIStorageUpgradeable {
    ...
    //TODO: set the default url.
    string placeHolderUrl = "placeholder.com";
    string baseUrl = "baseUrl.com";
    ...
    function whitelistMint(uint256 _count) external whenNotPaused returns (uint256, uint256) {
        ...
        require(whitelistMintCountsRemaining[msg.sender] >= _count, "You cannot mint this many Genesis Spirits");
    ...
    function allocateWhitelistMint(GSWhitelistTypes.GSWhitelist[] memory _whitelists) public onlyAdminOrOwner {
    ...
    function setPlaceHolderUrl(string calldata _newPlaceHolder) external onlyAdminOrOwner {
        placeHolderUrl = _newPlaceHolder;
    }

    function getPlaceHolderUrl() public view returns (string memory) {
        return placeHolderUrl;
    }

    function setBaseUrl(string calldata _newBaseUrl) external onlyAdminOrOwner {
        baseUrl = _newBaseUrl;
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        if(keccak256(abi.encodePacked(baseUrl)) == keccak256(abi.encodePacked(""))) {
            return placeHolderUrl;
        } else {
