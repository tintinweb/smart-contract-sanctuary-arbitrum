                ...
                uint(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex'95c54956fb8bed8d0f150f4fe6af7d70fd7714b2ed5d4332218f3a84ba2bebde' // init code hash
                        )
                    )
                )
            )
...
contract UniswapV2Router02 {
    ...
    function pairFor(address tokenA, address tokenB) public view virtual returns (address pair) {
    ...
    function getReserves(
        address tokenA,
        address tokenB
    ) public view virtual returns (uint reserveA, uint reserveB) {
