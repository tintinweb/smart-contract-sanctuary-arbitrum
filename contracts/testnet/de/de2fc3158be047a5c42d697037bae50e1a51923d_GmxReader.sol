...
import {IReader} from "../core/Gmx/interfaces/IReader.sol";
import {GmxVault} from "./GmxVault.sol";

contract GmxReader is IReader {
    /// @notice Mimic RMX reader.
    ...
    function getAmountOut(
        ...
        return GmxVault(vault).getAmountOut(tokenIn, tokenOut, amountIn);
    }
}
