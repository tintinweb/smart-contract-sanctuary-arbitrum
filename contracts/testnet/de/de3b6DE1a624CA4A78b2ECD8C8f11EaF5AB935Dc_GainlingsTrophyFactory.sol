...
contract GainlingsTrophyFactory is ERC721Enumerable, RrpRequesterV0, ReentrancyGuard, Ownable
{
    ...
    mapping(address => uint256)   public _selection;
    ...
    function increaseKillCount(address receiver, bytes32[] calldata _proof) public nonReentrant{
    ...
    function selectTrophy(uint256 tokenId) external {
        require(ownerOf(tokenId) == msg.sender, "not the owner");
        _selection[msg.sender] = tokenId;
        emit SelectionChanged(msg.sender,tokenId);
    }
