...
contract RyzeBridge is NonblockingLzApp {
    ...
    function _nonblockingLzReceive(
        ...
        (address receipent, address[] memory _assets, uint256[] memory _amounts) = abi.decode(_payload, (address, address[], uint256[]));
    ...
    function estimateFee(
        ...
        bytes memory payload = abi.encode(_assets, _amounts);
        return
    ...
    function bridgeAssets(
        ...
        // encode the payload with the token addresses and token amounts
        bytes memory payload = abi.encode(msg.sender, _assets, _amounts);
