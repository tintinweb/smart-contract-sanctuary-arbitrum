...
/// @title Balance Sheet Mock
/// @notice Mock contract representing the balance sheet used by DeFrag.fi for testing purposes only.

contract BalanceSheetMock is Initializable {
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.UintSet;

    mapping(address => EnumerableSetUpgradeable.UintSet) private userToTokenIds;
    ...
    function getTokenIds(
        ...
        return (EnumerableSetUpgradeable.values(userToTokenIds[_userAddress]));
    }
    ...
    function _addCollateral(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            if (EnumerableSetUpgradeable.add(userToTokenIds[_userAddress], _tokenIds[i])) {
