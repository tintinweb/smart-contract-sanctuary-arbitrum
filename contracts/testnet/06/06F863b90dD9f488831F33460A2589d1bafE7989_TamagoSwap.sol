...
contract TamagoSwap is Ownable, ERC721Holder, ERC1155Holder {
  ...
  */
  ...
  function recordSwapHistory(Swap memory swap) internal {
    SwapHistory memory newSwapHistory = SwapHistory({
        initiator: swap.initiator,
        initiatorEtherValue: swap.initiatorEtherValue,
        initiatorErc20Address: swap.initiatorErc20Address,
        initiatorErc20Amount: swap.initiatorErc20Amount,
        initiatorNftAddresses: swap.initiatorNftAddresses,
        initiatorNftIds: swap.initiatorNftIds,
        initiatorNftAmounts: swap.initiatorNftAmounts,
        secondUser: swap.secondUser,
        secondUserEtherValue: swap.secondUserEtherValue,
        secondUserErc20Address: swap.secondUserErc20Address,
        secondUserErc20Amount: swap.secondUserErc20Amount,
        secondUserNftAddresses: swap.secondUserNftAddresses,
        secondUserNftIds: swap.secondUserNftIds,
        secondUserNftAmounts: swap.secondUserNftAmounts
    });

    swapHistories.push(newSwapHistory);
}
