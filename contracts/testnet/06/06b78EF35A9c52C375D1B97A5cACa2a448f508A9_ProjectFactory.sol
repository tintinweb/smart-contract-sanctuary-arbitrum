...
contract ProjectFactory is Ownable, BlackHolePrevention, AccessControl {
    ...
    event CollectionCreatedFromProject(uint32 communityId, uint32 collectionId, uint32 projectId);
    event CollectionCreatedFromProjectViaBridge(uint32 communityId, uint32 collectionId, uint32 projectId, uint256 chainId);
    event CollectionCreatedByBridge(uint32 communityId, uint32 collectionId);
    constructor(
    ...
    function LaunchProjectViaBridge(
        ...
        theBridge.launchProject(chainId,communityId,uint32(collectionId),saleConfig,tokenConfig);
