    ...
    ReentrancyGuardUpgradeable
{
        ...
        nonReentrant
    {
        ...
        _transferOut(receiveToken, amountOutToken, vault);
    ...
    function _transferIn(address _token, uint256 _tokenAmount) internal {
        ...
        _tokenAmount = IVault(vault).adjustDecimalToToken(_token, _tokenAmount);
    ...
    function swap(
        ...
        _transferIn(_tokenIn, _amount);
        _transferOut(_tokenIn, _amount, vault);
        return IVault(vault).swap(_tokenIn, _tokenOut, msg.sender);
    }
