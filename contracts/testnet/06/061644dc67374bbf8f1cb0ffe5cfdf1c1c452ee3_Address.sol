...
contract PigsCanFly is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigsCanFly";
    ...
    uint256 private _totalSupply = 8 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 8 * 10**4 * 10**9;
    uint256 public _walletMax = 8 * 10**4 * 10**9;
