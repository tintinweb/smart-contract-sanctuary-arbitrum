    ...
    ERC20VotesUpgradeable
{
    ...
    address public payableAddress = 0xAA31fB05523622c1FccaE06696620020587b38E2;
    ...
    function withdrawERC20(address _tokenContract, uint256 _amountToWithdraw) public onlyRole(DEFAULT_ADMIN_ROLE) {
        IERC20 tokenContract = IERC20(_tokenContract);
        tokenContract.transfer(payableAddress, _amountToWithdraw); // Payout ERC-20 tokens to recipient
    }
    /*///////////////////////////////////////////////////////////////
