...
{
  uint256 public sVotingDelay;
  uint256 public sVotingPeriod;
constructor(
    ERC20Votes _token,
  ...
  {
    sVotingDelay = _votingDelay;
    sVotingPeriod = _votingPeriod;
  }
function votingDelay() public view override returns (uint256) {
    return sVotingDelay; // 1 = 1 block
  }
function votingPeriod() public view override returns (uint256) {
    return sVotingPeriod; // 45818 = 1 week
  }
