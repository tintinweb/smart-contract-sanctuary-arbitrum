...
contract ConfigManager is Ownable {
    ...
    function setSyncIsOn(bool _syncIsOn) external onlyOwner {
        karrotChef.setSyncIsOn(_syncIsOn);
    }
...
interface IKarrotChef {
    ...
    function setSyncIsOn(bool _syncIsOn) external;
}
...
interface IRabbit {
    ...
    function setRabbitBatchSize(uint8 _batchSize) external;
