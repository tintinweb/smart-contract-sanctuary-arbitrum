...
import '../interfaces/USDTInterface.sol';
...
contract GNSStakingV6_2 {
    ...
    USDTInterface public immutable dai;
    ...
    function distributeRewardDai(uint amount) external{
        ...
        if(tokenBalance > 0){
            accDaiPerToken += amount * 1e6 / tokenBalance;
    ...
    function setBoosts() private{
        ...
        u.debtDai = (u.stakedTokens + u.totalBoostTokens) * accDaiPerToken / 1e6;
    }
