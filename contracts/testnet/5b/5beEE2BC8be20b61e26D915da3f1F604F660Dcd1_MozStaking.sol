...
contract MozStaking is Ownable {
    ...
    IMozToken public immutable mozaicToken; // MOZ token to convert to/from
    IXMozToken public immutable xMozToken;
    ...
    constructor(
        address mozaicToken_,
        address xMoztoken_,
        address daoTreasury_
    ) {
        require(mozaicToken_ != address(0x0), "Invalid addr");
        require(xMoztoken_ != address(0x0), "Invalid addr");
