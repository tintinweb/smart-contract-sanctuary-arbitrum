...
contract SwapPair is ISwapPair,Initializable, SwapERC20Initializable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _factory, address _token0, address _token1,bool _supportsTokenFee, bool _token0IsFee) internal initializer() {
        ...
        if (supportsTokenFee && _factory == address(0)) {
            ...
            emit Initialize(_token0, _token1, routerAddress, _factory);
        }
    }
