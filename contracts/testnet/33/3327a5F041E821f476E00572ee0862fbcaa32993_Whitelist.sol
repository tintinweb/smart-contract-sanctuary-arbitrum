...
contract Whitelist is IWhitelist, Ownable {
    ...
    function addToWhitelist(address _addr) external override virtual onlyOwner {
        if (_whitelisted[_addr]) {
    ...
    function removeFromWhitelist(address _addr) external override virtual onlyOwner {
        if (!_whitelisted[_addr]) {
    ...
    function check(address _addr) external view override virtual returns (bool) {
