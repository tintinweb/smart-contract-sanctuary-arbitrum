...
contract Arb_DeployLvlProxy is Script {
    address deployer = 0x8979dC115d94828701BEb77537e49624F2E6D783;
    address LvlToken;
    uint16 arb_chainId = 10143;
    address proxyAdmin = 0x42bDB7553ef8a32494662E5d91d9470155e9cD46;
    address arbL0Endpoint = 0x6aB5Ae6822647046626e83ee6dB8187151E1d5ab;
    ...
    function run() external {
        ...
        bridgeProxy.initialize(address(controller), arbL0Endpoint);
        ...
        controller.setValidator(deployer);
