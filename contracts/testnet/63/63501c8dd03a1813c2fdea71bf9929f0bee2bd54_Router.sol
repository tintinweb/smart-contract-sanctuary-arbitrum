...
contract Router is IRouter, Context, AccessControlBase {
    ...
    function pluginTransfer(
        ...
        SafeTransferLib.safeTransferFrom(ERC20(_token), _account, _receiver, _amount);
    }

    function directPoolDeposit(address _token, uint256 _amount) external {
        SafeTransferLib.safeTransferFrom(ERC20(_token), _sender(), vaultAddress, _amount);
    ...
    function swap(
        ...
        SafeTransferLib.safeTransferFrom(ERC20(_path[0]), _sender(), vaultAddress, _amountIn);
