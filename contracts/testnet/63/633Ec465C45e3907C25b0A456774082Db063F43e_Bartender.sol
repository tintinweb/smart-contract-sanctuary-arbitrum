...
contract Bartender is OwnableUpgradeable {
    ...
    function updateFeeStrategyParams(FeeSplitStrategyInfo calldata _feeStrategy) external onlyOwner {
        require(
            _feeStrategy.optimalUtilizationRate >= 0 && _feeStrategy.optimalUtilizationRate <= 100 * 10 ** 28 &&
            _feeStrategy.maxFeeSplitSlope1 >= 0 && _feeStrategy.maxFeeSplitSlope1 <= 100 * 10 ** 28 &&
            _feeStrategy.maxFeeSplitSlope2 >= _feeStrategy.maxFeeSplitSlope1 && _feeStrategy.maxFeeSplitSlope2 <= 100 * 10 ** 28 &&
            _feeStrategy.maxFeeSplitSlope3 >= _feeStrategy.maxFeeSplitSlope2 && _feeStrategy.maxFeeSplitSlope3 <= 100 * 10 ** 28 &&
            _feeStrategy.utilizationThreshold1 >= 0 && _feeStrategy.utilizationThreshold1 <= _feeStrategy.utilizationThreshold2 &&
            _feeStrategy.utilizationThreshold2 >= _feeStrategy.utilizationThreshold1 && _feeStrategy.utilizationThreshold2 <= _feeStrategy.utilizationThreshold3 &&
            _feeStrategy.utilizationThreshold3 >= _feeStrategy.utilizationThreshold2 && _feeStrategy.utilizationThreshold3 <= 100 * 10 ** 28,
