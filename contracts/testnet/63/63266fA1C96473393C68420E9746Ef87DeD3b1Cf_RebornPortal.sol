    ...
    AutomationCompatible
{
    ...
    function engrave(
        ...
        details[engraveParams.tokenId] = LifeDetail(
            engraveParams.seed,
            creator,
            uint96(engraveParams.lifeReward + engraveParams.boostReward),
        ...
        _rewardToClaim[creator][RewardToClaimType.EngraveDegen].totalReward +=
            engraveParams.lifeReward +
            engraveParams.boostReward;

        // record reward for referrer
        _rewardDegenRewardToRefs(creator, engraveParams.lifeReward);
