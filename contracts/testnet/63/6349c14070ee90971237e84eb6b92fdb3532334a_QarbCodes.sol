    ...
    ReentrancyGuard
{
    ...
    uint256 public constant PHASE_2_LIMIT = 10;
    uint256 public constant PHASE_3_LIMIT = 10;
    uint256 public constant PHASE_4_LIMIT = 10;
    uint256 public constant PHASE_5_LIMIT = 10;
    // PHASE_6_LIMIT is the remainder to get to max supply 8888

    uint256 public constant PHASE_1_WHITELIST_MINT_PRICE = 0 ether;
    uint256 public constant PHASE_2_MINT_PRICE = 0.00055 ether;
    uint256 public constant PHASE_3_MINT_PRICE = 0.00065 ether;
    uint256 public constant PHASE_4_MINT_PRICE = 0.00075 ether;
    uint256 public constant PHASE_5_MINT_PRICE = 0.00085 ether;
    uint256 public constant PHASE_6_MINT_PRICE = 0.00095 ether;
    // TEST END
    ...
    function _randomColor(
        ...
        for (uint256 i = 0; i < 3; i++) {
            uint8 r = uint8(random >> (i * 8));

            color[i] = r < 128
                ? bytes1(uint8(128))
                : bytes1(uint8(random >> (i * 8)));
        }
