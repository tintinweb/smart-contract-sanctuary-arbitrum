...
// This code defines a Solidity smart contract for a ReferralStorage. The contract is Governable,
// meaning it is subject to governance rules, and implements the IReferralStorage interface. The
// contract stores data about tiers, referrers, handlers, and referral codes in mappings. It also
// contains functions to set handlers, tiers, referrer tiers and discount shares, set trader referral
// codes by user or handler, register codes, set code owners by user or governance rules, and get
// trader referral info. Finally it contains events to log changes made to the data stored in the mappings.
