...
contract GNSTradingStorageV5 is Initializable {
    ...
    // Contracts (updatable)
    AggregatorInterfaceV6_4 public priceAggregator;
    ...
    function updateToken(TokenInterfaceV5 _newToken) external onlyGov {
        require(PausableInterfaceV5(trading).isPaused() && PausableInterfaceV5(callbacks).isPaused(), "NOT_PAUSED");
    ...
    function setPriceAggregator(address _aggregator) external onlyGov {
        ...
        priceAggregator = AggregatorInterfaceV6_4(_aggregator);
