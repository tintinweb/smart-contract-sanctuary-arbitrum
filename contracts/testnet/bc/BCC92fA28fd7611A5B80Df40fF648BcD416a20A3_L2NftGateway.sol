...
// File: contracts/arbitrum/L2ArbERC721.sol
...
// File: contracts/arbitrum/L2NftGateway.sol
...
contract L2NftGateway is IERC721Receiver,  Ownable{
    ...
    function finalizeDepositWithURI(
        ...
        require(l1ToL2Token[l1Token] == l2Token, "WRONG_ADDRESS_PAIRING");
        L2ArbERC721(l2Token).bridgeMintWithURI(to, tokenId,tokenURI);
    }
