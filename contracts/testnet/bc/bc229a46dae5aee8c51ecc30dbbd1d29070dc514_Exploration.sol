...
contract Exploration is Initializable, ExplorationSettings {
    ...
    function totalStakedTimeFor(uint256 _tokenId) external view override returns (uint256) {
        return tokenIdToRunningStakeTime[_tokenId];
    }
...
interface IExploration {
	...
	function totalStakedTimeFor(uint256 _tokenId) external view returns (uint256);
}
