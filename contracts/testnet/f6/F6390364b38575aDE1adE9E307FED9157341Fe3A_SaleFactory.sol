...
contract SaleFactory is Ownable {
    ...
    function createSale(address saleOwner, SaleType saleType, address saleTokenAddr, address tokenToSellAddr, bool isWithdrawVestingEnabled) public onlyOwner {
        ...
        (bool success, ) = newSale.call(abi.encodeWithSignature(
            ...
            msg.sender, saleOwner, saleTokenAddr, tokenToSellAddr, isWithdrawVestingEnabled)
        );
