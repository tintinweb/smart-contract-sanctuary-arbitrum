...
contract BGT_UFM {
    ...
    function registeredFp(uint256 __fp_quantity, uint256 day, uint256 __annualInterestRate) external onlyAdmin {
        _aufoFpIds++;
    ...
    function expired(uint256 __order_id) external {
        ...
        require(_order.time + cycle <= block.timestamp, "error");
