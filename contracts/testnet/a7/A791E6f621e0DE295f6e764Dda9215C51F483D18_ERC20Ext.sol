...
contract ERC20Ext is ERC20,Ownable{
    //鏀寔澧炲彂锛屾敮鎸侀攢姣侊紝浜ゆ槗鏀跺彇鎵嬬画璐癸紝浜ゆ槗閮ㄥ垎閿€姣?
    using SafeMath for uint256;

    uint public feeRatio;//鎵嬬画璐瑰崈鍒嗘瘮锛歠eeRatio/1000
    uint public burnRatio;//閿€姣佸崈鍒嗘瘮锛歜urnRatio/1000
    address public feeAddress;//鎵嬬画璐归厤缃湴鍧€
