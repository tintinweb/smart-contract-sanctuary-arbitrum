...
contract AccruPresale is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function verifyPrivateSalePurchase(
        ...
        uint256 purchasedPrice = calculatePrice(purchasedAmount);
        
        return (price >= PRIVATE_SALE_MINPURCHASE && purchasedPrice + price <= MAX_PURCHASE);
    }
    ...
    function verifyPublicSale1Purchase(
        ...
        return (price >= PUBLIC_SALE1_MINPURCHASE && purchasedPrice + price <= MAX_PURCHASE);
    }
    ...
    function verifyPublicSale2Purchase(
        ...
        return (price >= PUBLIC_SALE2_MINPURCHASE && purchasedPrice + price <= MAX_PURCHASE);
    }
