...
contract MemeDIDRegistry is Ownable, ReentrancyGuard, IERC2981, IMemeDIDRegistry, ONFT721 {
    using Address for address;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseTokenURI, bytes32 _root, 
            address _treasury, uint256 _fee, uint256 _minGasToTransfer, address _lzEndpoint) 
