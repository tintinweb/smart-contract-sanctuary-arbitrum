...
contract ReadONPickBadgeV2 is ERC721,AccessControl,Pausable {
    ...
    function safeMint(uint256 tokenId,uint256 contentId,uint256 points,string memory rate,string memory p3, bytes memory signature)
        public
    {
        require(verifySignature(p3,signature),"ReadON:invalid signature");
