...
contract Lending {
    ...
    function withdraw(
        ...
        emit Withdraw(msg.sender, _amount, address(manager.underlying()), uint256(uint64(response.price)) * (10 ** uint256((18 - (4294967295 + 1 - uint32(response.expo))))), uint256((18 - (4294967295 + 1 - uint32(response.expo)))), response);
