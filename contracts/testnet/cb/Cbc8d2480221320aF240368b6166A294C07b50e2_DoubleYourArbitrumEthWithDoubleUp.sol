...
/*
DOUBLE YOUR ARBITRUM ETH WITH DOUBLEUP!!!
A FUN LITTLE PROJECT CREATED FOR INVESTMENT GAMIFICATION!!!
SIMPLY SEND SOME ARBITRUM ETHER TO THIS CONTRACT ADDRESS TO STAKE YOUR POSITION
WHEN THE CONTRACT HAS RECIEVED ENOUGH ETHER TO DOUBLE YOUR POSITION
YOU WILL RECIEVE A PAYOUT EQUAL TO DOUBLE YOUR INITIAL INVESTMENT
ALL PAYOUTS ARE ORDERED BY RANK FIRST COME FIRST SERVED
THIS CONTRACT WAS CREATED FOR ENTERTAINMENT PUPOSES
*/
...
contract DoubleYourArbitrumEthWithDoubleUp{
    using SafeMath for uint256;
    string constant _name = "DOUBLEUP";
	User[] public users;
    ...
    uint256 public maxETH = 1000000000000000000000000000000000000000000000000000000 * (10**18) / 10;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address public devWallet = 0x849Fd5620C08e66A5613CBf59Ed483f738b3C202;
	struct User {
	...
	function withdrawFunds() external {
		...
		require(address(this).balance > 0, "This contract must have a balance above zero");
