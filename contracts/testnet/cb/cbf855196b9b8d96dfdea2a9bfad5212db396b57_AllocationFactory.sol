...
contract AllocationFactory is Ownable {
    ...
    constructor(
        ...
        uint256 totalSupplyCap = token.balanceOf(address(this));
        ...
        token.transfer(address(mghVesting), (totalSupplyCap * 15) / 100);
        mghVesting.transferOwnership(msg.sender);

        token.transfer(address(mghCrowdSale), (totalSupplyCap * 30) / 100);
