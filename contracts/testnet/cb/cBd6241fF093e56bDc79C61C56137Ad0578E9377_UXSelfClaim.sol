...
contract UXSelfClaim {
    ...
    function claim(
        ...
        require(verifySignature(transId,signature), "Signature is invalid");
    ...
    function toMessageHash(string memory message) public pure returns (bytes32) {
    ...
    function verifySignature(string memory message, bytes memory signature) public view returns (bool){
        bytes32 hash = toMessageHash(message);
