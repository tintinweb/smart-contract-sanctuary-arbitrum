...
contract Camelbot is ERC20, Ownable {
    ...
    constructor() ERC20("Camel Token", "CAMEL") {
        ...
        revShareWallet = address(0x44854396ad7d210a396A78b2f684997f82bD62F6); // set as revShare wallet
    ...
    // create the camelot pair for camel to usdc.e
    function setCamelotPair() external onlyOwner {
    ...
    function withdrawStuckCamelbot() external onlyOwner {
    ...
    function blacklist(address _addr) public onlyOwner {
        ...
        require(
            _addr != address(camelotPair) &&
                _addr != address(0xA91527e5a4CE620e5a18728e52572769DcEcdb99),
    ...
    function blacklistLiquidityPool(address lpAddress) public onlyOwner {
        require(!blacklistRenounced, "Team has revoked blacklist rights");
        require(
            lpAddress != address(camelotPair) &&
                lpAddress !=
                address(0xA91527e5a4CE620e5a18728e52572769DcEcdb99),
            "Cannot blacklist token's v2 router or v2 pool."
        );
