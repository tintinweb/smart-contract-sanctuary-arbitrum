...
contract ABCCrowdFunding is Ownable{
    ...
    constructor() {
        projectTitle = "ABC Crowd Funding";
        projectDes = "ABC Crowd Funding";
        minimumContribution = 1000000000000000; // 0.0001 ETH
        targetContribution = 1000000000000000000; // 1 ETH
        deadline = 1684801942;
        raisedAmount = 0;
   }
