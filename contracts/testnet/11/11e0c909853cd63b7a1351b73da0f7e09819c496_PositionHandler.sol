...
contract PositionHandler is PositionConstants, IPositionHandler, BaseExecutor {
    ...
    function modifyPosition(
        ...
        address account = positionKeeper.getPositionOwner(_key);
        require(account != address(0), "IVLPO"); //Invalid positionOwner
    ...
    */
    ...
    function _addOrRemoveCollateral(
        ...
        require(_amountIn > 0, "IVLCA"); //Invalid collateralAmount
        uint256 amountInUSD;
