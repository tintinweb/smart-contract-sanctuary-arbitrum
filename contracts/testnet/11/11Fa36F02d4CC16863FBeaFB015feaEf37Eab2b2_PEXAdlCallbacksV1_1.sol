...
contract PEXAdlCallbacksV1_1 is Initializable {
    ...
    function executeAdlCloseOrderCallback(
        ...
        for(uint i = 0; i < adlConditionInfo.totalAdlOrderLength; i++) {
            ...
            console.log("for");
            //console.logAddress(adlConditionInfo.o[i].trader);
            //console.logUint(uint(adlConditionInfo.o[i].adlType));
            ...
            //console.logInt(v.profitP);
            //console.logUint(t.openPrice);
            //console.logBool(t.buy);
            //console.logUint(t.leverage);
            //console.logUint(v.price);
            ...
            if (adlConditionInfo.o[i].adlType == IStorageT.AdlOrder.ADLTP) {
                console.log("test1");
                console.logUint(v.usdtSentToTrader);
                console.logUint(maxProfitUsdtBalance);
