...
contract Harvester is Ownable, Pausable {
    ...
    constructor(IERC20 _token, address _burnaddress, address _vesselAddress, address _teamAddress, uint256 _portion, uint256 _distribution_Incentive, uint256 _distribution_Team, uint256 _distribution_manual_Incentive ) {
        token = _token;
        ...
        // vesselAddress = 0xbD582572164ABEfd270B99A0B0884cF925b4d837;
        // teamAddress = 0x87fC83A1607AC6F0F26F247D786698ed27EBCb5b;

        // portion = 50;                    // value/100000 * remaining Token
        // distribution_Incentive = 15000;        // value/100000 * portion
        // distribution_Team = 5000;          // value/100000 * portion

        // distribution_manual_Incentive = 1000;       // value/100000 * remaining Token
    }
    ...
    function burnMultipleNFTs(address _nftContract, uint256[] memory _tokenIds) public whenNotPaused {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            collectionInformation[_nftContract].harvestingEfficiency *= collectionInformation[_nftContract].dimishingFactor / 100000;
        }

            // Distribute tokens to the caller, team and vessel address
            token.transfer(msg.sender, tokenReceived);
            token.transfer(vesselAddress, incentiveReceived);
    ...
    function addToWhitelist(address _nftContract, uint256 _limit, uint256 _harvestingEfficiency, uint256 _dimishingFactor) public onlyOwner {
    ...
    function sendTokenToVessel() public onlyOwner {
        ...
        token.transfer(vesselAddress, tokenForManualIncentive);
    }
