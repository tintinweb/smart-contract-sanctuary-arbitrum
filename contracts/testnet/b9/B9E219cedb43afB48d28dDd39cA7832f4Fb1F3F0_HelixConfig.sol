...
contract HelixConfig is BaseUpgradeablePausable {
  ...
  /// @notice Get config boolean variables in the system which is used to activate dividend payment functions in the fund
  ...
  /// @notice Set new value for system's config boolean variable
  /// @dev Only be called by admin
  /// @param index Index of boolean variable in the list in HelixConfigOptions contract
  /// @param newBoolean New value for the variable
  ...
  /// @notice Set new value for fund implementation repository address
  /// @dev Only be called by admin
  /// @param newAddress New value for fund implementation repository
  ...
  /// @dev Only be called by admin
  /// @param newAddress New value for fund implementation repository
  function setLoanImplementationRepository(
    address newAddress
  ) public onlyAdmin {
    uint256 key = uint256(
      HelixConfigOptions.Addresses.LoanImplementationRepository
    );
    emit AddressUpdated(msg.sender, key, addresses[key], newAddress);
    addresses[key] = newAddress;
  }
  ...
  /// @notice Initialize contract from other existed config contract
  /// @dev Only be called by admin
  /// @param _initialConfig Previous config contract
  /// @param numbersLength Length of system's config number array
  /// @param addressesLength Length of system's config address array
  ...
  */
  ...
  /// @notice Get config boolean variables in the system which is used to activate dividend payment functions in the fund
  /// @param index Index of boolean variable in the list in HelixConfigOptions contract
  /// @return boolean Value of respective boolean
