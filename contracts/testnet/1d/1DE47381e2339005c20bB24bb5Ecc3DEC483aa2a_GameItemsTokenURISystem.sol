...
uint256 constant ID = uint256(
    keccak256("game.piratenation.imageurlcomponent.v2")
);
...
library ImageUrlComponentStorage {
...
/**
 * @title ImageUrlComponent
 * @dev The default image url for an entity
 */
contract ImageUrlComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        value = ImageUrlComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ImageUrlComponentStorage
                .layout()
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ImageUrlComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = ImageUrlComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function remove(
        ...
        delete ImageUrlComponentStorage.layout().entityIdToStruct[entity];
    ...
    function batchRemove(
        ...
        for (uint256 i = 0; i < entities.length; i++) {
            delete ImageUrlComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
 ...
 * @dev Name Component
 */
contract NameComponent is BaseStorageComponentV2 {
    /** SETUP **/
     ...
     *
     * @param entity Entity to get value for
     * @param value Name of the entity or component
     */
    function setValue(
        uint256 entity,
        string calldata value
     ...
     *
     * @param entity Entity to get value for
     * @return value Name of the entity or component
     */
    function getValue(
        uint256 entity
    ) external view virtual returns (string memory value) {
        if (has(entity)) {
            Layout memory s = NameComponentStorage.layout().entityIdToStruct[
                entity
            ];
            (value) = abi.decode(_getEncodedValues(s), (string));
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = NameComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete NameComponentStorage.layout().entityIdToStruct[entities[i]];
        }
        _emitBatchRemoveBytes(entities);
    }
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.traitmetadatacomponent.v3")
);
...
library TraitMetadataComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title TraitMetadataComponent
 * @dev Component for storing metadata about a trait
 */
contract TraitMetadataComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // A display worthy component name
        keys[0] = "display_name";
        values[0] = TypesLibrary.SchemaValue.STRING;

        // A code-safe component name
        keys[1] = "trait_name";
     ...
     *
     * @param entity Entity to get value for
     * @param displayName A display worthy component name
     * @param traitName A code-safe component name
     */
    function setValue(
        uint256 entity,
        ...
        _setValue(entity, Layout(displayName, traitName));
    }
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = TraitMetadataComponentStorage.layout().entityIdToStruct[entity];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return displayName A display worthy component name
     * @return traitName A code-safe component name
     */
    function getValue(
        uint256 entity
    )
        ...
        view
        virtual
        returns (string memory displayName, string memory traitName)
    {
        if (has(entity)) {
            Layout memory s = TraitMetadataComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (displayName, traitName) = abi.decode(
                _getEncodedValues(s),
                (string, string)
            );
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = TraitMetadataComponentStorage
            .layout()
            .entityIdToStruct[entity];

        // ABI Encode all fields of the struct and add to values array
        values = new bytes[](2);
        values[0] = abi.encode(s.displayName);
        values[1] = abi.encode(s.traitName);
    }
    ...
    function setBytes(
        ...
        Layout memory s = TraitMetadataComponentStorage
            .layout()
            .entityIdToStruct[entity];
        (s.displayName, s.traitName) = abi.decode(value, (string, string));
        _setValueToStorage(entity, s);
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete TraitMetadataComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete TraitMetadataComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
    ...
    function _setValueToStorage(uint256 entity, Layout memory value) internal {
        ...
        s.displayName = value.displayName;
        s.traitName = value.traitName;
    }
    ...
    function _setValue(uint256 entity, Layout memory value) internal {
        ...
        // ABI Encode all native types of the struct
        _emitSetBytes(entity, abi.encode(value.displayName, value.traitName));
    }

    function _getEncodedValues(
        Layout memory value
    ) internal pure returns (bytes memory) {
        return abi.encode(value.displayName, value.traitName);
    }
}
