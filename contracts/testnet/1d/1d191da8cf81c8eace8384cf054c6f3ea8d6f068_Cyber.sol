...
abstract contract ERC721Omni {
    ...
    function ownerOf(uint256 id) public view virtual returns (address) {
        require(_ownerOf[id].tokenHolder != address(0), "Token does not exist");
    ...
    function _burn(uint256 tokenId) internal {
        address _owner = _ownerOf[tokenId].tokenHolder;
        require(_owner != address(0), "Null ID");
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        require(_ownerOf[tokenId].tokenHolder != address(0), "Null ID");
...
contract Cyber is ERC721Omni {
    ...
    string private _baseURI = "ipfs://QmbXs7Z4Yo6GT3CBPryNswyVbZLaWSvtQEnmPZFw28WkEL/";
    uint256 public constant maximumSupply = 70;
    uint256 public publicMintedCap = 2;
