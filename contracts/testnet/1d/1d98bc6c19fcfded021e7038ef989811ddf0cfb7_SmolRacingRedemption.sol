...
contract SmolRacingRedemption is Ownable {
    ...
    function redeem(uint256 _tokenId, uint256 _quantity) public {
        require(tokenIdToRedemptionQuantity[_tokenId] > 0, "Token does not have magic redemption number!");
    ...
    function setAddresses(address _ERC1155Address, address _ERC20Address) public onlyOwner {
