...
ReentrancyGuard
{
    ...
    uint256 public ticketPrice = 1000 * 10 ** DECIMALS; // 1000 LUCKY (LUCKY has 18 decimals)
    uint256 public totalTicketCount = 15900;
    uint256 private emptyTickets = 14180;
    enum CardResult {
        LOSS,
        WIN1000,
        WIN2000,
    ...
    "ipfs://QmXThLkwv89GaM1i4ZZuEvi1WVbvyyqqWnmPjU7zpTq8i2/";
    ...
    constructor(
         ...
         */
        generationCounts[CardResult.WIN10000] = 50;
        generationCounts[CardResult.WIN5000] = 200;
        generationCounts[CardResult.WIN2000] = 2000;
        generationCounts[CardResult.WIN1000] = 8500;

        rewardAmounts[CardResult.WIN10000] = 10000;
        rewardAmounts[CardResult.WIN5000] = 50000;
