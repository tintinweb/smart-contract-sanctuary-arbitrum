...
contract BeaconProxyPayable is BeaconProxy {
    receive() external payable override {
        ...
        require(
            ...
            msg.sender == 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3, //Arbitrum Goerli WETH
...
interface IPairFactory {
    function pairByTokens(address _tokenA, address _tokenB)
        external
        view
        returns (address);
}
...
import "./external/SafeOwnable.sol";
import "./external/AddressLibrary.sol";
import "./external/BeaconProxyPayable.sol";
