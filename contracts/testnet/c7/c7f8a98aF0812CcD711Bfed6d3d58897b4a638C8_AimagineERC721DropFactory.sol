...
contract AimagineERC721Drop is ERC721A, IERC2981, ReentrancyGuard, AccessControl, IAimagineERC721Drop, Ownable {
     ...
     */
    function owner() public view override(Ownable, IAimagineERC721Drop) returns (address) {
        return super.owner();
    }
...
contract AimagineERC721DropFactory is Ownable, Pausable {
    ...
    function deployAimagineERC721Drop(
        ...
        new AimagineERC721Drop(_contractName, _contractSymbol, _contractURI, _initialOwner, _fundsRecipient, _editionSize, _royaltyBPS, _mintFeeAmount, _mintFeeRecipient, _salesConfig);
