...
contract AddressBook is IAddressBook, Ownable {
    ...
    address public cryptoPoolAdapter;
    /// @dev stablePoolAdapter address
    address public stablePoolAdapter;
    /// @dev treasure address
    ...
    function setCryptoPoolAdapter(address cryptoPoolAdapter_) external onlyOwner {
        _checkAddress(cryptoPoolAdapter_);
        cryptoPoolAdapter = cryptoPoolAdapter_;
    }

    function setStablePoolAdapter(address stablePoolAdapter_) external onlyOwner {
        _checkAddress(stablePoolAdapter_);
        stablePoolAdapter = stablePoolAdapter_;
    }
