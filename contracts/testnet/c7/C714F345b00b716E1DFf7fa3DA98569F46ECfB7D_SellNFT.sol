...
contract SellNFT is OwnableUpgradeable {
    using AddressUpgradeable for address;
    address public WALLET;
    address public USDT;
    address public msw721Address;
    IMSW721 public msw721;
    ...
    function init() public initializer {
        ...
        // setMsw721(address("0x1ab4C7f49fC75Ba0B08C5FB3464c88E480fEcedb"));
    }
    ...
    function setMsw721(address msw721_) public onlyOwner {
        msw721Address = msw721_;
        msw721 = IMSW721(msw721_);
    }
    ...
    function nftPrice(uint cardId_) public view returns (uint) {
        (, , , uint price, ) = msw721.cardInfoes(cardId_);
        return price;
    }
    ...
    function buyNFTWithUSDT(uint cardId_) public {
        ...
        msw721.mint(msg.sender, cardId_, 1);
        uint tokenId = msw721.cardIdMap(cardId_);
