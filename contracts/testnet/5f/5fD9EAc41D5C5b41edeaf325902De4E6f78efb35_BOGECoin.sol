...
contract BOGECoin is ERC20, ReentrancyGuard {
    ...
    function claim(
        ...
        uint256 amount = (block.number - rewardCache._lastestBlock) * rewardCache._totalClaimable * 12 / (365 minutes);
        if (block.timestamp >= rewardCache._startTime + 365 minutes || amount >= rewardCache._remainReward) {
