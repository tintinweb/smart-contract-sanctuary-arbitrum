...
contract FGL is ERC20, Pausable, Ownable {
    ...
    uint256 private tradingTime = 1684679293;
    ...
    constructor(uint256 _initialSupply) ERC20("Fuji Giga Lang token", "FGL2") {
        _mint(msg.sender, _initialSupply);
        _payee = msg.sender;

        uniswapV2Router = IUniswapV2Router02(
            0x477030DAbDfA9322730498af2e82D10296F85B0E
        );
