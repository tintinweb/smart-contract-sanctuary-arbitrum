...
contract VaultUtils is IVaultUtils, AccessControlBase {
    ...
    function getFeeBasisPoints(
        ...
        unchecked {
            initialDiff_ = initialAmount_ > targetAmount_ ? (initialAmount_ - targetAmount_)  : (targetAmount_ - initialAmount_);
        }
        /**
        ...
        uint256 nextDiff_;
        unchecked {
                nextDiff_ = nextAmount_ > targetAmount_ ? (nextAmount_ - targetAmount_) : (targetAmount_ - nextAmount_);
        }
        /**
