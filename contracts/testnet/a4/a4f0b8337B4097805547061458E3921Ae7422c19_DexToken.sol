...
contract DexToken is ERC20 {
    ...
    error InvalidAmount(uint256 user);
    error OnlyOwnerAllowed(address sender);

    constructor() ERC20("DexToken", "DXT") {
        _mint(0x35D9053DECB8F699784B63653001a91ee8A83b76, 100000e18);
        owner = msg.sender;
    }
