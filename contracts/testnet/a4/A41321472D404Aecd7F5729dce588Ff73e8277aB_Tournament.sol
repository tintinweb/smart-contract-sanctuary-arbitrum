...
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.4;
import "./NFT721-Ticket.sol";
import "./iNFT721-Ticket-Factory.sol";
...
import "./NFT721-Ticket.sol";
import "./NFT721-Ticket-Factory.sol";
import "./iNFT721-Ticket-Factory.sol";
...
contract Tournament is AccessControl, ReentrancyGuard {
    ...
    function claimTicket(uint256 requestId, bytes memory signature) external nonReentrant {
    ...
    function withdrawTicket(TicketQuantity[] memory withdrawTickets) public nonReentrant{
    ...
    function buyNFT(address ticketCollectionAddress, uint256 quantity) public nonReentrant {
    ...
    function getListTicketOfUser(
        ...
        for(uint256 i =0 ; i < listTicketCollectionAddress.length; i++) {
            if(depositTicketOfUser[user][listTicketCollectionAddress[i]].length > 0) {
