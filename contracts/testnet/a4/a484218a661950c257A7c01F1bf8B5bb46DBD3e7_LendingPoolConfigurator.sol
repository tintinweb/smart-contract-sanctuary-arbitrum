...
/**
 *Submitted for verification at Etherscan.io on 2023-7-17
*/
 ...
 * @author Natrium, inspiration from Aave
 * @dev Implements the configuration methods for the Natrium protocol
 **/
  ...
  function _initReserve(ILendingPool _pool, InitReserveInput calldata input) internal {
    ...
    address aTokenProxyAddress = _initTokenWithProxy(
      ...
      abi.encodeWithSelector(
        ...
        INatriumIncentivesController(input.incentivesController),
