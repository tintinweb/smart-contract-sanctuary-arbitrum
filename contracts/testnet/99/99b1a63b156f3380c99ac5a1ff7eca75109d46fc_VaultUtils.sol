    ...
    function validateConfirmDelay(
        ...
        if (transaction.status == 0) {
            if (
                ...
                //&& transaction.params[0] > 0 //TODO: Re-check
            ) validateFlag = true;
...
import {PrepareTransaction, TxDetail, Bond, BondDetail, OrderType} from "../../constants/Structs.sol";
...
interface IRouter {
    ...
    */
    ...
    function getBondDetail(bytes32 _key, uint256 _txType) external view returns (BondDetail memory);
}
