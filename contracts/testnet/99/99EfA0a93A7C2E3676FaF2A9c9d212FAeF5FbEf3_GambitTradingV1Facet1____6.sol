...
/**
 * @dev GambitTradingV1Facet1 implements initialize, setMaxPosUsdc, setLimitOrdersTimelock, setMarketOrdersTimeout, pause, done
 */
abstract contract GambitTradingV1Facet1 is GambitTradingV1Base {
    constructor() {
        _disableInitializers();
    }
    ...
    // Manage params
    function setMaxPosUsdc(uint value) external onlyGov {
...
/**
 * @dev GambitTradingV1Facet1 with stablecoin decimals set to 6.
 */
contract GambitTradingV1Facet1____6 is GambitTradingV1Facet1 {
 ...
 * @dev GambitTradingV1Facet1 with stablecoin decimals set to 6.
 */
contract GambitTradingV1Facet1____18 is GambitTradingV1Facet1 {
    function usdcDecimals() public pure override returns (uint8) {
        return 18;
    }
}
