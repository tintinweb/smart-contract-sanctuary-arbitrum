...
contract RecruitLevel is Initializable, RecruitLevelSettings {
    ...
    whenNotPaused
    {
        ...
        if(_recruitTypeCur == RecruitType.NONE) {
            ...
            require(_recruitTypeCur == RecruitType.COGNITION
                || _recruitTypeCur == RecruitType.PARABOLICS
                || _recruitTypeCur == RecruitType.LETHALITY,
                "Recruit must be a cadet to become an apprentice");

            // Verify the recruit type is correct.
            require(_newRecruitType == RecruitType.SIEGE_APPRENTICE
                || _newRecruitType == RecruitType.FIGHTER_APPRENTICE
                || _newRecruitType == RecruitType.ASSASSIN_APPRENTICE
                || _newRecruitType == RecruitType.RANGED_APPRENTICE
                || _newRecruitType == RecruitType.SPELLCASTER_APPRENTICE,
                "Bad Recruit type");
