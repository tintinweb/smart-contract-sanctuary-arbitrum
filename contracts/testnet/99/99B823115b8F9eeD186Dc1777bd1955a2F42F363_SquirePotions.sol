...
contract SquirePotions is ERC1155, Ownable {


    enum ItemType { RING, POTION, TRINKET }

    uint256 thisType = uint(ItemType.POTION);

    //mappings
    mapping(address => bool) private allowedContracts;

	string public _baseURI = "ipfs://QmSrweg3GHCqpWrzmQ4toaP9fSAwMWgABzhiGQ4WxjQiVN/";
