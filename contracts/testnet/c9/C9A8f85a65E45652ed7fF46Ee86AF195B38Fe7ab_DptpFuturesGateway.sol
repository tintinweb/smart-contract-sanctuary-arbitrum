    ...
    ReentrancyGuardUpgradeable
{
    ...
    function swap(
        ...
        _transferIn(_path[0], _amount);
        _transferOut(_path[0], _amount, vault);
        uint256 amountTokenOut = _swap(_path, address(this), false);
        _transferOut(_path[1], amountTokenOut, msg.sender);
    }
