...
contract FaucetLBFR is Ownable {
    ...
    mapping(address => uint256) public totalTokensAllocatedPerUser;
    ...
    function _validateSigner(
        ...
        bytes32 digest = ECDSA.toEthSignedMessageHash(
            keccak256(abi.encodePacked(tokens, timestamp, sender))
        );
    ...
    function claim(
        ...
        require(
            totalTokensAllocated > totalTokensAllocatedPerUser[msg.sender],
        ...
        uint256 claimableTokens = totalTokensAllocated -
            totalTokensAllocatedPerUser[msg.sender];

        token.mint(msg.sender, claimableTokens);
        totalTokensAllocatedPerUser[msg.sender] = totalTokensAllocated;
