...
contract ProfitShare is Roles, ERC2771Context, IProfitShare {
    ...
    bytes32 private constant MASTER_PROFIT_ADD = keccak256("MASTER_PROFIT_ADD");
    bytes32 private constant GOV = keccak256("GOV");
    IPool immutable pool;
    bytes32 private DOMAIN_HASH;
    // uint256 private EPOCH = 1 weeks;
    uint256 private EPOCH = 1 hours; //for test
    ...
    function recordShare(
        ...
        int256 amount,
        bytes32 id
    ) external override hasRole(MASTER_PROFIT_ADD) returns (int256 change) {
