...
contract PositionRouterV2_STG is BasePositionV2, IPositionRouterV2, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function closePosition(
        ...
        if (isFastExecute && settingsManager.disableFastExecuteForClosePosition()) {
            isFastExecute = false;
        }
