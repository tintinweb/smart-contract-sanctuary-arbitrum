...
contract UXSelfClaim {
    ...
    function claim(
        ...
        // check signature
        bytes32 msgHash = toEthSignedMessageHash(msg.sender,amount);
    ...
    function toEthSignedMessageHash(address _account, uint256 amount) public pure returns (bytes32) {
        bytes32 hash = keccak256(abi.encodePacked(_account, amount));
        return keccak256(abi.encodePacked("\x19Ethereum Signed Message:\n32", hash));
    }
