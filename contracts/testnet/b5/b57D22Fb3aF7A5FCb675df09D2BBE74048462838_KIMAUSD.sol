...
import "./interfaces/IKIMAUSD.sol";

contract KIMAUSD is IKIMAUSD, ERC20, Ownable {   
    ...
    constructor() ERC20("KIMAUSD", "KIMAUSD"){
    ...
    */
    ...
    /**
    * mints $KIMAUSD to a recipient
    * @param to the recipient of the $KIMAUSD
    * @param amount the amount of $KIMAUSD to mint
    */
    ...
    /**
    * burns $KIMAUSD from a holder
    * @param from the holder of the $KIMAUSD
    * @param amount the amount of $KIMAUSD to burn
    */
    ...
    */
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override(ERC20, IKIMAUSD) disallowIfStateIsChanging returns (bool) {
        ...
        // For instance, someone can't just make a contract and siphon $KIMAUSD from every account
    ...
    function updateOriginAccess() external override {
        ...
        lastWrite[_msgSender()] = block.number;
    }
