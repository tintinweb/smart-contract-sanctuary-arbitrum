...
contract RiskTakerz is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, EIP712, ERC721Votes {
    using Counters for Counters.Counter;
    ...
    constructor() ERC721("RiskTakerz", "RTZ") EIP712("RiskTakerz", "1") {
    ...
    function updateTokenURI(uint256 tokenId,string memory newUri) public onlyRole(UPDATE_URI_ROLE){
        _setTokenURI(tokenId,newUri);
    }

    function burn(uint256 tokenId) public onlyRole(BURNER_ROLE) override(ERC721Burnable){
        _burn(tokenId);
    }
}