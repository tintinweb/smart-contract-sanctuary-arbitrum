...
contract UPUXUYSale is Manager, Round {
    ...
    event Claimed(address account, uint8 round, uint256 usdtAmount, uint256 upuxuy, bool isVip, uint256 price, uint256 usdt, uint256 ratio);
    ...
    function setSaleConf(uint8 round, SaleConf calldata conf) public onlyManager {
        require(conf.PricePublic > 0, "price for public is zero");
