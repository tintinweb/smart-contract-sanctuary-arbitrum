 ...
 */
contract ARBRegistrarController is
    Ownable,
    IARBRegistrarController,
    IERC165,
    ERC20Recoverable
{
...
contract BaseRegistrarImplementation is ERC721, IBaseRegistrar, Ownable {
    ...
    constructor(ANS _ans, bytes32 _baseNode) ERC721("", "") {
        ans = _ans;
        baseNode = _baseNode;
    }
...
contract ReverseRegistrar is Ownable, Controllable, IReverseRegistrar {
    ...
    constructor(ANS ansAddr) {
        ...
        ReverseRegistrar oldRegistrar = ReverseRegistrar(
            ansAddr.owner(ADDR_REVERSE_NODE)
        );
    ...
    function claimForAddr(
        ...
        ans.setSubnodeRecord(ADDR_REVERSE_NODE, labelHash, owner, resolver, 0);
        return reverseNode;
    }
...
interface INameWrapper is IERC1155 {
    ...
    function ans() external view returns (ANS);
...
/**
 * Interface for the legacy (ARB-only) addr function.
 */
