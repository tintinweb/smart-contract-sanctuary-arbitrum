...
contract UXGroupAccount is IERC165, IERC1271, IERC6551Account {
    ...
    function transferERC721(address erc721Address, address to, uint256 tokenId) external onlyOwner {
        IERC721(erc721Address).transferFrom(address(this), to, tokenId);
    }

    function transferERC1155(address erc1155Address,address to, uint256 tokenId, uint256 amount, bytes calldata data) external onlyOwner {
        IERC1155(erc1155Address).safeTransferFrom(address(this), to, tokenId, amount, data);
    }
