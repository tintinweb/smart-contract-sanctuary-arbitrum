...
/**
 * @title Staking
 * @notice Stake protocol tokens to earn real yield in WETH.
 * @dev Based on Curve Finance's MultiRewards contract and updated to be compatible with solc 0.7.0
