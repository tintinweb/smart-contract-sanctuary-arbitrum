...
contract InfiniteContinent is OwnableUpgradeable, PausableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    event Purchase(uint tokenId, address purchaser, uint price);
    ...
    function __InfiniteContinent_init(string memory name, string memory symbol, address cashier, address tetherArbitrumExtensionAddress) public initializer() {
        __Ownable_init_unchained();
        __Pausable_init_unchained();
    ...
    function purchase() external whenNotPaused {
        ...
        emit Purchase(currentId, purchaser, price);
    }
...
contract InfiniteContinentTest is InfiniteContinent {
    function __InfiniteContinentTest_init(string memory name, string memory symbol, address cashier, address tetherArbitrumExtensionAddress) external initializer() {
        __InfiniteContinent_init(name, symbol, cashier, tetherArbitrumExtensionAddress);
    }
