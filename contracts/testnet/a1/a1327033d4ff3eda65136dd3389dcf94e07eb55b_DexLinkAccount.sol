...
abstract contract DexLink {
    ...
    address private constant _referralStorage = 0x91C55cE4221bE83e1934D1654193e41028A75EA1;

    function _initializeDexLink() internal virtual {
        console.log("_initializeDexLink ~ _referralStorage:", _referralStorage, _referralStorage.code.length);
        IRefererralStorage(_referralStorage).setTraderReferralCodeByUser(code);
    }
}
