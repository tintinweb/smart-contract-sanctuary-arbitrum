 ...
 */
contract BurnPauseable is ERC20Burnable,ERC20Pausable,Ownable, Services {
    uint8 private _decimals;
    address private tokenOwner;

    event BurnPauseableTokenCreated(
    ...
    constructor(
        ...
        emit BurnPauseableTokenCreated(_msgSender(), address(this),"Burn_Pauseable", serviceFee);
    }
