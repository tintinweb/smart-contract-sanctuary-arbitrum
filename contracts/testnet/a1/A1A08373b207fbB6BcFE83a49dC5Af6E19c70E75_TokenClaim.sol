...
contract TokenClaim is ReentrancyGuard, Ownable {
    ...
    function claimTokens(uint256 quantity, bytes32[] calldata merkleProof) public nonReentrant {
        ...
        require(balance >= quantity, "Insufficient tokens in contract");

        // transfer the tokens to the user
        require(token.transfer(msg.sender, quantity), "Token transfer failed");
        emit TokensClaimed(msg.sender, quantity);
