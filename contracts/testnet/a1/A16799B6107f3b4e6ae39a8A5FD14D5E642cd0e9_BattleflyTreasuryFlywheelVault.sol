    ...
    PausableUpgradeable
{
    ...
    function claimAllAndRestake() external override nonReentrant onlyBattleflyBot returns (uint256 amount) {
        ...
        if(ids.length > 0) {
            ...
            FOUNDER_VAULT_V2.topupMagicToStaker(v2VaultAmount, TREASURY_LOCK);
            ...
            if (activeRestakeDepositId == 0) {
            ...
            } else if (canWithdraw(activeRestakeDepositId)) {
                ...
                pendingTreasuryAmountToStake = 0;
            } else if (canRequestWithdrawal(activeRestakeDepositId)) {
    ...
    modifier onlyBattleflyBot() {
        require(_msgSender() == BATTLEFLY_BOT, "BattleflyTreasuryFlywheelVault: caller is not a battlefly bot");
        _;
    }
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _stakeBack(uint256 stakeBackAmount) internal {
        ...
        if (activeRestakeDepositId == 0 && pendingStakeBackAmount > 0) {
        ...
        } else if (BattleflyStakerV2.canWithdraw(activeRestakeDepositId)) {
            ...
            pendingStakeBackAmount = 0;
        } else if (BattleflyStakerV2.canRequestWithdrawal(activeRestakeDepositId)) {
    ...
    function setBattleflyStaker(address staker) external onlyOwner {
        ...
        // Approve the AtlasStaker contract to spend the magic
        magic.safeApprove(address(BattleflyStakerV2), 2**256 - 1);
    }
