...
contract L2UnicornMinter is BaseGame, L2NFTPeriphery {
    ...
    constructor(address randomizer_, address l2Unicorn_, address l2_, address recipient_) BaseGame(randomizer_) {
    ...
    function hatch(uint256 gasPrice_, uint256 playCount_, uint256 callbackGasLimit_, uint256 eSeries_) payable external {
        ...
        require(_costAmount[eSeries_] > 0 && IERC20(l2).transferFrom(_msgSender(), recipient, playCount_ * _costAmount[eSeries_]), "L2UnicornMinter: L2 transfer failure");
        //
        ...
        depositFund();
        //
        afterPlay(_msgSender(), playCount_, callbackGasLimit_, bytes32(eSeries_));
    }
