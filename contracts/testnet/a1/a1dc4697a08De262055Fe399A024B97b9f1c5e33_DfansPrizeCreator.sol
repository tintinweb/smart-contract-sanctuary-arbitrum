...
contract DfansPrizeCreator is Ownable {
  ...
  function createDfansPrize(
      ...
      dp.initialize(name, symbol, collectionId, owner, initialPublish, fixedPrice);
...
contract DfansPrize is ERC721, ERC721Royalty, ERC721Pausable, Ownable, Initializable, DefaultOperatorFilterer {
    ...
    address payable private _royalTyBeneficiary;
    ...
    function getRoyalTyBeneficiary() public view returns (address payable) {
    ...
    function setBeneficiaryAndRoyalty(address payable beneficiary, 
        address payable royaltyBeneficiary, 
        uint96 royaltyFraction) public onlyOwner {
        // mint beneficiary and royalty receiver are same
        _beneficiary = beneficiary;
        _royalTyBeneficiary = royaltyBeneficiary;
        _setDefaultRoyalty(royaltyBeneficiary, royaltyFraction);
    }

    /// @notice Set the recipient of revenues.
    ...
    function setRoyaltyBeneficiary(address payable royaltyBeneficiary, uint96 royaltyFraction) public onlyOwner {
        // mint beneficiary and royalty receiver are same
        _royalTyBeneficiary = royaltyBeneficiary;
        _setDefaultRoyalty(royaltyBeneficiary, royaltyFraction);
    }
