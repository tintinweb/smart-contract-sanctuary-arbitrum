...
contract VaultAccessControlRegistry is IVaultAccessControlRegistry, AccessControl, Pausable {
    ...
    /**
     * @notice convenience function that sets a new governanceAddress
     ...
     */
    function changeGovernanceAddress(address _governanceAddress) external onlyRole(GOVERANCE_ROLE) {
        require(
