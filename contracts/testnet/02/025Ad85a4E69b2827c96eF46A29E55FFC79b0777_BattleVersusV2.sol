...
contract BattleVersusV2 is ReentrancyGuard, Pausable, ManagerModifier {
  ...
  uint256[] public animaRewardsProbabilityThresholds;
  uint256[] public animaRewardsMultipliers;

  //=======================================
  // XP Rewards
  //=======================================
  uint16[] public xpRewards;
  ...
  constructor(
    ...
    animaRewardsProbabilityThresholds = new uint256[](3);
    animaRewardsProbabilityThresholds[0] = 74;
    animaRewardsProbabilityThresholds[1] = 49;
    animaRewardsProbabilityThresholds[2] = 4;

    animaRewardsProbabilityThresholds = new uint256[](3);
    animaRewardsProbabilityThresholds[0] = 2;
    animaRewardsProbabilityThresholds[1] = 6;
    animaRewardsProbabilityThresholds[2] = 24;
  }
  ...
  function updateXpReward(uint16[] calldata _xpRewards) external onlyAdmin {
  ...
  function _beginVersusBattle(
    ...
    for (uint8 traitId = 2; traitId < 8; traitId++) {
      ...
      battleData.lootBoxChance += (uint256)(perTraitLootBoxProbabilityMap[
  ...
  function _calculateAnima(
    ...
    uint256 multiplier = _getAnimaMultiplier(data.probability);
    uint256 anima = animaReward * multiplier;
  ...
  function _getAnimaMultiplier(
    ...
    for (uint i = 0; i < animaRewardsProbabilityThresholds.length; i++) {
      ...
      multiplier = animaRewardsMultipliers[i];
    }
  }
