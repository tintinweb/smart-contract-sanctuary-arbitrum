...
contract StructureMinter is Pausable, ManagerModifier {
  ...
  function mint(StructureMintRequest calldata _request) external whenNotPaused {
    ...
    // Stake collectibles, burn collectibles, mint structures. Will revert if verification fails
    _stakeBurnAndMint(_request);
    ...
    // Add structures to be able to be picked during crafting
  ...
  function _stakeBurnAndMint(StructureMintRequest calldata _request) internal {
