...
contract ArbitrumFaucet is Initializable, AccessControlUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        todayDate = block.timestamp / 1 days;
    ...
    /**
     * @notice Getter for `lastRequestTimestamp`.
     */
    ...
    /**
     * @notice Getter for `lastRequestTwitterTimestamp`.
     */
    ...
    function setTodayDate()external onlyRole(OWNER_ROLE){
        todayDate = block.timestamp;
    }
}