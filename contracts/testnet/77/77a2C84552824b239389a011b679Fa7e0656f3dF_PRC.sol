...
contract PRC is IERC20, Auth {
    ...
    string constant _name = "PRC";
    string constant _symbol = "PRC";
    ...
    // TODO
    bool public isTradingEnabled = true; // change to false before mainnet deployment
    uint256 public tradingTimestamp;

    constructor() Auth(msg.sender) {
        address _dexRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
        router = IDexRouter(_dexRouter);
        WETH = 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3;
        _allowances[address(this)][_dexRouter] = _totalSupply;
    ...
    function _transferFrom(
        ...
        require(isTradingEnabled, "Trading not yet enabled");
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require((amount <= _maxTxSize && _balances[sender] + amount <= _maxWalletSize) || isTxLimitExempt[sender],
            "TX or wallet limit exceeded"
        );
    }
    ...
    function addToBlacklist(address _address) public authorized {
        _blacklist[_address] = true;
    }

    function whitelist(address _address) public authorized {
