...
// File: @ansdomains/ans/contracts/ANS.sol
...
// File: @ansdomains/resolver/contracts/Resolver.sol
...
// File: contracts/ARBRegistrarController.sol
 ...
 */
contract ARBRegistrarController is Ownable {
    ...
    function registerWithConfig(string memory name, address owner, uint duration, bytes32 secret, address resolver, address addr) public payable {
        ...
        if(resolver != address(0)) {
            ...
            // Set the resolver
            base.ans().setResolver(nodehash, resolver);
...
contract BulkRenewal {
    bytes32 constant private ARB_NAMEHASH = 0xd924c6d6935f3bf84be3da0b40fabe48800690c760c2db576028a389f1b54f89;
    ...
    function getController() internal view returns(ARBRegistrarController) {
        ...
        return ARBRegistrarController(r.interfaceImplementer(ARB_NAMEHASH, REGISTRAR_CONTROLLER_ID));
    }
