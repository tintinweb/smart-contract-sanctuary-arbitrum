...
/** 
  ...
  @dev
  Adheres to -
  ISNOWProjects: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
...
*/
contract SNOWProjects is SNOWOperatable, ERC721Votes, Ownable, ISNOWProjects {
  //*********************************************************************//
  ...
  */
  ISNOWTokenUriResolver public override tokenUriResolver;
  ...
  */
  function tokenURI(uint256 _projectId) public view override returns (string memory) {
    ...
    if (tokenUriResolver == ISNOWTokenUriResolver(address(0))) return '';
  ...
  */
  ...
  {
    return
      _interfaceId == type(ISNOWProjects).interfaceId ||
  ...
  */
  function setMetadataOf(uint256 _projectId, SNOWProjectMetadata calldata _metadata)
    external
    override
    requirePermission(ownerOf(_projectId), _projectId, SNOWOperations.SET_METADATA)
  {
  ...
  */
  function setTokenUriResolver(ISNOWTokenUriResolver _newResolver) external override onlyOwner {
