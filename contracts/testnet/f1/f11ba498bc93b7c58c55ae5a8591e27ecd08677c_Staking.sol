...
contract Staking {
    ...
    {
        return (userWithdraw[_address].status, userWithdraw[_address].amount, userWithdraw[_address].withdrawTime);
    }
    ...
    function stake(uint256 amount) external _hasAllowance(msg.sender, amount) {
        require(amount >= 150 * 10**18, "Please increase your staking value!");
    ...
    function claimWithdraw() external {
        ...
        require(userWithdraw[msg.sender].withdrawTime < block.timestamp, "Maturity date is not over!");
