...
contract Runbot is A_Base, A_Math, ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
	...
	function completeAskMint(uint256 mintId, uint256 lockTimeout, bool withFirstBidRebate, bool isApproved) external onlyOwner{
		...
		if(isApproved){
			...
			safeMint(mintAsk.asker, mintAsk.nftType, mintAsk.nftSubType, bidPrice, mintAsk.borrowDuration, lockTimeout, withFirstBidRebate);
		}
	...
	function batchSafeMint(uint256 nb, address to, uint256 nftType, uint256 nftSubType, uint256 bidPrice, uint256 borrowDuration, uint256 lockTimeout, bool withFirstBidRebate) external onlyOwner{
