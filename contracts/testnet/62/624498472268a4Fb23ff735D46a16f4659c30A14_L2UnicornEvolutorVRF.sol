 ...
 * @notice 独角兽进化(VRF)
 */
contract L2UnicornEvolutorVRF is BaseVRFConsumer, BaseMaximum, BaseL2Unicorn, BaseL2UnicornRule, BaseRecipient, Pausable {
    ...
    constructor(address l2Unicorn_, address l2UnicornRule_, address recipient_, address vrfCoordinator_, bytes32 keyHash_, uint64 vrfSubscriptionId_)
