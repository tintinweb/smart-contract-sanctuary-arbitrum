...
// File contracts/libraries/HelixErrors.sol
...
library HelixErrors {
    ...
    string public constant LOAN_IS_CLOSED = "2";
...
// File contracts/upgradeable/HelixBaseUpgradeablePausable.sol
...
// File contracts/proxy/ImplementationRepository.sol
...
// File contracts/proxy/UcuProxy.sol
...
contract UcuProxy is IERC173, Proxy {
  ...
  constructor(ImplementationRepository _repository, address _owner) {
  ...
  /// @notice Returns the associated {ImplementationRepository}
  ///   contract used for fetching implementations to upgrade to
  function getRepository() external view returns (ImplementationRepository) {
  ...
  function _upgradeImplementation() internal {
    ImplementationRepository repo = _getRepository();
  ...
  function _setRepository(ImplementationRepository newRepository) internal {
  ...
  function _getRepository() internal view returns (ImplementationRepository repo) {
    // solhint-disable-next-line security/no-inline-assembly
    assembly {
