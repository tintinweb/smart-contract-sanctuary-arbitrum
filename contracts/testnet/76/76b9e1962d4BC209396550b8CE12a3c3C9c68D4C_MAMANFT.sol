...
contract MAMANFT is ERC721Enumerable, Ownable {
    ...
    uint256 public plAndWlAaMintAmount = 0;
    ...
    function setPlAndWlAaMintAmount(uint256 _plAndWlAaMintAmount) public onlyOwner {
        plAndWlAaMintAmount = _plAndWlAaMintAmount;
    }
    ...
    function mintAaToPl(uint64 _amount) public payable {
        ...
        plAndWlAaMintAmount = plAndWlAaMintAmount + _amount;
        require(plAndWlAaMintAmount <= plAndWlAaAmountLimit, "total amount limit");
