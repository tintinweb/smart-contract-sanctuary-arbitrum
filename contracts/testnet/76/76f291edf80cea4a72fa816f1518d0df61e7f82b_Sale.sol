...
contract Sale {
    ...
    function withdrawExcessERC20() public {
        ...
        if (userDepositedEUSD[msg.sender] > 0) {
            ...
            excessAmount = depositedEUSD - saleERCSoftCap;
            percentage = calculateDepositPercentage(msg.sender, userDepositedEUSD[msg.sender]);
            amount = calculateUserExcess(excessAmount, percentage);
        ...
        if (userDepositedDAI[msg.sender] > 0) {
            ...
            excessAmount = depositedDAI - saleERCSoftCap;
            percentage = calculateDepositPercentage(msg.sender, userDepositedDAI[msg.sender]);
            amount = calculateUserExcess(excessAmount, percentage);
        ...
        if (userDepositedUSDC[msg.sender] > 0) {
            ...
            excessAmount = depositedUSDC - saleERCSoftCap;
            percentage = calculateDepositPercentage(msg.sender, userDepositedUSDC[msg.sender]);
            amount = calculateUserExcess(excessAmount, percentage);
    ...
    function calculateDepositPercentage(address _user, uint256 _deposited) public view returns (uint256)  {
