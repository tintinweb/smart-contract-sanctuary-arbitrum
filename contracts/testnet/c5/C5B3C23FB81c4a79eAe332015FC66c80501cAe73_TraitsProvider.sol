...
uint256 constant ID = uint256(
    keccak256("game.piratenation.animationurlcomponent.v2")
);
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.combatmodifierscomponent.v2")
);
...
contract CombatModifiersComponent is BaseStorageComponentV2 {
    ...
    function getValue(
        uint256 entity
    ) external view virtual returns (int64[] memory value) {
        if (has(entity)) {
            Layout memory s = CombatModifiersComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (int64[]));
        }
    }
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.energyprovidedcomponent.v2")
);
...
library EnergyProvidedComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title EnergyProvidedComponent
 * @dev Describes how much energy an entity provides
 */
contract EnergyProvidedComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = EnergyProvidedComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = EnergyProvidedComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = EnergyProvidedComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete EnergyProvidedComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete EnergyProvidedComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.equipmenttypecomponent.v2")
);
...
library EquipmentTypeComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title EquipmentTypeComponent
 * @dev The equipment type of an entity
 */
contract EquipmentTypeComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = EquipmentTypeComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = EquipmentTypeComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (uint256));
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = EquipmentTypeComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete EquipmentTypeComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete EquipmentTypeComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.isplaceablecomponent.v2")
);
...
library IsPlaceableComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title IsPlaceableComponent
 * @dev Whether an entity is placeable
 */
contract IsPlaceableComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = IsPlaceableComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = IsPlaceableComponentStorage
                .layout()
                .entityIdToStruct[entity];
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = IsPlaceableComponentStorage
            .layout()
            .entityIdToStruct[entity];
    ...
    function getBytes(
        ...
        Layout memory s = IsPlaceableComponentStorage.layout().entityIdToStruct[
            entity
        ];
        value = _getEncodedValues(s);
    }
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete IsPlaceableComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete IsPlaceableComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.modelurlcomponent.v2")
);
...
contract ModelUrlComponent is BaseStorageComponentV2 {
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ModelUrlComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (string));
        }
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.placeableobjectcomponent.v2")
);

struct Layout {
    uint8 terrain;
    bool isBottomStackable;
    bool isTopStackable;
}

library PlaceableObjectComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title PlaceableObjectComponent
 * @dev The static data for a placeable object entity
 */
contract PlaceableObjectComponent is BaseStorageComponentV2 {
    /** SETUP **/
        ...
        returns (string[] memory keys, TypesLibrary.SchemaValue[] memory values)
    {
        ...
        // The terrain type of a placeable entity
        keys[0] = "terrain";
        values[0] = TypesLibrary.SchemaValue.UINT8;

        // Whether a placeable entity is bottom stackable
        keys[1] = "is_bottom_stackable";
        values[1] = TypesLibrary.SchemaValue.BOOL;

        // Whether a placeable entity is top stackable
        keys[2] = "is_top_stackable";
     ...
     *
     * @param entity Entity to get value for
     * @param terrain The terrain type of a placeable entity
     * @param isBottomStackable Whether a placeable entity is bottom stackable
     * @param isTopStackable Whether a placeable entity is top stackable
     */
    function setValue(
        uint256 entity,
        uint8 terrain,
        ...
        _setValue(entity, Layout(terrain, isBottomStackable, isTopStackable));
    }
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = PlaceableObjectComponentStorage.layout().entityIdToStruct[
            entity
        ];
    }
     ...
     *
     * @param entity Entity to get value for
     * @return terrain The terrain type of a placeable entity
     * @return isBottomStackable Whether a placeable entity is bottom stackable
     * @return isTopStackable Whether a placeable entity is top stackable
     */
    function getValue(
        uint256 entity
    )
        ...
        view
        virtual
        returns (uint8 terrain, bool isBottomStackable, bool isTopStackable)
    {
        if (has(entity)) {
            Layout memory s = PlaceableObjectComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (terrain, isBottomStackable, isTopStackable) = abi.decode(
                _getEncodedValues(s),
                (uint8, bool, bool)
            );
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = PlaceableObjectComponentStorage
            .layout()
            .entityIdToStruct[entity];

        // ABI Encode all fields of the struct and add to values array
        values = new bytes[](3);
        values[0] = abi.encode(s.terrain);
        values[1] = abi.encode(s.isBottomStackable);
        values[2] = abi.encode(s.isTopStackable);
    }
    ...
    function setBytes(
        ...
        Layout memory s = PlaceableObjectComponentStorage
            .layout()
            .entityIdToStruct[entity];
        (s.terrain, s.isBottomStackable, s.isTopStackable) = abi.decode(
            value,
            (uint8, bool, bool)
        );
        _setValueToStorage(entity, s);
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete PlaceableObjectComponentStorage.layout().entityIdToStruct[
            entity
        ];
        _emitRemoveBytes(entity);
    }
    ...
    function _setValueToStorage(uint256 entity, Layout memory value) internal {
        ...
        s.terrain = value.terrain;
        s.isBottomStackable = value.isBottomStackable;
        s.isTopStackable = value.isTopStackable;
    }
    ...
    function _setValue(uint256 entity, Layout memory value) internal {
        ...
        _emitSetBytes(
            ...
            abi.encode(
                value.terrain,
                value.isBottomStackable,
                value.isTopStackable
            )
        );
    }
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.raritycomponent.v2")
);
 ...
 */
contract RarityComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = RarityComponentStorage.layout().entityIdToStruct[
                entity
            ];
            (value) = abi.decode(_getEncodedValues(s), (uint256));
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = RarityComponentStorage.layout().entityIdToStruct[
            entity
        ];
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.scale1dcomponent.v2")
);
...
contract Scale1DComponent is BaseStorageComponentV2 {
    ...
    function getValue(
        uint256 entity
    ) external view virtual returns (int64 value) {
        if (has(entity)) {
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.shiprankcomponent.v2")
);
...
library ShipRankComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title ShipRankComponent
 * @dev The ship rank of an entity
 */
contract ShipRankComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = ShipRankComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = ShipRankComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (uint256));
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = ShipRankComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = ShipRankComponentStorage.layout().entityIdToStruct[
            entity
        ];
        value = _getEncodedValues(s);
    }
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete ShipRankComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete ShipRankComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
...
uint256 constant ID = uint256(
    keccak256("game.piratenation.soulboundcomponent.v2")
);
...
library SoulboundComponentStorage {
    bytes32 internal constant STORAGE_SLOT = bytes32(ID);
...
/**
 * @title SoulboundComponent
 * @dev Whether an entity is soulbound
 */
contract SoulboundComponent is BaseStorageComponentV2 {
    /** SETUP **/
    ...
    function getLayoutValue(
        ...
        // Get the struct from storage
        value = SoulboundComponentStorage.layout().entityIdToStruct[entity];
    }
    ...
    function getValue(
        ...
        if (has(entity)) {
            Layout memory s = SoulboundComponentStorage
                .layout()
                .entityIdToStruct[entity];
            (value) = abi.decode(_getEncodedValues(s), (bool));
        }
    ...
    function getByteValues(
        ...
        // Get the struct from storage
        Layout storage s = SoulboundComponentStorage.layout().entityIdToStruct[
            entity
        ];
    ...
    function getBytes(
        ...
        Layout memory s = SoulboundComponentStorage.layout().entityIdToStruct[
            entity
        ];
        value = _getEncodedValues(s);
    }
    ...
    function remove(
        ...
        // Remove the entity from the component
        delete SoulboundComponentStorage.layout().entityIdToStruct[entity];
        _emitRemoveBytes(entity);
    }
    ...
    function batchRemove(
        ...
        // Remove the entities from the component
        for (uint256 i = 0; i < entities.length; i++) {
            delete SoulboundComponentStorage.layout().entityIdToStruct[
                entities[i]
            ];
        }
        _emitBatchRemoveBytes(entities);
