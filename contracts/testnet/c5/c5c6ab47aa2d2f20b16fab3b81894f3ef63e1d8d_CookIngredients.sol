...
contract CookIngredients is  ERC1155, ERC1155Burnable, ReentrancyGuard, Ownable, Pausable{
    address  ingredientsERC1155;
    address  bossCardERC1155Address;
    uint256 stakeIdCount = 1;
    uint256  _timeForReward = 2 hours;
    uint[] legendryBoost =[1,23,53]; 
    uint[] shinyBoost = [2,24,54];
    ...
    constructor(address _ingredientsERC1155, address _bossCard) ERC1155("https://gateway.pinata.cloud/ipfs/QmfQCdUSMGyhZWwfJLP4dABhWysiGPuaoQ9cAJofAhGHJs/{id}.json") {
    ...
    function claimReward(uint256 _stakeId) public {     
        ...
        for(uint i=0; i< tokenIds.length; i++){
            IIngredientsERC1155(ingredientsERC1155).burn(msg.sender, tokenIds[i], 1);
