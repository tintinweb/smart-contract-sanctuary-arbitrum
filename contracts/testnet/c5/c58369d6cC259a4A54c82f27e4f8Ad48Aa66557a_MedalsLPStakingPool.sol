...
import "./interfaces/IElleriumMedalERC20.sol";

contract MedalsLPStakingPool is Ownable, ReentrancyGuard {

    IElleriumMedalERC20 private rewardsToken;
    IERC20 private stakingToken;

    uint256 private rewardRate = 694444444; // in GWEI
    ...
    constructor(address _stakingToken, address _rewardsToken, address _stakingFeeAddress) {
        stakingToken = IERC20(_stakingToken);
        rewardsToken = IElleriumMedalERC20(_rewardsToken);
...
// Interface for $MEDALS.
contract IElleriumMedalERC20 {
