...
contract Bond is ReentrancyGuard{
    ...
    uint internal constant TOKEN_BONUS_PER_DAY = 2;  // 2%
    uint internal constant VEST_DURATION = 5;        // 5 days
    ...
    uint public startTime = 1683158400; // Thu May 04 2023 00:00:00 GMT+0000
    uint public endTime = startTime + 7 days;   // Thu May 11 2023 00:00:00 GMT+0000
    ...
    function buyBackAndBurn(Route[] calldata routes) external onlyBurnOnceTimePerDuration {
        ...
        AGI.transfer(address(0), _agiAmount);
    ...
    function getBondInfo(address user, uint index) public view returns(uint, uint, uint){
        ...
        return (earned, _userinfo.baseAmount, _userinfo.maxAmount);
    }
