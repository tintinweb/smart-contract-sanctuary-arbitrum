...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'46d910a922b68f6f384fb11db2e276c91a89484a8c9b820f13e117120b712432' // init code hash
            ))));
    }
...
contract MtcMain is Context, Ownable{
    ...
    function mintPower() payable public workstatus{
        ...
        TransferHelper.safeTransferFrom(mtcToken, address(this), pair, amountToken);
