...
import "./interfaces/FarmlandCharacter.sol";

contract Mercenaries is FarmlandCharacter {

    constructor ()
    ERC721A("Farmland Mercenaries", "MERCENARIES")
    {
        ...
        override
    {
        ...
        randomNumbers = getRandomNumbers(5);                                    // Return some random numbers
        CollectibleTraits storage collectibleTrait = collectibleTraits[id];     // Shortcut accessor to store Collectible traits on chain
        collectibleTrait.trait1 = (randomNumbers[0] % 80) + 15;                 // Stamina
        collectibleTrait.trait2 = (randomNumbers[1] % 80) + 15;                 // Strength
        collectibleTrait.trait3 = (randomNumbers[2] % 80) + 15;                 // Speed
        collectibleTrait.trait4 = (randomNumbers[3] % 80) + 15;                 // Courage
        collectibleTrait.trait5 = (randomNumbers[4] % 80) + 15;                 // Intelligence
    }
}
...
abstract contract FarmlandCharacter is ERC721AQueryable, Pausable, Ownable, ReentrancyGuard, Initializable {
...
// EVENTS
        ...
        whenNotPaused
    {
        ...
        _mint(_msgSender(), numTokens);                                                   // Mint the Collectibles
    }
...
// ADMIN FUNCTIONS
        ...
        onlyOwner
    {
       ...
       _mint (to, amount);           // Mint the collectibles 
    }
