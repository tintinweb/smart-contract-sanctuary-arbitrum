...
contract ERC721Facet is ERC721FacetInternal {
    ...
    function findImageBasedOnPlayerClass(PlayerSlotLib.Player memory player) internal pure returns (string memory) {
        string memory image;
        if (player.playerClass == 0) {
            if (player.male) {
                image = "https://ipfs.io/ipfs/QmV5pSsMGGMLW3Y9yQ8qSLSMDQakdnjhjS4k5he6mJyPeH";
            } else {
                image = "https://ipfs.io/ipfs/QmfBNHpxpwUNgtw6iXBxKXLbVxom8mpdBsgqZZy59pRM5C";
            }
        } else if (player.playerClass == 1) {
            if (player.male) {
                image = "https://ipfs.io/ipfs/QmQXeYe9rxRkkqfEB7DrZRSG2S1yrNgj64V8m6v7KetzQd";
            } else {
                // image = ERC721Storage.layout()._class1femaleImage;
                image = "https://ipfs.io/ipfs/QmUqZKRudnang1GXbD2nHHwmJfNNBFQVdmoH8WAneaii5h";
            }
        } else if (player.playerClass == 2) {
            if (player.male) {
                image = "https://ipfs.io/ipfs/QmUbWxUd8sX4MZojKERUPmPu9YtAYfYroBS4Te1HJEKucy";
            } else {
                image = "https://ipfs.io/ipfs/QmbVABt9sKpNUa8DgMJde3DBCQyorSCT9V1Dzd6cJ8ZUmP";
            }
        }
        return image;
    }
