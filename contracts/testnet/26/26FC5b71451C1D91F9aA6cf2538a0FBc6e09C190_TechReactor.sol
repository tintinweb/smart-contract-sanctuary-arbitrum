...
contract TechReactor is ERC721A, ReentrancyGuard, ManagerModifier {
  ...
  constructor(address _manager)
    ERC721A("TechnologicalReactor", "TECHNOLOGICAL_REACTOR")
  ...
  function burn(uint256 _tokenId) external nonReentrant {
    ...
    require(
      ...
      "TechReactor: You do not own this token"
    );
  ...
  IERC721Enumerable
{
  ...
  function _safeMint(
    ...
    return _mint(to, quantity, _data, true);
  }
