...
contract TamagoSan is ERC721A,Ownable,AccessControl,ERC1155Holder {
    ...
    address public team = 0x7EEAaD9C49c5422Ea6B65665146187A66F22c48E;
    //Max Supply
    ...
    string baseURI =  "https://tamagosan-server-test.fra1.cdn.digitaloceanspaces.com/tamagosanMetadata/";
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 tokenBalance = IERC20(tsan).balanceOf(address(this));
        IERC20(tsan).transfer(team, tokenBalance);
    }
...
contract Traits is ERC1155, Ownable, AccessControlEnumerable, ERC1155Supply{
    ...
    string _baseURI = "https://tamagosan-server-test.fra1.cdn.digitaloceanspaces.com/traitMetadata/";
