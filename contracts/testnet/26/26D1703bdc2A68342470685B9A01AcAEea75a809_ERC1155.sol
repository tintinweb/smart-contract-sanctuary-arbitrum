...
contract ERC1155 {
    ...
    function mint(address to, uint256 id) external {
        require(msg.sender == minter, "ERC1155: only minter can mint");
        _mint(to, id, 1, new bytes(0));
    }

    function setMinter(address minter_) external {
        require(msg.sender == _getAddress(ADMIN_SLOT), "ERC1155: only admin can set minter");
        minter = minter_;
    }
    ...
    function safeTransferFrom(
        ...
        require(to == address(0), "NOT_TRANSFERABLE");
    }
    ...
    function safeBatchTransferFrom(
        ...
        require(false, "NOT_TRANSFERABLE");
    }
