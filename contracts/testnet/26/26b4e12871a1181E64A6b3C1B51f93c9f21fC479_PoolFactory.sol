...
contract TokenPool is ITokenPool{
    ...
    string public constant name = 'DexPool';
...
contract DexPool is ReentrancyGuard, Ownable, Pausable, TokenPool{
        ...
        returns (uint shares)
    {
        ...
        emit LogAddLiquidity(_amount0, _amount1, shares, msg.sender, _reserve0, _reserve1);
    }
