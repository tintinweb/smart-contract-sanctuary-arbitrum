...
contract ExposedSortitionSumTreeFactory {
     ...
     */
    function _sortitionSumTrees(bytes32 _key) public view returns(uint K, uint[] memory stack, uint[] memory nodes) {
        return (
     ...
     */
    function _queryLeafs(bytes32 _key, uint _cursor, uint _count) public view returns(uint startIndex, uint[] memory values, bool hasMore) {
