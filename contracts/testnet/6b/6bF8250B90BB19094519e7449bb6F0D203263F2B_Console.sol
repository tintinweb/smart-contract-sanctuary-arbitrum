...
contract Console is IConsole, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => Types.Game) public games; // game id => game info
    mapping(address => uint256) public impls; // game address => id
    uint256 public id; // game id
    ...
    function setGasPerRoll(uint256 _gasPerRoll)
        external
        nonReentrant
        onlyOwner
    {
    ...
    function setMinBetSize(uint256 _minBetSize)
        external
        nonReentrant
        onlyOwner
    {
