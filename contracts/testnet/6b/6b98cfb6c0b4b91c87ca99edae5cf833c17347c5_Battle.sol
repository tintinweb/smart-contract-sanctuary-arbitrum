...
//			hirelingHouses[0] = uint8(uint(blockhash(block.number - 6)) % 4); // 0 - 3
			hirelingRarities[0] = 0; // 0 - 3
			hirelingHouses[0] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[1].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[1].id = ((uint(blockhash(block.number - 7)) % data.hirelingPool[hirelingRarities[0]][hirelingHouses[0]].length) * 10000) + (uint256(hirelingHouses[0]) * 100) + uint256(hirelingRarities[0]);
		}
...
//			hirelingHouses[1] = uint8(uint(blockhash(block.number - 9)) % 4); // 0 - 3
			hirelingRarities[1] = 0; // 0 - 3
			hirelingHouses[1] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[2].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[2].id = ((uint(blockhash(block.number - 10)) % data.hirelingPool[hirelingRarities[1]][hirelingHouses[1]].length) * 10000) + (uint256(hirelingHouses[1] * 100)) + uint256(hirelingRarities[1]);
		}
...
//			hirelingHouses[2] = uint8(uint(blockhash(block.number - 12)) % 4); // 0 - 3
			hirelingRarities[2] = 0; // 0 - 3
			hirelingHouses[2] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[3].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[3].id = ((uint(blockhash(block.number - 13)) % data.hirelingPool[hirelingRarities[2]][hirelingHouses[2]].length) * 10000) + (uint256(hirelingHouses[2] * 100)) + uint256(hirelingRarities[2]);
		}
...
//			hirelingHouses[3] = uint8(uint(blockhash(block.number - 15)) % 4); // 0 - 3
			hirelingRarities[3] = 0; // 0 - 3
			hirelingHouses[3] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[2].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[2].id = ((uint(blockhash(block.number - 16)) % data.hirelingPool[hirelingRarities[3]][hirelingHouses[3]].length) * 10000) + (uint256(hirelingHouses[3] * 100)) + uint256(hirelingRarities[3]);
		}
...
//			hirelingHouses[4] = uint8(uint(blockhash(block.number - 18)) % 4); // 0 - 3
			hirelingRarities[4] = 0; // 0 - 3
			hirelingHouses[4] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[3].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[3].id = ((uint(blockhash(block.number - 19)) % data.hirelingPool[hirelingRarities[4]][hirelingHouses[4]].length) * 10000) + (uint256(hirelingHouses[4] * 100)) + uint256(hirelingRarities[4]);
		}
...
//			hirelingHouses[5] = uint8(uint(blockhash(block.number - 21)) % 4); // 0 - 3
			hirelingRarities[5] = 0; // 0 - 3
			hirelingHouses[5] = 0; // 0 - 3
			data.nextBattleConfig[msg.sender].enemyCards[3].isCard = false;
			data.nextBattleConfig[msg.sender].enemyCards[3].id = ((uint(blockhash(block.number - 22)) % data.hirelingPool[hirelingRarities[5]][hirelingHouses[5]].length) * 10000) + (uint256(hirelingHouses[5] * 100)) + uint256(hirelingRarities[5]);
		}
