...
contract FlywheelEmissions is IFlywheelEmissions, Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setGFlyStaking(address gFlyStaking_) public onlyAdmin {
        require(gFlyStaking_ != address(0), "FlywheelEmissions:INVALID_ADDRESS");
        GFLY_STAKING = gFlyStaking_;
    }
