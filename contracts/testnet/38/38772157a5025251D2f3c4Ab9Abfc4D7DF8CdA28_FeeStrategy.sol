...
contract FeeStrategy is Access {
  ...
  uint256 public periodStartTime = block.timestamp - 5 minutes;
...
/**
 * 
 * @param _token address of the whitelisted token on the vault
 * @param _amount amount of given token
 * @notice function to dollar value calculation
 */
...
/**
 * 
 * @return _totalLoss total loss on the vault
 * @return _totalProfit total profit on the vault
 * @notice function to dollar value calculation of profit and loss
 */
 ...
 * @notice function computes wager fee in 1e4 and sets to vault
 */
 ...
 */
  function getPeriodIndex() public view returns (uint256 periodIndex) {
    periodIndex = (block.timestamp - periodStartTime) / 5 minutes;
  }
...
/**
 * @notice funcrtion to current multiplier calculation
 */
