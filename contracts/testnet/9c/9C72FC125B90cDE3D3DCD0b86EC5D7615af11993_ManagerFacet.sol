...
contract ManagerFacet is Calculator {
    ...
    event TerminateService(bytes32 indexed id, address indexed caller, address buyer, address seller, uint amount, uint remaining, uint fee);
    ...
    function _terminate(
        ...
        emit TerminateService(_id, msg.sender, service.buyer, service.seller, _amount, remaining, fee);
    }
