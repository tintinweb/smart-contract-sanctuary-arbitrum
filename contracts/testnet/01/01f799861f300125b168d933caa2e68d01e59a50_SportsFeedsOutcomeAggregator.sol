...
contract SportsFeedsOutcomeAggregator is ChainlinkClient {
    ...
    function updateRoundAnswer(uint32 _roundId, GameResolve[] memory games)
        internal
        returns (bool, GameResolve[] memory)
    {
        ...
        returns (GameResolve[] memory)
    {
        ...
        GameResolve[] memory games = new GameResolve[](count);
