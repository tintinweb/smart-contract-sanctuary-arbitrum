...
// Asset with minimal `CrossChainCanonicalBase` interface for testing
contract TestAlAsset is ERC20PermitUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function exchangeOldForCanonical(address bridgeTokenAddress, uint256 tokenAmount) external nonReentrant returns (uint256 canonicalTokensOut) {
    ...
    function exchangeCanonicalForOld(address bridgeTokenAddress, uint256 tokenAmount) external nonReentrant returns (uint256 bridgeTokensOut) {
