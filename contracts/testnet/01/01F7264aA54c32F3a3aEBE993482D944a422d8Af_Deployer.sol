...
contract Deployer{
    ...
    function deployToken(string memory _name, string memory _symbol, uint256 _totalSupply, uint16 _decimal) public payable{
        ...
        require(feeAddress != address(0), "Fee address musst be not null");
    ...
    function listingToken(address _contractAddress) public payable{
        ...
        contracts[msg.sender].push(ContractItem(_contractAddress, 1, block.timestamp));
    }
}