...
// File: contracts/governance/governor/IUpt.sol
...
// File: contracts/governance/governor/Structs.sol
...
// File: contracts/governance/governor/GovernorStorage.sol
...
contract GovernorJohnnyDelegatorStorage {
  /// @notice Active brains of Governor
  address public implementation;
}

/**
 * @title Storage for Governor Johnny Delegate
 * @notice For future upgrades, do not change GovernorJohnnyDelegateStorage. Create a new
 * contract which implements GovernorJohnnyDelegateStorage and following the naming convention
 * GovernorJohnnyDelegateStorageVX.
 */
//solhint-disable-next-line max-states-count
contract GovernorJohnnyDelegateStorage is GovernorJohnnyDelegatorStorage {
  ...
  /// @notice The address of the Uplend Protocol governance token
  IUpt public upt;
...
// File: contracts/governance/governor/IGovernor.sol
...
interface IGovernorJohnnyDelegator {
...
interface IGovernorJohnnyDelegate {
  function initialize(
    address upt_,
...
interface GovernorJohnnyEvents {
...
// File: contracts/governance/governor/GovernorDelegator.sol
...
contract GovernorJohnnyDelegator is GovernorJohnnyDelegatorStorage, GovernorJohnnyEvents, IGovernorJohnnyDelegator {
  constructor(
    address upt_,
