...
//        require(msg.sender == tx.origin, "The minter is another contract");
    ...
    function mint(uint256 count, string memory qrCodeText) public payable returns (uint256) {
...
//        emit QRCodeURIGenerated(QRCodeURI);
    ...
    returns (string memory)
    {
        ...
        DynamicBuffer.appendSafe(svgBytes, '<svg viewBox="0 0 296 296" style="shape-rendering:crispEdges" xmlns="http://www.w3.org/2000/svg"><style>.bg{fill:#FFF}.fg{fill:#000}</style><rect class="bg" x="0" y="0" width="296" height="296"></rect>');
