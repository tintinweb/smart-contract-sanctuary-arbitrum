...
contract Loot8Marketplace is ILoot8Marketplace, Initializable, DAOAccessControlled {
    ...
    function initialize(
        ...
        PRIVATE_TRADE_NOT_ALLOWED = 11;
        PUBLIC_TRADE_NOT_ALLOWED = 12;
        INVALID_VALIDATION_SIGNATURE = 13;
        VALIDATION_SIGNATURE_EXPIRED = 14;
        NOT_A_PASSPORT = 15;
        COLLECTION_NOT_LINKED = 16;
        PASSPORT_NEEDED = 17;
        PASSPORT_NOT_OWNED = 18;
    ...
    function checkItemValidity(address _passport, address _collection) public view {
    ...
    function checkTraderEligibility(address _patron, address _passport, address _collection, ListingType _listingType) public view {
        ...
        if(_listingType == ListingType.PUBLIC) {
            ...
            ICollectionManager _collectionManager = ICollectionManager(collectionManager);
            if(_collectionManager.getCollectionChainId(_passport) == block.chainid) {
