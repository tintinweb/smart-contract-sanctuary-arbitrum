...
/// @notice Binary merkle distributor
contract BinaryReferral is Ownable, ReentrancyGuard {
    ...
    constructor(address _signer, address _underlyingToken) {
        signer = _signer;
    ...
    function claim(
        ...
        if (allocation > claimedAmount[msg.sender]) {
            ...
            if (availableAmount != 0) {
                ...
                _transferToken(msg.sender, underlyingToken, availableAmount);
