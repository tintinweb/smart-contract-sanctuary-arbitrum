...
abstract contract KeeperRegistryBase is ConfirmedOwner, ExecutionPrevention, ReentrancyGuard, Pausable {
  ...
  uint256 public s_paymentPremiumPPB;
  ...
  function _calculatePaymentAmount(
    ...
    s_paymentPremiumPPB = store.paymentPremiumPPB;
    s_premium = premium;
...
interface MigratableKeeperRegistryInterfaceDev {
  /**
   ...
   */
  function upkeepTranscoderVersion() external returns (UpkeepFormatDev version);
}
