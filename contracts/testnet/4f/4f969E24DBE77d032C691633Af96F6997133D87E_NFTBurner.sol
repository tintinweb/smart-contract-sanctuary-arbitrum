...
contract NFTBurner is Ownable, Pausable {
    ...
    constructor() {
        ...
        bribingPortion = 13;        // value/100 * portion
        teamPortion = 2;            // value/100 * portion
    ...
    function burnMultipleNFTs(address _nftContract, uint256[] memory _tokenIds) public whenNotPaused {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            bribingAmount += amount * bribingPortion / 100;
            teamAmount += amount * teamPortion / 100;
    ...
    function getCollectionData() public view returns (address[] memory _whitelistedContracts){
       
        return whitelistedContracts;
    }   

    function getCollectionData_byte() public view returns (bytes memory){

        return abi.encode(whitelistedContracts);
    }
