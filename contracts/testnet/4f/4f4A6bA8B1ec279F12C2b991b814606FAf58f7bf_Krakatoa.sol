...
abstract contract Additional is OwnableUpgradeable {
    ...
    /**
     * @dev Initialize commission of the contract to a new value.
     * Can only be called by the current admin.
     */
    function initCommission(uint16 commission_) public onlyOwner {
    ...
    function changeRefundFeeWallet(address newRefundFeeWallet) public onlyOwner {
...
contract Krakatoa is Initializable, OwnableUpgradeable, Additional, EIP712Upgradeable {
