...
contract OrderFacet is Calculator {
    ...
    event OneTimePayment(bytes32 indexed id, address payer, address receiver, address token, uint amount, uint fee);
    ...
    function settle(bytes32 _id, address _token, address _payer, address _receiver) external {
        ...
        emit OneTimePayment(_id, _payer, _receiver, _token, amount, fee);
    }
