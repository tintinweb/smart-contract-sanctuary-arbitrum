...
contract FuturXVoucher is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function claim(
        ...
        return _claim(_voucherId, _to, _voucherType, _value, _maxDiscountValue);
    }

    function claimAll(ClaimRequest[] memory requests) external {
    ...
    function _claim(
        ...
        uint256 _value,
        uint256 _maxDiscountValue
    ) private returns (Voucher memory, uint256) {
        if (_voucherType == 1) {
