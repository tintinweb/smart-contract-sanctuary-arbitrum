...
contract AovUnbind is ManagerModifier, ReentrancyGuard, Pausable {
  //=======================================
  // Immutables
  //=======================================
  ...
  // Events
  //=======================================
  event Unbound(address addr, uint256 id);
  ...
  function unbind(
    ...
    // Check ETH
    require(msg.value == price * total, "AovUnbind: Not enough ETH");
    ...
    for (uint256 j = 0; j < total; j++) {
      ...
      require(
        ...
        "AovUnbind: You do not own Adventurer"
      );

      // Unbind
      BOUND.unbind(addr, adventurerId);

      emit Unbound(addr, adventurerId);
    }
  }
