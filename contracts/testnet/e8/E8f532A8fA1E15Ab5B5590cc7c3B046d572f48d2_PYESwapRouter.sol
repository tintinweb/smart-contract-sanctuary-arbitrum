...
// !!!!!!!!!
    ...
    function swapTokensForExactTokens(
        ...
        uint totalFee;
        if(path[0] == pairFeeAddress[pair]) {
            // uint256 sFee = 10000 - swapFee - adminFee;
...
library PYESwapLibrary {
    ...
    address private constant factory = 0x594092eeC29e5c2C84eD521A0bDD3f742bBC9b39;
    ...
    function getAmountsOut(
        ...
        for (uint i; i < path.length - 1; i++) {
            ...
            uint lpFee = IFeeStore(address(this)).pairFeeAddress(address(pair)) == path[i + 1] ? 17 : 0;
    ...
    function pairFor(address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                hex'e37364b2523440f5e4ac3b985de35b30a94fab7bb2b3fdd72a64b771e7eb528a' // init code hash
            )))));
    }
    ...
    function getAmountOut(
        ...
        uint denominator = (reserveIn * 10000) + swapFeeAdjuster;
