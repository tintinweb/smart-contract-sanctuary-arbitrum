...
contract ArbotICOStable is Ownable, ReentrancyGuard {
    IERC20 public token;
    IERC20 public usdc;

    uint256 public constant RATE = 33333333333333333; // USD to token rate
    uint256 public constant HARD_CAP = 186000e6; // 186,000 USDC
    uint256 public constant MIN_CONTRIBUTION = 200e6; // 200 USDC
    uint256 public constant MAX_CONTRIBUTION = 2000e6; // 2,000 USDC
    ...
    function buyTokens(address beneficiary, uint256 usdcAmount) public nonReentrant {
        ...
        uint256 tokens = usdcAmount * RATE;
    ...
    function claimTokens() public nonReentrant {
        ...
        uint256 tokens = contributedUsdc * RATE;
