...
contract MlpManager is ReentrancyGuard, Governable, IMlpManager {
    ...
    function _addLiquidity(address _fundingAccount, address _account, address _token, uint256 _amount, uint256 _minUsdm, uint256 _minMlp) private returns (uint256) {
    ...
    function _removeLiquidity(address _account, address _tokenOut, uint256 _mlpAmount, uint256 _minOut, address _receiver) private returns (uint256) {
