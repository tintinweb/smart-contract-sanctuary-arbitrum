...
contract AccruPresale is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        publicSale1MinPurchase = 5555555;
    ...
    function verifyPublicSale1Purchase(
        ...
        if (
            purchasedAmount >= publicSale1MinPurchase && 
            purchasedAmount + amount <= maxPurchase
        ) {
            return true;
        }
        return (amount >= publicSale1MinPurchase && amount <= maxPurchase);
    }
    ...
    function verifyPublicSale2Purchase(
        ...
        if (
            purchasedAmount >= publicSale2MinPurchase && 
            purchasedAmount + amount <= maxPurchase
        ) {
            return true;
        }

        return (amount >= publicSale2MinPurchase && amount <= maxPurchase);
    }
