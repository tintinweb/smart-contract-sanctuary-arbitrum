...
contract IFOInitializable is IIFO, ReentrancyGuard, Ownable {
     ...
     * @dev This function is only callable by admin.
     */
    function updateStartAndEndBlocks(uint256 _startTime, uint256 _endTime) external onlyOwner {
        require(_endTime < (block.timestamp + MAX_BUFFER_TIME), "Operations: EndTime too far");
        require(block.timestamp < startTime, "Operations: IFO has started");
