...
contract PalMinterL2 is PalMinter {
    ArbSys constant arbsys = ArbSys(address(100));
    address public l1Contract;

    constructor(address _genesisToken, address _palToken, address _treasury, address _daoWallet, uint256 _treasuryPercentage, address _l1Contract) 
        PalMinter(_genesisToken, _palToken, _treasury, _daoWallet, _treasuryPercentage) {
