...
//        emit QRCodeURIGenerated(QRCodeURI);
    ...
    {
        string
        memory QRCodeURI = '<svg viewBox="0 0 296 296" style="shape-rendering:crispEdges" xmlns="http://www.w3.org/2000/svg"><style>.bg{fill:#FCF}.fg{fill:#000}</style><rect class="bg" x="0" y="0" width="296" height="296"></rect>';
