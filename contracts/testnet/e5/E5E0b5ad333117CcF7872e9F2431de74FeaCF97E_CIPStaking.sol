...
contract CIPStaking is Ownable{
    ...
    uint public ROI_PERCENT_ANNUALY = 144; 
    uint256 public ROI_PERCENT_PERDAY = ROI_PERCENT_ANNUALY/365; 
    uint256 public ROI_PERCENT_HOUR = ROI_PERCENT_PERDAY/24; 
    uint256 public ROI_PERCENT_MINUTE = ROI_PERCENT_HOUR/60; 
    uint256 public ROI_PERCENT_SECOND = ROI_PERCENT_MINUTE/60; 
    ...
    uint[20] public first_self_business_required = [20000,20000,20000,20000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000,24000];
    ...
    uint[4] public rank_mercury = [20,100000,40000,10000];
    uint[4] public rank_venus = [25,240000,0,0];
    uint[4] public rank_earth = [30,600000,0,0];
    uint[4] public rank_mars = [40,1500000,140000,24000];
    uint[4] public rank_jupiter = [45,4000000,0,40000];
    uint[4] public rank_sun = [50,10000000,0,60000];
    ...
    function _systemSetting(uint256 _MIN_STAKE_AMOUNT,uint256 _MIN_WITHDRAWAL_AMOUNT,uint _ROI_PERCENT_ANNUALY) onlyOwner public {
        ...
        ROI_PERCENT_PERDAY = ROI_PERCENT_ANNUALY/365; 
        ROI_PERCENT_HOUR = ROI_PERCENT_PERDAY/24; 
        ROI_PERCENT_MINUTE = ROI_PERCENT_HOUR/60; 
        ROI_PERCENT_SECOND = ROI_PERCENT_MINUTE/60; 
    }
    ...
    function _arbiVerified(address payable _user,uint256 _amount) onlyOwner public {
