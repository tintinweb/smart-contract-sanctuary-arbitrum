    ...
    ERC20PermitUpgradeable
{
    ...
    IAxelarGateway public _gateway;
    IAxelarGasService public _gasService;
    ...
    function initialize(
        ...
        __EIP712_init("Axelar USDM", "1");
        __ERC20_init("Axelar USDM", "axlUSDM"); // Set token name and symbol
        __ERC20Permit_init("Axelar USDM"); // Initialize ERC20Permit with the token name
    ...
    function _tryGetAssetDecimals(
        ...
        (bool success, bytes memory encodedDecimals) = asset_.staticcall(
    ...
    function updateRewardMultiplier(
        ...
        bytes memory payload = abi.encode(_asset.rewardMultiplier());
        _gasService.payNativeGasForContractCall{value: msg.value}(
            address(this),
            destinationChain,
