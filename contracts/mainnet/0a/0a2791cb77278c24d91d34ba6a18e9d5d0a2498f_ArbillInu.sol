...
/**
Arbill Inu First Dollar Bill On Arbitrum Chain.
Arbill Inu will initially launch as a meme token. Nevertheless, as our community grows we would start to implement utilities to benefit our loyal holders. 
Arbill Inu plans on building the strongest community in the DeFi ecosystem by constantly giving back to holders.
🐦  https://twitter.com/ArbillInu
☎️  https://t.me/arbillinu
🌐  http://arbillinu.website/
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8); //USDC Rewards considered
    DEXRouter router;
...
contract ArbillInu is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Arbill Inu";
    string constant public symbol = "ArbillInu";
    ...
    bool public tradingOpen = false; //Change to True at launch
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x420783c84186831eF72E571d079f774F5F1e2DB4;
