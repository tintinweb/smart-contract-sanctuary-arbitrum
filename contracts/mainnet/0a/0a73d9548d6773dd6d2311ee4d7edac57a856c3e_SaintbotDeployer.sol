...
contract SaintbotDeployer is Ownable {
    ...
    {
        require(msg.value > 0.2 ether, "ETH liquidity need to be bigger than 0.02");
...
contract ModelERC20V2 is Context, IERC20 {
    ...
    uint256 public constant _maxTxAmount = 4_000_000 * 10 ** _decimals;
    uint256 public constant _maxWalletSize = 4_000_000 * 10 ** _decimals;
