...
contract DemoSwap {
    // Sourced from: https://github.com/Uniswap/v3-periphery/blob/697c2474757ea89fec12a4e6db16a574fe259610/deploys.md?plain=1#L12
    ...
    uint24 public constant poolFee = 3000; // (1/100 of bips) 3000 bips = 30% / 100 = 0.3%
