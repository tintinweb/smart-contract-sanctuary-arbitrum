...
contract GasThrottler {
    ...
    address public gasprice = address(0xb4fC05E083890BfB68A5da59F26C89c3499dA49A);
...
contract TsuFeeBatch is Ownable, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wbnb = address(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
    address constant public bifi = address(0x3A3207B4a33a93fA84ac9b04440A05E6d029A1dB);
    ...
    uint constant public REWARD_POOL_FEE = 700;
