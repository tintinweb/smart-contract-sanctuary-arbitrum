 ...
 */
abstract contract AccessManaged_0 is Context, IAccessManaged {
...
// lib/ipor-fusion/node_modules/@openzeppelin/contracts/access/manager/AccessManaged.sol
 ...
 * functions, and ideally only used in `external` functions. See {restricted}.
 */
abstract contract AccessManaged_1 is Context, IAccessManaged {
    address private _authority;
...
abstract contract PlasmaVaultGovernance is AccessManaged_0 {
    constructor(address accessManager_) AccessManaged_0(accessManager_) {}
...
// lib/ipor-fusion/contracts/managers/RewardsClaimManager.sol

contract RewardsClaimManager is AccessManaged_1, IRewardsClaimManager {
    ...
    constructor(address initialAuthority_, address plasmaVault_) AccessManaged_1(initialAuthority_) {
