    ...
    ReentrancyGuardUpgradeable
{
    ...
    // ========== CONTRACT UPGRADE FOR GETTING LIQUID MAGIC FOR HARVESTERS ======= //

    uint256 public allowedForHarvestersDeploy;
    ...
    function withdrawLiquidAmountForMigration(uint256 amount) external override onlyOwner {
        ...
        require(
            allowedForHarvestersDeploy >= amount,
    ...
    /**
     * @dev
     * Sets the amount allowed to be withdrawn and to deploy in Harvesters
     */
    function setAllowedForHarvestersDeploy(uint256 amount) external override onlyOwner {
        allowedForHarvestersDeploy = amount;
    }
