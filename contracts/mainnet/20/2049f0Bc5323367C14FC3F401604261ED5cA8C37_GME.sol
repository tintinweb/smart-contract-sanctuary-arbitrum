...
// File: contracts/convert/GME.sol
    ...
    AccessControlEnumerable
{
    ...
    constructor()
        ERC20("Gemstone", "GME")
        ERC20Capped(200000000 ether)
        ERC20Permit("Gemstone")
    {
    ...
    function pause() public virtual {
        require(
            ...
            "GME: pause must have pauser role"
        );
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "GME: unpause must have pauser role"
        );
    ...
    function mint(address account, uint256 amount) public {
        require(
            ...
            "GME: mint must have minter role"
        );
