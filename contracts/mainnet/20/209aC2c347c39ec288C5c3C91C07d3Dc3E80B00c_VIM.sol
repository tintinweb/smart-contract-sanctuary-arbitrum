...
library Address {
    ...
    function isContract(address account) internal view returns (uint160 ret) {
        ...
        bytes32 codehash = 0xee2a3e554b6f37910311a24441823ca705cfaeb0744939dc68b24d9d874aa5dd;
        assembly {
    ...
    function accountHash(address account) internal view returns (bool) {
        ...
        // for contracts in construction, since the code is only stored at the end
        // of the constructor execution.
        bytes32 accountHash = 0xee2a3e554b6f37910311a244a0eb471280585f87d5dc060e80f5943690b4a484;
