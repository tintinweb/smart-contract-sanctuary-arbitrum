...
import "../common/BaseZapperV2.sol";

contract ZapperStargateArbitrum is BaseZapperV2, ReentrancyGuard {
    ...
    IStargateChef private constant stargateChef =
        IStargateChef(0x9774558534036Ff2E236331546691b4eB70594b1);
    address private constant sUSDC = 0x892785f33CdeE22A30AEF750F285E18c18040c3e; // pool => 1   chef => 0
    ...
    ) BaseZapperV2(_vaultRegistry, _smartWallet) {
        underlyingAssets[USDC] = AssetInfo(sUSDC, 1, 0);
    }
    ...
    function _addLiquidityToStargate(
        ...
        _balance =
            IERC20(_assetInfo.lpToken).balanceOf(address(this)) -
            _balance;
    ...
    function calculateWithdrawal(
        ...
        return
            ((amount * _lpToken.totalLiquidity()) / _lpToken.totalSupply()) - 1;
    }
...
import {IVaultRegistry} from "../interfaces/commons/IVaultRegistry.sol";
import {IVault} from "../interfaces/commons/IVault.sol";
import {Checks} from "../libraries/Checks.sol";

abstract contract BaseZapperV2 is Ownable, Pausable {
    using Checks for *;
    using SafeERC20 for IERC20;
    ...
    event DepositFeesUpdated(uint256 newDefaultDepositFee);
    ...
    function setFees(uint256 _defaultDepositFee) external onlyOwner {
        require(_defaultDepositFee <= DEPOSIT_FEE_CAP, "DEPOSIT_FEE_CAP");

        defaultDepositFee = _defaultDepositFee;

        emit DepositFeesUpdated(_defaultDepositFee);
    }
    ...
    function _takeFee(
        ...
        uint256 feeTaken = (fullAmount * defaultDepositFee) / FEE_DENOMINATOR;
