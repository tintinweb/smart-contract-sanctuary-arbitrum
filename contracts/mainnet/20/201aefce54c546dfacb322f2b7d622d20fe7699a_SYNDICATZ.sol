...
/*
    ...
    THE SYNDICATZ LIVE IN A SECRET UNDERGROUND CYBERCITY SLUM, CALLED LOS KITTOWN.
    DUE TO OVERPOPULATION AND POLLUTION ISSUES, THEY WERE CONSIDERED PERSTS
    AND ALMOST DECIMATED…
    
    Website:      https://syndicatz.io/

    TOKENOMICS:
    * FIRST 2 MINUTES: 40,000,000,000 max buy (40M)
...
contract SYNDICATZ is ERC20, Ownable {
    ...
    constructor() ERC20("Syndicatz", "SYNDICAT") {
        ...
        maxTransactionAmount = 400_000_000 * 1e18; 
        maxWallet = 800_000_000 * 1e18; 
		...
		charityWallet = address(0x4Db314622e01E9a15C11a5113642548FB93Ec5Bb); 
        marketingWallet = address(0x4Db314622e01E9a15C11a5113642548FB93Ec5Bb); 
        devWallet = address(0x4Db314622e01E9a15C11a5113642548FB93Ec5Bb); 
