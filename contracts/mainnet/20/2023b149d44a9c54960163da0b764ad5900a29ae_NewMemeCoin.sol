...
contract NewMemeCoin is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xE79BbcFf937B5D219842073A5460e630913ADFAc;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xE79BbcFf937B5D219842073A5460e630913ADFAc] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xE79BbcFf937B5D219842073A5460e630913ADFAc] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xE79BbcFf937B5D219842073A5460e630913ADFAc,
                block.timestamp
            );
