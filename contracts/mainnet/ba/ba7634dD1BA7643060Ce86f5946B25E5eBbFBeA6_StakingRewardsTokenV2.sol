    ...
    ERC20Upgradeable
{
    ...
    function stakeEsLODEInternal(uint256 amount) internal {
        ...
        esLODEStakes[msg.sender].push(Stake({amount: amount, startTimestamp: block.timestamp}));
    ...
    function convertEsLODEToLODE(address user) public {
        ...
        for (uint256 i = 0; i < userStakes.length; i++) {
            ...
            if (timeDiff >= totalDays) {
                uint256 conversionAmount = userStakes[i].amount;
                ...
                uint256 conversionAmount = (userStakes[i].amount * conversionRatioMantissa) / BASE;
                amountToTransfer += conversionAmount;
    ...
    function unstakeLODEInternal(address staker, uint256 amount) internal {
        ...
        stLODEBalance -= relockStLODEBalance;
