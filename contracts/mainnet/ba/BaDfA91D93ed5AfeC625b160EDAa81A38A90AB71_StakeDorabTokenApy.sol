...
import "./IStakeDorabTokenApy.sol";

contract StakeDorabTokenApy is IStakeDorabTokenApy, Ownable {
    ...
    constructor() {
        initStakeDorabTokenApy();
    }

    /**
     * @dev init stake apr for each NFT ID
     */
    function initStakeDorabTokenApy() internal {
        startTime[0] = [0];
        endTime[0] = [0];
        poolApy[0] = [8000];
        startTime[1] = [0];
     ...
     */
    function setStakeDorabTokenApy(uint256 _poolId, uint256 _apy) external override onlyOwner {
    ...
    function setStakeDorabTokenApyExactly(uint256 _poolId, uint256[] calldata _startTime, uint256[] calldata _endTime, uint256[] calldata _apy) external override onlyOwner {
