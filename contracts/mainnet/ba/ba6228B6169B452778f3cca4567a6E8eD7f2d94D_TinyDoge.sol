...
contract TinyDoge is Ownable, ERC721, NonblockingReceiver {
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "TinyDoge: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "TinyDoge: Failed to withdraw funds");
    }
