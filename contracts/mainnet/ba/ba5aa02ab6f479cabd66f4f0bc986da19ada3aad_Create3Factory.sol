...
abstract contract Initializable {
    ...
    function _getInitializedVersion() internal view returns (uint64) {
        return __getInitializableStorage()._initialized;
    }
    ...
    function _isInitializing() internal view returns (bool) {
        return __getInitializableStorage()._initializing;
    }
     ...
     */
    // solhint-disable-next-line var-name-mixedcase
    function __getInitializableStorage() private pure returns (InitializableStorage storage $) {
        assembly {
...
import { IERC1822Proxiable } from "../interfaces/IERC1822.sol";
...
abstract contract UUPSUpgradeable is IERC1822Proxiable {
    ...
    function _checkProxy() internal view virtual {
        if (
            address(this) == __self // Must be called through delegatecall
                || ERC1967Utils._getImplementation() != __self // Must be called through an active proxy
        ) {
     ...
     */
    function __upgradeToAndCallUUPS(address newImplementation, bytes memory data) private {
        try IERC1822Proxiable(newImplementation).proxiableUUID() returns (bytes32 slot) {
            if (slot != ERC1967Utils.IMPLEMENTATION_SLOT) {
                revert UUPSUnsupportedProxiableUUID(slot);
            }
            ERC1967Utils._upgradeToAndCall(newImplementation, data);
        } catch {
...
library ERC1967Utils {
    ...
    function __setImplementation(address newImplementation) private {
        ...
        StorageSlot._getAddressSlot(IMPLEMENTATION_SLOT).value = newImplementation;
    }
    ...
    function _getAdmin() internal view returns (address) {
        return StorageSlot._getAddressSlot(ADMIN_SLOT).value;
    }
    ...
    function __setAdmin(address newAdmin) private {
        ...
        StorageSlot._getAddressSlot(ADMIN_SLOT).value = newAdmin;
    }
    ...
    function _getBeacon() internal view returns (address) {
        return StorageSlot._getAddressSlot(BEACON_SLOT).value;
    }
    ...
    function __setBeacon(address newBeacon) private {
        ...
        StorageSlot._getAddressSlot(BEACON_SLOT).value = newBeacon;
     ...
     */
    function __checkNonPayable() private {
        if (msg.value > 0) {
 ...
 *
 *     function __getImplementation() internal view returns (address) {
 *         return StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value;
 *     }
 *
 *     function __setImplementation(address newImplementation) internal {
...
library StorageSlot {
     ...
     */
    function _getStringSlot(bytes32 slot) internal pure returns (StringSlot storage r) {
        /// @solidity memory-safe-assembly
        assembly {
            r.slot := slot
        }
     ...
     */
    function _getStringSlot(string storage store) internal pure returns (StringSlot storage r) {
        /// @solidity memory-safe-assembly
        assembly {
            r.slot := store.slot
        }
     ...
     */
    function _getBytesSlot(bytes32 slot) internal pure returns (BytesSlot storage r) {
        /// @solidity memory-safe-assembly
        assembly {
            r.slot := slot
        }
     ...
     */
    function _getBytesSlot(bytes storage store) internal pure returns (BytesSlot storage r) {
        /// @solidity memory-safe-assembly
        assembly {
            r.slot := store.slot
        }
