...
contract HarryPotterObamaSonic10Inu is ERC20, Ownable {
    ...
    constructor() ERC20("HarryPotterObamaSonic10Inu", "ARB") {
        ...
        uint256 totalSupply = 694_200_000_000 * 1e18; // 420.000.000.000 Total Supply
        ...
        marketingWallet = address(0xae4DfcE9CFdE295086508740B34E6519D2023017); // set as marketing wallet
        devWallet = address(0xae4DfcE9CFdE295086508740B34E6519D2023017); // set as dev wallet
