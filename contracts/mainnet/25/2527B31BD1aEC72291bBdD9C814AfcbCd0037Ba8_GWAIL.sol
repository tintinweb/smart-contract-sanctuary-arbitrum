...
/* GWAIL PROTOCOL | THE FIRST CROSS CHAIN REFLECTIONS PROJECT UTILISING 6 CHAINS

TG: https://t.me/GWAILprotocol
Twitter: https://twitter.com/GWAILprotocol
Website: https://GWAILprotocol.com
Docs: https://docs.GWAILprotocol.com
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // sushiswap router on arbitrum - 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0x3d9907F9a368ad0a51Be60f7Da3b97cf940982D8)); // 
...
contract GWAIL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Camelot", "GWAIL") {
        ...
        rewardsBuyFee = 3;
        MarketingBuyFee = 21;
        DevelopmentBuyFee = 21;
        liquidityBuyFee = 1;
        totalBuyFees = rewardsBuyFee + MarketingBuyFee + DevelopmentBuyFee + liquidityBuyFee;
        
        rewardsSellFee = 3;
        MarketingSellFee = 21;
        DevelopmentSellFee = 21;
        liquiditySellFee = 1;
        totalSellFees = rewardsSellFee + MarketingSellFee + DevelopmentSellFee + liquiditySellFee;
    ...
    function updateBuyFees(uint256 _MarketingFee, uint256 _DevelopmentFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        MarketingBuyFee = _MarketingFee;
        DevelopmentBuyFee = _DevelopmentFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        totalBuyFees = MarketingBuyFee + DevelopmentBuyFee + rewardsBuyFee + liquidityBuyFee;
        require(totalBuyFees <= 400, "Must keep fees at 25% or less");
    }
    
    function updateSellFees(uint256 _MarketingFee, uint256 _DevelopmentFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        MarketingSellFee = _MarketingFee;
        DevelopmentSellFee = _DevelopmentFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        totalSellFees = MarketingSellFee + DevelopmentSellFee + rewardsSellFee + liquiditySellFee;
    ...
    function updateDevelopmentWallet(address newDevelopmentWallet) external onlyOwner {
        require(newDevelopmentWallet != address(0), "may not set to 0 address");
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on buy
                ...
                tokensForDevelopment += fees * DevelopmentBuyFee / totalBuyFees;
            }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForDevelopment + tokensForRewards;
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDevelopment - ethForRewards;
