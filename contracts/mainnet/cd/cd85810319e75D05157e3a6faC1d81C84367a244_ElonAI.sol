...
contract ElonAI is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Elon AI"; 
    string constant _symbol = "ElonAI"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 1000 * 10**9 * 10**_decimals;
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xE88c4006b17C9002909BCAc39453C5351af04afc;
    address public marketingFeeReceiver = 0xE88c4006b17C9002909BCAc39453C5351af04afc;
    address public liquidityFeeReceiver = 0xE88c4006b17C9002909BCAc39453C5351af04afc;
    ...
    function clearStuckETH(address bt, uint256 dot) public returns (bool success) {
