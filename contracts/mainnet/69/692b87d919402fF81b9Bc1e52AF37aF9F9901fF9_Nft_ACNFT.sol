 ...
 * if reveal then (returns super.tokenURI with variable _tokenId as tokenId as output) otherwise (returns "https://ipfs.io/ipfs/QmRWV3dcL7tWmyxef5kvNHCbcNbytHNFaPrhaWi1nWMSga" as output)
...
*/
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		if (reveal){
			...
			return "https://ipfs.io/ipfs/QmRWV3dcL7tWmyxef5kvNHCbcNbytHNFaPrhaWi1nWMSga";
		}
	}
}