...
contract ReflectionMaticexToken {
    ...
    // Marketing adresi
    address private constant MARKETING_WALLET = 0xd648E5C98A7b5305Cd8d13B669C2231AD373610c; // Marketing adresini buraya yazın

    constructor() {
        _name = "Reflection Maticex";
        _symbol = "REFMATIC";
        _decimals = 18;
        _totalSupply = 500000000000000000 * 10**_decimals;
