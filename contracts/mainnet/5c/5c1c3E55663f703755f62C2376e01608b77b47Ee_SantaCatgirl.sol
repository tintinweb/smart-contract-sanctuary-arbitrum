...
(   ). '.   | /  | |  | |  | |   | | | |  | /  | |   |  | ___  | /  | |  | | | |  | |  | |  | |   | |         | |  
 | |  `\ |  ; |  ; |  | |  | |   | ' | |  ; |  ; |   |  '(   ) ; |  ; |  | ' | |  | '  | |  | |   | |         | |  
 ; '._,' '  ' `-'  |  | |  | |   ' `-' ;  ' `-'  |   '  `-' |  ' `-'  |  ' `-' ;  '  `-' |  | |   | |         | |  
  '.___.'   `.__.'_. (___)(___)   `.__.   `.__.'_.    `.__,'   `.__.'_.   `.__.    `.__. | (___) (___)       (___) 
                                                                                   ( `-' ;                         
                                                                                   `.__.       


Tokenomics:
3% Stuffs the liquidity!
1% Spreads the Christmas cheer!

t.me/ArbiSantaCatgirl
santacatgirl.io
twitter.com/Santa_Cat_Girl
...
contract SantaCatgirl is ERC20, Ownable {
    ...
    constructor() ERC20("Santa Catgirl", "SCG") {
        ...
        uint256 _buySantaFee = 1;
        uint256 _buyLiquidityFee = 2;

        uint256 _sellSantaFee = 1;
        ...
        santaWallet = address(0xF9D2348AD7d0ba4Ac0a63B0AE44957F423E1F709); // set as Santa wallet
