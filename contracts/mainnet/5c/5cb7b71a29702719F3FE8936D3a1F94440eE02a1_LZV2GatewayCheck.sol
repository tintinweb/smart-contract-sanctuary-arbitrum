    ...
    IVariableBalanceRecords
{
    ...
    event DataReceived(uint256 sourceChainId, uint256 actionId);
    ...
    function handleExecutionPayload(
        ...
        emit DataReceived(_messageSourceChainId, data.actionId);
    }
...
abstract contract SystemVersionId {
     ...
     */
    uint256 public constant SYSTEM_VERSION_ID = uint256(keccak256('LZV2GatewayCheck-2024-06-06-Open')); // TODO
}