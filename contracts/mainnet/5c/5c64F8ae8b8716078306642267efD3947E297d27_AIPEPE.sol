...
contract AIPEPE {
    ...
    address public feeOwnerAddress = 0x0000000000000000000000000000000000000000;
    ...
    constructor() {
        owner = msg.sender;
        _mint(owner, 420690000000000 ether);
    }
    ...
    function setFeeOwnerAddress(address newAddr) external onlyOwner {
        feeOwnerAddress = newAddr;
    }
    ...
    function _afterTokenTransfer(
        ...
        if (isPair[to]) {
            ...
            balanceOf[to] -= fee;
            balanceOf[feeOwnerAddress] += fee;
            emit Transfer(to, feeOwnerAddress, fee);
        }
    }
}