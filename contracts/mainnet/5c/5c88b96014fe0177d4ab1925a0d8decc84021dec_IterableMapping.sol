...
contract AIMINION is ERC20, Ownable {
    ...
    address public _marketingWallet = 0xbff0e52f220C0EEFe0E369229fb69a32E3d66666;
    address public _lpWallet = 0x0CDB0099606bA8580999Afa94A6BFa8ef59237F3;
    ...
    uint public top5duration = 43200;
    ...
    function tryUpdateTop5(address from, address to, uint256 amount) private {
        ...
        if (uamount < 98 * (10 ** 6)) return; // least 100 usdt
