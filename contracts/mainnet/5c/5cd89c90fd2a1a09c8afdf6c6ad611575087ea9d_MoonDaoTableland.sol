...
contract MoonDaoTableland is ERC721Holder, Ownable {
    ...
    function insertIntoTable(uint256 id, string memory name, string memory bio, string memory image, string memory twitter, string memory website, string memory _view) external {
        TablelandDeployments.get().mutate(
            ...
            SQLHelpers.toInsert(
                _TABLE_PREFIX,
                _tableId,
                "id,name,bio,image,twitter,website,view",
                string.concat(
    ...
    function updateTable(uint256 id, string memory name, string memory bio, string memory image, string memory twitter, string memory website, string memory _view) external {
