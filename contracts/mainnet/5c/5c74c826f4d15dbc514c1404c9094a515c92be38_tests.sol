...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RewardToken = ERC20(0x796a4503b444A71b331c9556bEF0815237ddEaBC);
    ...
    uint256 public minDistribution = 0 * (10 ** 18);
...
contract tests is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "test";
    string constant _symbol = unicode"test";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address RewardToken = 0x796a4503b444A71b331c9556bEF0815237ddEaBC; 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xaFE8587Da4e16976Fcd7F29961f893C7eFC57096;
        marketingWallet = 0xaFE8587Da4e16976Fcd7F29961f893C7eFC57096;
        devWallet = 0xaFE8587Da4e16976Fcd7F29961f893C7eFC57096;
    ...
    function launch(bool newStatus) public onlyOwner {
