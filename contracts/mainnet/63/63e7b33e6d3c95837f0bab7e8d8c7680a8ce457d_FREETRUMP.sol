...
Nikkish 1st contract Emulated  ---------[FREETRUMP]----------

TRUMP POWER

Please dont buy before understand this product, only for alpha, cheers.
...
contract FREETRUMP is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7F0e5249f7e596DFeBaeE964dFa97c4cc6D40703;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "FREETRUMP";
    string constant _symbol = "FTRP";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7F0e5249f7e596DFeBaeE964dFa97c4cc6D40703;
