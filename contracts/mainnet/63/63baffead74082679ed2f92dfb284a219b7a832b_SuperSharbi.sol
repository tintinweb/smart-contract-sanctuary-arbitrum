...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public USDC = IBEP20(0xaa54e84A3e6e5A80288d2C2f8e36eA5cA3A3Ca30);
...
/* Token contract */
contract SuperSharbi is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address USDC = 0xaa54e84A3e6e5A80288d2C2f8e36eA5cA3A3Ca30; 
    address WETH = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    ...
    // Name and symbol
    string constant _name = "SuperSharbi";
    string constant _symbol = "$SSHarbi";
    ...
    uint256 devFeeBuy = 50;
    uint256 reflectionFeeBuy = 750;
    uint256 marketingFeeBuy = 100;
    uint256 totalFeeBuy = 1000;      

    // Sell fees
    uint256 liquidityFeeSell = 100;
    uint256 devFeeSell = 50;
    uint256 reflectionFeeSell = 750;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa3D6A6B8d8F20A2627c48F4c20C799502D64B2Eb;
        devFeeReceiver = 0x72aAFF8A66965CF16E0099b7fF60c61F5cc18521;
