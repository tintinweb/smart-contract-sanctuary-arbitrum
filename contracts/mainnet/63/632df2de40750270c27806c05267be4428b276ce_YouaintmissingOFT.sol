...
// You aint missing shit in market 
// Only AI runs thats a sep story and this aint a real bull run 
// Seeing btc climb to new ath doesnt equate to an alt season 
// Btc needs to stablize n go sideways which it wont anytime soon for altseason to start
// And that is gonna be a mini one 
// After that markets gonna heavily correct
// If you even think about the bullrun and our Maia DAO Ecosystem V2 time frame wise we are in a much better position Inu
...
contract YouaintmissingOFT is OFTCore, ERC20, IOFT {
    constructor(
        string memory _name,
