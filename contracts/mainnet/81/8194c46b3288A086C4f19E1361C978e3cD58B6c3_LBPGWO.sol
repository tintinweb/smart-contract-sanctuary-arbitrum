...
contract LBPGWO is Context, Ownable, IERC20 {
    ...
    uint256 constant public buyfee = 1_000;
    uint256 constant public sellfee = 1_000;
    ...
    constructor () {
        ...
        balance[msg.sender] = _totalSupply * 35 / 100;
        emit Transfer(address(0), msg.sender, _totalSupply * 35 / 100);
