/**
 *Submitted for verification at Arbiscan on 2022-09-19
*/

// SPDX-License-Identifier: BUSL-1.1
// Sources flattened with hardhat v2.11.1 https://hardhat.org

// File contracts/yieldspace-tv/src/Math64x64.sol
...
// File contracts/yieldspace-tv/src/Exp64x64.sol
...
// File contracts/yieldspace-tv/src/YieldMath.sol
...
// File contracts/yieldspace-tv/src/Pool/PoolEvents.sol
...
// File contracts/yieldspace-tv/src/Pool/PoolErrors.sol
...
// File contracts/yieldspace-tv/src/interfaces/IMaturingToken.sol
...
// File contracts/yieldspace-tv/src/interfaces/IPool.sol
...
// File contracts/yieldspace-tv/src/interfaces/IERC4626.sol
...
// File @yield-protocol/utils-v2/contracts/utils/[email protected]
...
// File contracts/yieldspace-tv/src/Pool/PoolImports.sol


pragma solidity >=0.8.15;


// File contracts/yieldspace-tv/src/Pool/Pool.sol
...
contract Pool is PoolEvents, IPool, ERC20Permit, AccessControl {
    ...
    using MinimalTransferHelper for IERC20Metadata;
    ...
    /// are cast as "IERC20Metadata" and when that 4626 functionality is needed, they are recast as IERC4626.
    /// This wei, modules for non-4626 compliant base tokens can import this contract and override 4626 specific fn's.
    IERC20Metadata public immutable sharesToken;
        ...
        )
    {
        ...
        // Set sharesToken.
        sharesToken = IERC20Metadata(sharesToken_);

        // Cache baseToken to save loads of SLOADs.
        IERC20Metadata baseToken_ = _getBaseAsset(sharesToken_);
    ...
    function _approveSharesToken(IERC20Metadata baseToken_, address sharesToken_) internal virtual {
    ...
    /// We use the IERC20Metadata interface, but this should be an ERC20 asset per EIP4626.
    function _getBaseAsset(address sharesToken_) internal virtual returns (IERC20Metadata) {
        return IERC20Metadata(address(IERC4626(sharesToken_).asset()));
    }
    ...
    */
    ...
    function base() external view returns (IERC20) {
        // Returns IERC20 instead of IERC20Metadata (IERC20Metadata) for backwards compatability.
        return IERC20(address(baseToken));
    }
}


// File contracts/yieldspace-tv/src/Pool/Modules/PoolNonTv.sol
...
contract PoolNonTv is Pool {
    ...
    function _approveSharesToken(IERC20Metadata baseToken_, address sharesToken_) internal virtual override {}

    /// This is used by the constructor to set the base token as immutable.
    /// For Non-tokenized vaults, the base is the same as the base asset.
    function _getBaseAsset(address sharesToken_) internal virtual override returns (IERC20Metadata) {
        return IERC20Metadata(sharesToken_);
    }
