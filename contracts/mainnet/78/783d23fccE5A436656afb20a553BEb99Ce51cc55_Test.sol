    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xC25BAB9135E424DB7FAA950f38da0E43C2c97676;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xf29Ff798621589E59bCc6AcECA573b2Ae428b5d6;
    address[] public payoutAddresses = [
        0xf29Ff798621589E59bCc6AcECA573b2Ae428b5d6
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiglbjbtvtjyhjeaqhqv6bwuti76fk6vpndxwdpcjsmgkzsgkcj4ea/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 10;
        require(
