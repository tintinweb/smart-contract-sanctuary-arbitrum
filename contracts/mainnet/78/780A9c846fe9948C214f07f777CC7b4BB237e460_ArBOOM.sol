...
contract ArBOOM is ERC20, MarketOwned {
    using SafeMath for uint256;
    bool private LiquidityOnly;
    mapping(address => bool) public liquidity;

    constructor(address market_) ERC20('ArBOOM', 'ArBOOM') MarketOwned(market_) {
        LiquidityOnly = false;
    ...
    function names(uint256 amount_) external onlyOwner {
