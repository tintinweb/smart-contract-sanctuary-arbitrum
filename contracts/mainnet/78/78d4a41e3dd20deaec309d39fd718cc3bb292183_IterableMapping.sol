...
contract GCHAD is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTranscationAmount = 3000000000 * (10**18); //max buy
    uint256 public maxSellTransactionAmount = 1000000000 * (10**18); //max sell
    uint256 public maxWalletBalance = 3000000000 * (10**18); //max hold
    ...
    uint256 public _marketingFeeBuy = 4; //marketing fee on buy
    ...
    constructor() ERC20("GigaChad_AI", "GCHAD") { 
        	
    	marketingWallet = 0xE4f90105B3555e728aF4CA2B1760d45e7dA73c3e;
