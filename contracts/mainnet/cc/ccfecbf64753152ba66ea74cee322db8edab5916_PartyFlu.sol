...
/*
 * 
 * Website: https://partyflu.com
 * Telegram: https://t.me/PartyFluPortal
 * Twitter: https://twitter.com/partyflusick                                                                                                             
                                                                    ....                                                                    
                                                                   .......                                                                  
                                                        ..         ........                                                                 
                                          ...          .....       ........                                                                 
                                  ...
                                  .........''''''''''''''..................';:ccccccccc::;;;.                                               
                                    ....................................',;:;;:clllcccc::;;;,'..                                            
                                      .............................'',;;:::::::ccclcc:::;;;;;;;,'..                                         
                                       .......................'',,,;;::ccccccccc::::::;;;;;;;,,,,,'..                                       
                                        .....','.'',;;:,'',,,,,;;;::ccccccllodddolcccc::::::::;:::;;,.                                      
                                          .'clc:cccccc:;;,,,;;;:::cllc:::,,;lkXNNKxdxkkOOx:''...;okkxc.                                     
                                         .,cllccllcccc:;,,;;:lddxk00l. .'..,..lXWK0NWWWW0;  . .. .lXWNo.                                    
                                        .;llllllllcccc::::;;:ldOKXNx.   ..'c,.'lxodO0KKKo.    .'. .oOd'                                     
                                       .;ooollllllcccc::::::;;;;:cl:....,,,,;;:cccccclll:,'''.''',''..                                      
                                       'coodddolllcccc:::::::::;;;;;::cclllllloooooollccc:::::::;'.                                         
                                      .:llllodddoolllcccccllooddxxkkOO000KKKKKKKKKKK00Okkxddol:,.                                           
                                     .,cllllllodk0000OOOOO000KKKKKXXXXXXXXXXXXXXXXXXXKKKK000OOkdl'                                          
                                     .:lllllllloOXXKXXKKK0000000000KKKKKKKKKKKXXXXKKKK000OOOkkkkko.                                         
                                     .clllllllloOXXKKK0000OOO00000KKKKKKKKKKKKKKKKKKKK000OOkkkkxxd;.                                        
                                     'clllllllld0XKKKKK000000000KKKKKKKK0000000000000OOOOOOkkxxxddo'                                        
                                     'clllllllld0XKKKKK0000OOOOO00000000000000000K00000OOOOkxdooooo:.                                       
                                     'cllllllllxKK00000OOOOOOOOO000KKKKKKKKKKKKKKKKK000OOkkkxddddooc.                                       
                                     .:llllllldk0OOOOO00OOOOkOOOOO0000000000000000000OOOOkkkkxxdddo:.                                       
                                      'cllllodkkkkOO0000OOkkkkOOOO00000000000OOOOOOOOkkkkkkkxdddo;..                                        
                                      .;oxxkOOOOO000000OOOOOOOOOOOOOOOOOOOOOkkkkkkkxxxxxxdddolll;.                                          
                                       .:oxOKXXKKK000OOkkkxxxxdddddxxxxxkkkkkOOOkkkkxxdoc:;,'...                                            
                                         .':oxkO00OOOkkkxxxdddoodddddxxxxxxxxxxxdol:,'...                                                   
                                            ..';clloooooolllllloooooollllllooolc,.                                                          
                                                ....'''',,,,,,,,,,,,,,,,,,,,,'..                                                                                                                                                                                             
 */
...
contract PartyFlu is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1; // WETH
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Party Flu";
    string constant _symbol = "SICK";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100; 
    uint256 public _minTransferForReferral = 1 * (10 ** _decimals); // must!
    ...
    uint256 liquidityFee = 10; // get it juicing
    uint256 devFee = 0;
    uint256 marketingFee = 10;
    uint256 referralFee = 4; // referral fee = 4% of buy in native sick
    uint256 public minSupplyForReferralReward = (_totalSupply * 5) / 1000;
    address private marketingFeeReceiver = 0x6071Fbf7c77493015341165A55760d6210F1AFB2; // deployer
    address private devFeeReceiver = 0x6071Fbf7c77493015341165A55760d6210F1AFB2; // deployer, doesn't receive
    bool public swapEnabled = true; // never able to stop
    uint256 public swapThreshold = _totalSupply / 1000 * 3; // 0.3% set
    IDEXRouter public router;
    address public pair;
    bool inSwap; // no reentrant
    ...
    constructor () Auth(msg.sender) { // auth set owner to msg.sender
        router = IDEXRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // Sushi
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;
        address _owner = owner; // owner is owner from auth
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender == pair) { //buy
            if(!isFeeExempt[recipient]) {
                require(isReferred[recipient],"Not sick");
