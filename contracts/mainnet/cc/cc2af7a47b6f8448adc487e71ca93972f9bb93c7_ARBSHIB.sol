...
///██║░░██║██║░░██║██████╦╝██████╔╝██║░░██║██║██████╦╝███████╗
///╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═════╝░╚═╝░░╚═╝╚═╝╚═════╝░╚══════╝
//* TELEGRAM :  https://t.me/arbshibeinu
// WEBSITE : http://www.arbshibeinu.site/
...
contract ARBSHIB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Arbshibe Inu";
    string constant _symbol = "ARBSHIB";
    ...
    uint256 public _maxTxAmount = 2000 * 10**4 * (10 ** _decimals);
    uint256 public _walletMax = 20000 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6Bc4D3Be631c68aEaab266C8Ce318aA30B18bE43;
        marketingWallet = 0x6Bc4D3Be631c68aEaab266C8Ce318aA30B18bE43;
        devWallet = 0x6Bc4D3Be631c68aEaab266C8Ce318aA30B18bE43;
