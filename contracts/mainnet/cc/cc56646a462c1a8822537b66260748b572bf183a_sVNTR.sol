...
contract sVNTR is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("Staked TVNTR", "sTVNTR", 9) ERC20Permit() {
  ...
  /**
        @notice increases sVNTR supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sVNTR
