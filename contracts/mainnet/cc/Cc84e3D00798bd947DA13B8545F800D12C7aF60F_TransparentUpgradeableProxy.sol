 ...
 *
 *  Contributors:
 *   -   543#3017 (Sam), ftm.guru, Eliteness.network & Equalizer.exchange
 *
 *
...
contract ProxyAdmin is Ownable {
    ...
    event Deployed(address indexed implementation, address indexed admin, address _proxy, bytes data);
