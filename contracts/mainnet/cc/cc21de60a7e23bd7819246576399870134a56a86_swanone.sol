...
contract swanone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SwanOne";

    string private _symbol = "$SWONE";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x0627FcaF76d7B39Ff221D09b98eB122082a62Cd1;
