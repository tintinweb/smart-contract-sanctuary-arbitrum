...
contract FixeArt is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 max_supply = 500;

    string public baseURI = "ipfs://bafybeigfsnrx6p7whgvl4ujx57aiqgzm7yty2qjuvemaoa6vft75y44tji/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("Fixe Art V2", "FIXEART") {
    }
