...
contract DEX is ERC20Base {
    ...
    function addLiquidity(uint256 _amount) public payable returns (uint256) {
        ...
        if (tokenReserve == 0) {
            ...
            require(
                ...
                "Amount of tokens sent is less than minimum"
            );
    ...
    function removeLiquidity(uint256 _amount) public returns (uint256, uint256) {
        ...
        uint256 liquidityBalance = balanceOf(msg.sender);
        require(liquidityBalance >= _amount, "Insufficient liquidity balance");
    ...
    function swapTokenToEth(uint256 _tokenSold) public {
        ...
        uint ethBought = getAmountOfTokens(_tokenSold, address(this).balance, _reservedTokens);
