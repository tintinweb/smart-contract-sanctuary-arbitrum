...
// File src/optimism/lib/safe-math.sol
...
// File src/optimism/lib/context.sol
// License-Identifier: MIT
...
// File src/optimism/lib/erc20.sol
...
// File src/optimism/interfaces/univ3/pool/IUniswapV3PoolImmutables.sol
...
// File src/optimism/interfaces/univ3/pool/IUniswapV3PoolDerivedState.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/interfaces/univ3/pool/IUniswapV3PoolActions.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/interfaces/univ3/IUniswapV3Pool.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/lib/univ3/FullMath.sol
// License-Identifier: MIT
...
// File src/optimism/lib/univ3/FixedPoint96.sol
// License-Identifier: GPL-2.0-or-later
...
// File src/optimism/lib/univ3/LiquidityAmounts.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/lib/univ3/TickMath.sol
// License-Identifier: GPL-2.0-or-later
...
// File src/optimism/lib/univ3/PositionKey.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/lib/univ3/LowGasSafeMath.sol
// License-Identifier: GPL-2.0-or-later
...
// File src/optimism/lib/univ3/SafeCast.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/lib/univ3/UnsafeMath.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;
...
// File src/optimism/lib/univ3/SqrtPriceMath.sol
...
// File src/optimism/lib/univ3/PoolVariables.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0 <0.8.0;
...
// File src/optimism/lib/univ3/PoolActions.sol
...
// File src/optimism/interfaces/uniswapv2.sol
// License-Identifier: MIT
...
// File src/optimism/interfaces/univ3/IERC165.sol
// License-Identifier: MIT
...
// File src/optimism/interfaces/univ3/IERC721.sol
// License-Identifier: MIT
...
// File src/optimism/interfaces/univ3/IUniswapV3PositionsNFT.sol
// License-Identifier: GPL-2.0-or-later
pragma solidity >=0.6.12;
...
// File src/optimism/interfaces/univ3/ISwapRouter.sol
// License-Identifier: MIT
...
// File src/optimism/interfaces/controllerv2.sol
// License-Identifier: MIT
pragma solidity >=0.6.12;
...
// File src/strategies/arbitrum/strategy-univ3-rebalance.sol
// License-Identifier: MIT
pragma solidity >=0.6.12;
    ...
    function _distributePerformanceFees(uint256 _amount0, uint256 _amount1) internal {
        if (_amount0 > 0) {
            ...
            if (tokenToNativeRoutes[address(token0)].length > 0) {
                _token0ToTreasury = _swapUniV3WithPath(
                    address(token0),
        ...
        if (_amount1 > 0) {
            ...
            if (tokenToNativeRoutes[address(token1)].length > 0) {
                _token1ToTreasury = _swapUniV3WithPath(
                    address(token1),
...
// File src/strategies/arbitrum/uniswapv3/strategy-univ3-eth-usdc-lp.sol
// License-Identifier: MIT
pragma solidity ^0.6.12;
