...
contract HolyGrail is SafeOwnable {
    ...
    function buyAll(address _for) external {
        require(shouldSnipe(), "HolyGrail: missed");
        ...
        require(grailClaimable >= ((_balance * 1E18) / 10 ** IERC20Metadata(USDC).decimals()) / 35, "HolyGrail: grail");
        require(xgrailClaimable >= ((_balance * 1E18) / 10 ** IERC20Metadata(USDC).decimals()) / 65, "HolyGrail: xgrail");
    }
