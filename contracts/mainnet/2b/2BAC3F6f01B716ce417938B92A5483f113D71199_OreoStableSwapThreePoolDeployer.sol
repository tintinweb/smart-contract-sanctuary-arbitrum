...
import "./OreoStableSwapThreePool.sol";

contract OreoStableSwapThreePoolDeployer is Ownable {
  ...
  function createSwapPair(
    ...
    bytes memory bytecode = type(OreoStableSwapThreePool).creationCode;
    ...
    OreoStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
...
contract OreoStableSwapThreePool is Ownable, ReentrancyGuard {
  ...
  IOreoStableSwapLP public token;
