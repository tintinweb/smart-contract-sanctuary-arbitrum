...
contract DininhoFunWorldHouses is ERC721AQueryable, ERC721ABurnable, Ownable {
    uint public maxSupply = 50;

    string private _contractUri;
    string private _baseUri;

    mapping(address => uint[]) public bids; // armazena indice no array bids

    constructor() ERC721A("Dininho Fun World Houses", "DFWH") {
    }
