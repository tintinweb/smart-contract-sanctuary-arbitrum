...
contract JAKANT is OFT, ERC20Votes {
    IJAKANTMasterDistributor private JAKANTMasterDistributor;
     ...
     * - Sets the `JAKANTRoleManager` by casting the `_JAKANTRoleManager` address to the
     *   IJAKANTRoleManager interface, which is expected to manage role-based access in the contract.
     * - Sets the `JAKANTMasterDistributor` by casting the `_JAKANTMasterDistributor` address to the
     ...
     * @param _JAKANTMasterDistributor Address of the contract managing token distributions.
     */
    constructor(
        string memory _name,
        string memory _symbol,
        ...
        address _lzEndpoint,
        address _JAKANTMasterDistributor,
        address _owner
        ...
        JAKANTMasterDistributor = IJAKANTMasterDistributor(
            _JAKANTMasterDistributor
        );
     ...
     * accounts that have been granted distributor privileges by the JAKANTRoleManager. The
     * `isDistributor` function of the JAKANTRoleManager is used to check if the caller (_msgSender())
    ...
    function mint(address account, uint256 amount) external virtual {
        JAKANTMasterDistributor.mintAllowed(_msgSender());
     ...
     *
     * The function includes an additional security feature using the `JAKANTRoleManager` to check
    ...
    function approve(
        ...
        JAKANTMasterDistributor.approveAllowed(_msgSender(), _spender);
     ...
     * - Calls `JAKANTRoleManager.transferAllowed` to perform custom checks based on the contract's
    ...
    function transfer(
        ...
        JAKANTMasterDistributor.transferAllowed(
            _msgSender(),
            _to,
            _msgSender()
        );
     ...
     * - Calls `JAKANTRoleManager.transferAllowed` to perform custom validation. This could involve
    ...
    function transferFrom(
        ...
        address spender = _msgSender();
        JAKANTMasterDistributor.transferAllowed(_from, _to, spender);
     ...
     * based on the current burn rate as determined by the `JAKANTMasterDistributor.getBurnAmount`
     ...
     *
     * The function performs the following operations:
     * - Calls `getBurnAmount` from `JAKANTMasterDistributor` to determine the amount of tokens that
    ...
    function _burnOnTransfer(
        ...
        uint256 burnAmount = JAKANTMasterDistributor.getBurnAmount(
            _sender,
            _amount
        );
