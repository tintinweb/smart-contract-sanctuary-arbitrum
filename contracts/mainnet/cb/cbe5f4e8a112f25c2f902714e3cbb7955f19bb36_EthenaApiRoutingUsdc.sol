...
contract EthenaApiRoutingUsdc is EthenaPowerFarm {
    ...
    // @TODO - get rid of ternary, parameter base
    // for example, pass these to PowerFarmNFTs as constructor arg and then
    // read here
    constructor(
    ...
    SendValueHelper
{
    ...
    IUniswapV2Pool public immutable UNISWAP_V2_POOL;
    IUniswapV3PoolPowerFarm public immutable UNISWAP_V3_POOL;
