...
contract Water is ERC20, Ownable {
    ...
    address WATER_MARKETING = 0xf5a21293FCbE7F27683777C37c69B1C1c42114e7; // To be used for actual marketing
    ...
    mapping(address => bool) public blacklist; //to blacklist rogue pools
    ...
    function initialize(
        ...
        _mint(address(this), maxSupply / 4);
