...
contract UsdeOracle {
    ...
    int192 constant PRECISION_FACTOR_E10 = 1E10;
        ...
        returns (int256)
    {
        ...
        (
            ...
            ,
            ,
        ) = pythOracle.latestRoundData();

        return answerUsde
            * int256(PRECISION_FACTOR_E18)
            / ethUsdAnswer;
    }
        ...
        )
    {
        (
            ...
            updatedAt,
            answeredInRound
        ) = pythOracle.getRoundData(_roundId);
    }
    ...
    function maxAnswer()
        ...
        returns (int192)
    {
        int256 ethUsdAnswer = int256(ethUsdFeed.latestAnswer());
        int256 result = int256(pythOracle.maxAnswer())
            * int256(PRECISION_FACTOR_E18)
            / ethUsdAnswer;
    ...
    {
        int256 ethUsdAnswer = int256(ethUsdFeed.latestAnswer());
        int256 result = int256(pythOracle.minAnswer())
            * int256(PRECISION_FACTOR_E18)
            / ethUsdAnswer;
