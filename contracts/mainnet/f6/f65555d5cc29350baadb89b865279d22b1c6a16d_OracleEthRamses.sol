...
/**
 * @title OracleEthRamses contract.
 * @notice An oracle for a token that uses Ramses pool's TWAP to price it. On of the tokens in the pool must be
 *         WETH.
 */
contract OracleEthRamses is Ownable, IOracle {
    ...
    /**
     * @notice Deploy the OracleEthRamses contract.
     * @param _pool Ramses Pool contract address.
     * @param _weth WETH contract address.
     * @param _twapPeriod TWAP period (in seconds) that will be used to price the token.
     */
    constructor(address _pool, address _weth, uint32 _twapPeriod) Ownable(msg.sender) {
