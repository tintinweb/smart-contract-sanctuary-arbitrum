...
contract When is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap =
        0xa49aA9F038F41c1007f64268c94bD98485b2ca46;
    ...
    constructor() {
        ...
        _isExcludedFromFee[
            address(0x6c70B78B0a44864E1072EDC437AE5f5253c9dee1)
        ] = true;
        _isExcludedFromFee[
            address(0x3b3892827994D9bE5c6185DbE0109DAc81A300e2)
        ] = true;
        _isExcludedFromFee[
            address(0xa49aA9F038F41c1007f64268c94bD98485b2ca46)
        ] = true;
