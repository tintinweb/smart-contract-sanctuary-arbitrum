...
import { Peer } from "contracts/bridge/dependencies/DataStructures.sol";
...
contract BridgeToken is OFT, ERC20FlashMint {
    ...
    function setPeer(uint32 _eid, bytes32 _peer) public override {
        require(msg.sender == CORE_OWNER.owner() || msg.sender == CORE_OWNER.bridgeRelay());
        _setPeer(_eid, _peer);
    }
...
import { IOFT, OFTCore } from "contracts/oft/OFTCore.sol";
...
import { OApp, Origin } from "contracts/oapp/OApp.sol";
...
import { IOFT, SendParam, OFTLimit, OFTReceipt, OFTFeeDetail, MessagingReceipt, MessagingFee } from "contracts/oft/interfaces/IOFT.sol";
...
import { OAppSender, MessagingFee, MessagingReceipt } from "contracts/oapp/OAppSender.sol";
// @dev Import the 'Origin' so it's exposed to OApp implementers
// solhint-disable-next-line no-unused-import
import { OAppReceiver, Origin } from "contracts/oapp/OAppReceiver.sol";
...
import { IOAppReceiver, Origin } from "contracts/oapp/interfaces/IOAppReceiver.sol";
import { OAppCore } from "contracts/oapp/OAppCore.sol";
...
import { ILayerZeroReceiver, Origin } from "contracts/interfaces/ILayerZeroReceiver.sol";
...
import { Ownable } from "contracts/access/Ownable.sol";
import { IOAppOptionsType3, EnforcedOptionParam } from "contracts/oapp/interfaces/IOAppOptionsType3.sol";
...
import { Ownable } from "contracts/access/Ownable.sol";
import { IPreCrime } from "contracts/precrime/interfaces/IPreCrime.sol";
import { IOAppPreCrimeSimulator, InboundPacket, Origin } from "contracts/precrime/interfaces/IOAppPreCrimeSimulator.sol";
...
// solhint-disable-next-line no-unused-import
import { InboundPacket, Origin } from "contracts/precrime/libs/Packet.sol";
...
import { MessagingFee } from "contracts/interfaces/ILayerZeroEndpointV2.sol";
import { IMessageLib } from "contracts/interfaces/IMessageLib.sol";
