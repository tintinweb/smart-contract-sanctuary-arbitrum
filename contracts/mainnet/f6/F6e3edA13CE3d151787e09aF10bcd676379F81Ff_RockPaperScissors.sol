...
contract RockPaperScissors {
    ...
    function createGame(uint256 _player1Move, uint256 _player1Bet) public payable {
        require(msg.value == _player1Bet, "Invalid bet amount");
