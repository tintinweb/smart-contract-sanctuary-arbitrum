...
contract ArbHouse_ARX is VRFConsumerBaseV2, Ownable, ReentrancyGuard {

	// ARX on ARB Mainnet ===============================================================
    using SafeERC20 for IERC20;
	address private constant TOKEN_ADDRESS = 0xD5954c3084a1cCd70B4dA011E67760B8e78aeE84;
    ...
    */
    ...
    uint64 private s_subscriptionId = 4;
    ...
    uint16 requestConfirmations = 1; // Minimum is 1 on ARB
    uint32 numWords = 1;
	...
	// Minimum Bet & Deposit=============================================================
	uint256 minBet = 1; // Technically no minimum bet
    ...
    uint256 minDeposit = 100000000000000; // default 0.0001 ARX
	...
	uint256 betTax = 100000000000000000; // default 0.1%
	...
	uint256 vrfFee= 50000000000000; // default 0.00005 ETH ~0.09 Cents.
