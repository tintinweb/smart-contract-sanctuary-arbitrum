...
Arbinoots is community based Meme Nft project on #Arbitrum chain.
Twitter : https://twitter.com/arbinoots
...
contract Arbinoots is ERC20, Ownable {
    ...
    constructor() ERC20("Arbinoots", "$NOOTS") {
        ...
        marketingWallet = address(0x7c7cAd9200D3B7b1A2C31EF0f97168ACdf8693a9); // set as marketing wallet
        devWallet = address(0x7c7cAd9200D3B7b1A2C31EF0f97168ACdf8693a9); // set as dev wallet
