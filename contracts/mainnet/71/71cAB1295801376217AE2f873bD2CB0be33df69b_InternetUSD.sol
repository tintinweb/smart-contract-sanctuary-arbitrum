...
contract InternetUSD is ERC20, BoringOwnable {
    using BoringMath for uint256;
    // ERC20 'variables'
    string public constant symbol = "IUSD";
    string public constant name = "Internet USD";
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require(to != address(0), "IUSD: no mint to zero address");

        // Replace later with convergence function
    ...
    function burn(uint256 amount) public {
        require(amount <= balanceOf[msg.sender], "IUSD: not enough");
