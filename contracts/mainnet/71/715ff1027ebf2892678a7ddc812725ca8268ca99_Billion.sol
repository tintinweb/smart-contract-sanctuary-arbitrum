...
contract Billion is Context, IERC20, Ownable{
    ...
    string private _name = "ARBILLIONAIRE";
    string private _symbol = "$BILLION";
    ...
    constructor () {
        ...
        EnableOptimization = payable(address(0x747602c7596Ed2b42aF805400872E73731804838));
