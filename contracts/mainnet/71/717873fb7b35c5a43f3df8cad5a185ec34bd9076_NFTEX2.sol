...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v3.4/contracts/token/ERC721/ERC721Holder.sol
...
contract NFTEX2 is ERC721Holder, Ownable {
...
//    require(true, "Token not in whitelist");
//    }
   
    require (whitelisted[_token], "Token not in whitelist");
  ...
  function bid(bytes32 _order) payable external {
    ...
    if (block.number > endBlock - 150) {  //20blocks = 5 mins in Etherium.
