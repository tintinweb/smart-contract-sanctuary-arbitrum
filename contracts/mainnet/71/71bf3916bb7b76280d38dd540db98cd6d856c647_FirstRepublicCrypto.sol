...
// File: contracts/FRCInitMintable.sol
...
contract FRCInitMintable is ERC20("FirstRepublicCrypto", "FRC"), Ownable {
    ...
    uint256 private SUPPLY_PER_YEAR;
    uint256 private SUPPLY_PER_BLOCK;
    ...
    function distributeSupply(
        ...
        require(block.timestamp >= nextDistributionTimestamp, "FRCInitMintable: Not ready");
        require(_teamAddresses.length == _teamAmounts.length, "FRCInitMintable: Array length mismatch");
...
// File: contracts/FirstRepublicCryptoToken.sol
...
contract FirstRepublicCrypto is FRCInitMintable {

    constructor (
        uint256 _supplyPerYear
    ) FRCInitMintable(_supplyPerYear) public {}
