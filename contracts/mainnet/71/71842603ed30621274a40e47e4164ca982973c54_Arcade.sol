...
contract Arcade is Ownable {
    ...
    address public protocolPayoutWallet =
        0x3f2ff81DA0B5E957ba78A0C4Ad3272cB7d214e71; //this is my arcade payout wallet on metamask (update this!)
    address public gameDevPayoutWallet =
        0x3f2ff81DA0B5E957ba78A0C4Ad3272cB7d214e71; //this is my arcade payout wallet on metamask (update this to be the game developer!)
    bool public hasWhitelist = false;
    ...
    function buyArcadeTokens(uint256 _numTokens)
        public
        payable
    ...
    function changeLeaderboardName(string memory _name) public onlyOwner {
