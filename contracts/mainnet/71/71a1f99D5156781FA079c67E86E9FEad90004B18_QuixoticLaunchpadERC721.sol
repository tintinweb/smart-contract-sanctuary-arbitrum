...
contract QuixoticLaunchpadERC721 is ERC721("Pulchritudinous NFT", "Pulchri"), ERC721Enumerable, Ownable, ReentrancyGuard {

    string private _baseURIextended;
    string private _baseURISuffix = "";
    bool public frozenMetadata = false;
    uint256 public MAX_TOKENS = 876;
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 8, "Exceeded max token purchase");
