...
contract CVIIncentivesARBAirdrop is Ownable {

    IERC20 public token;

    event TokenDistributed(string indexed name, address[] addresses, uint256[] amounts);
     ...
     */
    function distribute(string calldata name, address[] calldata addresses, uint256[] calldata amounts) public onlyOwner {
        ...
        emit TokenDistributed(name, addresses, amounts);
    }
}
