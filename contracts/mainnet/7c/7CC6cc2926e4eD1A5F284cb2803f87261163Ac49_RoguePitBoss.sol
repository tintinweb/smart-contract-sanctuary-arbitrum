...
contract RoguePitBoss is ERC721Royalty, VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    function updateDayAndPrice() external {
        currentDay = ((block.timestamp - startDate) + 60) / 60; // change to 3600 to test
        currentPrice = startPrice + ((currentDay - 1) * 100000000000000);// 0.0001, add extra 2 zero to make it 0.01
