...
contract LShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accTSharePerShare; // Accumulated LSHAREs per share, times 1e18. See below.
    ...
    uint256 public tSharePerSecond = 0.00158332066 ether; // 100000 LSHARE / (731 days * 24h * 60min * 60s)
    ...
    // Safe LSHARE transfer function, just in case if rounding error causes pool to not have enough tSHAREs.
