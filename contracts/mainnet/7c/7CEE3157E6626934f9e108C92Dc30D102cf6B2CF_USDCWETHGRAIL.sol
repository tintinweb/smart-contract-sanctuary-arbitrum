...
interface IUniswapV2Router02 is IGrailRouter {
...
// File: CoreStrategyAaveGrail.sol
...
abstract contract CoreStrategyAaveGrail is BaseStrategy {
        ...
        BaseStrategy(_vault)
    {
        ...
        router = IGrailRouter(_config.router);
...
contract USDCWETHGRAIL is CoreStrategyAaveGrail {
    ...
    function _pendingRewards() internal view returns (uint256) {
        // return
        //     IMiniChefV2(farmMasterChef)
        //         .pendingSushi(farmPid, address(this))
