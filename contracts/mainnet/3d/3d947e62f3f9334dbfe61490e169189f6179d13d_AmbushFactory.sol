...
/**
 *AMBUSH is a well-known designer brand in Japan. in large-scale online market and now AMBUSH will integrate with web3.0 From fashion start and now AMBUSH released a virtual game called play to earn (P2E) based on blockchain using Non-Fungible Tokens (NFT). as the main means of passive income to get reward tokens. now we have available beta version 1.0.0 and we will upgrade to version 1.0.1 on 2023-02-16 to launch on Arbitrum Blockchain.
 
 Telegram:https://t.me/ambushfactory
 Website:https://ambushsilverfctry.io/
