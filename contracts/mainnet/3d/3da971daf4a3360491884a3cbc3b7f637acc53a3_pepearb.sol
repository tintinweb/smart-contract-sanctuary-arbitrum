...
contract pepearb  is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pepe arb reward ";
    string constant _symbol = "pepe arb r";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf19204e341F6E36970a70A1845Aa34BCe4ae6525;  // marketingwallet
        lotteryWallet = 0xf19204e341F6E36970a70A1845Aa34BCe4ae6525;  // no tax for lotterywallet
