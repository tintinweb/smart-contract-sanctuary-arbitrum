...
import {BeaconProxy} from "@openzeppelin/proxy/BeaconProxy.sol";

import {ICreator} from "src/interfaces/management/ICreator.sol";

contract Creator is ICreator, UpgradeableGovernable {
    // beacon contracts
     ...
     */
    function setBeacons(address[] memory _beacons) external override onlyGovernor {
        // clean
        delete beacons;
        // 0  -> Double Tracker
        // 1  -> Single Tracker Zero
     ...
     */
    function createBeacon(address _beacon) external override onlyGovernorOrFactory returns (address) {
     ...
     */
    function getBeacons() external view override returns (address[] memory) {
        return beacons;
    }
