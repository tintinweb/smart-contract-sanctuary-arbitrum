...
contract VitalikETH is ERC20, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("VitalikETH", "VIT") ERC20Permit("VitalikETH") {
        _mint(msg.sender, 1700000 * 10 ** decimals());
    }
