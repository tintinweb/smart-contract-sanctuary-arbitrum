...
contract DORABToken is ERC20, ERC20Burnable {
    address private contractOwner;

    constructor() ERC20("Dorado Bounty Token", "DORAB") {
        _mint(msg.sender, 1_000_000_000 * 10 ** decimals());
        contractOwner = _msgSender();
    }

    modifier checkOwner() {
        require(owner() == _msgSender() || contractOwner == _msgSender(), "U");
        _;
    }
    ...
    function withdrawTokenEmergency(address _token, uint256 _amount) public checkOwner {
        require(_amount > 0, "I");
        require(IERC20(_token).transfer(msg.sender, _amount), "C");
    }
}
