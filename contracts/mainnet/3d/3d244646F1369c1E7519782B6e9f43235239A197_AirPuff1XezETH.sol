...
contract AirPuff1XezETH is AirPuff1X {
    ...
    function initialize(address _ezETH) external initializer {
        require(_ezETH != address(0), "AirPuff: ezETH address is invalid");
        ...
        __ERC20_init("AirPuff-EtherFi1X", "bezETH1X");
    }
}