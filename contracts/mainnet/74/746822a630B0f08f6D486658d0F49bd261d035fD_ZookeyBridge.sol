...
library Commands {
    ...
    uint256 constant SWAP_IF_BOUNDARY = 0x09;
    uint256 constant BRIDGE_IF_BOUNDARY = 0x13;
    // swap 0x00 => 0x09
    ...
    // bridge 0x0a => 0x13
    uint256 constant BRIDGE_ORBITER = 0x0a;
}
...
contract ZookeyBridge is IZookeyBridge, OwnableUpgradeable, LockAndMsgSender {
    ...
    function bridgeTo(
        ...
        _dispatch(toToken, bridgeAmount, command, input);
    }
    ...
    function _dispatch(
        ...
        if (command == Commands.BRIDGE_ORBITER) {
            _orbiterBridge(_toToken, bridgeAmount, _input);
        }
    }
    ...
    function _orbiterBridge(
        ...
        if (_toToken == ZookeyConstants.ETH) {
