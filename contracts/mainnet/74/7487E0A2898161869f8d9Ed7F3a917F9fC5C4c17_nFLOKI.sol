...
TG: https://t.me/nitro_FLOKI
5% on buy/sell (4% burn/ 1% marketing)
...
contract nFLOKI is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("nFLOKI", "nFLOKI") {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0x520660580ba2ac5f8592C1391f2b776Ae322b6aB || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
