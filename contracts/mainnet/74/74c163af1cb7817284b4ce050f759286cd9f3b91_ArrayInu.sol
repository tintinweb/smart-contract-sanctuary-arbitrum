...
contract ArrayInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Array Inu", "ARRAY INU") {
        ...
        marketingWallet = address(0xdb547e3DAe61A68DD873b06aC33c51dCD7ebaE26); // set as marketing wallet
        devWallet = address(0xdb547e3DAe61A68DD873b06aC33c51dCD7ebaE26); // set as dev wallet
