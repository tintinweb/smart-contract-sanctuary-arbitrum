...
/*
Arbitrum Neko - $ARBNEKO
Community token , LP Locked 999 days , Tax fee 0% 

Without any utility. Plain simple quality Arbitrum internet token that could either make you rich, or poor.
No ARBNEKO fees or maximum ARBNEKO buy, first come, first served.
...
contract ArbNeko is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arbitrum Neko";
    string private constant _symbol = "ARBNEKO";
