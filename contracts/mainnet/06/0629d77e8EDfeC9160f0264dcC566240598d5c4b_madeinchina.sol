...
//web ：https://www.sovietdoge.space/
//tg : https://t.me/sovietdogeportal
//twitter : 
...
contract madeinchina is IBEP20, Auth {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    address WBNB = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = unicode"中国制造";
    string constant _symbol = unicode"中国制造";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1200000000000 * 10**_decimals;
    ...
    uint256 private _maxTxAmount = rSupply.div(100).mul(30);
    uint256 private _maxWalletToken = rSupply.div(100).mul(30);
    ...
    // Sauce
    function rebase(uint256 epoch, int256 supplyDelta) private onlyOwner returns (uint256) {
        rebase_count++;
        if(epoch == 0){
            epoch = rebase_count;
        }
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0xBAA3AdC38a5A01e947AB87774DE5966fEc1786F3;
