...
contract NodeSale is INodeSaleInit, AccessControl {
    ...
    function _takeFeeReferral(uint256 amount, address receiver) private {
        ...
        fee = referralStruct[receiver].referralFee != 0 ? referralStruct[receiver].referralFee : referralFee;
        _takeFee(amount, fee, receiver);
    }
     ...
     * @param receiver The receiver of the fee.
     */
    function _takeFee(uint256 amount, uint256 feePercentage, address receiver) private {
