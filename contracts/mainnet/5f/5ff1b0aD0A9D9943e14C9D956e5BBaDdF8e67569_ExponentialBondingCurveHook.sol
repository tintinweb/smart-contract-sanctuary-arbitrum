...
contract ExponentialBondingCurveHook {
    constructor() {}
    ...
    function onKeyPurchase(
        ...
        // Calculate 101% of the current price
        uint256 newPrice = (lock.keyPrice() * 101) / 100; 
        lock.updateKeyPricing(newPrice, lock.tokenAddress());
