...
contract ARBEAST is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 61,000 ARBEAST
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ARBEAST", "ARBEAST") {
        _mint(msg.sender, 100000000 ether); // mint 1 ARBEAST for initial pools deployment
