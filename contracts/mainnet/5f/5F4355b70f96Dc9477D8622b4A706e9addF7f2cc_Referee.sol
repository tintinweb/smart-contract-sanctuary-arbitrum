...
contract Referee is ERC2771Context, Initializable, Proxied {
    ...
    event LogFinalized(
        ...
        uint256 _nrOfSuccessfulNodeKeys
    );
    ...
    function finalize(
        ...
        uint256 ptr;
        uint256[] memory successfulNodeKeys = new uint256[](
        ...
        if (nrOfSuccessfulNodeKeys > 0) {
            for (uint256 x; x < length; x++) {
                ...
                if (l2StateRoot == _finalL2StateRoot) {
                    successfulNodeKeys[ptr] = uint256(nodeKeyIdBytes);
                    ptr += 1;
                }
            }

            nodeRewards.updateRewards(
                successfulNodeKeys,
