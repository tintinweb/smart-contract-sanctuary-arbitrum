...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getMangoPrice() external view returns (uint256) {
        return treasury.getMangoPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            mango.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        mango.safeTransferFrom(msg.sender, address(this), amount);
