    ...
    IERC1155Receiver
{
    ...
    function isOperation(
        ...
        // Timestamp comparison is at the core of this class. If a miner
        // manipulates it we're screwed anyway.
    ...
    function isOperationDone(
        ...
        // We're using _DONE_TIMESTAMP explicitly to mark a transaction as done.
        // In addition Timestamp comparison is at the core of this class. If a
        // miner manipulates it we're screwed anyway.
     ...
     */
    // This function can reenter, but it doesn't pose a risk because _afterCall
    // checks that the proposal is pending, thus any modifications to the
    // operation during reentrancy should be caught.
    // slither-disable-start reentrancy-eth,reentrancy-events
    function execute(
        address target,
        uint256 value,
    ...
    // slither-disable-end reentrancy-eth,reentrancy-events
    ...
    function _execute(
        ...
        // As a proxy class, TimelockController should be able to:
        // * send ETH to an  arbitrary address
        // * execute other contracts in a loop
