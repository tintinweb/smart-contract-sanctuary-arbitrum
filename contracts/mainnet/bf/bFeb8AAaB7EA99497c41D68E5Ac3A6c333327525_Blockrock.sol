...
contract Blockrock is ReentrancyGuard, Pausable, Ownable, IERC20 {
  ...
  uint256 public transactionLimit  = maxSupply / 100; // 1% of total supply
  uint256 public maxWallet = maxSupply * 25 / 1000; // starting at 2.5% of total supply
  ...
  uint256 public swapTimeLock = 12 minutes;
  ...
  function setDistributor(address distributorAddress) external authorized {
    require(distributorAddress != address(0), "Zero address");
    distributor = IDividendDistributor(distributorAddress);
    distributorInitialized = true;
    dividendExempt[distributorAddress] = true;
    txLimitExempt[distributorAddress] = true;
    maxWalletExempt[distributorAddress] = true;
    authorizations[distributorAddress] = true;
    emit SetDistributor(distributorAddress);
  }
