...
interface IUniswapV2Factory {
    ...
    function tradingFeeAddress() external view returns (address);
    function swapFeeSetter() external view returns (address);
    ...
    function setTradingFeeAddress(address) external;
    function setSwapFeeSetter(address) external;
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'f2d437799411d5683b43551fbe05b3e0454ba7fabb1ff0d9335a972832ce740e' // init code hash
            ))));
    }
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function _addLiquidity(
        ...
        require(amountADesired >= amountAMin && amountBDesired >= amountBMin,
            "amountDesired must be >= amountMin");
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = UniswapV2Library.getAmountOut(amountInput, reserveInput, reserveOutput, pair.swapFee());
            }
