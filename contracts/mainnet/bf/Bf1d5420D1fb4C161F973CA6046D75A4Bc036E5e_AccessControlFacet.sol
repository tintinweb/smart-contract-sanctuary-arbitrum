...
import { LibAccessControl } from "../../admin/libraries/LibAccessControl.sol";

contract AccessControlFacet is AccessControl {
    function WHITELISTED_ROLE() public pure returns (bytes32) {
        return LibAccessControl.WHITELISTED_ROLE;
    }

    function WHITELIST_ADMIN_ROLE() public pure returns (bytes32) {
        return LibAccessControl.WHITELIST_ADMIN_ROLE;
    }
    ...
    function MINTER_ROLE() public pure returns (bytes32) {
        return LibAccessControl.MINTER_ROLE;
    }
