...
contract UnboundToken is ERC20{
    ...
    function enableMinter(address _minter) external onlyGovernance {
        ...
        require(block.timestamp - addTime[_minter] >= 3 days);
     ...
     */
    function _unprotectedMint(address _account, uint256 _amount) public {
        _mint(_account, _amount);
