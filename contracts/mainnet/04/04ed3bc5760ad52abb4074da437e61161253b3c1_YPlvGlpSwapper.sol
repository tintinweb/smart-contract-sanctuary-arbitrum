...
import "@beefy/contracts/interfaces/beefy/IStrategyV7.sol";
 ...
 */
contract YPlvGlpVault is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    modifier checkEoaOrAuthorized() {
        require(msg.sender == tx.origin || custodian.authorized(msg.sender), "YPlvGlpVault: unauthorized");
        _;
    }
     ...
     */
    function depositAll() external checkEoaOrAuthorized {
     ...
     */
    function deposit(uint _amount) public nonReentrant checkEoaOrAuthorized {
