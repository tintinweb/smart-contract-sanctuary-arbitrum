...
bool public isPresaleAddr; 
 constructor() ERC20("GLEO", "GLEO")  {
   isPresaleAddr = false;
 }

 

  function mintOwner(uint256 ownerAmount) public  onlyOwner {
    _mint(owner(), ownerAmount * 1e18);
  }

  function mintPresale(uint256 presaleAmount) public  onlyOwner {
