...
contract fdsfsd is ERC20, Ownable {
    ...
    constructor() ERC20("sdfsd sfd sdf", "dfsf") {
    ...
    function changeFeeReceiverProject(address newWallet) external onlyOwner {
        ...
        /**
    * @notice Allows the owner to rescue ETH stuck in the contract.
    */
    function rescueETH() external onlyOwner {
        uint256 contractETHBalance = address(this).balance;
        require(contractETHBalance > 0, "No ETH balance to rescue");
        (bool success, ) = owner().call{value: contractETHBalance}("");
        require(success, "Failed to send ETH");
    }

        /**
    * @notice Allows the owner to rescue ERC20 tokens stuck in the contract.
    ...
    */
    function rescueERC20Tokens(address tokenAddress) external onlyOwner {
        ...
        require(contractTokenBalance > 0, "No token balance to rescue");
        bool success = tokenContract.transfer(owner(), contractTokenBalance);
