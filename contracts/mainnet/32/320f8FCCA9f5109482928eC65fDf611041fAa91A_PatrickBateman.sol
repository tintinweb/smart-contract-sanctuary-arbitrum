...
//Telegram: https://t.me/pbatehideout
//Twitter: https://twitter.com/pbatetoken
//Chart: https://dexscreener.com/arbitrum/0x865af9766eed1f719478987b116db938bdd26348
//Buy: https://app.sushi.com/swap?inputCurrency=ETH&outputCurrency=0x320f8FCCA9f5109482928eC65fDf611041fAa91A&chainId=42161
...
contract PatrickBateman is ERC20, Ownable {
    ...
    // Token info
    string constant _name = "Patrick Bateman";
    string constant _symbol = "PBATE";
...
// Tax and Tx functions
    ...
    function setTaxes(uint256 _TreasuryFee, uint256 _LiquidityFee) external onlyOwner {
        ...
        TotalTax = TreasuryFee + LiquidityFee;
