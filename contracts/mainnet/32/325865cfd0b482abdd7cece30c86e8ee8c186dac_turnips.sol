...
// File: contracts/turnips-arb.sol
...
contract turnips is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    bool public paused = true;
    uint256 nextTokenId = 250;
    uint256 MAX_MINT_ARBITRUM = 500;

    uint256 gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("turnips", "trnps")
    {
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < 3, "turnips: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ARBITRUM,
            "turnips: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "turnips: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "turnips: Failed to withdraw Ether");
    }
