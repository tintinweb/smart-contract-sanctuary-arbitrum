...
contract BOSNFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("BOS NFT", "BOS NFT"){
        _fundAddress = msg.sender;
        //USDT6
        _rewardToken = address(0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9);
        _maxTotal = 888;
        //如果每个NFT图片通过链接拼接，_baseUri赋值，如果没有后缀_suffix=""
        _baseUri = "https://ipfs.4everland.xyz/ipfs/QmfTMzGJqk5hfPPqhdSrYEVSCLTrZnExvq1NFYeK1uY3iK/";
        _suffix = ".json";

        //如果图片都相同，_sameUri赋值，_baseUri="";
        _sameUri = "";
    }
}