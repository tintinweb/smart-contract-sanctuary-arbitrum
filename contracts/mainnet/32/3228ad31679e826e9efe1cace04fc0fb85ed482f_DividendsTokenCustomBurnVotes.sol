...
// 
contract DividendsTokenCustomBurnVotes is
    ERC20BurnableVotes,
    DividendsTokenCustomVotes
{
    constructor(
        ...
        Ownable(_owner)
        DividendsTokenCustomVotes(_args)
        ERC20Permit(_name)
    {
    ...
    function transfer(
        address recipient,
        uint256 amount
    ) public virtual override(ERC20, DividendsTokenCustomVotes) returns (bool) {
        return DividendsTokenCustomVotes.transfer(recipient, amount);
    }
    ...
    function transferFrom(
        ...
        return
            DividendsTokenCustomVotes.transferFrom(sender, recipient, amount);
    }
    ...
    function _afterTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(DividendsTokenCustomVotes, ERC20VotesDecimals) {
        ERC20VotesDecimals._afterTokenTransfer(from, to, amount);
        DividendsTokenCustomVotes._afterTokenTransfer(from, to, amount);
    }
}