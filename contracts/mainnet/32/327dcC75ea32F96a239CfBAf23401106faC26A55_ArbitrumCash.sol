...
Do you missed $MONKEYS (ERC)...?
(Don't Missed $MONKEYS ARB)

Monkey is built on Arbitrum. With the ambition to create a strong community.

Stealth Launch Tue, April 4th at 3:30 PM UTC

Tokenomics:
Token Name :  Monkeys
Token Symbol :  $MONKEYS
Total Supply : 500,000,000,000

Buy/Sell Taxes : ZERO 0%

Telegram:
https://t.me/MonkeysARB
Twitter:
https://twitter.com/MonkeysArb
*/
...
contract ArbitrumCash is Context, IBEP20, Ownable {
    ...
    string public _name = "Monkeys"; // token name
    string public _symbol = "MONKEYS"; // token ticker
