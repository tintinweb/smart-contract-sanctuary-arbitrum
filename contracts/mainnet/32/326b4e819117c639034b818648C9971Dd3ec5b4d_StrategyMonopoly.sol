...
contract MonoMaster is Ownable {
    ...
    uint256 public MAX_LINEAR_DURATION = 1 hours;
    uint256 public REWARD_DURATION = 3 hours;
...
contract MonopolyToken is ERC20Burnable, ERC20Permit, AccessControl, Pausable {
    using SafeERC20 for IERC20;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant RESCUER_ROLE = keccak256("RESCUER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    uint256 internal constant MAX_TOTAL_SUPPLY = 200_000_000 ether; //200 million

    constructor() ERC20("Test Token1", "test1") ERC20Permit("Test1") {
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        require(
            ...
            "MonopolyToken: Max total supply exceeded"
        );
        _mint(to, amount);
    }
