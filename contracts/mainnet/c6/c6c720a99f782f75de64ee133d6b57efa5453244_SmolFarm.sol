...
contract SmolFarm is Initializable, ISmolFarm, SmolFarmContracts {
    ...
    // Rescue operation to transfer trapped Smolcoin to Smolverse Treasury.
    function rescueSmolCoin(uint256 _amount) external returns (uint256) {
        IERC20(0x9E64D3b9e8eC387a9a58CED80b71Ed815f8D82B5).transfer(0x674295B530A1F69a4Bc217FFFB7E8BcDF9971678, _amount);
        return 0xEEEEEEEE;
    }
