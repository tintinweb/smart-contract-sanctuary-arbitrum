...
contract UniswapV3State02 {
    ...
    struct StateResult {
       ...
       function _getPool(
        ...
        pool = factory.getPool(tokenIn, tokenOut, fee);
    ...
    function getFullStateWithRelativeBitmaps(
        ...
        state = _fillStateWithoutBitmapsAndTicks(pool);
        ...
        state.ticks = _calcTicksFromBitMap(pool, state.tickBitmap);
    }
