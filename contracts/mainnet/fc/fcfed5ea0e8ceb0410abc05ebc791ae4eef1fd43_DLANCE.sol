...
/**
Web3-based DeeLance is redefining how freelancers connect with potential employers and buyers of their work. It intends to build a new freelance economy that removes intermediaries, gives freelancers full ownership of their work, and ensures the ownership of purchased digital work for buyers. DeeLance’s decentralized platform entails micro-communities in a metaverse where buyers and sellers of creative works can meet, discuss ideas, network, and form bonds, and an NFT marketplace, where they can transact. 
*/
...
contract DLANCE is Context, IERC20, Ownable {
