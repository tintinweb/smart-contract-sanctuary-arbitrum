...
contract SushiSwapV2Swap {
    ...
    function swap(address tokenA, address tokenB, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
    ...
    function wethSwap(address tokenA, address tokenB, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
        TransferHelper.safeApprove(tokenA, defiRouter, tokenAAmount);
    ...
    function _pathToSwap(address tokenA, address[] memory path, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
        TransferHelper.safeApprove(tokenA, defiRouter, tokenAAmount);
