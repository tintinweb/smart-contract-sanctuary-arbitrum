...
interface IBaseReward is IClaim {
...
contract NFTMarketplace is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721AQueryableUpgradeable {
    ...
    function deposit(address _underlyingToken, uint256 _amountIn, bool _listing, uint256 _price) public nonReentrant {
        require(_underlyingToken != address(0), "NFTMarketplace: _vsToken cannot be 0x0");
        ...
        tokenMetas[currentTokenId] = TokenMeta({ tokenId: currentTokenId, underlyingToken: _underlyingToken, liquidity: _amountIn, owner: msg.sender });
    ...
    function withdraw(uint256 _tokenId) public nonReentrant isTokenOwner(_tokenId, msg.sender) {
