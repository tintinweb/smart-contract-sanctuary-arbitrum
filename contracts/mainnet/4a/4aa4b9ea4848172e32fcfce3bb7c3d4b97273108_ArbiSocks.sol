...
contract ArbiSocks is ERC20, Ownable {
    ...
    string constant _name = " ArbiSocks";
    string constant _symbol = "ASOCKS";

    uint256 public _totalSupply = uint256(10_000 * (10 ** 9));
    ...
    address public marketingFeeReceiver = 0x7D4A2D8173a9595537fA2ae1Ae0Dfdbdc6b203D7;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x7D4A2D8173a9595537fA2ae1Ae0Dfdbdc6b203D7] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x7D4A2D8173a9595537fA2ae1Ae0Dfdbdc6b203D7] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x7D4A2D8173a9595537fA2ae1Ae0Dfdbdc6b203D7,
                block.timestamp
            );
