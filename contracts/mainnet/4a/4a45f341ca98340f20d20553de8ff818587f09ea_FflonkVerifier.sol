...
contract FflonkVerifier {
    uint32 constant n     = 8; // Domain size
    ...
    uint256 constant wr   = 13274704216607947843011480449124596415239537050559949017414504948711435969894;
    // Omega_3, Omega_3^2
    ...
    uint256 constant C0x  = 6704336304466523959078636869371958575521480528486971525540043730366049427281;
    uint256 constant C0y  = 14849083322413879621916376668849673893613058077369408945360552590978614117935;
