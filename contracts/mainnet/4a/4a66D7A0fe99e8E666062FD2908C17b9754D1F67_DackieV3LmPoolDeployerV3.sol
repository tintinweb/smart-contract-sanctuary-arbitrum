...
/// versions.
contract DackieV3LmPoolDeployerV3 {
    struct Parameters {
        address pool;
        address masterChef;
    ...
    function deploy(IDackieV3PoolWithLMPool pool) external onlyOwner returns (IDackieV3LmPoolV3 lmPool) {
        ...
        lmPool = new DackieV3LmPoolV3{salt: keccak256(abi.encode(address(pool), masterChef, block.timestamp))}();
...
import './interfaces/IDackieV3LmPoolV3.sol';
import './interfaces/ILMPool.sol';
import './interfaces/IMasterChefV3.sol';
import './interfaces/IDackieV3LmPoolDeveloperV3.sol';

contract DackieV3LmPoolV3 is IDackieV3LmPoolV3 {
    ...
    constructor() {
        ...
        ) = IDackieV3LmPoolDeveloperV3(msg.sender).parameters();
...
interface IDackieV3LmPoolDeveloperV3 {
    function parameters()
    external
    view
