...
import "@adrastia-oracle/adrastia-periphery/contracts/accumulators/proto/adrastia/ManagedAdrastiaPriceAccumulator.sol";

import "../../../AdrastiaVersioning.sol";

contract AdrastiaSelfPA is AdrastiaVersioning, ManagedAdrastiaPriceAccumulator {
    struct PriceAccumulatorParams {
        bool validationDisabled;
        IAveragingStrategy averagingStrategy;
        address adrastiaOracle;
    ...
    constructor(
        ...
        ManagedAdrastiaPriceAccumulator(
            params.validationDisabled,
            params.averagingStrategy,
            params.adrastiaOracle,
            params.updateTheshold,
