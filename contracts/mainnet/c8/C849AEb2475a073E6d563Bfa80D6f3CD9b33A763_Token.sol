...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public operationsWallet = payable(0xE9cFc7F116FeC8962F1B109f85c269deC7Df526c);
    address payable public devWallet = payable(0x0433718367E3e704A24a38bFd0e12848926063e3);
    ...
    uint256 public _buyoperationsFee = 2;
    uint256 public _buydevFee = 2;
    
    uint256 public _sellLiquidityFee = 1;
    uint256 public _selloperationsFee = 2;
 ...
 IDEXRouter public dexRouter;
    ...
    constructor () {
        ...
        IDEXRouter _dexRouter = IDEXRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //sushi
    ...
    function setSellTaxes(uint _Liquidity, uint _operations , uint _dev) public onlyOwner {
        ...
        _selldevFee = _dev;
        _totalTaxIfSelling = _sellLiquidityFee.add(_selloperationsFee).add(_selldevFee);
	require(_totalTaxIfSelling <= 15, "Fees cannot be more than 15%");
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountETHoperations = recievedBalance.mul(operationsShare).div(totalETHFee);
        uint256 amountETHdev = recievedBalance.sub(amountETHLiquidity).sub(amountETHoperations);
