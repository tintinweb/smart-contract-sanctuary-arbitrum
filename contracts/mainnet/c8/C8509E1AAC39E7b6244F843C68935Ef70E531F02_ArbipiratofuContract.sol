    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 1000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmW5GdgT78WwY8smjYy5NX1CvdRHeMtaf1gkKhEEYPas9o/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3G9PFt0Ly0GBq8zhjA3S/contract-metadata";
  }
...
// File: contracts/ArbipiratofuContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbipiratofuContract is RamppERC721A {
    constructor() RamppERC721A("ARBI PIRATOFU", "ARPI"){}
}
