...
interface INeadTradeFeeHandler {
...
import "./interfaces/INeadTradeFeeHandler.sol";
    ...
    UUPSUpgradeable
{
    ...
    /// @custom:oz-renamed-from tradeFeeReceiver
    address dirtySlot;
    /// @custom:oz-renamed-from swappoor
    address dirtySlotTwo;
    /// @custom:oz-renamed-from neadRam
    address dirtySlotThree;
    address ram;

    // Mirrored from booster
    uint public neadTokenId;
    uint public platformFee;
    /// @custom:oz-renamed-from tradeFeeRate
    uint dirtySlotFour;
    ...
    function onERC721Received(
        ...
        if (pool == address(0)) {
            ...
            rewardsForPool[pool].add(IBooster(booster).xRam());
        }
    ...
    function reattach(uint _tokenID) public {
        require(allTokenIds.contains(_tokenID), "!deposited");
