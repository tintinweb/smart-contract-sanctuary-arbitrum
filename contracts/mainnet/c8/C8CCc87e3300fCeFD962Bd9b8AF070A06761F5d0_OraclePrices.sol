...
contract OraclePrices is IOraclePrices, Context, AccessControlEnumerable {
    ...
    function setGrainPrice(uint256 _soyPrice, uint256 _wheatPrice, uint256 _ricePrice, uint256 _cornPrice) public {
        ...
        require(_soyPrice > 0 && _soyPrice < 9999999999, "Invalid values");
        require(_wheatPrice > 0 && _wheatPrice < 9999999999, "Invalid values");
        require(_ricePrice > 0 && _ricePrice < 9999999999, "Invalid values");
        require(_cornPrice > 0 && _cornPrice < 9999999999, "Invalid values");
