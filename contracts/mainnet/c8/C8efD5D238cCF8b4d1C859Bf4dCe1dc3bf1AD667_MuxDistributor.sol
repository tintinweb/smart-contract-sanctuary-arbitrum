...
contract MuxDistributor is ReentrancyGuardUpgradeable, OwnableUpgradeable, IRewardDistributor {
    ...
    function _getMuxDistribution(uint256 amount) internal view returns (uint256 toMlpAmount, uint256 toVeMuxAmount) {
        toMlpAmount = ((amount * (1e18 - IRewardRouter(rewardRouter).poolOwnedRate())) / 1e18);
        toMlpAmount = (toMlpAmount * (1e18 - IRewardRouter(rewardRouter).votingEscrowedRate())) / 1e18;
