...
contract LBPGWOToken is Context, Ownable, IERC20 {
    ...
    uint256 public constant swapThreshold = TOKEN_TOTAL_SUPPLY / 5_000;
    ...
    string private constant _name = "LBPGWOToken";
    string private constant _symbol = "LBPGWO";
