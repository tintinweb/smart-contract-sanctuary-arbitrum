...
contract TinyPirate is ERC721Enumerable, Ownable, ERC721Holder {
    using Strings for uint256;

    address public miner;
    uint256 latestTokenId;

    string private baseURI = "https://oss.tiny-pirate.com/preview/tinypirate/";

    string public baseExtension = ".json";

    mapping(uint256 => string) private _tokenURIs;

    constructor() ERC721("Tiny Pirate", "Tiny Pirate") {}
