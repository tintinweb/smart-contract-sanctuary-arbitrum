...
contract AiMUSK is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 46000 ;
	uint256 public MAX_MINT_SALE = 10;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 10;
	uint256 public SALE_MINTED;
		
	uint256 public SALE_PRICE =  600000000000000;
    ...
    constructor() ERC721P('AiMUSK', 'AiMUSK') {}
    ...
    function transferFrom(address _from, address _to, uint256 _tokenId) public override(ERC721P,IERC721) {
        ERC721P.transferFrom(_from, _to, _tokenId);
    }

    function safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes memory _data) public override(ERC721P,IERC721)  {
