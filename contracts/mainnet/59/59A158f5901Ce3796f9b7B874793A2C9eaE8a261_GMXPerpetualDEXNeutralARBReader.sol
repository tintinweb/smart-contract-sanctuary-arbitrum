...
import "../../interfaces/vaults/gmx/IGMXPerpetualDEXNeutralVault.sol";
...
contract GMXPerpetualDEXNeutralARBReader {
  ...
  IGMXPerpetualDEXNeutralManager public immutable manager;
  // Chainlink oracle
  ...
  */
  constructor(
    ...
    IGMXPerpetualDEXNeutralManager _manager,
  ...
  */
  function additionalCapacity() public view returns (uint256) {
    IGMXPerpetualDEXNeutralVault.VaultConfig memory _vaultConfig = vault.vaultConfig();
