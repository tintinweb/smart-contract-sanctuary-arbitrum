 ...
 */
abstract contract LayerZeroV2EstimateMixin is Pausable, ERC165, IFailureNotification {
    /**
     ...
     */
    function notifyFailure() external virtual override(IFailureNotification) {
    ...
    function supportsInterface(
        ...
        return
            _interfaceId == type(IFailureNotification).interfaceId ||
