...
contract QILIN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Qi Lin Coin";
        _symbol = "QILIN";
        _mint(0xa47c9269843FF1E56F52b51962109B4A426C2074, initSupply);
        setWList(0xa47c9269843FF1E56F52b51962109B4A426C2074, true);
        ...
        if(block.chainid == 56) {
            ...
            usdtAddress = 0xf7693c6fD9a7172D537FA75D133D309501Cbd657;
        } else {
            uniswapV2Router = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
            usdtAddress = 0xf7693c6fD9a7172D537FA75D133D309501Cbd657;
        }
