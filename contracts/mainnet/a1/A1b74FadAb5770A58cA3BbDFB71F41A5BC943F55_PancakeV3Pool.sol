...
/// @title Minimal ERC20 interface for Pancake
/// @notice Contains a subset of the full ERC20 interface that is used in Pancake V3
...
import './yield/interfaces/IPancakeV3Pool.sol';
