...
// File contracts/StandardERC20Token.sol
...
contract StandardERC20Token is ERC20, ERC20Detailed {
    constructor(string memory name, string memory symbol, uint8 decimals, address initialHolder, uint256 amount) ERC20Detailed(name, symbol, decimals) public {
