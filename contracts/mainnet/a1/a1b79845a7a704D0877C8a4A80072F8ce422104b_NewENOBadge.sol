...
contract NewENOBadge is ERC721Enumerable, Ownable {
    ...
    function migrateMintBulk(address[] calldata wallets) public onlyOwner {
        for (uint256 i = 0; i < wallets.length; i++) {
            address to = wallets[i];
            require(_tokenId <= MAX_SUPPLY, "Max supply reached");
            require(_mintedCount[to] == 0, "Address already received migrated NFT");
