...
contract LaunchPadFactoryFacet is ILaunchPadFactory, AccessControl {
    ...
    function addLaunchPad(ILaunchPadCommon.CreateLaunchPadInput memory input, address launchPad, uint256 usdPrice) private {
    ...
    function createLaunchPad(ILaunchPadCommon.CreateLaunchPadInput memory storeInput) external payable override {
        LibLaunchPadFactoryStorage.DiamondStorage storage ds = LibLaunchPadFactoryStorage.diamondStorage();
        ...
        addLaunchPad(storeInput, launchPad, usdPrice);
    }
    ...
    function _prepareLaunchPadDiamond(address launchPad, ILaunchPadCommon.CreateLaunchPadInput memory input) private {
        ...
        bytes4[] memory functionSelectors = new bytes4[](20);
        ...
        functionSelectors[3] = ILaunchPadProject.getLaunchPadAddress.selector;
        functionSelectors[4] = ILaunchPadProject.getLaunchPadInfo.selector;
        functionSelectors[5] = ILaunchPadProject.getProjectOwnerRole.selector;
        functionSelectors[6] = ILaunchPadProject.getReleasedTokensPercentage.selector;
        functionSelectors[7] = ILaunchPadProject.getReleaseSchedule.selector;
        functionSelectors[8] = ILaunchPadProject.getTokensAvailableToBeClaimed.selector;
        functionSelectors[9] = ILaunchPadProject.getTokenCreationDeadline.selector;
        functionSelectors[10] = ILaunchPadProject.paidTokenAmountByUser.selector;
        functionSelectors[11] = ILaunchPadProject.purchasedAmountByUser.selector;
        functionSelectors[12] = ILaunchPadProject.refund.selector;
        functionSelectors[13] = ILaunchPadProject.refundOnSoftCapFailure.selector;
        functionSelectors[14] = ILaunchPadProject.refundOnTokenCreationExpired.selector;
        functionSelectors[15] = ILaunchPadProject.setTokenAddress.selector;
        functionSelectors[16] = ILaunchPadProject.tokenDecimals.selector;
        functionSelectors[17] = ILaunchPadProject.totalTokensClaimed.selector;
        functionSelectors[18] = ILaunchPadProject.totalTokensSold.selector;
        functionSelectors[19] = ILaunchPadProject.withdrawTokens.selector;
        ...
        cut[1] = IDiamondCut.FacetCut({ facetAddress: ds.pausableFacet, action: IDiamondCut.FacetCutAction.Add, functionSelectors: functionSelectors });
    ...
    function updateMaxTokenCreationDeadline(uint256 newMaxTokenCreationDeadline) external override onlyRole(AccessControlStorage.DEFAULT_ADMIN_ROLE) {
        LibLaunchPadFactoryStorage.DiamondStorage storage ds = LibLaunchPadFactoryStorage.diamondStorage();
    ...
    modifier onlyLaunchPadOwner(address launchPad) {
        require(
            AccessControl(launchPad).hasRole(LibLaunchPadProjectStorage.LAUNCHPAD_OWNER_ROLE, msg.sender),
