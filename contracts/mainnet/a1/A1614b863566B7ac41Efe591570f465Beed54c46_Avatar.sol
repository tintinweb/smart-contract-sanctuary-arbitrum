...
contract Avatar is  AvatarStore{
    ...
    function chapeIndex() public view returns(uint8){
        ...
        uint256 saleEndTime = _mintStartTime + 86400 * 4;
    ...
    function chapeTime() public view returns(uint256){
        uint8 chapeN = chapeIndex();
        if(0 == chapeN){
    ...
    function mint(uint32 count) public payable reentrancyGuard{
        ...
        require(count > 0 && count <= 5, "amount must > 0 and <=5");
...
contract AvatarProxy is  Proxy, AvatarStore{
    ...
    function setMintStartTime(uint256 t) public onlyOwner{
        _mintStartTime = t;
    }
