...
contract PampdaWalletCollection is
    BaseUpgradeable,
    ERC721Upgradeable,
    ERC721EnumerableUpgradeable,
    ERC721BurnableUpgradeable
{
    ...
    function initialize(string memory name_, string memory symbol_, address roleManager_) public initializer {
        __BaseUpgradeable_init_unchained(roleManager_);
    ...
    function batchMint(address[] calldata recipients_) external onlyRole(Roles.MINTER_ROLE) {
