...
contract LunArbitrum is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf2c6c37F1F0e47E737DE6B4FbdD27e54E29f570c); 
    address payable public Wallet_Dev = payable(0x20c8BC18338e9fA56540362C184fFadFf1b59EFc);
    ...
    string private constant _name = "LunArbit"; 
    string private constant _symbol = unicode"LUBIT"; 
    ...
    constructor () {
        ...
        _owner = 0x20c8BC18338e9fA56540362C184fFadFf1b59EFc;
    ...
    function setmaxTxn(uint256 newmaxTx) external onlyOwner() {
