...
contract ArbiSocks is ERC20, Ownable {
    ...
    uint256 public maxSwapPerTx;

    uint8 public marketingFee = 30;
    address payable public _marketingWallet = payable(address(0xBdD46C5470Ff7C19E8EF6Ad23dd38b829c76B8BF));
    ...
    constructor() ERC20("ArbiSocks", "ZKSOCKS") {
        IUniswapV2Router02 _sushiswapRouter = IUniswapV2Router02(0x38eEd6a71A4ddA9d7f776946e3cfa4ec43781AE6);
    ...
    function updateRouter(address newAddress) public onlyOwner {
        require(newAddress != address(sushiswapRouter), "ZKSOCK The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ZKSOCKS Account is already excluded");
    ...
    function setSwapAmount(uint256 _swapMinBalance, uint256 _maxValuePerSwap) external onlyOwner {
        swapTokensAtAmount = _swapMinBalance;
        maxSwapPerTx = _maxValuePerSwap;
    }
    ...
    function _transfer(
        ...
        if (canSwap && !swapping && !automatedMarketMakerPairs[from] && from != owner() && to != owner()) {
            ...
            contractTokenBalance = contractTokenBalance > maxSwapPerTx ? maxSwapPerTx : contractTokenBalance;
