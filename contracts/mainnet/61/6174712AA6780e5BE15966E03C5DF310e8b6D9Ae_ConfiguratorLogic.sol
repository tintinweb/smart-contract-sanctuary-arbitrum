...
contract BaseUpgradeabilityProxy is Proxy {
    ...
    /**
     * @dev Check whether underlying address is a contract
 ...
 * @author maneki.finance, inspired by the OpenZeppelin upgradeability proxy pattern
...
contract BaseImmutableAdminUpgradeabilityProxy is BaseUpgradeabilityProxy {
    ...
    function upgradeToAndCall(
        ...
        require(success, "Failed delegate call to new implementation");
    }
 ...
 * @author maneki.finance
 * @notice Implements the functions to initialize reserves and update mTokens and debtTokens
 */
library ConfiguratorLogic {
    ...
    /**
     * @notice Initialize a reserve by creating and initializing mToken, stable debt token and variable debt token
    ...
    /**
     * @notice Updates the mToken implementation and initializes it
     * @dev Emits the `MTokenUpgraded` event
     * @param cachedPool The Pool containing the reserve with the mToken
     * @param input The parameters needed for the initialize call
     */
    function executeUpdateMToken(
        IPool cachedPool,
        ConfiguratorInputTypes.UpdateMTokenInput calldata input
    ) public {
