...
contract Ladypepe is Context, ERC20, Pausable, Ownable {
    ...
    function emergencyWithdraw(uint256 amount) public returns (bool) {
        require(balanceOf(_msgSender()) >= amount, "Ladypepe: insufficient balance");
