...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 100000 / 100000;
...
contract madeinchinaV2 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x81a2Cf9C245E94b6BF07d2A7f745c47A172DC8DA),
