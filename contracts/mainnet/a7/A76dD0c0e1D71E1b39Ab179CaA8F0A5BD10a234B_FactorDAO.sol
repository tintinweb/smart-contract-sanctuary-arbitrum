...
contract FactorDAO is ERC20, Ownable {
    ...
    string constant _name = "FactorDAO";
    string constant _symbol = "FCTR";
    ...
    address public marketingFeeReceiver = 0xc51BE9C197E464BD27133E04c6138F780c880F51;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xc51BE9C197E464BD27133E04c6138F780c880F51] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xc51BE9C197E464BD27133E04c6138F780c880F51] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xc51BE9C197E464BD27133E04c6138F780c880F51,
                block.timestamp
            );
