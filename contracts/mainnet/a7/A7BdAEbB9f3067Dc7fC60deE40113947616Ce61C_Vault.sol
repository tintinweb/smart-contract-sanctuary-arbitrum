...
library DefiiStatusLogic {
    ...
    */
    ...
    function validateNewStatus(
        ...
        // Additional enter: ENTERED -> ENTER_STARTED -> ENTERED
        // Partial exit: ENTERED -> EXIT_STARTED -> ENTERED
        // Full exit: ENTERED -> EXIT_STARTED -> NOT_ENTERED
        ...
        return
            ...
            (currentStatus == DefiiStatus.ENTERED &&
                (newStatus == DefiiStatus.EXIT_STARTED ||
                    newStatus == DefiiStatus.ENTER_STARTED)) ||
            // EXIT_STARTED -> NOT_ENTERED / ENTERED
...
import {DefiiStatus, DefiiStatusLogic} from "./misc/DefiiStatusLogic.sol";
