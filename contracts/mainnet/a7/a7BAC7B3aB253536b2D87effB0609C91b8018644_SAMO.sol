...
contract SAMO is Ownable, ERC20 {
    ...
    address public feeAddress = 0xb658CB3EC99CAd9FE331013808204e9cbFA2bCB8;
    ...
    function mint() external onlyOwner {
        require(_totalMinted < _totalSupply, 'only totalSupply can be minted');
        _mint(msg.sender, _totalSupply);
        _totalMinted += _totalSupply;
    }

    function setTax(uint _tax) external onlyOwner {
        require(_tax <= 20 && _tax >= 0);
        taxPercentage = _tax;
    }
