...
/*
            EREN COIN 
  https://twitter.com/Eren_ERC       
  https://t.me/Erencoinarbi          
...
contract EREN is ERC20, Ownable {
    string private _name = "EREN COIN";
    ...
    uint256 public DevFeeBuy = 10; // = 1%
    uint256 public DevFeeSell = 10; // = 1%
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
