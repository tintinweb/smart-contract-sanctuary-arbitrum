...
contract TrancheYieldCurve is CoreRef {
    ...
    constructor(address _core, address[] memory _farmTokens) CoreRef(_core) {
        farmTokens = _farmTokens;
    }

    function setFixedAPR(uint256 _apr) public onlyTimelock {
        require(_apr > 0, "APR should be a positive number");
        fixedAPR = _apr;
    }
