...
contract FaceNFTCollection is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    function setBaseTokenURI(string memory baseTokentURI_) public onlyOwner() {
...
contract FaceNFTCollectionV4 is FaceNFTCollectionV3 {
    ...
    function safeTransferFrom(address sender, address recipient, uint256 id, uint256 value, bytes memory data) public virtual override  {
        ...
        super.safeTransferFrom(sender, recipient, id, value, data);
...
contract FaceNFTCollectionV6 is FaceNFTCollectionV5 {
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafkreicf2aarjuocoiqkfgsyki7klunuz42s5rneuqbbwp5u7xagt7haey";

        // return "https://bafybeidlrb2dzzprettxko5mvm7lgmkf2mi3jxwhixf3s7b2pijv5ymhc4.ipfs.nftstorage.link/contract-metada.json";
        // return string(
        //     abi.encodePacked(
        //         _contractURI
        //     )
