 ...
 */
contract BhavishBalancerVault is AccessControl, BaseVault {
...
abstract contract BaseVault is Pausable, AccessControl, ReentrancyGuard {
    ...
    constructor(
        ...
        vaultConfig.predictionPerc = 3300;
        vaultConfig.minPredictionPerc = 10000; // 10% of predictionPerc
        vaultConfig.withdrawFeeRatio = 0;
        vaultConfig.performanceFeeRatio = 1000;
        vaultConfig.lockPeriod = 0 days;
    ...
    function setLockPeriod(uint256 _period) public onlyAdmin(msg.sender) {
        require(_period <= 7 days, "Cannot be > 7 days");
