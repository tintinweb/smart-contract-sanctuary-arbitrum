...
contract TempNFTStakeContract is Ownable{
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    IERC20 public bonusToken; // AIAPE

    constructor(IERC20 bonusToken_) {
        bonusToken = bonusToken_; // AI APE
    }
    ...
    function addCaller(address val) public onlyOwner() {
        require(val != address(0), "Temp NFT STAKE: val is the zero address");
        _callers.add(val);
    }

    function delCaller(address caller) public onlyOwner returns (bool) {
        require(caller != address(0), "Temp NFT STAKE: caller is the zero address");
