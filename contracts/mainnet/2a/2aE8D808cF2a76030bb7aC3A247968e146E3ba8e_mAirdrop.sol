...
import "../interfaces/ImAirdrop.sol";
...
contract mAirdrop is ImAirdrop, ERC20, Ownable {
    ...
    function transfer(address to, uint256 amount) public virtual override(ERC20, IERC20) returns (bool) {
        revert("mAirdrop: transfer is forbidden");
    }
...
contract mAirdropManager is Ownable, ReentrancyGuard{
    ...
    function deposit(address tokenIn, uint256 amountIn) external nonReentrant{
        ...
        require(!onlyNFTHolders || hasValidNft(msg.sender), "mAirdropManager: no valid NFT");
    ...
    function bulkAirdrop(address[] calldata destination, uint256[] calldata amount) external onlyOwner{
        require(destination.length == amount.length, "mAirdropManager: different length");
