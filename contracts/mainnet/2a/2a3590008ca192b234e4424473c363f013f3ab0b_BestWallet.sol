...
//--- Contract v2 ---//
contract BestWallet is Context, Ownable, IERC20 {
    ...
    uint256 private swapThreshold = _totalSupply / 6_000;
    ...
    address payable private marketingAddress = payable(0xaC353Aa4a347AA6E56eE1381887A529F47510160);


    IRouter02 public swapRouter;
    string constant private _name = "BestWallet Token";
    string constant private _symbol = "BWT";
    ...
    function changeWallets(address marketing) external onlyOwner {
        require(marketing != address(0),"ERC20: Zero Address Validation");
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        // Certik: Unchecked Variables, require(success) is not needed as if marketingAddress will be a contract, swaps will reverts. Safer without.
        }
    }

        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            require(buy <= 10,"SAFU: No tax allowed over 10%");
            require(sell <= 10,"SAFU: No tax allowed over 10%");
            buyfee = buy * 10;
            sellfee = sell * 10;
        ...
        function setPresaleAddress(address presale, bool yesno) external onlyOwner {
            require(presale != address(0),"ERC20: Zero Address Validation");
