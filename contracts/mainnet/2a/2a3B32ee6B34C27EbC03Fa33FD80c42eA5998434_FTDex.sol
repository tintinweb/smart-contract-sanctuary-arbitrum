...
contract FTDex is ERC20, Ownable {
    uint256 public buyFee = 1;
    uint256 public sellFee = 1;

    address public marketingWallet = 0xF6A95617461bF29Fb7C7eA353775809F0E0f351b;
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 20 && _sellFee <= 30, "Max buy fee is 20% and max sell fee is 30%");
        buyFee = _buyFee;
        sellFee = _sellFee;
