...
/**
 * @notice `purchaseTokens` function called with 0.0095 ETH will trigger the token distribution
 * @notice Receive all tokens required for all Arbitrum guild.xyz roles - https://guild.xyz/arbitrum
 * @notice Receive tokens POTENTIALLY required for Arbitrum Odyssey - 🚀︱odyssey-faq in https://discord.com/invite/Arbitrum
 * @notice Includes Dodo ($DODO), Ideamarket ($IMO), IzumiFinance ($iZi), $UNI, $SUSHI and SLP - SUSHI-ETH LP
 * @notice Disclaimer: PURCHASE DOES NOT GAURANTEE ARBITRUM AIRDROP NOR ODYSSEY NFTS
 * @author bagel - 谢谢 thanks
 */
