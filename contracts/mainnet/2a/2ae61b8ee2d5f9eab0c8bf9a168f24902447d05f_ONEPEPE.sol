...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "0xc10b8dE0C8617261c1024F083CE6d9C6Ef094243");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "0xc10b8dE0C8617261c1024F083CE6d9C6Ef094243");
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  modifier nonReentrant() {
    ...
    contract ONEPEPE is ERC20, Ownable, ReentrancyGuard{
    using SafeMath for uint256;
    ...
    constructor() ERC20("THE ONE PEPE", "1PEPE") {
        ...
        maxTransactionAmount = totalSupply * 6 / 100; // 3% maxTransactionAmountTxn
        maxWallet = totalSupply * 6 / 100; // 5% maxWallet
