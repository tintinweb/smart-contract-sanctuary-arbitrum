...
contract HSHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 25,000 HSHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 22000 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 2000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("HearTomb Share", "HSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 HSHARE for initial pools deployment
