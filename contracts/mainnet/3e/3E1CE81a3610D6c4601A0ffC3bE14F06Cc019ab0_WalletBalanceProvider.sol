 ...
 * @author  maneki.finance
 * @notice  Peripheral contract that implements a logic of getting multiple tokens balance for one user address
 * @dev     This contract is not used within the core protocol. It's used to fetch information from the blockcahin in batch.
 *          Based on AaveV3's WalletBalanceProvider
 **/
contract WalletBalanceProvider {
    ...
    **/
    receive() external payable {
        ...
        revert("WalletBalanceProvider: The contract doesn't accept ETH");
    }
    ...
    */
    ...
    /**
     * @notice  Internal function to check whether underlying address is a contract
     * @dev     Replacing Openzeppelin's Address.sol isContract function
