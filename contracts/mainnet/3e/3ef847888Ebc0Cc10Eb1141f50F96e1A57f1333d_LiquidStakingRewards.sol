...
contract LiquidStakingRewards is IStakingRewards, Ownable, ReentrancyGuard, ERC20 {
	...
	/// @notice How much rewards contract distributes every second
	...
	constructor(string memory _name, string memory _symbol, address _rewardsToken, address _stakingToken) ERC20(_name, _symbol) {
	...
	/// @notice calculates how much tokens were distributed across ALL stakers for time since last update for one token (1 ether)
	...
	function stakeWithPermit(
		...
		bytes32 r,
		bytes32 s
	) public nonReentrant virtual updateReward(msg.sender) {
	...
	function stake(uint256 amount) public nonReentrant virtual updateReward(msg.sender) {
		require(amount > 0, 'Cannot stake 0');
