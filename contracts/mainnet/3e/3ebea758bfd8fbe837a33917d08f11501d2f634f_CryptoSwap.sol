...
contract CryptoSwap is Ownable {
    ...
    function _handlePeriod(uint64 _startDate, PeriodInterval _periodType, uint16 _totalIntervals) internal pure returns (Period memory period) {
        uint32 periodInterval;
