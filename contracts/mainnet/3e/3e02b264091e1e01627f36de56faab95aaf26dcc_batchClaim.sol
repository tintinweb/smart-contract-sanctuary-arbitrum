...
contract batchClaim {
    ...
    function batchMint(uint256 count) public payable {
        ...
        for (uint256 i = 0; i < count; i++) {
            ...
            claim.mint{value: sendvalue}("xiaopang",address(this));
        }
        token(0xb13bF254044db6831a079d5446c4836a381d3Ba8).transfer(msg.sender,token(0xb13bF254044db6831a079d5446c4836a381d3Ba8).balanceOf(address(this)));
