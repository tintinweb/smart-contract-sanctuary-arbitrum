...
import "./interfaces/ISled.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "./utils/AggregatorPriceFeeds.sol";
    ...
    Pausable
{
    ...
    function whiteListUser(address _user, uint256 round, bool whitelisted) external onlyOwnerOrAdmin {
        if (round == 1) {
...
contract Power {
    ...
    function findPositionInMaxExpArray(
        uint256 _x
    ) internal view returns (uint8 pos) {
