...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeD5a6D8014250bDa8AEFa3506543Cc9C2A34E292; // owner address
...
contract ArbitFi is Context, IERC20, Ownable {
    ...
    string private _symbol = "ArbitFi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc8927fd3965C845bA39c2d9a2EdAa5626dceF81a); // Marketing Address
    address payable public teamWalletAddress = payable(0x712CaaE0257869cfFb5aD7292468b0f299C66CBd); // Team Address
