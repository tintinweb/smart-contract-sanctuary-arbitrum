...
contract Airdrop is Pausable, Ownable {
    ...
    function sweep(address[] memory _tokens, address _receiver) external onlyOwner whenPaused {
    ...
    function claim(address _account, uint256 _amount, bytes32[] calldata _merkleProof) external whenNotPaused {
