...
$$ |      $$ |  $$ |$$  /   \$$ |   $$ |   
\__|      \__|  \__|\__/     \__|   \__|   
Website : https://pawt.io/
Discord : https://discord.com/invite/Sf3Zwy4V9r
*/
...
contract pawtential is ERC20Detailed, Ownable {
    ...
    uint256 public Development = 2;
    uint256 public sellFee = 0;
    uint256 public totalFee =
        liquidityFee.add(Treasury).add(Development);
    ...
    uint256 private gonSwapThreshold = (TOTAL_GONS * 25) / 10000;
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    constructor() ERC20Detailed("Pawtential", "PAWT", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x65Eed456c0676941F9c1e797c8521bafF0520957;
        TreasuryReceiver = 0x65Eed456c0676941F9c1e797c8521bafF0520957;
        DevelopmentReceiver = 0x9917458E85EE42568719F177886A8834B1fbdE25;
    ...
    function _basicTransfer(
       ...
       function checkTxLimit(address sender, uint256 gonAmount) internal view {
        require(gonAmount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHDevelopment = amountETH.mul(Development).div(totalETHFee);
    ...
    function sendAirdrop(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
    ...
    function setFees(
        ...
        Treasury = _Treasury;
        sellFee = _sellFee;
        totalFee = liquidityFee.add(Treasury).add(Development);
    ...
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
         require(maxTXPercentage_base1000 >= 1, "Cannot set maxTransactionAmount lower than 0.1%");
