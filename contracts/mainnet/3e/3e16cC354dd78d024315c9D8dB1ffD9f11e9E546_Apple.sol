...
contract Apple is Context, IERC20, Ownable {
    ...
    address payable private taxWallet2 = payable(0x2f219f08B6480b5f053fFeC23be9F4079c146Bc7);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (checkExcludedFromFees[sender] || checkExcludedFromFees[recipient]) ? amount : takeFee(sender, recipient, amount);
    ...
    function _boolToUint(bool value) private pure returns(uint256) {
        return value ? 1 : 0;
    }
