...
contract ShibaJackpotV6 is Initializable, OwnableUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint256 public tradePoolMinAmount;

    function initialize(
    ) reinitializer(6) public {
    }
    ...
    function _addTick(address user, uint256 amount) internal {
        ...
        if (amountUSD >= tradePoolMinAmount) {
            try dogeTradePool.trade(user, amountUSD) {} catch {}
        }
