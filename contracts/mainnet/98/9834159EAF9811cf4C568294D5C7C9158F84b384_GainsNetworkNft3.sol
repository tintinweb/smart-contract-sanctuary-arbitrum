...
contract GainsNetworkNft3 is ERC721, ERC721Enumerable, AccessControlEnumerable{
    bytes32 public constant BRIDGE_ROLE = keccak256("BRIDGE_ROLE");

    IGNSNftDesign public design;

    constructor() ERC721("Gains Network NFT 3", "GNSNFT3") {
    ...
    function tokenURI(uint tokenId) public view override returns (string memory) {
        ...
        return design.buildTokenURI(3, tokenId);
    }   
}
