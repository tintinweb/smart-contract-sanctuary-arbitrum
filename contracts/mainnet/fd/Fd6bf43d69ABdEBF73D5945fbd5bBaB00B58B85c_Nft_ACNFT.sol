...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	...
	function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
		...
		return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, (tokenId + 1).toString(), ".png")) : "";
	}
	...
	function _baseURI() internal view virtual returns (string memory) {
		return "https://ipfs.io/ipfs/QmSqoZyzYWXBtnhAmA5DtaVv1u9RovJ6y2B1mDfgpwVLXu/";
	}
...
contract Nft_ACNFT is ERC721Enumerable {
	...
	uint256 public mint_NativePrice = uint256(500000000000000);
 ...
 * checks that ((totalSupply) + (_amt)) is less than or equals to 4000
...
*/
	function mint(uint256 _amt) public payable {
		require(((totalSupply() + _amt) <= uint256(4000)), "Exceeded Total Supply");
