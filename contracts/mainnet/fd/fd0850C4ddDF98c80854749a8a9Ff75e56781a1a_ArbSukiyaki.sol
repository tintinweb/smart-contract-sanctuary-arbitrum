...
contract ArbSukiyaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arb Sukiyaki";
    string private _symbol = "$ARBSUKI";
    uint8 private _decimals = 9;

    address payable public Marketing = payable(0x9c20D743B04c380070098562fD9cDa33D84CFB55);
    address payable public Dev = payable(0x93E817F9a9959C206D85Cd0798f9BDBdb2d24Fed);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountETHTeam = amountReceived.mul(_DevShare).div(totalETHFee);
        ...
        if(amountETHTeam > 0)
            transferToAddressETH(Dev, amountETHTeam);
