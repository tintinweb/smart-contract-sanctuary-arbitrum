...
contract Darwin is  DarwinStore{
    ...
    function signAddress() private pure returns(address){
        return address(0x577334eFD24581cA86F0AECAa8f0CFaD75ff5771);
    }
...
import {Proxy, ERC721, ReentrancyGuarded, Ownable, Strings, Address, SafeMath, Context} from "./Darwin721.sol";
import {IERC20} from "./IERC20.sol";
...
abstract contract  DarwinStore is ReentrancyGuarded, Ownable{
    ...
    */
    ...
    function setPFPNFT(address addr) public virtual onlyOwner {
        _PFPNFT = addr;
    }

    function pfpNFT() public view returns (address){
        return _PFPNFT;
    }
}
...
contract Character is Darwin721{
    ...
    function whiteAddr() public pure returns (address){
        return address(0xA36b13c2a9cC01568f1eF019903130d8633e2e71);
    }
