...
contract ZODIAC is Context, IERC20, Ownable {
    ...
    address payable public operationsWallet = payable(0x749F89477a52E2B556d04Cc8C08Ca8ed336D9965);
    address payable public devWallet = payable(0x749F89477a52E2B556d04Cc8C08Ca8ed336D9965);
 ...
 IDEXRouter public router;
    ...
    function setSellTaxes(uint _Liquidity, uint _operations , uint _dev) public onlyOwner {
        ...
        _selldevFee = _dev;
        _totalTaxIfSelling = _sellLiquidityFee.add(_selloperationsFee).add(_selldevFee);
	require(_totalTaxIfSelling <= 50, "Fees cannot be more than 50%");
    }
