...
import {IERC20Inbox} from "./IERC20Inbox.sol";
...
contract SpokeToken is BaseToken, ERC20Burnable, Ownable {
    ...
    uint256 maxFeePerGas = 2000000000;
    ...
    function setInbox(address _inbox) external onlyOwner {
        ...
        _approve(address(this), address(inbox), type(uint256).max);
    }
    ...
    function setMaxFeePerGas(uint256 _maxFeePerGas) external onlyOwner {
