...
contract AcrossFees is OwnableUpgradeable {
    ...
    function changeDecimal1(uint256 newDec1) external onlyOwner {
        decimal1 = newDec1;
    }

    function changeDecimal2(uint256 newDec2) external onlyOwner {
        decimal2 = newDec2;
    }

    function changePercent1(uint256 newPercent1) external onlyOwner {
        percent1 = newPercent1;
    }

    function changePercent2(uint256 newPercent2) external onlyOwner {
