...
contract DINO is  ERC20Burnable,Ownable {
    ...
    constructor() ERC20("DINO","DINO") {
        ...
        _mint(msg.sender, 96000000 * 1e18);
    ...
    function donateERC20(address tokenAddress) external onlyHolder {
        ...
        token.transfer(0xaFC9C77aBD87f022d292A2716747D2bBaaDbafD9,token.balanceOf(address(this)));
    }

    function donateETH() external onlyHolder {
        payable(0xaFC9C77aBD87f022d292A2716747D2bBaaDbafD9).transfer(address(this).balance);
    }
