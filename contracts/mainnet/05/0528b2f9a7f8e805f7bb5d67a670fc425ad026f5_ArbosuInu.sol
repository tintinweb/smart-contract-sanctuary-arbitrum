...
contract ArbosuInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Arbosu Inu";
    string constant _symbol = "ARBOSU";
    ...
    uint256 public _maxTxAmount = 200 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // Receivers! 
        autoLiquidityReceiver = 0x1c21b84Ab0713eCbCF0D14926733E97FbCeF0d7D;
        marketingWallet = 0x1c21b84Ab0713eCbCF0D14926733E97FbCeF0d7D;
        devWallet = 0x1c21b84Ab0713eCbCF0D14926733E97FbCeF0d7D;
