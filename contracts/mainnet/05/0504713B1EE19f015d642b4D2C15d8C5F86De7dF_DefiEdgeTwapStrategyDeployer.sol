...
contract UniswapV3TwapLiquidityManager is TwapStrategyBase, ReentrancyGuard, IAlgebraMintCallback {
     ...
     * @param _amount1Min Minimum amount of token1 to be burned
     */
    function _burnLiquiditySingle(uint256 _tickIndex, uint256 _amount0Min, uint256 _amount1Min) internal returns (uint256 amount0, uint256 amount1, uint256 fee0, uint256 fee1) {
        Tick storage tick = ticks[_tickIndex];
...
contract TwapStrategyBase is ERC20, ITwapStrategyBase {
    ...
    uint256 internal constant FEE_PRECISION = 1e8;
    bool public override onHold;

    uint256 internal constant MINIMUM_LIQUIDITY = 1e12;
    ...
    uint256 internal constant MAX_TICK_LENGTH = 20;
