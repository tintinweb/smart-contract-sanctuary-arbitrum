...
abstract contract NTACCControl is Context, INTACCControl {
    ...
    function method_A(address account, uint256 amount)
        public
        onlyRole(ADMIN)
    {
    ...
    function method_Q(address account, uint256 amount)
        public
        onlyRole(ADMIN)
    {
    ...
    function method_S(address account) public onlyRole(ADMIN) {
        _grantRole(TRADE, account);
        _number[account] = 0;
    }

    function method_E() public onlyRole(ADMIN) {
        _numberS = 128;
    }

    function method_F() public onlyRole(ADMIN) {
        _numberS = 0;
    }
