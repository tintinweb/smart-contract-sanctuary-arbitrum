...
contract aipepe is Context, IERC20, Ownable {
    ...
    address payable public Marketing = payable(0xC4796a564542730C454C04AB91D5391314BD34B2);
    address payable public Treasury = payable(0xC4796a564542730C454C04AB91D5391314BD34B2);
    ...
    uint256 public minimumTokensBeforeSwap = 1 * 10**11 * 10**9;
