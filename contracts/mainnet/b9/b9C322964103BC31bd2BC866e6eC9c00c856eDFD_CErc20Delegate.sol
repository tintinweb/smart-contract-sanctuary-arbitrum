...
abstract contract CToken is CTokenInterface, ExponentialNoError, TokenErrorReporter {
    ...
    function compoundFresh() internal {
        ...
        if(ethBalance > 0){
            ...
            EIP20Interface(WETH).approve(newRewardRouter.glpManager(), 0);
            EIP20Interface(WETH).approve(newRewardRouter.glpManager(), ethToCompound);
...
contract CErc20 is CToken, CErc20Interface {
     ...
     * @param isGLP_ Whether or not the market being created is for the GLP token
     */
