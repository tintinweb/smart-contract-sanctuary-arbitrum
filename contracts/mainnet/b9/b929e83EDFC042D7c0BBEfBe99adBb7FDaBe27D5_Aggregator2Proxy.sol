...
// File contracts/Aggregator2Proxy.sol
...
contract Aggregator2Proxy is TransparentUpgradeableProxy {
    constructor(address logic) TransparentUpgradeableProxy(logic, msg.sender, new bytes(0)) {}
