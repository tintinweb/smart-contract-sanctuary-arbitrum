 ...
 * @author Josh Davis
 * @notice This plugin adds the freeMint() function
 */

interface IFreeMintHybridPlugin {
    /**
...
contract FreeMintHybridPlugin is ViciERC20HybridPlugin {
    bytes4 constant FREE_MINT = IFreeMintHybridPlugin.freeMint.selector;
