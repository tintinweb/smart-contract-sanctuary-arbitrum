...
contract WXRP20 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Wrapped XRP2.0";
    string private constant _symbol = "WXRP2.0";
    ...
    address payable private _developmentAddress = payable(0x0512c39f8fe0Baafc5AE24dA932F6785c75FA134);
    address payable private _marketingAddress = payable(0x0512c39f8fe0Baafc5AE24dA932F6785c75FA134);
