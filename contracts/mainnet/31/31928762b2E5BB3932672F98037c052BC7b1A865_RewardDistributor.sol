    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _rewardToken, address _rewardTracker)
        external
        initializer
    {
...
interface IRewardDistributor is IAdmin {
...
interface IRewardTracker {
    ...
    function redeem(uint256[] calldata _indexes) external returns (uint256);
