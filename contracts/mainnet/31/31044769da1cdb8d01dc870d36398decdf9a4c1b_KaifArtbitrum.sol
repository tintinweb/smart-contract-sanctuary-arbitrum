...
contract KaifArtbitrum is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("KaifArtbitrum", "KA") {
        _mint(msg.sender, 89898989 * 10 ** decimals());
    }
