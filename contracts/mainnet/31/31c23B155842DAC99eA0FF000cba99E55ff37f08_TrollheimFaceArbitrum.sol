...
/*
Arb TROLLHEIM FACE  is a meme token that was launched on the Arbitrum network, with the aim of creating a centralized meme token so that all investors get security and comfort in investing.

ARB TROLLHEIM FACE will create a meme token with strong holders that can compete in the Cryptocurrency market, so that all winners can enjoy the results of investing in the future. 

The goal of the project is to create a secure, reliable and valuable token for the community, team and investors.
...
contract TrollheimFaceArbitrum is IBEP20, Auth {
    ...
    address constant DEV = 0xEA6BFbc313D57fC9E23fF9776A94dE5Ea65D1102;


    string constant _name = "TROLLHEIM FACE ARBITRUM";
    string constant _symbol = "TFARB";
