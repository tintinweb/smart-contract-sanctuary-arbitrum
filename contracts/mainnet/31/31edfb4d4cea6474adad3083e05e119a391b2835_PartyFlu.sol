...
contract PartyFlu is IBEP20, Auth {
    ...
    uint256 liquidityFee = 5; // get it juicing
    uint256 devFee = 0;
    uint256 marketingFee = 10;
    uint256 referralFee = 0; // referral fee = 4% of buy in native sick
    uint256 public minSupplyForReferralReward = (_totalSupply * 5) / 1000;
    address private marketingFeeReceiver = 0xE9C77FA5CcEae52A7891d0EDFFc7314300ae204E; // deployer
    address private devFeeReceiver = 0xE9C77FA5CcEae52A7891d0EDFFc7314300ae204E; // deployer, doesn't receive
