  ...
  PausableUpgradeable
{
  ...
  function initialize(
    ...
    baseDecimals = 10 ** 18;
    usdtDecimals = 10 ** IERC20MetadataUpgradeable(_usdt).decimals();
  ...
  function buyWithUSDT(
    ...
    bool success = USDT.transferFrom(_msgSender(), address(this), price);
  ...
  function startClaim(
    ...
    tokenDecimals = 10 ** IERC20MetadataUpgradeable(_saleToken).decimals();
  ...
  function withdraw(address payable recipient) external {
    ...
    require(USDT.transfer(recipient, usdtBalance), "Token transfer failed");
  }
}