...
contract IE {
    ...
    /// @dev Returns resulting percentage change of ETH or token balance for command safety scoring.
        ...
        returns (uint256 percentage)
    {
        unchecked {
            ...
            return amount / (token == ETH ? user.balance : _balanceOf(token, user)) * 100;
        }
    }
