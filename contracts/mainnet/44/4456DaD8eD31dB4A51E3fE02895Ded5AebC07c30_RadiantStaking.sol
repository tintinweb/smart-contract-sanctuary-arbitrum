    ...
    IRadiantStaking
{
    ...
    function claimARBMerkl( 
        ...
        rArbTokenAddress[0] = 0x2dADe5b7df9DA3a7e1c9748d169Cd6dFf77e3d01; // rArb Token address
        ...
        ILendingPool(lendingPool).withdraw(0x912CE59144191C1204E64559FE8253a0e49E6548, afterRArbBalance - beforeRArbBalance, msg.sender);
    }
