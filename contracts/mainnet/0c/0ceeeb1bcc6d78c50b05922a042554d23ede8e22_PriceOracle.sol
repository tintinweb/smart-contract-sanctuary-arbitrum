/**
 *Submitted for verification at Arbiscan on 2022-05-16
*/
...
// File: contracts/libraries/V3Oracle.sol
...
// File: contracts/libraries/UniswapV3TwapGetter.sol
...
contract PriceOracle is IPriceOracle, Initializable {
    ...
    function getPremiumFraction(address amm) external view override returns (int256) {
        ...
        return ((int256(marketPrice) - int256(indexPrice)) * 1e18) / (240 * 3600) / int256(indexPrice);
    }
