    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 2000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQD1WJE1ASYpEQAyTZugVKeea8ZAV4m2y7pztPqSUncY9/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MQ93bp03ak2oXhPiALu4/contract-metadata";
  }
