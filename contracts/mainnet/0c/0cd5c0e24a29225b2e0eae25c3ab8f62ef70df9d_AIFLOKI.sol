...
contract AIFLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x206351CB685472bB8cFF824508531EEeF5A3E5f1); 
    address payable public reserveWalletAddress = payable(0x953C1aE3676697A19094584cDd32AA5676718219); 
    address payable public stakingWalletAddress = payable(0x526367dCE8494ef6e4B881D6a644328252b7fB5f); 
    address payable public devWalletAddress = payable(0x212943195da44c1822c2bCa74AdE39d0120C5F2F); 
    ...
    external onlyOwner 
    {
        ...
        require(totalSwapableFee + totalSwapableSaleFee <= 35, "Must be less than 35% total");
