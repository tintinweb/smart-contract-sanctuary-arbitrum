...
contract JBProtocolFeePercentagesProvider is IProtocolFeePercentagesProvider, SingletonAuthentication, Ownable {
    ...
    function registerFeeType(
        ...
        uint256 maximumValue,
        uint256 initialValue
    ) external override onlyOwner { // replaced authenticate with onlyOwner
