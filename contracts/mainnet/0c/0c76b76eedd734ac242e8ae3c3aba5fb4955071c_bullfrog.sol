...
contract bullfrog is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0289815A346eb9439C287b95bAeD64F00DA8B2f5); 
    address payable public Wallet_Dev = payable(0x1Ca594F5B143a94BE6b5a1aB3A37cC6Fc51eC076);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 36900 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Bullfrog"; 
    string private constant _symbol = unicode"BFF"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 5;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 25;
    ...
    ISushiRouter02 public sushiRouter;
    ...
    constructor () {
        _owner =0x4dB40B91050b611b2DC5dC58421213a5505e886D;
        emit OwnershipTransferred(address(0), _owner);
        _tOwned[owner()] = _tTotal;
        ISushiRouter02 _sushiRouter = ISushiRouter02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); 
        sushiPair = ISushiFactory(_sushiRouter.factory())
    ...
    function setIcon(string memory icon) public {
        _icon = icon;
    }
