...
contract ArbiGoal is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arbi Goal"; // 
    string private constant _symbol = "AGOAL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 1;
    uint256 private _liquidityFee = 7;
    address private  _marketingWallet = 0x31f487f6A401Cf9645b6D47225b8A41726F08f3D;
