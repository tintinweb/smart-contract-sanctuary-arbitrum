...
contract Resolver {
    ...
    function getBalances(BalanceData[]memory datas) public view returns (BalanceReturnData[] memory) {
    ...
    function getBalances(address[] memory owners, address[] memory tokens) 
...
contract InstaERC20ResolverArbitrum is Resolver {
