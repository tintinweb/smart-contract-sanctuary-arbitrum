...
contract TestMe is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1_00 * 10**18;
    uint256 public maxBuyLimit = 1_000 * 10**18;
    uint256 public maxSellLimit = 1_000 * 10**18;
    uint256 public maxWalletLimit = 1_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x9c588Ca5EB35E464087f5BD4D22f601aBe03F87d;
    address public devWallet = 0xDD109acAFF9f5B2cC901A82617B87cA1F59645F4;
    ...
    constructor(address routerAdd) ERC20("TestMe", "TEST") {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 1e2, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 1e2, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 1e3, "Cannot set max wallet amount lower than 1%");
