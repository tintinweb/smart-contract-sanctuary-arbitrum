...
contract woofinarbitrum is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "woofin arbitrum";
    ...
    uint256 public _walletMax = _totalSupply * 40 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0a6f99F37d2e7f596F9cd06F6F695dF69457BeCe;  // marketingwallet
        lotteryWallet = 0x6100AA56Fd1148949D899135dFc51456d8174184;  // no tax for lotterywallet
