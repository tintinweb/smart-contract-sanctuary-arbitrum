/**
 *Submitted for verification at Arbiscan on 2022-03-16
*/

// SPDX-License-Identifier: MIT
/*
treasury wallet :  0xa1cF8b6607241970656741b25cc8C1679bAe5BF3
dev wallet: 0x7209F8F1A7956817A1D7Ce011DE9610F5D534bf7
Website: https://smolprinter.com/
Twitter: https://twitter.com/SmolPrinter
Launch date: 16 March 2022


 _____                 _      ______     _       _            
/  ___|               | |     | ___ \   (_)     | |           
\ `--. _ __ ___   ___ | |     | |_/ / __ _ _ __ | |_ ___ _ __ 
 `--. \ '_ ` _ \ / _ \| |     |  __/ '__| | '_ \| __/ _ \ '__|
/\__/ / | | | | | (_) | |     | |  | |  | | | | | ||  __/ |   
\____/|_| |_| |_|\___/|_|     \_|  |_|  |_|_| |_|\__\___|_|   
...
contract DividendDistributor  {
    ...
    // magic; 
    IERC20 EP = IERC20(0x539bdE0d7Dbd336b79148AA742883198BBF60342); // MAGIC
...
// File: smolprinter.sol


pragma solidity ^0.8.7;
contract smolprinter is Auth {
  ...
  string constant _name =  "Smol Printer";    
  string constant _symbol = "BRR";        
  uint8 constant _decimals = 9;

  uint256 _totalSupply = 1_000_000 * 100 * (10 ** _decimals);
  ...
  // 2% Goes to the reflections for token holders; 
  uint256 reflectionFee = 200; // %2
  // 8% Goes to the Treasury team;
  uint256 marketingFee = 800; 
  // 0% Goes to the dev team; 
  uint256 devFee = 0;
