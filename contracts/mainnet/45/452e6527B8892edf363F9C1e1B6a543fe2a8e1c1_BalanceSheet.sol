...
import {IConfigurations} from "./interfaces/IConfigurations.sol";
import {IPremuimPricer} from "./interfaces/IPremuimPricer.sol";
...
interface IBalanceSheet {
    ...
    function getMaxBorrow() external view returns (uint256 maxBorrow);
