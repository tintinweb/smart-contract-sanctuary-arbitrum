...
contract PepeDeathDistributor is Ownable {
    IERC20 public token;
    mapping(address => bool) public whitelist;

    uint256 public claimableSupply = 2_000_000 * 1e18;
    uint256 public claimedSupply = 0;
    uint256 public claimAmount = 20_000 * 1e18; // Fixed amount each user can claim

    bool isClaimLive = false;
