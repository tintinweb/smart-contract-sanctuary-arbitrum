...
/**
 * @title pALEO Pool V2 Contract
 * @author GAST-TEAM
 * @notice In this contract user can stake GAST and harvest pALEO
 */
contract pALEOPoolV2 is AccessControlEnumerable, ReentrancyGuard {
    ...
    event SetAddrs(address gastAddr, address paleoAddr);
    ...
    function setAddrs(
        ...
        require(
            gastAddr != address(0) && paleoAddr != address(0),
        ...
        emit SetAddrs(gastAddr, paleoAddr);
    }
