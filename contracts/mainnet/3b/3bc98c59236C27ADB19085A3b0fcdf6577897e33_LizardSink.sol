...
contract LizardSink is IERC20 {

  string public constant symbol = "SlizSink1";
  string public constant name = "SolidLizard sink token 1";
  ...
  constructor() {
    minter = msg.sender;
    _mint(msg.sender, 1000000000000000000); //1
  }
