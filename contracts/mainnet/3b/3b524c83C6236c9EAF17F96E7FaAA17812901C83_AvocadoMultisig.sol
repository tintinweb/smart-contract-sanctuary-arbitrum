...
abstract contract AvocadoMultisigCast is AvocadoMultisigCore {
    ...
    function simulateCast(
        ...
        return _simulateCast(params_, forwardParams_, signaturesParams_, new bytes32[](0), false);
    }
    ...
    function estimateCast(
        ...
        return _simulateCast(params_, forwardParams_, signaturesParams_, new bytes32[](0), true);
    }
}
