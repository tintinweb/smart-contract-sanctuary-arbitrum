...
/*
🐰 Easter Arb 🐰
A meme cryptocurrency project on Arbitrum Network based on the upcoming Easter Holiday. 

TOKENOMICS 
Total Supply: 1m
Tax: 5/5 (3% Mw, 1% LP, 1% Auto Buybacks) 
Max Wallet: 2% 
Max TxLimit: 2%

Telegram: @easterarb
Twitter: https://twitter.com/easterarbitrum
Medium: https://medium.com/@easterarb
Linktree: https://linktr.ee/easterarb

#easterarb #easterarbmoonshot #eastergem #arbitrumgem
*/
...
contract EasterArb is IBEP20, Auth {
    ...
    address constant DEV = 0x3813e2aae7D379d55834018C547f7C4a587d2395;


    string constant _name = "Easter Arb";
    string constant _symbol = "$EARB";
