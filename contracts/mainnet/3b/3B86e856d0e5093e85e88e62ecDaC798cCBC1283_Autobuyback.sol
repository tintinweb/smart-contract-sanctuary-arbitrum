...
AutoBuyBack utility makes buybacks on all purchases and sells to help sustain the chart. 

https://t.me/autoBuyBack
...
contract Autobuyback is ERC20, Ownable {
    ...
    // Digit is a %
    uint256 public walletDigit = 10;
    uint256 public transDigit = 10;
    ...
    constructor(address _feesManagerAddress) ERC20("AutoBuyBack", "aBB") {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0x0c24D7f511C57b4E9Bf9652a9D87279763FC974e || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
