...
contract PIRATE is ERC20, Ownable {
    ...
    string constant _name = "PIRATE";
    string constant _symbol = "PIRATE";
    ...
    address public marketingFeeReceiver = 0xEE0070D25e807cBcd160250a18BF24B17311E590;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x783F150aeD55bf8C3C66400e9bfE999Db7588e2f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x783F150aeD55bf8C3C66400e9bfE999Db7588e2f] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x783F150aeD55bf8C3C66400e9bfE999Db7588e2f,
                block.timestamp
            );
