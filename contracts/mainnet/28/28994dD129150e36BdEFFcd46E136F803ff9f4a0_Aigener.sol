...
Tackle development of all kind without the necessary skills/abilities.
Generate Videos, Games, Movies, Assets and much more easily.

🤖 aigener.org
🤖 telegram: t.me/aigenerchat
*/
...
contract Aigener is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Aigener", "Aigener") {
        ...
        marketingWallet = address(0xD5042390E7Ba79A2fa16816D18a4692640116386); // set as marketing wallet
        devWallet = address(0xD5042390E7Ba79A2fa16816D18a4692640116386); // set as dev wallet
