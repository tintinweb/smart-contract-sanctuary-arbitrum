...
contract Stimpak is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor(address initialOwner)
        ERC20("Stimpak", "STIM")
        Ownable(initialOwner)
        ERC20Permit("Stimpak")
    {
        _mint(initialOwner, 50000000 * 10 ** decimals());
    }
