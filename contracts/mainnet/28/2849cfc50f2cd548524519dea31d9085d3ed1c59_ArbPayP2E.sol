...
$ARK aims to be the flagship token of the Defi 3.0 Ecosystem.

// TELEGRAM: https://t.me/ArbPayP2E
// Twitter: https://twitter.com/ArbP2e
...
contract ArbPayP2E is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ArbPayP2E";
    string constant _symbol = "ARBPAY";
    ...
    uint256 public _maxTxAmount = 25 * 10**4 * (10 ** _decimals);
    uint256 public _walletMax = 25 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4479D498a58b59fF53274eCcD938C24780e320fA;
        marketingWallet = 0x4479D498a58b59fF53274eCcD938C24780e320fA;
        devWallet = 0x4479D498a58b59fF53274eCcD938C24780e320fA;
