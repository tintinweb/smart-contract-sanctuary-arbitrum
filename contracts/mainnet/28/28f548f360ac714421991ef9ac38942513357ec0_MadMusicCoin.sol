...
contract MadMusicCoin is ERC20, Ownable {
    ...
    string constant _name = "MadMusicCoin";
    string constant _symbol = "MMC";
    ...
    address public marketingFeeReceiver = 0x384b1291Ef1985BC7AB5a639A3Ac152958B78198;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x384b1291Ef1985BC7AB5a639A3Ac152958B78198] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x384b1291Ef1985BC7AB5a639A3Ac152958B78198] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x384b1291Ef1985BC7AB5a639A3Ac152958B78198,
                block.timestamp
            );
