...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xcE6aF844D8F3C9B72E095B72FBeB997C214E6eB7;
...
contract firetrum is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIRETRUM"; // 
    string private constant _symbol = "FIRETRUM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x438B00b286389BDF1c271710E9d1881d4d52C2f6);
    ...
    function adjustFees(uint256 newmarketingFee, uint256 newliquidityFee) external onlyOwner {
    ...
    function maxTxAmount(uint256 newTxAmount) external onlyOwner() {
