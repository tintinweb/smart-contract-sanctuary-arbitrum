...
contract SingleRewardTracker is ISingleRewardTracker, UpgradeableOperableKeepable {
    ...
    function _updateRewards(address _account) private {
        ...
        if (tokenOption) {
            ...
            if (minAmount > 0) {
                rewards = rewards1.add(rewardsSwapper.swap(tokenIn, rewards0, address(rewardToken), minAmount, ""));
            } else {
                rewards = rewards1;
            }
        } else {
            ...
            if (minAmount > 0) {
                rewards = rewards0.add(rewardsSwapper.swap(tokenIn, rewards1, address(rewardToken), minAmount, ""));
            } else {
                rewards = rewards0;
            }
        }
