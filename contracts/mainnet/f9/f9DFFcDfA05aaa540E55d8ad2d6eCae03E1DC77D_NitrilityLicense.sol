        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "License(string tokenURI,string artistId,bytes32 creator,bytes32 advertisement,bytes32 tvSeries,bytes32 movie,bytes32 videoGame,bytes32 aiTraining)"
                        ),
