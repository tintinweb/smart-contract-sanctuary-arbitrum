...
contract BLUEY is ERC20, Ownable {
    ...
    constructor() ERC20("BLUEY", "BLUEY") {
        ...
        uint256 totalSupply = 690_000_000_000 * 1e18; // 100.000.000.000 Total Supply

        maxTransactionAmount = 6_900_000_000 * 1e18; // 
        maxWallet = 6_900_000_000 * 1e18; // 1% 
        ...
        marketingWallet = address(0xfeC0f942aFB75E0E95e92f3E0105cf19bBa2D6Af); // set as marketing wallet
        devWallet = address(0xfeC0f942aFB75E0E95e92f3E0105cf19bBa2D6Af); // set as dev wallet
