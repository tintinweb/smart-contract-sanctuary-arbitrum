...
abstract contract LzApp is ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function setAdmin(address _lzAdmin) external {
        require(msg.sender == lzAdmin);
        require(_lzAdmin != address(0));
        lzAdmin = _lzAdmin;
    }
...
contract DegenToken is OFT, Ownable {
    /// @notice The chain ID of the main chain (Arbitrum)
    uint256 public constant MAIN_CHAIN_ID = 10;
    ...
    */
    constructor(
        ...
        address _lzAdmin,
        uint256 _maxSupply
    ) OFT(_name, _symbol, _lzEndpoint, _lzAdmin) Ownable() {
