...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USD = IBEP20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = USD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            USD.transfer(shareholder, amount);
...
contract ArbitrumClassic is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x14C943FdbE910422325Fe89E5C7582Fd7e24c3EC;

    string constant _name = "ARBITRUM CLASSIC";
    string constant _symbol = "$ARBC";
    uint8 constant _decimals =  9;

    uint256 _totalSupply = 9999999999 * (10 ** _decimals);
