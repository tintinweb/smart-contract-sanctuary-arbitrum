    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0x912CE59144191C1204E64559FE8253a0e49E6548));
...
contract PooNomics is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PooNomics", "PooNomics") {
        uint256 totalSupply = 1 * 1e6 * 1e18;

        swapTokensAtAmount = (totalSupply * 3) / 10000; // 0.03% swap tokens amount
        ...
        operationsWallet = address(0xaE36A4FAf83745B0D23f6a9152aFb2ec421dCAE9); // set as operations wallet
