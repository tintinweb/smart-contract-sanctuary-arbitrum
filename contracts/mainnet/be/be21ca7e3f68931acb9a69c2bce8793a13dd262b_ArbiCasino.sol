...
Website: https://arbicasino.com/
Twitter: https://twitter.com/arbicasino
TG:      https://t.me/ArbiCasino_Official
...
contract ArbiCasino is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 Sushiswap
    ...
    constructor() ERC20("AribCasino v2", "CASINOv2") {
        ...
        uint256 _buyLiqFee =3;
        uint256 _buyDevFee = 3;
        uint256 _buyOperationsFee = 3;
        
        // launch sell fees
        uint256 _sellMarketingFee = 2;
        uint256 _sellLiqFee = 2;
        uint256 _sellDevFee = 3;
        uint256 _sellOperationsFee = 3;

        uint256 totalSupply = 1_000_000 * 1e18;

        maxTransactionAmount = 40_000 * 1e18; // 2% max txn at launch
        maxWallet = 40_000 * 1e18; // 2% max wallet at launch
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% swap wallet

        buyMarketingFee = _buyMarketingFee;
        buyLiqFee = _buyLiqFee;
        buyDevFee = _buyDevFee;
        buyOpsFee = _buyOperationsFee;
        buyTotalFees = buyMarketingFee + buyLiqFee + buyDevFee + buyOpsFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiqFee = _sellLiqFee;
        sellDevFee = _sellDevFee;
        sellOpsFee = _sellOperationsFee;
        sellTotalFees = sellMarketingFee + sellLiqFee + sellDevFee + sellOpsFee;

        marketingWallet = address(0xE94fc53348DfBD1f5B16370cE64e5eF30a8d55AA); 
        devWallet = address(0xE94fc53348DfBD1f5B16370cE64e5eF30a8d55AA); 
        liqWallet = address(0xE94fc53348DfBD1f5B16370cE64e5eF30a8d55AA); 
        operationsWallet = address(0xE94fc53348DfBD1f5B16370cE64e5eF30a8d55AA);
    ...
    function swapBack() private {
        ...
        (success, ) = address(operationsWallet).call{value: ethForOps}("");
