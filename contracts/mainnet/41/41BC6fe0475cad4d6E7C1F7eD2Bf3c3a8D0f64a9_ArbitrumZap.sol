...
import "./ArbitrumZapInitializer.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";

/// @dev verified, public contract
/// @dev ceratin functions only owner callable
contract ArbitrumZap is IZap, IZapEvent, Ownable, ArbitrumZapInitializer {
    using SafeMath for uint256;
    ...
    constructor(address _constants, uint24 _slippageToleranceNumerator) ArbitrumZapInitializer(_constants) {
...
contract ArbitrumZapInitializer {
