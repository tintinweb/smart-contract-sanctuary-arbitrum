...
// File: contracts/TriggerAccessControl.sol


pragma solidity ^0.8.20;


contract TriggerAccessControl is AccessControl {
    ...
    fallback(bytes calldata data) external payable onlyRole(TRIGGER_ROLE) returns (bytes memory) {
