...
contract ChainlinkLPOracle is AggregatorV3Interface {
    ...
    function priceFor(uint256 amount) external view returns (uint256) {
        return (amount * _fetchPrice()) / 1e18;
    }
    ...
    function _fetchPrice() internal view returns (uint256) {
        ...
        // price of 1 token in e18
        uint256 lpPriceE18 = uint256(
            _scalePriceByDigits(totalInLPQuote(), 8, oracleDecimals)
        );
        uint256 price18 = (lpPriceE18 * 1e18) / totalSupply;
