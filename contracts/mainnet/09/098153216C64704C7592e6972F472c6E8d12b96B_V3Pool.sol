...
contract V3Pool is IV3Pool, V3PoolOptions, NoDelegateCall {
    ...
    function transferFromPool(
        ...
        // console.log("transferFromPool, amount:", amount);
        ...
        returns (int256 amount0, int256 amount1)
    {
        ...
        while (
            ...
            // console.log("step.feeCoefficient");
            // console.log(step.feeCoefficient);
            ...
            console.log("Fee amount: %s",step.feeAmount);
...
import {IUniswapV3Pool} from "./interfaces/IUniswapV3Pool.sol";
import {IV3PoolOptions} from "./interfaces/IV3PoolOptions.sol";
