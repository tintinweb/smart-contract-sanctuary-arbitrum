...
contract AirPuff1XrsETH is AirPuff1X {
    ...
    function initialize(address _rsETH) external initializer {
        require(_rsETH != address(0), "AirPuff: rsETH address is invalid");
        ...
        __ERC20_init("AirPuff-EtherFi1X", "brsETH1X");
    }
}