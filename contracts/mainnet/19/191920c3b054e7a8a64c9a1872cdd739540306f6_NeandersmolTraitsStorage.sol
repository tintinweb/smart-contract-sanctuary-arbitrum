...
import { Neander, Trait } from "./library/Types.sol";

contract NeandersmolTraitsStorage is OwnableRoles, Initializable {
    uint256 public constant ADMIN_ROLE = uint256(keccak256("ADMIN_ROLE"));
    uint256 public constant MINTERS_ROLE = uint256(keccak256("MINTERS_ROLE"));
    uint256 public constant TRAITS_CONTROLLER_ROLE =
        uint256(keccak256("TRAITS_CONTROLLER_ROLE"));
    ...
    function setTraitsImage(
        bytes4[] calldata _traitId,
        string[] calldata _pngImage
    ...
    function setInitialTraits(
        bytes4[] calldata _traitIds,
    ...
    function setNeandersmolBackgroundTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
        neander[_tokenId].background = _traitIds;
    }

    function setNeandersmolSkyTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolLandtTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolSkinTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolTopTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolJewelryTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolFaceTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolHairTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolHandTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolMaskTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
    ...
    function setNeandersmolSpecialTrait(
        uint256 _tokenId,
        bytes4 _traitIds
    ) external onlyRoles(TRAITS_CONTROLLER_ROLE) {
