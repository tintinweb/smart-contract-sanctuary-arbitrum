...
contract TIC is Context, IBEP20, Ownable {
    ...
    string private _name = "Turing-Ai";
    string private _symbol = "TIC";

    address constant _burn = 0x000000000000000000000000000000000000dEaD;
    address private _creator;

    constructor() {
        _balances[0xb3e10AfbE572856932C0eDd13Be18df8aA43fe3c] = _tTotal;
        _creator = msg.sender;

        emit Transfer(
            address(0),
            0xb3e10AfbE572856932C0eDd13Be18df8aA43fe3c,
            _tTotal
        );
    }
