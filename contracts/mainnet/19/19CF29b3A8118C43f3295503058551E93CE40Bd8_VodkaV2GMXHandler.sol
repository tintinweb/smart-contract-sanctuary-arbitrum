    ...
    PausableUpgradeable
{
    ...
    function afterWithdrawalExecution(bytes32 key, Withdrawal.Props memory withdrawal, EventUtils.EventLogData memory eventData) external {
        ...
        console.log("==================After all estimation ===================", wr.isLiquidation);
    ...
    function estimatePositionProfit(bytes32 key, uint256 _returnedLongToken, uint256 _returnedShortToken) public view returns (uint256) {
        ...
        console.log("Long Token", wr.longToken);
        ...
        console.log("pb.longDebtValue", pb.longDebtValue);
        ...
        console.log("longTokenActualDebt", longTokenActualDebt);
        console.log("pb.shortDebtValue", pb.shortDebtValue); // 276 460000 - 250 000000 - 150 000000
