...
您將購買的第一個中國模因硬幣 並對獲得的收益感到驚訝 立即購買並持有 您將購買的第個中國模因硬幣 立即購買並持有 並對獲得的收益感到驚訝
...
contract ChineseToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = unicode"金融醋栗";
    string private _symbol = unicode"金融醋栗";
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0x2C06D69c54ce867E4aE15510DCC838e575EF57a6));
