...
/**
Aight, let me tell ya 'bout dis Bored Doge Club token. Dis shit is straight-up lit, bruh. You wanna talk 'bout making some dank cash? Look no further than dis mofo.

Now, I ain't no financial advisor or nothin', but I can tell ya dat this token is the real deal. And let me tell ya, we are no joke. We all do whatever it takes to make sure dis token reaches the moon.

And the best part? This ain't just some boring-ass token, my man. It's got a ton of cool shit goin' on. Just stay tuned and bored folks.
TG: https://t.me/BoredDogeClub
*/
...
contract BoredDogeClub  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bored Doge Club";
    ...
    address payable private _developmentAddress = payable(0x7d758C75437D28782BF0B5F5402922Add8E49720); 
    address payable private _marketingAddress = payable(0x7d758C75437D28782BF0B5F5402922Add8E49720);
