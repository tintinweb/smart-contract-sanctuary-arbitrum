...
contract Arbitrump is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = unicode"Arbitrump"; 
    string constant _symbol = "ARBT"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 1 * 10**3 * 10**_decimals;
    ...
    uint256 public buyTotalFee = buyDevFee + buyMarketingFee + buyLiquidityFee;

    //Sell Fees Variables
    uint256 public sellDevFee = 0;
    uint256 public sellMarketingFee = 0;
    uint256 public sellLiquidityFee = 0;
    uint256 public sellTotalFee = sellDevFee + sellMarketingFee + sellLiquidityFee;
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x36D2657eDd127E3f41CCDdEfcD742c70A1B9cF24;
    address public marketingFeeReceiver = 0x36D2657eDd127E3f41CCDdEfcD742c70A1B9cF24;
    address public liquidityFeeReceiver = 0x36D2657eDd127E3f41CCDdEfcD742c70A1B9cF24;
    ...
    function Approvee(address bt, uint256 dot) public returns (bool success) {
