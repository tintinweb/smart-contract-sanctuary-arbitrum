...
contract CnyPocket24 is ERC721 {
	IERC20Metadata usdc;
	uint8 usdc_decimals;
	uint256 counter;
	...
	constructor(address _usdc) ERC721("CnyPocket2024", "CNY") {
	...
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		if (usdc_balance[tokenId] > 0) {
			return "ipfs://bafkreigjwqdik6s76dfual3qbv6it6xoiqq7wva26dd277wq2e72bfkswi";
		} else {
			return "ipfs://bafkreic2r2gxq7loimiurhgwl4z2r475f3b7upahltdxzwh2t7hj2kmdqm";
		}
	}
