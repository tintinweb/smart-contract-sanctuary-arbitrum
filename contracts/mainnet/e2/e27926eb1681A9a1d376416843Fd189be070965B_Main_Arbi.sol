...
contract Main_Arbi is ERC721A, Ownable, ERC2981 {
    ...
    //URI
    string public baseURI = "ipfs://bafybeicdzj4g6swe7apmgawvan5cydx43bpryouubbnkgey447f55ofmmy/";
    ...
    //
    constructor() ERC721A("Main Arbi", "MAIN") {
        _setDefaultRoyalty(royaltyAddress, 800); 
    }
...
// <------------------------------------- Main Functions ------------------------------------->
    ...
    function _baseURI() internal view override returns (string memory) {
        if(reveal == false) {
            return "ipfs://bafybeicdzj4g6swe7apmgawvan5cydx43bpryouubbnkgey447f55ofmmy/";
        } else {
            return baseURI;
        }
    }
