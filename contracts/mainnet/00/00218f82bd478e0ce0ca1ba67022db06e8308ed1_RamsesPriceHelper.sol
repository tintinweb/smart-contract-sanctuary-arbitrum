...
import {FullMath} from "src/libraries/ramses/FullMath.sol";
import {IRamsesV2Pool} from "src/interfaces/pool/ramses/IRamsesV2Pool.sol";
...
library RamsesLibrary {
    ...
    function getPool(address factory, address tokenA, address tokenB, uint24 fee, bytes32 initCodeHash)
        public
        pure
        returns (IRamsesV2Pool)
    {
        return IRamsesV2Pool(computeAddress(factory, getPoolKey(tokenA, tokenB, fee), initCodeHash));
    }
        ...
        returns (uint256 quoteAmount)
    {
        ...
        console2.log("sqrtRatioX96", uint256(sqrtRatioX96));
        console2.log("baseAmount", uint256(baseAmount));
