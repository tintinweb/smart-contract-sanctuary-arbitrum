...
import "./Utils/VotingConstants.sol";
...
contract VotingPower is VotingConstants, Initializable, VotesUpgradeable, Ownable2StepUpgradeable, PausableUpgradeable {
    ...
    /// @notice Update the lode speed constant used in the protocol.
    /// @param newStakingRewards The new staking rewards contract address to update to.
    function _updateStakingRewards(IStakingRewards newStakingRewards) external onlyOwner {
        stakingRewards = newStakingRewards;
        emit StakingRewardsUpdated(stakingRewards, block.timestamp);
    }
}