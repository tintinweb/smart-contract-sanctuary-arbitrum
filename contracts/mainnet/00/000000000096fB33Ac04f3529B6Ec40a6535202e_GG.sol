...
abstract contract PVERC20Votes is IVotes, ERC20Permit {
    struct Checkpoint {
        uint32 fromBlock;
        uint224 votes;
    }
...
abstract contract BaseOFTV2 is ERC165, OFTCoreV2, IOFTV2 {
    constructor(
        uint8 _sharedDecimals,
        address _admin
    ) OFTCoreV2(_sharedDecimals, _admin) {}
...
abstract contract NonblockingLzApp is LzApp {
    ...
    constructor(address _admin) LzApp(_admin) {}
...
contract OFTV2 is BaseOFTV2, ERC20 {
    ...
    constructor(
        ...
        uint8 _sharedDecimals,
        address _admin
    ) ERC20(_name, _symbol) BaseOFTV2(_sharedDecimals, _admin) {
