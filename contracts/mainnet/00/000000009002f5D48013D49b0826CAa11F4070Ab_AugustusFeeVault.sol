...
contract AugustusFeeVault is IAugustusFeeVault, Ownable {
    /*//////////////////////////////////////////////////////////////
                                LIBRARIES
    //////////////////////////////////////////////////////////////*/
    ...
    constructor(address[] memory _augustusContracts) Ownable(msg.sender) {
    ...
    /// @inheritdoc IAugustusFeeVault
    function withdrawAllERC20(IERC20 token, address recipient) public returns (bool success) {
        // Check recipient
        recipient = _checkRecipient(recipient);
    ...
    /// @inheritdoc IAugustusFeeVault
    function registerFee(address account, IERC20 token, uint256 fee) external onlyApprovedAugustus {
    ...
    function _checkRecipient(address recipient) private view returns (address) {
        // Allow arbitray recipient unless it is zero address
