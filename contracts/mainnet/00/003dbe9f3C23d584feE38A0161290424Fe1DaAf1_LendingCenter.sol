    ...
    PausableUpgradeable
{
    ...
    function borrow(
        ...
        uint256 price = LendingPriceManager(priceManager).getPrice();
        uint256 pledgedAmount = this.forecastPledgedAmount(_lendingId, _amount);
        ...
        borrowOrder.pledgedAmount = pledgedAmount;
        ...
        pledgeAmount[borrowOrder.borrower] += pledgedAmount;
