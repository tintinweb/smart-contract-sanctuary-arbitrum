...
import {IBoringERC20} from "../../interfaces/IBoringERC20.sol";
import {IMultipleRewards} from "../../interfaces/IMultipleRewards.sol";
...
import {IDuoMaster} from "../interfaces/IDuoMaster.sol";

contract DuoBaseStrategy is IStrategy, Ownable {
    using SafeERC20 for IERC20;

    IDuoMaster public immutable duoMaster;
    // deposit want token
    ...
    constructor(IDuoMaster _duoMaster, IERC20 _depositToken) {
        duoMaster = _duoMaster;
        depositToken = _depositToken;
        transferOwnership(address(_duoMaster));
    }
