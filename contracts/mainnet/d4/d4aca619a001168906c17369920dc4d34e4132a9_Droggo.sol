...
// TG: https://t.me/YukiYumiOfficial
...
contract Droggo is Context, IERC20, Ownable {
    ...
    uint256 public _maxAccountAmount = 30 * 10**8 * 10**_decimals;
 
    address public marketingAddress = 0x04B08188d83B26954A167fFa877D31625334b20b;
 
    string private constant _name = "YumiYuki";
    string private constant _symbol = "YIYI";
    ...
    function swapAndSendToFee(uint256 tokens, address recipient) private lockTheSwap{
        swapTokensForETH(tokens, recipient);
    }
