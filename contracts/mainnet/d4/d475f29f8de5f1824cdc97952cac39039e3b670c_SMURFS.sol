...
contract SMURFS is ERC20, Ownable {
    ...
    constructor() ERC20("SMURFS", "SMURFS") {
        ...
        marketingWallet = address(0x4612cCa50B5541CFFEdfAf113c92f2FCe1eb9067); // set as marketing wallet
        devWallet = address(0x4612cCa50B5541CFFEdfAf113c92f2FCe1eb9067); // set as dev wallet
