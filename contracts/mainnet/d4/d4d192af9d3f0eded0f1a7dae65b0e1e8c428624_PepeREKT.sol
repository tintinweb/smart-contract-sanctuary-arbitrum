...
PepeRekt - Hold and earn $REKT token
https://t.me/peperektarb
...
contract DividendDistributor is IDividendDistributor {
    ...
    DEX router;
    address routerAddress = 0x1111111254EEB25477B68fb85Ed929f73A960582;
    IERC20 RewardToken = IERC20(0x1D987200dF3B744CFa9C14f713F5334CB4Bc4D5D); //REKT
    ...
    function deposit() external payable override {
        ERC20(WETH).approve(routerAddress, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        ERC20(WETH).deposit{value: msg.value}();
        uint256 balanceBefore = RewardToken.balanceOf(address(this));

        uint256[] memory pools = new uint256[](1);
        pools[0] = 57896044618658097711785492505343728060629568630187398932445064552763852819920;

        router.uniswapV3Swap(
...
contract PepeREKT is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PepeREKT";
    string constant _symbol = "PREKT";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address RewardToken = 0x1D987200dF3B744CFa9C14f713F5334CB4Bc4D5D;
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(lotteryWallet).call{value: amountETHLottery, gas: 30000}("");
