...
Tg : Private before launch 

Twitter : https://twitter.com/ArbifyProtocol/
...
contract ArbiFy is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"ArbiFy"; ////
    string public constant symbol = unicode"ARBIFY"; ////
