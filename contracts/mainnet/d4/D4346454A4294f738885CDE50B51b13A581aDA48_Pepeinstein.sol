...
contract Pepeinstein is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepeinstein";
    string private constant _symbol = "$PEINSTEIN";
