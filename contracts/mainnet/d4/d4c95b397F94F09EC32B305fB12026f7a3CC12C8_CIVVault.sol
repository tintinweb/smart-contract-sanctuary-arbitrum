...
contract CIVVault is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function _distributeShares(uint _id) internal {
        ...
        // Check for zero shares to distribute
        require(sharesToDistribute > 0, "No shares to distribute");

        // Check for zero deposited assets to avoid division by zero
        require(epoch.totDepositedAssets > 0, "No deposited assets");
        ...
        for (uint i = lastProcessedIndex; i < loopLimit; i++) {
            ...
            // Check for a valid investor address
