  ...
  SafeOwnableUpgradeable
{
  ...
  function getRedeemableWeth(
    ...
    uint256 pointsPurchased = (wethSpent * 1e18) / listing.saleWethPerPoint;
    uint256 collateralWethValue = (pointsPurchased *
      listing.collateralWethPerPoint) / 1e18;
    uint256 settlementWethValue = (pointsPurchased * _settlementWethPerPoint) /
      1e18;
  ...
  function getReclaimableCollateralWethValue(
    ...
    uint256 pointsDebt = (wethDebt * 1e18) / listing.saleWethPerPoint;
    uint256 settlementWethValue = (pointsDebt * _settlementWethPerPoint) /
      1e18;
  ...
  function getLockedCollateralWethValue(
    ...
    Listing memory listing = _idToListing[id];
    uint256 pointsDebt = (_idToWethDebt[id] * 1e18) / listing.saleWethPerPoint;
    return (pointsDebt * listing.collateralWethPerPoint) / 1e18;
  }
  ...
  function getMaxSpendableWeth(
    ...
    uint256 maxSaleWethValue = (effectiveBalance * getSaleWethValue(id)) /
      getCollateralWethValue(id);
