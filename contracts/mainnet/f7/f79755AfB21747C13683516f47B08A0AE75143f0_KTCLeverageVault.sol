    ...
    ERC20BurnableUpgradeable
{
    ...
    function getUpdatedDebt(
        ...
        ( uint256 leverageWithInterests, uint256 totalInterests) = IHandler(interestRateHandler).getPositionWithInterestRate(
            _user,
            _positionID,
            address(this),
        ...
        uint256 currentDTV = leverageWithInterests.mulDiv(contractParameters.DECIMAL, currentPosition);
