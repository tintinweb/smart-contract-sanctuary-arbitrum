...
// main contract
contract CARBS is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "CARBS";
    string private constant _symbol = "$CARBS";
    ...
    uint256 _reflectionBuyFee = 5_00;
    uint256 _liquidityBuyFee = 5_00;
    uint256 _marketingBuyFee = 10_00;

    uint256 _reflectionSellFee = 20_00;
    uint256 _liquiditySellFee = 20_00;
    uint256 _marketingSellFee = 20_00;

    uint256 _reflectionFeeCount;
    uint256 _liquidityFeeCount;
    uint256 _marketingFeeCount;

    uint256 private totalBuyFee = 20_00;
    uint256 private totalSellFee = 60_00;
    ...
    uint256 private snipingTime = 0 seconds;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0xd4f133e47a155E1E08d9620959d517504b2F417B;
