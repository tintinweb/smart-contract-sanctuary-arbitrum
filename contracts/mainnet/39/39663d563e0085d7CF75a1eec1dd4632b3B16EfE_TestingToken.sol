...
contract TestingToken is ERC20, Ownable {
    ...
    constructor () ERC20("TestingToken", unicode"TKN") 
    {   
        ...
        DEVFeeOnSell = 3;
        DEVFeeOnTransfer = 3;
        DEVWallet = 0xF7032739b125aaBD86de5197ccF17388072FA8f3;
        ...
        maxTransferAmount = totalSupply() / 100; //Hàm limitTransfer
        maxHold = totalSupply() / 50; //Hàm limitHold
