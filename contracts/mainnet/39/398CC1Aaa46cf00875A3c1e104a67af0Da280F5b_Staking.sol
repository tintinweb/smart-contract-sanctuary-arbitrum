...
contract Staking is StakeInfo {
    ...
    uint256 public perBlockReward = 56000000000000000;
    ...
    function getBoostMultiplier(
        ...
        if (stakedOf <= 100 ether) {
            ...
            return 140;
        } else if (stakedOf <= 1000 ether) {
            return 160;
        } else if (stakedOf <= 2000 ether) {
            return 180;
        } else if (stakedOf <= 5000 ether) {
            return 200;
        } else if (stakedOf <= 10000 ether) {
            return 220;
        } else if (stakedOf <= 30000 ether) {
            return 240;
        } else if (stakedOf <= 60000 ether) {
            return 260;
        } else if (stakedOf <= 100000 ether) {
            return 280;
        } else {
            return 300;
        }
