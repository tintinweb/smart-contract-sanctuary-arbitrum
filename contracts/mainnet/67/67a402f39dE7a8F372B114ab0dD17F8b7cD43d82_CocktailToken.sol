...
contract CocktailToken {
    ...
    function transfer(address _to, uint256 transferAmount) public returns (bool success) {
        ...
        require(transferAmount >= 0, "Value to be transfered must be greater or equal to 0.");
        require(senderBalance >= transferAmount, "Insufficient balance, transfer stopped.");
        
        /* Removed maxWallet and maxTx
        ...
        */
        ...
        /*Planned transfer:*/
        _balances[msg.sender] = SafeMath.safeSub(senderBalance, transferAmount);
    ...
    function transferFrom(address _from, address _to, uint256 _amount)
      public returns (bool success) {
        ...
        require(_to != address(0), "Receiver address invalid");
        require(_amount >= 0, "Value must be greater or equal to 0");
        ...
        */
        ...
        uint256 allowanceBalance = _allowances[_from][_to];
        uint256 senderBalance = _balances[_from];
        uint256 receiverBalance = _balances[_to];

        _balances[_from] = SafeMath.safeSub(senderBalance, _amount);
        _balances[_to] = SafeMath.safeAdd(receiverBalance, _amount);
        _allowances[_from][_to] = SafeMath.safeSub(allowanceBalance, _amount);
