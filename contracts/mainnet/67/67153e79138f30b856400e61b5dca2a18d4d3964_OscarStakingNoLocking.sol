...
contract OscarStakingNoLocking is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    uint256 public lockDownDuration = 7 days;
    ...
    // Staking limit variables
    uint256 public stakingWalletsLimit = 100;
    uint256 public stakingWalletsCount = 0;
    mapping(address => bool) public stakingWallets;

    address public feeCollector = 0x041B96984A000F1066e4368A9b6251C757daB9Cb;
    ...
    function stake(uint256 amount) external nonReentrant notPaused updateReward(msg.sender) {
        ...
        // Check if staking limit has been reached
        if (!stakingWallets[msg.sender]) {
            require(stakingWalletsCount < stakingWalletsLimit, "Staking limit reached");
            stakingWallets[msg.sender] = true;
            stakingWalletsCount = stakingWalletsCount.add(1);
        }
