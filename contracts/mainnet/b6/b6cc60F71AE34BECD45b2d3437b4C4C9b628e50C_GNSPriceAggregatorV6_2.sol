/**
 *Submitted for verification at Arbiscan on 2022-09-18
*/
...
// File: contracts\v6.2\TWAPPriceGetter.sol
...
abstract contract TWAPPriceGetter {
    ...
    constructor(IUniswapV3Pool _pool, uint32 _twapInterval, uint _precision){
    ...
    function tokenPriceDai() public view returns (uint price) {
        ...
        return FullMath.mulDiv(sqrtPriceX96, sqrtPriceX96, FixedPoint96.Q96) * precision / 2**96;
    }
}
...
// File: contracts\v6.2\GNSPriceAggregatorV6_2.sol

pragma solidity 0.8.17;

contract GNSPriceAggregatorV6_2 is ChainlinkClient, TWAPPriceGetter{
    using Chainlink for Chainlink.Request;
    
    // Contracts (constant)
    StorageInterfaceV5 public immutable storageT;
    IUniswapV3Pool public immutable tokenDaiLp;
    ...
    uint32 constant TWAP_PERIOD = 1 minutes;
    ...
    constructor(
        ...
        address _linkToken
    ) TWAPPriceGetter(_tokenDaiLp, TWAP_PERIOD, PRECISION){
