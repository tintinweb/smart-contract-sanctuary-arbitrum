...
// ARBIKEN is Live on Arbitrum
// 3% max buy and 5% max wallet.
// Tax : 6/6
// A gamble shitcoin or a serious investment
// Stealth launch
// Wait for liquidity lock on DXSALE
// Twitter : https://twitter.com/Arbi_Ken
// Telegram : https://t.me/ArbiKen
...
contract ArbiKen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ArbiKen";
    string constant _symbol = "KEN";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 10_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(30); // 3%
    ...
    uint256 reflectionFee = 300; // 3 % gamble
    uint256 marketingFee = 200; // 2% 
    uint256 totalFee = 600;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xefE591c0DA81a4a122daf85aeC2dbDac91fD0e92; //liq address
    address public marketingFeeReceiver=0xefE591c0DA81a4a122daf85aeC2dbDac91fD0e92; // marketing address
