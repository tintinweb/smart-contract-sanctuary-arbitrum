...
contract BankXNFT is AccessControl, Ownable, ERC1155Pausable, ERC1155Supply {
  ...
  address payable public constant COLLECTOR = payable(0xCfB66cf4a206e4e637bC2FFbE181bcb46bbAF1B5);
  address public constant ADMIN_KEY_ADDR = 0xcB67d182Bd9A57BAfbF924f4E1d35a4CF4a49c9E;
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    string private _uri;
    mapping(uint => string) private _batchUris;
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
        uint batch = (_id - 1) / 5000 + 1;
        return string(abi.encodePacked(_batchUris[batch], _id.toString(), ".json"));
    }
     ...
     */
    function _setURI(string memory newuri, uint batch) internal virtual {
        _batchUris[batch] = newuri;
    }
