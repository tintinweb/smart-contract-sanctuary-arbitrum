...
contract ARBMINDS is ERC20, Ownable {
    ...
    uint256 public gov1FeeBuy = 0;
    uint256 public gov2FeeBuy = 0;
    uint256 public liquidityFeeBuy = 200;
    uint256 public jackpotFeeBuy = 0 ;
    uint256 public bonusFeeBuy = 0 ;
    uint256 public devFeeBuy = 200;
    uint256 public totalFeeBuy = 500;
    // Sell Fees
    uint256 public burnFeeSell = 100;
    uint256 public gov1FeeSell = 0;
    uint256 public gov2FeeSell = 0;
    uint256 public liquidityFeeSell = 200;
    uint256 public jackpotFeeSell = 0;
    uint256 public bonusFeeSell = 0;
    ...
    constructor(
        ...
        address _swapRouter,
        address _weth
    ) ERC20("ARBMINDS", "AIMINDS") {
        uint256 _totalSupply = 230_000_000_000_000 * 1e6;
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AIMINDS: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "AIMINDS: index out of bounds");
