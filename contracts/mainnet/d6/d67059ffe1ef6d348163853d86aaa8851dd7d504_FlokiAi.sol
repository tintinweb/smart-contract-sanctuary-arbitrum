...
/*
Telegram: https://t.me/Flokiaiarb
...
contract FlokiAi is ERC20, Ownable {
    ...
    FlokiAiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Floki AI", "FLOKIAI") {
        marketingWallet = payable(0x619e57615ECA72552a57e2689a85F2Be55D033b7);
        devWallet = payable(0x4ECCA68661127E22D9f9BaB40C770D9447a29DF5);
        ...
        dividendTracker = new FlokiAiDividendTracker(
            payable(this),
            router,
            0x2404572eaA937c5A64C84Ee597fAAe4C13823782,
            "FLOKIAICTRACKER",
            "FLOKIAICTRACKER"
        );
        ...
        uint256 totalTokenSupply = (1_00_000_000_000) * (10**18);
...
contract FlokiAiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    FlokiAi public FlokiAiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        FlokiAiContract = FlokiAi(mainContract);
    ...
    function _transfer(
        ...
        require(false, "FlokiAi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "FlokiAi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(FlokiAiContract);

            uint256 prevBalance = FlokiAiContract.balanceOf(address(this));
            ...
            {
                uint256 received = FlokiAiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    FlokiAiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
