...
interface ICamelotReader {
  ...
  function assetValue(bool _addProtocolFees) external view returns (uint256);
...
import "../../../interfaces/vaults/camelot/v2/ICamelotReader.sol";
import "../../../interfaces/oracles/IChainlinkOracle.sol";
import "../../../interfaces/tokens/IWETH.sol";
import "../../../enum/ManagerAction.sol";
import "../../../enum/VaultStrategy.sol";

contract CamelotETHUSDCeLongVault is ERC20, Ownable, ReentrancyGuard, Pausable, ICamelotVault {
  ...
  */
  function deposit(uint256 _amt, uint256 _minSharesAmt) external
   nonReentrant whenNotPaused {
    ...
    tokenA.safeTransferFrom(msg.sender, address(manager), _amt);
  ...
  */
  ...
  external nonReentrant whenNotPaused {
    ...
    IERC20(tokenA).safeTransfer(msg.sender, withdrawAmt);
  ...
  */
  ...
  /**
    * Emergency shut down of vault that withdraws all assets and repays all debt
  */
  function emergencyShutdown() external onlyKeeper {
  ...
  */
  function emergencyResume() external onlyKeeper whenPaused {
    ...
    tokenA.safeTransfer(address(manager), tokenA.balanceOf(address(this)));

    _deposit(tokenA, balance, 0);
