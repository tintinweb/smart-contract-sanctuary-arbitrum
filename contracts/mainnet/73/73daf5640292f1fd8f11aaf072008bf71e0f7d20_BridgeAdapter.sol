...
contract BridgeAdapter {
     ...
     */
    function doOceanInteraction(address[] calldata _tokens, address _receiver, address[] calldata _primitives, bytes32[] calldata _minOutputAmounts, uint256[] calldata _oceanIds) external payable {
        ...
        for (uint256 i = startIndex; i < endIndex;) {
            interactions[i] = Interaction({
                ...
                metadata: _minOutputAmounts[startIndex == 1 ? i - 1 : i]
            });
            unchecked {
                ++i;
            }
