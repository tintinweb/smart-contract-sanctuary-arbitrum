...
import "./interfaces/IOreoStableSwap.sol";
import "./interfaces/IOreoStableSwapLP.sol";
import "./interfaces/IOreoStableSwapDeployer.sol";
import "./interfaces/IOreoStableSwapLPFactory.sol";

contract OreoStableSwapFactory is Ownable {
  ...
  IOreoStableSwapLPFactory public immutable LPFactory;
  IOreoStableSwapDeployer public immutable SwapTwoPoolDeployer;
  IOreoStableSwapDeployer public immutable SwapThreePoolDeployer;
   ...
   */
  constructor(
    IOreoStableSwapLPFactory _LPFactory,
    IOreoStableSwapDeployer _SwapTwoPoolDeployer,
    IOreoStableSwapDeployer _SwapThreePoolDeployer
  ) {
  ...
  function createSwapPair(
    ...
    IOreoStableSwapLP(LP).setMinter(swapContract);
  ...
  function addPairInfo(address _swapContract) external onlyOwner {
    IOreoStableSwap swap = IOreoStableSwap(_swapContract);
...
interface IOreoStableSwapDeployer {
  function createSwapPair(
    address _tokenA,
    address _tokenB,
    uint256 _A,
