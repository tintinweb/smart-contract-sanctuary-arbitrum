...
contract Arbyramid is ERC20, Ownable {
  using SafeMath for uint256;
  address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
  address DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "Arbyramid";
  string constant _symbol = "ARBYRAMID";
  ...
  address public marketingFeeReceiver =
    0x2e36492ee5De30037eE178742A276376d840cA38;
  ...
  constructor() Ownable(msg.sender) {
    ...
    isFeeExempt[0xAbF5890F6e46C6244f66Fa766C65C54d096eCE05] = true;
    isTxLimitExempt[address(router)] = true;
    isTxLimitExempt[_owner] = true;
    isTxLimitExempt[0xAbF5890F6e46C6244f66Fa766C65C54d096eCE05] = true;
  ...
  function swapBack() internal swapping {
    ...
    if (amountToLiquify > 0) {
      router.addLiquidityETH{value: amountETHLiquidity}(
        ...
        0,
        0,
        0xAbF5890F6e46C6244f66Fa766C65C54d096eCE05,
        block.timestamp
      );
