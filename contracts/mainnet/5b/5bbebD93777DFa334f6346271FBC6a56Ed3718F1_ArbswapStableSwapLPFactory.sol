...
import "./ArbswapStableSwapLP.sol";

contract ArbswapStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(ArbswapStableSwapLP).creationCode;
        ...
        ArbswapStableSwapLP(lpToken).setMinter(_minter);
...
contract ArbswapStableSwapLP is ERC20 {
    address public minter;

    constructor() ERC20("Arbswap StableSwap LPs", "Stable-LP") {
        minter = msg.sender;
    }
