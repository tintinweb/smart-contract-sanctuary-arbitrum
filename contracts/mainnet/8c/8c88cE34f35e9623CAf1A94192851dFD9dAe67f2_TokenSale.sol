...
contract TokenSale is Ownable, ReentrancyGuard {
    ...
    uint256 public constant maxTier1Contributions = 50 ether;
    uint128 public constant maxTier1ContributionPerWallet = 1 ether;
    uint256 public tokensTier1PerWei;
    uint256 public totalTier1Contributions;
    uint256 public constant maxTier2Contributions = 1000 ether;
    uint128 public constant maxTier2ContributionPerWallet = 3 ether;
    ...
    uint128 public constant startClaimAt = 1 days;
    ...
    function startSale(uint256 _tokensTier1PerWei, uint256 _tokensTier2PerWei, uint128 _startTime, uint128 _endTime) external onlyOwner {
