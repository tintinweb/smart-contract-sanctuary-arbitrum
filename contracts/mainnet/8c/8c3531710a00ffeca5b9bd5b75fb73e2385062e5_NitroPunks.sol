...
// Minting website: https://nitropunks.club/
// Telegram: https://t.me/NitroPunks
// Twitter: https://twitter.com/nitro_punks
...
contract NitroPunks is NFTokenEnumerableMetadata, Ownable {
	using SafeMath for uint256;

	uint256 public price = 0.0042 ether; // 0.0042 eth
	uint256 public maxSupply = 10000;
	string public baseUri; 
	uint16 public refShare = 2000; // 20%
	...
	function mint(uint256 _mintAmount, address _referrer) external payable {
		require(msg.value >= price.mul(_mintAmount), "Amount is less than price");
		require(maxSupply >= this.totalSupply(), "Sold out");
		require(_mintAmount > 0, "The mint amount cannot be 0");
		require(_mintAmount <= maxMintAmount, "Mint amount exceeds maxMintAmount");
	...
	function setReferralAddress(Referral _referralAddress) public onlyOwner {
