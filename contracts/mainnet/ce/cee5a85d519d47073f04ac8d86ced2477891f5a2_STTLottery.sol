...
contract STTLottery is VRFV2WrapperConsumerBase, ConfirmedOwner {
    ...
    function random(uint _number) private returns(uint) {
        ...
        uint _chainlinkNumber = (_number % 9) + 0;
        uint _win = calculate(STT.balanceOf(address(this)), rate_balance) * _chainlinkNumber * _number2 * _number3;

        tickets[lastTicket].chainlinkNumber = _chainlinkNumber;
