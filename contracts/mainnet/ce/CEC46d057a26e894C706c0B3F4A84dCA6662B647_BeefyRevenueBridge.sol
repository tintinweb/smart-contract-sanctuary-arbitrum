...
contract BeefyRevenueBridge is OwnableUpgradeable, BeefyRevenueBridgeStructs {
    ...
    // Mapping our enums to function bytes4
    mapping(bytes32 => bytes4) public bridgeToUse;
    mapping(bytes32 => bytes4) public swapToUse;
    ...
    function _initBridgeMapping() private {
        bridgeToUse[keccak256(abi.encode("CIRCLE"))] = bytes4(keccak256(bytes("bridgeCircle()")));
        bridgeToUse[keccak256(abi.encode("STARGATE"))] = bytes4(keccak256(bytes("bridgeStargate()")));
        bridgeToUse[keccak256(abi.encode("AXELAR"))] = bytes4(keccak256(bytes("bridgeAxelar()")));
        bridgeToUse[keccak256(abi.encode("SYNAPSE"))] = bytes4(keccak256(bytes("bridgeSynapse()")));
        bridgeToUse[keccak256(abi.encode("zkEVM"))] = bytes4(keccak256(bytes("bridgezkEVM()")));
        bridgeToUse[keccak256(abi.encode("zkSYNC"))] = bytes4(keccak256(bytes("bridgezkSync()")));
    }

    function _initSwapMapping() private {
        swapToUse[keccak256(abi.encode("UNISWAP_V2"))] = bytes4(keccak256(bytes("swapUniV2()")));
        swapToUse[keccak256(abi.encode("UNISWAP_V3"))] = bytes4(keccak256(bytes("swapUniV3()")));
        swapToUse[keccak256(abi.encode("UNISWAP_V3_DEADLINE"))] = bytes4(keccak256(bytes("SwapUniV3Deadline()")));
        swapToUse[keccak256(abi.encode("BALANCER"))] = bytes4(keccak256(bytes("swapBalancer()")));
    }
    ...
    function _swap() private {
        bytes memory result = address(this).functionCall(
            abi.encode(swapToUse[activeSwap])
        );
    ...
    function _bridge() private {
        bytes memory result = address(this).functionCall(
            abi.encode(bridgeToUse[activeBridge])
        );
