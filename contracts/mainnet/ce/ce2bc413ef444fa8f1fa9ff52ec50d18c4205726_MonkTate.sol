...
contract MonkTate is Context, Ownable, IERC20, ERC20Detailed {
    ...
    uint256 public feeDev = 20;
    uint256 public feeMarketing = 30;
    uint256 public feeJackpot = 40;

    uint256 public constant ONE_HUNDRED_PERCENT = 100;

    address payable public walletMarketing =
        payable(0x29763a7fDffD2ce1A6a60A05F2153c8dcd8Cc93F);
    address payable public walletDev =
        payable(0xCEd630d7554078f5E42cab35EDfF5Ec4Ddd2b0b3);
    address payable public walletJackpot =
        payable(0x1df0542C57dc58c93E6E35E28E9e68b229a835dE);
    ...
    constructor() ERC20Detailed("MonkTate", "MTATE", 18) {
        _owner = msg.sender;
    ...
    function setSellFeePercent(uint256 newFee) external onlyOwner {
        require(newFee <= 31, "Sell fee should be less than 30%");
        sellFee = newFee;
    }
