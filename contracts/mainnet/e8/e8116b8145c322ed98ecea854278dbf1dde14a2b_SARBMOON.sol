...
/**
*/
//Join Our Community on Tg: https://t.me/blurinuarbi
//Website: www.blur.com
//$BLUR Rewards token - Automatically - No trigger
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0x21410516d0a9f59dfAa9906313bF013C86Df8899);
    DEXRouter router;
...
contract SARBMOON is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "SARBMOON";
    string constant public symbol = "$SARBMOON";
    uint8 constant public decimals = 9;

    uint256 public constant totalSupply = 1 * 10**7 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 1;
    uint256 public _maxWalletToken = totalSupply / 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAAb286F6dEA3AC32219F7B7F1eD4D5224AD06fc6;
