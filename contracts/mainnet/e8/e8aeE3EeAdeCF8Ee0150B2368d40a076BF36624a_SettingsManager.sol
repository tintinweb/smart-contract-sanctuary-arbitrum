...
contract SettingsManager is ISettingsManager, Initializable, ReentrancyGuardUpgradeable, Constants {
    ...
    event SetLiquidationFee(uint256 liquidationFee);
    ...
    function setLiquidationFee(uint256 _liquidationFee) external onlyOperator(3) {
        require(_liquidationFee <= 50000, "Above max");
