...
/**
TELEGRAM : https://t.me/PloutusArb
**/
...
contract PloutusArb is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "PloutusArb";
    string constant _symbol = "PLOTARB";
    ...
    bool private blacklistMode = false;
    ...
    uint256 private extraFeeOnSell = 99;

    uint256 private totalFee;
    uint256 private totalFeeIfSelling;

    address private autoLiquidityReceiver;
    address public marketingWallet;
    address private anothermarketingWallet;

    bool public plebs = false;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x89270f90Bb087258fB3Ec99aae09e204BB4CA2eB;  
        anothermarketingWallet = 0x89270f90Bb087258fB3Ec99aae09e204BB4CA2eB;
