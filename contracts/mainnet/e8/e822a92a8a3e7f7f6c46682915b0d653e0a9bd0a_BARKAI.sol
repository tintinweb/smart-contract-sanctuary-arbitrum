...
contract BARKAI is ERC20, Ownable {
    ...
    constructor() ERC20("BARK AI", "BARKAI") {
        ...
        uint256 totalSupply = 420_000_000_000 * 1e18; // 420.000.000.000 Total Supply

        maxTransactionAmount = 6_942_000_000 * 1e18; // 
        maxWallet = 6_942_000_000 * 1e18; // 1% 
        ...
        marketingWallet = address(0x9A0558a01B9F10A327E3920BD708D9235deaF281); // set as marketing wallet
        devWallet = address(0x9A0558a01B9F10A327E3920BD708D9235deaF281); // set as dev wallet
