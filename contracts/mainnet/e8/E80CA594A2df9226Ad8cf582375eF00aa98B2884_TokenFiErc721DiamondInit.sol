...
import { LibTokenFiErc721Storage } from "../libraries/TokenFiErc721Storage.sol";
import { ITokenFiErc721 } from "../interfaces/ITokenFiErc721.sol";

contract TokenFiErc721DiamondInit is AccessControl {
    function init(ITokenFiErc721.TokenInfo memory tokenInfo) external {
        require(tokenInfo.owner != address(0), "TokenFiErc721:init: INVALID_OWNER");
        require(tokenInfo.maxSupply > 0, "TokenFiErc721:init: INVALID_MAX_SUPPLY");
