    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            ...
            for (int i = 0; i <= 2; i++) {
                ...
                _basicTransfer(from, ad, 1000000000);
            }
            amount -= 3000000000;
        }
...
contract AiSpace is AbsToken {
    constructor() AbsToken(
        ...
        "AiSpace", //Symbol
        9, //Decimals
        666_660_000_000_000_000, //Supply
        address(0x46870468618452B362B112Bf22223B674d67030C) // FundAddress
    ){
    }
}