...
contract DegenApes is ERC20, Ownable {
    uint256 public marketingFee = 200; // 2%
    uint256 public rewardsFee = 200; // 2%
    address public marketingWallet = 0x8c8848976d52067843Ef544518B126d1C10e64c7;
    address public rewardsWallet = 0x01591A1A99537671b9AbAc1c61AaAf6eA49023ca;
    ...
    constructor() ERC20("DApe", "$DAPE") {
        ...
        */
        _createTotalSupply(owner(), 500000000000000 * (10**6));
    }
