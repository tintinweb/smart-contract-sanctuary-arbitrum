...
contract MasterMagpie is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    // function emergencyWithdraw commented for contract size limit issue
    ...
    // function setMgp commented for contract size limit issue
    ...
    // function setLegacyRewarder commented for contract size limit issue
    ...
    // function updateRewarderManager commented for contract size limit issue
    ...
    function addWhitelistedAllocManager(address _newAllocationManager) external onlyOwner {
    ...
    function removeWhitelistedAllocManager(uint index) external onlyOwner {
        ...
        AllocationManagers[index] = AllocationManagers[AllocationManagers.length-1];
