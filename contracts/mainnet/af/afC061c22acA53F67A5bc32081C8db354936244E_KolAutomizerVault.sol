...
contract KolAutomizerVault is Initializable, UUPSUpgradeable, ERC20Upgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("KOL Chronos KEYCHR-CHR Automizer Receipt", "CHR-KEYCHR-CHR");
    }
    ...
    function depositAllFor(address user) external {
        depositFor(user, want.balanceOf(msg.sender));
    }
    ...
    */
    ...
    function updateV2() external onlyOwner {
        require(address(this)==0xd562C99D19eb7554CA441b7921b2A72AaCCaa9b6,"wrong vault");
        want = IERC20Upgradeable(strategy.want());
    }
}