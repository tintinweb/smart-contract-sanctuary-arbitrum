...
import { BlinQFuelFeeCollector } from "../Periphery/BlinQFuelFeeCollector.sol";
import { LibAsset, IERC20 } from "../Libraries/LibAsset.sol";
import { ReentrancyGuard } from "../Helpers/ReentrancyGuard.sol";
import { SwapperV2, LibSwap } from "../Helpers/SwapperV2.sol";
import { Validatable } from "../Helpers/Validatable.sol";

/// @title BlinQFuel Facet
/// @author モンキー・D・ルフィ
/// @notice Provides functionality for bridging gas through LIFuel
/// @custom:version 1.0.1
contract BlinQFuelFacet is IBlinQ, ReentrancyGuard, SwapperV2, Validatable {
    /// Storage ///

    bytes32 internal constant NAMESPACE =
        keccak256("com.blinq.facets.periphery_registry");
    string internal constant FEE_COLLECTOR_NAME = "BlinQFuelFeeCollector";
    ...
    function startBridgeTokensViaBlinQFuel(
    ...
    function swapAndStartBridgeTokensViaBlinQFuel(
        IBlinQ.BridgeData memory _bridgeData,
    ...
    /// @param _bridgeData Data used purely for tracking and analytics
    function _startBridge(IBlinQ.BridgeData memory _bridgeData) private {
        BlinQFuelFeeCollector BlinQFuelFeeCollector = BlinQFuelFeeCollector(
            getStorage().contracts[FEE_COLLECTOR_NAME]
        );

        if (LibAsset.isNativeAsset(_bridgeData.sendingAssetId)) {
            BlinQFuelFeeCollector.collectNativeGasFees{
            ...
            LibAsset.maxApproveERC20(
                ...
                address(BlinQFuelFeeCollector),
                _bridgeData.minAmount
            );

            BlinQFuelFeeCollector.collectTokenGasFees(
                _bridgeData.sendingAssetId,
                _bridgeData.minAmount,
                _bridgeData.destinationChainId,
                _bridgeData.receiver
...
/// @title BlinQFuelFeeCollector
/// @author モンキー・D・ルフィ
/// @notice Provides functionality for collecting fees for BlinQFuel
/// @custom:version 1.0.1
contract BlinQFuelFeeCollector is TransferrableOwnership {
    /// Errors ///
