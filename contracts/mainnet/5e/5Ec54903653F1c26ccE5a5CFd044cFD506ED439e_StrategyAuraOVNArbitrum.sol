...
contract StrategyAuraOVNArbitrum is StratFeeManagerInitializable {
    ...
    ISolidlyRouter.Route[] public usdcToFRAXRoute;
    ISolidlyRouter.Route[] public fraxToUSDPRoute;
    ...
    function initialize(
        ...
        ISolidlyRouter.Route[] memory _usdcToFRAXRoute,
        ISolidlyRouter.Route[] memory _fraxToUSDPRoute,
        address _booster,
        uint256 _pid,
    ...
    function usdcToFRAX() external view returns (address[] memory) {
        ISolidlyRouter.Route[] memory _route = usdcToFRAXRoute;
        return _solidlyToRoute(_route);
    }

    function fraxToUSDP() external view returns (address[] memory) {
        ISolidlyRouter.Route[] memory _route = fraxToUSDPRoute;
        return _solidlyToRoute(_route);
    }
}
