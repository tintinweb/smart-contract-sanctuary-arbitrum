/**
 *Submitted for verification at Arbiscan on 2021-11-13
*/
...
// File: contracts/BIFI/strategies/Common/MaxiStratManager.sol
...
// File: contracts/BIFI/strategies/Common/MaxiFeeManager.sol
...
// File: contracts/BIFI/strategies/BIFI/StrategyArbiBifiMaxi.sol
...
contract StrategyArbiBifiMaxi is MaxiStratManager, MaxiFeeManager, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public output = address(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
    address public want;
    ...
    constructor(
        ...
        address _unirouter,
        address _keeper
    ) MaxiStratManager(_keeper, _unirouter, _vault) public {
        want = _want;
    ...
    function harvest(address callFeeRecipient) external virtual whenNotPaused gasThrottle {
