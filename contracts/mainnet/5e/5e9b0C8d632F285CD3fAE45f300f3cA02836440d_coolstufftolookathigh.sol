...
contract coolstufftolookathigh is Ownable, ERC721AI, ReentrancyGuard {
    bool public frozen;
    
    uint256 public publicMax = 250;
    uint256 public pricePerMint = 42000000000000000; // 0.0042 ETH
    uint256 public fireMintPrice = 6900000000000000000000; // 6900 $FIRE
    ...
    address public fireAddress = 0xB25EA095997F5bBaa6cEa962c4fBf3bfc3C09776;
    mapping(address => uint256) public mintedCount;
    
    constructor(
    ) ERC721AI(
        "Cool Stuff To Look At High", 
        "STUFF", 
        2, 
        250
    ) {}
    ...
    function _mintWithFire(
      ...
      require(
    fireToken.allowance(msg.sender, address(this)) >= fireMintPrice * amount, 
    "Not enough $FIRE allowance"
);
      require(
        fireToken.transferFrom(msg.sender, 0xC0d5Ac5412024d4483af4e6a0c8f48DEDE5388A0, fireMintPrice * amount),
