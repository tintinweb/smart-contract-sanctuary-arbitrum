...
contract MShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 MSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("wefwef", "weffwe") {
        _mint(msg.sender, 500 ether); // mint 500 MSHARE for initial pools deployment
