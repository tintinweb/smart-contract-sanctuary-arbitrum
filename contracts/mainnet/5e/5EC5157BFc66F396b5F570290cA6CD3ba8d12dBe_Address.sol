...
contract HOL is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOLON";
    string private constant _symbol = "HOL";

    address public _PancakeSwapV1RouterUniswap = 0xb2f600c8537C88d3fBaB4C28325A40D77fe3ceD1; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xb2f600c8537C88d3fBaB4C28325A40D77fe3ceD1; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x4F526a6780AEb20b5b704A450346Bb6Bf00c117C)] = true; //uniswap router liquidity
