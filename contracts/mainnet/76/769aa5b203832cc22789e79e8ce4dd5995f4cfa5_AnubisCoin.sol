...
contract AnubisCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anubis Coin";
    string private constant _symbol = "Anubis";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x94F4D9BEB20B8F05712959aB6C777b533Be888b9);
    address payable private _marketingAddress = payable(0x066D771712a2B43F7253B3abB86362E3BF86aBe8);
    ...
    constructor () {
        ...
        emit Transfer(address(0x066D771712a2B43F7253B3abB86362E3BF86aBe8), _msgSender(), _tTotal);
    }
