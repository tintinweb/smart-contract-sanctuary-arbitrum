...
contract Vester12MonthsV2 is IERC20Upgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function remainingVestingAmount(address _account) public view returns (uint256) {
        ...
        return balance - claimable(_account);
    }
    ...
    function _getNextClaimableAmount(address _account) private view returns (uint256) {
        ...
        uint256 claimableAmount = (vestedAmount * timeDiff) / VESTING_DURATION;
