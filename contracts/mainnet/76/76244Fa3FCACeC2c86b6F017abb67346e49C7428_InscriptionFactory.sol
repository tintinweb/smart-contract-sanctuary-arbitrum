...
contract InscriptionFactory is Ownable {
    ...
    function deploy(
        ...
        require(!_compare(_tick, "pepemint"), "tickcannot use pepemint");
        require(!_compare(_tick, "pepemints"), "tickcannot use pepemints");
        ...
        bytecode = abi.encodePacked(
            ...
            abi.encode(
                ...
                platformAddress,
                platformMinQuantity,
                _isBurnPepeMint ? mintBurnPlatformQuantity : 0
            )
        );
        ...
        string memory onlyContractSymbol = _onlyContractAddress != address(0x0) ? ICommonToken(_onlyContractAddress).symbol() : '';
    ...
    // set burn 
    function updatePlatformBurnQuantity(uint256 _quantity) external onlyOwner {
        mintBurnPlatformQuantity = _quantity;
    }
