...
import "./libs/ArbitrumSushiLibrary.sol";
...
contract O3ArbitrumSushiAggregator is Ownable {
    ...
    function _swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        if (pull) {
            ...
            IERC20(path[0]).safeTransfer(ArbitrumSushiLibrary.pairFor(factory, path[0], path[1]), amountIn);
        }
