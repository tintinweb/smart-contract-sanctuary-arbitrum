...
contract test is ERC20, ERC20Burnable, Ownable2Step, Initializable {
    ...
    constructor()
        ERC20("test", "test") 
    {
        address supplyRecipient = 0xC4DF63959D18f77ee56c4d0170C2b4F9878BE125;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x7feeBfD30aFbD48A962400B03Db80A7Bd233C40C);
        marketingFeesSetup(200, 200, 0);

        devAddressSetup(0x7feeBfD30aFbD48A962400B03Db80A7Bd233C40C);
        ...
        _transferOwnership(0xC4DF63959D18f77ee56c4d0170C2b4F9878BE125);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(tradingEnabled || isExcludedFromFees[from] || isExcludedFromFees[to], "Trading not yet enabled!");
        // Check for bot
    ...
    function _updateRouterV2(address router) public {
