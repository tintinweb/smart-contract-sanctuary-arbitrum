...
contract RiceDAOPass is ERC721A, DefaultOperatorFilterer, Ownable {
    /**
      * @notice Maximum number of Rice DAO Passes that can be minted
      */
    uint256 public constant SUPPLY_MAX = 200;

    /**
      * @notice The price of a Rice DAO Pass in wei
      */
    ...
    /**
      ...
      */
    string constant public baseURI = "ipfs://QmW9q4xjCjBtM71i93RryXA1pAdgAqE9M5Kos6UyfqCSQr";

    constructor() ERC721A("RiceDAOPass", "RICE") {}
