...
contract LunaValidationDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LunaValidationDAO";
    string private constant _symbol = unicode"LVD";
    ...
    constructor () {
        ...
        _taxWallet = payable(address(0x303D0E8a5ed321E71561b106eC96F2F6A5Cc42A1));
