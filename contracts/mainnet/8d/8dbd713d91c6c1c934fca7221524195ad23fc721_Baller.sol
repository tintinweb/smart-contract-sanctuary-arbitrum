...
// Root file: contracts/baby/token.sol
...
contract Baller is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        address mrkWallet,
        uint256 mrtFee
        // 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1, 0x4C60051384bd2d3C01bfc845Cf5F4b44bcbE9de5, 0xF1E573cdd0A647Cc9E8000562Bd25D6c118BdeEF
        // [0x82aF49447D8a07e3bd95BD0d56f35241523fBab1, 0x4C60051384bd2d3C01bfc845Cf5F4b44bcbE9de5, 0xF1E573cdd0A647Cc9E8000562Bd25D6c118BdeEF]
    ) payable ERC20(name_, symbol_) {
        rewardToken = reward;
        _marketingWalletAddress = mrkWallet;
        require(
 ...
 */
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Baller: The router already has that address"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Baller: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Baller: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Baller: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Baller: Cannot update gasForProcessing to same value"
        );
