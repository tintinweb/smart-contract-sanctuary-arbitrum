...
contract YLDRLeverageAutomations is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        // add compounds from old contract
        scheduledCompounds[0x09274d33271d69E49F275402a0eE67cCC30be4d7] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
        scheduledCompounds[0xA2e312282d2837640aDda25153a4566D1857aE64] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
        scheduledCompounds[0x4f8DD0a48ce4FF1419641096eD28195FEa0fBa35] = ScheduledCompound({initialized: true, maxTotalFeePercent: 2500});
        scheduledCompounds[0x5a72b4949330A0f9cA30CCEECb9CbFE00796a0f2] = ScheduledCompound({initialized: true, maxTotalFeePercent: 500});
        scheduledCompounds[0x77F9abcCcF8c972b6e96d74D8B33F93cBB21ea19] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
        scheduledCompounds[0xc935009550B1070B28C17970f2E93D903e367Edb] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1100});
        scheduledCompounds[0xA56B2988e9312c28237A8C98Cec107F2754DD58b] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
        scheduledCompounds[0x9B2B8Ad773C692e60348F030F74E1eB628BBef58] = ScheduledCompound({initialized: true, maxTotalFeePercent: 500});
        scheduledCompounds[0xFD1f4348d1488ccf92B278A1d98daf7301a8BFa3] = ScheduledCompound({initialized: true, maxTotalFeePercent: 100});
        scheduledCompounds[0xB709626EaC03E5dD7927bbaE9E7FB059651fDEb7] = ScheduledCompound({initialized: true, maxTotalFeePercent: 500});
        scheduledCompounds[0x0d2e5d1dc4F07F302202eAc0Ac8e24d820A8f35D] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
        scheduledCompounds[0xcf12c05b09C5099D3A6aCf8c507f729e728256d6] = ScheduledCompound({initialized: true, maxTotalFeePercent: 500});
        scheduledCompounds[0xfB9D674d1D681496a19cF452Da0BcCb5f0Cec32F] = ScheduledCompound({initialized: true, maxTotalFeePercent: 1000});
    }
        ...
        returns (uint256 gasFee, uint256 percent)
    {
        ...
        percent = (flashFeeUsd + usdGasFee) * 1e4 / pendingFeesUsd;
