...
Collection of NFTs and Arblienverse built on the Arbitrum Blockchain.
4% Automatic USDC Rewards Every Transaction 
...
// main contract
contract ArblienUSDC is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "ARBLIEN";
    string private constant _symbol = "$ARBLIEN";
