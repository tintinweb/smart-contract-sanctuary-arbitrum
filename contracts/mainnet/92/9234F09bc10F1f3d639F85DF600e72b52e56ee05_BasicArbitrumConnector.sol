...
abstract contract BasicResolver is Events, DSMath, Basic {
	...
	/**
	 * @dev Deposit Assets To Layer Smart Account.
	 * @notice Deposit a token to LSA
	...
	/**
	 * @dev Deposit Assets To Layer Smart Account From any user.
	 * @notice Deposit a token to LSA from any user.
	...
	/**
	 * @dev Withdraw Assets from Layer Smart  Account
	 * @notice Withdraw a token from LSA
...
contract BasicArbitrumConnector is BasicResolver {
