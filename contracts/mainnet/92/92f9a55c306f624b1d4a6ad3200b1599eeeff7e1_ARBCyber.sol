...
// Telegram : https://t.me/ArbCyber
// Website : https://arbcyber.io
// Twitter : https://twitter.com/arbcyber
// Discord : https://discord.gg/XhHFC43zsB
...
contract ARBCyber is Context, IERC20, Ownable {
    ...
    uint256 private _airdropToken = 10000*10**18; //10k

    uint256 private saleMaxBlock;
    uint256 private salePrice = 10000*10**3; //1T
    ...
    uint256 private constant _tTotal = 1000000000 * 10**18;//10Q
    string private constant _name = "ARBCyber";
    string private constant _symbol = "ARBC";
    uint256 public _maxTxAmount =   1000000000 *10**18;
    uint256 public _maxWalletSize = 1000000000 *10**18;
    uint256 public _taxSwapThreshold= 10000000 *10**18;
    uint256 public _maxTaxSwap= 10000000 *10**18;
    ...
    constructor () public{
        ...
        _balances[_msgSender()] =  _tTotal/10;
    ...
    uint256 set_salePrice
    )public onlyOwner{
        salePrice = set_salePrice * 10**3;
