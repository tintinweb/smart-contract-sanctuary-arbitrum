...
/// @title The Waves token
/// https://waves.tech/

/*********************************
 Waves is a community-based stack of decentralized 
 open-source technologies to build scalable, user-friendly apps
 *********************************/
 
pragma solidity =0.6.12;
import "./ERC20.sol";

contract WavesToken is ERC20 {
    using SafeMath for uint256;
  
    constructor (uint256 totalsupply_) public ERC20("WAVES", "WAVES") {
