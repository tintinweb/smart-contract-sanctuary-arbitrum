...
contract CoastPacific is ERC20, Ownable {
    ...
    constructor() ERC20("Coast Pacific", "COAST") {
        ...
        maxTransactionAmount = 5000000 * 1e18; // .15% from total supply maxTransactionAmountTxn
