...
/**
 *Submitted for verification at Arbiscan on 2022-11-16
*/
...
// Defi has been nerfed, we're here to buff it!
// Telegram : t.me/buffalotoken
...
contract BUFFALO is Context, IERC20, Ownable {
    ...
    string private _name = "BUFFALO";
    string private _symbol = "BUFF";
    uint8 private _decimals = 18;

    address payable public operationsWallet = payable(0x734367CE9C006C9808B1fe9EB1ED9B0CB35240A1);
    address payable public devWallet = payable(0x734367CE9C006C9808B1fe9EB1ED9B0CB35240A1);
