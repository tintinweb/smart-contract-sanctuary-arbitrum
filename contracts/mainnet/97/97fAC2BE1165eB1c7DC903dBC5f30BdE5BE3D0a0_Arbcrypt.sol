...
/*
The First Tax-Free Locker and Ecosystem on Arbitrum One Network

https://www.arbcrypt.com/

https://t.me/Arbcryptlocker
*/
...
contract Arbcrypt is IBEP20, Auth {
    ...
    address constant DEV = 0x5e1C89c9551572baA51019d711c64cCdcE183582;


    string constant _name = "ArbCrypt";
    string constant _symbol = "$ACRYPT";
    uint8 constant _decimals = 9;

    uint256 constant _totalSupply = 1000000000 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 35 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 35 / 1000;
