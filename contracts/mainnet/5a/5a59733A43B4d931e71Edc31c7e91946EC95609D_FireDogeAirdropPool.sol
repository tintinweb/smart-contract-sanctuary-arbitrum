...
import { IERC20Tax } from "./interfaces/IERC20Tax.sol";
import { ERC20TaxReferenced } from "./mixins/ERC20TaxReferenced.sol";
...
contract FireDogeAirdropPool is ERC20TaxReferenced {
    ...
    address public immutable AIRDROP_SIGNER;
    address public immutable DEV;
    uint256 public immutable AIRDROP_START_TIME;

    uint256 public constant AIRDROP_DURATION = 28 days;
    uint256 public constant AIRDROP_AMOUNT_DENOMINATOR_AT_THE_END = 5;  // In 5 times less at the end
    uint256 public constant AIRDROP_REFERRER_PROPORTION = 5;  // 1/5
    uint256 public constant AIRDROP_MAX_USERS = 600_000;
    ...
    function withdrawUnclaimed() public {
        require(AIRDROP_START_TIME + AIRDROP_DURATION <= block.timestamp, "Unclaimed tokens can be withdrawed only when airdrop is ended");
        TOKEN.transferWithoutFee(DEV, TOKEN.balanceOf(address(this)));
    }
