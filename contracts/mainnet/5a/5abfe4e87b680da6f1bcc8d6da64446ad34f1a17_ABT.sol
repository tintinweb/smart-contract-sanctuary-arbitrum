...
contract ABT is Ownable, ERC20 {
    using SafeERC20 for IERC20;
    mapping (address => bool) public whiteList;
    mapping(address => bool) public blackList;
    bool public isLaunch = false;

    constructor() ERC20("ABT", "ABT") {
        address ownerAddress = 0x1B2e8233d579199e0A839eeD774EeCD0cF1A4beA;
        _transferOwnership(ownerAddress);
        _mint(ownerAddress, 3999090900000000 * (10 ** 18));
