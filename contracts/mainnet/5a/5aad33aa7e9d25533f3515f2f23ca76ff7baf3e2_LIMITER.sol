...
contract LIMITER is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AI.LIMITER";
    string constant _symbol = "AI.LIMITER";
    ...
    address public marketingFeeReceiver = 0xE251a304a88d4b69789a6071Df7B0F54Bb7C14DD;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xE251a304a88d4b69789a6071Df7B0F54Bb7C14DD] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xE251a304a88d4b69789a6071Df7B0F54Bb7C14DD] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xE251a304a88d4b69789a6071Df7B0F54Bb7C14DD,
                block.timestamp
            );
