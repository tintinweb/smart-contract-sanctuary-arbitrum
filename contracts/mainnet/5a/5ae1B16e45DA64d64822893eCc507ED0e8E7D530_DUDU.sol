...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function presale() public payable {
        ...
        //ETH 不足
        require(msg.value >= _perPresaleEth, "ETH Not Enough");
        address account = msg.sender;
        //拒绝机器人
        require(tx.origin == account, "ban robot");
        //参与过了
        require(!joinPresale[account], "account have joined");
