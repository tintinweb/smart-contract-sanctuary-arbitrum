...
/*
0xPrint 🖨 Enter the Matrix 🟢
 
🌎 https://0xprint.xyz/
🐦https://twitter.com/Arbitrum0xPrint

Released on the Arbitrum Network, 0xPrint is a Taxless Reflection Token that rewards holders with Eth every 15 minutes!
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BNB200Xprint is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "0xPrint";
    string private _symbol = "0xPrint";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0xbAc7Da6f1DB86c72cE789805A728974639e9F42D);
    address payable public devWalletAddress = payable(0x5F1b52fA1cd4d0b25DfE76B192f5AEDf84A9F5F3);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(blacklistMode){
            require((!isBlacklisted[sender] && !isBlacklisted[recipient]) || uniswapPair == sender,"Blacklisted");
        }
