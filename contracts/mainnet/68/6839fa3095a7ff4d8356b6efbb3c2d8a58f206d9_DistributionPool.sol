...
contract DistributionPool is OwnableUpgradeable {
    ...
    uint256 public constant MAX_TOKEN = 420_000_000_000_000_000 * 1e6;
    uint256 public constant INIT_CLAIM = 2_325_600_000_000 * 1e6;
    ...
    function claim(string memory nonce, bytes calldata signature, address referrer) public {
    ...
    function addSigner(address val) public onlyOwner() {
        require(val != address(0), "0xApepe: val is the zero address");
        _signers.add(val);
    }

    function delSigner(address signer) public onlyOwner returns (bool) {
        require(signer != address(0), "0xApepe: signer is the zero address");
