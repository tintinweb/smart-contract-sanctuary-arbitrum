...
/*
    ...
    |  \/  |           (_)    | ___ \   (_)     | |           
    | .  . | __ _  __ _ _  ___| |_/ / __ _ _ __ | |_ ___ _ __ 
    ...
    MagicPrinter - Purchases and distributes $MAGIC dividends to holders using buy & sell taxes.
    https://magicprinter.pro
...
// Dependency file: contracts/baby/MagicPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeMagicDividends(uint256 amount) public onlyOwner {
...
contract MagicPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MagicPrinter contract."
        );
    }
...
// Root file: contracts/baby/MagicPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/MagicPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract MagicPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    MagicPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = MagicPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MagicPrinter: The dividend tracker already has that address"
        );

        MagicPrinterDividendTracker newDividendTracker = MagicPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "MagicPrinter: The new dividend tracker must be owned by the MagicPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "MagicPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "MagicPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MagicPrinter: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MagicPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "MagicPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MagicPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialMagicBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForMagic(tokens);
    ...
    function swapTokensForMagic(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeMagicDividends(dividends);
