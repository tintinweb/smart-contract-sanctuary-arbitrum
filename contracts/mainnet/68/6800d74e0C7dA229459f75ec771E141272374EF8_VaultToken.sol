...
/**
 * @title VaultToken
 * @dev A token contract representing shares of the Locus Vault.
 */
    ...
    AccessControlUpgradeable
{
    ...
    function initialize(
        ...
        __ERC20_init("Pendle Index", "pendleETH");
        _grantRole(ADMIN, _admin);
        _grantRole(VAULT, _vault);
        _grantRole(DEFAULT_ADMIN_ROLE, _admin);
        currentVault = IOnChainVaultPendle(_vault);
        _mint(0x000000000000000000000000000000000000dEaD, 1);
    }

    bytes32 public constant ADMIN = keccak256("ADMIN");
    bytes32 public constant VAULT = keccak256("VAULT");
    IOnChainVaultPendle public currentVault;
    ...
    /**
     * @dev Dispatches tokens to multiple recipients.
     * @param to An array of recipient addresses.
     * @param amount An array of corresponding amounts to dispatch.
     */
    ...
    /**
     * @dev Sets the current vault contract.
    ...
    function setCurrentVault(address newVault) external onlyRole(ADMIN){
        ...
        currentVault = IOnChainVaultPendle(newVault);
        _grantRole(VAULT, newVault);
    }

    /**
     * @dev Retrieves the price per share of the vault.
