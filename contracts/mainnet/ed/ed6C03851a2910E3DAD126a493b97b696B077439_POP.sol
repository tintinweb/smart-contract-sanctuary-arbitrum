...
contract POP is Context, IERC20, Ownable {
    ...
    string private _name = "Proof of pepe";
    string private _symbol = "POP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95b7b9816E49523Fc9615BA1B71094bbB87C2252); // marketing wallet
    address payable lotteryWallet = payable(0x4ca9ac0f7e01c6685471415a0BC99e4267C6759a);  // lotterywallet
