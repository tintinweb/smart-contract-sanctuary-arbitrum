...
contract ChainSwitch is Context, Ownable, IERC20 {
    ...
    string constant private _symbol = "SWTCH";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 allocation =  address(this).balance / 3;


        if(allocation > 0) {
            (success1,) = marketingAddress.call{value: allocation, gas: 35000}("");
            (success2,) = developmentAddress.call{value: allocation, gas: 35000}("");
        ...
        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            require(buy <= 10,"SAFU: Fee Error");
            require(sell <= 10,"SAFU: Fee Error");
