...
Do you have what it takes to be the biggest and baddest of them all?  
Are you just another trader or are you here to utterly annihilate the competition?
Introducing Giganto: A tax token with a winner-takes-all attitude. And you want to win.

Rules:

If you make the biggest buy you become Giganto, and collect 5% fees (in ETH).
If you sell any tokens at all at any point you can never be Giganto. 
If someone beats your record, they become Giganto. 
If you sell while you're Giganto, the  record is reset to 0- ready for a new Giganto!
Giganto is set via biggest buy.
The point is to reward big buys. There are no punishments other than disallowing sellers from being Giganto.

Each Giganto has a timelimit. After 30 minutes, they cease to be Giganto and the record is reset to 0, giving more a chance and increasing volume!
*/
...
contract Giganto is IERC20, Ownable {

    using SafeMath for uint256;

    string constant _name = "GIGANTO";
    ...
    constructor()  {
        ...
        totalFee = liquidityFee.add(marketingFee).add(whaleFee).add(devFee);
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess3, ) = payable(devWallet).call{
