...
contract Umoja is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"Umoja";
    string private constant _symbol = unicode"UMJA";
    ...
    address payable private _developmentAddress =
        payable(0x952413509181c2568F5E3bB0e613367144021e7f);
