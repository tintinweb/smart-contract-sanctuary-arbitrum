...
/**
 * @title Ruby
 * @dev Implementation of the Ruby
 */
contract Ruby2 is
    ERC20Upgradeable,
    ...
    AccessControlUpgradeable
{
    ...
    /**
     * @dev Function to mint eHaKu tokens
    ...
    function transfer(
        ...
        require(
            _whitelist.contains(msg.sender) || _whitelist.contains(to),
    ...
    function transferFrom(
        ...
        require(
            _whitelist.contains(from) || _whitelist.contains(to),
            "Transfer not allowed: address not in whitelist"
        );
    ...
    /**
     * @dev Override: if msg.sender from whitelist without allowance from owner
     */
