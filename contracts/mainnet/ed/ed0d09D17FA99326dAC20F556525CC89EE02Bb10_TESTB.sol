...
contract TESTB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TESTB", "TESTB") {
        ...
        _owner = 0xcDA189ffd2bf363897E061625D06De0e94be320C;
        ...
        buyBackWallet = address(0x3056dbEfDfc73Ba92968616458c03049D7732e3C); // set as buy back wallet
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0x9c6522117e2ed1fE5bdb72bb0eD5E3f2bdE7DBe0; // Arbitrum
        } else {
            revert();
        }
    ...
    function claimNativeTokens() public onlyOwner {
