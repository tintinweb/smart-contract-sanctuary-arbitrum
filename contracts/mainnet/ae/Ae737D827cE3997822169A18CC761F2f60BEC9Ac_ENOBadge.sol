...
contract ENOBadge is ERC721Enumerable, Ownable {
    ...
    function mint(address to) public {
        ...
        require(_mintedCount[msg.sender] < 1, "Each address may only mint one NFT"); // Verifica si la dirección ya minteó un NFT
        
        _mintedCount[msg.sender] += 1; // Actualiza el contador de minteo para la dirección
