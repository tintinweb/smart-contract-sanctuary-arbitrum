...
contract AiMon is ERC721ABurnableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        __ERC721A_init("Polychain Monsters Experimental AI Toons", "AI1");
    ...
    function division(uint256 decimalPlaces, uint256 numerator, uint256 denominator) internal view returns(string memory result) {
