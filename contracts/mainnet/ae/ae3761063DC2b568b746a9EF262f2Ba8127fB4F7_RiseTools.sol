...
/**
Telegram: https://t.me/RiseTools
Website : https://RiseTools.cc
*/
...
contract RiseTools is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RISE TOOLS";
    ...
    uint256 public _maxTxAmount = 100000 * 10**4 * (10 ** _decimals);
    uint256 public _walletMax = 100000 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3d4990F7D873045Fcd3c2530f751A8F6263Ef38d;
        marketingWallet = 0x3d4990F7D873045Fcd3c2530f751A8F6263Ef38d;
        devWallet = 0x3d4990F7D873045Fcd3c2530f751A8F6263Ef38d;
