...
contract ArbitrumKing is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ArbitrumKing";
    string constant _symbol = "ARBKING";
    ...
    address public marketingFeeReceiver = 0x0156554830Aa23d0785b2Db6ae194a82b6A15ee0;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x0156554830Aa23d0785b2Db6ae194a82b6A15ee0] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x0156554830Aa23d0785b2Db6ae194a82b6A15ee0] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x0156554830Aa23d0785b2Db6ae194a82b6A15ee0,
                block.timestamp
            );
