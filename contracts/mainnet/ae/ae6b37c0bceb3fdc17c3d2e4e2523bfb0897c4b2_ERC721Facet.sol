...
import {ERC721Enumerable} from "lib/solidstate/contracts/token/ERC721/enumerable/ERC721Enumerable.sol";
import {ERC721Base, ERC721BaseInternal} from "lib/solidstate/contracts/token/ERC721/base/ERC721Base.sol";
import {LibDiamond} from "src/diamond/libraries/LibDiamond.sol";
import {ERC721MetadataStorage} from "lib/solidstate/contracts/token/ERC721/metadata/ERC721MetadataStorage.sol";
import {AccessControlInternal} from "../../../lib/solidstate/contracts/access/access_control/AccessControlInternal.sol";
    ...
    ERC721Enumerable
{
    ...
    ) external onlyRole(bytes32(0)) {
        ERC721MetadataStorage.layout().baseURI = _newURI;
