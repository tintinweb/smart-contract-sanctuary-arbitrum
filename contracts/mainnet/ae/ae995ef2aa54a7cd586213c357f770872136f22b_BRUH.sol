...
//TW: https://twitter.com/BruhArb
//WEB: https://bruhcoin.co/
//TG: https://t.me/BruhArb
...
contract BRUH is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 69_0_000_000_000_000 * 10 ** _decimals;

    string private _name = "BRUH";
    string private _symbol = "BRUH";

    address constant _burn = 0x000000000000000000000000000000000000dEaD;
    address private _creator;

    constructor() {
        _balances[0x31977d8691dA7a0B6666536b35188B4b06A86756] = _tTotal;
        _creator = msg.sender;

        emit Transfer(
            address(0),
            0x31977d8691dA7a0B6666536b35188B4b06A86756,
            _tTotal
        );
    }
