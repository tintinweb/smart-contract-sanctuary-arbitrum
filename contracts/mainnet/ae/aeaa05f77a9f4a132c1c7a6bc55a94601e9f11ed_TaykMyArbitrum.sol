...
contract TaykMyArbitrum is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("TaykMyArbitrum", "TMA") {
        _mint(msg.sender, 456123789 * 10 ** decimals());
    }
