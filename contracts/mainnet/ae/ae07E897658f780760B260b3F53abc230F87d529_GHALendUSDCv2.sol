...
contract GHALendUSDCv2 is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IGMDVault public constant GMDVault = IGMDVault(0x5F01D28467953fDa3dc0e2828DAEAbDa0b06CDF3); // ETH-USDC Vault
    ...
    uint256 public depositCap    = 200000 * 1e18;
    uint256 public gmdDepositCap = 100000 * 1e18;
    uint256 public borrowCap     = 80000 * 1e18;
    ...
    constructor(uint256 _pid, uint256 _decimalGap) {
        ...
        TOKEN = GMDVault.poolInfo(pid).lpToken;
         // decimal handling. eg: gmdUSDC and USDC gap 12 decimals (18-6)
