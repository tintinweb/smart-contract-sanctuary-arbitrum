    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 500, 1400) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcpSgQWCDeVNY6hhPKbPWyiG5YtirSY2iKe1CegnsnUed/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/SyLIZq8q3lQ7VJBCpXkh/contract-metadata";
  }
...
// File: contracts/BeautifulPiratesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BeautifulPiratesContract is RamppERC721A {
    constructor() RamppERC721A("Beautiful Pirates", "BPRT"){}
}
