...
contract Bullish is ReentrancyGuard, Pausable, XNFTHolder
{
	...
	function _deposit_erc20(uint256 _pool_id, address _address_user, uint256 _amount) internal
	{
		...
		if(_amount > 0)
		{
			...
			require(reward.emission_start_block_id >= block.number, "_deposit_erc20: Emission is not started yet.");
			require(pool.total_staked_amount > 0, "_deposit_erc20: Total staked amount is zero.");
			require(pool.last_reward_block_id == 0, "_deposit_erc20: Emission is paused.");
