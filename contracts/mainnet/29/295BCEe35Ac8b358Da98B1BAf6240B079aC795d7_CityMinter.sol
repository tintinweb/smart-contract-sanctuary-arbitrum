...
contract CityMinter is ReentrancyGuard, Pausable, ManagerModifier {
  ...
  // Constant
  //=======================================
  uint256 constant DEPREACATED = 9999;
  ...
  constructor(
    ...
    primeCollectibles[0] = [10, 11];
    primeCollectibles[1] = [DEPREACATED];
    primeCollectibles[2] = [12, 13, 14, 15];
    primeCollectibles[3] = [16];
    primeCollectibles[4] = [17];
    primeCollectibles[5] = [18];
    primeCollectibles[6] = [19];
  }
  ...
  function unstakeBatch(
    ...
    for (uint256 j = 0; j < _realmIds.length; j++) {
      ...
      require(realmLock.isUnlocked(realmId), "CityMinter: Realm is locked");
  ...
  function updateCollectibleCostPerCity(
    uint256 _collectibleCostPerCity
  ) external onlyAdmin {
  ...
  function updatePrimeCollectible(
    uint256[][] calldata _values
  ) external onlyAdmin {
    primeCollectibles[0] = _values[0];
    primeCollectibles[1] = _values[1];
    primeCollectibles[2] = _values[2];
    primeCollectibles[3] = _values[3];
    primeCollectibles[4] = _values[4];
    primeCollectibles[5] = _values[5];
    primeCollectibles[6] = _values[6];
  }
  ...
  function _checkPrimeCollectibles(
    uint256 _cityId,
