...
/**
Legend fabled that frogs are the bringer of rains,
Even more so on a rainy night with the moon shining brightly,
Across culture, rain has been connected to great wealth,
The sound of raindrop resonates with the sound of coins dropping on the floor,
Echoing the trades that occurs in this bullish crypto market,
The wisdom of the frog will bring forth a new era in the crypto space.
Le Luna PePe will bring on the rain to us and shine brightly towards a new financial future.
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0F2d484e07F6C99788fD7Dc4D9142e24b6279f7 ;
...
contract LeLunaPEPE is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xC3d616Cd74dB9F12bd2525b7E44Dee4d4Cb25f9C);
    ...
    string private _name = "Le Luna PEPE"; 
    string private _symbol = "LPPE";  
