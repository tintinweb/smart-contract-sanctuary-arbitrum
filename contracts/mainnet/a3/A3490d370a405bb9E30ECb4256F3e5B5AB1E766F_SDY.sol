...
/**
  * @title SDY
  * @author Steadefi
  * @notice Steadefi's protocol governance token. SDY will first launch on Arbitrum and
  * Avalanche networks with 150m tokens minted on Arbitrum and 50m on Avalanche for a total of 200m.
  * Future SDY deployments on new chains should not mint anymore SDY tokens as 200m is the max supply.
*/
contract SDY is ERC20, Ownable2Step {
  ...
  /**
    * @notice Only allow approved minter
  */
  modifier onlyMinter() {
    if (!minters[msg.sender]) revert Errors.OnlyMinterAllowed();
    _;
  }

  /* ====================== CONSTRUCTOR ====================== */

  constructor() ERC20("Steadefi", "SDY") Ownable(msg.sender) {
  ...
  */
  ...
  /**
    ...
    * @param approved Boolean to indicate whether minter is approved or not
  */
  function updateMinter(address minter, bool approved) external onlyOwner {
