 ...
 */
    ...
    function swapOnChainStrategies(address strat1, address strat2) external onlyAuthorized{
        uint256 pos1 = strategyPositionInArray[strat1];
        uint256 pos2 = strategyPositionInArray[strat2];
        OnChainStrategies[pos1] = strat2;
        OnChainStrategies[pos2] = strat1;
        strategyPositionInArray[strat1] = pos2;
        strategyPositionInArray[strat2] = pos1;
    }
