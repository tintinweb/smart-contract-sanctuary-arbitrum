...
import {IOrderHandler, MarketUtils, Price, Market, IReferralStorage, IMarketToken, ISwapHandler, IOrderVault, IGMXOracle, IEventEmitter, BaseOrderUtils, PositionUtils, IGMXUtils, Order, IOrderUtils, IDataStore, IReader, IExchangeRouter, Position, EventUtils, IOrderCallbackReceiver} from "../../interfaces/IGMX.sol";

import "../../interfaces/IGMXHedger.sol";
...
contract GMXHedger is IGMXHedger, OwnableUpgradeable, IOrderCallbackReceiver {
    ...
    function _updateConfig(
        ...
        marketProps = IReader(reader).getMarket(dataStore, market);
