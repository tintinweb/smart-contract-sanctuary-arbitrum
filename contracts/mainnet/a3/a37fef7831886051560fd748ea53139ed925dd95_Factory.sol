...
contract Factory is IFactory, UpgradeableOperable {
    ...
    function _swapperPaths(
        ...
        if (_type == 1 || _type == 3) {
            ...
            // Token 1 to token 0
            IUniswapV3Swapper(_swapper).upsertPathOverride(trackerZero, asset1, asset0, routes1);
            // Token 0 to token 1
            IUniswapV3Swapper(_swapper).upsertPathOverride(trackerOne, asset0, asset1, routes0);
        } else if (_type == 2) {
            // ALGEBRA
            ...
            // Token 1 to token 0
            IAlgebraSwapper(_swapper).upsertPathOverride(trackerZero, asset1, asset0, routes0);
            // Token 0 to token 1
            IAlgebraSwapper(_swapper).upsertPathOverride(trackerOne, asset0, asset1, routes1);
        }
    }
}
