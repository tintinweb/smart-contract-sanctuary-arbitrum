...
contract FOURTWENTY is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420000420 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xd060FFf8e12c78149C1F2f3A84Ee6Af6E9baF38C); 
    address payable private _marketingAddress = payable(0xd060FFf8e12c78149C1F2f3A84Ee6Af6E9baF38C);
    ...
    uint256 public _maxTxAmount = 4200420 * 10**9; 
    uint256 public _maxWalletSize = 4200420 * 10**9; 
