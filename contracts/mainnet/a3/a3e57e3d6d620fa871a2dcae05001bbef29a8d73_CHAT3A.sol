...
contract ERC721Creator is Proxy {
    ...
    constructor(string memory name, string memory symbol) {
        ...
        StorageSlot.getAddressSlot(_IMPLEMENTATION_SLOT).value = 0x4bd5B0A96611cc847c73c7F6cbCa1D2E1F6b7D20;
        (bool success, ) = 0x4bd5B0A96611cc847c73c7F6cbCa1D2E1F6b7D20.delegatecall(abi.encodeWithSignature("initialize(string,string)", name, symbol));
