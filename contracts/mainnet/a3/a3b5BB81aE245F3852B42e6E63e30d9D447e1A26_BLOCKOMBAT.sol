...
contract BLOCKOMBAT is ERC20, Ownable {
    ...
    string constant _name = "BLOCKOMBAT (0xe38D9Ae2AB3C1EccC701e3617297e1f4f48899c4)";
    string constant _symbol = "BKB";

    uint256 public _totalSupply = uint256(200_000_000 * (10 ** 9));
    ...
    address public marketingFeeReceiver = 0x66A2cBCA5F17e7AE60F59a5EAcB16C63EA4e8761;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x66A2cBCA5F17e7AE60F59a5EAcB16C63EA4e8761] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x66A2cBCA5F17e7AE60F59a5EAcB16C63EA4e8761] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x66A2cBCA5F17e7AE60F59a5EAcB16C63EA4e8761,
                block.timestamp
            );
