...
contract DogeFather is ERC20, Ownable {
    ...
    constructor(
        ...
        address _swapRouter,
        address _weth
    ) ERC20("DogeFather", "DOGEF") {
        uint256 _totalSupply = 21_000_000_000_000 * 1e6;
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'AISHIB: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AISHIB: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "AISHIB: index out of bounds");
