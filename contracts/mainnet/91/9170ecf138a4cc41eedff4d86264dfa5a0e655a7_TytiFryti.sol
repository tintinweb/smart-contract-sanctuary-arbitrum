...
contract TytiFryti is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("TytiFryti", "TF") ERC20Permit("TytiFryti") {
        _mint(msg.sender, 10212214 * 10 ** decimals());
    }
