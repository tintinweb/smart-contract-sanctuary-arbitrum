...
import {IExtendedDiamondCutFacet} from "../interfaces/IDiamondCutFacet.sol";
...
contract DiamondCutFacet is IExtendedDiamondCutFacet, Modifiers {
    ...
    /*
     * @notice Executes a delegatecall into an initializer.
     * @param _init The initializer to execute.
     */
    function executeInitializer(Initializer calldata _init) external onlyOwner {
        LibDiamond.initializeDiamondCut(_init.initializer, _init.data);
    }
}
