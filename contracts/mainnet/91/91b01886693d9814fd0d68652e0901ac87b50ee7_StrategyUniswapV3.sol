    ...
    function rate(uint256 sha) public view override returns (uint256) {
        ...
        );
        {
            ...
            uint256 newTokensOwed0 = FullMath.mulDiv(
                feeGrowthInside0X128 - min(feeGrowthInside0X128, feeGrowthInside0LastX128), liquidity, FixedPoint128.Q128);

            uint256 newTokensOwed1 = FullMath.mulDiv(
                feeGrowthInside1X128 - min(feeGrowthInside1X128, feeGrowthInside1LastX128), liquidity, FixedPoint128.Q128);
