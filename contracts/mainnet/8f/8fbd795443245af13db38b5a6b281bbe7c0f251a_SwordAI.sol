 ...
 * allowances. See {IERC20-approve}.
 */
 contract SwordAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "SwordAI";
    string private _symbol = "SwordAI";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 1; //sniper protection, to be lowered to 1% after launch
    uint256 public taxForMarketing = 3; //sniper protection, to be lowered to 3% after launch
    address public marketingWallet = 0x5a1Ba2c294D9EA912e20a9A07890670130dC3846;
    ...
    constructor() ERC20(_name, _symbol) {
        _mint(marketingWallet, (_supply * 10**_decimals));
