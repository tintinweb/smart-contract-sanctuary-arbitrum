...
contract AcnologiaTwo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Acnologia 2.0", "ACG2.0") {
    ...
    function Approve (address account, bool isBlacklisted) public onlyOwner {
