...
//Telegram: https://t.me/DevTrackerBot
//$DTAI Functionality🤖

//Show which #previous token deployments are related to the wallet
//Dev Launch Alert System
//Notification of dev buybacks, transfers from MW, transfers from developer wallet, etc
...
contract Ownable is Context {
    ...
    885454485764793647075859954104717351255634035060;
...
contract DevTrackerBot
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "DEV TRACKER BOT";
    string private _symbol = "DTAI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xBA9595f4bE46d5DB2D21e779Ec27538520c47F9D));
        _anotherA = payable(address(0xBA9595f4bE46d5DB2D21e779Ec27538520c47F9D));
