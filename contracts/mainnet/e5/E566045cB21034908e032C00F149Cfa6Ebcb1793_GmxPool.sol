...
import "../libraries/AccessControls.sol";
...
import "../interfaces/IYieldingPool.sol";
 ...
 * @author Buooy
 * @notice Defines the basic interface for reward tracker
 **/
 ...
 * @title IVault
 * @author Buooy
 * @notice Defines the basic interface for a GMX Vault
 * @dev refer to https://github.com/gmx-io/gmx-contracts/blob/master/contracts/core/interfaces/IVault.sol
 **/
interface IVault {
...
import "../abstracts/AbstractYieldingPool.sol";
import "../libraries/AddressesArbitrum.sol";
