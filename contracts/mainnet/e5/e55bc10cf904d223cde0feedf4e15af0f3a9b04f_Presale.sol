...
contract Presale is Ownable {
    ...
    uint256 public tokenPresaleDecimal;
    ...
    function setTokenPresale(address _tokenAddress, uint256 _decimal) public onlyOwner {
        TokenPresale = IERC20(_tokenAddress);
        tokenPresaleDecimal = _decimal;
    }
    ...
    function buyWithUSDT(uint256 usdtAmount, address referral) public {
        ...
        uint256 usdtAmount18 = usdtAmount * (10 ** (18 - usdtDecimal));

        require(usdtAmount18 >= minBuyUSDT, "Minimum purchase amount has not been reached");
        require(usdtAmount18 <= maxBuyUSDT, "Exceeded maximum purchase amount"); 

        uint256 receivedTokens = (usdtAmount18 * 10 ** priceDecimal) / pricePerUSDT[stage];
        ...
        if (referral != address(0) && referral != msg.sender) {
            ...
            totalSales[referral] += usdtAmount18;
    ...
    function claimTokens() public {
        ...
        uint256 claimableBalance = claimableBalances[msg.sender] / (10 ** (18 - tokenPresaleDecimal));
