...
contract NarkCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public initSupply = 300000000e18;
    ...
    address public uniswapV2Router = address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
    address public w3nAddress = address(0x63018C1E6f8B3fb24Ef35bA86Ac720ca78F5c05E);
    ...
    constructor() {
        ...
        // uniswapV2Pair = IPancakeFactory(IPancakeRouter(uniswapV2Router).factory()).createPair(address(this), w3nAddress);
    }
    ...
    function burn(address account, uint256 amount) external onlySupervise{
