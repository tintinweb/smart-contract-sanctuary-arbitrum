...
contract Arb15 is IBEP20, Auth {
    using SafeMath for uint256;

    address constant WBNB = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    address constant DEV = 0xaA3F7A6006C98327401c553ABb9580bF4579863f;

    string constant _name = "$ARB15";
    string constant _symbol = "ARB15";
