...
import "../../../external/uniswap/libraries/LiquidityAmounts.sol";
import "../../../external/uniswap/libraries/PositionValue.sol";
...
library FullMath {
    ...
    function mulDiv(
        ...
        // diff: original lib works under 0.8.9 with overflows enabled
        unchecked {
