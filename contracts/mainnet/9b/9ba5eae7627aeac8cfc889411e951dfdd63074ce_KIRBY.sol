...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69bDFd2a1a13cC9A943b4Cd94e4dC518FF9a06b3; // owner address
...
contract KIRBY is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x69bDFd2a1a13cC9A943b4Cd94e4dC518FF9a06b3); // Marketing Address
    address payable public teamWalletAddress = payable(0x69bDFd2a1a13cC9A943b4Cd94e4dC518FF9a06b3); // Team Address
