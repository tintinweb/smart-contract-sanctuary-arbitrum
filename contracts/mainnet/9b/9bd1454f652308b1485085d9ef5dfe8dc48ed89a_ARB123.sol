...
contract ARB123 is IERC20, Ownable {
    ...
    uint256 public _taxFee = 2;//鍒嗙孩
    uint256 public _destroyFee = 2;//閿€姣?
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    uint256 public _inviterFee = 3;//閭€璇?1浠ｇ櫨鍒嗕箣2浜屼唬鐧惧垎涔?1
    address public inviterAddress = address(0x775c5985E55Fa8713785eeA0DeEfDfbC3caA4C79);//鏃犳帹骞块粯璁ら挶鍖?
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;
    address public uniswapV2Pair;
    uint256 public _fund1Fee = 3;//钀ラ攢
    address public fund1Address = address(0x099D0E684dd8AD6764686A2bA30F72131DF299Af);//钀ラ攢閽卞寘
    address public Boss = address(0x05c2f1Bf714f4F6FbbD2393977f191f6727B2DaC);//鏉冮檺
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function blackbot(address addr, bool status) public{
