...
ShibAi is the first shib meme community token on Arbi ! 
...
contract ShibAi is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xeC3425370d245A38a3E44037a15a83cba9c13e4B);
    address payable private _marketingAddress = payable(0xeC3425370d245A38a3E44037a15a83cba9c13e4B);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 77, "Tax cannot be more than 7.");
	    require(taxFeeOnSell < 77, "Tax cannot be more than 7.");
