...
contract Treasury is ContractGuard {
    ...
    function setExtraFunds(
        ...
        require(_insuranceFundSharedPercent <= 1750, "out of range"); // <= 17.5%
        require(_devFund != address(0), "zero");
        require(_devFundSharedPercent <= 1250, "out of range"); // <= 12.5%
        daoFund = _daoFund;
    ...
    function _sendToMasonry(uint256 _amount) internal {
        ...
        if (insuranceFundSharedPercent > 0) {
            ...
            IERC20(tomb).transfer(insuranceFund, _insuranceFundSharedAmount);
