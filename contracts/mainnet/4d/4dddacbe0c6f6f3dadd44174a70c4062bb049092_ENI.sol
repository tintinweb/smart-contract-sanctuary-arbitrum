...
╔╗─╔╗─╔╗────║╚══╗║║─║║╔╝╚╗║╚═╝║║║╚╝║║║║║║───╔╗─╔╗─╔╗─
╚╝─╚╝─╚╝────╚═══╝╚╝─╚╝╚══╝╚═══╝╚╝──╚╝╚╝╚╝───╚╝─╚╝─╚╝─
https://t.me/EnigmaCryptocurrency
https://medium.com/@elusiveenigmatic/h-w-it-a-l-beg-n-9958d426f9f6
...
contract ENI is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Enigma"; 
    string constant _symbol = "ENI"; 
    ...
    uint256 public _maxWalletSize = _tTotal * 300 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0x239C49Beb734B5B6BC86BA815F1FdeBDcD8789Eb;
    address public marketingFeeReceiver = 0xb4669fFa00666431c552219Bf2433538d8257963;
    address public liquidityFeeReceiver = 0x2e8ae2459E5EA0E93ec509d4DF395B6185D431d0;
    ...
    function setBuyFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 10, "Invalid buy tax fees");
    }
    ...
    function setSellFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 10, "Invalid sell tax fees");
    }
