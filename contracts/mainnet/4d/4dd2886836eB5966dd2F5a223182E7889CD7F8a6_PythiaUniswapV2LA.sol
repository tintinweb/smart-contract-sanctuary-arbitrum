...
contract PythiaVersioning {
    string public constant PYTHIA_CORE_VERSION = "v1.0.0-rc.10";
    string public constant PYTHIA_PERIPHERY_VERSION = "v1.0.0-rc.7";
    string public constant PYTHIA_PROTOCOL_VERSION = "v0.0.6";
}
