...
contract VLC is Context, IBEP20, Ownable {
    ...
    string private _name = "Valentino Coin";
    ...
    constructor() {
        _balances[0xFf89AaD45eD7989a207480EC64F9ebe16933d38a] = _tTotal;
        _creator = msg.sender;

        emit Transfer(
            address(0),
            0xFf89AaD45eD7989a207480EC64F9ebe16933d38a,
            _tTotal
        );
    }
