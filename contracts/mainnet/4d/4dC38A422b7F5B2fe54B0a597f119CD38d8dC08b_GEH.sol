...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public USDC =
        IERC20Extended(0x292c6d47591D11198b1C1c935c391B292E69b5d3);
...
// main contract
contract GEH is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "GEH";
    string private constant _symbol = "GEH";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 42_690_000_000_000 * 10**_decimals;

    address public USDC = 0xEA7c9726632DdFcFFe7DfC8375f02E530E5D1890;
