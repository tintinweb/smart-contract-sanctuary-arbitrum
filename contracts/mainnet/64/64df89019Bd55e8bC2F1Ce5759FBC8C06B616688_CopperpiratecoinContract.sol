/**
 *Submitted for verification at Arbiscan on 2023-01-22
*/
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe981e2a9a49C82A22fE5E44E58C8523c8d622792];
  address public erc20Payable = 0xe981e2a9a49C82A22fE5E44E58C8523c8d622792;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 250, 300) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZWZkRaBQVEMS1gfrYDLoH7NJ28fHshYuEzqrC58GrV5W/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fNJE6PwsYoBRfNrWnbAx/contract-metadata";
  }
...
// File: contracts/CopperpiratecoinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CopperpiratecoinContract is RamppERC721A {
    constructor() RamppERC721A("COPPER PIRATE COIN", "CPC"){}
}
