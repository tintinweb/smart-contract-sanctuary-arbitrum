...
contract LShare is ERC20Burnable, Operator {
    ...
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 20000 ether;
    uint256 public constant INSURANCE_POOL_ALLOCATION = 17500 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 12500 ether;

    uint256 public constant VESTING_DURATION = 731 days;
    ...
    constructor(uint256 _startTime, address _communityFund, address _insuranceFund, address _devFund) public ERC20("LSHARE", "LSHARE") {
        ...
        insuranceFundRewardRate = INSURANCE_POOL_ALLOCATION.div(VESTING_DURATION);
    ...
    /**
     * @dev Claim pending rewards to community and insurance and dev fund
     */
