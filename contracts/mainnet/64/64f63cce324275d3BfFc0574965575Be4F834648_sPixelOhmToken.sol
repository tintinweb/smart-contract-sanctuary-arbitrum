...
contract sPixelOhmToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked Pixel OHM", "sPOHM", 9) ERC20Permit() {
    ...
    /**
        @notice increases staking token supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess staking token
