...
contract TheLostSBT is ERC1155, ERC1155Supply, Ownable, ReentrancyGuard {
    string public name = "TheLostSBT";
    string public symbol = "LostSBT";
    ...
    function mint(uint256 tokenId, address futureOwner, uint256 amount) public onlyAdmin {
        // Mint early token :
        _mint(futureOwner, tokenId, amount, "");
    }
