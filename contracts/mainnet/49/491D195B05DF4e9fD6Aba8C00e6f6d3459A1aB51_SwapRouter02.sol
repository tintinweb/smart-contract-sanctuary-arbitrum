...
interface ISwapRouter02 is IV3SwapRouter, IApproveAndCall, IMulticallExtended, ISelfPermit {
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x30146866f3a846fe3c636beb2756dbd24cf321bc52c9113c837c21f47470dfeb;
...
contract SwapRouter02 is ISwapRouter02, V3SwapRouter, ApproveAndCall, MulticallExtended, SelfPermit {
    constructor(
        address _factoryV2,
        address factoryV3,
