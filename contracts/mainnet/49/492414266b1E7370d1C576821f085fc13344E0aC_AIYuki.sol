...
contract AIYuki is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 210000000000000000 * 10**_decimals;
    string private constant _name = unicode"AIYUKI";
    string private constant _symbol = unicode"AIYUKI";
