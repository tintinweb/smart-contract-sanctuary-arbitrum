...
contract EvilNFT is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 6283;
    uint256 MAX_MINT_ARBI = 6666;
  ...
  function setMaxMintAmountPerTx(uint256 _maxMintAmountPerTx) public onlyOwner {
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < maxMintAmountPerTx, "Evil NFT: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ARBI,
