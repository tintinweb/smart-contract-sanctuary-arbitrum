...
contract Registry is SafeOwnable, Pausable {
    function initialize(
        ...
        l.vaultSettings.maxCpitBips[VaultRiskProfile.low] = 300; // 3%
        l.vaultSettings.maxCpitBips[VaultRiskProfile.medium] = 600; // 6%
        l.vaultSettings.maxCpitBips[VaultRiskProfile.high] = 1250; // 12.5%
        l.vaultSettings.maxSingleTradeImpactBips = 1250; // 12.5%;
    ...
    function maxCpitBips(
        ...
        RegistryStorage.Layout storage l = RegistryStorage.layout();
        return l.vaultSettings.maxCpitBips[riskProfile];
    }

    function maxSingleTradeImpactBips() external view returns (uint256) {
        RegistryStorage.Layout storage l = RegistryStorage.layout();
        return l.vaultSettings.maxSingleTradeImpactBips;
    }
