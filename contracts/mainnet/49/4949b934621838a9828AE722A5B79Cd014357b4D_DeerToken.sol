...
contract DeerToken is ERC20, Ownable, ERC20Burnable {
    ...
    uint public transferFee = 50; // fee 5%
    ...
    function enableTransferFee() public onlyAdmin {
        transferFeeEnabled = true;
    }

    function setTransferFee(uint256 fee) public onlyAdmin {
        transferFee = fee;
    }
    ...
    function _transfer(
        ...
        if (transferFeeEnabled) {
            uint256 taxAmount = amount.mul(transferFee).div(PERCENT_DIVIDER);
