...

        {
...

            {
                ...
                if (boostedLiquidityCache.newBoostedLiquidity > 0) {
                    ...
                    uint256 veRamBoostUsedRatio = states
                        .boostInfos[period]
                        .veRamInfos[params.veRamTokenId]
                        .veRamBoostUsedRatio -
                        states.boostInfos[period].veRamInfos[params.veRamTokenId].positionBoostUsedRatio[_positionHash];
                    {
                        uint256 veRamBoostAvailableRatio = 1e18 - veRamBoostUsedRatio;
                    ...
                    states.boostInfos[period].veRamInfos[params.veRamTokenId].positionBoostUsedRatio[
                        _positionHash
                    ] = FullMath.mulDiv(boostedLiquidityCache.newBoostedLiquidity, 1e18, veRamBoostAvailable);
