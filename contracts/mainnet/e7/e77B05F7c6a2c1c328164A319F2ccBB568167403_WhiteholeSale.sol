...
contract WhiteholeSale is ReentrancyGuard {
    ...
    // claim cliff + whitehole customize
    // 50% claim , 50% 1 month cliff

    uint256 public unlockTime;

    uint256 public lockupRatio = 5000;

    struct CliffInfo {
        uint256 claimable;
        bool claimed;
    }
    mapping(address => CliffInfo) public lockInfo;
    ...
    function initialize(
        ...
        // unlockTime = ((_releaseTime + 30 days) / 1 weeks) * 1 weeks; // TODO 
        unlockTime = _releaseTime + 600; 
    ...
    function harvest() public nonReentrant {
        ...
        lockInfo[msg.sender].claimable =
            (offeringTokenAmount * lockupRatio) /
            10000;
    ...
    function harvestUnlocked() public nonReentrant {
        require(block.timestamp > unlockTime, "not harvest time");
        require(lockInfo[msg.sender].claimable > 0, "have you participated?");
        require(!lockInfo[msg.sender].claimed, "nothing to harvest");
