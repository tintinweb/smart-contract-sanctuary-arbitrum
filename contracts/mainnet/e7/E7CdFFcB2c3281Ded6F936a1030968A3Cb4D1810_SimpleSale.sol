...
import "./xERMM.sol";  // Ensure the correct import if your token is xERMM

contract SimpleSale {
    IERC20 public token;
    IERC20 public usdt;
    uint256 public rate = 1250 * 10**18;  // Rate adjusted for xERMM decimals
    ...
    function buy(uint256 _usdtAmount) external {
        ...
        // Transfer USDT directly to owner's address instead of contract
    ...
    function withdraw() external {
        ...
        uint256 balance = token.balanceOf(address(this));  // Assuming you might want to withdraw tokens
