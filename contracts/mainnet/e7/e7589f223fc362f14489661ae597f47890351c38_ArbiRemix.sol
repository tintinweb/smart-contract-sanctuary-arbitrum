...
contract ArbiRemix is Context, IERC20, Ownable {
    ...
    string private constant _name = "ArbiRemix"; // 
    string private constant _symbol = "ArbiRemix"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 1;
    uint256 private _liquidityFee = 7;
    address private  _marketingWallet = 0x8163f3F873574B300e1580CBfFD99d26f64DbB1A;
