 ...
 */
contract SushiUsdChainlinkL2OracleId is ILiveFeedOracleId, OwnableWithEmergencyOracleId {
    // Chainlink
    ...
    constructor(
        ...
        {
            "author": "Opium.Team",
            "description": "SUSHI/USD Oracle ID",
            "asset": "SUSHI/USD",
            "type": "onchain",
            "source": "chainlink",
            "logic": "none",
        ...
        */
        emit LogMetadataSet("{\"author\":\"Opium.Team\",\"description\":\"SUSHI/USD Oracle ID\",\"asset\":\"SUSHI/USD\",\"type\":\"onchain\",\"source\":\"chainlink\",\"logic\":\"none\",\"path\":\"latestAnswer()\"}");
    }
