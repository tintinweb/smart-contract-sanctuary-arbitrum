...
contract ProphetIDO is Ownable {
    ...
    function buyAtTier(uint256 _tokenAmount, uint256 _tier) public payable {
        ...
        require(_tokenAmount * tiers[_tier].price / MINIMUM_PURCHASE == msg.value, "IDO: Wrong amount");
    ...
    function previewPurchase(uint256 _etherAmount, uint256 _tier) public view returns (uint256 tokensOut) {
        tokensOut = _etherAmount * MINIMUM_PURCHASE / tiers[_tier].price;
    }
