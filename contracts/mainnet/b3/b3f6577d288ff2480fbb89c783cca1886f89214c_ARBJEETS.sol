...
/*
 * ARBJEETS $NOJEET (COMMUNITY TOKEN)
 * =========================================
 * Community Chat: https://t.me/arbjeets
 * =========================================
 * 
 * TOKENOMICS :
 ...
 * 
 *🩸 WE KILL JEETS AND BOTS:
 *
 *Sell within 3 hours: 36% burn (24% Back to the Liquidity Pool, 12% Redistributed to Holders)
...
/*
 * @dev Provides information about the current exeNOJEETion context, including the
 * sender of the transaction and its data. While these are generally available
 * via msg.sender and msg.data, they should not be accessed in such a direct
 * manner, since when dealing with GSN meta-transactions the account sending and
 * paying for exeNOJEETion may not be the actual sender (as far as an application
 * is concerned).
 *
...
contract ARBJEETS is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 10 * 10**9 * 10**9; // Max Transaction: 100 Million (1%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 10 * 10**9 * 10**9; // Max Wallet: 200 Million (2%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "ARBJEETS";
    string private _symbol = "NOJEET";
