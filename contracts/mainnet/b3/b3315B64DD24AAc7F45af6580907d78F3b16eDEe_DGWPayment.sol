...
contract DGWPayment is DChainBase {
    ...
    bytes32 constant public ORDER_COMPLETED_SLUG = keccak256(abi.encode("COMPLETED"));
    ...
    event OrderExecuted(bytes32 indexed id, address indexed recipient, uint256 amount);
    ...
    function initialize(address _owner, IERC20WithBurn _rewardToken) external initializer {
    ...
    function updateExecutor(address _executor, bool status) external onlyRole(OWNER_ROLE) {
