...
contract AirPuff1XweETH is AirPuff1X {
    ...
    function initialize(address _weETH) external initializer {
        require(_weETH != address(0), "AirPuff: WETH address is invalid");
        ...
        __ERC20_init("AirPuff-EtherFi1X", "bweETH1X");
    }
}