...
contract Potato is ERC20, Ownable {
    ...
    string constant _name = "Potato";
    string constant _symbol = "POTATO";
    ...
    address public marketingFeeReceiver = 0xfCaF976F5775190AeF9c9c7B5D35Fa2cfb8a93a4;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xfCaF976F5775190AeF9c9c7B5D35Fa2cfb8a93a4,
                block.timestamp
            );
