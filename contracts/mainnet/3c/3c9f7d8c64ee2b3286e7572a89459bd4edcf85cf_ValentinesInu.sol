...
https://t.me/ValentinesInuARB

https://twitter.com/ValentinesInuARB

https://ValentinesInu.site
...
contract ValentinesInu is Context, IERC20 { // 69
    ...
    address payable public Wallet_Marketing = payable(0x693677611D4bD2BFc73e2515bf8C96Ba0Ba93294); // 69
    address payable public Wallet_Dev = payable(0xea8f3641F7AC6B2a8D6Ff2b7Eb5CB7F93b71a728);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**6 * 10**_decimals;// 69
    string private constant _name = "Valentine's Inu"; 
    string private constant _symbol = unicode"$CUPID"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 5; //69
    ...
    constructor () {
        ...
        _owner = 0x4689DE6b18Ae73e5dad2BaC02ba64Ccb53e7E119; // 69
