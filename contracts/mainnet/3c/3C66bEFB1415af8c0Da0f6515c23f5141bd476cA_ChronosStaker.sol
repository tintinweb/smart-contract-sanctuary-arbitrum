...
contract ChronosStaker is DyVARAManager, ReentrancyGuardUpgradeable, ERC20Upgradeable {
  ...
  function setSolidVoter(IEquilibreVoter _solidVoter) external onlyManager {
...
contract DyVARAManager is OwnableUpgradeable, PausableUpgradeable {
  /**
   * @dev Dyson Contracts:
  ...
  function __DyVARAManager_init(address _keeper, address _voter) public initializer {
    __DyVARAManager_init_unchained(_keeper, _voter);
  }

  function __DyVARAManager_init_unchained(address _keeper, address _voter) internal initializer {
    keeper = _keeper;
    voter = _voter;
  }
