...
contract HideNSeekBase {
    ...
    mapping(uint256 => mapping(uint256 => IHideNSeek.GhostMapSession))
        public TIDtoGMS;
    ...
    mapping(address => IHideNSeek.Session[]) public claimableSessions;
    mapping(address => IHideNSeek.Session) lockedSessions;
    IHideNSeek.Session[] activeSessions;
