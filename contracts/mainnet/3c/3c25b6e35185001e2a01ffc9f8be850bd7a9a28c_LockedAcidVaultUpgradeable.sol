...
contract LockedAcidVaultUpgradeable is UpgradeableVault {
    ...
    function totalAssets() public view override returns (uint256) {
        uint256 earned = vester.claimable(address(this)) * (HUNDRED_PERCENT - treasuryFeePercentage - burnPercentage)
            / HUNDRED_PERCENT;
        ...
        return IERC20Upgradeable(address(rewardTracker)).balanceOf(address(this))
            ...
            + IERC20Upgradeable(address(vester)).balanceOf(address(this)) + earned + rewardTracker.claimable(address(this))
            - feesToCollect;
    }
