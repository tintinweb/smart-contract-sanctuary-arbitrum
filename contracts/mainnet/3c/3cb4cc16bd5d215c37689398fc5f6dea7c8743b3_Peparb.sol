...
contract Peparb is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Peparb";
    string private _symbol = "Peparb";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xb46CBb12eadf189c45af7256B842074b5BBCfb37);
    address payable public DeveloperWallet = payable(0xb46CBb12eadf189c45af7256B842074b5BBCfb37);
