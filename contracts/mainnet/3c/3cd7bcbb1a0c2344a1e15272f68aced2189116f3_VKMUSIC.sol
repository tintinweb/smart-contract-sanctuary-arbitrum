...
contract VKMUSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="VKMUSIC";
    string private _symbol = unicode"VKMUSIC";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xB626feD3b1e5f9f827fc39b0b470F71342223991);
    address payable private taxWallet2 = payable(0xB626feD3b1e5f9f827fc39b0b470F71342223991);
    ...
    uint256 private _totalSupply = 10_000_000 * 10**9; //10000000000000000000000
