...
// File: contracts/pool/DuckJackpot.sol
...
contract DuckJackpotV2 is Initializable, OwnableUpgradeable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function addCaller(address val) public onlyOwner() {
        require(val != address(0), "DuckJackpot: val is the zero address");
        _callers.add(val);
    }

    function delCaller(address caller) public onlyOwner returns (bool) {
        require(caller != address(0), "DuckJackpot: caller is the zero address");
