...
library Utils {
    ...
    function linkVertexSigner(
        ...
        bytes32 contractSubaccount = bytes32(abi.encodePacked(uint160(address(this)), defaultSubaccountName));
        bytes32 externalSubaccount = bytes32(abi.encodePacked(uint160(externalAccount), defaultSubaccountName));
