...
contract SER is ERC20, Ownable {
    ...
    event FeedVillage(address indexed account, uint256 feedAmount);
    event ExcludeFromFees(address indexed account, bool isExcluded);

    constructor(address _erc20) ERC20("Feed Village", "SER") {
        _ERC20 = _erc20;
        ...
        uint256 _buyFrenFee = 6;
        uint256 _buyLiquidityFee = 0;

        uint256 _sellFrenFee = 6;
        uint256 _sellLiquidityFee = 0;

        uint256 totalSupply = 420_000 * 1e18;
        ...
        frenWallet = address(0x047f3B3a47BC81078BB2D3C7dca7F8f325131840); // set as Fren wallet
    ...
    function feedVillage(uint256 amount) public returns (bool) {
        _transfer(msg.sender, address(0xdead), amount);
        emit FeedVillage(msg.sender, amount);
    }
