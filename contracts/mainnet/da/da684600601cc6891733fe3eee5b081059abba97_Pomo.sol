...
import {IPomo} from "./interfaces/IPomo.sol";
import {ERC20} from "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import {Ownable} from "@openzeppelin/contracts/access/Ownable.sol";

contract Pomo is IPomo, ERC20, Ownable {
    address private _minter;

    modifier onlyMinter() {
        require(msg.sender == _minter, "Pomo: caller is not the minter");
        _;
    }

    constructor(address admin) ERC20("POMO Network", "POMO") Ownable(admin) {}
