...
/*
Baby Saitarb Inu is a community meme token launching to support the already successful 
SAITARB INU. Liquidity will be locked after launch + Ownership will be fully renounced. 
With this project we want to show our appreciation to the Saitarb project by bringing 
the same vibes and community but in its baby form.


Telegram: https://t.me/BabySaitarbInu
Website: V1 coming soon


Taxes: 0% on Buys + Sells
*/
...
contract BABYSAITARBINU is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public _totalAmount = 100000000 * 10 ** 18;
    uint256 public _totalFee = 0;
    uint256 public _feeDenominator = 100;
    mapping(address => bool) private _blackList;
    string  _name = "BABY SAITARB INU";
    string  _symbol = "bSAITARB";
    address _marketingFeeReceiver = 0xeB5b2ADC63C0362f958DacDAbEd7057362fa9d7c;
    address _teamFeeReceiver = 0xeB5b2ADC63C0362f958DacDAbEd7057362fa9d7c;
