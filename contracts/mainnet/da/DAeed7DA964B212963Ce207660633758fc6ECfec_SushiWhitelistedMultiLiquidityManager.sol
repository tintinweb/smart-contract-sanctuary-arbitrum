...
abstract contract SushiBaseLiquidityManager is
    Initializable,
    ERC20Upgradeable,
    PausableUpgradeable,
    ...
    IUniswapV3SwapCallback
{
    ...
    IUniswapV3Factory internal constant FACTORY =
        IUniswapV3Factory(0x917933899c6a5F8E37F31E19f92CdBFF7e8FF0e2); //Sushi Factory Address
...
import { SushiMultiPositionLiquidityManager } from "./SushiMultiPositionLiquidityManager.sol";
...
contract SushiWhitelistedMultiLiquidityManager is
