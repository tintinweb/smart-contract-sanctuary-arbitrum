...
contract LendingVaultV2 is ERC20, ReentrancyGuard, Pausable, AccessManaged, ILendingVaultV2 {
  ...
  */
  function updateKeeper(address keeper, bool approval) external restricted {
  ...
  /**
    ...
    * @param repayAmt Amount of debt to repay in token decimals
  */
  function emergencyRepay(uint256 repayAmt, address defaulter) external nonReentrant restricted {
    if (repayAmt == 0) revert Errors.InsufficientRepayAmount();
