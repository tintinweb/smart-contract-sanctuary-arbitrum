...
contract RedKing is ERC20, Ownable {
    ...
    string public name_ = "ABC";//名称
    string public symbol_ = "AB";//简称
    uint256 public totalSupply_ = 100000;//供应量 不用后面18位
    address public rewardAddr_ = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;//分红合约地址
    address public marketingWalletAddr_ = 0x236d5e492E836eccB8be80D429B0F71a33BB34a4;//营销钱包地址
    uint256[3] public  buyFeeSetting_ = [0,3,0];//买入手续费
    uint256[3] public  sellFeeSetting_ = [0,3,0];//卖出手续费
    ...
    function _transfer(
        ...
        bool canSwap = AmountMarketingFee > swapTokensAtAmount || AmountLiquidityFee > swapTokensAtAmount ;
        if( canSwap &&
            !swapping &&
    ...
    function swapAndSendToFee() private  {
        uint256 tokens = balanceOf(address(this)).sub(AmountLiquidityFee);
