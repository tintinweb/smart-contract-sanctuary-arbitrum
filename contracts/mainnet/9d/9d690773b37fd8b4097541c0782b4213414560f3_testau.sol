...
// File: contracts/auditAIToken.sol
...
contract testau is ERC20, Ownable {
    ...
    constructor(address _uniswapRouter, address payable _marketing, address payable _developer)
        ERC20('testau', '$Au') Ownable(msg.sender)
    {
    ...
    uint256 public totalAvailableToClaim = 0; // make it private
