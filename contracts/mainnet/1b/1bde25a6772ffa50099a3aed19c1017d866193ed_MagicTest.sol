...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, Ownable {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
      ...
      router = _router;
      rewardToken = 0x539bdE0d7Dbd336b79148AA742883198BBF60342;
  }
...
contract MagicTest is ERC20, Ownable {
    ...
    iStableDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x950eBD2713d06f0f8534b1b6F330EA013E4c4A9F;
    address public devWallet = 0xe0504d478F48fBeA692b024b086e8F5aD83b5293;
    ...
    constructor() ERC20("MagicTest", "MagicTest") {
        dividendTracker = new iStableDividendTracker();
        ...
        /*
            ...
            and CANNOT be called ever again
        */
        _tokengeneration(owner(), 1e9 * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        iStableDividendTracker newDividendTracker = iStableDividendTracker(
            payable(newAddress)
        );
...
contract iStableDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
