...
frenliest liquidity locker on arbitrum,
soon to be a platform for auditing other projects to make sure everyone is secure on Arbitrum!

https://t.me/fren_ship
https://twitter.com/FRENSHIP101 
https://frenship.biz/ 
...
contract Frenship is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "FrenShip";
    string private _symbol = "FrenShip";
    ...
    constructor () {
        ...
        workSpace = payable(address(0x95F76B9Bd7dd3676c1536b6b7002277fcA24b21f));
