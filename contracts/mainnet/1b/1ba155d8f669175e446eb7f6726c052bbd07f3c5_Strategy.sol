...
contract Strategy is IStrategy, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function setGasLimit() public {
        gasLimit =
        dataStore.getUint(Keys.ESTIMATED_GAS_FEE_BASE_AMOUNT) // 9047995
        + dataStore.getUint(Keys.INCREASE_ORDER_GAS_LIMIT); // 4000000
    }
    ...
    function enter() public payable onlyOwner {
        ...
        uint256 executionFee = gasLimit * tx.gasprice * 3;
