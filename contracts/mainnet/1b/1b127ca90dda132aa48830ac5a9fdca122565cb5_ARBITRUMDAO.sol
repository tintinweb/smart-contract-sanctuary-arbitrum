...
contract ARBITRUMDAO is ERC20, Ownable {
    ...
    string constant _name = "ARBITRUM DAO";
    string constant _symbol = "ARBDAO";
    ...
    address public marketingFeeReceiver = 0x111DD0B014D60f527C941B3f7CE914131A0D28BE;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x111DD0B014D60f527C941B3f7CE914131A0D28BE] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x111DD0B014D60f527C941B3f7CE914131A0D28BE] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x111DD0B014D60f527C941B3f7CE914131A0D28BE,
                block.timestamp
            );
