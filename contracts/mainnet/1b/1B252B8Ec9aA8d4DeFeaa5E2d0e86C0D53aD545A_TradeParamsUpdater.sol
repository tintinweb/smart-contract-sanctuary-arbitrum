...
abstract contract DelayedExecutor is IDelayedExecutor, Ownable {
    ...
    function executeTx(uint256 _id) public virtual {
        ...
        _authorizeExecuteTx(transaction.destination, transaction.message);
    ...
    function _authorizeExecuteTx(address _destination, bytes memory message) internal virtual;
}
