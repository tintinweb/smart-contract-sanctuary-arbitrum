...
library LibLaunchPadFactoryStorage {
    ...
    function getLaunchPadProjectSelectors() internal pure returns (bytes4[] memory) {
        bytes4[] memory functionSelectors = new bytes4[](33);
        ...
        functionSelectors[26] = ILaunchPadProject.setTokenAddress.selector;
        functionSelectors[27] = ILaunchPadProject.tokenDecimals.selector;
        functionSelectors[28] = ILaunchPadProject.totalTokensClaimed.selector;
        functionSelectors[29] = ILaunchPadProject.totalTokensSold.selector;
        functionSelectors[30] = ILaunchPadProject.withdrawFees.selector;
        functionSelectors[31] = ILaunchPadProject.withdrawTokens.selector;
        functionSelectors[32] = ILaunchPadProject.withdrawTokensToRecipient.selector;
