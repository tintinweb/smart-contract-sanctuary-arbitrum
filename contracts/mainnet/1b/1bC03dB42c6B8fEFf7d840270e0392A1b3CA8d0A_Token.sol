...
interface IERC20 {
     ...
     * https://g...content-available-to-author-only...b.com/ethereum/EIPs/issues/20#issuecomment-263524729
     *
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://g...content-available-to-author-only...b.com/OpenZeppelin/openzeppelin-contracts/pull/522
        if (a == 0) {
            return 0;
        }
 ...
 * that a supply mechanism has to be added in a derived contract using {_addLiquid}.
 * For a generic mechanism see {ERC20PresetMinterPauser}.
 *
 * TIP: For a detailed writeup see our guide
 * https://f...content-available-to-author-only...n.com/t/how-to-implement-erc20-supply-mechanisms/226[How
