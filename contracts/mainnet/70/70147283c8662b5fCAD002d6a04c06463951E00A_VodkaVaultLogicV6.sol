...
//@note @OnahProsperity potential problem 1 
        IERC20Metadata(asset).safeTransferFrom(msg.sender, address(this), assets);
//@note @OnahProsperity  potential problem 2
...
library VodkaVaultManagerV2 {
    ...
    using VodkaVaultManagerV2 for State;
...
import { VodkaVaultManagerV2 } from "../libraries/VodkaVaultManagerV2.sol";
import { SafeCast } from "../libraries/SafeCast.sol";
 ...
 * @author Vodka
 **/
contract VodkaVaultLogicV6 is IVodkaVault, ERC4626Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    using SafeCast for uint256;
    using FullMath for uint256;
    ...
    using VodkaVaultManagerV2 for VodkaVaultManagerV2.State;
    uint256 internal constant MAX_BPS = 10_000;
    uint256 internal constant PRICE_PRECISION = 1e30;

    VodkaVaultManagerV2.State internal state;
    ...
    function initialize(
        ...
        VodkaVaultManagerV2.Tokens calldata _tokens,
    ...
    function updateAssets(address _sglp) external onlyOwner {
        asset = _sglp;
    }
    ...
    */
    ...
    function getTokenReservesInGlp() public view returns (uint256) {
        return state.getTokenReservesInGlp(address(state.wbtc), totalAssets());
    }
}