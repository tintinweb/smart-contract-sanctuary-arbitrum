...
contract Dogwifhat is ERC20, Ownable {
    ...
    constructor() ERC20("dogwifhat", "$WIF") {
        ...
        uint256 totalSupply = 694_200_000_000 * 1e18; // 694.200.000.000 Total Supply

        maxTransactionAmount = 4_200_000_000 * 1e18; // 
        maxWallet = 4_200_000_000 * 1e18; // 1% 
        ...
        marketingWallet = address(0x192f163f2eA2ca8CaC812AAEf5b1398E65e7006e); // set as marketing wallet
        devWallet = address(0x192f163f2eA2ca8CaC812AAEf5b1398E65e7006e); // set as dev wallet
