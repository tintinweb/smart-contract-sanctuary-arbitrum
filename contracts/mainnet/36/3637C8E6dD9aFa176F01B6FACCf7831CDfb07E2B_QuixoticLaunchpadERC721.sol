...
contract QuixoticLaunchpadERC721 is ERC721("Charmings NFT", "charm"), ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 6, "Exceeded max token purchase");
