...
contract LaunchPadProjectDiamondInit is AccessControl, ILaunchPadProjectInit {
    function init(ILaunchPadCommon.CreateLaunchPadInput memory input) external {
        ...
        require(input.feePercentage < LibCommonConsts.BASIS_POINTS, "LaunchPad: feePercentage must be less than 100%");
        ...
        ds.feePercentage = input.feePercentage;
        ...
        require(totalPerc == LibCommonConsts.BASIS_POINTS, "LaunchPad: release percentages must sum up to 100%");
