...
import {SafeCast} from "@openzeppelin/contracts-new/utils/math/SafeCast.sol";
import {ERC20Permit, ERC20} from "@openzeppelin/contracts-new/token/ERC20/extensions/draft-ERC20Permit.sol";
import {ReentrancyGuard} from "@openzeppelin/contracts-new/security/ReentrancyGuard.sol";
import {Ownable} from "@openzeppelin/contracts-new/access/Ownable.sol";
import {IAlgebraPool} from "./algebra/interfaces/IAlgebraPool.sol";
import {TickMath} from "./libraries/TickMath.sol";
import {FullMath} from "./libraries/FullMath.sol";
import {LiquidityAmounts} from "./libraries/LiquidityAmounts.sol";
import {PositionKey} from "./periphery/libraries/PositionKey.sol";
import {PoolAddress} from  "./periphery/libraries/PoolAddress.sol";
import {CallbackValidation} from "./periphery/libraries/CallbackValidation.sol";
import {ILiquidityManager} from "./interfaces/ILiquidityManager.sol";
import {IAlgebraMintCallback} from "./algebra/interfaces/IAlgebraMintCallback.sol";
import {IDataStorageOperator} from "./algebra/interfaces/IDataStorageOperator.sol";

import {ISwapRouter} from "./periphery/interfaces/ISwapRouter.sol";
...
contract LiquidityManager is ILiquidityManager, ERC20Permit, ReentrancyGuard {
    ...
    **/
    ...
    function _position(int24 tickLower, int24 tickUpper) internal view returns (uint128 liq, uint128 tokensOwed0, uint128 tokensOwed1){
...
import {IERC20Metadata} from "@openzeppelin/contracts-new/token/ERC20/extensions/IERC20Metadata.sol";
import {Ownable} from "@openzeppelin/contracts-new/access/Ownable.sol";
import {Constants} from "./algebra/libraries/Constants.sol";
...
import "../../tokens/mocks/TestERC20.sol";
...
/// @title AlgebraMulticall
/// @notice Enables calling multiple methods in a single call to the contract
abstract contract AlgebraMulticall is IMulticall {
...
import "../../algebra/interfaces/IAlgebraMintCallback.sol";
    ...
    PeripheryImmutableState
{
    ...
    function unwrapWNativeToken(uint256 amountMinimum, address recipient)
        ...
        override
    {
        uint256 balanceWNativeToken = IWNativeToken(WNativeToken).balanceOf(
            address(this)
        );
        require(
            balanceWNativeToken >= amountMinimum,
    ...
    IPeripheryPaymentsWithFee
{
    ...
    function unwrapWNativeTokenWithFee(
        ...
        if (balanceWNativeToken > 0) {
            ...
            if (feeAmount > 0)
                TransferHelper.safeTransferNative(feeRecipient, feeAmount);
            TransferHelper.safeTransferNative(
                recipient,
                balanceWNativeToken - feeAmount
            );
        }
    }
...
import "@openzeppelin/contracts-new/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts-new/token/ERC20/extensions/draft-IERC20Permit.sol";
...
import "../../algebra/interfaces/IAlgebraSwapCallback.sol";
...
library PoolAddress {
    ...
    function computeAddress(address poolDeployer, PoolKey memory key)
        internal
        pure
...
library PoolInteraction {
    ...
    function _getSqrtPrice(IAlgebraPool pool)
        internal
        view
...
import "./base/AlgebraMulticall.sol";
