...
contract LevelOracle is Ownable, ILevelOracle {
    ...
    uint256 public constant PRICE_FEED_ERROR = 1 days;
    uint256 public constant PRICE_FEED_INACTIVE = 12 hours;
    ...
    function configToken(
        ...
        require(chainlinkTimeout != 0 && chainlinkTimeout <= MAX_CHAINLINK_TIMEOUT, "PriceFeed:invalidTimeout");
        require(chainlinkDeviation != 0 && chainlinkDeviation <= MAX_DEVIATION, "PriceFeed:invalidChainlinkDeviation");
