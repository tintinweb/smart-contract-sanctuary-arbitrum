...
/**
Mametchi your virtual mascot in Arbitrum.

Mametchi [MET] gives to their holders a juicy USDC rewards in every transaction. So its worth to hold longterm because you will earn USDC while doing nothing.


Taxes distributed in:
 - 4% USDC rewards
 - 3% Marketing
 - 1% LP

Telegram: https://t.me/Mametchi_Arb
Website: https://mametchitoken.com
Twitter: https://twitter.com/mametchitoken
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
        address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Sushi
    IBEP20 RewardToken = IBEP20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8); //USDC
...
contract Mametchi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MAMETCHI";
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Sushi
    address RewardToken = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8; //USDC

    uint256 _totalSupply = 10 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 0.1 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 0.2 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // 
        autoLiquidityReceiver = 0xda345E87e60da285a65390f1b32A3e52b6A236a0;
        marketingWallet = 0xda345E87e60da285a65390f1b32A3e52b6A236a0;
        devWallet = 0xda345E87e60da285a65390f1b32A3e52b6A236a0;
