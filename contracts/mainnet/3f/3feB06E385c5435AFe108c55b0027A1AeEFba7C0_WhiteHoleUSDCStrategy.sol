...
import {ICore} from "../interfaces/whiteHole/ICore.sol";
import {IGToken} from "../interfaces/whiteHole/IGToken.sol";
import {IERC20, InitializableAbstractStrategy} from "../utils/InitializableAbstractStrategy.sol";
import "@uniswap/v3-periphery/contracts/interfaces/ISwapRouter.sol";
import "@uniswap/v3-periphery/contracts/libraries/TransferHelper.sol";

contract WhiteHoleUSDCStrategy is InitializableAbstractStrategy {
    ...
    function initialize(
        ...
        address[] calldata _pTokens // gUSDC 0xD8fD0886Ef16fE8FBD1771b6AE6B9A5B4Be228E1
    ...
    function collectRewardTokens()
        ...
        nonReentrant
    {
        ICERC20 cToken = _getCTokenFor(primaryStableAddress);
    ...
    function _deposit(address _asset, uint256 _amount) internal {
        ...
        uint256 bal = ICore(platformAddress).supply(address(cToken), _amount);
    ...
    function withdraw(
        ...
        ICore(platformAddress).redeemUnderlying(address(cToken), _amount);
    ...
    function _checkBalance(
        ...
        balance = IGToken(address(_cToken)).underlyingBalanceOf(address(this));
    }
