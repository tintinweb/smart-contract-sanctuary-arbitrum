...
contract QuoterV2 is IQuoterV2, IOreoV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IOreoV3Pool) {
        return IOreoV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function oreoV3SwapCallback(
        ...
        IOreoV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IOreoV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
...
/// @notice Provides validation for callbacks from OreoSwap V3 Pools
library CallbackValidation {
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (IOreoV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolAddress.PoolKey memory poolKey)
        internal
        view
        returns (IOreoV3Pool pool)
    {
        pool = IOreoV3Pool(PoolAddress.computeAddress(deployer, poolKey));
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xb9c7f513200b32af38da357c2f65e668bddabfd0b166ebc8190a2d221f282b06;
