...
contract Factory is Helper {
    ...
    function crossChainMint(
        ...
        if (bytes(_tokenURI).length != 0) {
            _daoBalance = IERC721DAO(_daoAddress)._tokenIdTracker() * _daoDetails.pricePerToken;
            ...
            _daoBalance = IERC20DAO(_daoAddress).totalSupply() * _daoDetails.pricePerToken;
    ...
    function buyGovernanceTokenERC20DAO(
        ...
        uint256 daoBalance = IERC20DAO(_daoAddress).totalSupply() * _daoDetails.pricePerToken;
    ...
    function buyGovernanceTokenERC721DAO(
       ...
       uint256 daoBalance = IERC721DAO(_daoAddress)._tokenIdTracker() * _daoDetails.pricePerToken;
