...
Don't Miss Today's Launch 4.30PM UTC 
 
Shepherd helps by creating an alternative to the dominant centralized systems of the Internet, protecting our ability to make our own choices and giving trustworthy information we can act on. We call this 'digital agency', and we believe it will give us the power to face today's complex problems, together.

🟢 TOKENOMICS 

Token Supply :1000.000.000
97% Token Liquidity Sushiswap 
3%    Marketing Token 
...
Portal :
https://t.me/ShepherdARB
Twitter:
https://twitter.com/Shepherd_ARB
Website:
will be live within 2-4 hours After launch
*/
...
contract SheppherdARB   is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SheppherdARB  ";
    string private constant _symbol = unicode"$Sheppherd ";
    ...
    address internal constant development_receiver = 0xbCa14F7414C0B0351993d4F04D8e9243f6f2Ef76; 
    address internal constant marketing_receiver = 0xbCa14F7414C0B0351993d4F04D8e9243f6f2Ef76;
    address internal constant liquidity_receiver = 0xbCa14F7414C0B0351993d4F04D8e9243f6f2Ef76;
