...
contract ArkenDexV4 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function trade(
        ...
        require(
            desc.amountIn > 0,
            'Amount-in needs to be more than zero'
        );
        require(
            desc.amountOutMin > 0,
    ...
    function tradeStopLimit(
        ...
        require(
            stopLimitFee > 0 && minimumStopLimitFee > 0,
            'stopLimitFee and minimumStopLimitFee need to be more than zero'
        );
        require(
    ...
    function tradeStopLimitOutside(
        ArkenDexTrader.TradeDescriptionOutside calldata desc,
        uint256 stopLimitFee,
        uint256 minimumStopLimitFee,
        bytes calldata interactionDataOutside,
