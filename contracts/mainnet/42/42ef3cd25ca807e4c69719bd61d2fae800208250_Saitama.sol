...
contract Saitama is Ownable, ERC20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x00Ab7242c136062114805D7D5151985CD6F80010;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        function editMaxHoldings(uint256 maxWallPercent) external onlyOwner {
         require(_maxWalletToken >= _totalSupply / 1000); 
        _maxWalletToken = (_totalSupply * maxWallPercent ) / 1000;
                
    }

    function editMaxTX(uint256 maxTXPercent) external onlyOwner {
    ...
    function setpercent(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
