...
/**
 * Website - https://www.arbikaiinu.com
 * Telegram - https://t.me/arbikaiinu
 * Twitter - https://twitter.com/arbikaiinu
*/
...
contract ArbiKai is ERC20, Ownable {
    ...
    uint256 public constant LIQUIDITY_SHARE = (MAX_SUPPLY / 1000) * 480;
    uint256 public maxWallet = MAX_SUPPLY / 100; // 1% (10000000)
    uint256 public maxTransfer = MAX_SUPPLY / 200; // 0.5% (5000000)
    uint256 public maxRestrictionBlocks = 250000;

    uint256 public ohakaRyou = 300;
