...
contract GEMS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GEMS";  // Name
    string private constant _symbol = unicode"MOCK"; // Symbol
    ...
    //Tax fee Collector
    address payable public _taxFeeCollectorWallet = payable(0x493b85e31Ca9Ea2cC98b750892CA6491C41F4543);
