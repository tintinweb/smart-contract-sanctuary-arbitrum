...
contract RewardPool is IStake, Initializable {
    ...
    function initialize(bytes calldata data) external initializer() {
        (address _generator, address _factory, address stake, address reward, uint limit, uint lock, uint _rewardPerBlock, bytes4 _mintSelector, bool test) =
         abi.decode(data, (address, address, address, address, uint, uint, uint, bytes4, bool));
