...
contract TestGMXVault {
  ...
  IERC20 WETH_GM = IERC20(0x450bb6774Dd8a756274E0ab4107953259d2ac541); // WETH- GM
  IERC20 WETH_USDC_GM = IERC20(0x70d95587d40A2caf56bd97485aB3Eec10Bee6336); // WETH-USDC GM
  ...
  constructor() {
    ...
    WETH_USDC_GM.approve(address(router), type(uint256).max);
    ...
    WETH_USDC_GM.approve(address(withdrawalVault), type(uint256).max);
  }
  ...
  */
  function addLiquidityUSDC(
    ...
    WETH.safeTransferFrom(msg.sender, address(this), amtWETH);
    USDC.safeTransferFrom(msg.sender, address(this), amtUSDC);
  ...
  */
  function removeLiquidityUSDC(
    ...
    uint256 amt = WETH_USDC_GM.balanceOf(address(this));
  ...
  function recover() external {
    ...
    WETH_USDC_GM.safeTransfer(
      tester,
      WETH_USDC_GM.balanceOf(address(this))
    );
