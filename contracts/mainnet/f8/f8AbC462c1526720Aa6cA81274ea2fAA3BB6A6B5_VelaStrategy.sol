...
import { IVelaVault } from '../interfaces/vela/IVelaVault.sol';
import { IVelaTokenFarm } from '../interfaces/vela/IVelaTokenFarm.sol';
...
contract VelaStrategy is IStrategy, StratManager, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    */
    function balanceOf() external view returns (uint256) {
        (uint256 balance, ) = IVelaTokenFarm(velaTokenFarm).getStakedVLP(address(this));
    ...
    */
    function deposited() external nonReentrant whenNotPaused {
        ...
        depositFeeCharge();
        IVelaTokenFarm(velaTokenFarm).depositVlp(_asset.balanceOf(address(this)));
    ...
    */
    function withdraw(uint256 amount) external nonReentrant {
        ...
        //charge fee
        IVelaTokenFarm(velaTokenFarm).withdrawVlp(amount);
    ...
    */
    function exit() external nonReentrant {
        require(msg.sender == address(_vault), "!vault");
        (uint256 balance, ) = IVelaTokenFarm(velaTokenFarm).getStakedVLP(address(this));
        IVelaTokenFarm(velaTokenFarm).withdrawVlp(balance);
        _withdraw(_asset.balanceOf(address(this)));
    ...
    */
    function _giveAllowances() internal {
        ...
        _asset.safeApprove(velaTokenFarm, type(uint256).max);
    ...
    */
    function _removeAllowances() internal {
        ...
        _asset.safeApprove(velaTokenFarm, 0);
    }
