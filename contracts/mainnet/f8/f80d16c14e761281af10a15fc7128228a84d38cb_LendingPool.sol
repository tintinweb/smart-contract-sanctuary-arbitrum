...
abstract contract BaseLendingPool is HookableLender {
    ...
    event NewLoanDeployedByPool(address loanAddr);
    ...
    function deployNewLoan(
        ...
        emit NewLoanDeployedByPool(loanAddr);
...
contract LendingPool is BaseLendingPool {
     ...
     */
    function pauseDepositsAndWithdrawals(bool bPauseDeposits, bool bPauseWithdrawals) external onlyIfInitialized nonReentrant onlyOwner {
