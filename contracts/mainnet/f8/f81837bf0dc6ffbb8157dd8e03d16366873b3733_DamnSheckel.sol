...
contract DamnSheckel is ERC20 {
    string private salt = "SHECKEL"; // A private string variable
    ...
    uint256 public maxSupply = 69420000000000000000000; // Maximum supply of tokens
    uint256 public claimAmount = 69420000000000000000; // Amount of tokens to be claimed
