...
contract MasterChef is Ownable {
    ...
    // Withdraw without caring about rewards. EMERGSHIELDY ONLY.
    function emergencyRewardsWithdraw(address _token, uint256 amount)
        public
        onlyOwner
    {
    ...
    function emergencyGaugeWithdraw(uint256 _pid)
        public
        onlyOwner
    {
        PoolInfo storage pool = poolInfo[_pid];
...
contract ShieldToken is BEP20('SHIELD', 'SHIELD') {
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "SHIELD::delegateBySig: signature expired");
