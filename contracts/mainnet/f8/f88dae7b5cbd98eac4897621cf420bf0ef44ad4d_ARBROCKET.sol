...
Telegram: t.me/arbrocket
Twitter: twitter.com/arbrocket
Website: arbrocket.com
...
contract ARBROCKET is Context, IERC20, Ownable {
    ...
    string private _name = "ARBROCKET";
    string private _symbol = "ARBROCKET";
    ...
    address public marketingTokenFeeWallet = 0xaF488801c785D15CD986cE901796DA1debF5764E;
    address public marketingETHFeeWallet = 0xcaA71BB6b902398Bf83F2904391E3085d05c569D;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 100 * 10**7 * 10**9, "Cannot set transaction amount less than 0.1 percent of initial Total Supply!");
