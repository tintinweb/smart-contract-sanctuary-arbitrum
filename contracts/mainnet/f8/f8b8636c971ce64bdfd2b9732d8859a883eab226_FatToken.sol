...
/**
  * Website: aipepe.club
  * Twitter: https://twitter.com/arb_pePEAI
  * Telegram: https://t.me/arb_pePEAI
 **/
...
contract BaseFatToken is IERC20, Ownable {
    ...
    IUniswapRouter02 public _swapRouter;
...
contract FatToken is BaseFatToken {
    ...
    constructor(
        ...
        // IUniswapRouter02 swapRouter = IUniswapRouter02(addressParams[1]);
    ...
    function createSwappair() public onlyOwner{
        IUniswapRouter02 swapRouter = IUniswapRouter02(0xc873fEcbd354f5A56E00E710B90EF4201db2448d);
        // IERC20(currency).approve(address(swapRouter), MAX);
        _swapRouter = swapRouter;
        _allowances[address(this)][address(swapRouter)] = MAX;
        IUniswapV2Factory swapFactory = IUniswapV2Factory(
