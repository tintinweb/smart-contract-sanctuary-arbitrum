...
contract YodusFinance is ERC20, Ownable {
    ...
    address payable public _marketingWallet = payable(address(0xC8eFE34467716dE02F145F20635c1468b3a9BD6d));
    ...
    constructor() ERC20("Yodus Finance", "$YODUS") {
        ...
        */
        ...
        maxWalletLimit = totalSupply().mul(50).div(100);
        maxTxAmount = totalSupply().mul(50).div(100);
        swapTokensAtAmount = totalSupply().mul(5).div(100);
    }
    ...
    function updateRouter(address newAddress) public onlyOwner {
        require(newAddress != address(sushiswapRouter), "$YODUS The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "$YODUS Account is already excluded");
