...
Welcome to Yasuke $YASUKE

As the hunter stalks his pray, hidden in the forest, waiting for the perfect time to strike. The morning
dew resting on his clothes. Controlling his breathing and his movement.

Every move is calculated, every action, thought through. This isn't about sport, this is about a deep
need. Hunting is in his blood. Forged through the fire and the flame, training countless years to perfect every technique.

Yasuke will enter this market at the perfect time. When everything is calculated. Our experienced team will
push this to higher highs every day. We will build a community of yasuke that will be relentlessly pushing, shilling and spreading the name.
...
https://t.me/YasukeARB

https://medium.com/@YasukeCommunity
...
contract YASUKE is Context, IERC20, Ownable {
    ...
    string private _name = "Yasuke";
    string private _symbol = "YASUKE";
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0x1b251063aB54f1Cc4b110f6C38f03347930EfD13));
