...
import {ICreditDelegation} from "../../../interfaces/ICreditDelegation.sol";
...
abstract contract CreditDelegation is ICreditDelegation {
    ...
    function increaseDelegation(address delegatee, uint256 addedValue) external override {
        _approveDelegation(msg.sender, delegatee, _borrowAllowances[msg.sender][delegatee] + addedValue);
    }

    /// @inheritdoc ICreditDelegation
    function decreaseDelegation(address delegatee, uint256 amount) external override {
        _decreaseBorrowAllowance(msg.sender, delegatee, amount);
    }
...
import {IERC20} from "../../dependencies/openzeppelin/contracts/IERC20.sol";
import {IGuild} from "../../interfaces/IGuild.sol";
import {UpgradeableERC20} from "./base/UpgradeableERC20.sol";
import {CreditDelegation} from "./base/CreditDelegation.sol";
import {WadRayMath} from "../libraries/math/WadRayMath.sol";

/**
 * @title Covenant ERC20 LiabilityToken
 * @author Covenant Labs
...
contract LiabilityToken is VersionedInitializable, CreditDelegation, NotionalERC20, ILiabilityToken {
    uint256 public constant LIABILITY_TOKEN_REVISION = 0x2;
