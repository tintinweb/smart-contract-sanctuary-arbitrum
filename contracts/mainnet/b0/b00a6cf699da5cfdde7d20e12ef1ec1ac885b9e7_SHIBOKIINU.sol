...
Twitter   : https://twitter.com/shibokiinu/
Medium : https://medium.com/@ShibokiInuOfficial
Telegram : https://t.me/ShibokiArb
...
contract SHIBOKIINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SHIBOKI INU", "$SHIBOKI") {
        ...
        uint256 totalSupply = 100 * 10**6 * 10**9;
 
        maxTransactionAmount = totalSupply * 30 / 1000; // 3%
        maxWallet = totalSupply * 30 / 1000; // 3% 
        swapTokensAtAmount = totalSupply * 60 / 10000; // 0.6%
 
        buyMarketingFee = _buyMarketingFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyDevelopmentFee = _buyDevelopmentFee;
        buyBuyBackFee = _buyBuyBackFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevelopmentFee + buyBuyBackFee;
 
        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevelopmentFee = _sellDevelopmentFee;
        sellBuyBackFee = _sellBuyBackFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevelopmentFee + sellBuyBackFee;
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyDevelopmentFee + buyBuyBackFee + buyLiquidityFee + buyMarketingFee;
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellDevelopmentFee +  sellBuyBackFee + sellLiquidityFee + sellMarketingFee;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForDevelopment + tokensForBuyBack;
        bool success;
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDevelopment - ethForBuyBack;
