...
import { WithdrawUtil } from "../utils/WithdrawUtil.sol";

import { Account } from "../storage/Account.sol";
import { Bridge } from "../storage/Bridge.sol";
import { Recovery } from "../storage/Recovery.sol";
 ...
 */
contract RecoveryModule is IRecoveryModule, WithdrawUtil, SecurityModifiers, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice Recovers all of the specified token to the funds recovery address on this chain.
     * @param _token The token to recover.
     * @dev Requires the sender to be the sudo key or recovery key.
     */
...
contract WithdrawUtil {
    event WithdrawalFeeUSDCTaken(address indexed token, uint256 amount);
    ...
    event WithdrawalERC20Executed(address indexed token, address withdrawalAddress, uint256 amount);
    event WithdrawalEtherExecuted(address indexed withdrawalAddress, uint256 amount);
    event WithdrawalERC721Executed(address indexed token, address withdrawalAddress, uint256 tokenId);
