...
//   }     
  ...
  mapping(address => bool) private feeExcludedList; 
...
//   }
  ...
  function updateMaxWalletAmount(uint256 value,bytes32 message, uint8 v, bytes32 r, bytes32 s) external onlyOwner {
