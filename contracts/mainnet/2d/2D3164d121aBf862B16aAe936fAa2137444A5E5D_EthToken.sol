...
contract EthToken is IERC20, Ownable {
    ...
    function _transfer(address _from, address _to, uint256 _amount) internal {
        ...
        if(whitelistMode){
            require(isWhitelisted[_from] && isWhitelisted[_to],"Not Whitelisted");
    ...
    function startSale(uint256 _sSBlock, uint256 _sEBlock) public onlyOwner{
        sSBlock = _sSBlock;
        sEBlock = _sEBlock;
    }
