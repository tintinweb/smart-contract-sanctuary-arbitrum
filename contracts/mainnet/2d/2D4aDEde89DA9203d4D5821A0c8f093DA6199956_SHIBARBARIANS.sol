...
contract SHIBARBARIANS is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2_50000 * 10**18;
    uint256 public maxBuyLimit = 30_0000 * 10**18;
    uint256 public maxSellLimit = 20_0000 * 10**18;
    uint256 public maxWalletLimit = 30_00000 * 10**18;
    ...
    address public marketingWallet = 0x0e3f45968ac7c503b6A2F5924c5510cE92748C83;
    address public devWallet = 0x0e3f45968ac7c503b6A2F5924c5510cE92748C83;
    address public operationsWallet = 0x84EE65bEB5413D560ae1e73ad0673f60d54f137e;
    address public charityWallet = 0x84EE65bEB5413D560ae1e73ad0673f60d54f137e;
    ...
    Taxes public taxes = Taxes(4, 0, 4, 0, 0, 0);
    Taxes public sellTaxes = Taxes(4, 0, 4, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("SHIBARBARIANS", "SARB") {
