...
contract BathPresale is Ownable {
  ...
  // uncomment for testing purposes only. Should be commented out for production
  // function resetRaise() public onlyOwner {
  //   // for testing purposes only
  //   totalRaised = 0;
  //   wlTotalRaised = 0;
  // }

  // function resetAccount(address _addy) public onlyOwner {
  //   // for testing purposes only
  //   accounts[_addy] = Account(0, 0, 0);
  // }
}
