    ...
    Initializable
{
     ...
     */
    function initialize(address anOwner,address _managerModule) public virtual initializer {
        _initialize(anOwner);
...
contract VaultFactory is Initializable, UUPSUpgradeable {
    ...
    function setManagerModule(address _managerModule) public onlyOwner{
        managerModule = _managerModule;
    }
        ...
        ret = Vault(
            payable(
                new ERC1967Proxy{salt: bytes32(salt)}(
                    ...
                    abi.encodeCall(Vault.initialize, (wallet,managerModule))
                )
            )
        );
