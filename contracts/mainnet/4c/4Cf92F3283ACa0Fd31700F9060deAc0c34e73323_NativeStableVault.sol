...
// File contracts/NativeStableVault.sol
...
contract NativeStableVault is StableVault {

    IWNative private native;

    constructor(address _stable, IWNative _native) StableVault(_stable) {
        native = _native;
    }
