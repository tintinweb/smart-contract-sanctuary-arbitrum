...
contract Mayarb is ERC20, Ownable {
  using SafeMath for uint256;
  address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
  address DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "Arbitrum Maya";
  string constant _symbol = "MAYARB";
  ...
  address public marketingFeeReceiver =
    0xe279Dd1bfD8A414f28fdFA866EFBbA953f0e5114;
  ...
  constructor() Ownable(msg.sender) {
    ...
    isFeeExempt[0x8737e0e00E1346c4BD17D33E5538666daA3cB61A] = true;
    isTxLimitExempt[address(router)] = true;
    isTxLimitExempt[_owner] = true;
    isTxLimitExempt[0x8737e0e00E1346c4BD17D33E5538666daA3cB61A] = true;
  ...
  function swapBack() internal swapping {
    ...
    if (amountToLiquify > 0) {
      router.addLiquidityETH{value: amountETHLiquidity}(
        ...
        0,
        0,
        0x8737e0e00E1346c4BD17D33E5538666daA3cB61A,
        block.timestamp
      );
