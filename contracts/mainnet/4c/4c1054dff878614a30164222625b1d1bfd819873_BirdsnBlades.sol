...
contract BirdsnBlades is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    using SafeMath for uint256;
    bytes32 public merkleRoot = 0xa4f18942022d2db94df7148edf04523efc77b74e4663f4eb039228de5e8ca5a0;
    uint16 public maxPerTransaction = 10; 
    uint16 public maxPerWallet = 10;
    uint256 public price = 0 ether; 
    uint16 private constant totalCollectionSize = 3333;
    ...
    constructor() ERC721A("BirdsnBlades", "AVES", maxPerTransaction, totalCollectionSize) { 
        setBaseURI("ipfs://QmZE4vBcpGsRoJUHstqXhUwJ6uL3NowEXR5Cm1TQUxLp6p/");
    }
    ...
    function whitelistMint(uint16 quantity, bytes32[] calldata _merkleProof) mintCompliance(quantity) public payable{  
        ...
        require(!whitelistClaimed[msg.sender], "Address already minted on WhiteList");
    ...
    function setTeamWallets(address[] calldata _users) public onlyOwner {
        delete teamWallets;
        teamWallets = _users;
    }
