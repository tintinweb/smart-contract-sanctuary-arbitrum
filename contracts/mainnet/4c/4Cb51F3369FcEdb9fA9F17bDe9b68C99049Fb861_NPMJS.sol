import "./lib/IDividendDistributor.sol";
...
/* 
   ...
   @@@@ WTFUCK TOKEN @@@@
   Telegram: https://twitter.com/wtfcoinarb 
   Website: https://www.wtfcoin.xyz  
...
contract NPMJS is IBEP20, Auth {
    ...
    string constant _name = "NPMJS";
    string constant _symbol = "NPMJS";
