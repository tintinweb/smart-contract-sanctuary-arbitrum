...
contract CZZ is Context, ERC20Burnable, ERC20Pausable, Ownable {
    uint256 public constant MAX_SUPPLY = 180_000 ether;
    ...
    // max - 10000
    uint256 public rateSell = 0;
    uint256 public rateBuy = 10000;

    bool private feeSwaping = false;

    constructor() ERC20("CZZ Token", "CZZ") {
        addressCommunity = 0x49C7074894f73E24C89Fff1A7518e3CF39C305b9;
        amountSettleFee = 100000000000000000000000;
