...
// File contracts/interfaces/common/IWrappedNative.sol
...
// File contracts/interfaces/curve/ICurveSwap.sol
...
// File contracts/interfaces/curve/IGaugeFactory.sol
...
// File contracts/interfaces/curve/IRewardsGauge.sol
...
// File contracts/strategies/common/StratManager.sol
...
// File contracts/strategies/common/FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    uint public companyFee = MAX_FEE - callFee;

    function setCallFee(uint256 _fee) public onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        companyFee = MAX_FEE - callFee;
    }
...
// File contracts/utils/IGasPrice.sol
...
// File contracts/utils/GasThrottler.sol
...
// File contracts/strategies/curve/StrategyCurveLP.sol
...
contract StrategyCurveLP is StratManager, FeeManager, GasThrottler {
    ...
    constructor(
        ...
        address _keeper,
        address _companyFeeRecipient
    ) StratManager(_keeper, _unirouter, _vault, _companyFeeRecipient) public {
        want = _want;
    ...
    function chargeFees() internal {
        uint256 nativeFeeBal = IERC20(native).balanceOf(address(this)).mul(5).div(1000);
