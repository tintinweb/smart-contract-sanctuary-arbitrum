...
interface ILBRouter {
    ...
    function getLegacyFactory() external view returns (address);

    function getV1Factory() external view returns (address);
    ...
    function getSwapIn(address LBPair, uint128 amountOut, bool swapForY)
        external
        view
