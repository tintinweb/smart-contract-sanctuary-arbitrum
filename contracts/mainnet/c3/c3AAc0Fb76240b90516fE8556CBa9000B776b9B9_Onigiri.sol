...
contract Onigiri is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI) ERC721("Onigiri", "ONI") {
    ...
    **/
    ...
    function presaleMint(address _account) external payable nonReentrant {
        //Are we in Presale ?
        require(sellingStep == Steps.Presale, "Presale has not started yet.");
        //Did this account already minted 3 NFT ?
