...
contract OptionModule is ModuleBase,IOptionModule, Initializable,UUPSUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function submitJvaultOrder(SubmitJvaultOrder memory _info,bytes memory _writerSignature,bytes memory _holderSignature) external {
        ...
        if(_info.orderType==IOptionFacet.OrderType.Call){
             ...
             emit OptionPremiun(IOptionFacet.OrderType.Call ,  IOptionFacet(diamond).getOrderId(),  _info.writer,  _info.holder,  _info.premiumAsset,   optionService.getParts(_info.underlyingAsset,_info.underlyingAmount, _info.premiumFee));
            ...
            IOptionFacet.PutOrder memory putOrder= IOptionFacet.PutOrder({
             ...
             emit OptionPremiun(IOptionFacet.OrderType.Put ,  IOptionFacet(diamond).getOrderId(),  _info.writer,  _info.holder,  _info.premiumAsset,   optionService.getParts(_info.underlyingAsset,_info.underlyingAmount, _info.premiumFee));
        }else{
    ...
    function submitOptionOrder(SubmitOrder memory _info,bytes memory _writerSignature) external  onlyVaultOrManager(_info.holder){   
        ...
        if(_info.signature.orderType==IOptionFacet.OrderType.Call){
             ...
             optionService.createCallOrder(callOrder);
             emit OptionPremiun(IOptionFacet.OrderType.Call ,  IOptionFacet(diamond).getOrderId(),  _info.writer,  _info.holder,  _info.signature.premiumAssets[_info.premiumSelect],   optionService.getParts(_info.signature.underlyingAsset,_info.underlyingAmount, _info.signature.premiumFees[_info.premiumSelect]));
            ...
            IOptionFacet.PutOrder memory putOrder= IOptionFacet.PutOrder({
             ...
             optionService.createPutOrder(putOrder);
             emit OptionPremiun(IOptionFacet.OrderType.Put ,  IOptionFacet(diamond).getOrderId(),  _info.writer,  _info.holder,  _info.signature.premiumAssets[_info.premiumSelect],   optionService.getParts(_info.signature.underlyingAsset,_info.underlyingAmount, _info.signature.premiumFees[_info.premiumSelect]));
