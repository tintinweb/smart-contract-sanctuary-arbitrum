...
contract DogeCEOTwitter is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB9369dC5FF8a13d14A151718585ea460df845A4D); 
    address payable public Wallet_Dev = payable(0xB9369dC5FF8a13d14A151718585ea460df845A4D);
    ...
    string private constant _name = "DogeCEOTwitter"; 
    string private constant _symbol = unicode"DCT"; 
    ...
    constructor () {
        ...
        _owner = 0xB9369dC5FF8a13d14A151718585ea460df845A4D;
