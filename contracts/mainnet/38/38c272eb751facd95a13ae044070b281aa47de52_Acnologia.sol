...
Acnologia is known as the destroyer. 
Shall it do the same on Arbitrum? 
With its auto-staking APY offered to holders, it's sure to entice.
Being known as the first anime token on the chain, Acnologia provides a different and new concept 🐉 

Telegram: https://t.me/AcnologiaPortal
Twitter: https://twitter.com/AcnologiaArb
Website: https://acnologia.tech/
...
contract Acnologia is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public constant deployer = address(0x8d3fbccEF14F577e9e9a3A13b27FEb74395c2F30);
    ...
    constructor() ERC20("Acnologia", "ACN") {
        ...
        marketingWallet = address(0x8d3fbccEF14F577e9e9a3A13b27FEb74395c2F30); // set as marketing wallet
        treasuryWallet = address(0xa8bEEFf67A58e3942d1296e1380D489580023bCF); // set as treasury wallet
