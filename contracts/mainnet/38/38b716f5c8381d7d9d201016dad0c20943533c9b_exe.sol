...
contract exe is Context, Ownable {

    using Math for uint256;
    address public OWNER_ADDRESS;
    bool private initialized = false;
    address BUSD = 0xFEa7a6a0B346362BF88A9e4A88416B77a57D6c2A;
    ...
    uint256 MIN_DEPOSIT = 10 ether; // 10 MIM
    uint256 MIN_BAKE = 1 ether; // 1 MIM
    uint256 MAX_WALLET_TVL_IN_BNB = 100000 ether; // 100000 MIM
    uint256 MAX_DAILY_REWARDS_IN_BNB = 6500 ether; // 6500 MIM
    uint256 MIN_REF_DEPOSIT_FOR_BONUS = 100 ether; // 100 MIM
    ...
    function handleBake(bool onlyRebaking) private {
        ...
        if (onlyRebaking == true) {
            require(
                ...
                "Rewards must be equal or higher than 1 MIM to bake"
            );
        }
