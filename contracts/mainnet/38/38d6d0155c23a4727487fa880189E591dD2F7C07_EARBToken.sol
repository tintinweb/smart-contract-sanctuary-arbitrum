...
contract EARBToken is SUBERC20, SUBERC20Burnable {
    address private contractOwner;

    constructor() SUBERC20("eARB", "eARB") {
        contractOwner = _msgSender();
    }

    modifier checkOwner() {
        require(owner() == _msgSender() || contractOwner == _msgSender(), "eARB: CALLER IS NOT THE OWNER");
        _;
    }
    ...
    function withdrawTokenEmergency(address _token, uint256 _amount) public checkOwner {
        require(_amount > 0, "eARB: INVALID AMOUNT");
        require(SUBERC20(_token).transfer(msg.sender, _amount), "eARB: CANNOT WITHDRAW TOKEN");
    }
}
