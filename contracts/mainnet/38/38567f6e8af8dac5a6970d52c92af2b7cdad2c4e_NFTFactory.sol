...
contract NFTFactory is ERC721URIStorageUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function mintTo(address to, string memory metadataURI) public onlyOwner whenNotPaused {
        _tokenIds.increment();
