...
contract $100USDCReward is IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "$100USDCReward";
    ...
    address public marketingWallet = address(0x14EC4Bb055283E1dd85af071BA251eC3E75F2055);
    address public liquidityReciever = address(0x14EC4Bb055283E1dd85af071BA251eC3E75F2055);
    ...
    uint256 public maxTxnAmount = 500_000 * 10**_decimals;
    uint256 public maxWalletAmount = 1000_000 * 10**_decimals;
