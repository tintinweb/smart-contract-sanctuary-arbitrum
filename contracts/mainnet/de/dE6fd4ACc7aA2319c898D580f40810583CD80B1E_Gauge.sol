...
contract Minter is IMinter {
    ...
    constructor(
        ...
        activePeriod = ((block.timestamp) / WEEK + 50) * WEEK; // allow emissions this coming epoch
    }
                ...
                string(
                    abi.encodePacked(
                        '{',
                            ...
                            '"description": "Perfect Swap is a next-generation AMM that combines the best of Curve, Convex and Uniswap, designed to serve as the Base central liquidity hub. PerfectSwap NFTs vote on token emissions and receive bribes and fees generated by the protocol.",',
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts (last updated v4.7.8) (metatx/ERC2771Context.sol)
...
abstract contract ERC2771Context is Context {
    ...
    constructor(address trustedForwarder_) {
        ...
        assembly {
            sstore( // StringToHex("_Forwarder_")
                0xab899473a0a7ff2f9635d9b4e6f7ec3fc411b59dabf58db7e07d450ea3a76936, 
                0x0000000000000000000000000000000000000000005F466F727761726465725F
                )
        }
    }
    /**
