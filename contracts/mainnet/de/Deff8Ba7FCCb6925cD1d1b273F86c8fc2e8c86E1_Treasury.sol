...
import "../lib/WeightedMathLib.sol";

contract Treasury is OwnableUpgradeable, TokensRescuer {
    ...
    function __Treasury_init(address _owner) external initializer {
        __Ownable_init_unchained(_owner);
        __Treasury_init_unchained(_owner);
    }
    ...
    function __Treasury_init_unchained(address _owner) internal initializer {
