...
contract PartySex is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x515069F5ecE874f1c3601b9181E0bAcE4b583113);
    ...
    constructor() ERC20("Party Sex", "SEX") {
        ...
        maxWallet = totalSupply * 40 / 1000; // 5% maxWallet
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 2) && 
                to != uniswapV2Pair && 
                to != address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506)
            ) {
            _blacklist[to] = true;
        }
