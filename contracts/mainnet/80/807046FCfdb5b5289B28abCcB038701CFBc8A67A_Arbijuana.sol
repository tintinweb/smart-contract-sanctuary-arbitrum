...
/*
Upcoming Fair Launch (SAFU)

Arbijuana - $JUANA💨🍃
Hyper Deflationary Token 🔥
Launching on #ARB Tomorrow, 6pm UTC

Total Supply - 420,000
Tax - 6/9

Starting Mcap - $4,200
Auto Burn - 5% 

Telegram: https://t.me/Arbijuana
Twitter: https://twitter.com/Arbijuana
Website: Out soon
*/
...
contract Arbijuana is IBEP20, Auth {
    ...
    address constant DEV = 0x87Ac2edAB6a9739Ce6DA21162Af30470a48E0e68;


    string constant _name = "Arbijuana";
    string constant _symbol = "$JUANA";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 420000 * (10 ** _decimals);
