...
contract Bullish is ReentrancyGuard, Pausable, XNFTHolder
{
		...
		uint256 _harvest_interval_block_count, uint256 _withdrawal_interval_block_count, bool _refresh_reward) public onlyOperator
	{
		...
		require(_address_token_stake != _address_token_reward, "make_pool: Wrong address");
		...
		RewardInfo storage reward_check = reward_info[_address_token_stake];
		require(reward_check.emission_per_block == 0, "make_pool: Invalid stake token");
...
// Contract
//---------------------------------------------------------
contract BullishBooster is Bullish
{
