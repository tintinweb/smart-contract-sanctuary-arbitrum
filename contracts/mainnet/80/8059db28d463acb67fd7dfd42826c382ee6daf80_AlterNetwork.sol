...
*/
// https://t.me/AlterNetworkARB
// https://alternetwork.site/
// https://t.me/AlterNetworkARB
...
contract AlterNetwork is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Alter Network";
    string constant _symbol = "$ALTN";
    ...
    address public marketingFeeReceiver = 0xb3a9C2f98E42779D942d6706217b66A16e0A6f25;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xb3a9C2f98E42779D942d6706217b66A16e0A6f25] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xb3a9C2f98E42779D942d6706217b66A16e0A6f25] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xb3a9C2f98E42779D942d6706217b66A16e0A6f25,
                block.timestamp
            );
