...
contract BookToken is IBookToken, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        contributorVestingContract = new BookVesting(_vestAdmin, _vestingStart, CONTRIBUTOR_ALLOCATION, "Contributor Vesting");

        marketingVestingContract = new BookVesting(_vestAdmin, _vestingStart, DEV_MARKETING_ALLOCATION, "Dev/Marketing Vesting");
