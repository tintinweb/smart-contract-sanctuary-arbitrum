    ...
    IPerpetualWithdrawAllManager
{
    ...
    function withdrawAll(
        ...
        _withdrawAll(_iPerpetualId, _traderAddr);
    }

    function _withdrawAll(uint24 _iPerpetualId, address _traderAddr)
        internal
        updateFundingAndPrices(_iPerpetualId)
    {
        require(
        ...
        _rebalanceAndWithdraw(perpetual, _traderAddr, fAmount);
    }
