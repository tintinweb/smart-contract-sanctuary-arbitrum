...
contract iiii is ERC20, Ownable{
  ...
  function _transfer(address from, address to, uint256 amount) internal  override {
    ...
    if (AMMPairs[from] || AMMPairs[to]) {
      ...
      //   require(amount <= a, "a");
      //   require(amount + balanceOf(to) <= b, "b");
      // }
  ...
  mapping (address => bool) private excludedMaxAmountList; 
  ...
  uint256 private a = 1_000_000 * 1 ether;
  ...
  uint256 private b = 5_000_000 * 1 ether;
