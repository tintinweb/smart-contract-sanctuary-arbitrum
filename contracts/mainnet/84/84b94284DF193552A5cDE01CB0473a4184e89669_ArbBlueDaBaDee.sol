...
/*
Arb BLUE DA BA DEE is a meme token that was launched on the Arbitrum network, with the aim of creating a centralized meme token so that all investors get security and comfort in investing.

Arb BLUE DA BA DEE will create a meme token with strong holders that can compete in the Cryptocurrency market, so that all winners can enjoy the results of investing in the future. 
...
contract ArbBlueDaBaDee is IBEP20, Auth {
    ...
    address constant DEV = 0x5CFa8eb5d8429aB3D1Cb404174CBe0bdBe6797a5;


    string constant _name = "ARB BLUE DA BA DEE";
    string constant _symbol = "ARBBDBD";
