...
contract VibeFactory is BoringBatchable {
    ...
    function createNFTMintSaleWhitelisting(
        ...
        factory.exec(proxy, abi.encodeCall(NFTMintSaleWhitelisting.setMerkleRoot, (merkleRoot_, ipfsHash_)), 0);
        factory.transferOwnership(proxy, msg.sender);
    ...
    function createNFTMintSaleMultipleWhitelisting (
        ...
        factory.exec(proxy, abi.encodeCall(NFTMintSaleWhitelistingMultiple.setMerkleRoot, (merkleRoot_, ipfsHash_)), 0);
        factory.transferOwnership(proxy, msg.sender);
