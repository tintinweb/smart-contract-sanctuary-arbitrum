...
library Constants {
    ...
    uint256 private constant CHAIN_ID = 42161; // Arb 1
    ...
    address private constant CRV3 =
        address(0x7f90122BF0700F9E7e1F688fe926940E8839F353); // Anywhere the term CRV3 is refernenced, consider that as "peg", really
    ...
    uint256 private constant CURRENT_EPOCH_START = 1669190086;
    ...
    uint256 private constant FORGE_EXIT_LOCKUP_EPOCHS = 96; // 5 days fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 48; // 3 days fluid
...
contract OracleV1 {
    ...
    constructor(
        ...
        OracleV1 prevOracle = OracleV1(_previousOracle);
