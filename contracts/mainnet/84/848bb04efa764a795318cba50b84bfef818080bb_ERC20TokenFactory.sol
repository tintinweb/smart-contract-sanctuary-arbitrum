...
contract ERC20TokenFactory is BaseFactory {
    ...
    function createERC20(
        ...
        uint256 tokenLiquidityThreshold_
    ) external payable nonReentrant returns (address, address) {
        require(tokenLiquidityThreshold_ >= _totalSupply * 2/ 10000 && tokenLiquidityThreshold_ <= _totalSupply / 100, "tokenLiquidityThreshold must 0.02-1% of supply");
