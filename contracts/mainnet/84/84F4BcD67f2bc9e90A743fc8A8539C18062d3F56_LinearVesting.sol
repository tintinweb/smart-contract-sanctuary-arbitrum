...
contract LinearVesting is Ownable {
    uint _TEAM_ALLOCATION = 50_000 ether;
    uint _VESTING_DURATION = 13 days;
     ...
     */
    constructor(IERC20 _santa) {
        require(
            _santa != IERC20(address(0)),
    ...
    function claim() external returns (uint256 vestedAmount) {
        ...
        santa.transfer(msg.sender, vestedAmount);
    }
        ...
        onlyOwner
    {
        ...
        require(
            santa.balanceOf(address(this)) >= _TEAM_ALLOCATION,
    ...
    function panic() public onlyOwner {
        ...
        santa.transfer(owner(), santa.balanceOf(address(this)));
    }
}