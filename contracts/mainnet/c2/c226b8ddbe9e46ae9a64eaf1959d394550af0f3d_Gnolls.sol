...
//shout out to Tales of Alleria we forked and edited from their contract.
contract Gnolls is ERC1155, Ownable {
    using Strings for uint256;

    // Keeps track of admin addresses.
    mapping (uint256 => address) private _externalMinterAddress;

    string private uriPrefix = "https://gnolls.world/api/erc1155/";
    string private uriSuffix = ".json";

    constructor() ERC1155("https://gnolls.world/api/erc1155/") {
    }
    ...
    */
    function SetExternalMinterAddress(uint256 _id, address _address) external onlyOwner {
        _externalMinterAddress[_id] = _address;
    }
    ...
    */
    ...
    /* 
    * So we can have smart contracts mint later.
    */
    function externalMint(address to, uint256 id, uint256 amount) external {
        require(msg.sender == _externalMinterAddress[id], "External Mint Denied");
