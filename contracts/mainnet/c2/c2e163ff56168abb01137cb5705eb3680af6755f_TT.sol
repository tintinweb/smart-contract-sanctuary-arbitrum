...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // router 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8)); // USDC - 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8
...
contract TT is ERC20, Ownable {
    ...
    constructor() ERC20("TT", "TT") {
    	...
    	operationsWallet = address(0x1b9FcaE07eCD9a4494212C052F2072E1FF3266F3); // set as operations wallet

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);//0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
