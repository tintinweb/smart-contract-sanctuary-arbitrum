...
contract QuoterV2 is IQuoterV2, IDonaswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IDonaswapV3Pool) {
        return IDonaswapV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function donaswapV3SwapCallback(
        ...
        IDonaswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IDonaswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
...
/// @notice Provides validation for callbacks from Donaswap V3 Pools
library CallbackValidation {
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (IDonaswapV3Pool pool) {
    ...
    {
        pool = IDonaswapV3Pool(PoolAddress.computeAddress(deployer, poolKey));
