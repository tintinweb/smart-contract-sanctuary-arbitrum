...
contract MagicInternetFrens is ERC721 {
    ...
    mapping(uint256 => string) public frenX_usr;
    ...
    function mint(address fren) public onlyAuth returns (uint256) {
        ...
        miXP[newTokenId] = 0;
        miHP[newTokenId] = 100;
        frenTokenId[fren] = newTokenId;
        tokenIdFren[newTokenId] = fren;
        _tokenIdCounter++;
        totalSupplyOnChain++;
        return newTokenId;
    }
    ...
    function SummonDedFren(address fren, uint256 _tokenId) public onlyAuth returns (uint256) {
        require(isDed[_tokenId], "fren not ded");
        _mint(fren, _tokenId);
        miHP[_tokenId] = 100;
    ...
    function bridgeFren(address fren, uint256 _tokenId) public onlyAuth returns (uint256) {
        _mint(fren, _tokenId);
        miHP[_tokenId] = 100;
        frenTokenId[fren] = _tokenId;
        _tokenIdCounter++;
