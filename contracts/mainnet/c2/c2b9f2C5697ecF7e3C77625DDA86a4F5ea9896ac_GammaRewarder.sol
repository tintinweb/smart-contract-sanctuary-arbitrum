...
contract GammaRewarder is BrevisApp, ReentrancyGuard, Ownable {
    ...
    function createDistribution(
        ...
        require(_startBlockNum > block.number && _amountOfBlock > 0, "The first distribution time has to be backward and the amount of epoch has to be greater than zero.");
