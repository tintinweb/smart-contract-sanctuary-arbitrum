...
contract AnimaRegeneration is ReentrancyGuard, ManagerModifier, Pausable {
  ...
  constructor(
    ...
    AOV = _aov;
    ANIMA = IAnima(_anima);
    config.minLinearAnimaMultiplier = 50000;
  ...
  function _calculateAvailableAnima(
    ...
    if (_renown <= minRenown) {
      ...
      availableAnima =
        (availableAnima * (cfg.baseAnima * uint(_focus))) /
    ...
    availableAnima =
      ...
      ONE_HUNDRED;
    availableAnima = (cfg.baseAnima * availableAnima) / (ONE_HUNDRED);
