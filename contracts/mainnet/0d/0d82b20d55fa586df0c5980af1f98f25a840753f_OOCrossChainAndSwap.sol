...
contract MainStorage {
    ...
    mapping(MsgDataTypes.BridgeSendType => mapping(address => mapping(uint256 => uint256))) public deprecated_minBridgeAmounts;
    mapping(MsgDataTypes.BridgeSendType => mapping(address => mapping(uint256 => uint256))) public deprecated_maxBridgeAmounts;
...
contract OOCrossChainAndSwap is MessageSenderApp, MessageReceiverApp, ReentrancyGuard, Initializable{
    ...
    function setBridgeAmounts(MsgDataTypes.BridgeSendType[] calldata _types, address[] calldata _tokens, uint256[] calldata _minAmounts, uint256[] calldata _maxAmounts) external onlyOwner {
