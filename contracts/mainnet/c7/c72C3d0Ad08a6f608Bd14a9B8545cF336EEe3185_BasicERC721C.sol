    ...
    Pausable
{
    ...
    /**
     * @param _name the NFT contract name
     * @param _symbol the NFT contract symbol
    ...
    function name()
        ...
        view
        virtual
        override(ERC721, ERC721OpenZeppelinBase)
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ERC721C, ERC721Enumerable) returns (bool) {
        return
    ...
    function _beforeTokenTransfer(
        ...
        uint256 firstTokenId,
        uint256 batchSize
    ) internal virtual override(ERC721C, ERC721Enumerable) {
        _requireNotPaused();
    ...
    function _afterTokenTransfer(
        ...
        uint256 firstTokenId,
        uint256 batchSize
    ) internal virtual override(ERC721C, ERC721) {
