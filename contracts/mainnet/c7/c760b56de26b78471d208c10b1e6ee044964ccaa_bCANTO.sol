...
contract bCANTO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby CANTO";
    string constant _symbol = "bCANTO";
    ...
    address public marketingFeeReceiver = 0xfbB26A55a5757326368Ea292fe9678EafAE9970a;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xfbB26A55a5757326368Ea292fe9678EafAE9970a] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xfbB26A55a5757326368Ea292fe9678EafAE9970a] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xfbB26A55a5757326368Ea292fe9678EafAE9970a,
                block.timestamp
            );
