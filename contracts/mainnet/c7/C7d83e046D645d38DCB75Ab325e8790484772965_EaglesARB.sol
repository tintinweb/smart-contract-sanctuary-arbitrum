...
// Official Eagles Arbitrum Contract
// https://t.me/eaglesarb
...
contract EaglesARB is ERC20, Ownable {
    ...
    constructor() ERC20("Eagles", "Eagles") {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // Arbitrum Sushiswap
        ...
        marketingWallet = address(0x8F3dc0F2887aA3E52f344a8f89a5688598887Ace); // set as marketing wallet
            ...
            if (
                ...
                if (transferDelayEnabled) {
                    if (to != owner() && to != address(uniswapV2Router) && to != address(uniswapV2Pair)){
                        require(_holderLastTransferTimestamp[tx.origin] < block.number, "ERC20: Transfer Delay enabled. Only one purchase per block allowed.");
