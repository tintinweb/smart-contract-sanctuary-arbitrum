...
import '@elkdex/v3-core/contracts/interfaces/callback/IElkDexV3MintCallback.sol';
...
/// @notice Internal functions for safely managing liquidity in ElkDex V3
abstract contract LiquidityManagement is IElkDexV3MintCallback, PeripheryImmutableState, PeripheryPayments {
    struct MintCallbackData {
        PoolAddress.PoolKey poolKey;
        address payer;
    }

    /// @inheritdoc IElkDexV3MintCallback
    function elkDexV3MintCallback(
        uint256 amount0Owed,
        uint256 amount1Owed,
        bytes calldata data
...
import '@elkdex/v3-core/contracts/libraries/FixedPoint96.sol';
...
import '@elkdex/v3-core/contracts/interfaces/IElkDexV3Pool.sol';
import '@elkdex/v3-core/contracts/libraries/FixedPoint128.sol';
import '@elkdex/v3-core/contracts/libraries/FullMath.sol';
...
/// @title NFT positions
/// @notice Wraps ElkDex V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the ElkDex position
    struct Position {
    ...
    ) ERC721Permit('ElkDex V3 Positions NFT-V1', 'UNI-V3-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IElkDexV3Pool pool = IElkDexV3Pool(PoolAddress.computeAddress(factory, poolKey));
