...
contract ArbitrumFoxAI is BEP20 {
    ...
    string public constant name = "Arbitrum Fox AI";
    string public constant symbol = "AIFOX";
    uint public constant decimals = 9;
    uint public deadline = now + 20 * 1 days;
    uint public round2 = now + 15 * 1 days;
    uint public round1 = now + 30 * 1 days;
    
    uint256 public totalSupply = 210000000000000000e9;
    uint256 public totalDistributed;
    uint256 public constant requestMinimum = 0.0005 ether / 1000;
    uint256 public tokensPerEth = 20000000000000e11;
    ...
    constructor() public {
        uint256 teamFund = 105000000000000000e9;
        owner = msg.sender;
