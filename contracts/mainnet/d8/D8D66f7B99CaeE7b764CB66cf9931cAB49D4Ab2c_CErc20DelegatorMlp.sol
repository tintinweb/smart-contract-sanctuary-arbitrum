...
import "./CTokenInterfacesMlp.sol";
 ...
 * @author Compound
 */
contract CErc20DelegatorMlp is CTokenInterfaceMlp, CErc20InterfaceMlp, CDelegatorInterfaceMlp {
    /**
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, CTokenInterfaceMlp cTokenCollateral) override external returns (uint) {
    ...
    function _setGlpAddresses(IStakedGlp stakedGLP_, IGmxRewardRouterMlp glpRewardRouter_, address glpManager_, address gmxToken_, address stakedGmxTracker_, address sbfGMX_) override public returns (uint) {
...
import "./IGmxRewardRouterMlp.sol";
import "./IStakedGlp.sol";
import "./IRewardTracker.sol";

contract CTokenStorageMlp {
    /**
     ...
     */
    IGmxRewardRouterMlp public glpRewardRouter;
...
abstract contract CTokenInterfaceMlp is CTokenStorageMlp {
    /**
    ...
    function _setGlpAddresses(IStakedGlp stakedGLP_, IGmxRewardRouterMlp glpRewardRouter_, address glpManager_, address gmxToken_, address stakedGmxTracker_, address sbfGMX_) virtual public returns (uint);
...
abstract contract CErc20InterfaceMlp is CErc20StorageMlp {
    ...
    function liquidateBorrow(address borrower, uint repayAmount, CTokenInterfaceMlp cTokenCollateral) virtual external returns (uint);
...
contract CDelegationStorageMlp {
    /**
...
abstract contract CDelegatorInterfaceMlp is CDelegationStorageMlp {
    /**
...
abstract contract CDelegateInterfaceMlp is CDelegationStorageMlp {
    /**
