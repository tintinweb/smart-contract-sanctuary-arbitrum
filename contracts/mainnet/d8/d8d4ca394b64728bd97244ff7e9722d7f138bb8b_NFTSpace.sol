...
/**
    Website: https://nftspace.au/
    Twitter: https://twitter.com/NFTSpace_Au
    Channel: https://t.me/NFTSpace_Au
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract NFTSpace is ERC20, Ownable {
    event PairUpdated(address _address);
    event ExcludedFromFeeUpdated(address _address, bool _status);
    // TOKENOMICS START ==========================================================>

    string private _name = "NFTSpace.au";
    string private _symbol = "NFTSpace";
    uint8 private _decimals = 18;
    uint256 private _supply = 500000000;
    uint256 public sellTaxForMarketing = 5; 
    uint256 public buyTaxForLiquidity = 5; 
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x2AFa5dF9a02caF408ee130f5D1aD6b0D1C1F0Ee6;
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //Goerli
        }
