...
interface ILockdropPhase1 {
    ...
    function totalTokensLocked(address user, uint256 index) external view returns (uint256);
    ...
    //    mapping(address => mapping(uint256 => uint256)) totalTokensLocked;
