...
The Dollar Doge arb is loosing its value day by day, The markets are crashing , Billions of dollars are being printed by the Fed. We are in a critical situation.
To take us out of this case Doge is joining the race.

Dollar Doge is already the Ceo of Twitter and now Dollardoge is going to be the next Dollar.

1,000,000,000 supply
2%max
5%tax

Join DollarDoge let’s make X’s:

Twitter: https://www.twitter.com/Dollardogearb
Telegram: https://t.me/Dollardogearb
Medium: https://medium.com/@Dollardogearb/dollardoge-bc9816fafd7e
*/
...
contract DollarDogeArb is IBEP20, Auth {
    ...
    address constant DEV = 0x7B4c83D4D18fB5FC89E820798c364447797D9648;


    string constant _name = "DOLLAR DOGE ARB";
    string constant _symbol = "DDARB";
