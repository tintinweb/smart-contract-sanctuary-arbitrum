...
contract XINA is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"John Xina";
    string private _symbol = unicode"XINA";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 100000000 * 10 ** _decimals;
    uint256 public _maxWalletToken = _totalSupply * 10000000000000000000000000000;
