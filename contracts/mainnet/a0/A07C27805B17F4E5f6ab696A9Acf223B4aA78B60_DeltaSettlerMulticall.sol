...
interface IAlphaPortfolioValuesFeed {
	...
	function updateStores(
		Types.OptionSeries memory _optionSeries,
		int256 _shortExposure,
		int256 _longExposure,
		address _seriesAddress
	) external;
	...
	function storesForAddress(
		address seriesAddress
	) external view returns (AlphaPortfolioValuesFeed.OptionStores memory);
