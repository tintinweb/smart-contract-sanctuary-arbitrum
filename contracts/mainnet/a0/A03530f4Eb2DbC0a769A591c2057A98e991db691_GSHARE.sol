...
// GMCash FINANCEGSHARE
contract GSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 1,000,000 GSHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 600000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 150000 ether;
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 150000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 100000 ether;

    uint256 public constant VESTING_DURATION = 365 days; // 1 years
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _insuranceFund) public ERC20("GMCash Share", "GSHARE") {
        _mint(msg.sender, 100 ether); // mint 500 GSHARE for initial liquidity deployment

        startTime = _startTime; // supposed to be 1680739200 Thursday, April 6, 2023 12:00:00 AM
