...
contract BeefyQuery {
    ...
    function swapGivenInputAmount(uint256 inputToken, uint256 outputToken, uint256 inputAmount) public returns (uint256 outputAmount) {
