 ...
 * @dev     Based on AaveV3's DelegationAwareMToken
 */
...
/**
 * @title   Maneki ERC20 MToken
 * @author  maneki.finance
 * @notice  Implementation of the interest bearing token for the Maneki protocol
 * @dev     Based on AaveV3's MToken
 */
contract MToken is
    ...
    IMToken
{
    ...
    function nonces(
        address owner
    ) public view override(IMToken, EIP712Base) returns (uint256) {
