...
//SPDX-License-Identifier: MIT
        ...
        */
        ...
        contract Ownable is Context {
            ...
            constructor() {
                _owner = 0xC0E6c933e97d0c0425993A88DAe4aa99B4B74618;
        ...
        contract TestPulseFI is IERC20, Context, Ownable, ReentrancyGuard {
            event Bought(
            ...
            // token data
            string private constant _name = "TestPulseFI";
            string private constant _symbol = "TPFI";
            ...
            // Total Supply
            uint256 public constant _totalSupply = 1000 * _DECMULTIPLIER;
            ...
            uint256 public maxBag = _totalSupply * 500/100 / 100;
            uint256 public maxTX = _totalSupply * 500/100 / 100;
                ...
                if (candleStickData[cTime].open == 0) {
                    if (totalTx == 1) {
                        candleStickData[cTime].open =
                            ((liquidity - buyAmount) / (_totalSupply)) *
                            getSRGPrice();
                    } else {
            ...
            function _sell(
                ...
                bool successful = SRGIE.transfer(msg.sender, amountSRG);
