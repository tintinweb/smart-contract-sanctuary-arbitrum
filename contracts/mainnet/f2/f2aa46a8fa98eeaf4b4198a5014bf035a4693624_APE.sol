...
contract APE is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	    maxWalletToken = _maxToken * (10**18);
              ...
              //Contract By: TraderEdison
    constructor() ERC20("Auto Pilot Enterprise", "APE") {
        BNBRewardsFee = 0;
        liquidityFee = 0;
        extraFeeOnSell = 2; // extra fee on sell
        marketingFee = 0;
        marketingWallet = payable(0x0282922f480f39Bf818984EF572AF9cF1fA6B3D8);
        ...
        */
        _mint(owner(), 720000000000 * (10**18));
    }
