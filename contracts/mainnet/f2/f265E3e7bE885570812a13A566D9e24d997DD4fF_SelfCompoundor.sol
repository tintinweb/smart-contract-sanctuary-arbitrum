...
contract SelfCompoundor is Ownable, ReentrancyGuard {
    ...
    uint64 public totalRewardX64 = uint64(Q64 / 5); // Fixed reward for protocol
    ...
    function updateTorqueFees(uint64 _fee) external onlyOwner {
        totalRewardX64 = uint64((Q64 * _fee)/100);
    }
