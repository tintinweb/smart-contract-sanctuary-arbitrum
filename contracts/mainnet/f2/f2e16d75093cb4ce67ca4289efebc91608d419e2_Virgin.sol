...
This is only for VIRGINS! DONT APE IF YOU ARE NOT! 

Ca will be rounced and liq locked

https://t.me/virginARB
...
contract Virgin is Context, IERC20, Ownable {
    ...
    string private _name = "Virgin";
    string private _symbol = "Virgin";
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0xB07f7AeB6E4F339A5aa5C64C542410a4143FAF2E));
