...
contract FullRangeConvertorV2 is IERC721Receiver, ReentrancyGuard {
    ...
    function convertToFullRangeAndLock (
      ...
      (bool isFullRange, int24 maxTick) = _getRangeAndMaxTick(_lockParams.nftPositionManager, _lockParams.nft_id);
    ...
    function _getRangeAndMaxTick (INonfungiblePositionManager _nftPositionManager, uint256 _nftId) private returns (bool _isFullRange, int24 _maxTick) {
