...
import { BabyTokenDividendTracker } from "./dividend-paying-token/BabyTokenDividendTracker.sol";
import { SafeERC20NoRevert } from "./dividend-paying-token/libraries/SafeERC20NoRevert.sol";
...
*/
    ...
    function _transfer(
        ...
        if (owner() == from || owner() == to || _marketingWalletAddress == from || _marketingWalletAddress == to || address(this) == from || address(this) == to) {
            takeFee = false;
        }
...
import { ERC20Upgradeable } from "@openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol";
import { OwnableUpgradeable } from "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import { SafeERC20NoRevert } from "./libraries/SafeERC20NoRevert.sol";
import { SafeMathInt } from "./libraries/SafeMathInt.sol";
import { SafeMathUint } from "./libraries/SafeMathUint.sol";
import { DividendPayingTokenInterface } from "./interfaces/DividendPayingTokenInterface.sol";
import { DividendPayingTokenOptionalInterface } from "./interfaces/DividendPayingTokenOptionalInterface.sol";
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function _transfer(
        ...
        int256 _magCorrection = (magnifiedDividendPerShare * value)
            .toInt256Safe();
