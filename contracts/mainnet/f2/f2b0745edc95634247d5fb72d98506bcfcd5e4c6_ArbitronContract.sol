...
abstract contract Project {
    address public marketingWallet = 0xcCE41a4cD8E6009d7980c30cAc86F92273798855;
    address public devWallet = 0x3f266518a564B0A55592c6C782a7034AE4D0754d;
    address public burnWallet = 0x3F0871544361780ae5B4752d6a49989c7fB7E85d;

    string constant _name = "Arbitron";
    string constant _symbol = "ARON";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**7 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 30) / 1000; // (_totalSupply * 30) / 1000 [this equals 3%]
    ...
    uint256 public swapTotalFee       = swapMarketing + swapLpFee + swapBurnFee + swapTreasuryFee;
 ...
 * MainContract
 */
contract ArbitronContract is Project, IERC20, Ownable {
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //Mainnet & Testnet ETH
...
// *** 
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHBurn = amountETH.mul(swapBurnFee).div(totalETHFee);
        ...
        (tmpSuccess,) = payable(burnWallet).call{value: amountETHBurn, gas: 30000}("");
...
// ***
    ...
    function setSwapFees(uint256 _newSwapLpFee, uint256 _newSwapMarketingFee, uint256 _newSwapTreasuryFee, uint256 _newSwapBurnFee, uint256 _feeDenominator) external onlyOwner() {
        swapLpFee = _newSwapLpFee;
        swapMarketing = _newSwapMarketingFee;
        swapTreasuryFee = _newSwapTreasuryFee;
        swapBurnFee = _newSwapBurnFee;
        swapTotalFee = _newSwapLpFee.add(_newSwapMarketingFee).add(_newSwapTreasuryFee).add(_newSwapBurnFee);
...
// ***
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _newMarketingWallet, address _newdevWallet, address _newBurnWallet ) external onlyOwner() {
        ...
        isFeeExempt[burnWallet] = false;
        isFeeExempt[_newBurnWallet] = true;

        isMaxExempt[_newMarketingWallet] = true;
        isMaxExempt[_newBurnWallet] = true;
