...
contract Swapper is Withdrawable {
    ...
    event SourceChainSwap(uint256 indexed _swapId, address _sender, uint32 _chainId, SwapInfo _swapInfo, uint256 _fromTokenAmount);
    event TargetChainSwap(uint256 indexed _swapId, address _receiver, uint32 _chainId, SwapInfo _swapInfo);
