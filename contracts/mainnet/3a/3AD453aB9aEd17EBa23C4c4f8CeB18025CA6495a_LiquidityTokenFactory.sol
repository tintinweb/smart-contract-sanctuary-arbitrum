...
contract LiquidityTokenFactory is TokenFactoryBase {
    ...
    function create(
        ...
        token = Clones.cloneDeterministic(implementation, keccak256(abi.encodePacked(msg.sender, name, symbol, totalSupply, taxFeeBps, liquidityFeeBps)));
        ILiquidityToken(token).initialize(
            msg.sender,
            name,
            symbol,
            totalSupply,
