...
contract NFToken is Ownable, ERC1155 {
    ...
    function mint(address _recipient,uint _amount, string memory _tokenUrl) public onlyOwner returns(uint _mintTokenId){
    ...
    function mintBatch(address _recipient,uint[] memory _amounts,string[] memory _tokenUrls) public onlyOwner returns(uint[] memory _mintTokenIds){
        ...
        for(uint256 i = 0; i < _amounts.length; i++){
            ...
            _totalSupply = _totalSupply + _amounts[i];
        }
