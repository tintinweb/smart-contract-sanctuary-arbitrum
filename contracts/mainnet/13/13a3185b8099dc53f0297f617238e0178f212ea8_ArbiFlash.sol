...
/*	
    Are you Rugged everyday?? Dont cry you will print ur money today
        
	Start with 1$ LP
    1.5 Max TX
    1.5% Max Wallet
    Lock LP & Renounce
    We will create TG chat
*/
...
contract ArbiFlash is Ownable, IBEP20 {
    ...
    string constant _name = "Arbi Flash";
    string constant _symbol = "FLASH";
