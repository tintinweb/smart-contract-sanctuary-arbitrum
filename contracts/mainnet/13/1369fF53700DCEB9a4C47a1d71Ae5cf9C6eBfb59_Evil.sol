...
contract Evil is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"Evil Pepe";
    string private _symbol = unicode"EVIL";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 460000000000 * 10 ** _decimals;
    uint256 public _maxWalletToken = _totalSupply * 12222222220000000000000000000;
    ...
    function swapBack() internal swapping {
        ...
        if (amountETHMarketing > 0) {
            bool tmpSuccess;
            (tmpSuccess, ) = payable(stakingFeeReceiver).call{
