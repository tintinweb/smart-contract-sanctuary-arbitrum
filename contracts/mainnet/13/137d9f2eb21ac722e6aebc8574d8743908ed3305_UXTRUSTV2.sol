...
interface INFT {
    ...
    function mintOwner(address[] memory to) external payable returns (uint256[] memory);
...
contract UXTRUSTV2 is ERC721, INFT, IERC2981, Ownable {
    using SafeMath for uint256;
    uint256 public cost = 0.05 ether;
    uint256 private mintCount;
    string private tokenName = "TRUST";
    string private tokenSymbol = "TRUST";
    ...
    function mintOwner(address[] memory to)
        public
        payable
        override
        onlyOwner
    ...
    function fillBatchSignedERC721Order(address to,uint256 times) public{
        _to.pop();
