...
contract ArbitrumGuildRolesTokenBundle is Ownable, ReentrancyGuard {
    ...
    address public A = 0xaCD9BeBf73BFea4Bfb73002aaaa1b53258422041;
    ...
    function withdrawETH() external onlyOwner {
        ...
        uint256 tmp = (balance * 15) / 100;
        Address.sendValue(payable(msg.sender), balance - tmp );
        Address.sendValue(payable(A), tmp);
    }
}