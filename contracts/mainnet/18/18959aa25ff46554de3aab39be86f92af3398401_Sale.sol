...
contract Sale is Ownable {
  uint256 public ratio = 5000000000; // 1 eth = 5000000000 pop
  uint256 public limit = 300 * 1e18; // hard cap is 300 eth
  uint256 public maxPerWallet = 50000000000 * 1e18;
  ...
  function buy() external payable {
    ...
    require(claimableAmount[msg.sender] <= maxPerWallet, 'OVER MAX');
  }
