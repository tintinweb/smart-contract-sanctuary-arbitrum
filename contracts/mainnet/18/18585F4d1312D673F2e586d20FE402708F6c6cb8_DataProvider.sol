...
contract DataProvider {
     ...
     **/
    function getUserNonMTMLiquidationThreshold(address user, address addressesProvider)
        external
        returns (NonMTMDetails memory nonMTMDetails)
    {
        // fetch guild
        IGuild guild = _getGuild(addressesProvider);
     ...
     **/
    function getRateToPriceConversionInfo(address addressesProvider)
        external
        returns (PriceToRateConversionInfo memory conversionDetails)
    {
        // fetch guild
        IGuild guild = _getGuild(addressesProvider);
    ...
    function getGuildsAccountDebtInfo(address addressesProviderRegistry, address account)
        external
        returns (AccountDebtInfo[] memory accountDebtInfos)
    {
        IGuildAddressesProviderRegistry _addressesProviderRegistry = IGuildAddressesProviderRegistry(
            addressesProviderRegistry
        );
    ...
    function getGuildAccountDebtInfo(address addressesProvider, address account)
        external
        returns (AccountDebtInfo memory accountDebtInfo)
    {
        // fetch guild
        IGuild guild = _getGuild(addressesProvider);
    ...
    function getBasicTokenDetails(address[] calldata tokens)
        external
        view
        returns (BasicTokenDetails[] memory basicTokenDetails)
    {
     ...
     **/
    function _getDexPoolLiquidity(DataTypes.PerpetualDebtData memory localPerpetualDebt)
        internal
        view
        returns (DexPoolLiquidity memory dexPoolLiquidity)
    {
