    ...
    ERC4626Upgradeable
{
    ...
    mapping(address => uint256) public userDepositdAmount;
    ...
    function _deposit(address _caller, address _receiver, uint256 _assets, uint256 _shares) internal override {
        ...
        userDepositdAmount[_caller] += _assets;
        ...
        returns (uint256 shares)
    {
        ...
        if (userDepositdAmount[msg.sender] >= stGet_)
            userDepositdAmount[msg.sender] -= stGet_;
    ...
    function deleverageWithdraw(
        ...
        _burn(_owner, shares);
        if (userDepositdAmount[msg.sender] >= assetsGet_)
            userDepositdAmount[msg.sender] -= assetsGet_;

        _withdraw(msg.sender, _receiver, _owner, assetsGet_, shares);
