...
contract ARBMario  is ERC20Burnable, Ownable, AccessControlEnumerable {
    ...
    uint256 public _buyTaxFee = 50; // 5%
    uint256 public _sellTaxFee = 70; // 7%
    ...
    constructor (address tokenOwner, address _beneficiary) ERC20("ARB Mario", "Mario") {
        ...
        _mint(tokenOwner, 100_000_000_000 ether); // 100.000.000 $ARB Mario
    }
