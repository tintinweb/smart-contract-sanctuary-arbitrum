...
contract EffectArbit is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("EffectArbit", "EA") {
        _mint(msg.sender, 136985659 * 10 ** decimals());
    }
