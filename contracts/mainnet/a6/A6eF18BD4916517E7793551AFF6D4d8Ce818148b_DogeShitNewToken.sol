...
contract DogeShitNewToken is Owner,ERC20 {
    uint256 public constant maxSupply = 100000000000 * 1e18;
    
    constructor() ERC20("DogeShit", "DOGSHIT") {
        _mint(0xA2b7e1aDb1Bc16ba6F70b9552ceC3c69A655A5b5, 100000000000 * 1e18);
    }
}