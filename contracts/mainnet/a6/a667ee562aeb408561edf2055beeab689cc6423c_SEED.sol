...
// TG:https://t.me/seedportal
// Website: https://www.seedfinance.xyz/
// Twitter: https://twitter.com/Seed_Finance_
...
contract SEED is ERC20Detailed, Ownable, Pausable
{
    ...
    ERC20Detailed(name_, symbol_, uint8(DECIMALS))
        ...
        liquidityFeeOnBuy = 0;
        treasuryFeeOnBuy = 2400;
        insuranceFundFeeOnBuy = 0; // here Dev fee are included here
        ethFeeOnBuy = 100;
        firePitFeeOnBuy = 0;
        ...
        treasuryFeeOnSell = 2400;
        insuranceFundFeeOnSell = 0; // here Dev fee is included here
        ethFeeOnSell = 100;
        firePitFeeOnSell = 0;
        ...
        maxTokenPerWalletPercent = 150; // 1%
        timeframeQuotaInPercentage = 500; // 1%
        timeframeQuotaOutPercentage = 500; // 1%
