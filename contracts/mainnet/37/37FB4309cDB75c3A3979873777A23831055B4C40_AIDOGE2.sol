...
contract AIDOGE2 is ERC20 {
    ...
    constructor() ERC20("AIDOGE2.0", "AIDOGE2.0") {
        _mint(dev, 21_000_000_000_000_000 ether); // 10% dev
        _mint(msg.sender, 126_000_000_000_000_000 ether); // 60% lp
        _mint(address(this), 63_000_000_000_000_000 ether); // 30% airdrop
    }
    ...
    function mint() external {
        ...
        require(IERC20(AIDOGE).balanceOf(msg.sender) > 1_000_000 ether, "no AIDOGE");
