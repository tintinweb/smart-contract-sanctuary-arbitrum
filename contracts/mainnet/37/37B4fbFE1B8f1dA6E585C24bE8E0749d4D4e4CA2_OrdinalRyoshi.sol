...
/*
            Ordinal ryoshi is a decentralized, 
            peer-to-peer cryptocurrency that 
        provides a secure, fast, and low-cost way 
               to transfer funds globally. 
The currency could leverage advanced blockchain technology 
    to ensure the security and privacy of transactions, 
            while enabling rapid settlement times,

Telegram: https://t.me/Ordinalryoshientry
Medium: https://medium.com/@oransom85/ordinal-ryoshi-launching-tomorrow-arb-702f3f012628
Twitter: https://twitter.com/ordinalryoshi
**/
...
contract OrdinalRyoshi is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "OrdinalRyoshi";
    string private constant _symbol = "OrdinalRyoshi";
    ...
    address internal constant development_receiver = 0xd44A473C41a4EE606A06933b4Ef3b81179A575dD; 
    address internal constant marketing_receiver = 0xd44A473C41a4EE606A06933b4Ef3b81179A575dD;
    address internal constant liquidity_receiver = 0xd44A473C41a4EE606A06933b4Ef3b81179A575dD;
