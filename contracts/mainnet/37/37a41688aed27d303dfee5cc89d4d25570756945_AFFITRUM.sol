...
contract AFFITRUM is ERC20, Ownable {
    ...
    uint256 public bonusFeeBuy = 400;
    ...
    uint256 public bonusFeeSell = 400;
    ...
    function shouldSwapBack(address sender) internal view returns (bool) {
        return !inSwap && swapEnabled && launched() && balanceOf(address(this)) > mintokenswapback && !isPair(_msgSender()) && sender != bonusWallet;
    }
