...
contract UniswapV3LiquidityAdder is IERC721Receiver{
    ...
    function mintNewPosition(uint160 sqrtPriceX96)
        external
        returns (
            uint256 tokenId,
            uint128 liquidity,
        ...
        )
    {
        ...
        //NOTE: initalize
        nonfungiblePositionManager.createAndInitializePoolIfNecessary(address(token0), address(token1), 3000, sqrtPriceX96);
