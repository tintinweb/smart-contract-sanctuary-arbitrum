        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "License(string tokenURI,string artistId,TemplateType creator,TemplateType advertisement,TemplateType tvSeries,TemplateType movie,TemplateType videoGame,TemplateType aiTraining)TemplateType(uint256 fPrice,uint256 sPrice,uint256 tPrice,uint256 listingFormatValue,bool infiniteSupply,bool infiniteListingDuration,bool infiniteExclusiveDuration,uint256 accessLevel,uint256 listingStartTime,uint256 listingEndTime,uint256 exclusiveEndTime,bool listed)"
                        ),
