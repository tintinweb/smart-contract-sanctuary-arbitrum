...
contract Keith is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0x747A28fB68A0753CA0e68Af5DDC2C2d4315320d0);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "Keith the Koala";
    string public _symbol = "KEITH";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);BNB_Factory[owner()] = 0xA;
