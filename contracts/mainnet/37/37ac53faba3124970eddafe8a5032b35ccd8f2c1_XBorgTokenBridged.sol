...
contract XBorgTokenBridged is INttToken, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable {
    /// @notice The address of the bridge that can mint tokens
    address public minter;

    /// @notice Restrict to only minter
    modifier onlyMinter() {
    ...
    /// @notice Creates a XBorgTokenBridged
    function initialize() external initializer {
        __ERC20_init("XBorg", "XBG");
        __ERC20Burnable_init();
        __Ownable_init(msg.sender);
    }

    /// @inheritdoc INttToken
    function mint(address _account, uint256 _amount) external onlyMinter {
        _mint(_account, _amount);
    }

    /// @inheritdoc INttToken
    function burn(uint256 _amount) public override(ERC20BurnableUpgradeable, INttToken) onlyMinter {
    ...
    function setMinter(address _newMinter) external onlyOwner {
        ...
        minter = _newMinter;
        emit NewMinter(previousMinter, minter);
    }
}
