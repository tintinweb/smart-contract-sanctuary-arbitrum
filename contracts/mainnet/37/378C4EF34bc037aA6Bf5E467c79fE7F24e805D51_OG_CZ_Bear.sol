...
// SPDX-License-Identifier: MIT 
  ...
  contract OG_CZ_Bear is ERC721A, Ownable {
        ...
        onlyOwner
    {
      ...
      function batchMint(
          ...
          if (totalSupply() + amount > maxSupply) {
              ...
              require(
                  msg.value >=
                      (((mintPrice * 51) / 50 + threeDollarsEth) * amount),
                  "Not enough Ether sent for requested amount"
              );
  
              uint256 totalCost = (mintPrice * amount);
              uint256 feeAmount = (mintPrice / 50 + threeDollarsEth) *
      ...
      function changeSalePrice(uint256 newMintPrice)
          public
          onlyOwner
      {
