...
contract BananaDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "BananaDAO";
    string private _symbol = "BND";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x4C1F9Bf506CdEE26f9740f77056Ed734EbE9396E);
    address payable public DeveloperWallet = payable(0x18aA5d7418EaF2e02B4C361850cF4c4157EF85D4);
