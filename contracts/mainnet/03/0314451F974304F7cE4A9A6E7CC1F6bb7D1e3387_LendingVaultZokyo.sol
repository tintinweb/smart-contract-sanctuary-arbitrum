...
import { ILendingVaultZokyo } from "../interfaces/lending/ILendingVaultZokyo.sol";
import { IWNT } from "../interfaces/tokens/IWNT.sol";
import { Errors } from "../utils/Errors.sol";

contract LendingVaultZokyo is ERC20, ReentrancyGuard, Pausable, AccessManaged, ILendingVaultZokyo {
  ...
  */
  function _mintShares(uint256 assetAmt) internal returns (uint256) {
    ...
    if (totalSupply() == 0) {
      ...
      // Mint dead shares to vault on first deposit to prevent inflation attack
