...
// File contracts/okse/CelerWrapper.sol
 ...
 */
contract CelerWrapper is ReentrancyGuard, Ownable {
    using SafeERC20 for IERC20;
    ...
    function transfer(
        ...
        bytes32 transferId;
        {
            ...
            uint256 feeAmount = (_amount * protocolFee) / MAX_PERCENT;
    ...
    function transferNative(
        ...
        bytes32 transferId;
        {
            ...
            require(success, "feee transfer error");
            _amount = _amount - feeAmount;
    ...
    function setTresuryAddress(address _newAddress) public onlyOwner {
        treasuryAddress = _newAddress;
        emit TreasuryAddressUpdated(treasuryAddress);
    }

    function setProtocolFee(uint256 _newFeeValue) public onlyOwner {
