...
contract AethirCore is ICore, ReentrancyGuard {
    ...
    function stakeContainers(
        ...
        uint256 amount = _registry.getStakeHandler().handleStake(
            msg.sender,
            containers,
            vdata
        );
    ...
    function unstakeContainers(
        ...
        uint256 amount = _registry.getStakeHandler().handleUnstake(
            msg.sender,
            containers,
            vdata
        );
        ...
        pendings[0] = amount;
        _registry.getAethirToken().safeApprove(
    ...
    function forceUnstake(
        ...
        _registry.getStakeHandler().handleForceUnstake(
            msg.sender,
            providers,
            indexes,
            vdata
