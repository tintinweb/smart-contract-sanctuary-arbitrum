...
/**
 * SexToken = The integrated Finance Token
 * A new type of contract that designed and implemented by Sex Community
 */
contract SexToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    uint256 private _tTotal = (10**9) * _DECIMALFACTOR; // Total supply: 1 Quadrillion
