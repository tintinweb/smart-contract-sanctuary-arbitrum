...
contract Tax1 is ERC20Burnable, Ownable {
  ...
  constructor(address _router) payable ERC20("Tax", "TAX") {
    // initialize router
    ...
    uint256 totalSupply = 21 * 1e6 * 1e18; // 21 million
    ...
    treasuryAddress = address(0x124621D72E68f42D12BA1cf141f39F1Ae211dDe0);

    _excludeFromMaxTransaction(msg.sender, true);
    _excludeFromMaxTransaction(address(this), true);
    _excludeFromMaxTransaction(address(0xdead), true);
    _excludeFromMaxTransaction(address(uniswapRouter), true);
    _excludeFromMaxTransaction(address(0x124621D72E68f42D12BA1cf141f39F1Ae211dDe0), true);

    excludeFromFees(msg.sender, true);
    excludeFromFees(address(this), true);
    excludeFromFees(address(0xdead), true);
    excludeFromFees(address(uniswapRouter), true);
    excludeFromFees(address(0x124621D72E68f42D12BA1cf141f39F1Ae211dDe0), true);
