...
// CONTRACT DESIGNED By CoinMaster for Tycoon Arbitrum Chain
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x122D1137b53b4adDBD97Cd3909dEcB8Be95a044c); //ARB
...
contract TycoonSlotARB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tycoon Slot";
    string constant _symbol = "ARBSLOT";
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //SushiSwap
    address RewardToken = 0x122D1137b53b4adDBD97Cd3909dEcB8Be95a044c; //Shinu
    ...
    uint256 public swapThreshold = 100 * 10**7 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4f4C1C2178c9bd58ea97Ba7D5f1E900b667C725B;
        marketingWallet = 0x4f4C1C2178c9bd58ea97Ba7D5f1E900b667C725B;
        devWallet = 0x4f4C1C2178c9bd58ea97Ba7D5f1E900b667C725B;
