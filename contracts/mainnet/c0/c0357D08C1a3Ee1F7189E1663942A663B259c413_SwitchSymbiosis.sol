...
contract SwitchSymbiosis is Switch {
        ...
        nonReentrant
    {
        ...
        if (isNative) {
            ...
            IERC20(transferArgs.fromToken).safeApprove(symbiosisRouter, 0);
            IERC20(transferArgs.fromToken).safeApprove(symbiosisRouter, amountAfterFee);
        ...
        nonReentrant
    {
        ...
        if (isNativeBridgeToken) {
            ...
            IERC20(bridgeToken).universalApprove(symbiosisRouter, returnAmount);
            ISymbiosisRouter(symbiosisRouter).metaRoute(
                ISymbiosisRouter.MetaRouteTransaction(
                    swapArgs.symbiosisData.firstSwapCalldata,
                    swapArgs.symbiosisData.secondSwapCalldata,
