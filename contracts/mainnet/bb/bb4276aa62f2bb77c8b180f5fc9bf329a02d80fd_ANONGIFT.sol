...
// AnonGift - marketing funds distributed to holders.
// t.me/anongift
// anongift.pro
...
contract ANONGIFT is ERC20, Ownable {
    ...
    constructor() ERC20("Anon Gift", "ANONGIFT") {
        ...
        maxTransactionAmount = 1 * 1e6 * 1e18 *3/100; 
        maxWallet = 1 * 1e6 * 1e18 *4/100; 
        ...
        devWallet = address(0x9834765a94275c744f1a225e97BE933FF19488bf); 
