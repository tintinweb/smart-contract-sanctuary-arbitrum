...
// File contracts/governance/CongressMembersRegistry.sol

pragma solidity 0.6.12;

/**
 * CongressMembersRegistry contract.
 * @author Nikola Madjarevic
 * Date created: 13.9.21.
 * Github: madjarevicn
 */

contract CongressMembersRegistry {
    using SafeMath for *;

    // The name of this contract4
    string public constant name = "CongressMembersRegistry";

    // Event to fire every time someone is added or removed from members
    event MembershipChanged(address member, bool isMember);

    // _dcentralabCongress congress pointer
    ...
    modifier onlyDcentralabCongress {
        require(msg.sender == dcentralabCongress);
        _;
    }
