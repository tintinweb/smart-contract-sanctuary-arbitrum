...
/**
 Website: Coming
 Twitter: https://www.twitter.com/satoshiplays
 Telegram: https://www.t.me/satoshiplays
 */
...
contract SatoshiPlays is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * (10**9) * (10**18); // Changed to 1 billion with 18 decimals
    ...
    string private constant _name = "SATOSHIPLAYS";
 string private constant _symbol = "SATP";
 uint8 private constant _decimals = 18;


 address payable private _marketingAddress = payable(0x517fE85A5b637eF39f675781ECec5Ec209e021a1);
 address payable private _marketing2Address = payable(0x517fE85A5b637eF39f675781ECec5Ec209e021a1);
