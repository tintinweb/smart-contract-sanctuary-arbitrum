...
contract SushiSwapV2Swap {
    ...
    function swap(address tokenA, address tokenB, address to, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
    ...
    function wethSwap(address tokenA, address tokenB, address to, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
        TransferHelper.safeTransferFrom(tokenA, msg.sender, address(this), tokenAAmount);
        TransferHelper.safeApprove(tokenA, defiRouter, tokenAAmount);
    ...
    function pathToSwap(address tokenA, address to, address[] memory path, uint256 tokenAAmount) external returns (uint256[] memory amounts) {
        TransferHelper.safeTransferFrom(tokenA, msg.sender, address(this), tokenAAmount);
        TransferHelper.safeApprove(tokenA, defiRouter, tokenAAmount);
