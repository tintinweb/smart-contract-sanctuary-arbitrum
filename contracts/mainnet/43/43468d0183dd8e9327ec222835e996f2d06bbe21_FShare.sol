...
contract FShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 61,000 fSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("FSHARE Token", "FSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 FROZEN Share for initial pools deployment
