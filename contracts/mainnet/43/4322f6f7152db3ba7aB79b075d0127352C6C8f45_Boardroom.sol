...
contract Boardroom is ContractGuard {
    ...
    function initialize(
        ...
        rewardLockupEpochs = 12; // Lock for 12 epochs (24h) before release claimReward
    ...
    function setLockUp(uint256 _withdrawLockupEpochs, uint256 _rewardLockupEpochs) external onlyOperator {
        require(_withdrawLockupEpochs >= _rewardLockupEpochs && _withdrawLockupEpochs <= 126, "_withdrawLockupEpochs: out of range"); // <= 2 week
