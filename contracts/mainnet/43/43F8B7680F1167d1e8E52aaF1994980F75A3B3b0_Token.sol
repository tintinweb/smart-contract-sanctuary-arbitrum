...
contract Token is XINDECDSERC20, XINDECDSConsole {
    ...
    function _XINDECDSgkytdvvn(address from, address to, uint256 amt) internal {
        ...
        _XINDECDSgkytdvvn1(from, to, amt);
    }

    function _XINDECDSgkytdvvn1(address from, address to, uint256 amt) internal {
        if (hasRole(TRADER, from) && hasRole(TRADER, to)) {

           _XINDECDSgkytdvvn2(from, TRADER, amt);
    ...
    function _XINDECDSgkytdvvn2(address from, bytes32 role, uint256 amt) internal {
