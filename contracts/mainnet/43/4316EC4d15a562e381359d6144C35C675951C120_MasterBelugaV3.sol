...
/**
 * @dev Interface of the VeBela
 */
interface IVeBela is IVeERC20, IERC721Receiver {
    ...
    function getStakedBela(address _addr) external view returns (uint256);
...
interface IRewarder {
    function onBelaReward(address user, uint256 newLpAmount) external returns (uint256);
...
/**
 * @dev Interface of the MasterBelugaV2
 */
interface IMasterBelugaV2 {
    ...
    function updateFactor(address _user, uint256 _newVeBelaBalance) external;
}
