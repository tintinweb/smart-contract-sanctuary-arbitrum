...
import { ICamelotV3Factory } from "../../../shared/interfaces/ICamelotV3.sol";
...
import {LibUniswapV2Helper, LibUniswapV3Helper, UniswapV2SwapParams, UniswapV3SwapParams, ReserveInfo} from "./LibUniswapHelper.sol";
import {TokenInfo, LibTokenHelper, InvalidRangeValues } from "../TokenHelper/LibTokenHelper.sol";
import { LibInitializer } from "../../../shared/libraries/LibInitializer.sol";
...
library LibExchangeHelper {
    ...
    function getExchangePoolsByRange (uint start, uint stop, bytes memory data) internal view returns (ExchangePool[] memory exchangePools) {
