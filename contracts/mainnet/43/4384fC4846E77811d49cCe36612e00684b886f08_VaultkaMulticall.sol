...
interface ISakeV3 {
  ...
  function getUpdatedDebt(
    ...
    external
    view
    returns (uint256 currentDTV, uint256 currentPosition, uint256 leverageWithInterests, uint256 totalInterests);
...
contract VaultkaMulticall {
  ...
  function _getDtv(
    ...
    if (areStringsEqual(_vault, "maotai")) {
      ...
      (dtv.currentDTV, dtv.currentPosition, dtv.leverageWithInterests, dtv.totalInterests) = ISakeV3(vaultAddress)
        .getUpdatedDebt(_positionId, _user);
