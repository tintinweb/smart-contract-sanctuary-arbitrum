...
contract GoldenTicket is MinterControl, ERC721Enumerable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    address public constant paymentToken = 0x539bdE0d7Dbd336b79148AA742883198BBF60342;
    ...
    event GoldenTicketMint(address to, uint256 tokenId);

    constructor() ERC721("Gg", "gg") {
    ...
    function mint(uint tokensNumber) external {
        ...
        IERC20(paymentToken).transferFrom(_msgSender(), 0x5d75D6A019dEeAB32Cc2Af685900F4a96aF22852, tokenPrice * tokensNumber);
    ...
    function _mint(address _to) internal {
        ...
        ticketsMinted++;
        emit GoldenTicketMint(_to, _tokenId);
