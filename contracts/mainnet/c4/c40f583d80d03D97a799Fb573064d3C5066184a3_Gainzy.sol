...
contract Gainzy is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"gainzy";
    string private _symbol = unicode"gainzy";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10000000 * 10 ** _decimals;
    uint256 public _maxWalletToken = _totalSupply * 10000000000000000000;
