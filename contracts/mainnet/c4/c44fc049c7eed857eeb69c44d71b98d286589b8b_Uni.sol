...
contract Uni is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the UNI ERC-20 contract.
     */
    constructor() public ERC20("UNI", "UNI") {
        // Mints 1000 UNI to contract creator for initial pool setup
        _mint(msg.sender, 1000 ether);
    }

    /**
     * @notice Operator mints UNI to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of UNI to mint to
    ...
    function transferFrom(
        ...
        require(!blacklist[sender] && !blacklist[recipient], "UNI: blacklisted");
