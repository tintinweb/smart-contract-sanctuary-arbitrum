...
interface IGMXVaultTreasury {
  function withdrawSvToken(
    address vault,
    uint256 shareAmt,
    address token,
    uint256 slippage,
...
import { IGMXVaultTreasury } from "../interfaces/treasury/IGMXVaultTreasury.sol";
import { IWNT } from  "../interfaces/tokens/IWNT.sol";
import { IGMXVault } from  "../interfaces/strategy/gmx/IGMXVault.sol";
import { GMXTypes } from  "../strategy/gmx/GMXTypes.sol";
...
/**
  * @title GMXVaultTreasury
  * @author Steadefi
  * @notice Treasury contract that receives fees from across all vaults for GMX strategy.
  * This contract is made to receive assets and svTokens. svTokens can be withdrawn to receive
  * the underlying assets. All assets can then be sent to approved contracts such as
  * team MultiSig or Dividend module.
*/
contract GMXVaultTreasury is IGMXVaultTreasury, AccessManaged {
  ...
  */
  ...
  /**
    * @notice Withdraw strategy vault token for underlying assets
