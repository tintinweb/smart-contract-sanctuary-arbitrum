...
contract Registry is IRegistry, Upgradeable {
    ...
    ITradeParamsUpdater public constant tradeParamsUpdater = ITradeParamsUpdater(0x1B252B8Ec9aA8d4DeFeaa5E2d0e86C0D53aD545A);
    // @address:UPGRADER
    ...
    ISubaccountRegistry public constant subaccountRegistry = ISubaccountRegistry(0xf40A0438d10b9Ee20eB2D1513bA3097A4E77272A);
    // @address:GMX_V2_EXCHANGE_ROUTER
    IExchangeRouter public constant gmxV2ExchangeRouter = IExchangeRouter(0x7C68C7866A64FA2160F78EEaE12217FFbf871fa8);
    // @address:GMX_V2_ORDER_VAULT
    address public constant gmxV2OrderVault = address(0x31eF83a530Fde1B38EE9A18093A333D8Bbbc40D5);
    // @address:GMX_V2_ROUTER
    address public constant gmxV2Router = address(0x7452c558d45f8afC8c83dAe62C3f8A5BE19c71f6);
    // @address:GMX_V2_READER
    IReader public constant gmxV2Reader = IReader(0xf60becbba223EEA9495Da3f606753867eC10d139);
    // @address:GMX_V2_DATASTORE
    DataStore public constant gmxV2DataStore = DataStore(0xFD70de6b91282D8017aA4E741e9Ae325CAb992d8);
}
