...
contract RedKing is ERC20, Ownable {
    ...
    string public name_ = "XXJ";
    string public symbol_ = "XJ";
    uint256 public totalSupply_ = 55555;
    address public rewardAddr_ = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
    address public marketingWalletAddr_ = 0xA6C78Fd3C9619B1A0Eb119EA1A308741dfC5B825;
    uint256[3] public  buyFeeSetting_ = [0,3,0];
    uint256[3] public  sellFeeSetting_ = [0,3,0];
