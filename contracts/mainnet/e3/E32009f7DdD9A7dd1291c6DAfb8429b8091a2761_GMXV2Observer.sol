...
contract GMXV2Observer is IObserver, Ownable {
    ...
    function _evaluatePosition(
        ...
        for (uint256 i; i < positions.length; ) {
            ...
            overallPositionsValueUSD = overallPositionsValueUSD + int256(positions[i].numbers.sizeInUsd) + positionPnlUsd;
    ...
    function _evaluateIncreaseOrders(
        ...
        for(uint256 i = 0; i < orders.length; i++) {
            increaseOrdersUSD = increaseOrdersUSD + orders[i].numbers.sizeDeltaUsd;
        }
    }
