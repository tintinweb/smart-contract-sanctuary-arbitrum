  ...
  Ownable2StepUpgradeable
{
  ...
  function _withdraw(
    ...
    uint256 amountToTransfer = balanceOfBaseTokenAfter -
      balanceOfBaseTokenBefore;
    TokenUtils.safeTransfer(baseToken, recipient, amountToTransfer);

    return (amountToTransfer, amount);
  }
