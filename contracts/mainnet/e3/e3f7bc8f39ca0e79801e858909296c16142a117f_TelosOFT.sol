 ...
 */
abstract contract LzApp is OwnableUpgradeable, UUPSUpgradeable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    /** @dev Empty reserved space to allow future versions to add new variables without shifting down storage in inheritance chain */
    uint256[49] private __gap;
    ...
    event Initialize(address _endpoint);

    function __LzApp_init(address _endpoint) onlyInitializing internal {
        lzEndpoint = ILayerZeroEndpoint(_endpoint);
        __Ownable_init();
        __UUPSUpgradeable_init();
        emit Initialize(_endpoint);
    }
...
abstract contract NonblockingLzApp is LzApp {
    ...
    function __nonblockingLzApp_init(address _endpoint) onlyInitializing internal {
...
abstract contract BaseOFTV2 is OFTCoreV2, ERC165Upgradeable, IOFTV2 {

    /** @dev Empty reserved space to allow future versions to add new variables without shifting down storage in inheritance chain */
    uint256[49] private __gap;

    function __BaseOFTV2_init(uint8 _sharedDecimals, address _lzEndpoint) onlyInitializing internal {
...
abstract contract OFTCoreV2 is NonblockingLzApp {
    ...
    function __OFTCoreV2_init(uint8 _sharedDecimals, address _lzEndpoint) onlyInitializing internal {
...
contract TelosOFT is BaseOFTV2,  ERC20Upgradeable {
