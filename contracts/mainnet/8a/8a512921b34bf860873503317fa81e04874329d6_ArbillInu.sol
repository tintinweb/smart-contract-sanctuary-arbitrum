...
Telegram    : https://t.me/arbillinu
Twitter     : https://twitter.com/arbillinu
Website     : http://arbillinu.website/u
...
contract ArbillInu is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Arbill Inu';
    string private constant _symbol = 'ARBILL';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 100000000 * (10 ** _decimals);
    uint256 private _maxTxAmount = ( _totalSupply * 2 ) / 100;
    uint256 private _maxSellAmount = ( _totalSupply * 2 ) / 100;
    uint256 private _maxWalletToken = ( _totalSupply * 2 ) / 100;
    ...
    address internal constant development_receiver = 0xbF2dE941eBaA776d0AA1452a803f7cf052112b74; 
    address internal constant marketing_receiver = 0xbBFEc3264F262D61E0d48e6782b726D4E8d99545;
    address internal constant liquidity_receiver = 0xbF2dE941eBaA776d0AA1452a803f7cf052112b74;

    constructor() Ownable(msg.sender) {
        IRouter _router = IRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //SUSHI
