...
interface IPriceConsumer {
     ...
     */
    function getPriceInUSD(address token) external view returns (uint256, uint256, uint256);
}
...
contract ChainlinkPriceConsumer is IPriceConsumer, AccessControlEnumerable {
    ...
    function getPriceInUSD(address token) external view override returns (uint256 price, uint256 decimals, uint256 timestamp) {
