...
/**
 * @title   UniswapV3TWAPAggregator
 * @notice  Gets the unit price of an asset for a uniswap v3 pool
...
contract UniswapV3TWAPAggregator is IValioCustomAggregator {
    ...
    /**
     * @notice  Helper that creates observation slots in the V3 Pool
     * @dev     If the cardinality is not high enough the pool cannot store enough price samples
    ...
    /**
     * @notice  Returns true if the v3Pools cardinatlity meets the configured threshold
     * @param   pool  The pool to check
     * @return  bool  Returns true if the cardinality meets the threshold
     */
    ...
    /**
     * @notice  Helper function for monitoring the mean liquidty of the configured v3 pool of the given asset
     * @param   mainToken  The erc20 asset
     * @return  harmonicMeanLiquidity the current harmonicMeanLiquidity
     */
    ...
    /**
     * @notice  Returns the required cardinality for this chain
     * @return  uint16  The cardinality required by this contract
     */
    ...
    /**
     * @notice  Asserts that the cardinality of the given pool meets the required threshold
     * @param   pool  the v3 pool
     */
    ...
    function _latestRoundData(
        ...
        RegistryStorage.PoolConfig memory v3PoolConfig = VALIO_REGISTRY
            .poolConfig(mainToken);
        _assertCardinality(IUniswapV3Pool(v3PoolConfig.pool));
