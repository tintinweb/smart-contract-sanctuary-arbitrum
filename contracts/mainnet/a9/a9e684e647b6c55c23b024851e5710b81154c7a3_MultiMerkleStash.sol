...
// File contracts/MultiMerkleStash.sol
...
contract MultiMerkleStash is Ownable, ReentrancyGuard {
    ...
    function claim(address token, uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) nonReentrant public {
