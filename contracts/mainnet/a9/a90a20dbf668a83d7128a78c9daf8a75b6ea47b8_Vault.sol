...
//QUICK DEX// twitter.com/quickdexio
...
// File contracts/tokens/interfaces/IUSDQ.sol
...
contract Vault is ReentrancyGuard, IVault {
    ...
    function buyUSDQ(address _token, address _receiver) external override nonReentrant returns (uint256) {
        ...
        uint256 feeBasisPoints = getFeeBasisPoints(_token, usdqAmount, mintBurnFeeBasisPoints, taxBasisPoints, true);
    ...
    function sellUSDQ(address _token, address _receiver) external override nonReentrant returns (uint256) {
        ...
        uint256 feeBasisPoints = getFeeBasisPoints(_token, usdqAmount, mintBurnFeeBasisPoints, taxBasisPoints, false);
    ...
    function swap(address _tokenIn, address _tokenOut, address _receiver) external override nonReentrant returns (uint256) {
        ...
        uint256 feeBasisPoints;
        {
            ...
            uint256 feesBasisPoints0 = getFeeBasisPoints(_tokenIn, usdqAmount, baseBps, taxBps, true);
            uint256 feesBasisPoints1 = getFeeBasisPoints(_tokenOut, usdqAmount, baseBps, taxBps, false);
    ...
    function getTargetUsdqAmount(address _token) public view returns (uint256) {
