...
contract CIZION is IBEP20, Auth {
   
    using SafeMath for uint256;
 
    string constant _name = "JSUISDSMACHAMBRE";
    string constant _symbol = "CIZINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x71F6206cFd48DA807189F3992dB90F314242F6e2;  // marketingwallet
        lotteryWallet = 0x71F6206cFd48DA807189F3992dB90F314242F6e2;  // no tax for lotterywallet
