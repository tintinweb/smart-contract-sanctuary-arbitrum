    ...
    OwnableUpgradeable
{
    ...
    function migrateTaskResult(
        ...
        for (uint256 i = 0; i < proofs.length; i++) {
            ...
            (uint256 taskId, bytes32 uuidHash, string memory value) = abi
                .decode(proofs[i], (uint256, bytes32, string));
    ...
    function acceptTaskResults(bytes calldata proof) external whenNotPaused {
        (
            uint256 taskId,
            bytes32 uuidHash,
            string memory value,
