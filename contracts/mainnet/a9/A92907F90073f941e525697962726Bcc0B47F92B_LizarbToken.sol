...
/*
This from a friend his launching on arb loving the beautiful vibes precall.

the Arbitrum chain is growing extremely fast and has exceeded billions in volume. This will be my first arb project and it will be beautiful

LIZARB is a token meme with a new hype trend, formed with a strong and large community to try to  MOON.

The Next Moonshot in ARB 🚀

💹 Lp locked and renounced 
💹 Safu Dev and team
💹 Based and strong Community 
💹 Gems x1000

TOKENOMICS :

🟩TAX: 6/6 
🟩1 Month Lock with PinkSale 
🟩%1 max bag and max  amount

https://t.me/lizarbtoken
*/
...
contract LizarbToken is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    address private _owner;

    string private constant _name = "Lizarb Token";
    string private constant _symbol = "LIZARB";
    ...
    address payable public DevWallet = payable(0xC9754D0E0810Ba5B83356E27a949CcC32B16260A);
    address payable public MarketingWallet = payable(0x32c0cfdAd2Fe442ffc3E40fB57eADa15D92213a3);
    address payable private TeamWallet01 = payable(0xEBE54257A7914B625E6141685ED5Fd4Cc8e8D314);
    address payable private TeamWallet02 = payable(0x254d0836B25fAbcc897510455EF3181bd1Efc9Cd);
    address payable private TeamWallet03 = payable(0x6eF9ad0d4e5c1A5C851fDa7D746CAa83Fd60EeC4);
