    ...
    Pausable
{
    ...
    // hmp
    IHaloMembershipPass public hmp;
    ...
    {
        BadgePoolConfig memory poolConfig = badgePoolConfigs[poolId];
        require(poolConfig.kol != address(0), "INV_ID");
    ...
    function setHMPLevelThreshold(uint8 newLevel) public onlyOwner {
    ...
    function setProtocolFeeTo(address newReceiver) public onlyOwner {
    ...
    function setMaxLimitInBuyOrSell(uint256 newLimit) public onlyOwner {
    ...
    function toggleIsCheckHMPInCreation() public onlyOwner {
        isCheckHMPInCreation = !isCheckHMPInCreation;
    }

    function toggleIsCheckHMPInBuyOrSell() public onlyOwner {
        isCheckHMPInBuyOrSell = !isCheckHMPInBuyOrSell;
    }

    function toggleIsCheckCreator() public onlyOwner {
        isCheckCreator = !isCheckCreator;
    }

    function toggleIsCheckConstA() public onlyOwner {
        isCheckConstA = !isCheckConstA;
    }

    function toggleIsCheckConstB() public onlyOwner {
        isCheckConstB = !isCheckConstB;
    }

    function addWhitelistKOLs(address[] memory users) public onlyOwner {
    ...
    function removeWhitelistKOLs(address[] memory users) public onlyOwner {
    ...
    function addBlacklistKOLs(address[] memory users) public onlyOwner {
        uint256 addLength = users.length;
        address user;
        for (uint i = 0; i < addLength; i++) {
            user = users[i];
    ...
    function removeBlacklistKOLs(address[] memory users) public onlyOwner {
        uint256 removeLength = users.length;
        address user;
        for (uint i = 0; i < removeLength; i++) {
            user = users[i];
    ...
    function addWhitelistPayTokens(address[] memory tokens) public onlyOwner {
    ...
    function addWhitelistPreminer(address newMiner) public onlyOwner {
        isWhitelistPreminter[newMiner] = true;
    }

    function removeWhitelistPreminer(address removedMiner) public onlyOwner {
        isWhitelistPreminter[removedMiner] = false;
    }

    function addWhitelistConstA(uint256 constA) public onlyOwner {
        isWhitelistConstA[constA] = true;
    }

    function removeWhitelistConstA(uint256 constA) public onlyOwner {
        isWhitelistConstA[constA] = false;
    }

    function addWhitelistConstB(uint256 constB) public onlyOwner {
        require(constB > 0, "NOT_ZERO");
        isWhitelistConstB[constB] = true;
    }

    function removeWhitelistConstB(uint256 constB) public onlyOwner {
        isWhitelistConstB[constB] = false;
    }

    function addWhitelistFunder(address funder) public onlyOwner {
        isWhitelistFunder[funder] = true;
    }

    function removeWhitelistFunder(address funder) public onlyOwner {
