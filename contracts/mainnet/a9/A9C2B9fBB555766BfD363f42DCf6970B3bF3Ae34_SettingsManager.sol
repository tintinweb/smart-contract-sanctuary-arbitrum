...
contract SettingsManager is ISettingsManager, Initializable, ReentrancyGuardUpgradeable, Constants {
    ...
    event SetExecutionGasUnits(uint256 executionGasUnits);
    ...
    uint256 public override executionGasUnits;
    ...
    function setExecutionGasUnits(uint256 _executionGasUnits) external onlyOperator(3) {
        executionGasUnits = _executionGasUnits;
        emit SetExecutionGasUnits(_executionGasUnits);
    }
