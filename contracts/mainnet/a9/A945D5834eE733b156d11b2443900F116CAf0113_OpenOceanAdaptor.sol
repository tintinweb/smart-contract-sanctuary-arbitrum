...
/// @title OpenOceanAdaptor is to help exchange assets based on swap description struct
/// @notice Users can call `swap` method to swap assets
/// OpenOceanAdaptor will forward the swap description to `caller` contract to perform multi-swap of assets
contract OpenOceanAdaptor is IDexAggregatorAdaptor, AccessControl, ReentrancyGuard {
