...
contract ApetimismLaunchpadNFT is ERC721AQueryable, Ownable, ReentrancyGuard /*, ERC2981*/ {
  ...
  string private constant TOKEN_NAME = "ONEAPES";
  string private constant TOKEN_SYMBOL = "ONEAPES";
  ...
  address public signerAddress = 0xee8bDC82Ad0a8D62152a857B97AED64BE917E900;

  uint8 public currentRound = 0;
  bool public metadataFrozen = false;
  uint16 public maxMintPerTx = 3;
  uint16 public maxMintPerAddress = 3;
