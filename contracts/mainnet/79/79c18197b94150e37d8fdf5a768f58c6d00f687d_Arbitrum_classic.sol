...
// telegram: https://t.me/arbitrumclassic_arb
// website: https://arbclassic.com/
// twitter: https://twitter.com/ClassicArbitrum
...
contract Arbitrum_classic is ERC20, Ownable {
    ...
    ARBC_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x53D990B5CfD48438464F3E19E3920Bc15faAe90a;
    address private developmentWallet = 0xD251510A46CC82568cF09C97a8be3aDB6b6Db1a4;
    
    uint256 public swapTokensAtAmount = 29999999.99999999 * 10**9;
    uint256 public maxWalletBalance = 199999999.9999999 * 10**9;
    uint256 public maxBuyAmount = 199999999.9999999 * 10**9;
    uint256 public maxSellAmount = 199999999.9999999 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(2, 3, 1, 0);
    Taxes public sellTaxes = Taxes(2, 3, 1, 0);
    ...
    constructor() ERC20("Arbitrum classic", "ARBC") {
        dividendTracker = new ARBC_DividendTracker();
        IRouter _router = IRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
        ...
        /*
            ...
            and CANNOT be called ever again
        */
        _tokengeneration(owner(), 9999999999.999999  * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        ARBC_DividendTracker newDividendTracker = ARBC_DividendTracker(
            payable(newAddress)
        );
    ...
    function setMarketingWallet(address _newWallet) external onlyOwner {
     ...
     function setDevelpomentWallet(address _newWallet) external onlyOwner {
        require(_newWallet != address(this), "Fee Address cannot be Contract Address");
        require(_newWallet != address(0),"Fee Address cannot be zero address");
    ...
    function setMaxWallet(uint256 amount) external onlyOwner {
        require(amount >= 99999999, "Cannot set max wallet amount lower than 1%");
        maxWalletBalance = amount * 10**9;
    }
    
    function setMaxBuyAndSellLimits(uint256 maxBuy, uint256 maxSell) external onlyOwner {
        require(maxBuy >= 9999999, "Cannot set max Buy amount lower than 0.1%");
        require(maxSell >= 9999999, "Cannot set max Sell amount lower than 0.1%");
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _development, uint256 _liquidity) external onlyOwner{
        buyTaxes = Taxes(_rewards, _marketing, _development, _liquidity);
        require((_rewards + _marketing + _development +  _liquidity ) <= 40, "Must keep fees at 40% or less");
    }

    function setSellTaxes(uint256 _rewards, uint256 _marketing, uint256 _development, uint256 _liquidity) external onlyOwner{
        sellTaxes = Taxes(_rewards, _marketing, _development, _liquidity);
        require((_rewards + _marketing + _development +  _liquidity ) <= 50, "Must keep fees at 50% or less");
    }
...
contract ARBC_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("ARBC_Dividen_Tracker", "ARBC_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 999999 * (10**decimals()); 
    }
    ...
    function _transfer(
        ...
        require(false, "ARBC_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "ARBC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "ARBC_Dividend_Tracker: Cannot update claimWait to same value"
        );
