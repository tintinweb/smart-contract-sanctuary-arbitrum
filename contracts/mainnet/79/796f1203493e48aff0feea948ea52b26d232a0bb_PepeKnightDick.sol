...
contract PepeKnightDick is ERC20, Ownable, ERC20Permit, ERC20Votes {

    address constant BURN = 0x000000000000000000000000000000000000dEaD;
    bool reveal = false;

    constructor() ERC20("Pepe Knight Dick", "PEPEKD") ERC20Permit("Pepe Knight Dick") {
     ...
     */
    function name() public view virtual override returns (string memory) {
        return reveal ? "REVEAL NAME" : super.name();
    }
     ...
     */
    function symbol() public view virtual override returns (string memory) {
        return reveal ? "RUG" : super.symbol();
    }
