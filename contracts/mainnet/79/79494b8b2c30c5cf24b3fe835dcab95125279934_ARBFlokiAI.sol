...
contract ARBFlokiAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiAI";
    ...
    constructor () {
        ...
        uniswapV2Router = IUniswapV2Router02(0x0aA363C0C8EfAde9690a3C769B6238BC28de552a);
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
        
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[marketingWallet] = true;
        _isIncludedFromFee[0x5CA10b0b6E0AFaAc8E58D38ef78f2b842E99C358] = true;
