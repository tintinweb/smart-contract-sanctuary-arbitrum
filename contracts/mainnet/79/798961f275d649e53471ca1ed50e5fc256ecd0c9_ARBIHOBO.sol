...
/*
Don't just be regular hobo, be arbitrum hobo

Telegram: t.me/Arbihobo
Twitter: twitter.com/ArbiHobo
Website: arbihobo.org/
*/
...
contract ARBIHOBO is ERC20, Ownable {
    ...
    address public marketingWallet = 0x023B8bd8C4A3d2303770E4C3B9336971E84ED5AD;
    address public devWallet = 0x023B8bd8C4A3d2303770E4C3B9336971E84ED5AD;

    uint256 public swapTokensAtAmount = 1e2 * 10**9;
    uint256 public maxWalletBalance = 2e2 * 10**9;
    uint256 public maxBuyAmount = 2e2 * 10**9;
    uint256 public maxSellAmount = 1e2 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(5, 2, 0, 2);
    Taxes public sellTaxes = Taxes(5, 2, 0, 2);
    ...
    constructor() ERC20("Arbitrum Hobo", "ARBIHOBO") {
        ...
        /*
            ...
            and CANNOT be called ever again
        */
        _tokengeneration(owner(), 1e4 * (10**9));
    }
    ...
    function setMaxWallet(uint256 amount) external onlyOwner {
        require(amount >= 2e1, "Cannot set max wallet amount lower than 0.1%");
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount < 1e3,"Swap Threshold should be less than 1% of total supply");
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _dev, uint256 _liquidity) external onlyOwner{
        ...
        require((_rewards + _marketing + _dev + _liquidity ) <= 9, "Must keep fees at 9% or less");
    }
    ...
    function setMaxBuyAndSellLimits(uint256 maxBuy, uint256 maxSell) external onlyOwner {
        require(maxBuy >= 2e1, "Cannot set max Buy amount lower than 0.1%");
        require(maxSell >= 2e1, "Cannot set max Sell amount lower than 0.1%");
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100 * (10**decimals()); 
    }
