    ...
    ReentrancyGuardUpgradeable
{
    ...
    function earlyExit() external {
        ...
        bal.total = 0;
        bal.earned = 0;
        console2.log('total-penalty', total, penaltyAmount);
        ...
        )
    {
        ...
        if (locked > 0) {
            ...
            for (uint256 i = 0; i < length; i++) {
                ...
                uint256 unlockTime = userLocks[user][i].unlockTime;
