...
contract YANKEE is Context, IERC20, Ownable {
    ...
    string private constant _name = "YANKEE";
    string private constant _symbol = "YANKEE";
    ...
    uint256 public swapTokenAtAmount = 100 * 10**_decimals;
