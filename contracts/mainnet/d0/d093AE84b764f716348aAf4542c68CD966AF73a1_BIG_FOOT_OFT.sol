...
// File @layerzerolabs/solidity-examples/contracts/token/oft/v2/fee/[email protected]
...
abstract contract Fee is Ownable {
  ...
  function quoteOFTFee(uint16 _dstChainId, uint256 _amount)
    public
    view
    virtual
    returns (uint256 fee)
  ...
  function _payOFTFee(
    ...
    uint16 _dstChainId,
    uint256 _amount
  ) internal virtual returns (uint256 amount, uint256 fee) {
...
// File contracts/TokenOFT.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.0;

contract BIG_FOOT_OFT is OFTWithFee {
  constructor(address _lzEndpoint)
    OFTWithFee("BIG_FOOT", "BFT", 4, _lzEndpoint)
  {}
}