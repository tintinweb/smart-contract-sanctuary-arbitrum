...
contract NEOAI is ERC20Burnable, Ownable {
    ...
    constructor (address router, address operator) ERC20("NEO AI", "NEOAI")
    {
    ...
    function updateFees(uint256 _sellFee, uint256 _buyFee) external onlyOwner {
        require(_sellFee <= 15, "Fees must be less than 15%");
        require(_buyFee <= 15, "Fees must be less than 15%");
        sellFee = _sellFee;
        buyFee = _buyFee;
