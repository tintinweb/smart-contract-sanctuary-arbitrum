...
import "@openzeppelin/[email protected]/utils/StorageSlot.sol";
...
contract HyphenDepositor {
    ...
    function initialize(address _hyphen) public {
        StorageSlot.getAddressSlot(HYPHEN_SLOT).value = _hyphen;
    }

    function depositAllErc20(address receiver, uint256 toChainId, address tokenAddress) public {
