...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xbCB66B60a4CeBAdfF6FfC131c4E25647EE9F884C,0x4597cE42Cd2fAcb8d18925D8F456fBE21Ec705E5,0x808FAACb4a502060A73dE1F0f4B094eedbc60c08];
  address public erc20Payable = 0xbCB66B60a4CeBAdfF6FfC131c4E25647EE9F884C;
  uint256[] public payableFees = [45,45,10];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 7000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/BC2kqeToyFs1w7NpMr5t/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/bm2DoD2olk5vWaI76NGi/contract-metadata";
  }
...
// File: contracts/ArbMoonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbMoonContract is ERC721APlus {
    constructor() ERC721APlus("ArbMoon", "ArbMoon"){}
}
