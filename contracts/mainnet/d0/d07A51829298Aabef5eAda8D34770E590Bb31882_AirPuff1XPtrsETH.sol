...
abstract contract AirPuff1X is
    OwnableUpgradeable,
...
contract AirPuff1XPtrsETH is AirPuff1X {
    ...
    function initialize(address _pt_rsETH) external initializer {
        require(_pt_rsETH != address(0), "AirPuff: LRT address is invalid");
        ...
        __ERC20_init("AirPuff-PendleptrsETH1X", "bptrsETH1X");
    }
}