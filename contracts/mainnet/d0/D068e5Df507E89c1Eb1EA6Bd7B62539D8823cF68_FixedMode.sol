...
contract FixedMode is AccessControl {
    ...
    address constant TO_ADDRESS = 0xB98D7198796BFA01bf73Bc35f8f82887AbaB180D;
    address public WETH;
    ...
    function donateETH(uint256 _donationId) external payable {
        donate(_donationId, msg.value);
    }

    function donate(uint256 _donationId, uint256 _amount) public {
        DonationToken storage donationToken = donationTokens[_donationId];
        ...
        if (donationToken.paymentToken != WETH) {
