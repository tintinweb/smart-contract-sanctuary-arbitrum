...
import { AccessControl } from "@openzeppelin/contracts/access/AccessControl.sol";
import { TokenFiERC1155 } from "./TokenFiERC1155.sol";
import { ITokenLauncherERC1155 } from "../../interfaces/ITokenLauncherERC1155.sol";
...
contract TokenLauncherERC1155 is ITokenLauncherERC1155, AccessControl {
    ...
    function getPriceErc1155() public view returns (uint256) {
        return erc1155TokenPrice;
    }

    function setErc1155Price(uint256 newPrice) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function createErc1155(CreateErc1155Input memory input) external payable override {
        ...
        uint256 usdPrice = getPriceErc1155();
        ...
        // ERC1155 Facet
        cut[0] = IDiamondCut.FacetCut({
            facetAddress: ds.erc1155Facet,
            action: IDiamondCut.FacetCutAction.Add,
            functionSelectors: IDiamondFacet(ds.erc1155Facet).getFunctionSelectors()
        });
        IDiamondCut(token).diamondCut(cut, ds.erc1155Facet, abi.encodeWithSelector(ITokenFiERC1155Init.init.selector, input));
...
interface ITokenFiERC1155Init {
    function init(ITokenLauncherERC1155.CreateErc1155Input memory _input) external;
}
