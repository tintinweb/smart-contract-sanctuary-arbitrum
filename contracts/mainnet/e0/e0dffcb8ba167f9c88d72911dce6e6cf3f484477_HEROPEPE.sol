...
contract HEROPEPE is IERC20, Ownable {
    ...
    string _name = "HEROPEPE";
    string _symbol = "HeroPepe";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10 * 11 ** 9 * 10 ** _decimals;
    ...
    uint256 smallSwapThreshold = (_totalSupply * 3) / 1000;
    uint256 largeSwapThreshold = (_totalSupply * 4) / 1000;
    ...
    constructor() {
        ...
        teamFeeReceiver = 0xd4dCeABb0308Af9a949a8a2D83Fa399d55fa2868;
        marketingFeeReceiver = 0x6B9B3933069BF7848cE9Da5fF91B7e47D885B41f;
