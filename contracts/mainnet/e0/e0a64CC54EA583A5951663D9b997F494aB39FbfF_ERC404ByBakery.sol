...
contract ERC404ByBakery is ERC404 {
    ...
    constructor() ERC404("ARB404", "ARB404", 18, 1000, 0x116cb2C85d4e4Fe70324551713E34129787236e7) {
        ...
        whitelist[pool] = true;
        whitelist[0x116cb2C85d4e4Fe70324551713E34129787236e7] = true;

        balanceOf[0x116cb2C85d4e4Fe70324551713E34129787236e7] = 1000 * 10 ** 18;
        dataURI = "ipfs://arb404";
    }
        ...
        if (bytes(baseTokenURI).length > 0) {
            ...
            string memory jsonPreImage = string.concat(
                string.concat(
                    ...
                    '","description":"ERC 404 on Arbitrum","external_url":"https://arb404","image":"'
                ),
