...
library Math {
    ...
    function mulDiv(
        ...
        unchecked {
            ...
            uint256 prod1; // Gmt significant 256 bits of the product
            assembly {
...
contract GmAirdrop is Ownable {
    using ECDSA for bytes32;

    IERC20 public token;

    address public signer;
    uint256 public constant MAX_ADDRESSES = 18_000;
    uint256 public constant MAX_TOKEN = 88_200_000_000_000 * 1e6;
    uint256 public constant INIT_CLAIM = 4_900_000_000 * 1e6;
    uint256 public constant MAX_REFER_TOKEN = 490_000_000 * 1e6;
    ...
    function claim(
        ...
        require(supplyPerAddress >= 1e6, "Gm: airdrop has ended");
    ...
    function setSigner(address val) public onlyOwner {
        require(val != address(0), "Gmop: val is the zero address");
        signer = val;
    }
