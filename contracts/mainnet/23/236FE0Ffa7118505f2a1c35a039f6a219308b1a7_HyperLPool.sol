...
import { IAlgebraMintCallback } from "./interfaces/IAlgebraMintCallback.sol";
...
import {SafeAlgebraPool} from "./utils/SafeAlgebraPool.sol";
    ...
    IHyperLPool
{
    ...
    using SafeAlgebraPool for IAlgebraPool;
    ...
    /// @notice Algebra V3 callback fn, called back on pool.mint
    ...
    /// @notice Algebra v3 callback fn, called back on pool.swap
    ...
    /// @notice mint fungible HyperLP tokens, fractional shares of a Algebra position
    ...
    /// @return liquidityMinted amount of liquidity added to the underlying Algebra position
    ...
    /// @notice burn HyperLP tokens (fractional shares of a Algebra position) and receive tokens
    ...
    /// @return liquidityBurned amount of liquidity removed from the underlying Algebra position
    ...
    /// @notice Change the range of underlying Algebra position, only manager can call
    ...
    function executiveRebalance(
        ...
        require(rebalanceEnabled, "DH");   //  Disabled by hyperpools
        ...
        if (totalSupply() > 0) {
            ...
            require(newLiquidity > 0, "NP");   //  new position 0
        } else {
            lowerTick = newLowerTick;
            upperTick = newUpperTick;
        }
    ...
    function rebalance(
        ...
        require(msg.sender == HYPERPOOLS, "OH");   //  Hyperfied: Only hyperpools
    ...
    /// @return sqrtRatioX96 from algebra pool store
    // solhint-disable-next-line function-max-lines
    ...
    {
        (uint160 sqrtRatioX96, int24 tick, , , , , , ) = pool.safeState();
    ...
    function _deposit(
        ...
        (uint160 sqrtRatioX96, , , , , , , ) = pool.safeState();
    ...
    function _calculateFinalAmounts(
        uint256 amount0,
        uint256 amount1,
        int256 swapAmount,
        uint160 swapThresholdPrice,
    ...
    function _swapAndDeposit(
        ...
        (finalAmount0, finalAmount1) = 
            _calculateFinalAmounts(amount0, amount1, swapAmount, swapThresholdPrice, zeroForOne);
    ...
    function _computeMintAmounts(
        ...
        if (amount0Current == 0 && amount1Current > 0) {
            ...
            require(amount0Mint > 0 && amount1Mint > 0, "M0"); //  mint 0
        ...
        view
    {
        ...
        require(tickCumulatives.length == 2, "AL");    //  array len
    ...
    IHyperLPoolStorage
{
    ...
    IAlgebraPool public override pool;
    ...
    /// @param _pool address of Algebra pool
    ...
    function initialize(
        ...
        // e.g. "HyperPools Algebra USDC/DAI LP" and "HyperLP"
...
abstract contract OwnableUninitialized {
    ...
    modifier onlyManager() {
        require(manager() == msg.sender, "NM"); //  Ownable: caller is not the manager
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyManager {
        require(
            newOwner != address(0),
            "ZA"    //  Ownable: new manager is the zero address
        );
