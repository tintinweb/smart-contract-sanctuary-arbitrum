...
interface TokenSwapInfo {
    ...
    function geetFeeAmount(uint256 amount, uint256 newPrice)
        external
        view
        returns (
            uint256,
    ...
    function getAmountPrice() external view returns (uint256);
...
contract Token404 is ERC404, Pausable, ReentrancyGuard {
    string public baseTokenURI =
        "https://orange-efficient-landfowl-259.mypinata.cloud/ipfs/QmfSCPs2v6bD3iXPD83sxwJSwCKDbLntBiBV7kc1ohw4by/";
