...
contract Migration_ARB_Lens is
  Migration // solhint-disable-line contract-name-camelcase
{
  ...
  function migrate() internal override onlyAdmin {
    _registry.setAddress(keccak256("ambit.protocol.lens"), 0xC59D9A9D0ec37db8FcC6fE0D2A0a893961a47Dcb);
    _registry.setAddress(keccak256("ambit.account.lens"), 0xBd2DF88D162A12C9Ba920538b326f509C318E2EA);

    // grant authorization on MARKET_LIQUIDATION to the LIQUIDATOR
    grantAuthorization(0x6d90FcBBe64a8359759a46bF9DcDeb3B8d374a3e, 0x9E40449fF25Da734243965CE97411ABA2C77DbA4);
  }
