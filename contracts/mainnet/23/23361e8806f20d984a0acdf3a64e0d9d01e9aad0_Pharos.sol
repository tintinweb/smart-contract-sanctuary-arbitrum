 ...
 * allowances. See {IERC20-approve}.
 */
contract Pharos is ERC20, Ownable {
    string private _name = "Pharos";
    string private _symbol = "Pharos";
    uint8 private _decimals = 18;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 4;
    address public marketingWallet = 0x20618ecA6F3f3E6Cc16F959dbAD8BF1347e84227;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _marketingReserves = 0;
    mapping(address => bool) public _isExcludedFromFee;
    uint256 public numTokensSellToAddToLiquidity = 2000000 * 10 ** _decimals;
    uint256 public numTokensSellToAddToETH = 1000000 * 10 ** _decimals;
    uint256 private _supply = 10_000_000_000;
    bool public isCanTransfer;
    address public phroasAddress;
     ...
     * construction.
     */
    constructor(address PhroasAddress) ERC20(_name, _symbol) {
        ...
        phroasAddress = PhroasAddress;

        _isExcludedFromFee[address(uniswapV2Router)] = true;
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[marketingWallet] = true;
        _isExcludedFromFee[PhroasAddress] = true;
        feeWhiteList[PhroasAddress] = true;
    ...
    function _transfer(
        ...
        if (!feeWhiteList[from] && !feeWhiteList[to]) {
            require(isCanTransfer, "The game is not open.");
            if (
    ...
    function openTransfer() external {
        require(
            msg.sender == marketingWallet ||
                msg.sender == phroasAddress ||
                msg.sender == owner(),
    ...
    function setfeeWhiteList(
        address feeWhiteList_,
        bool state_
    ) external onlyOwner {
        feeWhiteList[feeWhiteList_] = state_;
    }
