...
contract RoyaltyFeeManager is IRoyaltyFeeManager, Ownable {
     ...
     */ function getRemixCreatorRoyaltyFee()
        external
        view
        override
        returns (uint256)
    {
        return royaltyFeeRegistry.getRemixCreatorRoyaltyFee();
    }

    /**
     * @notice Get remix owner royalty info
     */ function getRemixOwnerRoyaltyFee()
        external
        view
        override
        returns (uint256)
    {
        return royaltyFeeRegistry.getRemixOwnerRoyaltyFee();
    }
}