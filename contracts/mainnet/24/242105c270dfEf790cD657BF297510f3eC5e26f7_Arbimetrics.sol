...
/**               
Telegram : https://t.me/Arbimetrics                                          
...
contract Arbimetrics is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arbimetrics";
    string private constant _symbol = "Arbimetrics";
 
    address public _PancakeSwapV1RouterUniswap = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 ; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 ; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // mainnet
