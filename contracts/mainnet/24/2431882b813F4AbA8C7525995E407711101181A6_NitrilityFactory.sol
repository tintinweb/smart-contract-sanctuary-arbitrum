        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "License(string tokenURI,string artistId,TemplateType creator,TemplateType advertisement,TemplateType tvSeries,TemplateType movie,TemplateType videoGame,TemplateType aiTraining)TemplateType(string tokenURI,string artistId,uint256 listingFormatValue,uint256 fPrice,uint256 sPrice,bool infiniteSupply,bool infiniteDuration,uint256 accessLevel,uint256 startTime,uint256 endTime)"
                        ),
