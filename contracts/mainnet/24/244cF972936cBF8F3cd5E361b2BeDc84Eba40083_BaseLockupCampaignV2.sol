...
contract BaseLockupCampaignV2 {    
    ...
    function setIsClaimable(address _address, bool _isClaimable) external onlyOwner {
        isClaimable[_address] = _isClaimable;
    }
    ...
    function claimParticipationReward(address account) external returns (uint256){
        ...
        require(isClaimable[account], "BaseCampaign: Can't claim yet");
