...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9); //USDT
...
contract IgnoranceOfficialTokenV2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "IgnoranceOfficialTokenV2";
    string constant _symbol = "IOT";
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //SUSHI
    address RewardToken = 0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9; //USDT

    uint256 _totalSupply = 10 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100 * 10**7 * (10 ** _decimals);
    uint256 public _walletMax = 100 * 10**7 * (10 ** _decimals);
    ...
    uint256 public extraFeeOnSell = 37;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xe06BC24fBEbdfCA49f3214EA621e80e4AA1a18dc;
        marketingWallet = 0xe06BC24fBEbdfCA49f3214EA621e80e4AA1a18dc;
        devWallet = 0xe06BC24fBEbdfCA49f3214EA621e80e4AA1a18dc;
