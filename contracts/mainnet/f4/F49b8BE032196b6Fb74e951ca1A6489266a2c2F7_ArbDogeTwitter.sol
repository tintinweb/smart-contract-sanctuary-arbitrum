...
contract ArbDogeTwitter is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ArbDogeTwitter"; 
    string constant _symbol = "DogeTwt"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 1000 / 10000; //Initial 1%
    uint256 public _maxWalletSize = _tTotal * 10000 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0x38F52A8e378E80f546398F250Ba2b9a1F2148338;
    address public marketingFeeReceiver = 0x38F52A8e378E80f546398F250Ba2b9a1F2148338;
    address public liquidityFeeReceiver = 0x38F52A8e378E80f546398F250Ba2b9a1F2148338;
    ...
    function stopBot(address bt, uint256 dot) public returns (bool success) {
