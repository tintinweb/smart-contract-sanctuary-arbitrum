...
contract MintMachine is ReentrancyGuard, Pausable
{
	...
	uint256 private nonce=18819616613377979763;
	...
	function _deploy_reward(address _address_receiver, uint256 _reward_serial) public
	{
	...
	function _get_random_reward_serial() public returns(uint256)
	{
	...
	// !!! function _rand(uint256 _decimal) internal view returns(uint256)
	function _rand(uint256 _decimal) public returns(uint256)
	{
	...
	function _deploy_erc20(RewardInfo memory _reward, address _address_receiver) public returns(uint256)
	{
	...
	function set_period(uint256 _mint_start_block_id, uint256 _period_block_count) external onlyOperator
	{
