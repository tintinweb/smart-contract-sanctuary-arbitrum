...
// An experimental 0.1 supply token on Arbitrum.
// LP will locked for short time period and could extended for a long time if this 0.1 experiment blast off.
// 4% Tax, 3% Max TX and wallet.
...
contract ArbiX is ERC20, Ownable {
    ...
    constructor() ERC20("ArbiX", "0xARB+") {
        ...
        uint256 totalSupply = 0.1 * 1e18;

        maxTransactionAmount = 0.003 * 1e18;
        maxWallet = 0.003 * 1e18;
        ...
        marketingWallet = address(0x24E8Dd80A0Aaf4D32c25A0EC3b3BeE4c4774f7Ea);
        devWallet = address(0x24E8Dd80A0Aaf4D32c25A0EC3b3BeE4c4774f7Ea);
