...
contract GrandTheftPepeGenesis {
    ...
    function stakeToken(uint256 _tokenId, uint256 _quantity) public notPaused {
        ...
        stakers[msg.sender].quantity = _quantity;
    ...
    function claimReward() public {
        ...
        require(block.timestamp >= staker.time + 0.1 hours, "0.1 hours not passed yet");
