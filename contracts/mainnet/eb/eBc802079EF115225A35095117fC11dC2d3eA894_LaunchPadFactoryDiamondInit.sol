...
contract LaunchPadFactoryDiamondInit is AccessControl {
    ...
    function init(InitDiamondArgs memory _input) external {
        ...
        // require(_input.flokiAddress != address(0), "LaunchPadPaymentV1::constructor::ZERO: flokiToken cannot be zero address.");
        // require(_input.tokenAddress != address(0), "LaunchPadPaymentV1::constructor::ZERO: tokenfiToken cannot be zero address.");
        require(
        ...
        ds1.flokiToken = _input.flokiAddress;
