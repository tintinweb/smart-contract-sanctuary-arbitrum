...
contract GNSPriceImpact is GNSAddressStore, IPriceImpactUtils {
    ...
    function removePriceImpactOpenInterest(
        ...
        PriceImpactUtils.removePriceImpactOpenInterest(uint128(_openInterestUsd), _pairIndex, _long, _addTs);
    }
...
library PriceImpactUtils {
    ...
    function removePriceImpactOpenInterest(
        ...
        emit IPriceImpactUtils.PriceImpactOpenInterestRemoved(
            IPriceImpact.OiWindowUpdate(settings.windowsDuration, _pairIndex, addWindowId, _long, _openInterestUsd),
            notOutdated
        );
    }
