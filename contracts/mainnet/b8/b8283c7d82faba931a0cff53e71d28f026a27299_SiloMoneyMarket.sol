...
contract SiloMoneyMarket is BaseMoneyMarket, SiloBase {
    ...
    {
        (actualAmount,) =
            silo.deposit(asset, asset.transferOut(payer, address(this), amount), isBitSet(positionId.getFlags(), COLLATERAL_ONLY));
    }
        ...
        returns (uint256 actualAmount)
    {
        ...
        (actualAmount,) = silo.withdraw(asset, amount, isBitSet(positionId.getFlags(), COLLATERAL_ONLY));
        asset.transferOut(address(this), to, actualAmount);
    }
