...
contract GlpStrategy is IJonesGlpLeverageStrategy, UpgradeableOperableKeepable {
    ...
    IJonesBorrowableVault private stableVault;
    ...
    function initialize(
        ...
        stableVault = IJonesBorrowableVault(_stableVault);
        glpVault = IJonesBorrowableVault(_glpVault);
        distributor = IJonesGlpRewardDistributor(_distributor);

        stable = IERC20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8);
     ...
     * @inheritdoc IJonesGlpLeverageStrategy
     */
    function onStableDeposit() external onlyOperator {
        _rebalance(getUnderlyingGlp());
    }
...
interface IJonesGlpLeverageStrategy {
    /**
     * @notice React to a GLP deposit, borrow GLP from Vault & relabance
