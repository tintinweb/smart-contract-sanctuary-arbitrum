...
abstract contract CTokenInterfaceGmx is CTokenStorageGmx {
    /**
...
abstract contract CErc20InterfaceGmx is CErc20StorageGmx {
    ...
    function liquidateBorrow(address borrower, uint repayAmount, CTokenInterfaceGmx cTokenCollateral) virtual external returns (uint);
...
contract CDelegationStorageGmx {
    /**
...
abstract contract CDelegatorInterfaceGmx is CDelegationStorageGmx {
    /**
...
abstract contract CDelegateInterfaceGmx is CDelegationStorageGmx {
    /**
