...
contract ArtificialInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x21737Dac7926dCA6A01AF2Aca31Ad69F9dB48172;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x21737Dac7926dCA6A01AF2Aca31Ad69F9dB48172] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x21737Dac7926dCA6A01AF2Aca31Ad69F9dB48172] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x21737Dac7926dCA6A01AF2Aca31Ad69F9dB48172,
                block.timestamp
            );
