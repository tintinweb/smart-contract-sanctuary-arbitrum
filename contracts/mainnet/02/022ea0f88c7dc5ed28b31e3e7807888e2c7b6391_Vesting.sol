...
contract Vesting is AccessControl {
	...
	modifier onlyInvestor() {
		...
		constructor(IWINR _Winr, IWINR _vWinr, address _admin, address _adminBackup , address coAdmin) {
		WINR = _Winr;
		vWINR = _vWinr;

		categoryDetails[Category.WINR_LABS] = CategoryDetail(180, 1350); // 180 days cliff, 1350 days vesting ( 1080 + 270)
		...
		categoryDetails[Category.CORE_CONTRIBUTORS] = CategoryDetail(0, 990); // 0 days cliff, 990 days vesting ( 720 + 270)
