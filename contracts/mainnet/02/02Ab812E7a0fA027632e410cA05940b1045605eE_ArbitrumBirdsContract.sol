/**
 *Submitted for verification at Arbiscan on 2022-11-21
*/
...
//
// .------..------..------..------..------..------..------..------.     .------..------..------..------..------.
// |A.--. ||R.--. ||B.--. ||I.--. ||T.--. ||R.--. ||U.--. ||M.--. |.-.  |B.--. ||I.--. ||R.--. ||D.--. ||S.--. |
// | (\/) || :(): || :(): || (\/) || :/\: || :(): || (\/) || (\/) ((5)) | :(): || (\/) || :(): || :/\: || :/\: |
// | :\/: || ()() || ()() || :\/: || (__) || ()() || :\/: || :\/: |'-.-.| ()() || :\/: || ()() || (__) || :\/: |
// | '--'A|| '--'R|| '--'B|| '--'I|| '--'T|| '--'R|| '--'U|| '--'M| ((1)) '--'B|| '--'I|| '--'R|| '--'D|| '--'S|
// `------'`------'`------'`------'`------'`------'`------'`------'  '-'`------'`------'`------'`------'`------'
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x4c6e2cc3f5f5af87cD2871B6a3d4FB6eCEd82814];
  address public erc20Payable = 0x4c6e2cc3f5f5af87cD2871B6a3d4FB6eCEd82814;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 8000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidagi63ovwzmk77ogsgvipszhhz3ofnhlm722yjr4okq3a3gjrpia/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 8000");
...
// File: contracts/ArbitrumBirdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArbitrumBirdsContract is RamppERC721A {
    constructor() RamppERC721A("Arbitrum Birds", "ARBD"){}
}
