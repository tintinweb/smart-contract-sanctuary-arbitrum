...
/*
STEALTH LAUNCH VERY SOON | McPEPE $McPE

McPepe is a cryptocurrency based on memes with a McDonald's theme. Each McPepe meme features different McDonald's characters, such as Ronald McDonald, Hamburglar, or Grimace, in funny or silly situations.

Our team is excited to bring you McPEPE (Arbitrum). A new cryptocurrency created on ARBITRUM Blockchain by a diverse group of many talented skilled individuals from the across the Globe. 

In today’s business practices, the value of an asset is determined by several factors such as estimated risk, cost of operations, and determinants of growth. If we have the community support needed, we believe there is no limit to how far $McPE can go in today’s market.
The same mentality applies to meme coins. If enough people believe an asset’s value, the sky’s the limit.

We will be going live soon kindly stay tuned, will host a live AMA as well let’s build a strong community for $McPE
...
contract Mcpepe is Ownable, IBEP20 {
    ...
    string constant _name = "McPEPE";
    string constant _symbol = "$McPE";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x9eC9a70a7487B33a77B7A7081dbfEB6C89424f06;
        marketingWallet = 0x9eC9a70a7487B33a77B7A7081dbfEB6C89424f06;
