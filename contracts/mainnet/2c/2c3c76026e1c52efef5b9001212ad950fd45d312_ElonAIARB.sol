...
/**
 Fresh Meme Token on Arbitrum Blockchain, ElonAIARB - Building a NFT Marketplace on Arbitrum Blockchain
...
contract ElonAIARB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ElonAIARB", "ElonAIARB") {
        ...
        marketingWallet = address(0xCe81ce5a8fd110DdC3F11E778eb3A6f6f0A02A94); // set as marketing wallet
        devWallet = address(0xCe81ce5a8fd110DdC3F11E778eb3A6f6f0A02A94); // set as dev wallet
