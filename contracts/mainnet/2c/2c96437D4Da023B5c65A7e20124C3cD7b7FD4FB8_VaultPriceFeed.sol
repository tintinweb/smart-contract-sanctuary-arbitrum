...
import "../oracle/interfaces/IPancakePair.sol";
...
contract VaultPriceFeed is IVaultPriceFeed {
    ...
    mapping(address => bool) public hasChainlinkFeed;
    ...
    function setChainlinkFeed(address _token, bool _isValid) external onlyGov {
        hasChainlinkFeed[_token] = _isValid;
    }
    ...
    function getPriceV1(address _token, bool _maximise)
        public
        view
        returns (uint256)
    {
    ...
    function getPriceV2(address _token, bool _maximise)
        public
        view
        returns (uint256)
    {
