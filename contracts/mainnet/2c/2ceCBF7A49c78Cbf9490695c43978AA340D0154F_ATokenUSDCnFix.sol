...
import {IncentivizedERC20} from "../tokenization/IncentivizedERC20.sol";
import {IAaveIncentivesController} from "../../interfaces/IAaveIncentivesController.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
import {IMiddleFeeDistribution} from "../../interfaces/IMiddleFeeDistribution.sol";

/**
 * @dev Temporary implementation to reset "balanceOf" storage of `accounts` of deployed AToken.
 ...
 */
contract ATokenUSDCnFix is VersionedInitializable, IncentivizedERC20("ATOKEN_IMPL", "ATOKEN_IMPL", 0), IAToken {
	...
	/**
	 * @custom:usdcn-fix Reset the 4 addresses `balanceOf` state associated with the exploit here:
	 * https://arbiscan.io/token/0x3a2d44e354f2d88ef6da7a5a4646fd70182a7f55#balances
	 * @dev can only be called once.
	 */
	function burnOverrideExploiterBalances() external {
		// NOTE: Check /confirm this is the correct multisig
		require(msg.sender == 0x111CEEee040739fD91D29C34C33E6B3E112F2177, "only callable by radiant multisig");
		uint256 len = 4;
		address[] memory _accounts = new address[](len);
		// NOTE: Check /confirm  these are the correct exploiter addresses
		_accounts[0] = 0x39519c027b503f40867548Fb0c890b11728faA8F; // confirmed - Pizza
		_accounts[1] = 0x78d13f1225EC1F5fD80BBFaA88490779Ba079De8; // confirmed - Pizza
		_accounts[2] = 0xd8B591abA7E5eDAc39f544e5d365CD65705Ea8f3; // confirmed - Pizza
		_accounts[3] = 0xFD76399B68E8521245b2cD42771B308c7164b0B3; // confirmed - Pizza

		for (uint256 i = 0; i < len; i++) {
			uint256 amount = _balances[_accounts[i]];
			_burn(_accounts[i], amount);
			emit Transfer(_accounts[i], address(0), amount);
			emit Burn(_accounts[i], address(0), amount, 1e27);
		}

		require(super.totalSupply() == 0, "not all supply was burned");
	}
