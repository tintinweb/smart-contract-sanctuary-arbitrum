    ...
    ERC20Upgradeable
{
    ...
    function stakeEsLODE(uint256 amount) external whenNotPaused nonReentrant {
        ...
        stakers[_msgSender()].esLODEAmount += amount;
        totalStaked += amount;
    ...
    function unstakeLODEInternal(address user, uint256 amount) internal {
        require(stakers[user].lodeAmount >= amount, "StakingRewards: Invalid unstake amount");
        require(
    ...
    function unstakeEsLODEInternal(address user, uint256 amount) internal {
        require(stakers[user].esLODEAmount >= amount, "StakingRewards: Invalid unstake amount");
        _burn(user, amount);
