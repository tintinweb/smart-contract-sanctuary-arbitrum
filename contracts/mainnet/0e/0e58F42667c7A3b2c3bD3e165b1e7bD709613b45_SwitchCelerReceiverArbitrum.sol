...
contract SwitchCelerReceiverArbitrum is SwitchArbitrum {
    ...
    ) SwitchArbitrum(_switchViewAddress, _switchEventAddress, _paraswapProxy, _augustusSwapper)
        public
    {
...
import "./SwitchRootArbitrum.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract SwitchArbitrum is SwitchRootArbitrum {
...
abstract contract SwitchRootArbitrum is ISwitchView {
    ...
    uint256 constant internal PATHS_SPLIT = 1;
    address constant internal ETH_ADDRESS = address(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    address constant internal ZERO_ADDRESS = address(0);

    IWETH constant internal weth = IWETH(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
