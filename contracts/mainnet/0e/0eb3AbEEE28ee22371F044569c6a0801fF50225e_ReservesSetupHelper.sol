...
import {IChefIncentivesController} from "../../../maneki/interfaces/IChefIncentivesController.sol";
...
contract PoolConfigurator is VersionedInitializable, IPoolConfigurator {
    ...
    function addPoolOnIncentivesController(
        ...
        incentivesController.addPool(_asset, _allocPoint);
    }
}
