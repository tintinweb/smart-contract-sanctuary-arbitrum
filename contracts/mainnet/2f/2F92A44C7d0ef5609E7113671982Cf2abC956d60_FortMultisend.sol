...
contract FortMultisend is OwnedUpgradeabilityStorage, Claimable {
    ...
    function multisendToken(
        ...
        uint256 user2balance = totalFee.div(2);

        erc20token.transferFrom(msg.sender, owner(), totalFee.sub(user2balance));
        erc20token.transferFrom(msg.sender, referer, user2balance);
        ...
        payable
    {
        ...
        owner().transfer(totalFee.sub(user2balance));
