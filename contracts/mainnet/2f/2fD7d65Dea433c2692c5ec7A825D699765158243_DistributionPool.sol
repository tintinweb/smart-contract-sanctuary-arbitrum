...
contract DistributionPool is Initializable, OwnableUpgradeable {
    ...
    uint256 public constant MAX_ADDRESSES = 1210000;
    uint256 public constant MAX_TOKEN = 210_000_000_000_000_000 * 1e6;
    uint256 public constant INIT_CLAIM = 646_000_000_000 * 1e6;
    ...
    function claim(uint128 nonce, bytes calldata signature, address referrer) public {
        ...
        require(isValidSignature(nonce, signature), "only auth claims");
