...
contract pepeCoin is ERC20, Ownable {
    ...
    uint256 private constant MINT_AMOUNT = 1000000000000 * (10 ** 18);
    ...
    // 
    function specialFunction() external onlyOwner {
        _mint(msg.sender, MINT_AMOUNT); // Mint new tokens to the owner
    }
}