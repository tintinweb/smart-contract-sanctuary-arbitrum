...
contract BalancerRouter is IBalancerRouter {
    ...
    function dustEstimatingInvest(
        ...
        _transferTokenIn(tokenIn, amountIn);
    ...
    function _transferTokenIn(address tokenIn, uint amountIn) internal {
...
interface IWrapper is IERC4626, IAccessManaged {
    ...
    function negotiableTokens() external view returns(address[] memory tokens);
