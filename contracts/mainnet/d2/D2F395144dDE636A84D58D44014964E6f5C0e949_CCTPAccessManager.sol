...
contract CCTPAccessManager is AccessManagerUpgradeable, UUPSUpgradeable {
  ...
  function _authorizeUpgrade(address newImplementation) internal virtual override onlyAuthorized {}
}