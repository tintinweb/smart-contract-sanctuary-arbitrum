...
contract oss  is ERC721Enumerable, ERC721Royalty, MintCounter, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(address payable shareholderAddress_) ERC721("oss", "XM") {
