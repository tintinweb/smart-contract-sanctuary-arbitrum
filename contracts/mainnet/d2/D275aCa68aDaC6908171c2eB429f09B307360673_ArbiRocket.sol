...
/**
    ...
    Telegram: @ArbiRocketPortal

    Website: Live after launch

    Starting tax 0/10

    After burn we lower it to 0
...
contract ArbiRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ArbiRocket";
    ...
    address payable public liquidityWallet = payable(0xAdDb34605C9864535486dA9C1fc92A752301d5d0);
    address payable public operationsWallet =  payable(0xAdDb34605C9864535486dA9C1fc92A752301d5d0);
