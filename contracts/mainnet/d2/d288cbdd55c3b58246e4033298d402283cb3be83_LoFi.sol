...
// File: contracts/lofi.sol

pragma solidity ^0.8.0;


contract LoFi is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply, address _lpWallet, address _ecoWallet, address _airdropWallet) ERC20("LoFi", "LOFI") {
