...
contract NOTELEGRAM is IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "NOTELEGRAM";
    string private constant _symbol = "NOTG";
    ...
    address public marketingWallet = address(0x6b4d36B20Dbe99cDF37aDc972cA95cA457B8AB63);
    address public liquidityReciever = address(0x8441BFe23D097353B4B1190c1489aBB0187aE41B);
    ...
    uint256 public maxTxnAmount = 250_000 * 10**_decimals;
    uint256 public maxWalletAmount = 500_000 * 10**_decimals;
    ...
    bool public CoolDownActive = false;
