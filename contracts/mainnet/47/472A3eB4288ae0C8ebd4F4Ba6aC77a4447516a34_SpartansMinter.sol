...
contract SpartansMinter is ISpartansMinter, IERC721Receiver, Ownable {
    ...
    uint256 public constant TOKENS_AMOUNT = TEAM_TOKENS_AMOUNT + SALE_TOKENS_AMOUNT;
    ...
    mapping(address => mapping(uint256 => uint256)) internal userTokens;
    ...
    function getUserTokens(address user, uint256 index) view external returns (uint256) {
