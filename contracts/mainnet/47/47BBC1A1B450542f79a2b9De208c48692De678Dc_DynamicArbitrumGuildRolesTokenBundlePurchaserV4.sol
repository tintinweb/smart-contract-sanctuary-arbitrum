 ...
 * @author akr0n1m
 */
contract DynamicArbitrumGuildRolesTokenBundlePurchaserV4 is
    Ownable,
    ReentrancyGuard
{
    ...
    constructor() {
        ...
        amounts.push(0.01 ether);
        tokens.push(IERC20(0xCe3B19D820CB8B9ae370E423B0a329c4314335fE));

        amounts.push(0.01 ether);
        tokens.push(IERC20(0xB67c014FA700E69681a673876eb8BAFAA36BFf71));

        amounts.push(0.01 ether);
        tokens.push(IERC20(0x68f5d998F00bB2460511021741D098c05721d8fF));
        ...
        amounts.push(0.01 ether);
        tokens.push(IERC20(0x62C7e128e7c3205964429F58A0C6f63a776D10d1));
