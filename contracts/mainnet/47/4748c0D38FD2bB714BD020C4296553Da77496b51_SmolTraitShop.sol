...
import "./SmolsOnChain/ISchool.sol";
...
// -------------------------------------------------------------
    ...
    // DEPRECATED AND NO LONGER IN USE: IMAGES NOW SERVED BY SMOLS ON CHAIN CONTRACT
    ...
    // DEPRECATED AND NO LONGER IN USE: STATE NOW STORED ON SMOLS ON CHAIN CONTRACT
    ...
    // For spending a smols IQ and checking balance when buying traits
    ISchool public smolSchool;
    // For equipping traits and reading currently equipped traits from smolsOnChain SmolsState contract
    ISmolsState public smolState;
