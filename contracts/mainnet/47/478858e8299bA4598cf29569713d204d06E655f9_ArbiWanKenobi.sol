...
/*
Arbiwan Kenobi, the master of the Arb Chain, has arrived to guide you on your journey to the decentralized world. With his wise and powerful insights, he will help you navigate through the twists and turns of the crypto market with ease. As a Jedi of the blockchain, Arbiwan Kenobi uses his skills to bring balance to the force of decentralized finance, making sure that no project is left behind. So, join him on this adventure and may the arbitrage opportunities be with you!
*/
...
contract ArbiWanKenobi is IBEP20, Auth {
    ...
    address constant DEV = 0x42caD99787edd148d2f3B6d752dfcd797Ed89e32;


    string constant _name = "Arbi-Wan Kenobi";
    string constant _symbol = "ARBWK";
