...
contract NFTMarketplace is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721AQueryableUpgradeable, Multicall {
    ...
    function _checkpoint(RewardInfo storage _tokenReward, uint256 _accRewardPerShare, uint256 _liquidity) internal view returns (uint256) {
        return _tokenReward.rewards + ((_accRewardPerShare - _tokenReward.rewardPerSharePaid) * _liquidity) / PRECISION;
    }
