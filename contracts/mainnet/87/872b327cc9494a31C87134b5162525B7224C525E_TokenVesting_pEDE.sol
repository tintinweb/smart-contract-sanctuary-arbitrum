...
contract TokenVesting_pEDE is Ownable {
    ...
    uint256 public fixedDuration = 1460 days;
    ...
    //set fixedDuration
    function setFixedDuration(uint256 _fixedDuration) external onlyPolicy {
