...
library Address{
 ...
 contract lindayacc is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200_000_000 * 10**9; //2%
    uint256 public maxSellLimit = 200_000_000 * 10**9; //2%
    uint256 public maxWalletLimit = 400_000_000 * 10**9; //4%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xE0A728AE828e2cF9F42B4C079374DB1FFA9a0857;
    address public buybackWallet = 0xE0A728AE828e2cF9F42B4C079374DB1FFA9a0857;

    string private constant _name = "lindayacc";
    string private constant _symbol = "LINDA";
