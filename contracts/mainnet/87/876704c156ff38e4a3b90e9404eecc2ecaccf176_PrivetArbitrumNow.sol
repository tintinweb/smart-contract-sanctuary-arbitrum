...
contract PrivetArbitrumNow is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("PrivetArbitrumNow", "PAN") {
        _mint(msg.sender, 45659856411 * 10 ** decimals());
    }
