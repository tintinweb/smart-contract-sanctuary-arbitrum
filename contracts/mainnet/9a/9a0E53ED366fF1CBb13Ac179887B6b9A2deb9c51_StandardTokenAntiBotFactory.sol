...
import { IStandardERC20AntiBot } from "../interfaces/IStandardERC20AntiBot.sol";

contract StandardTokenAntiBotFactory is TokenFactoryBase {
    ...
    function create(
        ...
        token = Clones.cloneDeterministic(implementation, keccak256(abi.encodePacked(msg.sender, name, symbol, decimals, totalSupply, enableAntiBot)));
        IStandardERC20AntiBot(token).initialize(
            msg.sender,
            name,
            symbol,
            decimals,
        ...
        emit TokenCreated(msg.sender, token, 6, implementationVersion);
    }
}
 ...
 * 🚀 Unleash the power of decentralized finances and tokenization with DEXTools Token Creator. Customize your token seamlessly. Manage your created tokens conveniently from your user panel - start creating your dream token today!
 */
interface IStandardERC20AntiBot {
    function initialize(
        address owner_,
        string memory name_,
