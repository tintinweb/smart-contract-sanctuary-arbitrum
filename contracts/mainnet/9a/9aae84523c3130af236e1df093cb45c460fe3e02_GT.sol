...
contract GT is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
    ...
    // Airdrop
    mapping(uint256 => bool) public gen1AirdropDone;
    ...
    modifier gen1InitiateAirdropType1(uint256 airdropType) {
        ...
        require(!gen1AirdropDone[airdropType], "Airdrop already done for this type");
        _;
    }
