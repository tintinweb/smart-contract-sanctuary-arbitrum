...
contract Siberia is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Siberia", "Siberia")  {
        rewardToken = 0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9;
        _marketingWalletAddress = 0x43F765D974109d446f9E4B8AeFc1aDf5fD1B2A80;
    ...
    function updateRewardsToken(address _token) public onlyOwner {
        rewardToken = _token;
        dividendTracker = new TokenDividendTracker(_token, 1000 * 10 ** 18);
