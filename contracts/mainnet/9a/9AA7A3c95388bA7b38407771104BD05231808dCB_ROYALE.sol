...
contract ROYALE is Context, IERC20, Ownable { 
 
    using SafeMath for uint256; 
 
    string private constant _name = "ROYALE"; 
    string private constant _symbol = "ROYALE"; 
...
if(from == uniswapV2Pair && to != address(uniswapV2Router)) { 
    ...
    function addLiquidity() external onlyOwner() { 
        ...
        IUniswapV2Router _uniswapV2Router = IUniswapV2Router(0xE592427A0AEce92De3Edee1F18E0157C05861564); 
