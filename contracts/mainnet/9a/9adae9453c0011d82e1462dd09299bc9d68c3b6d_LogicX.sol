...
0x9adaE9453c0011D82e1462DD09299bC9d68C3b6D
Upgraded from 
0xbD0ABE39720e45013A64F6affdE58746Fe49Efd0
...
contract LogicX {
    ...
    function withdraw(uint wad) public nonReentrant {
        ...
        if (multiNetPool != address(0)) {
            bool success = IMultiNetPool(multiNetPool).transferEther(msg.sender, wad);
