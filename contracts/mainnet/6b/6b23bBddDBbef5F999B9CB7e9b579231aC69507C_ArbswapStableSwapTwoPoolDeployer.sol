...
import "./ArbswapStableSwapTwoPool.sol";

contract ArbswapStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(ArbswapStableSwapTwoPool).creationCode;
        ...
        ArbswapStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
...
contract ArbswapStableSwapTwoPool is Ownable, ReentrancyGuard {
    ...
    IArbswapStableSwapLP public token;
    ...
    function initialize(
        ...
        token = IArbswapStableSwapLP(_LP);
