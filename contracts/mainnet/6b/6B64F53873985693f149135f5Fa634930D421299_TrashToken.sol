...
contract TrashToken is ERC20Capped, ERC20Burnable, Ownable {

    // Define the supply of FunToken: 1,000,000 
    uint256 constant initialSupply1 = 6000000000 * (10**18);
    uint256 constant totalSupply1 = 100000000000 * (10**18);

    // Constructor will be called on contract creation
    constructor(
	 address owner1
	) ERC20("Trash", "TRASH") ERC20Capped(totalSupply1) Ownable(owner1) {
        _mint(owner(), initialSupply1);
    }
