...
contract OracleRouter is Ownable, IOracleRouter {
    ...
    function getAssetPrice(address asset) public view override returns (uint256) {
        ...
        if (!success) {
            ...
            // TODO: Not sure if we should revert here
            if (!feed.isSet) {
    ...
    function _getChainlinkPrice(PriceFeedData memory feed) internal view returns (bool, uint256) {
        ...
        // TODO: !Think about checking CL sequencer - Separate Issue in Linear!
        // TODO: Pyth push price update. Check Push price gas price
