...
//  ____  _            _                   _    ____ _______ _____ ____  
// |  _ \| |          | |                 | |  |  _ \__   __/ ____|  _ \ 
// | |_) | | ___   ___| | ___ __ ___   ___| | _| |_) | | | | |    | |_) |
// |  _ <| |/ _ \ / __| |/ / '__/ _ \ / __| |/ /  _ <  | | | |    |  _ < 
// | |_) | | (_) | (__|   <| | | (_) | (__|   <| |_) | | | | |____| |_) |
// |____/|_|\___/ \___|_|\_\_|  \___/ \___|_|\_\____/  |_|  \_____|____/ 
...
// https://x.com/BlockrockBTCB
// https://www.blockrock.finance
...
contract BlockrockBTCB is ReentrancyGuard, Pausable, Ownable, IERC20 {
  ...
  uint256 treasurySupply = maxSupply * 40 / 100;
  uint256 liquiditySupply = maxSupply * 40 / 100;
  uint256 teamSupply = maxSupply * 5 / 100;
