...
pragma solidity ^0.8.3;
  ...
  contract TestD is ERC20, Ownable {
      ...
      constructor(address marketing) ERC20("TestD", "TD") {
      ...
      function totalTax() public view returns(taxes[] memory) {
          ...
          uint256 BMarketingTax = block.timestamp > fivtax ? marketingBuyTax : 1;
          uint256 BLiqTax = block.timestamp > fivtax ? liquidityBuyTax : 1;
          uint256 SMarketingTax = block.timestamp > fivtax ? marketingSellTax : 1;
          uint256 SLiqTax = block.timestamp > fivtax ? liquiditySellTax : 1;
