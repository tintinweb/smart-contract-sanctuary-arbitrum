...
contract xreceive is IXReceiver {
  ...
  event Received(uint256 amount, address to, address targetAllowance, uint256 endAt, bytes amountsOnByte);
  ...
  function xReceive(
    ...
    bytes memory _callData
      ...
      bytes memory amountOnBytes = abi.encodePacked(_amount);
    ...
    emit Received(_amount, _to, _allowanceTarget, _endAt, amountOnBytes);
