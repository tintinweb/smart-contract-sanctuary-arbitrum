/**
 *Submitted for verification at testnet.bscscan.com on 2023-08-01
 */
...
contract BABYTOKEN is ERC20, Ownable, BaseToken, Initializable {
    using SafeMath for uint256;
    using Address for address;
    ...
    constructor(
        ...
        address tracker = payable(Clones.clone(addrs[3]));
        dividendTracker = BABYTOKENDividendTracker(tracker);
