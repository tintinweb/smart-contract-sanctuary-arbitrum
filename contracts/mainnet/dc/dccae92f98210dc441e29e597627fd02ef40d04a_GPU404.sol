...
// https://t.me/xGPU404_portal
// Note: Avoid buying first 45 minutes due to high gas to avoid bots
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x0FC0c323Cf76E188654D63D62e668caBeC7a525b); //LMR
    ...
    constructor (address _router, address _RWRD) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //Sushi
        _token = msg.sender;
        RWRD = IBEP20(_RWRD);  // Initialize RWRD with the provided address
    }

    function setRWRDAddress(address newRWRD) external onlyToken {
        RWRD = IBEP20(newRWRD);
    }
...
contract GPU404 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1; //WETH
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC0edaeC07D037004bD90bC7a375cf6E936AEDcde;

    string constant _name = "GPU404";
    string constant _symbol = "GPU404 ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**4 * 10**_decimals; //10000 mx 
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(address(router), address(0x0FC0c323Cf76E188654D63D62e668caBeC7a525b)); //LMR
