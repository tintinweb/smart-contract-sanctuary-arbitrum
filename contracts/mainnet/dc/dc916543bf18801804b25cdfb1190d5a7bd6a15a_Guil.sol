...
contract Guil is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256 _totalSupply = 100_000_000_000_000_0 * 1e6;
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'Guil: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "Guil: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "Guil: index out of bounds");
