...
contract GoodEntryVaultUniV3 is IGoodEntryVault, UniswapV3Position, GoodEntryVaultBase {
  ...
  /// @notice Get Amm type 
  function ammType() public pure override(UniswapV3Position, IGoodEntryVault, GoodEntryVaultBase) returns (bytes32 _ammType){
