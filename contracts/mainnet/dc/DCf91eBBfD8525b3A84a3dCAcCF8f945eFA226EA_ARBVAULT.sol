...
/**
Welcome to Arb Vault!

An unique reward token on Arbitrum, developing the first Arbitrum reward tracker dashboard. Arb Vault revolutionizes crypto by combining staking and DeFi. It eliminates third-party custodians and creates an open market for lending, borrowing, and trading. True holders will receive $ARB tokens just by holding! 

6/6 tax
2% $ARB rewards
4% marketing and development

Telegram: https://t.me/arbvault
Website: https://arbvault.online/
...
// main contract
contract ARBVAULT is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "ARBVAULT";
    ...
    uint256 _marketingBuyFee = 17_00;

    uint256 _reflectionSellFee = 2_00;
    uint256 _liquiditySellFee = 3_00;
    uint256 _marketingSellFee = 35_00;

    uint256 _reflectionFeeCount;
    uint256 _liquidityFeeCount;
    uint256 _marketingFeeCount;

    uint256 public totalBuyFee = 20_00;
    uint256 public totalSellFee = 40_00;
    ...
    uint256 public snipingTime = 10 seconds;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0x0242Eb4d96D071C0a91DeEF24Fb429E84D148d47;
    ...
    function setBuyFees(
        ...
        require(
            totalBuyFee <= feeDenominator.mul(100).div(100),
    ...
    function setSellFees(
        ...
        feeDenominator = _feeDenominator;
        require(
            totalSellFee <= feeDenominator.mul(100).div(100),
            "Can't be greater than 15%"
        );
    }
