...
/**
*/
//PetherPan is the first Token on Arbitrum that rewards holder with USDTether rewards!!
//Join Our community Tg: https://t.me/petherpanarb
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9);
    ...
    function deposit() external payable override onlyToken {
        ...
        path[0] = WETH;
        path[1] = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
        path[2] = address(EP);
...
contract PetherPan is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9; // EP
    address public WETH = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PetherPan";
    string constant _symbol = "Pether";
    ...
    address public autoLiquidityReceiver=0x368EB6266528a79996612b0536908F4F53F79586;
    address public marketingFeeReceiver=0x368EB6266528a79996612b0536908F4F53F79586;
