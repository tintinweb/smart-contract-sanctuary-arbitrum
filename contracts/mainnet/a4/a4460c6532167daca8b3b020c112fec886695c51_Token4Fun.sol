...
contract Token4Fun is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _MAXAMOUNT, uint256 SELLMAXAMOUNT, address tokenOwner)  {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
        ...
        //ICamelotRouter _camelotRouter = ICamelotRouter(routerAddress);
        // Create a uniswap pair for this new token
        //camelotPair = ICamelotFactory(_camelotRouter.factory()).createPair(address(this), _camelotRouter.WETH());
    ...
    function setRouterAddress(address newRouter) external onlyOwner {
        ICamelotRouter _camelotRouter = ICamelotRouter(newRouter);
        camelotPair = ICamelotFactory(_camelotRouter.factory()).createPair(address(this), _camelotRouter.WETH());
        camelotRouter = _camelotRouter;
    }
}