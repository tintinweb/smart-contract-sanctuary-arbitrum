...
// File: contracts/token/ePornhub.sol
...
contract ePornHub is ERC20, Ownable {
    ...
    uint256 private backFee = 100;

    uint256 private lpFee = 200;
    ...
    constructor(
        ...
        uint256 _totalSupply = 69_000_000 * 1e18;
    ...
    function swapBack() internal swapping {
        ...
        uint256 backTokenTotalFee = totalFee - burnFee - lpFee;
        uint256 amountBackTokenGov1 = (amountBackToken * backFee) / (backTokenTotalFee);
        uint256 amountBackTokenGov2 = amountBackToken - amountBackTokenGov1;

        backToken.transfer(backWallet, amountBackTokenGov1);
        backToken.transfer(govWallet, amountBackTokenGov2);
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, "ePornhub: ETH_TRANSFER_FAILED");
    }
    ...
    function setReceivers(address _govWallet, address _backWallet) external onlyOwner {
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "ePornhub: pair is the zero address");
