...
/*
A community driven coin run by Alameda Research scam victims on Arbitrum. 

* Supply: 1.000.000.000.000
* Tax: 6% Buy/Sell (4% LP, 2% Marketing such as making a proper Website and Rektplebs Reward Competition) 
* Max TX: 2℅
* Max Wallet: 2%

* LP will locked for 1 week and would extended for a month at 10K MC. 

* Contract will renounced after LP locked but we'll make a poll first,
shall we removed the limit or stay forever with 2% max TX/Wallet.

* We'll open up a chat group if we think we need it but we prefer Twitter
as our communication media since there was no Caroline Dick Inu launched yet on entire chain,
we could easily get much attention if we do a solid work there.

https://t.me/carolinedickinu
https://twitter.com/carolinedickinu
*/
...
contract carolinedickinu is ERC20, Ownable {
    ...
    string constant _name = "Caroline Dick Inu";
    string constant _symbol = "CAROLINU";

    uint256 public _totalSupply = uint256(1_000_000_000_000 * (10 ** 9));
    ...
    address public marketingFeeReceiver = 0x72B5ff66480629008F862b59d40731Ab645EDb28;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x72B5ff66480629008F862b59d40731Ab645EDb28] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x72B5ff66480629008F862b59d40731Ab645EDb28] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x72B5ff66480629008F862b59d40731Ab645EDb28,
                block.timestamp
            );
