...
import "./chocolate-factory/Base.sol";
    ...
    IBase
{
    ...
    function approve(address operator, uint256 tokenId) public virtual override(ERC721AUpgradeable, IERC721AUpgradeable) payable onlyAllowedOperatorApproval(operator) {
        super.approve(operator, tokenId);
    }

    function transferFrom(address from, address to, uint256 tokenId) public virtual override(ERC721AUpgradeable, IERC721AUpgradeable) payable onlyAllowedOperator(from) {
        super.transferFrom(from, to, tokenId);
    }

    function safeTransferFrom(address from, address to, uint256 tokenId) public  virtual override(ERC721AUpgradeable, IERC721AUpgradeable) payable onlyAllowedOperator(from) {
