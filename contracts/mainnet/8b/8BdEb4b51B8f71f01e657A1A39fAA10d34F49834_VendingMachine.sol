...
contract VendingMachine is ERC721, Ownable {
    ...
    constructor(string memory _newBottles, address[] memory paymentOptionAddresses, uint256[] memory paymentOptionPrices, address _vendingMachineOwner, uint256 _stickChance) ERC721("Metaverse Water", "MW") {
