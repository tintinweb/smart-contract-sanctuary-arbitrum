...
contract EXSRewardPool {
    ...
    uint256 public tSharePerSecond = 0.02700617283 ether;
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "EXSRewardPool: caller is not the operator");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].token != _token, "EXSRewardPool: existing pool?");
        }
    }
