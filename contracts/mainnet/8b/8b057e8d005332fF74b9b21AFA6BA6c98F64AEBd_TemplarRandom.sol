...
// File: contracts/EXORRequestIDBase.sol
...
// File: contracts/EXORConsumerBase.sol
...
contract TemplarRandom is EXORConsumerBase, Owned {
    ...
    // testNet
    constructor(address templar_) public EXORConsumerBase(0xfA4E20aBB91c049b518847b8239866c095280785, 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8, 0x3E11d9F9679357125A6a4e85F4e1c0DEEb5486Bf){
        templar = templar_;
 
        // changeDataSource(0xA275CfbD3549D80AE9e2Fed25B97EEA84A45e93E,true);
        // changeDataSource(0x75bf996d1348773144E8BFe674243192BFe48B83,true);
    }


    // mainNet
    // constructor(address templar_)public EXORConsumerBase(0x236C3d00918dE2Db04aa7665721d2bC696b6A459, 0x8F8526dbfd6E38E3D8307702cA8469Bae6C56C15, 0x21407CE76B98955F1155f8a92eC2B1adaa0CC993){
    //     templar = templar_;

    //     changeDataSource(0xE8f5c57a5a2C0b3706F4a895E2018BEa38a47A1f,true);
    //     changeDataSource(0xe31f0B7272E2EF4161d5a0f76040Fc464be55E4c,true);
    //     changeDataSource(0xa6c3aD36705E007D183177e091d44643D04a74E8,true);
    // }
    ...
    function openRand(uint256 tokenId) external view returns(bool usable,uint256 rand){
        
        Result memory res = results[tokenId];

        if (!res.usable && block.timestamp - res.reqAt > 10 minutes){
            return (results[lastId].usable,results[lastId].rand%100); 
        }else {
            return (res.usable,res.rand%100);
        }
    }
    function fightRand(uint256 tokenId,uint256 energy) external view returns(bool usable,uint256 rand){
        ...
        uint256 r2 = results[index].rand%100;
        return (true,r2);
    }
    ...
    function changeDataSource(address _datasource, bool _boolean) public onlyOwner {
    ...
    function withdraw() external onlyOwner {
        uint b = IERC20(feeToken).balanceOf(address(this));
