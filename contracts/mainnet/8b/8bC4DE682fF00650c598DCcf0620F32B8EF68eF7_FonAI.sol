...
Telegram Group:  https://t.me/FonAI_ARB
Twitter: https://twitter.com/FonAI_ARB
Website: https://fonai.app
Discord: https://discord.gg/SmTVCyHRsX
...
contract FonAI is ERC20, Ownable {
    ...
    string constant _name = "FonAI 0xCa848be669070A6a429a400EdF2Af8B95008951c";
    ...
    address public marketingFeeReceiver = 0x6C7975A6002Bb484D43Aa873E17E7AAD49ADE5c1;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x6C7975A6002Bb484D43Aa873E17E7AAD49ADE5c1] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x6C7975A6002Bb484D43Aa873E17E7AAD49ADE5c1] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x6C7975A6002Bb484D43Aa873E17E7AAD49ADE5c1,
                block.timestamp
            );
