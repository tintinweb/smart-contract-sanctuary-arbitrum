...
//import "@openzeppelin/contracts/security/ReentrancyGuard.sol"; // removed ReentrancyGuard after Ownable and nonReentrant from withdraw
import "@chainlink/contracts/src/v0.8/interfaces/VRFCoordinatorV2Interface.sol";
import "@chainlink/contracts/src/v0.8/VRFConsumerBaseV2.sol";

// Contract that mints 200 Rogue Pit Boss NFT node licenses. Immutable code not a proxy
// First 104 NFTs minted will be minted at zero cost to replace 104 DHRC NFTs
// tokenId 105 - 200 will be minted at currentPrice which starts at 2.38 ETH and rises by 0.01 ETH per day until all are minted
// If tokenId is 1 - 104 then mint NFT with same rarity traits of corresponding tokenId of DHRC NFT
// If tokenId > 104 then mint NFT using Chainlink VRF to generate random number that determines rarity
...
contract RoguePitBoss is ERC721Royalty, VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    // NFT mint variables
    uint256 startDate = 1714071600; // 4/25/24 19.00 pm GMT, must be in past
