...
contract Arbrickrum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Arbrickrum";

    string private _symbol = "aBRICK";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xA5979662e454Def4b53e98530203BCB30A32eD88;
