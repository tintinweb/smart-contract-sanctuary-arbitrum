...
contract SwitchSymbiosis is Switch {
...
contract Switch is Ownable, SwitchRoot, ReentrancyGuard {
        ...
        )
    {
        ...
        _callAggregator(fromToken, amount, aggregatorInfo);
        ...
        internal
    {
        ...
        if (token.isETH()) {
            ...
            token.universalApprove(fullSwapData.spender, amount);
        }

        (bool success,) = fullSwapData.swapContract.call{ value: ethAmountToTransfert }(fullSwapData.swapData);
