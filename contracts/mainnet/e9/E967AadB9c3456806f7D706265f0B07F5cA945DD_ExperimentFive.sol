...
contract ExperimentFive is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "ExperimentFive";
    string constant _symbol = "EXFIV";
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingWallet = 0x0A086d70dea9eB7aFE2Ec930d218ee5c86Ce68c4;

        totalFee = (
            liquidityFee.add(marketingFee).add(rewardsFee)
        );
