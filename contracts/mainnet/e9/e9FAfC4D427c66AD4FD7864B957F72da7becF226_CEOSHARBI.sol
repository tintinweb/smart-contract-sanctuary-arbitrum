...
Telegram: https://t.me/CEOSHARBIARB
Tax: 5/10%
Max: 3% (30000000000)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public Sharbi =
        IERC20Extended(0xaa54e84A3e6e5A80288d2C2f8e36eA5cA3A3Ca30);
...
// main contract
contract CEOSHARBI is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "CEO SHARBI";
    string private constant _symbol = "$CSHARBI";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * 10**_decimals;

    address public Sharbi = 0xaa54e84A3e6e5A80288d2C2f8e36eA5cA3A3Ca30;
    ...
    uint256 _marketingSellFee = 7_00;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0x9e6005E35834b5092D2069906cE13255140F3C09;
