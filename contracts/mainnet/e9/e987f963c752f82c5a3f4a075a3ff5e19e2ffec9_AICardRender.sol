...
telegram : https://t.me/aicardrender
Website : https://cardrender.ai/
Dapp : https://dapp.cardrender.ai/
...
contract AICardRender is ERC20, Ownable {
  using SafeMath for uint256;
  address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
  address DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "Ai Card Render";
  string constant _symbol = "ACR";
  ...
  address public marketingFeeReceiver =
    0x8c852E0f21161Cb6CF838101d4DC771aA2D4d730;
  ...
  constructor() Ownable(msg.sender) {
    ...
    isFeeExempt[0x8c852E0f21161Cb6CF838101d4DC771aA2D4d730] = true;
    isTxLimitExempt[address(router)] = true;
    isTxLimitExempt[_owner] = true;
    isTxLimitExempt[0x8c852E0f21161Cb6CF838101d4DC771aA2D4d730] = true;
