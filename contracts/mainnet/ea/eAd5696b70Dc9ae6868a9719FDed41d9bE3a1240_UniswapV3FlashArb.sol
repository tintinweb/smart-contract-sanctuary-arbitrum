...
contract UniswapV3FlashSwap {
    ...
    function flashSwap(
        ...
        (ISwapRouter02 router) = abi.decode(_data, (ISwapRouter02));

        bytes memory data = abi.encode(
            router, msg.sender, pool0, fee1, tokenIn, tokenOut, amountIn, zeroForOne
        );
    ...
    function uniswapV3SwapCallback(
        ...
        (
            ...
            data, (ISwapRouter02, address, address, uint24, address, address, uint256, bool)
        );
