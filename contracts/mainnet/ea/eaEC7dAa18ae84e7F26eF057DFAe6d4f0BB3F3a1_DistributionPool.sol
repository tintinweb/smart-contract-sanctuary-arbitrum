...
contract DistributionPool is OwnableUpgradeable {
    ...
    uint256 public constant MAX_ADDRESSES = 110000;
    uint256 public constant MAX_TOKEN = 294_000_000_000_000_000 * 1e6;
    uint256 public constant INIT_CLAIM = 10_100_000_000_000 * 1e6;
    ...
    event Claim(address indexed user, string nonce, uint256 amount, address referrer, uint timestamp);
    ...
    function claim(string memory nonce, bytes calldata signature, address referrer) public claimIsLive {
        ...
        bytes32 msgEthHash = ECDSA.toEthSignedMessageHash(message);
        _signers.requireValidSignature(msgEthHash, signature);
