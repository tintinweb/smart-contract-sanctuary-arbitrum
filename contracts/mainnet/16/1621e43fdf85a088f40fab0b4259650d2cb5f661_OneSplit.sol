...
contract OneSplit is Initializable, IOneSplit, OneSplitRoot, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function swap(
        ...
        _flags[0] = flags;
        emit Swap("swap", path, amount, msg.sender, msg.sender, returnAmount, _flags);
    }
    ...
    function swapWithRecipient(
        ...
        emit Swap("swapWithRecipient", path, amount, msg.sender, recipient, returnAmount, _flags);
    }
    ...
    function swapMulti(
        ...
        emit Swap("swapMulti", tokens, amount, msg.sender, msg.sender, returnAmount, flags);
    }
    ...
    function swapMultiWithRecipient(
        ...
        emit Swap("swapMultiWithRecipient", tokens, amount, msg.sender, recipient, returnAmount, flags);
    }
