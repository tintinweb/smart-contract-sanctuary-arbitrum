...
// SPDX-License-Identifier: MIT 
  ...
  contract FOMO_Card is ERC721A, Ownable, ERC2981 {
      ...
      uint256 public twoDollarsEth; // two dollars in eth at time of deployment
      ...
      function batchMint(
          ...
          if ((presaleActive[mintId]) && (mintId != 0)) {
            require(
              ...
              require(
                  msg.value >=
                      (((mintPrice[mintId] * 51) / 50 + twoDollarsEth) * amount),
                  "Not enough Ether sent for requested amount"
              );
  
              uint256 totalCost = (mintPrice[mintId] * amount);
              uint256 feeAmount = (mintPrice[mintId] / 50 + twoDollarsEth) *
