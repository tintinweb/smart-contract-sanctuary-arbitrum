...
// File contracts/Games/PredictionsMarket/interfaces/TreasuryInterface.sol
...
// File contracts/Games/PredictionsMarket/PredictionMarketV1.sol

pragma solidity ^0.8.0;
/**
 * @title PredictionMarketV1
 */
contract PredictionMarketV1 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant ALLOWANCE_NUM = 1e28;
    ...
    function _calculateRewards(uint256 epoch) internal {
        ...
        if (treasuryAmt != 0) {
            IERC20(address(token)).approve(treasuryAddress, treasuryAmt);
            TreasuryInterface(treasuryAddress).deposit(address(this), address(token), treasuryAmt);
        }
