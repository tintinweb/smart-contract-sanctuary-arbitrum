...
contract MarketLens {
    ...
    function getUserMaxBorrowForCauldronV2(ICauldronV2 cauldron) public view returns (uint256) {
        return getMimInBentoBox(cauldron);
    }

    function getUserBorrowLimitForCauldronV3(ICauldronV3 cauldron) private view returns (uint256) {
    ...
    function getMarketMaxBorrowForCauldronV3(ICauldronV3 cauldron) public view returns (uint256) {
    ...
    function getUserMaxBorrowForCauldronV3(ICauldronV3 cauldron) public view returns (uint256) {
        uint256 mimInBentoBox = getMimInBentoBox(cauldron);
        uint256 userBorrowLimit = getUserBorrowLimitForCauldronV3(cauldron);
    ...
    function getMarketInfoCauldronV2(ICauldronV2 cauldron) public view returns (MarketInfo memory) {
        return
            MarketInfo({
                ...
                userMaxBorrow: getUserMaxBorrowForCauldronV2(cauldron),
    ...
    function getMarketInfoCauldronV3(ICauldronV3 cauldron) public view returns (MarketInfo memory marketInfo) {
        ...
        marketInfo.marketMaxBorrow = getMarketMaxBorrowForCauldronV3(cauldron);
        marketInfo.userMaxBorrow = getUserMaxBorrowForCauldronV3(cauldron);
    }
}
...
library CauldronLib {
    ...
    function getUserCollateral(ICauldronV2 cauldron, address account) public view returns (uint256 amount, uint256 value) {
        IBentoBoxV1 bentoBox = IBentoBoxV1(cauldron.bentoBox());
