...
contract FLORBI is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"FLORBI", "$FLORBI") {
        ...
        operationsAddress = address(0xBA42DE3D958191eeBd736225Fd432d0E02A13b57);
        devAddress = address(0xBA42DE3D958191eeBd736225Fd432d0E02A13b57);
