...
/**
 * @title PendleEzEth
 * @dev Contract implementing a Pendle strategy for EzETH pool.
 */
contract PendleEzEth is Initializable, PendleGeneralEzEth, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    /**
     * @notice Initializes the Pendle strategy contract.
     * @param _info PendleGeneralInfo struct containing strategy information.
     * @param mainAdmin Address of the main admin for the contract.
