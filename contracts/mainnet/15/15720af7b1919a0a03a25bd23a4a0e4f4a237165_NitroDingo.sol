...
contract NitroDingo is ERC20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "NitroDingo";
    string constant _symbol = "DINGO";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 100000000 * (10 ** _decimals); 
    
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100;
    uint256 public _maxTxSize = (_totalSupply * 30) / 100;
    ...
    address public pair;
    address public Liq = 0xec72e4cedFB5CEdBfA773567ABe3cC0479Fe2037;
    address public dist;
