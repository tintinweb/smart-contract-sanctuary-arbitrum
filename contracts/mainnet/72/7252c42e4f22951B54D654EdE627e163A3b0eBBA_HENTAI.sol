...
/**
    HENT.AI 
    ALL YOUR WAIFUS ON ARBITRUM

    Enjoy hentai like never before. 
    Interact with your favorite anime characters and make your desires come through. 
    Hent.ai is aiming to be the biggest hentai platform powered by artificial intelligence. 
...
interface IUniswapV2Router02 {
    ...
    uint256 private constant _tTotal = 6900000000 * 10**18;
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0xfD98f30EaF06a4B0f06cD0fb32b00c4f5d071C67); 
        _feeAddrWallet2 = payable(0xfD98f30EaF06a4B0f06cD0fb32b00c4f5d071C67); 
        ...
        emit Transfer(address(0x5F799f365Fa8A2B60ac0429C48B153cA5a6f0Cf8), _msgSender(), _tTotal); 
    }
