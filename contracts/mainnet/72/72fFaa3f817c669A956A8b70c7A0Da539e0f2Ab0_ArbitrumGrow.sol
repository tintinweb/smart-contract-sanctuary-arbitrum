...
/*
Building a digital user experience in the new features about Aggregator

$ArbitrumGrow

A native currency
for the $ArbitrumGrow Ecosystem

Our team and future partnerships (to be announced) align highly specialized experts and representatives positioned strategically from some of the biggest Aggregator projgects today. We know we are well positioned to collaborate with major companies from any sector.
This provides businesses with a secure, decentralized payment system that eliminates the need for traditional banking institutions. Users can purchase brain Arbitrum tokens through various cryptocurrency exchanges and use them to access premium features on the platform.

https://t.me/Arbitrum_Grow
*/
...
contract ArbitrumGrow is Ownable, IBEP20 {
    ...
    string constant _name = "ARBITRUM GROW";
    string constant _symbol = "ARBGRW";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x6eb7F2f3dc5b3EEe203aDB949582f39C9947Dd0D;
        marketingWallet = 0x6eb7F2f3dc5b3EEe203aDB949582f39C9947Dd0D;
