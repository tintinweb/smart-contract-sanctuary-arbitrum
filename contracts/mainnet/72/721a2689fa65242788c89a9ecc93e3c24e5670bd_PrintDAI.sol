...
/**
PrintDAI is a meme coin which rewards Dai Stable Coin on the Arbitrum network.

Check out our socials for news and updates involving the project:
https://medium.com/@PRINTDAI
https://t.me/PrintDAI
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      // Mainnet DAI Token Rewards

      rewardTokens.push(address(0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1)); 
...
contract PrintDAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public routerCA = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    ...
    constructor() ERC20("Print DAI ", "pDAI") {

        uint256 totalSupply = 10_000_000 * 1e18;
        
        maxTransactionAmount = 400_000 * 1e18; // 4% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = 400_000 * 1e18; // 4% Max wallet
    	...
    	operationsWallet = address(0xFB25f33365E8C2Cc748B8ac0C5c9C88983FBf9c1);
