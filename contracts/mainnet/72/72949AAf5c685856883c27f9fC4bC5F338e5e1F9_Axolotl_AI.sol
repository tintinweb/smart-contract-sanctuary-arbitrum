...
contract Axolotl_AI is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        try swapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(amountAxoReflection,0,path2,address(this),address(0),block.timestamp){
            success = true;
        } catch {
    ...
    function distributeTokens() public onlyOwner {
        ...
        _mint(liqWallet,  (_targettotalSupply * 30) / 100); //Presale 30%, also goes into LP to create Pinksale pool (Has to be in one wallet)
        ...
        _mint(ownerWallet,  (_targettotalSupply * 9) / 100); // Unlocked 9%
