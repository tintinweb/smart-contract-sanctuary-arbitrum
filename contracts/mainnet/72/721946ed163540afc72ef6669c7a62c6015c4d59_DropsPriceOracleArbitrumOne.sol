...
contract DropsPriceOracleArbitrumOne is Admin, Initializable, IDropsPriceOracle {
  ...
  IUniswapV3Quoter constant UniV3Quoter = IUniswapV3Quoter(0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6);
  IUniswapV3Pair constant UniV2UsdcPool = IUniswapV3Pair(0xC31E54c7a869B9FcBEcc14363CF510d1c41fa443);
  IUniswapV3Pair constant UniV2UsdtPool = IUniswapV3Pair(0x641C00A822e8b671738d32a431a4Fb6074E5c79d);
  ...
  function _getUniUSDC(uint256 usdAmount) internal view returns (uint256 weiAmount) {
    bytes memory payload = abi.encodeWithSelector(
      UniV3Quoter.quoteExactInputSingle.selector,
      WETH,
      USDC,
      500,
      usdAmount,
    ...
    assembly {
      ...
      let result := staticcall(gas(), 0xb27308f9F90D607463bb33eA1BeBb41C27CE5AB6, add(payload, 0x20), mload(payload), ptr, 0x20)
      switch result
      case 0 {
        revert(0, returndatasize())
      }
      default {
        returndatacopy(weiAmount, ptr, 0x20)
      }
    }
  }
