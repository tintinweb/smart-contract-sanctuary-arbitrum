...
contract AICardRenderToken is ERC20, Ownable {
    ...
    address public excludedFromTax;

    
    uint256 public fightingBotActive = 40000000 * 1e18;
    uint256 public minSwapAmount = 500000 * 1e18;
    ...
    function _transfer(
        ...
        uint256 transferTaxRate = (recipient == uniswapV2Pair && sender != excludedFromTax)
        ? sellTaxRate
        ...
        if (transferTaxRate > 0 && sender != address(this) && recipient != address(this)) {
            uint256 _tax = amount.mul(transferTaxRate).div(100);
    ...
    function swapTokensForETH(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETH(tokenAmount, 0, path, marketingWallet, block.timestamp);
    }

    function setexcludedFromTax(address _excludedFromTax) public onlyOwner {
        excludedFromTax = _excludedFromTax;
    }

    function changeMarketingWallet(address _marketingWallet) external onlyMarketingWallet {
