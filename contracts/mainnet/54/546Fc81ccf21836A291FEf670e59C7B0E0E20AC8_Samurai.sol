...
/*
An ecosystem in Arbitrum Blockchain with a main target to revolution the way various people engage with digital assets’•
This will be the only token capable of bringing taste to the holders, by making the aim of team going 100x with the token •
Utilities and marketing will be developed by team and ensuring random rewards for holders’•
...
•Max - 5%
•Safe Team 
•Locking and renouncing

Telegram - https://t.me/samuraiarb
Twitter - https://www.twitter.com/samuraiarb
*/
...
contract Samurai is IBEP20, Auth {
    ...
    address constant DEV = 0xc88ed493c6C6ead7D70AE751E3910f019AF70381;


    string constant _name = "SAMURAI";
    string constant _symbol = "$SAMARB";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 1000000000 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 1000;
