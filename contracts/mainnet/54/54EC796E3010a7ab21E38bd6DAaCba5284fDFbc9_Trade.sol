...
// @address:REGISTRY
IRegistry constant registry = IRegistry(0x517259aFb352120B6B899326cbcB74312f468bCd);
...
contract Trade is ITrade, TradeStorage, ReentrancyGuardUpgradeable {
    ...
    function setFundId(uint256 fundId) external {
        require(registry.feeder().getFund(fundId).trade == address(this), "QHT/WID"); // wrong fund id
        _fundId = fundId;
    }
