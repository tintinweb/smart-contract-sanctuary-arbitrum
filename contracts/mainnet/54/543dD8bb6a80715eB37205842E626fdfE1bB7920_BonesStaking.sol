...
abstract contract ContractControl is AccessControlUpgradeable {
    ...
    modifier onlyOwner() {
        require(
            isOwner(_msgSender()),
            "MinterControl: not a SMOLNEANDER_OWNER_ROLE"
        );
        _;
    }
    ...
    modifier onlyStakingContract() {
        require(
            isStakingContract(_msgSender()),
            "MinterControl: not a SMOLNEANDER_CONTRACT_ROLE"
        );
        _;
    }
    ...
    modifier onlyMinter() {
        require(
            isMinter(_msgSender()),
            "MinterControl: not a SMOLNEANDER_MINTER_ROLE"
        );
        _;
    }
    ...
    modifier onlyAdmin() {
        require(
            isAdmin(_msgSender()),
            "MinterControl: not a SMOLNEANDER_ADMIN_ROLE"
        );
        _;
    }
