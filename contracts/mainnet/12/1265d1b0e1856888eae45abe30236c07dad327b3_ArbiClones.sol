...
contract ArbiClones is Ownable, ERC721A, ERC721APausable {
    ...
    uint public mintFee = 2e16;
    uint public maxPerTransaction = 1000;
    uint256 public maxPerWallet = 1000;
    uint256 public maxFree = 0;
    mapping (address => uint256 ) public minted;

    // =========== Start Smart Contract Setup ==============
    address payable public fundsWallet = payable(0x1B6C0F4b9353e8e199Ed4ed4281c4531D0D14B34);
    address payable public admin = payable(0x6C79c92168aD985A1399c9D2974e7378F9451048);
