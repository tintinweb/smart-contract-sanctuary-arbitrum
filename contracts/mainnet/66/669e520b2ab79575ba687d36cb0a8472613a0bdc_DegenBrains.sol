...
contract DegenBrains is ERC721Enumerable, Ownable {
    string public baseURI;
    string public baseExtension  = ".json";
    string public _name = "DegenBrains";
    string public _symbol = "DGNB";
    ...
    modifier onlyGateway() {
        require(isGateway(_msgSender()), "not auth");
        _;
    }
    ...
    function revokeGateway(address _gateway) public onlyOwner {
        gateways[_gateway] = false;
    }

    function isGateway(address _gateway) public view returns (bool) {
        return gateways[_gateway];
    }
    ...
    function mint(address account, uint256 tokenId) public onlyGateway {
        addressMintedBalance[account]++;
        _mint(account, tokenId);
    }

    function burn(uint256 tokenId) public onlyGateway {
        _burn(tokenId);
    }
