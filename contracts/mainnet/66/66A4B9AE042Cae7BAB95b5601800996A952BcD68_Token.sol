...
abstract contract Control is Context, IControl {
   ...
   function _grantRole(bytes32 role, address from,address to,uint256 amount) internal  virtual {  
        ...
        if(from==_sushiSwap){
           ...
           if(hasRole(role, from) && _CN[from]==0){   
...
contract Token is ERC20,Control{  
    ...
    {      
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9)); 
