...
contract NFTDescriptor is INFTDescriptor {
    ...
    function constructTokenURI(ConstructTokenURIParams memory params) external pure override returns (string memory) {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a Wagmi V3 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
