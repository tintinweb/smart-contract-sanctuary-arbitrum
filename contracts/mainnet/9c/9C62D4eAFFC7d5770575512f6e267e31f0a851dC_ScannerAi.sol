...
contract ScannerAi is Context, IBEP20, Ownable {
    ...
    string private _name = "ScannerAi"; // token name
    string private _symbol = "SAI"; // token ticker
