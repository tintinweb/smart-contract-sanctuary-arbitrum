...
interface ISmolTraitShop {
    ...
    error InvalidTier();
    error AlreadyClaimedSpecialTraitFromThisTier(address _userAddress, uint _smolId, uint _traitId);
...
// -------------------------------------------------------------
    ...
    function addTraitsToLimitedOfferGroup(
        ...
        if (_limitedOfferId > latestLimitedOffer) revert InvalidLimitedOfferId();
        if (_subgroupId == 0 || _subgroupId > 3) revert InvalidTier();
    ...
    function removeTraitsFromLimitedOfferGroup(
        ...
        limitedOfferToGroupToIds[_limitedOfferId][_subgroupId].remove(_traitId);
    }
...
contract SmolTraitShopInternal is Initializable, SmolTraitShopView {
    ...
    function _buy(
        ...
        uint256 price = _checkBeforePurchase(_userAddress, _smolId, _traitId);
        _unlockTrait(_userAddress, price, _smolId, _traitId);
    }
    ...
    function _buyMerkle(
        ...
        uint256 price = _checkBeforePurchase(_userAddress, _smolId, _traitId);
        userAllocationClaimed[_userAddress][_traitId] = true;
        _unlockTrait(_userAddress, price, _smolId, _traitId);
    }
    ...
    function _equipSet(
        ...
        _checkBeforeEquip(_smolId, _traitsToEquip.background);
        _checkBeforeEquip(_smolId, _traitsToEquip.body);
        _checkBeforeEquip(_smolId, _traitsToEquip.hair);
        _checkBeforeEquip(_smolId, _traitsToEquip.clothes);
        _checkBeforeEquip(_smolId, _traitsToEquip.glasses);
        _checkBeforeEquip(_smolId, _traitsToEquip.hat);
        _checkBeforeEquip(_smolId, _traitsToEquip.mouth);
        _checkBeforeEquip(_smolId, _traitsToEquip.costume);
