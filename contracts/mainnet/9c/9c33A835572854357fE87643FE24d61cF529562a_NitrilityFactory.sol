...
contract NitrilityFactory is Ownable, ReentrancyGuard {
    ...
    function createCollection(string memory sellerId) internal {
    ...
    function reFundOffer(
        ...
        require(amount >= gasFee, "Gas: Insufficient amount to cover gas fee");
    ...
    function withdrawFund(string memory sellerId) external {
        require(
