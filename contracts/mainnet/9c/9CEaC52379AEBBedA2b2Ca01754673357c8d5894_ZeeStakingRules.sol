...
contract ZeeStakingRules is StakingRulesBase {
    ...
    mapping(uint256 => uint256) public levelToUserDepositBoost;

    bool public paused;

    mapping(uint256 => uint256) public tokenIdToCachedLevel;

    event BoostFactor(uint256 boostFactor);
    event NftAddress(address nftAddress);
    ...
    function init(
        ...
        _setBoostFactor(_zeeBoostFactor);

        levelToUserDepositBoost[1] = 0.0345 * 1 ether;
        levelToUserDepositBoost[2] = 0.0597 * 1 ether;
        levelToUserDepositBoost[3] = 0.0755 * 1 ether;
        levelToUserDepositBoost[4] = 0.0872 * 1 ether;
        levelToUserDepositBoost[5] = 0.0965 * 1 ether;
        levelToUserDepositBoost[6] = 0.1043 * 1 ether;
        levelToUserDepositBoost[7] = 0.1109 * 1 ether;
        levelToUserDepositBoost[8] = 0.1167 * 1 ether;
        levelToUserDepositBoost[9] = 0.1218 * 1 ether;
        levelToUserDepositBoost[10] = 0.1264 * 1 ether;
        levelToUserDepositBoost[11] = 0.1306 * 1 ether;
        levelToUserDepositBoost[12] = 0.1344 * 1 ether;
        levelToUserDepositBoost[13] = 0.1380 * 1 ether;
        levelToUserDepositBoost[14] = 0.1413 * 1 ether;
        levelToUserDepositBoost[15] = 0.1444 * 1 ether;
        levelToUserDepositBoost[16] = 0.1472 * 1 ether;
        levelToUserDepositBoost[17] = 0.1499 * 1 ether;
        levelToUserDepositBoost[18] = 0.1525 * 1 ether;
        levelToUserDepositBoost[19] = 0.1549 * 1 ether;
        levelToUserDepositBoost[20] = 0.1572 * 1 ether;
        levelToUserDepositBoost[21] = 0.1594 * 1 ether;
        levelToUserDepositBoost[22] = 0.1615 * 1 ether;
        levelToUserDepositBoost[23] = 0.1635 * 1 ether;
        levelToUserDepositBoost[24] = 0.1654 * 1 ether;
        levelToUserDepositBoost[25] = 0.1673 * 1 ether;
        levelToUserDepositBoost[26] = 0.1691 * 1 ether;
        levelToUserDepositBoost[27] = 0.1708 * 1 ether;
        levelToUserDepositBoost[28] = 0.1724 * 1 ether;
        levelToUserDepositBoost[29] = 0.1740 * 1 ether;
        levelToUserDepositBoost[30] = 0.1755 * 1 ether;
        levelToUserDepositBoost[31] = 0.1770 * 1 ether;
        levelToUserDepositBoost[32] = 0.1785 * 1 ether;
        levelToUserDepositBoost[33] = 0.1798 * 1 ether;
        levelToUserDepositBoost[34] = 0.1812 * 1 ether;
        levelToUserDepositBoost[35] = 0.1825 * 1 ether;
        levelToUserDepositBoost[36] = 0.1838 * 1 ether;
        levelToUserDepositBoost[37] = 0.1850 * 1 ether;
        levelToUserDepositBoost[38] = 0.1863 * 1 ether;
        levelToUserDepositBoost[39] = 0.1874 * 1 ether;
        levelToUserDepositBoost[40] = 0.1886 * 1 ether;
        levelToUserDepositBoost[41] = 0.1897 * 1 ether;
        levelToUserDepositBoost[42] = 0.1908 * 1 ether;
        levelToUserDepositBoost[43] = 0.1919 * 1 ether;
        levelToUserDepositBoost[44] = 0.1929 * 1 ether;
        levelToUserDepositBoost[45] = 0.1939 * 1 ether;
        levelToUserDepositBoost[46] = 0.1949 * 1 ether;
        levelToUserDepositBoost[47] = 0.1959 * 1 ether;
        levelToUserDepositBoost[48] = 0.1969 * 1 ether;
        levelToUserDepositBoost[49] = 0.1978 * 1 ether;
        levelToUserDepositBoost[50] = 0.1987 * 1 ether;
    }

    /// @inheritdoc IStakingRules
    function getUserBoost(address, address, uint256 _tokenId, uint256) external view override returns (uint256) {
        // Use cached level so the user boost does not change while the Zee is staked
        //
        uint256 _level = tokenIdToCachedLevel[_tokenId];

        // If this is being called just for the front end, we want to return what the boost would be.
        //
        if(_level == 0) {
            _level = IZee(nftAddress).getLevel(_tokenId);
        }

        require(_level > 0, "Cached level is 0");

        uint256 _boost = levelToUserDepositBoost[_level];

        require(_boost > 0, "No boost for given Zee level");
    ...
    function _processStake(address _user, address, uint256 _tokenId, uint256) internal override {
        ...
        if (amountStaked[_user] + 1 > maxStakeablePerUser) revert MaxStakeablePerUserReached();

        tokenIdToCachedLevel[_tokenId] = IZee(nftAddress).getLevel(_tokenId);

        amountStaked[_user]++;
        staked++;
    }

    function _processUnstake(address _user, address, uint256, uint256) internal override {
        if (paused) revert Paused();
    ...
    function setNftAddress(address _nftAddress) external onlyRole(SR_ADMIN) {
        _setNftAddress(_nftAddress);
    }
    ...
    function setLevelToUserDepositBoost(uint256 _level, uint256 _userDepositBoost) external {
        require(hasRole(SR_ADMIN, msg.sender) || msg.sender == address(nftHandler), "Bad permission");

        levelToUserDepositBoost[_level] = _userDepositBoost;
    }
