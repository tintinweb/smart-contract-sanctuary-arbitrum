...
contract Migration_20240506_0001 is Migration { // solhint-disable-line contract-name-camelcase
  ...
  function migrate() internal override onlyAdmin {    
    MigrationLib.updateMarketplaceAdapter(_registry, Constants.ARB, address(0x0));
  }
}
