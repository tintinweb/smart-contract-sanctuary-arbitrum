...
contract ArbiCrazyPineapple is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 6500;
    uint public PRESALE_LIMIT = 1000;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 5000;
    uint256 public PRICE = 100000000000000000; //0.001 eth
    uint public perAddressLimit = 6000;
    ...
    constructor() ERC721("ArbiCrazyPineapple", "ACP") {}
