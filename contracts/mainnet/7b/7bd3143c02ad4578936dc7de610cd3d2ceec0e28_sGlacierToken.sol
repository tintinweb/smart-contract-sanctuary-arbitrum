...
contract sGlacierToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked GLACIER", "sGLA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGLA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGLA
