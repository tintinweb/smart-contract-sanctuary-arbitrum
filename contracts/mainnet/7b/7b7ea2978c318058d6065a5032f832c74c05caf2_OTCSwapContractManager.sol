...
import { ISubAccount } from "../interfaces/fractal/ISubAccount.sol";
...
import { ISubAccount } from "../interfaces/fractal/ISubAccount.sol";
import { ICounterPartyRegistry } from "../interfaces/fractal/ICounterPartyRegistry.sol";
import { ISwapContractManager } from "../interfaces/fractal/ISwapContractManager.sol";
...
contract SpotMarginAccount is SubAccount {
     ...
     */
    function setActiveStrategy(address strategyContractAddress) external onlyOperator onlyIfInitialized
    {
     ...
     */
    function deployToStrategy(IERC20 token, uint256 amount, uint256 minAmount) external onlyOperator onlyIfInitialized
    {
     ...
     * @param minAmount minimum amount of tokens to receive.
     */
    function withdrawFromStrategy(IERC20 token, uint256 amount, uint256 minAmount) external onlyOperator onlyIfInitialized
    {
     ...
     * @param amount amount of tokens to deposit.
     */
    function depositToStrategy(IERC20 token, uint256 amount) external onlyOperator onlyIfInitialized
    {
     ...
     * @param amount amount of tokens to deposit.
     */
    function withdrawOnlyFromStrategy(IERC20 token, uint256 amount) external onlyOperator onlyIfInitialized
    {
