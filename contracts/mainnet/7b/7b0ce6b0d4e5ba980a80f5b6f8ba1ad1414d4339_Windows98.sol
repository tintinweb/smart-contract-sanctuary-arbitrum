 ...
 * Windows 98
 *
 * https://t.me/win98arbitrum
 *
 * https://win98token.com
 *
 */
...
contract Windows98 is ERC20, Auth {
    ...
    string constant _name = "Windows 98";
    string constant _symbol = "WIN98";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // Sushi sushi 
        WETH = router.WETH();
        ...
        marketingFeeReceiver = 0x47ce2a478b81C15654b65b37ce2D6bd6574c0822;
       	devFeeReceiver = 0xf762c4F16052A8d72c8096A071FFff4f6Ae3c97D;
