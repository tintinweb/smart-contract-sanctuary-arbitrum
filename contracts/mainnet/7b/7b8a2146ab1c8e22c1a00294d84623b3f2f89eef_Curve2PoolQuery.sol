...
contract Curve2PoolQuery is IPoolQuery, Test {
    ICurveQuery pool;
    ...
    function swapGivenInputAmount(uint256 xBalance, uint256 yBalance, uint256 inputAmount, SpecifiedToken inputToken) public returns (uint256 outputAmount) {
