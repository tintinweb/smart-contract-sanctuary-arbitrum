  ...
  BaseIncentivesController
{
   ...
   **/
  function initialize(address rewardsVault, address _volToken) external initializer {
  ...
  function _transferRewards(address to, uint256 amount) internal override {
    ...
    IERC20(volToken).safeTransferFrom(_rewardsVault, to, amount);
  }
}
