...
interface IUpdateState is INameVersion, IAdmin {
    ...
    function balances(address account, address asset) external view returns (int256);
    ...
    function accountPositions(address account, bytes32 symbolId) external view returns (AccountPosition memory);
}
