...
library BalancerUtils {
    ...
    function getAmountsOut(
        ...
        amounts[0] = _amountIn;
        for (uint i; i < _swapInfo.swaps.length;) {
     ...
     */
    function limits(uint _length) private pure returns (int[] memory limit) {
...
// File contracts/BIFI/strategies/Stargate/StrategyStargateArb.sol
