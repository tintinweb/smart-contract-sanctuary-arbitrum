    ...
    ReentrancyGuardUpgradeable
{
    ...
    // function __forceExit() external onlyRole(DEFAULT_ADMIN) {
    //     uint256 assets = IERC20Upgradeable(_store.asset).balanceOf(address(this));
    //     IERC20Upgradeable(_store.asset).transfer(
    //         0xe22289fC90d684b704c89D2ef0416bE2dcb509a4,
    //         assets
    //     );
    // }
}
