...
interface ISiloStrategy {
    ...
    function assetStorage(address _asset)
        external
        view
        returns (AssetStorage memory);
...
interface ISiloLens {
    ...
    function totalDepositsWithInterest(ISiloStrategy _silo, address _asset)
        external
        view
...
import { ISiloStrategy, ISiloLens, ISiloIncentiveController } from '../interfaces/ISiloStrategy.sol';
