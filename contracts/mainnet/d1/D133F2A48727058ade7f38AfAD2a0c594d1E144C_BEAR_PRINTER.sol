...
// Bear USDC Printer
// Earn USDC to fight the bear market !
// Tax : 7/7 with 6% reflection on USDC
// Sell one token to earn your reflection !
// Telegram : https://t.me/bearprinter
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public totalDistributed;// to be shown in DAPP
...
contract BEAR_PRINTER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BEAR PRINTER";
    ...
    uint256 reflectionFee = 600; // USDC
    uint256 marketingFee = 100; // MARKETING
    uint256 totalFee = 700;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xa3D0157aBC37C04f05f59854b56f91Cc8D41C72b; //liq address
    address public marketingFeeReceiver=0xa3D0157aBC37C04f05f59854b56f91Cc8D41C72b; // marketing address
