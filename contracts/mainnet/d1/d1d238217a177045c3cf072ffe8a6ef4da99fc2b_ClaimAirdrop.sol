...
contract ClaimAirdrop {
    ...
    function claim(ClaimTypes.AdminSignature calldata adminSignature) public payable {
        ...
        //require(adminSignature.claimedAmount == claimedAmount[msg.sender], "Invalid claimed amount");
        ...
        uint256 pendingAmount = adminSignature.totalAmount - claimedAmount[msg.sender];
        token.transfer(msg.sender, pendingAmount);
        claimedAmount[msg.sender] += pendingAmount;
        ...
        return
            keccak256(
                abi.encode(
                    ...
                    _adminSignature.claimedAmount
                )
            );
    }
    // event
    event Claim(address indexed wallet, uint256 _amount);
}
...
library ClaimTypes {
    //keccak256("AdminSignature(address wallet,uint256 totalAmount,uint256 claimedAmount,uint256 timestamp");
    bytes32 internal constant MAKER_ADMIN_HASH = 0x9ca03db939f860017b68b7f008b71a4acee7b439f3bd7195e6d3991a007be3c8;
