...
import {IAstronaut} from "./IAstronaut.sol";

contract Astronaut is ERC721, Owned, IAstronaut {
    ...
    constructor() ERC721("Founding Orange", "FO") Owned(msg.sender) {}

    /**
     * @notice Returns the token URI for the given token ID.
     * token id is same between all tokens.
