...
contract bucksarbi is Context, IERC20, Ownable {
    ...
    string private _name = "Arbitrum Bucks";

    string private _symbol = "ARBUCKS";
    ...
    address payable public marketingWalletAddress = payable(0x6C56F0eE051Bd4d0cD3aBC86b223D44c96B314B3); // Marketing Address
