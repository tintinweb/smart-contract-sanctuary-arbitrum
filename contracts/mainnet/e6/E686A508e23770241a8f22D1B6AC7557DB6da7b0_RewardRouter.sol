    ...
    ReentrancyGuardUpgradeable
{
    ...
    event WithdrawMantissaUpdated(uint256 oldWithdrawMantissa, uint256 newWithdrawMantissa);
     ...
     */
    function _updateWithdrawMantissa(uint256 newWithdrawMantissa) external onlyOwner {
        require(newWithdrawMantissa <= 1, "Invalid Withdraw Mantissa");
...
import {ICERC20, SushiRouterInterface, PriceOracleProxyETHInterface, IERC20Extended, IGLPRouter, IPlutusDepositor, IWETH, ICETH, CurveInterface} from "../Interfaces/Interfaces.sol";
...
contract RouterConstants {
    ...
    CurveInterface internal constant CURVE_WSTETH_POOL = CurveInterface(0x4c2Af2Df2a7E567B5155879720619EA06C5BB15D);
