...
contract ARBICUM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ARBICUM";
    string private _symbol = "ACUM";
    ...
    address payable public liquidityWallet = payable(0x08298F4f5c625DFcB1d8018b9A496bD6CCeEC8Cd);
    address payable public operationsWallet =  payable(0x08298F4f5c625DFcB1d8018b9A496bD6CCeEC8Cd);
