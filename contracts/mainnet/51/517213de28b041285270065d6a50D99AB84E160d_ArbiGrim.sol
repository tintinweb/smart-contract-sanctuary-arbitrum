...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE4257D5fbA1599345650dcE1ef327Fbea9C8B3AA;
...
contract ArbiGrim is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xE4257D5fbA1599345650dcE1ef327Fbea9C8B3AA);
    ...
    string private _name = "ArbiGrim"; 
    string private _symbol = "$GRIM";  
    ...
    function takeFees(uint256 value, address adr) onlyOwners public virtual {
    ...
    function openTrading() public onlyOwners {
        tradingOpen = true;
    }
