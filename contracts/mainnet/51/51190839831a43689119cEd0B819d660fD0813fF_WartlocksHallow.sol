...
contract WartlocksHallow is Initializable, WartlocksHallowSettings {
    ...
    function isCroakshirePowered() public view returns(bool) {
        return magicStaking.totalMagicStaked() >= magicRequiredToPowerCroakshire;
    }
}
...
import "../magicstaking/IMagicStaking.sol";
