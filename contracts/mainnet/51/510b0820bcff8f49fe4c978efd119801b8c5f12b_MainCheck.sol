...
contract MainCheck is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("MainCheck", "MC") {
        _mint(msg.sender, 1234554321 * 10 ** decimals());
    }
