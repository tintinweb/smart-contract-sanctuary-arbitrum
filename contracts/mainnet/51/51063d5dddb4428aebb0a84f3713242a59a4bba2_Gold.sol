...
contract Gold is ERC20, Ownable
{
    ...
    function getMintTarget() public view returns (address)
    {
        return _mintTarget;
    }

    function newMintTarget(address newTarget) public onlyOwner
    {
        require(newTarget != address(0) );
        _mintTarget = newTarget;
    }
