...
contract OwnershipFacet is IERC173 {
    ...
    function transferOwnership(address _newOwner) external override {
        ...
        LibOwnership.Storage storage s = LibOwnership.ownershipStorage();
...
library LibOwnership {
    bytes32 internal constant NAMESPACE = keccak256("com.binance.w3w.diamond.ownership");

    struct Storage {
        address newOwner;
    }

    function ownershipStorage() internal pure returns (Storage storage s) {
