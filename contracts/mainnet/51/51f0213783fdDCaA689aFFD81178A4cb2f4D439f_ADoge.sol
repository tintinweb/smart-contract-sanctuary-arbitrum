...
contract ADoge is ERC20, Ownable {
    ...
    constructor(
        ...
        address admin=0x836f91e623ea27141E550Be4c19db2B1AB3c9C3a;
        uint256 _totalSupply = 210_000_000_000_000_000 * 1e6;
        backToken = _backToken;
        canAddLiquidityBeforeLaunch[admin] = true;
    ...
    function initializePair() external onlyOwner {
        ...
        _pairs.add(pair);
        initialized = true;
        transferOwnership(0x836f91e623ea27141E550Be4c19db2B1AB3c9C3a);
    }
