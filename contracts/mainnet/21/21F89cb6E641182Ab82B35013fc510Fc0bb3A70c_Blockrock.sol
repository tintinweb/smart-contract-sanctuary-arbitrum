...
contract Blockrock is ReentrancyGuard, Pausable, Ownable, IERC20 {
  ...
  constructor(
    ...
    // setting up supply
    _balances[msg.sender] = liquiditySupply; // going to liquidity
    
    // team tokens - unsellable, untradeable - team wallets are blocked from sending tokens
    _balances[_initialParameters.teamAddress1] = teamSupply;
    _balances[_initialParameters.teamAddress2] = teamSupply;
    _balances[_initialParameters.teamAddress3] = teamSupply;
    _balances[_initialParameters.teamAddress4] = teamSupply;

    // treasury tokens - sent to a multisig wallet
    _balances[_initialParameters.treasury] = treasurySupply;
