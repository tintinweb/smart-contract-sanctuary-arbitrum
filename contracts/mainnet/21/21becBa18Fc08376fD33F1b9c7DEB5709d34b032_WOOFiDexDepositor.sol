...
interface IWOOFiDexDepositor {
    ...
    function swap(address payable to, Infos calldata infos, VaultDeposit calldata vaultDeposit) external payable;
}
...
import {IWOOFiDexDepositor} from "./interfaces/IWOOFiDexDepositor.sol";
