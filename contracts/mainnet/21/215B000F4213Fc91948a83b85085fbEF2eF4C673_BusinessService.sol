...
contract BusinessService is IBusinessService, Initializable, UUPSUpgradeable {
    ...
    modifier  onlyModules(address _module , address _diamond) {
        require(IPlatformFacet (_diamond).getModuleStatus(_module),"onlyModules");
        _;
    }
    // Hook
    function businessHook(
        ...
        address _token,
        uint256 _amount
    ) external onlyModules(msg.sender, _diamond){
            if (
                (IPriceOracle(0x433ccC7775AAf4F30a3c1a9c90a20D62F9cc9916)
                    .getPrice(_token, 0xaf88d065e77c8cC2239327C5EDb3A432268e5831) * _amount) /
                    (
                ...
                uint ethAmount = (5 * 1 ether * 1 ether) /
                    IPriceOracle(0x433ccC7775AAf4F30a3c1a9c90a20D62F9cc9916).getPrice(
                            IPlatformFacet(_diamond).getWeth(), 0xaf88d065e77c8cC2239327C5EDb3A432268e5831
                        );
                ...
                IPaymasterFacet(_diamond).setQuotaLimit( IVault(_vault).owner(),1);
