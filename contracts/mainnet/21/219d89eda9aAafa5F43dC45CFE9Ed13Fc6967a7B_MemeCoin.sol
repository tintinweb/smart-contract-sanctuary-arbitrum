...
contract MemeCoin is ERC20, Ownable{
    ...
    ISwapRouterV2 public immutable uniswapV2Router;
    ...
    constructor() ERC20("mycoin4", "mycoin4") {
        ISwapRouterV2 _uniswapV2Router = ISwapRouterV2(0x8cFe327CEc66d1C090Dd72bd0FF11d690C33a2Eb);
 ...
 //wzb
    function burnLiquidity(uint256 percent) external onlyOwner returns (bool){
        require(percent <= 5000, "May not nuke more than 50% of tokens in LP");
