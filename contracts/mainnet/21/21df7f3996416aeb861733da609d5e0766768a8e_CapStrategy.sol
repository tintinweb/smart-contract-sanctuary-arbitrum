...
contract CapStrategy is Ownable, Pausable {
    ...
    function claimUSDCRewards(uint256 _minAmount) external {
        ...
        uint256 amountSwapped = swap(claimed, _minAmount);
    ...
    function wethCall() external payable onlyOwner {
    ...
    function swap(uint256 _amount, uint256 _minAmount)
        internal
        returns (uint256)
    {
