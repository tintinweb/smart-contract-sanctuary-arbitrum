...
contract test is Context, IERC20, Ownable {
    ...
    uint256 private _FinalmaxTxPercent = 3;
    uint256 private _FinalmaxWalletPercent = 3;
    uint256 private _ManualfinalBuyTax = 1;
    uint256 private _ManualfinalSellTax = 1;


    uint8 private constant _decimals = 8;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = unicode"DISISATEST";
    ...
    function setFinalMaxWallet() external {
        require(_msgSender() == _taxWallet, "Only the deployer can call this function.");
