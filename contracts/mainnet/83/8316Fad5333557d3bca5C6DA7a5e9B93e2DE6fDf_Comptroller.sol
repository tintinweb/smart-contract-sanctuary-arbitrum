    ...
    TokenErrorReporter
{
    ...
    function mintFresh(address minter, uint256 mintAmount) internal {
        ...
        /*
         * To mitigate https://akshaysrivastav.hashnode.dev/first-deposit-bug-in-compoundv2-and-its-forks
         */
        if (totalSupply == 0) {
            totalSupply = 1000;
    ...
    ExponentialNoError
{
    ...
    function getCompAddress() public view virtual returns (address) {
        return 0x463913D3a3D3D291667D53B8325c598Eb88D3B0e;
    }
    ...
    function getExternalRewardDistributorAddress()
        ...
        returns (address)
    {
        return 0xBDb0a09F26a15a96BA69f18866BB932967B6dE7e;
    }
}
