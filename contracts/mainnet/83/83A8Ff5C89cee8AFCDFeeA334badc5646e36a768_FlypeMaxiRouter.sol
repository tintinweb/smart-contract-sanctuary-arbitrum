    ...
    OwnableUpgradeable
{
        ...
        )
    {
        ...
        (uint256 amount0In, uint256 amount1In, uint256 _mintAmount) = vault
        ...
        )
    {
        ...
        uint256 leftoverBalance = IERC20(address(weth)).balanceOf(
            address(this)
        );
...
import {IFlypeMaxiVault} from "./IFlypeMaxiVault.sol";

interface IFlypeMaxiRouter {
    function addLiquidity(
        IFlypeMaxiVault vault,
        uint256 amount0Max,
        uint256 amount1Max,
