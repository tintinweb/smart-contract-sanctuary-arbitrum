...
/*
Arbitron - Launching Tuesday, April 11th!

The FIRST EVER zero knowledge privacy protocol on Arbitrum!

Welcome to Arbitron, a cutting-edge cryptocurrency platform that prioritizes the privacy and security of our users.

Our mission is to empower individuals to take control of their financial freedom by providing a zero knowledge mixer that makes cryptocurrencies untraceable.

Let's work together to create a more private and secure financial future for all! 👀🤖
...
contract Arbitron is IBEP20, Auth {
    ...
    address constant DEV = 0xDD4eDcC2E9a910a1C36F07877D47f755bEbdd99e;


    string constant _name = "Arbitron";
    string constant _symbol = "ARBITRON";
