...
interface IERC20Mintable {
    ...
    function transfer(address sender, uint256 outAmount) external;
}
...
contract LPSwapper is Ownable {
    ...
    function setReceiver(address _addy) public onlyOwner {
        receiver = _addy;
    }
