...
contract LShareRewardPool is IRewardPool, ReentrancyGuard {
    ...
    // uint256 public lsharePerSecond = 0.0001364488 ether; 
    uint256 public lsharePerSecond = 0.0000136448 ether; 
    uint256 public runningTime = 721 days;
    uint256 public constant TOTAL_REWARDS = 8500 ether;
    ...
    {
        require(
            _newRate >= 0.00005 ether && _newRate <= 0.05 ether,
            "out of range"
        );
