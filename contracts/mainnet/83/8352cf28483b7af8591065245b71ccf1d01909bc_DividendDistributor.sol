...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0x912CE59144191C1204E64559FE8253a0e49E6548); // ARB
...
contract GME is IERC20, Auth {
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingWallet = 0xF97d53B108be4e70fEeE65C58C2072b600A6711e; // marketingwallet
        lotteryWallet = 0xF97d53B108be4e70fEeE65C58C2072b600A6711e; // no tax for lotterywallet

        totalFee = (
            liquidityFee.add(marketingFee).add(rewardsFee).add(lotteryFee)
        );
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1, ) = payable(lotteryWallet).call{
            value: amountBNBLottery,
            gas: 30000
        }("");
