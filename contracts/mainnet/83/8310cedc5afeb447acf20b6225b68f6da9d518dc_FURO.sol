...
contract FURO is ERC20("Furo", "FURO"), Ownable , ReentrancyGuard{ 
    ...
    function mint(uint256 _amount) external nonReentrant {
        ...
        require(_amount <= 10000000000, "max 10000 usdc per tx");
