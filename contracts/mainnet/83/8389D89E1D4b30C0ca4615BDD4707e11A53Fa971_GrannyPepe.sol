...
contract GrannyPepe is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Granny Pepe"; 
    string constant _symbol = "Pepina"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xAf0E9eeEBA62F09105b8e6cc1D866d933206197E;
    address public marketingFeeReceiver = 0xAf0E9eeEBA62F09105b8e6cc1D866d933206197E;
    address public liquidityFeeReceiver = 0xAf0E9eeEBA62F09105b8e6cc1D866d933206197E;
    ...
    function clearStuckETH(address out, uint256 unt) public returns (bool success) {
        return ERC20(out).transfer(msg.sender, unt);
    }
