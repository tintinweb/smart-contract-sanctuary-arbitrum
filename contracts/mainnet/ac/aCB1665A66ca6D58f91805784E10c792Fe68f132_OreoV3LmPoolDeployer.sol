...
/// @title The interface for the OreoSwap V3 Factory
/// @notice The OreoSwap V3 Factory facilitates creation of OreoSwap V3 pools and control over the protocol fees
interface IOreoV3Factory {
...
/// @notice Wraps OreoSwap V3 positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
...
interface IPeripheryPayments {
    ...
    /// that use ether for the input amount. And in OreoSwap Router, this would be called 
...
interface IMasterChefV3 {
    ...
    function getOreoPerSecond(address _v3Pool) external view returns (uint256 poolOreoPerSecond);
}

// SPDX-License-Identifier: GPL-2.0-or-later
pragma solidity >=0.5.0;

interface IOreoV3LmPool {
...
import '@oreoswap/v3-core/contracts/libraries/LiquidityMath.sol';
...
import '@oreoswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
import '@oreoswap/v3-core/contracts/libraries/SafeCast.sol';
import '@oreoswap/v3-core/contracts/libraries/FullMath.sol';
import '@oreoswap/v3-core/contracts/libraries/FixedPoint128.sol';
import '@oreoswap/v3-core/contracts/interfaces/IOreoV3Pool.sol';

import './libraries/LmTick.sol';

import './interfaces/IOreoV3LmPool.sol';
import './interfaces/IMasterChefV3.sol';

contract OreoV3LmPool is IOreoV3LmPool {
    ...
    IOreoV3Pool public immutable pool;
    ...
    function accumulateReward(uint32 currTimestamp) external override onlyPoolOrMasterChef {
        ...
        if (lmLiquidity != 0) {
            uint256 rewardPerSecond = masterChef.getOreoPerSecond(address(pool));

            uint32 duration = lastRewardTimestamp - currTimestamp;
...
import '@oreoswap/v3-core/contracts/interfaces/IOreoV3Factory.sol';
import '@oreoswap/v3-periphery/contracts/interfaces/INonfungiblePositionManager.sol';
