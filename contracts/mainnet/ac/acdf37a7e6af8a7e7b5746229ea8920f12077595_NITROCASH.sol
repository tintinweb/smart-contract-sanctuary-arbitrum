...
contract NITROCASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "NITROCASH"; // 
    string private constant _symbol = "NITROCASH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 1;
    uint256 private _liquidityFee = 5;
    address private  _marketingWallet = 0x9793B6AcAAE06968a71FAa6D2D7821Bd82F8Ccf1;
