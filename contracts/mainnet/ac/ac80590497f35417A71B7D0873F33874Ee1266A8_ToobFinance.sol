...
/// @author Ilya Lyalin
/// version 2.1
contract ToobFinance is Ownable {
    ...
    modifier lock() {
        require(unlocked == 1, "ToobFinance is locked");
        require(paused == 1, "ToobFinance is paused");
        unlocked = 2;
        _;
        unlocked = 1;
    }
    ...
    /// @param amountOutMin Minimum amount of the output token
    /// @return amountOut Actual amount of the output token
    function transferValueAndtoobExecute(
    ...
    function toobExecuteInternal(
        ...
        while (stream.isNotEmpty()) {
            ...
            else revert("ToobFinance: Unknown command code");
        }
        ...
        require(
            ...
            "ToobFinance: Minimal imput balance violation"
        );
        ...
        require(
            ...
            "ToobFinance: Minimal ouput balance violation"
        );
    ...
    function swap(
        ...
        else revert("ToobFinance: Unknown pool type");
    }
    ...
    function swapUniV3(
        ...
        require(
            lastCalledPool == IMPOSSIBLE_POOL_ADDRESS,
            "ToobFinance.swapUniV3: unexpected"
        ); // Just to be sure
    }
    ...
    function swapAlgebra(
        ...
        require(
            lastCalledPool == IMPOSSIBLE_POOL_ADDRESS,
            "ToobFinance.swapAlgebra: unexpected"
        ); // Just to be sure
    }
    ...
    function uniswapV3SwapCallback(
        ...
        require(
            ...
            "ToobFinance.uniswapV3SwapCallback: call from unknown source"
        );
        lastCalledPool = IMPOSSIBLE_POOL_ADDRESS;
        ...
        require(
            amount > 0,
            "ToobFinance.uniswapV3SwapCallback: not positive amount"
        );

        // Normally, ToobFinance shouldn't have any liquidity on board
    ...
    function pancakeV3SwapCallback(
        ...
        require(
            msg.sender == lastCalledPool,
            "ToobFinance.pancakeswapV3SwapCallback: call from unknown source"
        );
        lastCalledPool = IMPOSSIBLE_POOL_ADDRESS;
        address tokenIn = abi.decode(data, (address));
        int256 amount = amount0Delta > 0 ? amount0Delta : amount1Delta;
        require(
            amount > 0,
            "ToobFinance.pancakeswapV3SwapCallback: not positive amount"
        );
    ...
    function algebraSwapCallback(
        ...
        require(
            msg.sender == lastCalledPool,
            "ToobFinance.algebraSwapCallback: call from unknown source"
        );
        lastCalledPool = IMPOSSIBLE_POOL_ADDRESS;
        address tokenIn = abi.decode(data, (address));
        int256 amount = amount0Delta > 0 ? amount0Delta : amount1Delta;
        require(
            amount > 0,
            "ToobFinance.algebraSwapCallback: not positive amount"
        );
