...
abstract contract AirPuff1XM is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function openPosition(uint256 _amount) external whenNotPaused nonReentrant {
        ...
        IERC20(LRTAsset).safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function closePosition(uint256 _positionID) external InvalidID(_positionID, msg.sender) whenNotPaused nonReentrant {
        ...
        if (feeConfiguration.withdrawalFee > 0) {
            ...
            IERC20(LRTAsset).safeTransfer(feeConfiguration.feeReceiver, fee);
        } else {
...
contract AirPuff1XsolvBTC is AirPuff1XM {
    ...
    function initialize(address _sbtc) external initializer {
        require(_sbtc != address(0), "AirPuff: LRT address is invalid");
        ...
        __ERC20_init("AirPuff-SolvBTC1X", "bsolvBTC1X");
    }
