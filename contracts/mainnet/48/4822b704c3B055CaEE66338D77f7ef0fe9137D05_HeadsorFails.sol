...
contract HeadsorFails is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "HeadsorFails";

    string private _symbol = "HeadsorFails";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x78Da1711FaEEcadf4d78018b9E02B802c1922Dbd;
