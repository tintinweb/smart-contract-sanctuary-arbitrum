...
import "./interfaces/IxELNs.sol";

contract xELNs is IxELNs {

    string public constant name = "xELNs";
    string public constant symbol = "xELNs";
    ...
    function setReln(address _reln) external {
        require(msg.sender == owner);
        reln = _reln;
    }
