...
contract bil126 is ERC20, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("126bil", "BIL") ERC20Permit("126bil") {
        _mint(msg.sender, 126000000 * 10 ** decimals());
    }
