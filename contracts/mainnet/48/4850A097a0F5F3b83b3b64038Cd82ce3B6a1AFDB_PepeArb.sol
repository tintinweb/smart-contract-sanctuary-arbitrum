...
/*
PEPEARB is a cryptocurrency based on memes with a McDonald's theme. 
Each PEPEARB meme features different McDonald's characters, 
such as Ronald McDonald, Hamburglar, or Grimace, in funny or silly situations.

https://t.me/PEPEARBTOKEN
**/
...
contract PepeArb is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE ARBITRUM";
    string private constant _symbol = "$PEPEARB";
