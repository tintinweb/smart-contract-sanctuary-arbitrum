...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract RewardPool is IRewardPool, ReentrancyGuard {
        ...
        uint256  public pendingRewardDebt;
        // Info of each pool.
        ...
        returns (uint256)
    {
            ...
            nonReentrant
        {
            ...
            pendingRewardDebt = pendingRewardDebt.add(_amount.mul(pool.accTokenPerShare).div(1e18));
            ...
            nonReentrant
        {
            ...
            if(_amount == 0 ) amount  = pendingRewardDebt;
            pendingRewardDebt = pendingRewardDebt.sub(amount);
