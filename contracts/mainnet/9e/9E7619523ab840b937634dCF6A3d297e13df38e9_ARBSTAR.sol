...
TG: https://t.me/ARBStarTokenPortal
...
/* Token contract */
contract ARBSTAR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "ARB $STAR";
    ...
    uint256 ttmFeeBuy = 400;
    uint256 reflectionFeeBuy = 300;
    uint256 marketingFeeBuy = 1300;
    uint256 totalFeeBuy = 2000;      

    // Sell fees
    uint256 liquidityFeeSell = 100;
    uint256 ttmFeeSell = 400;
    uint256 reflectionFeeSell = 300;
    uint256 marketingFeeSell = 2700;
    uint256 totalFeeSell = 3500;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6156dDa89Df46bcfCe2833e8eD90D981558DE273;
        ttmFeeReceiver = 0xEEEC7576bc80279c7795a2a7bB170bF67EfDFc1f;
