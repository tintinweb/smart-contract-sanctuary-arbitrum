...
library LibTokenFiErc1155Storage {
    ...
    struct DiamondStorage {
        ...
        mapping(uint256 => uint256) paymentServiceIndex;
...
import { LibTokenFiErc1155Storage } from "../libraries/TokenFiErc1155Storage.sol";
import { ITokenFiErc1155 } from "../interfaces/ITokenFiErc1155.sol";

contract TokenFiErc1155DiamondInit is AccessControl {
    function init(ITokenFiErc1155.TokenInfo memory tokenInfo) external {
        require(tokenInfo.owner != address(0), "TokenFiErc1155:init: INVALID_OWNER");

        LibTokenFiErc1155Storage.DiamondStorage storage ds = LibTokenFiErc1155Storage.diamondStorage();

        ds.tokenInfo = tokenInfo;
        ds.paymentModule = msg.sender;

        _grantRole(AccessControlStorage.DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(AccessControlStorage.DEFAULT_ADMIN_ROLE, tokenInfo.owner);
    }
}