...
contract JustYieldVault is ERC20, Ownable, ReentrancyGuard {
     ...
     */
    constructor (
        IStrategy _strategy, // 0x1FD55173238d730b16358E39bf8Ac098c5ca8ef2
        string memory _name, // Just Yield GLP Vault
        string memory _symbol, // bGLP
    ...
    function depositAll(bool _compound) public {
        deposit(underlying().balanceOf(msg.sender), _compound);
    }
    ...
    function inCaseTokensGetStuck(address _token) external onlyOwner {
        require(_token != address(want()), "!t");
        require(_token != address(underlying()), "!u");
