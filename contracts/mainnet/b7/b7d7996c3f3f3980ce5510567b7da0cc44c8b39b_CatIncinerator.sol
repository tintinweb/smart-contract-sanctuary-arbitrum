...
contract CatIncinerator is AxelarExecutable {
    ...
    address public axlUSDC = 0x750e4C4984a9e0f12978eA6742Bc1c5D248f40ed; // polygon
    address public axelarGatewayArbitrum = address(0xe432150cce91c13a887f7D836923d5597adD8E31);
    ...
    address public axelarGatewayPolygon = address(0x6f015F16De9fC8791b234eF68D486d2bF203FBA8);
    address public axelarGasReceiverPolygon = address(0x2d5d7d31F671F86C782533cc367F14109a082712);
    ...
    constructor() AxelarExecutable(axelarGasReceiverPolygon) {
        gasService = IAxelarGasService(axelarGasReceiverPolygon);
    }
    ...
    function depositCat(address cat, uint256 amount, string calldata bridgeDestination) public payable {
        ...
        squidRouter.bridgeCall{value: msg.value}(
            ...
            "axlUSDC", amountOut, "arbitrum", bridgeDestination, payload, msg.sender, true
        );
