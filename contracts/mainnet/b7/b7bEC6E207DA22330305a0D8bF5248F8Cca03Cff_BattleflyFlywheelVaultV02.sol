    ...
    ReentrancyGuardUpgradeable
{
    ...
    /**
     * @dev Claim emission from Harvesters
     */
    function claimHarvesters(address recipient) public override nonReentrant onlyOwner returns (uint256 emission) {
        emission = HARVESTER_EMISSION.claim(address(this));
        MAGIC.safeTransfer(recipient, emission);
        emit ClaimHarvesterEmission(recipient, emission);
    }
