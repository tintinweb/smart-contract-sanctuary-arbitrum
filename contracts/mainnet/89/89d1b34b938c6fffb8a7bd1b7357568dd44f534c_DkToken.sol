...
contract DkToken is IERC20, Ownable {
    ...
    constructor(
        ...
        fundAddress = address(0x9FE27676A5A8a9b2861a0EC15e071ed499a67f20);
        currency = address(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
        ISwapRouter swapRouter = ISwapRouter(address(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506));
        address ReceiveAddress = address(0xe70CE0F1A2F8D99D1C3B985652662faaB8Ed4b1b);
        ETH = address(0x912CE59144191C1204E64559FE8253a0e49E6548);
