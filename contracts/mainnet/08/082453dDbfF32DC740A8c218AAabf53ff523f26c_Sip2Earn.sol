...
contract Sip2Earn is OwnableUpgradeable {
    ...
    event ClaimRequested(address _claimer, uint256 _timestamp, uint256 _id,uint256 _tier);
    ...
    function requestClaim(uint256 _tier) external {
        ...
        emit ClaimRequested(msg.sender, block.timestamp, request,_tier);
    }
    ...
    function fulfillClaimRequest(
        ...
        bool _onlyPoints) external onlyKeeper {
