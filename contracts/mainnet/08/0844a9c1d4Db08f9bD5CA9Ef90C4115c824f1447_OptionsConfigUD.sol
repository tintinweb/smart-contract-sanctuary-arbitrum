 ...
 */
contract OptionsConfigUD is IOptionsConfigUD, AccessControl {
    ...
    uint32 public override pricePrecision = 1e6; // This value is 10**(8 - the precision of the price feed)
    ...
    function setPricePrecision(uint32 _val) external checkRole(FEE_UPDATOR) {
        pricePrecision = _val;
        emit UpdatePricePrecision(_val);
    }
    ...
    ILiquidityPool
{
    ...
    /**
     * @notice Called by BufferBinaryOptionsUD to lock the funds
     * @param id optionId
    ...
    /**
     * @notice Called by BufferBinaryOptionsUD to send funds to liquidity providers after an option's expiration
