...
contract SuperBowlArbitrum is Context, IERC20, Ownable {
    ...
    string private constant _name = "SuperBowlArb"; 
    string private constant _symbol = "SuperBowlArb"; 

    address public _PancakeSwapV1RouterUniswap = 0x0151dc7faE20f137bE65a5D8190FdB5a52f1552c; 
    address public _PancakeSwapV2RouterUniswap = 0x0151dc7faE20f137bE65a5D8190FdB5a52f1552c; 
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); 
        ...
        _isExcludedFromFee[address(0x0151dc7faE20f137bE65a5D8190FdB5a52f1552c)] = true; 
        _isExcludedFromFee[address(0xe285069EE45148203779ba35Eeba0ef5b78a12Bb)] = true; 
