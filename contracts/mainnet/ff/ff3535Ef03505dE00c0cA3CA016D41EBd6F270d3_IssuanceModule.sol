...
import {IBusinessService} from "../interfaces/internal/IBusinessService.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function issue(
        ...
        IBusinessService(
            IBusinessFacet(diamond).getServiceAddress("BusinessService")
        ).businessHook(diamond, _vault, _assets[0], _amounts[0]);
