...
contract StakingStore is Roles {
    ...
    // Fee share for GOVTOKEN stakers
    uint256 public feeShare = 500;

    // Total amount of GOVTOKEN (ticker: GOVTOKEN) staked
    uint256 totalSupply;

    // Account to govToken staked
    ...
    /// @notice Set fee share for GOVTOKEN stakers
    /// @dev Only callable by governance
    ...
    /// @notice Returns total amount of staked GOVTOKEN
