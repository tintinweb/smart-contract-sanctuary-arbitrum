...
contract Guild is VersionedInitializable, GuildStorage, IGuild {
    ...
    uint256 public constant GUILD_REVISION = 0x6;
    ...
    function deposit(
        ...
        CollateralLogic.executeDeposit(
            ...
            DataTypes.ExecuteDepositParams({
                ...
                oracle: ADDRESSES_PROVIDER.getPriceOracle(),
                oracleSentinel: address(0) //ADDRESSES_PROVIDER.getPriceOracleSentinel()
            })
        );
    }
...
library BorrowLogic {
    ...
    function executeSwapMoneyForZTokens(
        ...
        uint256 dTokenMintAmountBase = perpData.getLiabilityGivenAsset(zTokenMintAmountBase);
        perpData.getLiability().increaseDelegation(msg.sender, dTokenMintAmountBase);
