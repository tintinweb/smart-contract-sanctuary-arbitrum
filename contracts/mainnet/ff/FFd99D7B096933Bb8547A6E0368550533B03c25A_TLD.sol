...
contract TLD is ERC20 {
    ...
    IERC721 public NODE = IERC721(0x8bF3Fe4bC06d9e2B78C852BB226CB98aC1871460);
    ...
    function _transfer(
        ...
        if (from == PAIR && !isRemoveLiquidity() && antiDropTime == 0) {
            sellTLD(buySellFeeAmount);
    ...
    function setAntiDrop() internal {
        if (antiDropTime > 0 && block.timestamp - antiDropTime > 1 hours) {
            antiDropTime = 0;
        }
