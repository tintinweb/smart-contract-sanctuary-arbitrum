...
contract SushiAi is ERC20Detailed, Ownable {
    ...
    string public _name = "SUSHI Ai";
    string public _symbol = "$SAi";
    ...
    uint256 private liquidityFee = 40;
    uint256 private treasuryFee = 20;
    uint256 public RFVFundFee = 100;
    ...
    constructor() ERC20Detailed("SushiAi", "SushiAi", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xAe1Bd4b6b8B7ae6fB0C436182Ac64bc26491F249;
        treasuryReceiver = 0xcE85977b0955dD4a8Ac3e82f4ce5707E2F06a5D7; 
        RFVFundReceiver = 0x02f7D85Cc89608341028c4ad0CfC54F3064566D4;
        firePit = DEAD;
