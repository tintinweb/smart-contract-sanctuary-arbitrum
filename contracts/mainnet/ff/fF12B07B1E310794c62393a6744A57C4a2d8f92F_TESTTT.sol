...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable PORK = address(0xDba35afc5f4d5AF4933C29a157Dab3975F3eee9B); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(PORK).transfer(shareholder, amount);
        }
    }
...
contract TESTTT is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0xC18eb9b94B6790188EF8804E738960E366657dAb);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForPORK(amountToSwap.div(2));

        uint256 dividends = IERC20(PORK).balanceOf(address(this));

        bool success = IERC20(PORK).transfer(address(distributor), dividends);
    ...
    function swapTokensForPORK(uint256 tokenAmount) private {
