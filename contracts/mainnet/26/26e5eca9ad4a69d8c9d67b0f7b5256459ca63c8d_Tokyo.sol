...
contract Tokyo is ERC20, Ownable {
    ...
    constructor() ERC20("Tokyo", "T0K") payable {
        ...
        uint256 totalSupply = 20 * 1e02 * 1e18;
    	...
    	marketingWallet = address(0xf381f56b531B1B0514246B8bF2D7210720C8AD98); // set as marketing wallet
        devWallet = address(0xf381f56b531B1B0514246B8bF2D7210720C8AD98);
        ...
        excludeFromFees(0xf381f56b531B1B0514246B8bF2D7210720C8AD98, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xf381f56b531B1B0514246B8bF2D7210720C8AD98, true);

                // initialize router
        IDexRouter _dexRouter = IDexRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
        ...
        */
        ...
        _createInitialSupply(0xAe4D2adA135Ae0F32f7F89ffa51B70bC1ECF7658, totalSupply*100/100);
  ...
  function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506, 'We can not blacklist Uniswap router.');
