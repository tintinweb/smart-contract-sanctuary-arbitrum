...
interface IWaterLendingHandler {    
    ...
    function borrow(uint256 _amount, uint256 _leverage, address _longToken, address _shortToken) external returns (uint256, uint256);
}
...
contract VodkaVaultV2 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function fulfillClosePosition(
        ...
        //ETH
        console.log("wr.returnedLongAmounte", wr.returnedLongAmount);
