...
// File: contracts\v6.2\GNSTradingCallbacksV6_2.sol
...
contract GNSTradingCallbacksV6_2 {
    ...
    constructor(
        ...
        require(address(_storageT) != address(0)
            ...
            && _daiVaultFeeP + _sssFeeP == 100, "WRONG_PARAMS");
    ...
    function setClosingFeeSharesP(
        ...
        require(_daiVaultFeeP + _sssFeeP == 100, "SUM_NOT_100");
        
        daiVaultFeeP = _daiVaultFeeP;
        sssFeeP = _sssFeeP;

        emit ClosingFeeSharesPUpdated(_daiVaultFeeP, _sssFeeP);
    }
