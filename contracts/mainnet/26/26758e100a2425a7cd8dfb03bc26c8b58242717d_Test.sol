...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 5000 * 10**_decimals; // 100% of sp
    uint256 public maxTxAmountSell = 5000 * 10**_decimals; // 100% of sp
    uint256 public maxWalletAmount = 10000 * 10**_decimals; // 100% of sp
    ...
    string private constant _name = "ArbiTest";
    string private constant _symbol = "$ArbiTest";
    ...
    function setMaxTransactionAmount(
        ...
        require (_maxTxAmountSellPct <= 200, "Max Tx AmountSell cannot be less than 0,5%");
    ...
    function setMaxWalletAmount(uint256 _maxWalletAmountPct) external onlyOwner {
        require (_maxWalletAmountPct <= 200, "Max Wallet Ammount cannot be less than 0,5%");
