...
contract SecurityBaseFor5 is Ownable {
...
/**
 * @title MintableToken - primary marketplace mint contract (Only for create NFT page)
 * @dev anyone can mint token.
 */
contract MintableERC721New is ERC721BaseNew, SecurityBaseFor5 {
