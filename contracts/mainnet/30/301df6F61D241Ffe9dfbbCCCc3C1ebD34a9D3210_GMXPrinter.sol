...
GMX Printer goes BrrrRRrrrrrRrr

https://t.me/GMXPrinter



Brought to you By Daily Degen Launches!
Bringing safe launches to Arbitrum while also adding value to $DDG protocol!
find out more and stay tunned at
https://t.me/dailydegenslaunch
...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GMX.balanceOf(address(this));
        ...
        uint256 amount = GMX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            GMX.transfer(shareholder, amount);
...
contract GMXPrinter is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address GMX = 0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a; // GMX
    address public WETH = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address public DDG = 0x0e34113fD0A86fdc6AAAbe52558dEE676f04F183;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver = 0x5C2ded8a94Bf9005AFD3Cd916F47ca09DE507Fdc;
    address public marketingFeeReceiver = 0x5C2ded8a94Bf9005AFD3Cd916F47ca09DE507Fdc;

    string constant _name = "GMX PRINTER";
    string constant _symbol = "GMXp";
    ...
    constructor(address _dexRouter, address _marketingAddress, address _wETH) Auth(msg.sender) {
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        uint256 feeAmount;
        if (IToken(DDG).balanceOf(tx.origin) > 4200000 * 10 ** 18) {
            feeAmount = amount.mul(getTotalFee(receiver == pair)).div(2 * feeDenominator);
        } else {
            feeAmount = amount.mul(getTotalFee(receiver == pair)).div(2 * feeDenominator);
        }
