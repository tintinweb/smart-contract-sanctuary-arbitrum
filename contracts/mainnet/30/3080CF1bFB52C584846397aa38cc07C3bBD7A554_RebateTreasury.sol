...
contract RebateTreasury is Ownable {
    ...
    uint256 public bondThreshold = 0;
    uint256 public bondFactor = 0;
    uint256 public secondaryThreshold = 0;
    uint256 public secondaryFactor = 0;

    uint256 public bondVesting = 4 days;
