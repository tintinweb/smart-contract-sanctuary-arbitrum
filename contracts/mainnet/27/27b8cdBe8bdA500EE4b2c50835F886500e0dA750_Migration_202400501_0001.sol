...
contract Migration_202400501_0001 is Migration { // solhint-disable-line contract-name-camelcase
  ...
  function migrate() internal override onlyAdmin {    
    MigrationLib.updateMaxSupply(_registry, Constants.USDC, MigrationLib.scale(250_000, 6));
    MigrationLib.updateMaxSupply(_registry, Constants.USDT, MigrationLib.scale(250_000, 6));
    MigrationLib.updateMaxSupply(_registry, Constants.WETH, MigrationLib.scale(100, 18));
    MigrationLib.updateMaxSupply(_registry, Constants.WBTC, MigrationLib.scale(10, 8));
    MigrationLib.updateMaxSupply(_registry, Constants.ARB, MigrationLib.scale(1000, 18));
  }
}
