...
interface IArbinuStaking {
    ...
    function blocked(address _account) external view returns (bool _isBlocked);
}

contract ArbinuLPStaking02 is Initializable, OwnableUpgradeable {
    ...
    function withdraw(uint256 _index) public {
        require(
            !arbinuStaking.blocked(msg.sender),
