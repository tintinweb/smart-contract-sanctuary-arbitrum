...
*/
contract PirexRewards is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    function _claim(ERC20[] memory rewardTokens, address user)
        private
        returns (uint256[] memory claimed)
    {
        ...
        for (uint256 i; i < rLen; ) {
            ...
            if (claimed[i] != 0) {
                ...
                producer.claimUserReward(address(r), claimed[i], recipient);
    ...
    */
        ...
        )
    {
        ...
        claimed = _claim(rewardTokens, user);
    }
