...
contract StrategyCamelotV3 {
    ...
    constructor(
        ...
        */
        ...
        asset = IERC20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8);
        strategyHelper = IStrategyHelper(0x72f7101371201CeFd43Af026eEf1403652F115EE);
        xgrail = IXGrail(0x3CAaE25Ee616f2C8E13C74dA0813402eae3F496b);
        strategyHelperUniswapV3 = IStrategyHelperUniswapV3(0x357Abb2d1Ef48D8F3afDA83D0515F75322d59DcA);
        uniProxy = IUniProxy(0x1F1Ca4e8236CD13032653391dB7e9544a6ad123E);
        quoter = IQuoter(0x0Fc73040b26E9bC8514fA028D998E73A254Fa76E);
        hypervisor = IHypervisor(0x56c87c3892d3917895bAe1A4cAcf6ea23a4DB84d);
        nftPool = INFTPool(0xA562803Aa6FC35C3f3AB2d42b4281fE462dfb620);
        targetAsset = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
        name = string(abi.encodePacked("Camelot V3 ", hypervisor.token0().symbol(), "/", hypervisor.token1().symbol()));

        if (targetAsset != address(hypervisor.token0()) && targetAsset != address(hypervisor.token1())) {
