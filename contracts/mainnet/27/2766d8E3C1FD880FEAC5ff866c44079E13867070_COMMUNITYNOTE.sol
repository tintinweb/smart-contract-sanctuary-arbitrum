...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x912CE59144191C1204E64559FE8253a0e49E6548); 
...
contract COMMUNITYNOTE is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Community Note";
    string constant _symbol = "$CMN";
    ...
    uint256 private totalFeeIfSelling = 1;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xc93f21bF00b266d8Ec5f1C557B0b9E0E0BD2F8F4;
        anothermarketingWallet = 0xc93f21bF00b266d8Ec5f1C557B0b9E0E0BD2F8F4;
