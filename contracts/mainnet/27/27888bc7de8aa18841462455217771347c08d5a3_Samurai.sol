...
//https://t.me/samuraiarb
//https://www.twitter.com/samuraiarb
...
contract Samurai is Context, IERC20, Ownable {
    ...
    string private _name = unicode"SAMURAI 武士阶级";
    string private _symbol = unicode"$SAMARB";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(msg.sender);
    address payable private taxWallet2 = payable(msg.sender);
