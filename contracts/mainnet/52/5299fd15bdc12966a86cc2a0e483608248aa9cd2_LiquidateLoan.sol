...
contract LiquidateLoan is Ownable {
        ...
        returns (bool)
    {
        ...
        
        {
            ...
            _liquidateLoan(ILendingPool(msg.sender), collateral, assets[0], userToLiquidate, amounts[0], false);
        }
    ...
    function _liquidateLoan(ILendingPool _lendingPool, address _collateral, address _liquidate_asset, address _userToLiquidate, uint256 _amount, bool _receiveaToken) internal {
