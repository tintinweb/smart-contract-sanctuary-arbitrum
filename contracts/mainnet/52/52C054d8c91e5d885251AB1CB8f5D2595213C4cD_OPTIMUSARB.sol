...
For community and services please follow:
Telegram    : https://t.me/optimusarb
Twitter     : https://twitter.com/OPTIMUSARBit
Website     : http://optimusarb.com
...
contract OPTIMUSARB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OPTIMUS ARB", "OPTIMUM") {
        ...
        uint256 _buyDevFee = 250;
        
        uint256 _sellMarketingFee = 250;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 250;
        ...
        marketingWallet = address(0xf21E504EFDB1D0B8D23d437b2b6a8f2B8aCeC9cb); 
        devWallet = address(0xbB2f84356Fd934E87a30eA8533197551102D0f52); 
    ...
    function updateSwapEnabled(bool NewswapStatus, bool NewTradingStatus) external onlyOwner(){
        swapEnabled = NewswapStatus;
