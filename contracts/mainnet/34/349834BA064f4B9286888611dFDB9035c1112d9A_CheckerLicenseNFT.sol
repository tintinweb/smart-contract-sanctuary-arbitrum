    ...
    IERC4907
{
    ...
    mapping(uint256 /* tokenId */ => uint64 /* ban end timestamp */)
        internal _banRecords;
    ...
    function initialize() public initializer {
        __ERC721_init("Aethir Checker License", "ATHCL");
        __Ownable_init();
        minterAdminAddress = msg.sender;
        banAdminAddress = msg.sender;
        whitelistAdminAddress = msg.sender;
    ...
    function batchTransfer(
        ...
        require(
            toArray.length == tokenIdArray.length,
    ...
    function getWhitelistTransferTime()
        public
        view
