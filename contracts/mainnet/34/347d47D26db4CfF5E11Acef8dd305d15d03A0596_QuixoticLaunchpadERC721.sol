/**
 *Submitted for verification at Arbiscan on 2022-10-30
*/
...
contract QuixoticLaunchpadERC721 is ERC721("ShuangMaWei  NFT", "mawei"), ERC721Enumerable, Ownable, ReentrancyGuard {

    string private _baseURIextended;
    string private _baseURISuffix = "";
    bool public frozenMetadata = false;
    uint256 public MAX_TOKENS = 777;
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 17, "Exceeded max token purchase");
