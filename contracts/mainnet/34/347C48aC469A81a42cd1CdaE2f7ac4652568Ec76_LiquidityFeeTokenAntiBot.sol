...
contract LiquidityFeeTokenAntiBot is IERC20, Initializable, OwnableUpgradeable {
    using Address for address;
    ...
    function initialize(
        ...
        address[4] memory addrs_, // router, marketing wallet, marketing token, antibot
