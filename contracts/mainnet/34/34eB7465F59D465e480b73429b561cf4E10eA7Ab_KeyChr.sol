...
contract KeyChr is KolSolidlyManager, ReentrancyGuardUpgradeable, ERC20Upgradeable {
   ...
   */
    ...
    function setmintBalancer(address _mintBalancer) external onlyOwner {
        setExcludeFromFee(_mintBalancer, true);
    ...
    function setFees(uint256 _minTotalBuyFees, uint256 _maxTotalBuyFees, uint256 _totalMintFees) external onlyOwner {
        require(_minTotalBuyFees<=2000 && _maxTotalBuyFees<=2000 && _totalMintFees<=2000,">20%");
