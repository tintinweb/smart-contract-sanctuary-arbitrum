...
contract Treasury is Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    bytes32 public constant REFERRAL_DISBURSAL_ROLE = keccak256("REFERRAL_DISBURSAL_ROLE");
     ...
     * ADMIN role and sets role ADMIN as a role admin for PLATFORM and REFERRAL_DISBURSAL and sets PLATFORM role as admin for VAULT_CREATOR  role.
    ...
    /**
     * @notice  Function to provide functionality for withdrawing ERC20 token from the contract,caller must have DEFAULT_ADMIN role.
     ...
     */
    function withdrawFunds(IERC20Upgradeable _tokenAddress, address _to, uint256 _amount)
        external
    ...
    /**
     * @notice Function to provide functionality for checking if the given account has DEFAULT_ADMIN role.
     * @param   _account  Address of the account to check the DEFAULT_ADMIN_ROLE for.
     * @return  bool.
     */
     ...
     * @return  bool.
     */
    function isReferralDisburser(address _account) external view returns (bool) {
     ...
     */
    function _authorizeUpgrade(address _newImplementation) internal override onlyRole(ADMIN_ROLE) {}
}
