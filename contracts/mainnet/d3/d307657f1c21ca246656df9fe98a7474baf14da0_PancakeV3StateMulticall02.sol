...
import "./interfaces/IPancakeV3StateMulticall.sol";

contract PancakeV3StateMulticall02 is IPancakeV3StateMulticall {
    ...
    function _fillStateWithoutBitmapsAndTicks(
        ...
        IPancakeV3Pool pool = _getPool(factory, tokenIn, tokenOut, fee);
    ...
    function _getPool(
        ...
        pool = IPancakeV3Pool(factory.getPool(tokenIn, tokenOut, fee));
