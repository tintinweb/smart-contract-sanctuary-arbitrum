...
contract xCorpArb is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("xCorp ARB", "XCORP") {
        ...
        maxWalletAmount = totalSupply * 2 / 100; // % maxWallet
        thresholdSwapAmount = totalSupply * 1 / 10000; // 0.01% swap wallet

        _fees.buydevelopmentFee = 1;
        _fees.buyLiquidityFee = 1;
        _fees.buyTotalFees = _fees.buydevelopmentFee + _fees.buyLiquidityFee;

        _fees.selldevelopmentFee = 5;
        _fees.sellLiquidityFee = 14;
        _fees.sellTotalFees = _fees.selldevelopmentFee + _fees.sellLiquidityFee;


        developmentWallet = address(0x3774d233c99b80647d46A6A60033EF2812356450); // set as development wallet
    ...
    function updateFees(uint256 _developmentFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeSell, uint256 _liquidityFeeSell) external onlyOwner{
