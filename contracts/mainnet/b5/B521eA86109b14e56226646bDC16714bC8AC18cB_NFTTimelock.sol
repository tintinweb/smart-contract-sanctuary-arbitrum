...
contract NFTTimelock {
    ERC721 private immutable _token;
     ...
     * (in seconds).
     */
    constructor(ERC721 token_, address beneficiary_, uint256 releaseTime_) {
     ...
     */
    function token() public view virtual returns (ERC721) {
        return _token;
    }
    ...
    function releaseByAdress(uint256 tokenId, address contractAddress) public virtual {
        require(block.timestamp >= releaseTime(), "TokenTimelock: current time is before release time");
