...
*    of mostly coherent language.

*    My body was quickly becoming more clumsy, giant-like,
...
*    into the BEER AND RUM because this is obviously
*    the only way to properly celebrate.. 

CodeName: Beer And Rum

"When Life's Just Threatening To Drive You Insanae, There Always Be a $BAR For You With Only 3% Tax, And 5% Max Wallet/TX"
...
contract BeerAndRum is ERC20, Ownable {
    ...
    constructor() ERC20("Beer And Rum", "$BAR") {
        ...
        devWallet = address(0x62E0200a3c1e604C1d78547fe3A9A81727A8f112); // set as dev wallet
