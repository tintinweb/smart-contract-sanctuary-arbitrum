...
contract DataCollection is Ownable(msg.sender){
    ...
    constructor(){
        ...
        oldHarvester = IHarvester(0xBE767936403926c843fd37be1862F33c6f39e91b);
    }
    ...
    */    
    ...
    /**
     * @dev sets the changes the limit of one NFT collection
    */
    ...
    */
    ...
    /**
     * @dev migrates the Information from the old contract
    */
