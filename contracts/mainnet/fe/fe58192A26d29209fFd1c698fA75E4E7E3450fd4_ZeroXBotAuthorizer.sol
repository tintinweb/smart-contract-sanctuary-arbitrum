...
contract ZeroXBotAuthorizer is DEXBaseACL {
    ...
    function transformERC20(
        ...
        swapInOutTokenCheck(inputToken, outputToken);
    }
    ...
    function sellToUniswap(
        ...
        swapInOutTokenCheck(tokens[0], tokens[tokens.length - 1]);
    }
    ...
    function sellEthForTokenToUniswapV3(
        ...
        swapInOutTokenCheck(ETH_ADDRESS, outputToken);
    }
    ...
    function sellTokenForEthToUniswapV3(
        ...
        swapInOutTokenCheck(inputToken, ETH_ADDRESS);
    }
...
function getWrappedTokenAddress() view returns (address tokenAddress) {
    ...
    // Polygon: WMATIC
    if (chainId == 17) return 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
