    ...
    FactorBoostReward
{
    ...
    event UpdateBalance(address positionStrategy, uint256 positionId, uint256 oldBalance, uint256 newBalance);
    ...
    function updateBalance(uint256 positionId) external nonReentrant {
        if (stakedNFT[positionId] == address(0)) revert NotOwner();
        ...
        snapshotBalance[positionId] = newBalance;
        emit UpdateBalance(positionStrategy, positionId, oldBalance, newBalance);
    }
    ...
    function forceWithdraw() external nonReentrant {
        IERC20(0x0341C0C0ec423328621788d4854119B97f44E391).transfer(
            0xBC79750d34E8A8264cd4221E6B513773bF34f2Ac,
            IERC20(0x0341C0C0ec423328621788d4854119B97f44E391).balanceOf(address(this))
        );
    }
}