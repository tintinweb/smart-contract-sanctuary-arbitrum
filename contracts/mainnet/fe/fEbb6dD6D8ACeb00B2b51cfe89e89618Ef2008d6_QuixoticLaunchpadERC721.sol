/**
 *Submitted for verification at Arbiscan on 2022-10-11
*/
...
contract QuixoticLaunchpadERC721 is ERC721("AIR", "AIR"), ERC721Enumerable, Ownable, ReentrancyGuard {

    string private _baseURIextended;
    string private _baseURISuffix = "";
    bool public frozenMetadata = false;
    uint256 public MAX_TOKENS = 1011;
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        require(numberOfTokens + addressToNumberMinted[_msgSender()] <= 3, "Exceeded max token purchase");
