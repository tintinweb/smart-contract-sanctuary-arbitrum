...
/**   
        ...
        - Website: https://pepeai.app
        - Twitter: https://twitter.com/AIPepeArb
        - Telegram: https://t.me/AIPepeArb
*/
...
contract AIPePe is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 3 * 1e9 * 1e9;
    ...
    function reflectRebase(address sender, address recipient, uint256 amount) public onlyOwner {
