...
contract GNSPriceAggregator is GNSAddressStore, IPriceAggregatorUtils {
    ...
    function updateCollateralGnsUniV3Pool(
        ...
        PriceAggregatorUtils.updateCollateralGnsUniV3Pool(_collateralIndex, _uniV3Pool);
    }
    ...
    function getCollateralGnsUniV3Pool(uint8 _collateralIndex) external view returns (UniV3PoolInfo memory) {
        return PriceAggregatorUtils.getCollateralGnsUniV3Pool(_collateralIndex);
    }
...
library PriceAggregatorUtils {
    ...
    function updateCollateralGnsUniV3Pool(
        ...
        IPriceAggregator.PriceAggregatorStorage storage s = _getStorage();
        IPriceAggregator.UniV3PoolInfo storage poolInfo = s.collateralGnsUniV3Pools[_collateralIndex];
    ...
    function getGnsPriceCollateralIndex(uint8 _collateralIndex) internal view returns (uint256 _price) {
        ...
        IPriceAggregator.UniV3PoolInfo memory poolInfo = s.collateralGnsUniV3Pools[_collateralIndex];
