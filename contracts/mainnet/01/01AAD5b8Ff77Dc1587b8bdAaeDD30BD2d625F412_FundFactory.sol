...
interface IInteraction {
    ...
    function drip(uint256 fundId, uint256 tradeTvl) external returns (uint256);
    ...
    function pendingTvl(uint256[] calldata _funds, uint256[] calldata _tradeTvls) external view returns(
...
contract QHToken is ERC20, IToken, Warded {

    uint256 public holders;
    uint256 public fundId;

   // ITKN stands for Invest Token
    constructor (address _interaction, address _feeder, uint256 _fundId) ERC20("Defunds Token", "ITKN") {
        wards[_interaction] = 1;
        wards[_feeder] = 1;
        fundId = _fundId;
    }
