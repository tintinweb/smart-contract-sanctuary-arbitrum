...
contract UniSwapLPManager is IManager, IUniswapV3MintCallback, UpgradeableOperableKeepable, ERC20Upgradeable {
        ...
        for (uint256 i = 0; i < length;) {
            ...
            if (liq > 0) {
                ...
                (uint256 position0, uint256 position1) =
                    UniLiquidityLib.amountsForLiquidity(address(pool), _ranges[i].tickLower, _ranges[i].tickUpper, liq);
        ...
        returns (uint256 amount0, uint256 amount1, uint256 amount0AfterRetention, uint256 amount1AfterRetention)
    {
        ...
        for (uint256 i; i < length;) {
            ...
            (uint256 amount0Received, uint256 amount1Received) = UniLiquidityLib.amountsForLiquidity(
