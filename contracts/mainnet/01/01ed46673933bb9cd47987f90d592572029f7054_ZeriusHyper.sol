...
contract ZeriusHyper is HypERC721, ReentrancyGuard {
    /************
     *   ERRORS *
     ************/
    /**
     ...
     */
    error ZeriusHypNFT721_CoreError(uint256 errorCode);
     ...
     *
     * @dev emits {ZeriusHyper-MintFeeChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-BridgeFeeChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-ReferralEarningBipsChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-EarningBipsForReferrerChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-EarningBipsForReferrersChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-FeeCollectorChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-TokenURIChanged}
     */
     ...
     *
     * @dev emits {ZeriusHyper-TokenURILocked}
     */
    ...
    /**
     * @notice Mint new Zerius HypNFT
     * @dev new token ID must be in range [startMintId - maxMintId]
     * @dev tx value must be equal to mintFee. See {ZeriusHyper-mintFee}
     * @dev emits {ZeriusHyper-HypNFTMinted}
     */
     ...
     * @dev emits {ZeriusHyper-ONFTMinted}
     */
     ...
     * @dev emits {ZeriusHyper-FeeEarningsClaimed}
     */
     ...
     *
     * @dev earned amount must be more than zero to claim
     * @dev emits {ZeriusHyper-ReferrerEarningsClaimed}
     */
    ...
    function _validate(bool _clause, uint8 _errorCode) internal pure {
        if (!_clause) revert ZeriusHypNFT721_CoreError(_errorCode);
    }
}
