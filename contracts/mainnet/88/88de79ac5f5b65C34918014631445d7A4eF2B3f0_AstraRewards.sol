...
contract AstraRewards is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(rewardToken_ != address(0), "Astra: reward token is zero");

        _rewardToken = rewardToken_;
        for (uint256 i = 0; i < signers_.length; i++) {
            require(signers_[i] != address(0), "Astra: signer is zero");
    ...
    function claim(
        ...
        uint256 totalValue = 0;
            require(_claimedAddress[msg.sender] == false, "Astra: already claim");
