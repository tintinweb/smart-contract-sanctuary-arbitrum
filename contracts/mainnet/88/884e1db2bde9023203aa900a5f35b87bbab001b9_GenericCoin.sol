...
contract GenericCoin is ERC20 {
    ...
    // Recover tokens that were accidentally sent to the contract.
    function recover(address tokenAddress) public onlyOwner {
