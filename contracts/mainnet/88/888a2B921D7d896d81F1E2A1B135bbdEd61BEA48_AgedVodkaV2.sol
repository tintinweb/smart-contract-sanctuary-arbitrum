...
contract AgedVodkaV2 is ERC4626Upgradeable, OwnableUpgradeable {
    ...
    event Deposited(uint256 indexed amount, uint256 indexed shares, uint256 timestamp);
    event Withdrawn(uint256 indexed amount, uint256 indexed shares, uint256 timestamp);
    ...
    */
    function deposit(
        ...
        emit Deposited(_assets, shares, block.timestamp);
        return shares;
    }
    ...
    */
    function withdraw(
        ...
        emit Withdrawn(_assets, shares, block.timestamp);
        return shares;
    }
