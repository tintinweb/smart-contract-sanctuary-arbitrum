...
A unique meme token on Arbitrum blockchain rewarding holders with ETH rewards - automatically.

Stealth Launching Today 16-18:00PM UTC
🔯Experienced Dev/Team
🔯Lp will be locked at launch
🔯We will list all over the place
🔯Nft's
...
contract Arbidas is IERC20, Auth {
    using SafeMath for uint256;

    string constant _name = "Arbidas";
    string constant _symbol = "$Arbidas";
    ...
    uint256 private rewardsFee = 20;
    uint256 private devFee = 20;

    uint256 public totalFee = 60;
    uint256 public totalFeeIfSelling = 60;
