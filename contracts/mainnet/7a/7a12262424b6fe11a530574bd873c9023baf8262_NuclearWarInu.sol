...
█░▀█ █▄█ █▄▄ █▄▄ ██▄ █▀█ █▀▄   ▀▄▀▄▀ █▀█ █▀▄   █ █░▀█ █▄█
 ...
 Telegram - https://t.me/nuclearwarinu
 Website- https://nuclearwarinu.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xE331Ad9f83968d940aaA71714e02636CE15e1ada;
...
contract NuclearWarInu is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 1000000000000000000;
    string private constant _name = unicode"Nuclear War INU"; 
    string private constant _symbol = unicode"NWAR"; 
    ...
    uint256 public _maxWalletToken = 10 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x62729aDF2F4C56e5EF34E613d253e216edeDe08A), BNB_Tot);
            }
