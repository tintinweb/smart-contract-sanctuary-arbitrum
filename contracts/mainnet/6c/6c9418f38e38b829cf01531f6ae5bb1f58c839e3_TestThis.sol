...
contract TestThis is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TestThis3";
    string private constant _symbol = "TTS3";
    ...
    address payable private _developmentAddress = payable(0x342832879274C3d1B1DDe2B21352c54897A0F9cc);
    address payable private _marketingAddress = payable(0xC4C831f2e4c566C82ab4E3c604F743ffE3742Cf8);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public {
        ...
        require(taxFeeOnBuy <= 4);
        require(taxFeeOnSell <= 4);
        require(redisFeeOnBuy <= 1);
        require(redisFeeOnSell <= 1);
