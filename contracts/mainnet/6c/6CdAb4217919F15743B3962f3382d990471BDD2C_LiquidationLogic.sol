...
library GenericLogic {
    ...
    function _getUserBalanceInBaseCurrency(
        ...
        uint256 balance = (
            IScaledBalanceToken(reserve.mTokenAddress)
                .scaledBalanceOf(user)
...
library LiquidationLogic {
    ...
    function executeLiquidationCall(
        ...
        vars.userCollateralBalance = vars.collateralMToken.balanceOf(
            params.user
        );
        ...
        if (vars.liquidationProtocolFeeAmount != 0) {
            ...
            // To avoid trying to send more mTokens than available on balance, due to 1 wei imprecision
    ...
    function _liquidateMTokens(
        ...
        uint256 liquidatorPreviousMTokenBalance = IERC20(vars.collateralMToken)
    ...
    function _getConfigurationData(
        ...
        DataTypes.ReserveData storage collateralReserve,
        DataTypes.ExecuteLiquidationCallParams memory params
    ) internal view returns (IMToken, address, address, uint256) {
...
library ReserveLogic {
     ...
     * @param reserve The reserve object
     * @param mTokenAddress The address of the overlying atoken contract
    ...
    function init(
        ...
        require(
            reserve.mTokenAddress == address(0),
...
library ValidationLogic {
    ...
    function validateSupply(
        ...
        require(
            supplyCap == 0 ||
                ((IMToken(reserveCache.mTokenAddress).scaledTotalSupply() +
