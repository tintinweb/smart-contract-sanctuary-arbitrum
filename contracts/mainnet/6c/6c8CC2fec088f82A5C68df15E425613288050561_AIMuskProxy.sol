...
// File contracts/AIMuskProxy.sol


contract AIMuskProxy is TransparentUpgradeableProxy {
    constructor(address _logic, address _admin) TransparentUpgradeableProxy(_logic, _admin, ""){}

    function mGetAdmin() public view returns(address) {
        return _admin();
    }

    function mGetImplementation() public view returns(address) {
