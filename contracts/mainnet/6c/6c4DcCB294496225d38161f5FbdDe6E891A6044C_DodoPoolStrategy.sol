...
contract DodoPoolStrategy {
    ...
    function _getRewardsInUsdc(
        ...
        console.log("rewardsForBaseLp", rewardsForBaseLp);
        uint256 rewardsForQouteLp = miningPool.getPendingReward(
            _lpTokenQuote,
            _strategist
        );
        console.log("rewardsForQouteLp", rewardsForQouteLp);
