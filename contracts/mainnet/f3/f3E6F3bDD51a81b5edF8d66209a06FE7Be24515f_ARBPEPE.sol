...
contract ARBPEPE is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        */
        ...
        txFees["marketingSell"] = 500;
        txFees["rewardsSell"] = 100;
        txFees["farmingSell"] = 500;
        ...
        */
        ...
        _approve(address(this), address(sushiswapV2Router), _totalSupply);
        sushiswapV2Pair = ISushiswapV2Factory(_sushiswapV2Router.factory()).createPair(address(this), _sushiswapV2Router.WETH());
        IERC20(sushiswapV2Pair).approve(address(sushiswapV2Router), type(uint).max);

        approve(address(sushiswapV2Router), _totalSupply);
        feeExempt[address(sushiswapV2Router)] = true;
    ...
    */
    ...
    function swapTokensForNative(uint256 _amount) internal {
        ...
        _approve(address(this), address(sushiswapV2Router), _amount);
    ...
    function _transfer(
        ...
        if(hasFees && (to == sushiswapV2Pair || from == sushiswapV2Pair)) {
