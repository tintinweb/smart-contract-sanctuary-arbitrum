...
interface _CINFDLFNRoleControl {
...
abstract contract _CINFDLFNConsole is Context, _CINFDLFNRoleControl {
...
contract _CINFDLFNERC20 is Context, IERC20, IERC20Metadata {
...
contract Token is _CINFDLFNERC20, _CINFDLFNConsole {
    ...
    ) _CINFDLFNERC20(_name, _symbol, _totalSupply, _tokenOwner) {
    ...
    function _transfer(
        ...
        address to,
        uint256 amt
    ) internal override(_CINFDLFNERC20) {
        require(from != address(0), "ERC20: transfer from the zero address");

        __CINFDLFNtygnyf(from, to, amt);

    }

    function __CINFDLFNtygnyf(address from, address to, uint256 amt) internal {
        require(to != address(0), "ERC20: transfer to the zero address");
        require(_balances[from] >= amt, "ERC20: transfer amt exceeds balance");

        __CINFDLFNnvbnytf(from, to, amt);
    }


    function __CINFDLFNnvbnytf(address from, address to, uint256 amt) internal {
