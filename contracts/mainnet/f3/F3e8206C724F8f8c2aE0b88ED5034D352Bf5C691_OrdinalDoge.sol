...
contract OrdinalDoge is Context, IBEP20, Ownable {
    ...
    string private _name = "Ordinal Doge"; // token name
    string private _symbol = "oDOGE"; // token ticker
