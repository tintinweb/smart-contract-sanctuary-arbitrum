...
contract StakedMlp {
    ...
    function transferFrom(
        ...
        uint256 nextAllowance = allowances[_sender][msg.sender].sub(
            _amount,
            "StakedMlp: transfer amount exceeds allowance"
        );
    ...
    function _transfer(
        ...
        require(
            mlpManager.lastAddedAt(_sender).add(mlpManager.cooldownDuration()) <= block.timestamp,
            "StakedMlp: cooldown duration not yet passed"
        );
