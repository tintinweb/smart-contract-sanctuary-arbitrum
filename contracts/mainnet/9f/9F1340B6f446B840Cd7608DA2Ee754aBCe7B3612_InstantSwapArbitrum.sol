...
import "../interfaces/IRouterReferer.sol";
import "@uniswap/v2-core/contracts/interfaces/IUniswapV2Factory.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "../interfaces/IWETH.sol";

abstract contract InstantSwapReferrer is Ownable {
    ...
    function UNISWAP_V2_ROUTER() internal pure virtual returns (IRouterReferer);
    ...
    function swapExactETHForTokens(
        ...
        if (tokenOut == WETH) {
            ...
            UNISWAP_V2_ROUTER().swapExactETHForTokensSupportingFeeOnTransferTokens{
                value: amountInSub
            }(_amountOutMin, _path, msg.sender, teamWalletAddress, block.timestamp);
            if (teamAmount > 0) {
...
import "./base/InstantSwapReferrer.sol";
