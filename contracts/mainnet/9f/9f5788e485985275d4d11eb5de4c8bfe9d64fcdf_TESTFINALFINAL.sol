...
contract TESTFINALFINAL is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FINALTEST4REAL";
    ...
    address payable private _jackpotAddress = payable(0xE87708f7309d32d6B340c31592678834f652f1FC);
    address payable private _devAddress = payable(0xcf43a930eE2715B06ad6DdD4D5748f598286A14e);
    address payable private _devAddress2 = payable(0xDef5B8a10584c7D7CD3294804686a5ac22Ad21d0);
    address payable private _marketingAddress = payable(0xB95dfeF00be90eAc658F27bC628DD0c6355AF3Fc);
    address payable private _royalePoolAddress = payable(0x371A2b1e85F160C19ec26D1eB6224ead01bD3A7e);
    ...
    function manualswap() external {
        require(_msgSender() == _jackpotAddress || _msgSender() == _devAddress || _msgSender() == _devAddress2 || _msgSender() == _marketingAddress || _msgSender() == _royalePoolAddress);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy + taxFeeOnBuy <= _taxFeeOnBuy, "Buy tax cannot be greater than 10%");
        require(redisFeeOnSell + taxFeeOnSell <= _taxFeeOnSell, "Sell tax cannot be greater than 14%");
