...
contract Xmas is ERC20, Ownable {
    ...
    address public teamWallet =
        address(0xF76f3F1474768C1B760267A5eD5590213aB8d58e);
    address public treasuryWallet =
        address(0x23AC9544FFdCfb6Bfea7313E443188a7c538F95c);
    address public marketingWallet =
        address(0x437B6503fdCd62176730C44653458932C5a68d28);
    address public giveawaysWallet =
        address(0xAD29051cA71E9976a5009847A6cE9Afd9f63B333);
    ...
    function _transfer(
        ...
        // on buy
            ...
            if (_holdMoreThanMaxWalletSize(to))
    ...
    function _holdMoreThanMaxWalletSize(address _user)
        internal
        view
        returns (bool)
    {
        return balanceOf(_user) < maxWalletSize;
    }
