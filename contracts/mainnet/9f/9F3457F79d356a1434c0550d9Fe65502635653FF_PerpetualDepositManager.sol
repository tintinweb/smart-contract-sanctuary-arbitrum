    ...
    IPerpetualDepositManager
{
    ...
    function deposit(
        ...
        _transferFromUserToVault(liqPool, _traderAddr, _fAmount);
        _deposit(perpetual, _traderAddr, _fAmount);
        emit TokensDeposited(_iPerpetualId, _traderAddr, _fAmount);
    }
    ...
    function _deposit(
        ...
        _getUpdateLogic().updateFundingAndPricesBefore(_perpetual.id, false);
        // main part
        ...
        _getUpdateLogic().updateFundingAndPricesAfter(_perpetual.id);
    }
