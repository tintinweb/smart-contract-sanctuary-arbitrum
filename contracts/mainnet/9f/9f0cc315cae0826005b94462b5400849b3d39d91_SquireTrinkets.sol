...
contract SquireTrinkets is ERC1155, Ownable {

    enum ItemType { RING, POTION, TRINKET }

    uint256 thisType = uint(ItemType.TRINKET);

    //mappings
    mapping(address => bool) private allowedContracts;

	string public _baseURI = "ipfs://QmRvX9eRwPyaEM4m5VzXbU3g4156AFy4u6BGVzvvxUY5uX/";
