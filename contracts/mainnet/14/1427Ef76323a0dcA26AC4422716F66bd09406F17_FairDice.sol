...
// FAIR DICE is an ERC20 with a gambling function built in.
// t.me/fair_dice
// Call ROLL() with the amount of bet, then REVEAL() to see whether you won or lost!
// Fair dice with no house edge (edge = 0)
// 2% buy, 6% sell fee used to build LP. 0% dev or marketing fee
// 5% max wallet limit, 3% max txn limit
...
contract FairDice is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
