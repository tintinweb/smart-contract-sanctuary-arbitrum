    ...
    function _calculateGame(
        ...
        for (uint8 i = 0; i < _randomWords.length; i++) {
            ...
            if (_session.target <= multiplier_) {
                paidAmount_ +=
                    _calculateReward(_session.sentValue, _session.target) /
                    _randomWords.length;
            }
        }
...
import "../assets/interfaces/IConsole.sol";
import "../assets/interfaces/IGame.sol";
import "../assets/interfaces/IRNG.sol";
import "../assets/interfaces/IVault.sol";
...
import "./assets/interfaces/ICore.sol";
