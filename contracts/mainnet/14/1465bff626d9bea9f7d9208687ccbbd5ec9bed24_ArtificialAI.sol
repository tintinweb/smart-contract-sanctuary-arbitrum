...
contract ArtificialAI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Artificial AI";
    ...
    address payable private _developmentAddress = payable(0x1395d6bCA1324294Bd29999EAc033aFD8279c2BB);
    address payable private _marketingAddress = payable(0x101597e261E18244cD300a426d5f53cdE078CaDF);
