...
import {LevelMasterV2} from "src/farm/LevelMasterV2.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import {ArbAddresses} from "../Constants.s.sol";

interface IBurnable {
    function burn(uint amount) external;
}

contract RecallLevelMaster is LevelMasterV2 {
    function discardReward(address _rewardToken, uint256 amount) external onlyOwner {
        IBurnable(_rewardToken).burn(amount);
    }
}

contract RecallPreLvlFromChef is Test {
    function test_recall_pre_lvl_from_chef() external {
        vm.createSelectFork("arbitrum");

        address impl = address(new RecallLevelMaster());
        vm.startPrank(ArbAddresses.multisig);
        {
            address payable lvlMaster = payable(0x0180dee5Df18eBF76642e50FaaEF426f7b2874f7);
            ProxyAdmin(ArbAddresses.proxyAdmin).upgrade(IProxy(lvlMaster), impl);
            RecallLevelMaster(lvlMaster).discardReward(ArbAddresses.LVL, 13900 ether);
            RecallLevelMaster(lvlMaster).discardReward(ArbAddresses.PRE_LVL, 75000 ether);
        }
        {
            address payable preLvlMaster = payable(0xC18c952F800516E1eef6aB482F3d331c84d43d38);
            ProxyAdmin(ArbAddresses.proxyAdmin).upgrade(IProxy(preLvlMaster), impl);
            RecallLevelMaster(preLvlMaster).discardReward(ArbAddresses.PRE_LVL, 5700 ether);
        }
        vm.stopPrank();
    }
}
...
library ArbAddresses {
    ...
    address constant proxyAdmin = 0xC1190d736a0866601821b04791D4b7375bECC85B;
    address constant deployer = 0x6442b001c5AcCE8cb71986ad65B22684821A927A;
    address constant multisig = 0x3d883658C55210c353506f57B02D11EaBAcE6F7f;
    ...
    address constant pool = 0x32B7bF19cb8b95C27E644183837813d4b595dcc6;
    address constant orderManager = 0x2215298606C9D0274527b13519Ec50c3A7f1c1eF;
    address constant snrLLP = 0x5573405636F4b895E511C9C54aAfbefa0E7Ee458;
    address constant mzeLLP = 0xb076f79f8D1477165E2ff8fa99930381FB7d94c1;
    address constant jnrLLP = 0x502697AF336F7413Bb4706262e7C506Edab4f3B9;

    address constant LVL = 0xB64E280e9D1B5DbEc4AcceDb2257A87b400DB149;
    address constant LGO = 0xf8ec3c8625F9fC8034C8eA62c5Ae71dCBE073214;
    address constant PRE_LVL = 0x964d582dA16B37F8d16DF3A66e6BF0E7fd44ac3a;
    address constant LVL_USDT = 0xc11cFF8A44853A5B3F24a7F4B817E6e64fbEBA2a;
    address constant Pancake_LVL_USDT = 0x4c7cC7DdbC0530cafde9cFbc55F7583Fe71C7171;

    address constant ETH_UNWRAPPER = 0x38EE8A935d1aCB254DC1ae3cb3E3d2De41Fe3e7B;

    address constant LVL_USDT_LPV2 = 0xc11cFF8A44853A5B3F24a7F4B817E6e64fbEBA2a;

    address constant daoTreasury = 0x635aaC65f37a6bbE06a2dde77B0fD2F1748674d4;
    address constant timelock = 0x5DBe6E2d86f046E827d675Ba7E6234eC513Ac25A;

    address constant FEE_DISTRIBUTOR = 0x22e1C1C3A0725DaDa2faF0fB6874d9E79bFa1f50;
    address constant LVL_OMNI_STAKING = 0x23c2d94404fd489Fb9CA25fFE412E86e07428597;
}

library BscAddresses {
    address constant proxyAdmin = 0x8f886b4b10344289cEAd777953f95FA0317bcD33;
    address constant devProxyAdmin = 0x3fF830dbC1CF4dCA3c16203F2F29CE48C2E83CE8;
    address constant dev2ProxyAdmin = 0x29C267f68c8C53c40224e98310d66E1537c933e4;
    address constant timelock = 0x360071D15cce5542E6B7209752eA479b84b28625;
    address constant deployer = 0x6442b001c5AcCE8cb71986ad65B22684821A927A;
    address constant multisig = 0x6023C6afa26a68E05672F111FdbB1De93cBAc621;

    address constant LVL = 0xB64E280e9D1B5DbEc4AcceDb2257A87b400DB149;
    address constant PRE_LVL = 0x486060269E576F79Fbf8861F4C9c440945b57498;
    address constant LGO = 0xBe2B6C5E31F292009f495DDBda88e28391C9815E;
    address constant LVL_USDT = 0x69d6B9a5709eEad2C6568c1F636B32707eA55A7e;

    address constant pool = 0xA5aBFB56a78D2BD4689b25B8A77fd49Bb0675874;
    address constant orderManager = 0xf584A17dF21Afd9de84F47842ECEAF6042b1Bb5b;
    address constant snrLLP = 0xB5C42F84Ab3f786bCA9761240546AA9cEC1f8821;
    address constant mzeLLP = 0x4265af66537F7BE1Ca60Ca6070D97531EC571BDd;
    address constant jnrLLP = 0xcC5368f152453D497061CB1fB578D2d3C54bD0A0;
    ...
    address constant ETH_UNWRAPPER = 0x3d54A363bC92a2da545f39a0F09dE62a2cC7E62d;

    address constant LVL_USDT_LPV2 = 0x69d6B9a5709eEad2C6568c1F636B32707eA55A7e;
    address constant LVL_BNB_LPV2 = 0x70f16782010fa7dDf032A6aaCdeed05ac6B0BC85;

    address constant daoTreasury = 0x8BFf27E9Fa1C28934554e6B5239Fb52776573619;
    address constant FEE_DISTRIBUTOR = 0x63B487204A76bA4962d384Dc41F7B06e880c8d80;
    address constant LVL_OMNI_STAKING = 0x890Ca1A86269F26644B758394dCC06e862863500;
}

library ChapelAddresses {
    address constant PROXY_ADMIN = 0x902297752793A5b1854a6702f21674591b4f9368;
    address constant deployer = 0x962B5B9a4D512c21512Bf24197C94E199A6ce8c5;

    address constant LVL = 0x0f45eD1F06d2442d18B73Ab49AC5f1b8FB51211e;
    address constant PRE_LVL = 0x16BC1C43178E3F3e2d54A8Bd243BE3058fC50b93;
    address constant LGO = 0xBC13a557fb262398660E5A436A38CCc38086C254;
    address constant LVL_USDT = 0xd0df717D94f900Fa12e2BF0AB88D3D376d5BD576;

    address constant POOL = 0x339e42dFd61f4f4D1Be5D6D4b422FC571eC948DD;
    address constant ORDER_MANAGER = 0x392d828eEE93d01E164E4AE6977a8a5Ef8923214;
    address constant snrLLP = 0x840FFC777d9946417c07df1f85f8f5835270ee4a;
    address constant mznLP = 0x39007531cc3E86F52DDBd1fb9a93e1D67008a7a5;
    address constant jnrLLP = 0x58C5D5082c24128C087dE52269b26c91bDcb7cD8;

    address constant NATIVE = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    address constant WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address constant BTC = 0xdb87048a45c75F077eCEE18b0C344Eb167CBBb42;
    address constant ETH = 0x9e421F4606ec42Cd7F88260419566c9f233Cfa98;
    address constant USDT = 0x2F964CBa95FB30183084D0B8d672D819aD080e00;
    address constant BUSD = 0x14C6cD8582eC95cE3E6FA5e6FDDF0b994717B55b;
    address constant CAKE = 0x6FbF1AA3cB4CF6E00F9431828439333eA10215ba;

    address constant ETH_UNWRAPPER = 0x253B5Dc9e050436A2A353A8C2F36aE8E550746c3;

    address constant STAKING_V1 = 0x97eE199C698E62DF09693b9E7723796fb551c406;
    address constant FEE_DISTRIBUTOR = 0xf918538CADA2626ed346407FCC08c1f02d940Ecb;
    address constant DAO_TREASURY = 0xB9CF4A7AE795d393a6EE142555715457b8D9DaD8;

    address constant DAO_STAKING = 0xa744b864fE9Ca8E7cD227cfe8eC975840d457EA8;
    address constant LVL_OMNI_STAKING = 0x74ef6F365AD66A6680528221533AF4866F75c60F;
    address constant LVL_USDT_OMNI_STAKING = 0xA10b7Ae58A4D49496813e6731966CA7704b7Ddff;
    address constant LVL_DAO_STAKING = 0x1af2a9EdCe361795c837d1FA4DF02Bc968E7ec27;
    address constant LVL_USDT_DAO_STAKING = 0x490d8D6B8BcfaC6C3fa97dA58676dAbb6F82a141;
}
