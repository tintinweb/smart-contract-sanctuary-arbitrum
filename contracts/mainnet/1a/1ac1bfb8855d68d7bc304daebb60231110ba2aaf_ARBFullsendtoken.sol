...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8); //eth
...
contract ARBFullsendtoken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Fullsendtoken";
    string constant _symbol = "FTS";
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Sushi
    address RewardToken = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8; //ETH

    uint256 _totalSupply = 10 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 0.2 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // 
        autoLiquidityReceiver = 0x425C19F9958b18236Ddd1f884a36dF1b550bC416;
        marketingWallet = 0x425C19F9958b18236Ddd1f884a36dF1b550bC416;
        devWallet = 0x425C19F9958b18236Ddd1f884a36dF1b550bC416;
