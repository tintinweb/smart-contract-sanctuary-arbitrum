...
import "./Fiat24CryptoDeposit.sol";
...
contract F24Offramp {
    ...
    IERC20 public constant USD24 = IERC20(0xbE00f3db78688d9704BCb4e0a827aea3a9Cc0D62);
    IERC20 public constant EUR24 = IERC20(0x2c5d06f591D0d8cd43Ac232c2B654475a142c7DA);
    IERC20 public constant USDC = IERC20(0xaf88d065e77c8cC2239327C5EDb3A432268e5831);

    Fiat24CryptoDeposit fiat24 = Fiat24CryptoDeposit(0x4582f67698843Dfb6A9F195C0dDee05B0A8C973F);

    /**
    * @notice Uses uniswap v3 pool to swap from EUR24 to USDC
    * @param _amount The amount of reward token to swap
    */
    function swapEur24ToUsdc(uint256 _amount) external returns (uint256){
        // msg.sender must approve this contract
        console.log("Fiat24 User balance of EUR24 before: %s", EUR24.balanceOf(msg.sender));
        uint256 usdAmount = fiat24.moneyExchangeExactIn(address(EUR24), address(USD24), _amount);
        console.log("Fiat24 User balance of EUR24 after: %s", EUR24.balanceOf(msg.sender));

//         Approve the router to spend reward token.
        if (USD24.allowance(address(this), address(swapRouter)) < usdAmount)
            TransferHelper.safeApprove(address(USD24), address(swapRouter), usdAmount);

        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter.ExactInputSingleParams({
            tokenIn: address(USD24),
