...
contract AICORE is ERC20Capped, Ownable {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;

    uint256 public constant MAX_CAP = 21_000_000 * 1e18;
    ...
    constructor() ERC20Capped(MAX_CAP) ERC20("AICORE", "AICORE") {
        canAddLiquidityBeforeLaunch[_msgSender()] = true;
        canAddLiquidityBeforeLaunch[address(this)] = true;
        _mint(_msgSender(),50000000000000000000000);
    }
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, "AICORE: ETH_TRANSFER_FAILED");
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AICORE: pair is the zero address");
