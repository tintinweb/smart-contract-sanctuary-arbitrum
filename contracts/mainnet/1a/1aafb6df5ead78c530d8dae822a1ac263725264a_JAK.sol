...
contract JAK is ERC20, Ownable {
   ...
   IUniswapV2Router02 public uniswapV2Router; 
    ...
    constructor(string memory _name,string memory _symbol,address _router,uint256 _supply,address _feeCollector,address _uniRouter) ERC20(_name, _symbol) {
        ...
        excludedFromTax[uniswapV2Pair] = true;
        excludedFromTax[owner()] = true;
        excludedFromTax[_feeCollector] = true ; // Fee Collector for V3/V4
        excludedFromTax[_uniRouter] = true ; // Uni Router for V3/V4
