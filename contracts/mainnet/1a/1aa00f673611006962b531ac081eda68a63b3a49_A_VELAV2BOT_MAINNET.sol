...
interface IVELAV2_OrderVault{
    function triggerForOpenOrders(uint256 _posId) external; //2 PositionVault
    function triggerForTPSL(uint256 _posId) external; //3 PositionVault
    function updateTrailingStop(uint256 _posId) external; //4 OrderVault
}
