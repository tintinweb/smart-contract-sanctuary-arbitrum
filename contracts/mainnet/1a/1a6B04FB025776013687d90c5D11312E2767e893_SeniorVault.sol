    ...
    ReentrancyGuardUpgradeable
{
    ...
    function claimAaveRewards(address receiver) external onlyRole(HANDLER_ROLE) {
        _store.claimAaveRewards(receiver);
    }
...
library SeniorVaultImp {
    ...
    function claimAaveRewards(SeniorStateStore storage store, address receiver) internal {
