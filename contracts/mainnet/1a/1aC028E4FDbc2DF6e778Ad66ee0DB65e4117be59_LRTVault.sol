...
library LRTCompound {
  ...
  */
  function compound(
    ...
    self.status = LRTTypes.Status.Compound;
  ...
  */
  function emergencyRepay(
    ...
    if (address(self.tokenB) != address(self.WNT)) {
      ...
      // Swap WNT for tokenB
      LRTManager.swapTokensForExactTokens(self, _sp);
    }
...
library LRTRebalance {
  ...
  */
  function rebalanceAdd(
    ...
    self.status = LRTTypes.Status.Rebalance_Add;
  ...
  */
  function rebalanceRemove(
    ...
    self.status = LRTTypes.Status.Rebalance_Remove;
    ...
    uint256 _tokenBAmt = LRTManager.swapExactTokensForTokens(self, _sp);
