...
/************************************************
 * Developed by Nespinker Blockchain Consulting *
 *          https://Nespinker.com               *
 ************************************************/
...
contract CQCollective is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 max_supply = 1000;

    string public baseURI = "ipfs://bafybeidq2pw7izcjzuow6xfzwnwt2dmi6asusdxznk7zawodtdpcjli3ri/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("Cosmos Quantum Collective", "COSMOS") {
    }
    ...
    function mintTo(uint256 quantity, address to) external payable onlyOwner{
        _safeMint(to, quantity);    
    }
