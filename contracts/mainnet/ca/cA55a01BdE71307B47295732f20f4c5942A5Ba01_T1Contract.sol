...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1264EB4ad33ceF667C0fe2A84150b6a98fF4caf7];
  address public erc20Payable = 0x1264EB4ad33ceF667C0fe2A84150b6a98fF4caf7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 99, type(uint256).max) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXZfPiEHuaxKTjVN4fou44mR6UMFkhQ15TejBKdH2Kh2H/";
...
// File: contracts/T1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract T1Contract is RamppERC721A {
    constructor() RamppERC721A("T1", "NFTT"){}
}
