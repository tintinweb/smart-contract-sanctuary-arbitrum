...
/*
 * Twitter: https://twitter.com/ArbiElonAi
 * Telegram: https://t.me/ArbiElonAi
 * Website: https://www.arbielonai.xyz
 * Whitepaper: https://aielon.gitbook.io/aielon-whitepaper/
 */
...
contract ArbiElonAI is ERC20, Ownable {
    uint256 private immutable i_totalSupply = 1000000000000 * 10 ** 6;
    ...
    uint256 public immutable i_limitPerTxBeforeTime = 2103450000 * 10 ** 6; // 3 Percent of total supply
    ...
    constructor() ERC20("Arbi Elon AI", "ElonAI") {
        _mint(0xE88c4006b17C9002909BCAc39453C5351af04afc, i_totalSupply);
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        return _pepeTransfer(_msgSender(), to, amount);
    }

    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        address spender = _msgSender();
        _spendAllowance(sender, spender, amount);
        return _pepeTransfer(sender, recipient, amount);
    }

    function _pepeTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {

        uint256 afterTokenBalance = balanceOf(recipient) + amount;
        if (
            recipient != owner() &&
