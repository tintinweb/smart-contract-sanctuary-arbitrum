...
/**
 * @title PlatyPuusToken  (PPT)
 * @notice
 */
contract PlatyPuusToken is ERC20, Ownable, PPT {
    ...
    constructor(
        ...
        uint256 _cap
    ) public ERC20("PlatyPuusToken", "PPT") {
        require(
            _cap >= _premintAmount,
            "PPT: Premint amount is greater than cap"
        );
