...
// File contracts/PRFCT/infra/PrfctFeeConfigurator.sol

pragma solidity ^0.8.0;

contract PrfctFeeConfigurator is OwnableUpgradeable {
    ...
    function getFeeCategory(uint256 _id, bool _adjust) public view returns (FeeCategory memory fees) {
        ...
        if (_adjust) {
            ...
            fees.prfct = fees.prfct * _totalFee / DIVISOR;
    ...
    function setFeeCategory(
        ...
        uint256 prfct = DIVISOR - _call - _strategist;

        FeeCategory memory category = FeeCategory(_total, prfct, _call, _strategist, _label, _active);
        feeCategory[_id] = category;
        emit SetFeeCategory(_id, _total, prfct, _call, _strategist, _label, _active);
    }
