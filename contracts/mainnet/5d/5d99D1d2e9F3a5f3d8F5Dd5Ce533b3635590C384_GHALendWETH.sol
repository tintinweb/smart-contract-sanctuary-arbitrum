...
contract GHALendWETH is Ownable, ReentrancyGuard {
    ...
    uint256 public depositCap    = 10 * 1e18;
    uint256 public gmdDepositCap = 5 * 1e18;
    uint256 public borrowCap     = 4 * 1e18;
    ...
    constructor(uint256 _pid, uint256 _decimalGap) {
        ...
        TOKEN = GMDVault.poolInfo(pid).lpToken;
         // decimal handling. eg: gmdWETH and WETH gap 0 decimals (18-18)
