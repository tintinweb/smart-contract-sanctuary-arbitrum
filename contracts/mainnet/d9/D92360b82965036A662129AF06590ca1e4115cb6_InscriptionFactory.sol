...
contract Inscription is ERC20, ReentrancyGuard {
    ...
    constructor(
        ...
        string memory _tick,            // token tick, same as symbol. must be 8 characters.
...
contract InscriptionFactory is Ownable{
    ...
    uint8 public maxTickSize = 8;                 // tick(symbol) length is 8.
    ...
    function deploy(
        ...
        require(strlen(_tick) == maxTickSize, "Tick lenght should be 8");
