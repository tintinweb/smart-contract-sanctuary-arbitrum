...
contract LockableRevealERC721EnumerableToken is IToken, ERC721Enumerable, Ownable, BlackHolePrevention, UsesGalaxisRegistry, IVersionable { 
    ...
    function getRandomSource() internal view returns (IRandomNumberProvider) {
        ...
        if (useCommunityRandom) {
            ...
            return IRandomNumberProvider(galaxisRegistry.getRegistryAddress(REGISTRY_KEY_RANDOM_CONTRACT));
        }
    }
...
contract OperatorFilteredToken is LockableRevealERC721EnumerableToken {
    ...
    constructor(address _galaxisRegistry) LockableRevealERC721EnumerableToken(_galaxisRegistry){
    }
