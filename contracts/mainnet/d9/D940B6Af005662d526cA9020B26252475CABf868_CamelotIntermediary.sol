...
/**
 * @dev CamelotIntermediary is an interface between the 'real' Camelot
 ...
 *
 * Camelot is a Uniswap V2 fork with small adjustments.
 *
 * The intermediary is able to charge a small fee on the swap.
 */
contract CamelotIntermediary is Ownable {
