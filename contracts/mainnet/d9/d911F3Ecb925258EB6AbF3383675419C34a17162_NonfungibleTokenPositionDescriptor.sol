...
import '@elkdex/v3-core/contracts/libraries/BitMath.sol';
...
library NFTDescriptor {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a ElkDex V3 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
...
/// @title NFTSVG
/// @notice Provides a function for generating an SVG associated with a ElkDex NFT
library NFTSVG {
    using Strings for uint256;
    ...
    function generateSVG(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        msg: "Forged in SVG for ElkDex in 2021 by 0xe8ab59d3bcde16a29912de83a90eb39628cfc163",
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xe22d3a2fb5297ba0b9be272a57e88f3cca469b6dcaa6f12f4436eb45ce4d0f2c;
...
import '@elkdex/v3-core/contracts/interfaces/IElkDexV3Pool.sol';
import '@elkdex/lib/contracts/libraries/SafeERC20Namer.sol';
