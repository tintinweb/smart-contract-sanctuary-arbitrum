...
contract PaymentModuleDiamondInit is AccessControl {
    ...
    function init(InitPaymentModuleDiamondArgs memory _input) external {
        ...
        require(_input.usdToken != address(0), "PaymentModuleDiamondInit: USD token address cannot be 0");
        require(_input.router != address(0), "PaymentModuleDiamondInit: Router address cannot be 0");
