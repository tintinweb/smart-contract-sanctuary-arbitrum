...
$ScimitArb is the first user-friendly Liquidity pool locker on Arbitrum, 
we're here with a purpose to make this space safe & user-friendly to everyone!

🐦 Twitter: https://twitter.com/Scimit_arb
📱 Telegram: https://t.me/ScimitARB
🌐 Website: https://scimitarb.finance/
...
contract ScimitArb is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "ScimitArb";

    string private _symbol = "ScimitArb";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xdaEB8D5023177FA2659E39fcD865934eC3d3bA49;
