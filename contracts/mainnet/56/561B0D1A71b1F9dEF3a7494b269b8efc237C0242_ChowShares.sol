...
import "./interfaces/ISharesDist.sol";
import "./interfaces/IUniswapV2Router02.sol";
import "./interfaces/IUniswapV2Factory.sol";

pragma solidity ^0.8.4;

contract ChowShares is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;

    address public sushiPair;
    address public sushiRouterAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // sushi Router
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOwner {
        require(_maxTransferAmountRate <= 10000, "Max transfer amount rate must not exceed the maximum rate.");
    ...
    function updatemaxBalanceAmountRate(uint16 _maxBalanceAmountRate) external onlyOwner {
        require(_maxBalanceAmountRate <= 10000, "Max transfer amount rate must not exceed the maximum rate.");
