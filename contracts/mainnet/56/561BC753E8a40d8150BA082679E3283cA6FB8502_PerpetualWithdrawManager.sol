    ...
    IPerpetualWithdrawManager
{
     ...
     * @param _traderAddr Address of the trader. This is either the message sender or an authorized delegate
    ...
    function withdraw(
        ...
        _withdraw(_iPerpetualId, _traderAddr, _fAmount);
    }
    ...
    function _withdraw(
        ...
        address _traderAddr,
        int128 _fAmount
    ) internal updateFundingAndPrices(_iPerpetualId) {
        require(
            _traderAddr == msg.sender || delegates[_traderAddr] == msg.sender,
            "only trader or dlgt"
        );
        PerpetualData storage perpetual = _getPerpetual(_iPerpetualId);
        MarginAccount storage account = marginAccounts[_iPerpetualId][_traderAddr];
        ...
        _rebalanceAndWithdraw(perpetual, _traderAddr, _fAmount);
    }
