...
contract MemeCoin is ERC20, Ownable{ 
    ...
    constructor() ERC20("Rollo Token", "Rollo") {
        
        router = ISwapRouter(0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24); // uniswap arbitrum mainnet
        // router = ISwapRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // uinswap eth mainnet
        // router = ISwapRouter(0x425141165d3DE9FEC831896C016617a52363b687); // unsiwap eth testnet
        // router = ISwapRouter(0x10ed43c718714eb63d5aa57b78b54704e256024e); // pancake bsc mainnet
        // router = ISwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // pancake bsc testnet
        ...
        uint256 totalSupply = 6_600_000_000 * 1e18;
    ...
    // limit transaction amount
    uint256 public maxTxAmount = 3_300_000 * 1e18;
    function updateMaxTxAmount(uint256 value) external onlyOwner {
        require(value >= (totalSupply() * 1 / 1000) / 1e18, "Cannot set maxTxAmount lower than 0.05%");
        maxTxAmount = value * 1e18;
    }

    // limit wallet amount
    uint256 public maxWalletAmount = 6_600_000 * 1e18;
    function updateMaxWalletAmount(uint256 value) external onlyOwner{
        require(value >= (totalSupply() * 5 / 1000) / 1e18, "Cannot set maxWallet lower than 0.1%");
    ...
    // market fee
    uint256 public  marketFeeRate = 150; 
