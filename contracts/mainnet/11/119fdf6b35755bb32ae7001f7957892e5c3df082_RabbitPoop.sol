...
https://t.me/WhydoRabbitsPoopsSoMuch
...
contract RabbitPoop is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Why Do Rabbits Poops So Much?';
    string private constant _symbol = 'PELLETS';
    ...
    address internal constant development_receiver = 0xecF96e4B6ca44FddF287388e89Bbb305f37191e6; 
    address public constant marketing_receiver = 0xecF96e4B6ca44FddF287388e89Bbb305f37191e6;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(2 minutes) <= block.timestamp){totalFee = uint256(1000); sellFee =uint256(4000);}
        if(launchTime.add(4 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(4000);}
        if(launchTime.add(6 minutes) <= block.timestamp){totalFee = uint256(400); sellFee =uint256(2000);}
        if(launchTime.add(8 minutes) <= block.timestamp){totalFee = uint256(400); sellFee =uint256(1000);}
        if(launchTime.add(10 minutes) <= block.timestamp){totalFee = uint256(200); sellFee =uint256(400);
            ATLSCompletion = true;}
    }
    ...
    function AutomaticMaxLiftingSystem() internal {
        ...
        if(launchTime.add(24 hours) <= block.timestamp){
