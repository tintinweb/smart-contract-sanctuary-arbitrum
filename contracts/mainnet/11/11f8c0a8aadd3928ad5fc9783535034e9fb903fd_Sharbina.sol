...
contract Sharbina is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0xaa54e84A3e6e5A80288d2C2f8e36eA5cA3A3Ca30;
    address public marketingWallet = 0xA7C2CE2932cE6B3D5e6F5cea87bE154Ce67E6205;
    ...
    constructor() ERC20("Sharbina", "BINA") {
        ...
        tokenburnBuyFee = 20; // 2%, being used to buy and burn Sharbi
        marketingBuyFee = 280; // 
        totalBuyFees = 300; // 

        tokenburnSellFee = 20; // 2%, all being used to buy and burn Sharbi
        marketingSellFee = 680; // 
   ...
   function burnTargetToken(uint256 ethAmountInWei, address BurnToken) internal {
    ...
    function swapBack() private {
        ...
        // buy the Sharbi token and burn it
