...
/**
 * DefiGPT (GPT)
 * Official Community Chat - https://t.me/defigpt

 DefiGPT is a Defi project that is integrating AI to its crypto solutions auditing & scanning 
 newly launched tokens with deep analysis on dev's activities & smart contract in the blockchain
  in order to facilitate investors’ decisions to make the right choices about their investments.
...
contract DefiGPT is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        uniswapV2Router02 = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
        ...
        setTaxWallets(0xb6c6BeB069a29985b58e1DdA83336fA1f0740449); // 
        exclude(msg.sender);
