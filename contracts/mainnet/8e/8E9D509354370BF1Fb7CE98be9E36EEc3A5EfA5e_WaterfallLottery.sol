...
contract WaterfallLottery is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public jackpotTaxBuy = 700;
    uint256 public marketingTaxBuy = 200;
    uint256 public wltPoolTaxBuy = 50;
    uint256 public devOneTaxBuy = 50;
    uint256 public devTwoTaxBuy = 50;
    uint256 public devThreeTaxBuy = 50;
    uint256 public totalTaxBuy = 1100;
    //     Sell Tax or tax that will incur if you want to sell the token
    uint256 public jackpotTaxSell = 600;
    uint256 public marketingTaxSell = 300;
    uint256 public wltPoolTaxSell = 50;
    uint256 public devOneTaxSell = 50;
    uint256 public devTwoTaxSell = 50;
    uint256 public devThreeTaxSell = 50;
    uint256 public totalTaxSell = 1100;

    // private variables
    uint256 private jackpotTax;
    uint256 private liquidityTax;
    uint256 private marketingTax;
    uint256 private wltPoolTax;
    ...
    address payable private wltPoolWallet;
    ...
    constructor(
        ...
        address _wltPoolWallet,
        address _devOneWallet,
        address _devTwoWallet,
        address _devThreeWallet
    ) ERC20("Waterfall Lottery Ticket", "WLT") {
        uint256 _totalSupply = 777_777 * 1e18; // 1 million
        marketingWallet = payable(_marketingWallet);
        jackpotWallet = payable(_jackpotWallet);
        wltPoolWallet = payable(_wltPoolWallet);
    ...
    function transfer(
        ...
        return _wltTransfer(_msgSender(), to, amount);
    }
    ...
    function transferFrom(
        ...
        return _wltTransfer(sender, recipient, amount);
    }

    function _wltTransfer(
        address sender,
        address recipient,
        uint256 amount
