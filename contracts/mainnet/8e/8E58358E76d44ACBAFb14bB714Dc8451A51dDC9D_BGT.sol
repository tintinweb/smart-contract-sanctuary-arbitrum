...
contract BGT is ERC20, Ownable {
    ...
    function bridgeMint(address account, uint256 amount) external onlyAdmin {
        require(_totalBridgtSupply >= amount, "Not to exceed bridgeMint");
        _mint(account, amount);
        _totalBridgtSupply -= amount;
    }

    function bridgeBurn(uint256 amount) external onlyAdmin {
        _burn(msg.sender, amount);
        _totalBridgtSupply += amount;
    }
    ...
    function addProhibitFrom(address account) public onlyAdmin
    {
        _prohibitFrom[account] = true;
    }

    function removeProhibitFrom(address account) public onlyAdmin
    {
    ...
    function addProhibitTo(address account) public onlyAdmin
    {
        _prohibitTo[account] = true;
    }

    function removeProhibitTo(address account) public onlyAdmin
    {
