...
import {IArbitrageBroker, ICollateral, ILongShortToken, IPrePOMarket, ISwapRouter} from "./interfaces/IArbitrageBroker.sol";
  ...
  WithdrawERC20
{
    ...
    )
  {
    ...
    if (address(market) == 0xD14FF3165ddbe69C12Cb774326386f5d34a288Dc) {
      market.redeem(
    ...
    )
  {
    uint256 collateralBefore = _collateral.balanceOf(address(this));
    if (address(market) == 0xD14FF3165ddbe69C12Cb774326386f5d34a288Dc) {
      market.mint(tradeParams.longShortAmount, address(this));
    } else {
