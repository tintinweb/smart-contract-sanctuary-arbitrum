...
library Constants {
    /* Chain */
    uint256 private constant CHAIN_ID = 42161; // Arbitrum

    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 240; // 5 days
    ...
    address private constant CRV3 =
        address(0xb348B87b23D5977E2948E6f36ca07E1EC94d7328); // Anywhere the term CRV3 is refernenced, consider that as "peg", really
    ...
    uint256 private constant CURRENT_EPOCH_START = 1670481000;
    ...
    ERC20Burnable
{
    constructor()
        public
        ERC20Detailed("Fishbait", "BAIT", 18)
        Permittable()
    {}
        ...
        if (allowance(sender, _msgSender()) != uint256(-1)) {
            _approve(
                ...
                allowance(sender, _msgSender()).sub(
                    amount,
                    "Fishbait: transfer amount exceeds allowance"
                )
            );
        }
        return true;
