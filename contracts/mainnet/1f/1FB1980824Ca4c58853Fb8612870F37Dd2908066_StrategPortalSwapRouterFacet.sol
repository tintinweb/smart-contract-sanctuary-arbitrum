...
interface IStrategOperatingPaymentToken {
    ...
    function executePayment(address _payer, address _for, address _operator, uint256 _amount) external returns (bool);
...
import  "@murphy-labs/strateg-protocol-sopt/contracts/interfaces/IStrategOperatingPaymentToken.sol";
import  "@murphy-labs/strateg-protocol-sopt/contracts/interfaces/IWETH.sol";
...
import { LibParaswap } from "../libraries/LibParaswap.sol";
import { LibOneInch } from "../libraries/LibOneInch.sol";
import { LibPermit } from "../libraries/LibPermit.sol";
import { LibRelayer } from "../libraries/LibRelayer.sol";
...
library LibDiamond {
    ...
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    event SOPTSetup(address sopt);

    function setSOPT(address _sopt) internal {
        DiamondStorage storage ds = diamondStorage();
        ds.sopt = _sopt;
        emit SOPTSetup(_sopt);
    }
