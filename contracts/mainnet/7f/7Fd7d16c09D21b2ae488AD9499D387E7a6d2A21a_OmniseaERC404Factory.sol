...
contract OmniseaERC404Factory is IOmniseaERC404Factory, ReentrancyGuard {
    ...
    function create(CreateParams calldata _params) external override nonReentrant {
        OmniseaERC404Proxy proxy = new OmniseaERC404Proxy();
        address proxyAddress = address(proxy);
        IOmniseaERC404(proxyAddress).initialize(_params, msg.sender, _manager, scheduler);
