...
contract CoinFlipV3 is Ownable, ReentrancyGuard {
    IERC20 public token;
    ...
    constructor(address _token, address _authorized) {
        ...
        feeAmount = 4; // Percent fee on flip
    }
    ...
    function flip(uint256 _amount, uint256 _choose) public {
        ...
        if (!win) {
            ...
            uint256 doubleAmount = _amount * 2;
            // Minus fee
            uint256 fee = (doubleAmount * feeAmount) / 100;

            uint256 total = doubleAmount - fee;
