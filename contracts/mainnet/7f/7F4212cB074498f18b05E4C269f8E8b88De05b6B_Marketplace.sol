...
library MarketplaceLib {
        ...
        // transferring property tokens to user
        {
            ...
            if (amountToBringFromVaults > 0) {
                ...
                IERC20(swapArgs.from).safeApprove(
                    0x4bF08a3c5f59819293F47B7C2b8955865601fa4b,
                ...
                ISecondaryMarket(0x4bF08a3c5f59819293F47B7C2b8955865601fa4b).buyPropertyTokens(
                    swapArgs.to,
    ...
    function _sellPropertyHelper(
        ...
        ISecondaryMarket secondaryMp = ISecondaryMarket(0x4bF08a3c5f59819293F47B7C2b8955865601fa4b);
