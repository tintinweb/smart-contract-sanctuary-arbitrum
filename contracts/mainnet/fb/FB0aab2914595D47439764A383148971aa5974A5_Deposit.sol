...
contract Deposit is Ownable {
  ...
  function setCentralizeWallet(address _centralizeWallet) onlyOwner public {
    centralizeWallet = _centralizeWallet;
  }

  function sweepToken(address _tokenContract) onlyOwner public {
  ...
  function sweepNativeToken() onlyOwner public payable {
