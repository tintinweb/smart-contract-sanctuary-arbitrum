...
// main contract
contract Matrix_AI is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "MatrixAI";
    string private constant _symbol = "$MatrixAI";
    ...
    function setFees(
        ...
        require(
            totalBuyFee <= feeDenominator.div(100),
    ...
    function Burn(
        ...
        feeDenominator = _feeDenominator;
        require(
            totalSellFee <= feeDenominator.div(100),
            "Can't be greater than 10%"
        );
    }
