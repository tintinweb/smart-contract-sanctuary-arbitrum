...
contract DogeFanAI is Context, IERC20, Ownable {
    ...
    string private _name = "DogeFan AI";
    string private _symbol = "$DogeFAI";
    ...
    uint256 public snipingTime = 0 seconds; // snipping time
    ...
    constructor() {
        marketWallet = payable(0xfeaB81Ef4C24EFe11Bd596999A137FEc32223733);
        devWallet = payable(0xfeaB81Ef4C24EFe11Bd596999A137FEc32223733);
