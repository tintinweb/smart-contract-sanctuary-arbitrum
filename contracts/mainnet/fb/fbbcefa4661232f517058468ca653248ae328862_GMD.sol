...
contract GMD is ERC20("GMD", "GMD"), Ownable , ReentrancyGuard{ 
    ...
    function claimableTokens(address _address) external view returns(uint256) {
        ...
        uint256 claimable = userInfo[_address].totalMinted.mul(timePass).div(userInfo[_address].VestPeriod);
        return claimable;
    }
    ...
    function claim() external nonReentrant {
        ...
        uint256 claimable = userInfo[msg.sender].totalMinted.mul(timePass).div(userInfo[msg.sender].VestPeriod);
    ...
    function claim2() external nonReentrant {
        ...
        this.transferFrom(address(this), msg.sender, claimable);
    }
