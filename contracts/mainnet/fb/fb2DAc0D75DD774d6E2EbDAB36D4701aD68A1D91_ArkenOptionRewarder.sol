...
import '../../dex/interfaces/IArkenPairLongTerm.sol';
import '../interfaces/IArkenOptionRewarder.sol';
import '../interfaces/IArkenOptionNFT.sol';
    ...
    function _rewardLongTermByConfig(
        ...
        tokenId = IArkenOptionNFT(optionNFT).mint(
            ...
            IArkenOptionNFT.TokenData({
                unlockedAt: block.timestamp + config.lockTime,
                expiredAt: block.timestamp + config.expiredTime,
        ...
        emit RewardOptionNFT(
            tokenId,
            address(pair),
            block.timestamp + config.lockTime,
            block.timestamp + config.expiredTime,
            config.unlockPrice,
