...
contract PEPEGA is ERC20, Ownable {
    ...
    constructor() ERC20("PEPEGA", "PEPEGA") {
        ...
        marketingWallet = address(0x53464c5e376Ccb8e6828045eD9Ae2B5121a28e16); // set as marketing wallet
        devWallet = address(0x53464c5e376Ccb8e6828045eD9Ae2B5121a28e16); // set as dev wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0x53464c5e376Ccb8e6828045eD9Ae2B5121a28e16), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x53464c5e376Ccb8e6828045eD9Ae2B5121a28e16), true);
