...
// TELEGRAM :https://t.me/usdcrocketarb
//USDC Rocket will be a USDC printer - Contract will be renounced after launch
...
contract USDCRocket is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "USDCRocket";
    string constant _symbol = "RUSD";
    ...
    address routerAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address RewardToken = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x9Ae16A0A5e5dC33Fe223F28eBbAE07e357E0A46E;
        marketingWallet = 0x9Ae16A0A5e5dC33Fe223F28eBbAE07e357E0A46E;
        devWallet = 0x9Ae16A0A5e5dC33Fe223F28eBbAE07e357E0A46E;
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 50000}("");
        (bool tmpSuccess1,) = payable(devWallet).call{value: devShare, gas: 50000}("");
