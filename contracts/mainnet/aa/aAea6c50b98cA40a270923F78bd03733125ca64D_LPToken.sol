...
import "contracts/AMM/token/customERC1155/ERC1155Upgradeable.sol";
import "contracts/AMM/token/customERC1155/ERC1155BurnableUpgradeable.sol";
import "contracts/AMM/token/customERC1155/ERC1155PausableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/Initializable.sol";
import "contracts/AMM/interfaces/ILPToken.sol";
    ...
    ERC1155PausableUpgradeable
{
    ...
    mapping(uint64 => address) public override amms;

    event AmmAddressSet(uint64 indexed _ammId, address _ammAddress);
    ...
    /**
     * @notice transfers amount ERC1155 LP tokens from from to to
    ...
    function togglePause() external virtual {
        require(
            ...
            "LPToken: must have pauser role to unpause"
        );
    ...
    function setAmmAddress(uint64 _ammId, address _ammAddress) external {
        require(
            ...
            "LPToken: must have default admin role to set amm address"
        );
     ...
     * @return AMM id
     */
    function getAMMId(uint256 _id) external pure override returns (uint64) {
     ...
     * @return pair index
     */
    function getPairId(uint256 _id) external pure override returns (uint32) {
    ...
    function _createId(
        ...
        require(
            _ammId <= MAX_INT_64 &&
                _periodIndex <= MAX_INT_64 &&
                _pairId <= MAX_INT_32,
            "LPToken: id collision risk"
        );
