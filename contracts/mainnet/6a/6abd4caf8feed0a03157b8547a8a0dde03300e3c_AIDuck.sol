...
// File: contracts/interfaces/IShibaBonusPool.sol


pragma solidity >=0.5.0;

interface IShibaBonusPool {
...
// File: contracts/token/AIDuck.sol


pragma solidity =0.8.19;

contract AIDuck is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        IShibaBonusPool(bonusWallet).injectRewards(amountDogBonus);
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'AIDUCK: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "AIDUCK: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "AIDUCK: index out of bounds");
