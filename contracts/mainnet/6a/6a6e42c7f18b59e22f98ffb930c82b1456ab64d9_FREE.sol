...
contract FREE is IERC20 {
    ...
    uint256 public buyTaxPercentage = 15;
    uint256 public sellTaxPercentage = 15;
    address public taxAddress = 0x6eA158145907a1fAc74016087611913A96d96624;

    constructor() {
        _name = "Donate ZachXBT";
        _symbol = "FREE";
        _decimals = 9;
        _totalSupply = 10000000000 * (10**uint256(_decimals)); // 100亿代币
        _owner = msg.sender;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        uint256 taxAmount = amount.mul(buyTaxPercentage).div(100);
