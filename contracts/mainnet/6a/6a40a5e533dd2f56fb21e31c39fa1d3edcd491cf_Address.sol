...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _tokengeneration(address account)
        internal
        virtual
    {
...
contract ThisIsFine is ERC20, Ownable {
    ...
    uint256 public _totalSupply = 1e11 * 10**decimals();
    uint256 public maxWallet = (_totalSupply * 2) / 100; //2%
    ...
    mapping(address => bool) public isMaxWalletExept;
    ...
    constructor() ERC20("ThisIsFine", "$FINE") {
        ...
        if (block.chainid == 56) {
            ...
            router = IRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
        ...
        exemptFee[address(marketingWallet)] = true;
        exemptFee[address(devWallet)] = true;
        exemptFee[deadWallet] = true;
        exemptFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; // PinkLock
        exemptFee[0x663A5C229c09b049E36dCc11a9B0d4a8Eb9db214] = true; // Unicrypt (ETH)
        exemptFee[0xDba68f07d1b7Ca219f78ae8582C213d975c25cAf] = true; // Unicrypt (ETH)
        isMaxWalletExept[owner()];
        isMaxWalletExept[address(this)];
        isMaxWalletExept[pair];
        isMaxWalletExept[address(deadWallet)];
        isMaxWalletExept[address(marketingWallet)];
        isMaxWalletExept[address(devWallet)];
        isMaxWalletExept[address(router)];
    }
    ...
    function setMaxWallet(uint256 amount) external onlyOwner {
        require(amount >= _totalSupply / 50); //2%
        maxWallet = amount;
    }
    ...
    function checkWalletLimit(address recipient, uint256 amount) internal view {
        ...
        require(
            (heldTokens + amount) <= maxWallet || isMaxWalletExept[recipient],
    ...
    function updateExemptMaxWallet(address _address, bool state) external onlyOwner {
        isMaxWalletExept[_address] = state;
    }
