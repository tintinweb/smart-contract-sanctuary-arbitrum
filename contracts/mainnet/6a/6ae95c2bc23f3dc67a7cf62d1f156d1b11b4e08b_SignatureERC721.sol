...
import "../../cloneable-helper/CloneableERC721A.sol";

contract SignatureERC721 is CloneableERC721A, ERC2981, MintVoucherContract, CloneableNFT {
    constructor() CloneableNFT() {}
    ...
    **********************************************************************************************************/
    function initialize(
        ...
        CloneableERC721A(address(this)).initialize(name_, symbol_);
    ...
    function mintWithVoucher(MintVoucher calldata voucher, bytes calldata signature) external payable {
        ...
        currentSupply += uint128(voucher.quantity);
     ...
     */
    function adminMintMultiple(address to, uint256 quantity) external adminOrOwnerOnly {
    ...
    **********************************************************************************************************/
    ...
    /**
     * @dev Set max supply of the NFT collection
     * @param maxSupply_ The max supply of the NFT collection
     */
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view override(AccessControl, CloneableERC721A, ERC2981) returns (bool) {
        return
            AccessControl.supportsInterface(interfaceId) ||
            CloneableERC721A.supportsInterface(interfaceId) ||
    ...
    function approve(address operator, uint256 tokenId) public payable override isTransferAllowed {
        super.approve(operator, tokenId);
    }

    function transferFrom(address from, address to, uint256 tokenId) public payable override isTransferAllowed {
        super.transferFrom(from, to, tokenId);
    }

    function safeTransferFrom(address from, address to, uint256 tokenId) public payable override isTransferAllowed {
    ...
    function safeTransferFrom(
        ...
        uint256 tokenId,
        bytes memory data
    ) public payable override isTransferAllowed {
    ...
    **********************************************************************************************************/
    ...
    function _handleMint(address to, MintVoucher calldata voucher) internal override {
        _safeMint(to, voucher.quantity);
    }

    /**
     * @dev Overriding this function from the CloneableERC721A contract
     */
...
/**
 * @title CloneableERC721A
 *
 * @dev Fork of ERC721A but with an initializer for use with Clones.
 */
contract CloneableERC721A is Initializable, IERC721A {
