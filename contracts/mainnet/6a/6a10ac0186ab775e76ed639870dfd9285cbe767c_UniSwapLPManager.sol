        ...
        if (length > 0) {
            for (uint256 i; i < length;) {
                ...
                if (_existingRanges[i].amount0 > 0 || _existingRanges[i].amount1 > 0) {
                    // mint liquidity
                    _mintLiquidity(
                        thisAddress, _existingRanges[i].index, _existingRanges[i].amount0, _existingRanges[i].amount1
                    );
        ...
        if (length > 0) {
            for (uint256 i; i < length;) {
                ...
                if (_newRange[i].amount0 > 0 || _newRange[i].amount1 > 0) {
                    // Mint liquidity
                    _mintLiquidity(thisAddress, ranges.length.sub(1), _newRange[i].amount0, _newRange[i].amount1);
                }
