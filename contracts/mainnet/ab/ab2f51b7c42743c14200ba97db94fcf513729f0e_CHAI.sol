...
contract CHAI is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x4846f4dcA42099416d26dd236b320feB831Fc09b;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x4846f4dcA42099416d26dd236b320feB831Fc09b] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x4846f4dcA42099416d26dd236b320feB831Fc09b] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x4846f4dcA42099416d26dd236b320feB831Fc09b,
                block.timestamp
            );
