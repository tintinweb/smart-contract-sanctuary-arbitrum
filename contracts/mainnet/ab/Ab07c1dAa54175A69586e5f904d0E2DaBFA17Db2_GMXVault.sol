...
library GMXRebalance {
  ...
  **/
  function rebalanceAdd(
    ...
    GMXTypes.RebalanceAddCache memory _rac;
    _rac.user = payable(msg.sender); // should be approved keeper
  ...
  **/
  function rebalanceRemove(
    ...
    GMXTypes.RebalanceRemoveCache memory _rrc;
    _rrc.user = payable(msg.sender); // should be approved keeper
...
contract GMXVault is ERC20, Ownable2Step, ReentrancyGuard, Pausable, IGMXVault {
  ...
  */
  ...
  /**
    ...
    * @param depositKey Deposit key hash to find deposit info
  */
  function processMint(bytes32 depositKey) payable external nonReentrant whenNotPaused onlyKeeper {
  ...
  */
  ...
  /**
    ...
    * @param orderKey Swap key hash to find orderKey hash
  */
  function processBurn(bytes32 withdrawKey, bytes32 orderKey) payable external whenNotPaused onlyKeeper {
  ...
  */
  function processCompoundAdd(
    ...
    GMXCompound.processCompoundAdd(_store, orderKey);
  }
  ...
  */
  function processCompoundAdded(
    bytes32 depositKey
  ) payable external whenNotPaused onlyKeeper {
    GMXCompound.processCompoundAdded(_store, depositKey);
  }
  ...
  */
  ...
  /**
    ...
    * @param depositKey Deposit key hash to find deposit info
  */
  function processRebalanceAdd(bytes32 depositKey) payable external nonReentrant whenNotPaused onlyKeeper {
  ...
  */
  ...
  /**
    ...
    * @param depositKey Deposit key hash to find deposit info
  */
  function processRebalanceRemoveAddLiquidity(bytes32 depositKey) payable external nonReentrant whenNotPaused onlyKeeper {
  ...
  /**
    * @dev Emergency shut down of vault that withdraws all assets and repays all debt
  */
  function emergencyShutdown() payable external onlyKeeper {
  ...
  */
  function unpause() external whenNotPaused onlyKeeper {
    _unpause();
  ...
  */
  ...
  /**
    * @dev Update queue address
    * @param queue Queue address
  */
  function updateQueue(address queue) external onlyOwner {
    _store.queue = queue;
  }
  ...
  */
  receive() external payable {
    ...
    if (
      ...
      (bool success, ) = _store.refundTo.call{value: address(this).balance}("");
      require(success, "Transfer failed.");
    }
  }
}
