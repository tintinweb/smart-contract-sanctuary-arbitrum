...
contract WormholeMessageReceiver is IWormholeReceiver, Ownable {
    IWormholeRelayer public immutable wormholeRelayer;
    mapping(uint16 => uint16) public wormholeIdToChainId;
    ...
    constructor(
        ...
        wormholeIdToChainId[2] = 1; // Ethereum
        wormholeIdToChainId[23] = 42161; // Arbitrum One
        wormholeIdToChainId[6] = 43114; // Avalanche
        wormholeIdToChainId[30] = 8453; // Base
        wormholeIdToChainId[4] = 56; // BSC
        wormholeIdToChainId[24] = 10; // Optimism
        wormholeIdToChainId[5] = 137; // Polygon
    }
    ...
    function receiveWormholeMessages(
        ...
        vault.messageReceived(
            payload,
            address(uint160(uint256(sourceAddress))),
            wormholeIdToChainId[sourceChain]
        );
    }
}
