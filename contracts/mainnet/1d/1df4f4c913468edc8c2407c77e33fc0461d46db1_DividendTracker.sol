...
Website:  https://usdcprint.com/
Telegram: https://t.me/USDCPrint_Official
Twitter:  https://twitter.com/USDCPrint
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8)); 
...
contract USDCPrint is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("USDC Print", "USDCP") {
    	...
    	operationsWallet = address(0xE64Aa4B97d544d3B701dA65b0CE4a5AD69D8D9b7);
