...
contract KarrotChefV2 is Ownable, ReentrancyGuard {
    ...
    function openV2Deposits() external onlyOwner {
    ...
    function _userIsExemptFromClaimTax(address _user, uint256 _randomNumber) internal view returns (bool) {
        ...
        uint256 karrotsInFullProtecRatio = Math.mulDiv(karrotsInFullProtec, PERCENTAGE_DENOMINATOR, karrotsInSmol + karrotEquivalentInBig);
