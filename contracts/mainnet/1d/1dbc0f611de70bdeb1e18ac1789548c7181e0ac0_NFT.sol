...
contract NFT is ERC721A, Ownable {
    ...
    uint64 public publicPrice = 0 ether;  
    uint16 public maxNFTPerAddress = 1;
    ...
    constructor(string memory _notRevealedURI__) ERC721A("Epic Raven", "EPRVN") {
    ...
    function setPublicMaxSupply(uint16 _newSupply) external onlyOwner {
        maxNFTPerAddress = _newSupply;
    }
