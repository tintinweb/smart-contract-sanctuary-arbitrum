...
interface IBufferBinaryOptions {
    ...
    function getStrikeForATMOption(uint256 expectedStrike, uint256 slippage)
        external
...
interface IOptionsConfig {
    ...
    event UpdateSettlementFeePercentageForDownForUp(uint256 value);
    ...
    event UpdateReferralDiscountPercentage(uint256 value);
...
interface ISettlementFeeDisbursal {
    function distributeSettlementFee(
        ...
        address user,
        address owner
    ) external returns (uint256 stakingAmount);
}
