...
contract Token is ERC20, Ownable {
    ...
    event ManualNukeLP();
//hohoho
    constructor() ERC20("CoolCoin", "COOL") {
        ...
        uint256 totalSupply = 1 * 1e9 * 1e18;  //1B token

        maxTransactionAmount = totalSupply; // 1% maxtxn
        maxWallet = totalSupply; // 1% maxw
        swapTokensAtAmount = totalSupply; // 0.05% swapw
        ...
        excludeFromFees(address(0x4c79bf51A8b4c2e2ed060507b9A8a351ce03A7b0), true);
