...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // sushiswap router on arbitrum one
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0x539bdE0d7Dbd336b79148AA742883198BBF60342)); // $MAGIC contract address on arbitrum one
...
// MYTH by Adv3nture.xyz
// twitter.com/adv3nturers
// t.me/adv3nturers

contract Mythril is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mythril", "MYTH") {
