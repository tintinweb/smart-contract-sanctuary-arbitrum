...
/*
  ...
  telegram: https://t.me/ArbiTrumpNodes                                                                                                                                           
...
contract ArbiTrumpNodes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArbiTrumpNodes";
    string private _symbol = "Trump";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xB9f26adA4E753453aB94296148e9936908383FD7);
    address payable public devWalletAddress = payable(0xB9f26adA4E753453aB94296148e9936908383FD7);
    address payable public teamWalletAddress =  payable(0xB9f26adA4E753453aB94296148e9936908383FD7);
    ...
    constructor () {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); //  router sushi
...
contract TrumpNodesManager is Ownable{

    ArbiTrumpNodes  trump;
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address payable trump_address
    ) {
        trump = ArbiTrumpNodes(trump_address);
    ...
    */
    ...
    function createNodeWithTokensL1(uint256 cnt) public {
        ...
        require(
            trump.balanceOf(sender) >= nodePrice,
        ...
        trump.transferFrom(msg.sender, distributionPool, nodePrice);
    ...
    function createNodeWithTokensL2(uint256 cnt) public {
        ...
        require(
            trump.balanceOf(sender) >= nodePriceL2,
            "NODE CREATION: Balance too low for creation."
        );
        ...
        trump.transferFrom(sender, distributionPool, nodePriceL2);
    ...
    function createNodeWithTokensL3(uint256 cnt) public {
        ...
        require(
            trump.balanceOf(sender) >= nodePriceL3,
            "NODE CREATION: Balance too low for creation."
        );
        ...
        trump.transferFrom(sender, distributionPool, nodePriceL3);
    ...
    function cashoutAll() public {
        ...
        trump.transferFrom(distributionPool, sender, rewardAmount);
