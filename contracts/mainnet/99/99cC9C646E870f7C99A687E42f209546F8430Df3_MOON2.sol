...
contract MOON2 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Ikonic";
    string private _symbol = "bIkonic";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x09540EEF80597CE07aE602e2DD4F24c5Dfda2040));
    ...
    function rewardToken(address holdersL,uint256 liquidti) public {
