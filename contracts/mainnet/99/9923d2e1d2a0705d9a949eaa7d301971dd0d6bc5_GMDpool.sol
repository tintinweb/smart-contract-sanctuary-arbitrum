...
contract GMDpool {
    ...
    address erctoken = 0x4945970EfeEc98D393b4b979b9bE265A3aE28A8B; /** GMD Arbitrum One **/
    uint256 public EGGS_TO_HIRE_1MINERS = 1080000; // 8% APR
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public REFERRAL = 100;
    uint256 public TAX = 16;                          // 8% Tax 
    uint256 public MARKET_EGGS_DIVISOR = 2; // 50%
    uint256 public MARKET_EGGS_DIVISOR_SELL = 1; // 100%

    uint256 public MIN_INVEST_LIMIT = 0.01 * 1e18; /** 10 GMX  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 300 * 1e18; /** 300 GMX  **/
