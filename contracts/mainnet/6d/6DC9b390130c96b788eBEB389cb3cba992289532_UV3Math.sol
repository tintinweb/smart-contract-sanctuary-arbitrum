...
import {TickMath} from "../ramses/v2/libraries/TickMath.sol";
import {LiquidityAmounts} from "../ramses/v2-periphery/libraries/LiquidityAmounts.sol";
import {OracleLibrary} from "../ramses/v2-periphery/libraries/OracleLibrary.sol";
import {IRamsesV2Pool} from "../ramses/v2/interfaces/IRamsesV2Pool.sol";
import {IERC20} from "@openzeppelin-3.4.1/contracts/token/ERC20/IERC20.sol";
import {IICHIVaultFactory} from "../../interfaces/IICHIVaultFactory.sol";
import {SafeMath} from "@openzeppelin-3.4.1/contracts/math/SafeMath.sol";
import {SafeERC20} from "@openzeppelin-3.4.1/contracts/token/ERC20/SafeERC20.sol";
import {Strings} from "@openzeppelin-3.4.1/contracts/utils/Strings.sol";
...
library OracleLibrary {
    /// @notice Calculates time-weighted means of tick and liquidity for a given Ramses V2 pool
