...
/**
* @author NogemHypNFT721
* @title NogemHypNFT721
*/
contract NogemHypNFT721 is HypERC721, ReentrancyGuard {
    /************
    *   ERRORS  *
    ************/
    ...
    */
    error NogemHypNFT721_CoreError(uint256 errorCode);
    ...
    */
    ...
    /**
    * @notice Mint new Nogem ONFT by referral
    ...
    */
    function _validate(bool _clause, uint8 _errorCode) internal pure {
        if (!_clause) revert NogemHypNFT721_CoreError(_errorCode);
    }
}
