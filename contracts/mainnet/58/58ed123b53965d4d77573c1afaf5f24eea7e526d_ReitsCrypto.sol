...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UNISWAP ROUTER CONTRACT ADDRESS
    IBEP20 USDCToken = IBEP20(0xdAC17F958D2ee523a2206206994597C13D831ec7); // USDT CONTRACT ADDRESS, SEND AS REWARDS
...
contract ReitsCrypto is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "choccy milk";                             //Contract By TechAddict YT
    string constant _symbol = "choccy";
    ...
    uint256 _totalSupply = 41000000 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 1000000; //Max buy and sell amount per transaction
    uint256 public _walletMax = _totalSupply * 3 / 2500000; //anti whale features, max amount per wallet.
