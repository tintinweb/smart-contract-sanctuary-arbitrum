...
contract FactorySignatureVerifier {
    function getMessageHash(
        uint _chainId,
        uint contractId,
        address _owner
    ) public pure returns (bytes32) {
        return keccak256(abi.encodePacked(_chainId, contractId, _owner));
    }
    ...
    function verify(
        ...
        bytes32 messageHash = getMessageHash(_chainId, contractId, _owner);
