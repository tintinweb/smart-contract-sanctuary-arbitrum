...
contract ARB20 is ERC20, Control {
    ...
    function _transfer(
      ...
      // 允许当前 ADMIN 地址授予或撤销 ADMIN 角色
    function changeAdmin(address newAdmin) public onlyRole(ADMIN) {
        require(newAdmin != address(0), "Invalid address");
        revokeRole(ADMIN, _msgSender()); // 撤销当前 ADMIN 角色
        grantRole(ADMIN, newAdmin); // 授予新的 ADMIN 角色
    }
