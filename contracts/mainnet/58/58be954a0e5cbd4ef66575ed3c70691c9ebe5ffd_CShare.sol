...
contract CShare is ERC20Burnable, Operator {
    ...
    /*
        TOTAL MAX SUPPLY = 60,000 CSHAREs
        - 50000 CSHAREs allocated to CIRCLE-USDC and CSHARE-USDC pools
        - Allocate 6000 CSHAREs to DAO wallet for linear vesting
        - Allocate 4000 CSHAREs to Dev wallet for linear vesting
    */
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund) public ERC20("Circle Finance Share", "CSHARE") {
        _mint(msg.sender, 20 ether);         // mint 20 CSHARE Share for initial pools deployment and Boardroom initialization
