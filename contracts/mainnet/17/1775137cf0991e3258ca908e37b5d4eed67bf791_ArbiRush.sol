...
contract ArbiRush is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public totalTaxBuy = 1200;
    ...
    uint256 public totalTaxSell = 1200;
    ...
    function transfer(
        ...
        return _rushTransfer(_msgSender(), to, amount);
    }
    ...
    function transferFrom(
        ...
        return _rushTransfer(sender, recipient, amount);
    }

    function _rushTransfer(
        address sender,
        address recipient,
        uint256 amount
