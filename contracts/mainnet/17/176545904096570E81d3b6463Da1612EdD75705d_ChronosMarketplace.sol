...
library Errors {
    ...
    string public constant LOW_ETH_BALANCE = "Low eth balance";
    string public constant NOT_ALLOWED_CALL = "Another Contract can't make a bid";
    string public constant FAILED_TRANSFER = "Failed to send Ether";
}