...
interface IVaultUtils {
    ...
    function getBuyUsdzFeeBasisPoints(address _token, uint256 _usdzAmount) external view returns (uint256);
    function getSellUsdzFeeBasisPoints(address _token, uint256 _usdzAmount) external view returns (uint256);
    function getSwapFeeBasisPoints(address _tokenIn, address _tokenOut, uint256 _usdzAmount) external view returns (uint256);
    function getFeeBasisPoints(address _token, uint256 _usdzDelta, uint256 _feeBasisPoints, uint256 _taxBasisPoints, bool _increment) external view returns (uint256);
}
...
interface IVault {
    ...
    function getTargetUsdzAmount(address _token) external view returns (uint256);
    ...
    function setUsdzAmount(address _token, uint256 _amount) external;
    ...
    function usdzAmounts(address _token) external view returns (uint256);
    function maxUsdzAmounts(address _token) external view returns (uint256);
    function getRedemptionAmount(address _token, uint256 _usdzAmount) external view returns (uint256);
