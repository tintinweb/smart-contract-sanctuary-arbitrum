...
[Renounced Ownership, 100% Liquidity Locked on DxLock]

JizzRocketArbi $aJIZZ is a unique memecoin that combines the power of decentralized Arbitrum L2 blockchain, community, and cutting-edge AI technology. Our goal is to reach critical mass, making this coin a must-have for all memecoin enthusiasts and collectors.

Telegram: t.me/JizzRocketArbi
Twitter: twitter.com/JizzRocketArbi
Website: jizzrocketarbi.com >> mirror: jizzrocket.surge.sh
...
contract JizzRocketArbi is ERC20, Ownable {
    ...
    string constant _name = "JizzRocketArbi";
    string constant _symbol = "aJIZZ";
    ...
    address public marketingFeeReceiver = 0xDE4aD6944c88f3Eb7e7F118b894D2AEf0d17FdE3;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xDE4aD6944c88f3Eb7e7F118b894D2AEf0d17FdE3] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xDE4aD6944c88f3Eb7e7F118b894D2AEf0d17FdE3] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xDE4aD6944c88f3Eb7e7F118b894D2AEf0d17FdE3,
                block.timestamp
            );
