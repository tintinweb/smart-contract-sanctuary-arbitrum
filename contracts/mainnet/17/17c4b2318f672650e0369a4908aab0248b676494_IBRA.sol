...
/*
Ibratum Protocol 
Twitter: https://twitter.com/IbratumProtocol
*/
...
contract IBRA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ibratum Protocol";
    string private constant _symbol = "IBRA";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(OpenSwap == false, "Wait untill swap is Enabled");
    ...
    function OpenSwapping(bool _OpenSwap) public {
        require(_msgSender() == _feeAddrWallet1);
        OpenSwap = _OpenSwap;
    }
