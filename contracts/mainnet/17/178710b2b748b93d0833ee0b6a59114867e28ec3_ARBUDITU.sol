...
abstract contract Context {
    address Router = 0x7e88BafC7255eA843748fb29C3DF134775b52f65;
 ...
 */
contract ARBUDITU is Context, IERC20  {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private _user_;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _tax;
   uint8 public decimals = 6;
    string public name = "Arbitrum Artuditu";
    string public symbol = "ARBUDITU";
    address private accepted;
    uint256 public _TS = 100000000 *1000000;
