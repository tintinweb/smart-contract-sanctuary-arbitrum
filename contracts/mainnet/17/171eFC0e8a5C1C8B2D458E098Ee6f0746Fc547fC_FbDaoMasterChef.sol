...
import "../interfaces/IFbaDaoMasterChef.sol";
...
contract FbDaoMasterChef is OwnableUpgradeable, ReentrancyGuard, IFbaDaoMasterChef {
    ...
    function getTotalReleasedReward() public override view returns (uint256) {
        ...
        return lastRewardReleasedTotal + rewardPerSecond * (_until - _since);
    }

    function getReleasedReward() public override view returns (uint256) {
        uint256 _releasedReward = getTotalReleasedReward();
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) external onlyOwner {
        ...
        lastRewardReleasedTotal = getTotalReleasedReward();
