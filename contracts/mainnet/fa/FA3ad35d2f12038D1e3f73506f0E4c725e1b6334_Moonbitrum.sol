...
import "./interface/Camelotinterface.sol";
...
contract Moonbitrum is ERC20, Ownable {
    ...
    constructor() ERC20("MoonBitrumTest", "MBRTest") {
        ...
        ICamelotRouter _camelotRouter = ICamelotRouter(
            0xc873fEcbd354f5A56E00E710B90EF4201db2448d // CamelotRouter Contract  0xc873fEcbd354f5A56E00E710B90EF4201db2448d
        );
    ...
    function createTokenPair() public onlyOwner {
        ...
        if (
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                liquidityAmount = liquidityAmount.add(
                    amount.mul(liquidityFee).div(feeUnits)
                );
            }
            if (burnAmount > 0) {
...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        //must hold 1000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "Moonbitrum_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Moonbitrum_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Moonbitrum contract."
        );
    }

    function distributeUSDTDividends(uint256 amount) external onlyOwner {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Moonbitrum_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Moonbitrum_Dividend_Tracker: Cannot update claimWait to same value"
        );
    ...
    function process(
        uint256 gas
    ) public isDestroyed returns (uint256, uint256, uint256) {
