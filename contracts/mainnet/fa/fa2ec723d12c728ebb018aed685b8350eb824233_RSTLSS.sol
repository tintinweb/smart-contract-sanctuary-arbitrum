...
//  Giving you the tools to be Otherworldly. Creating wearables for WEB3, Gaming Ecosysystems, and IRL events.
...
contract RSTLSS is ERC20, Ownable {
    ...
    constructor() ERC20("Restless", "RSTLSS") {
        ...
        marketingWallet = address(0x555E7A5b614BBDC350C5e79c3D2e2e99a2dE0aae);
        developmentWallet = address(0x555E7A5b614BBDC350C5e79c3D2e2e99a2dE0aae);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
        ...
        require(_fees.sellTotalFees <= 90, "Must keep fees at 90% or less");
    }
