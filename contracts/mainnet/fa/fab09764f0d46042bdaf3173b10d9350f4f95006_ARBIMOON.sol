...
contract ARBIMOON is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ARBIMOON" ;
    ...
    uint256 public _walletMax = _totalSupply * 4/ 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x718B35987588Fcc81495e6fe91B5551F7056e4e5;
        buybackWallet = 0x718B35987588Fcc81495e6fe91B5551F7056e4e5;
