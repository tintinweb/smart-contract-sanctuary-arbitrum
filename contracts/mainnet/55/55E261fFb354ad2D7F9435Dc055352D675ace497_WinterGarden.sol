...
contract WinterGarden is ERC1155Supply, Ownable, ReentrancyGuard, Pausable {
    uint256 public constant WINTER_NFT1 = 1;
    uint256 public constant WINTER_NFT2 = 2;
    uint256 public mintPrice = 0.006 ether; 

    // Name and symbol for the NFT collection
    string public name = "Winter Garden";
    ...
    function mint(address to, uint256 id, uint256 amount) public payable nonReentrant whenNotPaused {
        require(id == WINTER_NFT1 || id == WINTER_NFT2, "Invalid token ID");
    ...
    function gift(address to, uint256 id, uint256 amount) public onlyOwner whenNotPaused {
        require(id == WINTER_NFT1 || id == WINTER_NFT2, "Invalid token ID");
        _mint(to, id, amount, "");
        emit Gifted(to, id, amount);
    }
