...
contract EagleFinance is Context, IBEP20, Ownable {
    ...
    string public constant name     = "EagleFinance";
    string public constant symbol   = "EGF";
    ...
    constructor (address cOwner, address marketingWallet) Ownable(cOwner) {
        ...
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0xa7Cb13dA26779efEd298077062e3FAb5e7116d65);
