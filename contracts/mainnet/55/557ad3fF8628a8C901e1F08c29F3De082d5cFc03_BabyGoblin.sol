...
//TELEGRAM :https://t.me/BabyGoblin_Arbitrum
...
contract BabyGoblin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Goblin";
    string constant _symbol = "BGOBLIN";
    ...
    uint256 public _maxTxAmount = 3 * 10**5 * (10 ** _decimals);
    uint256 public _walletMax = 3 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6c90A375173Eeb1bE348D492C9e908C42F415D5E;
        marketingWallet = 0x6c90A375173Eeb1bE348D492C9e908C42F415D5E;
        devWallet = 0x6c90A375173Eeb1bE348D492C9e908C42F415D5E;
