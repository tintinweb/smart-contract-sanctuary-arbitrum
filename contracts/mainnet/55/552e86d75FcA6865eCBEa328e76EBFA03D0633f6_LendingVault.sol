...
contract LendingVault is ERC20, ReentrancyGuard, Pausable, Ownable2Step, ILendingVault {
  ...
  /**
    * @dev Allow only approved borrower addresses
  */
  ...
  /**
    * @dev Allow only keeper addresses
  */
  modifier onlyKeeper() {
    _onlyKeeper();
    _;
  ...
  */
  ...
  /**
    * @dev Returns the total value of the lending vault, i.e totalBorrows + interest + totalAvailableAsset
  ...
  */
  ...
  /**
    * @dev Returns the available balance of asset in the vault that is borrowable
  ...
  */
  ...
  /**
    * @dev Returns the the borrow utilization rate of the vault
  ...
  */
  ...
  /**
    * @dev Returns the exchange rate for lvToken to asset
  ...
  */
  ...
  /**
    * @dev Returns the current borrow APR
  ...
  */
  ...
  /**
    * @dev Returns the current lending APR; borrowAPR * utilization * (1 - performanceFee)
  ...
  */
  ...
  /**
    * @dev Returns a borrower's maximum total repay amount taking into account ongoing interest
  ...
  */
  ...
  /**
    * @dev Deposits native asset into lending vault and mint shares to user
  ...
  */
  ...
  /**
    * @dev Deposits asset into lending vault and mint shares to user
    * @param assetAmt Amount of asset tokens to deposit in token decimals
    * @param minSharesAmt Minimum amount of lvTokens tokens to receive on deposit
  */
  ...
  /**
    * @dev Withdraws asset from lending vault, burns lvToken from user
  ...
  */
  ...
  /**
    * @dev Borrow asset from lending vault, adding debt
  ...
  */
  ...
  /**
    * @dev Repay asset to lending vault, reducing debt
  ...
  */
  ...
  /**
  * @dev Withdraw protocol fees from reserves to treasury
  ...
  */
  ...
  /**
    * @dev Calculate amount of lvTokens owed to depositor and mints them
  ...
  */
  ...
  /**
    * @dev Calculate amount of asset owed to depositor based on lvTokens burned
  ...
  */
  ...
  /**
    * @dev Interest accrual function that calculates accumulated interest from lastUpdatedTimestamp and add to totalBorrows
  ...
  */
  ...
  /**
    * @dev Returns the pending interest that will be accrued to the reserves in the next call
  ...
  */
  ...
  /**
    * @dev Conversion factor for tokens with less than 1e18 to return in 1e18
  ...
  */
  ...
  /**
    * @dev Return the interest rate based on the utilization rate
  ...
  */
  ...
  /**
    * @dev Updates lending vault interest rate model variables, callable only by keeper
  ...
  */
  ...
  /**
    * @dev Approve address to borrow from this vault
  ...
  */
  ...
  /**
    * @dev Revoke address to borrow from this vault
    * @param borrower  Borrower address
  */
  ...
  */
  ...
  /**
    * @dev Emergency repay of assets to lending vault to clear bad debt
    * @param repayAmt Amount of debt to repay in token decimals
  */
  ...
  /**
    * @dev Emergency pause of lending vault that pauses all deposits, borrows and normal withdrawals
  */
  ...
  /**
    * @dev Emergency resume of lending vault that pauses all deposits, borrows and normal withdrawals
  */
  ...
  */
  ...
  /**
    * @dev Updates maximum allowed lending vault interest rate model variables
  ...
  */
  ...
  /**
    * @dev Fallback function to receive native token sent to this contract,
