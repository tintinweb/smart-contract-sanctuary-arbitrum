...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 50000000000000000 * 10**7;
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!blacklisted[sender], "Sender is blacklisted and cannot perform transactions");
        require(!blacklisted[recipient], "Recipient is blacklisted and cannot receive transactions");
