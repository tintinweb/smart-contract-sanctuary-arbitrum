...
contract KEPVault is ERC20, AccessManaged, ReentrancyGuard, IKEPVault, IKEPVaultEvents {
  ...
  */
  ...
  /**
    ...
    * @param dp KEPTypes.DepositParams
  */
  function deposit(KEPTypes.DepositParams memory dp) external payable nonReentrant {
  ...
  */
  function withdraw(KEPTypes.WithdrawParams memory wp) external payable nonReentrant {
...
library KEPWithdraw {
  ...
  */
  function withdraw(
    ...
    _wc.healthParams.equityBefore = KEPReader.equityValue(self);
    _wc.healthParams.lrtAmtBefore = KEPReader.lrtAmt(self);
    _wc.healthParams.debtRatioBefore = KEPReader.debtRatio(self);
    _wc.healthParams.deltaBefore = KEPReader.delta(self);
    ...
    // Calculate amount of tokenB to swap ETH for to repay
