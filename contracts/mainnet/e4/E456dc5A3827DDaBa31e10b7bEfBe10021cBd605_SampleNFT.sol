...
import {IAirdroppable, IAirdroppableByType, IAirdroppableWithTokenURI} from "./IAirdroppable.sol";
...
contract SampleNFT is
    ...
    IAirdroppable,
    IAirdroppableByType,
    IAirdroppableWithTokenURI,
    BaseNFT
{
    uint256 private _tokenIDCounter;

    constructor()
        BaseNFT(_msgSender(), "Sample NFT", "SNFT", 0, type(uint256).max)
    {}
