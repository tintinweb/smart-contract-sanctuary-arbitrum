...
contract SHIBARD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBARD";
    string private _symbol = unicode"$SHIBARD";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0b6E48713f957529D4B0a8327B6336dea5De4bB0);
    address payable private taxWallet2 = payable(0x0b6E48713f957529D4B0a8327B6336dea5De4bB0);
    ...
    uint256 private _totalSupply = 1000_000_000_000_000 * 10**9;
