...
contract MixedPriceOracleWithWstETHv2 is PriceOracle {
    ...
    function getUnderlyingPrice(
        ...
        if(keccak256(abi.encodePacked(cToken.symbol())) == keccak256(abi.encodePacked("slwstETH"))) {
            ...
            require(lastRoundUpdateTimestamp > (block.timestamp - 3600), "oracle error: price is staled"); // 1 hour staleness checks
    ...
    function _getPythPrice(
        ...
        require(currentBasePrice.publishTime > (block.timestamp - 3600), "Pyth Oracle error: price staled"); // 1 hour staleness checks
