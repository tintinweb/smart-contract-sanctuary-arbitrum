...
// File: contracts/final/final_vault.sol
...
contract MuchoVault is Ownable, ReentrancyGuard {
    ...
    GLPRouter public _GLPRouter = GLPRouter(0xB95DB5B167D75e6d04227CfFFA61069348d271F5); 
    ...
    constructor(GDtoken _gdUSDC, GDtoken _gdETH, GDtoken _gdBTC) { 
        ...
        poolInfo.push(PoolInfo({
            ...
            vaultcap: 500000000000000000000000,
            stakable: true,
            withdrawable: false,
            rewardStart: false,
            glpFees: 200, 
        ...
        poolInfo.push(PoolInfo({
            ...
            EarnRateSec:0,
            lastUpdate: block.timestamp,
            vaultcap: 250000000000000000000,
            stakable: true,
            withdrawable: false,
            rewardStart: false,
            glpFees: 200, 
    ...
    function updatepoolGLP(address _newManager) external onlyOwner {
        poolGLP = _newManager;
    } 
