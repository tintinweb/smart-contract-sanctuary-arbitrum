...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address public marketingWallet = 0xDEA0eA201437805BA7328ACAc203d737aF674fa9;
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _mint(marketingWallet, 1000000000000000000);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        uint256 transferAmount = amount - marketingFee; // declare transferAmount here
        unchecked {
