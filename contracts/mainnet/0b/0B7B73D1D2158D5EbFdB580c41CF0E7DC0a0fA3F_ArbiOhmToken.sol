...
contract ArbiOhmToken is ERC20Permit, VaultOwned {
    using SafeMath for uint256;
    ...
    uint256 public constant INITIAL_LP = 2500 * 10e9;
    uint256 public constant INITIAL_MARKETING = 75 * 10e9;
    uint256 public constant INITIAL_TEAM = 50 * 10e9;

    constructor(address _usdc, address _feesWallet, address _marketing, address _team) ERC20("ArbiOHM", "AOHM", 9) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
        uniswapV2Router = _uniswapV2Router;
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _usdc);
        ...
        _mint(_marketing, INITIAL_MARKETING);
        _mint(_team, INITIAL_TEAM);
        ...
        _approve(owner(), address(uniswapV2Router), INITIAL_LP);
    }
    ...
    function setFees(uint buy, uint sell) public onlyOwner {
        require(buy <= 10, "Too much buy fees");
        require(sell <= 10, "Too much sell fees");
