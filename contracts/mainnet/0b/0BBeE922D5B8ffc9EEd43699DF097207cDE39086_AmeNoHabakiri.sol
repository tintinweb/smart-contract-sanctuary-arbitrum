...
/*
AME NO HABAKIRI (雨のはばきり)

Ame No Habakiri is a recently released token meme, which is getting tremendous attention from the crypto community. The word Ame basically means strange creature or beast, basically a force of nature or preternatural creatures of divine power. Ame No Habakiri are usually depicted for destroying cities or even fight other Ame as. And are referenced a lot in Japan,main character from the anime that become Japan’s highest-grossing film of all-time for 19 years  straight. Now, Ame No Habakiri will be here in Arbitrum block chain and keep developing as the best Meme token for many decades to come.

Telegram: https://t.me/AmeNoHabakiriARB

Twitter: https://twitter.com/AmeNoHabakiARB

Website: https://amenohabakiriarb.com/
*/
...
contract AmeNoHabakiri is IBEP20, Auth {
    ...
    address constant DEV = 0xeAae6796aacf4ebC6efFE1BAfCfC40Fc47A14615;


    string constant _name = "AME NO HABAKIRI";
    string constant _symbol = "$ANOKI";
