...
library GMXDeposit {
  ...
  */
  function processMint(
    ...
    GMXChecks.processMintChecks(self);
  ...
  */
  function calcMinTokensSlippageAmt(
    ...
    uint256 _minWithdrawTokenAAmt = _withdrawValue
      * SAFE_MULTIPLIER / _tokenAWeight * SAFE_MULTIPLIER
      / GMXReader.convertToUsdValue(
        self,
        address(self.tokenA),
        10**(_tokenADecimals)
    ...
    uint256 _minWithdrawTokenBAmt = _withdrawValue
      * SAFE_MULTIPLIER / _tokenBWeight * SAFE_MULTIPLIER
      / GMXReader.convertToUsdValue(
        self,
        address(self.tokenB),
        10**(_tokenBDecimals)
...
library GMXRebalance {
  ...
  */
  function processRebalanceRemoveAddLiquidity(
    ...
    self.refundee = payable(address(0));
    delete self.rebalanceRemoveCache;
