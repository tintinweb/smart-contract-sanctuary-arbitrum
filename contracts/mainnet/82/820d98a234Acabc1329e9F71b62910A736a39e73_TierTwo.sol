...
contract TierOne {
    ...
    constructor(uint256 _startTime, uint256 _remainingTokens) {
        require(block.timestamp < _startTime, 'start timestamp too early');
        
        startTime = _startTime;
        remainingTokens = _remainingTokens;
        publicAllocation = _remainingTokens;
    }
...
contract TierTwo is TierOne {
    constructor(uint256 _startTime, uint256 _remainingTokens) TierOne(_startTime, _remainingTokens) { }
}