...
// File: contracts/utils/treasure_chest/interfaces/ITreasureChest.sol

interface ITreasureChest {
    function mint(address recipient) external;
}

// File: contracts/utils/treasure_chest/TreasureChestShop.sol
...
contract TreasureChestShop is OwnableUpgradeable, PausableUpgradeable {
    ...
    function buyTreasureChest() external whenNotPaused {
        ...
        crds.transferFrom(sender, address(this), 300e18);
