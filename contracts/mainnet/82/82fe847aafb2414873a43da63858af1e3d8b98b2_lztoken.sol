...
// File: contracts/token/oft/composable/IOFTReceiver.sol
...
// File: contracts/token/oft/composable/IComposableOFTCore.sol
...
// File: contracts/token/oft/composable/ComposableOFTCore.sol
...
// File: contracts/token/oft/composable/IComposableOFT.sol
...
// File: contracts/token/oft/token.sol
...
contract lztoken is ComposableOFTCore, ERC20, IComposableOFT {
    ...
    function mintTo(address to, uint count) external onlyOwner {
        _mint(to, count);
    }
