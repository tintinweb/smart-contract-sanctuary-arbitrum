...
// File contracts/SupakiMarketplace.sol
    ...
    UUPSUpgradeable
{
    ...
    mapping(bytes32 => bool) public isSigExecuted;
    ...
    function initialize(
        ...
        EIP712Upgradeable.__EIP712_init("Supaki OrderMatching", "v0.0.1");
    ...
    function verify(
        ...
        bytes32 messageDigest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256(
                        "OrderDetails(address seller_address,address contract_address,uint256 token_id,uint256 nonce)"
                    ),
                    seller_address,
                    contract_address,
                    token_id,
    ...
    function transferItem(
        ...
        require(!isSigExecuted[signatureHash], "Executed_Sig");
        require(
            verify(
                _seller,
                _nftContract,
        ...
        require(_nftContract != address(0), "INVALID_NFT_ADDRESS");

        IERC721(_nftContract).safeTransferFrom(_seller, _buyer, _tokenId);
        isSigExecuted[signatureHash] = true;

        emit OrderDetails(_seller, _buyer, _nftContract, _tokenId);
    }
