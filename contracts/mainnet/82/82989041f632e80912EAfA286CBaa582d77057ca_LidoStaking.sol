...
abstract contract BaseDelegator is Ownable, ReentrancyGuard, IVaultDelegator {
  ...
  function deposit(
    uint256 amount
  ) external virtual onlyLinkedVault nonReentrant {
    require(
  ...
  function withdraw(
    uint256 amount
  ) public virtual onlyLinkedVault nonReentrant {
    require(
...
import "../interfaces/integrations/ICurvePool.sol";
import "../interfaces/integrations/ICurveRegistry.sol";
import "../interfaces/integrations/ICurveAddressProvider.sol";
