    ...
    OwnableUpgradeable
{
    ...
    function initialize(
        address _deagleToken,
        uint256 _maxSupply,
        uint256 _mintPrice,
        string memory __baseURI,
        string memory _suffixURI
    ) public initializer {
        __ERC721_init("DesertEagleOg", "DEAGLE_OG");
    ...
    function mint() public nonReentrant {
        ...
        // Check allowance
        require(
            deagleToken.allowance(msg.sender, address(this)) >= mintPrice,
            "Insufficient allowance"
        );

        // Burn token
        deagleToken.burnFrom(msg.sender, mintPrice);
