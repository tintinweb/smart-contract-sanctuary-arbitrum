...
//
// DCD Inu
// 3 million max buy / wallet
// 3% buy tax / 9% sell tax
// Website: https://opensea.io/collection/dcdpass-v2
// Twitter: https://twitter.com/DCDAO_
// Ownership will be transferred to DCD treasury: 0xF1078c100899326f7b4Bd979022F8d8ef0EE3aD1
// 1% buy and sell tax goes to DCD treasury
// Codebase forked from recent DCD pick memecoin
...
contract DCDInu is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"DCD Inu";
    string private _symbol = unicode"DINU";
    ...
    uint256 public stakingMultiplierV1  = 100; // 3% sell tax for staking contract use
    uint256 public stakingMultiplierV2  = 200; // 6% sell tax for staking contract use
    uint256 public stakingMultiplierV3  = 300; // 9% sell tax for initial and staking contract use
    ...
    constructor (address routeraddr) Ownable() {
        ...
        autoLiquidityReceiver = address(0xF1078c100899326f7b4Bd979022F8d8ef0EE3aD1); //DCD treasury
