...
contract Feeds is IFeeds, UpgradeableKeepable {
     ...
     */
    function addFeed(address _token, address _feed) external override onlyGovernorOrKeeper {
        feed[_token] = _feed;
    }
     ...
     * @param _token _token address.
     */
    function removeFeed(address _token) external onlyGovernorOrKeeper {
