...
BuffSharbi is the king of Sharbi on Arbitrum blockchain, another Sharbi family rewarding it’s holders with USDC Rewards
...
// main contract
contract BuffSharbi is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "BuffSharbi";
    ...
    uint256 _liquidityBuyFee = 20;
    uint256 _reflectionBuyFee = 50;

    uint256 _liquiditySellFee = 20;
    uint256 _reflectionSellFee = 50;

    uint256 _liquidityFeeCount;
    uint256 _reflectionFeeCount;

    uint256 public totalBuyFee = 70;
    uint256 public totalSellFee = 70;
