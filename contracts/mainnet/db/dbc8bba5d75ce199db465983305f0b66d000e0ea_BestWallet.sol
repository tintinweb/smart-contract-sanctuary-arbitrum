...
contract BestWallet is ERC20, Ownable {
    ...
    constructor (uint256 _totalSupply) ERC20("BestWallet Token", "BWT") 
    {   
        address router;
        if (block.chainid == 56) {
            ...
            router = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // arbitrum SushiSwap Router
        ...
        marketingWallet = 0xaC353Aa4a347AA6E56eE1381887A529F47510160;
