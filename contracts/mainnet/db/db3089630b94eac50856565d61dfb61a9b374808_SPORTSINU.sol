...
Welcome to SPORTS INU 🎮

An innovative new platform with its own crypto token $SINU that brings the worlds of cryptocurrencies and Sports together. It is a blockchain-based platform that leverages the power of the Arbitrum network to facilitate digital contracts and secure transactions. Sports Inu is committed to creating a fair and rewarding environment for players by leveraging blockchain technology. 

Become a token holder of the most innovative gaming community, created by long-time players, for Sport and betting enthusiasts.

LINKS:
https://t.me/Sports_Inu
...
contract SPORTSINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Sports Inu";
    string private _symbol = unicode"SINU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x17DEbcb98df1AA573686b778e46f0F4c1b1d476B);
    address payable private taxWallet2 = payable(0x17DEbcb98df1AA573686b778e46f0F4c1b1d476B);
    ...
    uint256 private _totalSupply = 125 * 1e6 * 1e9;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        feeAmount = amount.mul(_totalTaxIfBuying).div(1 * 1e9);
