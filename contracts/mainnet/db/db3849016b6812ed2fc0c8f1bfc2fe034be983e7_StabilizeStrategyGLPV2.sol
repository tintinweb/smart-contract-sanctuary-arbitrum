...
// File: contracts/strategies/StabilizeStrategyGLPV2.sol
...
contract StabilizeStrategyGLPV2 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public percentExecutor = 10000; // 10000 = 10% of WETH goes to executor, 1% of total profit.
    ...
    address constant NEW_GMX_REWARD_ROUTER = address(0xB95DB5B167D75e6d04227CfFFA61069348d271F5);
    ...
    function withdrawLocked() external pure returns (bool) {
        // GMX has removed its cooldown feature
        return false;
    }
    ...
    */
    ...
    function redeemStakeProfit() internal {
        ...
        if(_bal > 0){
            ...
            address glpManager = GMXRewardRouter(NEW_GMX_REWARD_ROUTER).glpManager();
            ...
            GMXRewardRouter(NEW_GMX_REWARD_ROUTER).mintAndStakeGlp(targetToken, sellAmount, 1, 1);
        }
    }
