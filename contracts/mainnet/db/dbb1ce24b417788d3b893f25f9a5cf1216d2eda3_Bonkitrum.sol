...
contract Bonkitrum is ERC20, Ownable { //replace ''test with your projects name. No Spaces!
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTranscationAmount = 30000000000 * (10**18); //max buy
    uint256 public maxSellTransactionAmount = 10000000000 * (10**18); //max sell
    uint256 public maxWalletBalance = 50000000000 * (10**18); //max hold
    ...
    uint256 public _marketingFeeBuy = 2; //marketing fee on buy
    uint256 public _LpFeeBuy = 1; //lp fee on buy
  //fees on sell
    uint256 public _usdcDividendRewardsFeeSell= 3; 
    ...
    constructor() ERC20("Bonkitrum", "BONKAR") { 
        	
    	marketingWallet = 0x91D54a0516C499a38f2065C713817Ec6cBa24a4A;  //set your wallet
    	usdcDividendToken = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
        ...
        */
        _mint(owner(), 1000000000000 * (10**18)); // set total supply
    }
