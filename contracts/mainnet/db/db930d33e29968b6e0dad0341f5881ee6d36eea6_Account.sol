...
contract AccountFactory is Ownable {
    ...
    event CreateNewAcount(address indexed main, address oneCT, address newAccount);
    ...
    function createNewAccount(address oneCT) external {
        ...
        address newAccount = address(new Account{salt: salt}(msg.sender, oneCT, protocolManager));
        
        userAccountMap[msg.sender] = newAccount;
        emit CreateNewAcount(msg.sender, oneCT, newAccount);
    }
...
library Constant {
    ...
    // string public constant GMX              = "GMX_V1";
}
