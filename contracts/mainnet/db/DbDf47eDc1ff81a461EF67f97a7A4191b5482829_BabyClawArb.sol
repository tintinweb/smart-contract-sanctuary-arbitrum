...
/*
BABY CLAW ARB 
BabyClaw is a crypto project that is based on memes and is set to launch on the Arbitrum network. This unique project aims to bring together the worlds of cryptocurrency and internet culture by creating a fun and engaging platform that allows users to trade and earn with meme-inspired tokens. With its playful and innovative approach, BabyClaw is poised to capture the attention of both crypto enthusiasts and meme lovers alike. So get ready to join the fun and start clawing your way to the top with BabyClaw!
...
TG: https://t.me/babyclawarb
Twitter: https://www.twitter.com/babyclawarb
Medium: https://medium.com/@oransom85/baby-claw-arb-e26790cecbef
Web: https://www.babyclaw.xyz/
*/
...
contract BabyClawArb is IBEP20, Auth {
    ...
    address constant DEV = 0x7D2CdB6FBCE6A02C5578D6084ec172114CaA075e;


    string constant _name = "Baby Claw Arb";
    string constant _symbol = "$BCA";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 1000000000000 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 40 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 40 / 1000;
