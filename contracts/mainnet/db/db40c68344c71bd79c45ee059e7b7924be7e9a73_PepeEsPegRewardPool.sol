...
import { IPepeEsPegRewardPool } from "./interfaces/IPepeEsPegRewardPool.sol";
import { IPepeEsPegStaking } from "./interfaces/IPepeEsPegStaking.sol";
...
struct Group {
    ...
    int256 shareDebt;
    string name;
    uint48 lastAllocatedContractsTimestamp;
    uint16 feeShare;
