...
contract SHIBARDINU is ERC20, Ownable {
    ...
    string constant _name = "Sibard Inu";
    ...
    address public marketingFeeReceiver = 0x4D8f6F8B58f12db04901e704b35765E7456d5708;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x4D8f6F8B58f12db04901e704b35765E7456d5708] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x4D8f6F8B58f12db04901e704b35765E7456d5708] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x4D8f6F8B58f12db04901e704b35765E7456d5708,
                block.timestamp
            );
