...
contract ARBPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Arbitrium Protocol", "ArbPro") {
        ...
        operationsAddress = address(0xEA0FD65DF9E68f3875624fc5169Cc8D84eC98410);
        devAddress = address(0xEA0FD65DF9E68f3875624fc5169Cc8D84eC98410);
