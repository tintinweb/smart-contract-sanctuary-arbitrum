...
interface IRewardPool {
    ...
    struct Deposit {
        ...
        uint256 boostWeight;
        // The boosted deposit amount applied when staking,
        // (partially) unstaking, or claiming rewards.
        // If this is the same as amount, the user has no boost applied.
        // This value should never be lower than the amount.
