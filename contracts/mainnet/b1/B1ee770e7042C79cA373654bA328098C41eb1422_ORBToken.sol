...
// File: contracts/Orbiter/Governance/utils/address.sol
...
// File: contracts/Orbiter/Governance/ORB.sol
...
contract ORBToken is ERC20, Ownable {
    ...
    modifier hasMinterRole() {
        require(isMinter[_msgSender()], "ORB: You don't have the permission!");
        _;
    }

    modifier hasBurnerRole() {
        require(isBurner[_msgSender()], "ORB: You don't have the permission!");
        _;
    }

    constructor(uint256 _initialSupply, address _feeWallet)
        ERC20("ORB token", "ORB")
    {
        require(_feeWallet != address(0), "ERC20: feeWallet the zero address");
