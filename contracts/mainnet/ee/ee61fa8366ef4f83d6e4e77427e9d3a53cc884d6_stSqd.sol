 ...
 */
contract stSqd is Initializable, Ownership, TokenStorage, VotesUpgradeable {
     ...
     * @param overseer_ manager
     */
    function initialize(address overseer_, address gov_) initializer public {
        name = "Staked Subsquid";
        symbol = "stSQD";
        decimals = 18;
        ...
        _grantRole(BURNER_ROLE, overseer_);
        _grantRole(MINTER_ROLE, overseer_);
        _grantRole(REBASER_ROLE, overseer_);
    ...
    */
     ...
     */
    function syncSupply(uint256 newSupply, uint256 syncInterval) external onlyRole(REBASER_ROLE) notRebasePaused returns (bool) {
    ...
    function _getVotingUnits(address) internal view override returns (uint256) {
        return 0;
    }
}
