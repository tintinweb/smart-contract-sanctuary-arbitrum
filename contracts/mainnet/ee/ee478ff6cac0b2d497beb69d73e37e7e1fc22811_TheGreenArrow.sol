...
//Just Meme Coin with small LP, Who wanna play? it's safe!!
...
contract TheGreenArrow is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "The Green Arrow";
    string constant _symbol = "ARROW";
    ...
    uint256 _totalSupply = 100 * 100**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 25 * 100**4 * (10 ** _decimals);
    uint256 public _walletMax = 25 * 100**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xc10b8dE0C8617261c1024F083CE6d9C6Ef094243;
        marketingWallet = 0xc10b8dE0C8617261c1024F083CE6d9C6Ef094243;
        devWallet = 0xc10b8dE0C8617261c1024F083CE6d9C6Ef094243;
