...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8); //reward token
    DEXRouter router;
...
contract ARBIDRAGON is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "ArbiDragon - Ryujin";
    string constant public symbol = "ARBIDRAGON";
    uint8 constant public decimals = 9;

    uint256 public constant totalSupply = 10000000 * 10*10 * 10**decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = msg.sender; // set marketing wallet here
