...
contract to_deploy is IERC20Metadata, ERC20, Ownable {
    ...
    uint public TaxSell = 50; // 5%
    uint public taxdev = 200; // 20%
    uint public taxmarket = 800; // 80%
    uint256 _totalSupply = 100 * 1e18;
    uint treshold = (_totalSupply*20)/1000;
    ...
    constructor(string memory _symbol,
        ...
        // TO CHANGE
        address _router = 0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24;
        // TO CHANGE
