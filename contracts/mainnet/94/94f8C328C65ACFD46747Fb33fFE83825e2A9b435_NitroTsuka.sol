...
contract NitroTsuka is ERC20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "NitroTsuka";
    string constant _symbol = "NITSUKA";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 1000000 * (10 ** _decimals); 
    
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100;
    uint256 public _maxTxSize = (_totalSupply * 25) / 100;
    ...
    address public pair;
    address public Liq = 0xc469b9423b6FC73154B2403bd8400cfdAA4390c2;
    address public dist;
