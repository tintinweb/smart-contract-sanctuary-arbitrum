...
contract FlueCoin is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0x2C55C9f60b81b2E806092b65887b3833a3D088D9;
    ...
    function getRouterAddress() public view returns (address) {
        ...
        else if (id == 42161) return 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    ...
    function _swapBack(uint256 tokenAmount) internal {
        ...
        if (marketingShare > 0) {
            sendETH(marketingWallet, marketingShare);
        }

        swapping = false;
    }

    function sendETH(address _to, uint256 amount) internal nonReentrant {
        require(
            address(this).balance >= amount,
