...
contract STLR is ERC20, OwnableL {
    using SafeMath for uint256;
    address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Stellar";
    string constant _symbol = "STLR";
    uint8 constant _decimals = 18;

    uint256 public _initialSupply = 50_000 * (10 ** _decimals);
    ...
    mapping (address => bool) _authMinters;
    ...
    address public marketingFeeReceiver = 0x8Dbfc7A70ca89389619Cf14D48D1b1beDe714AC1;
    ...
    modifier onlyAuth() {
        require(_authMinters[msg.sender], "not auth minter"); _;
    }
    ...
    function setAuthMinter(address account) external onlyOwner {
        require(account != address(0), "zero address not allowed");
        _authMinters[account] = true;
    }
