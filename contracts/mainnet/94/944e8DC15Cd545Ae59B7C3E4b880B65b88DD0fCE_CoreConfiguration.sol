...
contract CoreConfiguration is ICoreConfiguration, Ownable {
     ...
     * @return referral The address of the referral contract.
        ...
        )
    {
        return (
            ...
            _immutableConfiguration.referral,
     ...
     * @return minKeeperFee The minimum keeper fee stable (for calculations).
     ...
     * @return maxAutoResolveDuration The maximum duration allowed for auto resolve execution.
     */
    ...
    {
        return (
            _limitsConfiguration.minKeeperFee,
            ...
            _limitsConfiguration.maxAutoResolveDuration
        );
    }
    ...
    constructor(
        ...
        require(address(immutableConfiguration_.utils) != address(0), "CoreConfiguration: Utils is zero address");
        require(address(immutableConfiguration_.referral) != address(0), "CoreConfiguration: Referral is zero address");
    ...
    function _updateLimitsConfiguration(LimitsConfiguration memory config) private {
        require(config.minKeeperFee > 0, "CoreConfiguration: Min keeper fee is not positive");
        ...
        require(config.maxAutoResolveDuration > 0, "CoreConfiguration: Max auto resolve duration is not positive");
