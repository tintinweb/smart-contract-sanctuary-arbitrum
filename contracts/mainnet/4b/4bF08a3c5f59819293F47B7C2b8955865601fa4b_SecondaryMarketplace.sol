...
contract SecondaryMarketPositionManager {
    ...
    function repay(
        ...
        while (remaining > 0) {
            ...
            console.log(currentPertokenPrice, "Current price");
            console.log(_positions.actualCost);
            ...
            if (flag) {
                ...
                console.log(priceDiff, "price diff");
            ...
            if (flag) {
                ...
                if (totalProfit <= remaining) {
                    console.log(totalProfit, "Total Profit 1");
