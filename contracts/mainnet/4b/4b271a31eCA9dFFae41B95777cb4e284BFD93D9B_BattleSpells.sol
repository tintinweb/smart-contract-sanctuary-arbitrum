...
interface IBattle {
    ...
    function createSpellAction(uint256 _wizId, uint256 _originX, uint256 _originY, uint256 _spellId,uint256 _power, uint256 _gameId)external;
...
contract BattleSpells {
    ...
    function useSpell(uint256 _wizId, uint256 _spellId,uint256 _originX, uint256 _originY) external {
        ...
        // Action
        BATTLE.createSpellAction(_wizId, _originX, _originY, _spellId, power, currGame.gameId);
    }
