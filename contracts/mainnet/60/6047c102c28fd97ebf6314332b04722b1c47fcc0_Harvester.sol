...
// File: /Contracts/ReleaseCandidates/IDataCollection.sol
...
// File: /Contracts/SoulStone/ISoulStone.sol
...
interface ISoulStone {
    ...
    */    
    ...
    /**
     * @dev event when a NFT was minted
    */  
...
// File: Contracts/ReleaseCandidates/Harvester.sol
...
contract Harvester is Ownable(msg.sender), Pausable, ReentrancyGuard {
    ...
    address public dataCollectionAddress;
   ...
   //-----Events-----
    ...
    constructor(
        ...
        address _dataCollectionAddress
        ...
        dataCollectionAddress = _dataCollectionAddress;
        ...
        extCollectionInformation = IDataCollection(dataCollectionAddress);
    }
    /**
    ...
    */
    ...
    /**
     * @dev sets the address of the Data Collection contract
    */
    function setDataCollectionAddress(address _dataCollectionAddress) public onlyOwner {
        dataCollectionAddress = _dataCollectionAddress;
        extCollectionInformation = IDataCollection(dataCollectionAddress);
    }
    /**
