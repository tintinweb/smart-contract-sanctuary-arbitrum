...
/**
 * Wrapped BPX Chain native token (BPX) managed by BPX Bridge
 *
 * BPX is a new generation EVM blockchain based upon an innovative consensus algorithm,
...
library ECDSA {
    ...
    function tryRecover(
        ...
        // the valid range for s in (301): 0 < s < secp256k1n Ă· 2 + 1, and for v in (302): v â {27, 28}. Most
...
// File: bridge-contracts/token/BridgedToken.sol
