...
import "./interfaces/IVaultEnterprise.sol";
...
library VaultEnterpriseHelper {
    ...
    //             uint256(_amount0).mul(_userShareAmount).div(_totalSupply)
    //         );
    //         _amount1ForShares = uint128(
    //             uint256(_amount1).mul(_userShareAmount).div(_totalSupply)
    //         );
    //     }
    // }
    ...
    //     console.log(_pool.token0.address);
    //     console.log(_pool.token1.address);
    //     _total0 = IERC20(_pool.token0.address).balanceOf(_vaultAddress);
    //     console.log(_total0);
    //     _total0 = _total0.add(_amount0);
    //     _total1 = IERC20(_pool.token1.address).balanceOf(_vaultAddress);
    //     _total1 = _total1.add(_amount1);
    //     // _total0 = token0.balanceOf(_vaultAddress).add(_amount0);
    //     // _total1 = token1.balanceOf(_vaultAddress).add(_amount1);
    // }
    ...
    //     uint256 _price = getPoolPrice(_pool);
    //     (
