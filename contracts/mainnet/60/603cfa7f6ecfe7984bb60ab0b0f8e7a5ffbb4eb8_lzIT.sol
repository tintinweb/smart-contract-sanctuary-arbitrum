...
/**
 *Submitted for verification at lineascan.build/ on 2024-05-17
 */
...
library AddressCast {
    ...
    function toBytes32(bytes calldata _addressBytes)
        internal
        pure
    ...
    function toBytes32(address _address)
        internal
        pure
        returns (bytes32 result)
    {
    ...
    function toAddress(bytes32 _addressBytes32)
        internal
        pure
    ...
    function toAddress(bytes calldata _addressBytes)
        internal
        pure
        returns (address result)
    {
...
library PacketV1Codec {
    ...
    function encode(Packet memory _packet)
        internal
        pure
        returns (bytes memory encodedPacket)
    {
    ...
    function encodePacketHeader(Packet memory _packet)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function encodePayload(Packet memory _packet)
        internal
        pure
        returns (bytes memory)
    {
    ...
    function header(bytes calldata _packet)
        internal
        pure
    ...
    function senderAddressB20(bytes calldata _packet)
        internal
        pure
        returns (address)
    {
    ...
    function receiverB20(bytes calldata _packet)
        internal
        pure
        returns (address)
    {
    ...
    function message(bytes calldata _packet)
        internal
        pure
        returns (bytes calldata)
    {
    ...
    function payload(bytes calldata _packet)
        internal
        pure
        returns (bytes calldata)
    {
    ...
    function payloadHash(bytes calldata _packet)
        internal
        pure
        returns (bytes32)
    {
...
library PacketDecoder {
     ...
     */
    function decode(bytes calldata _packet)
        internal
        pure
        returns (InboundPacket memory packet)
    {
...
interface IOAppPreCrimeSimulator {
     ...
     */
    function lzReceiveAndRevert(InboundPacket[] calldata _packets)
        external
        payable;
...
abstract contract OAppPreCrimeSimulator is IOAppPreCrimeSimulator, Ownable {
     ...
     * @return Whether the peer passed is considered 'trusted' by the OApp.
     */
    function isPeer(uint32 _eid, bytes32 _peer)
        public
        view
        virtual
        returns (bool);
...
abstract contract OAppOptionsType3 is IOAppOptionsType3, Ownable {
     ...
     */
    function _assertOptionsType3(bytes calldata _options)
        internal
        pure
        virtual
    {
    ...
    OAppOptionsType3
{
     ...
     */
    function _removeDust(uint256 _amountLD)
        internal
        view
        virtual
     ...
     */
    function _toLD(uint64 _amountSD)
        internal
        view
        virtual
        returns (uint256 amountLD)
...
contract lzIT is OFT, AccessControl {
    ...
    constructor(address _treasury, address _layerZeroEndpoint)
        OFT(
            "Layer Zero Insane Technology",
            "lzIT",
            _layerZeroEndpoint,
            msg.sender
        )
    ...
    function print(address collateral, uint256 amount) public WhileNotPaused {
        if (!isCollateral[collateral]) revert CollateralNotSupported();
    ...
    function addCollateral(address collateral) public onlyRole(OPERATOR_ROLE) {
