...
import "../interfaces/ICamelotv3Callback.sol";

enum ComputeType {
    Swap
}

contract CamelotV3Adapter is OceanAdapter, ICamelotv3Callback, Ownable {
    /////////////////////////////////////////////////////////////////////
    //                             Errors                              //
    /////////////////////////////////////////////////////////////////////
    ...
    /// @notice The Camelot V3 pool callback where the token transfer is expected to happen.
    ...
    function algebraSwapCallback(int256 _amount0Delta, int256 _amount1Delta, bytes calldata _data) external override {
