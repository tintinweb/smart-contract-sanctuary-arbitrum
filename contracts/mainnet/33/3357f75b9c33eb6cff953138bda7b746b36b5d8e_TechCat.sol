...
contract TechCat is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor  (uint256 _prize) ERC20("TechCat", "STC") 
    {   
    ...
    require(
        IERC20(tokenContract).transferFrom(msg.sender, address(this), capturePrice), 
