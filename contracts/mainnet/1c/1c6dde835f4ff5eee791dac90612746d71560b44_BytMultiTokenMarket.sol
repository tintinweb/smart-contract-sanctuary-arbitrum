/**
 *Submitted for verification at Arbiscan on 2022-03-10
*/
...
contract BytMultiTokenMarket is Ownable, ReentrancyGuard {
    ...
    constructor() {
        setFee(200);
        setFeeRecipient(0xD14fD22c819F7948b76387e94Eaec9304f426e4B);
        setTransactionDictionary(0x9311C3a7C31F425D20c79219433858d75E76a379);
        addAllowedPaymentToken(0x539bdE0d7Dbd336b79148AA742883198BBF60342); 
    }
    ...
    function _buyItem(
        ...
        IERC20(_paymentToken).safeTransferFrom(_msgSender(), feeReceipient, feeAmount);
