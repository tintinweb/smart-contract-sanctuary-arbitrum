...
/**
    $BONKITRUM
    INSPIRED BY $BONK ON SOLANA
    BIGGEST AIRDROP ON ARBITRUM 
    FOLLOW TWITTER @BONKITRUM

    STEALTH LAUNCH
    50% BURNED
    75% FOR LP POOL
    25% RESERVED FOR AIRDROP - 1 HOUR AFTER LAUNCH
    BONKITRUM.XZY
    T.ME/BONKITRUM
...
contract BONKITRUM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Bonkitrum";
    string private _symbol = "BONKITRUM";
    ...
    address payable public marketingWallet = payable(0x626CdfbCe60a1650bfBFE6FFe88cf7b711CfF7Bb);
