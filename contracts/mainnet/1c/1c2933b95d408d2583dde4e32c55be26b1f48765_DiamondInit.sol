...
import {IERC165} from "lib/solidstate/contracts/interfaces/IERC165.sol";
import {IERC721} from "lib/solidstate/contracts/interfaces/IERC721.sol";
...
contract DiamondInit {
    ...
    function init() external {
        ...
        rs().isValid[
            address(0xAbDb949a18d27367118573A217E5353EDe5A0f1E)
        ] = true;
        rs().isValid[
            address(0x1C04925779805f2dF7BbD0433ABE92Ea74829bF6)
        ] = true;
        rs().kreditsForMint = 1000;

        ERC721MetadataStorage.Layout storage erc721 = ERC721MetadataStorage
            .layout();
        erc721.name = "Kreskian";
        erc721.symbol = "KRESKIAN";
        erc721.baseURI = "ipfs://";
