...
contract PricingModuleV1 is IPricingModule, AccessControlEnumerable {
    ...
    function getPrice(
        ...
        if (_hasDiscount(user)) {
            return
                PriceInfo({ v2LpTokens: lpV2Tokens, v2LpAmounts: lpV2Amounts, v3LpTokens: lpV3Tokens, usdtAmount: 0 });
        }
        ...
        return
            PriceInfo({
                v2LpTokens: lpV2Tokens,
                v2LpAmounts: lpV2Amounts,
                v3LpTokens: lpV3Tokens,
                usdtAmount: usdtCost
            });
    }
