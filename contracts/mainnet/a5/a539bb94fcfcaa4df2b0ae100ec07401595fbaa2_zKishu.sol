...
In a world fueled by blockchain technology, there lived a sly and mischievous cat named ZKishu. ZKishu wasn’t just any ordinary cat. 
He was a digital cat with a keen understanding of the Ethereum network and its layer 2 solution, Arbitrum. As a meme connoisseur, ZKishu had a dream to revolutionize the meme landscape on the Ethereum network, taking them to unprecedented heights.
ZKishu knew that the current state of Ethereum was congested and expensive, making it nearly impossible for average users to enjoy the meme ecosystem. 
He saw the potential of layer 2 solutions like Arbitrum, which allowed for lower fees and faster transactions. With its zero-knowledge proofs, Arbitrum provided ZKishu the perfect playground for his ambitious plan.
One day, ZKishu gathered a team of talented digital artists and developers, each bringing unique skills to the table. They called themselves “The Meme Revolutionaries.” 
United by their love for memes and blockchain, they embarked on a quest to create the ultimate meme platform on Arbitrum.
As time passed, the legend of ZKishu and The Meme Revolutionaries reached other blockchain communities. They were hailed as pioneers who had taken memes to the next level, inspiring others to follow in their footsteps and build upon their success.
ZKishu, sitting atop his digital throne, grinned with satisfaction. He had achieved his dream of revolutionizing the meme landscape, and ZKishu had become the ultimate destination for meme enthusiasts across the Ethereum network. 
With a twinkle in his eye, ZKishu knew that this was just the beginning of an exciting new era for memes and blockchain technology. And so, the adventures of ZKishu and The Meme Revolutionaries continued, as they pushed the boundaries of creativity and innovation, one meme at a time.


Website: https://zKishu.xyz

Telegram: https://t.me/zKishu

Twitter: https://twitter.com/zKishuOfficial

Medium: https://medium.com/@zKishu
...
contract zKishu is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2e085B964f4371c3F0d68f6aE2d4B94c3B772A1c;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "zKishu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x42C05954264F2F0486e6059c7aE3410015a9d6C9;
