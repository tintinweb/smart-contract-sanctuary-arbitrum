...
/**
    ...
    Aquatrum is a token that demonstrates a strong interest and curiosity in underwater exploration. 
    Despite the fact that over 70% of the Earth's surface is covered by oceans, only 5% has been explored, 
    leaving a vast realm of unknown territory and potential
...
contract Aquatrum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Aquatrum";

    string private _symbol = "AQUA";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xe06E5865ddBd2BCAA84ba14B3e071f822452219B;
    ...
    uint256 public _totalSupply =  95000000 * 10**_decimals;
