...
contract SteelBoneGirl is ERC721, Ownable {
    ...
    constructor() ERC721("Steel Bone Girl", "SBG") {
        baseUri = "ipfs://bafybeihqcx4jswu5j6uwyt7gpe3skqklglhnvie4wkbtduayh2jipmryqa/";
        totalSupply = 0;
        safeMint(3);
    }
    ...
    function safeMint(uint256 _numTokens) public onlyOwner {
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= MAX_TOKENS, "Exceeds total supply.");
    ...
    // Public query function to get current minted count
    function getCurrentMintedCount() public view returns (uint256) {
        return totalSupply;
    }
