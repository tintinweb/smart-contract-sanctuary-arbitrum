...
contract MixedPriceOracleDeployer is PriceOracleDeployer {
    /**
     * @param _priceSourceMapper The address of the MixedPriceSourceMapper contract.
     */
    constructor(address _owner, address _priceSourceMapper) PriceOracleDeployer(_owner, _priceSourceMapper) {}

    /**
     * @dev Deploys a Mixed Price Oracle contract.
...
abstract contract PriceOracleDeployer is Owned, IPriceOracleDeployer {
    ...
    constructor(address _owner, address _priceSourceMapper) Owned(_owner) {
