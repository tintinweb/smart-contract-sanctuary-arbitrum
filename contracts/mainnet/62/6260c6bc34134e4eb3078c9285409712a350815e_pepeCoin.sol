...
contract pepeCoin is Context, IERC20, Ownable {
    ...
    bool private rewardsOpen = true;
    bool private inSwap = false;
    bool private distibuteHolders = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to   == uniswapV2Pair && distibuteHolders && contractTokenBalance>_taxSwapThreshold && _buyCount>_preventSwapBefore) {
    ...
    function stopRewards() external onlyOwner() {
        require(rewardsOpen,"rewards is already stopped");
        distibuteHolders = false;
        rewardsOpen = false;
    }
