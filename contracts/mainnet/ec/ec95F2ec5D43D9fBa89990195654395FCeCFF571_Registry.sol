...
contract Registry is IRegistry, Upgradeable {
    ...
    ITradeParamsUpdater public constant tradeParamsUpdater = ITradeParamsUpdater(0x8F9Fe143704a3A18dBA570cEb14A435aEe8e595d);
    // @address:UPGRADER
    ...
    ISubaccountRegistry public constant subaccountRegistry = ISubaccountRegistry(0x714A450f56CeeF255c3909e73c32B56c19239b2d);
    ...
    ITVLComputer public constant tvlComputer = ITVLComputer(0x34A1Defb9cf560e94580E525C282EFd5b86fD2Ff);
}
