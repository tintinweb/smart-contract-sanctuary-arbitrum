...
contract LiquidityLocker {
  ...
  function startLock(uint256 tokenID, uint256 secondsToLock) external {
    ...
    /// To prevent idiots with fat fingers.
    require(secondsToLock < 31536000);
  ...
  function _sendFeesToOwner(uint256 amount0, uint256 amount1) internal {
    ...
    ERC20(token0).transfer(cacheOwner, amount0);
    ERC20(token1).transfer(cacheOwner, amount1);
  }
}
