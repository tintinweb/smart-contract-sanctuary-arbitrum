...
interface RewardRouterV2 {
    ...
    function pendingReceivers(address) external returns(address);
...
import {DividendDistributor} from "./library/DividendDistributor.sol";
...
contract wGMX is ERC20, ERC20Wrapper, Ownable, PaymentSplitter {
    ...
    IERC20 public immutable sbfGMX;
    ...
    constructor(address _rewardRouter, address _gmx, address[] memory _holders, uint[] memory _shares_) ERC20("Wrapped GMX","wGMX") ERC20Wrapper(IERC20(_gmx)) PaymentSplitter(_holders, _shares_) {
        ...
        sbfGMX = IERC20(rewardRouterV2.feeGmxTracker());
    ...
    function handleRewards() external {
        ...
        rewardRouterV2.handleRewards(true, false, true, true, true, true, false);
    ...
    function _withdraw() internal {
        ...
        rewardRouterV2.stakeGmx(received_ESGMX);
