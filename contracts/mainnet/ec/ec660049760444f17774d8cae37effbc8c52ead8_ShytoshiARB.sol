...
/**
WELCOME TO ShytoshiARB.

We Will Start Stealth Launch At 30-50 Members  On Sushiswap.

I think you all need to see this.
Trust the process. We are here to make history and have a plan. Sitting at TG during the dark hours of the night when the majority of the team is asleep and discussing with others what we should and shouldn't do is just not going to be. We also inform you that the marketing campaign starts any time. Stop lying to some of you. We value real input. If you believe then you believe, if not you have the right to go to your next project which will never be as transparent or hard working as we arare. $ShytoshiARB to the moon!.

👇Join Our Community!! 👇

ShytoshiPortal
https://t.me/shytoshiARB_official
Twitter
https://twitter.com/ShytoshiARB
*/
...
contract ShytoshiARB  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "ShytoshiARB ";
    string private constant _symbol = unicode"ShyARB ";
    ...
    address internal constant development_receiver = 0xb43BEB8D715a930b3D4a2C7d57D216a109803344; 
    address internal constant marketing_receiver = 0xb43BEB8D715a930b3D4a2C7d57D216a109803344;
    address internal constant liquidity_receiver = 0xb43BEB8D715a930b3D4a2C7d57D216a109803344;
