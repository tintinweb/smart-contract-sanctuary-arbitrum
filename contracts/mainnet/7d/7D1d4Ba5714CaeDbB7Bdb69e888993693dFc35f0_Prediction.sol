...
contract Prediction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /// @custom:oz-upgrades-renamed-from efunToken
    address payable public predumToken;
    ...
    function initialize(
        ...
        setFeeCollector(0xfE2972473c0Ea680889f6d9106A18b9cAC96a039);
        setEventData(0x633Cf477E2B881A466e22b61F1DAA3e24273D6bA);
        setPredumToken(0x213c80b60ed440665945863dDa9f8f287cba396C);
    ...
    function createSingleEvent(
        ...
        predictStats[_idx][predumToken].options = new uint256[](_odds.length);
    ...
    function setPredumToken(address _predumToken) public onlyOwner {
        predumToken = payable(_predumToken);
    }
    ...
    function _createEvent(
        ...
        if (!_affiliate) {
            IERC20Upgradeable(predumToken).safeTransferFrom(msg.sender, feeCollector, creationFee);
        }
