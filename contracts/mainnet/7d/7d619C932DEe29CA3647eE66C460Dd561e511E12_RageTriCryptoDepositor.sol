...
import { ICurveStableSwap } from "../../integrations/ICurveStableSwap.sol";
...
contract RageTriCryptoDepositor {
    ...
    function withdrawUsdc(uint256 shares, address receiver, uint256 minAmountOut) external {
        uint256 crv3Balance = rage3CryptoVault.redeem(shares, address(this), msg.sender);
