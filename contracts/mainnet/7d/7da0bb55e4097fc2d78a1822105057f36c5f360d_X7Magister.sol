...
90% of the mint at launch will go into the ecosystem splitter.
...
contract X7Magister is ERC721Enumerable, ERC721Holder, Ownable {
    ...
    constructor(address mintFeeDestination_, address treasury_, address magisterDistributor) ERC721("X7 Magister (Arbitrum)", "aX7MAGISTER") Ownable(msg.sender) {
        ...
        super._mint(magisterDistributor, 0);
        super._mint(magisterDistributor, 1);
        super._mint(magisterDistributor, 2);
        super._mint(magisterDistributor, 3);
        super._mint(magisterDistributor, 4);
        super._mint(magisterDistributor, 5);
        super._mint(magisterDistributor, 6);
    }
    ...
    function setMintFeeDestination(address mintFeeDestination_) external onlyOwner {
        ...
        address oldMintFeeDestination = mintFeeDestination;
        mintFeeDestination = payable(mintFeeDestination_);
        emit MintFeeDestinationSet(oldMintFeeDestination, mintFeeDestination);
    }
