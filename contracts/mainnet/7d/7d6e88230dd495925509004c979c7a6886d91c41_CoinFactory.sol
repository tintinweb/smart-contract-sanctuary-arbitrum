...
contract CoinFactory{
    ...
    function createToken(string  _name, string  _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address _FeeAddress,address tokenOwner)public returns (address){
