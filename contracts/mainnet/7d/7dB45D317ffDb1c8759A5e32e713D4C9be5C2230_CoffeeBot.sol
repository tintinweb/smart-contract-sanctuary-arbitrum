...
contract CoffeeBot is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"CoffeeBot";
    string private constant _symbol = unicode"COFFEE";

    uint256 public initialTotalSupply = 10000000 * 1e18;
    uint256 public maxTransactionAmount = 300000 * 1e18;
    uint256 public maxWallet = 300000 * 1e18;
