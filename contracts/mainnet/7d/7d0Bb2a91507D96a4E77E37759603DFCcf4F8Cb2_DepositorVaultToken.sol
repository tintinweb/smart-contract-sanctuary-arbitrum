...
contract DepositorVaultToken is ERC20, AuthorizedAccessControl, IDepositorVaultToken {

  constructor(IAddressRegistry registry, string memory name, string memory symbol) ERC20(name, symbol) AdminAccessControl(registry) { }

  /// @inheritdoc IDepositorVaultToken
