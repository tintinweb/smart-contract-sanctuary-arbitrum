...
contract OERCToken is ERC20, ERC20Burnable, Pausable, Ownable {
    using SafeMath for uint256;
    uint256 private _maxCap = 21000000 * 10**decimals();
    uint256 public constant D_ZERO = 10000;
    uint256 public sellTax; 
    uint256 public buyTax;
    address public feeWallet = 0x87D9302D2AE09Ed3E45c654ECcCD91454c99e2eD;
    ...
    uint256 public teamSupply = 10000000 * 10**18; 
    uint256 public initialMintAmount = 1000 * 10**18; 
    uint256 public investAmount = 100 * 10**18; // 2m
    uint256 public clipCost = 10000 * 10**18; // 25000k
    uint256 public remainmintnum = 21000000 * 10**18; 
    // uint256 public value = 0.001 * 10**18; 


    uint256 public lastClipUpdate;
    address public clipOwner;
    address private _fund = 0x87D9302D2AE09Ed3E45c654ECcCD91454c99e2eD;
    ...
    constructor() ERC20('Ordinals ERC20 TOKEN', 'OERC') {
        sellTax = 500;
        buyTax = 500;
    ...
    function mintClips(address invester) payable external {
        // require( 
        //     block.timestamp >= lastMintTime[msg.sender] + 10 days,
        //     "You can only mint once every 240 hours"
        // );
