...
contract Pepekarb is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"PepekArb";
    string private _symbol = unicode"PEPEKARB";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1000000 * 10**_decimals;
    uint256 public _maxWalletToken = _totalSupply * 100000000000;
