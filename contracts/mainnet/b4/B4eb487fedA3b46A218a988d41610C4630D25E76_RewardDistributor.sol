...
/// @author Turbo Fifty
/// @notice A reward distributor that allows for setting allocation
...
contract RewardDistributor is IRewardDistributor, DoubleOwnable {
    ...
    constructor(
        ...
        address token, 
        address _secondOwner) DoubleOwnable(_secondOwner) {
        // RewardToken = IERC20(_reflectionToken);
        RewardToken = IERC20(0xaF22d8FeF9ECf1394bE9f7b38e828fd735778E18); // SEIF Token
        _token = token;
    }
