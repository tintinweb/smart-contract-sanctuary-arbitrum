...
/**
 *Submitted for verification at Arbiscan on 2023-02-18
*/
...
contract BABYSHARKYSWAP is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 sushi
    ...
    constructor() ERC20("babysharkyswap", "BABYSHARKYSWAP") {
        ...
        maxTransactionAmount = 2_000_000 * 1e18; // 100% max txn
        maxWallet = 2_000_000 * 1e18; // 100% max wallet
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 100% swap wallet
        ...
        mktgWallet = address(0x4d29145DAFCC9d621A4AC9E83905767Ca257f866); 
        devWallet = address(0x4d29145DAFCC9d621A4AC9E83905767Ca257f866); 
        liqWallet = address(0x4d29145DAFCC9d621A4AC9E83905767Ca257f866); 
        operationsWallet = address(0x4d29145DAFCC9d621A4AC9E83905767Ca257f866);

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(0xbe2a5176B52BAef94424464e55E04d56F862C1a3), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(0xbe2a5176B52BAef94424464e55E04d56F862C1a3), true);
