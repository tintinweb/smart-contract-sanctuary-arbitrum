...
contract BatchTransfer is Ownable {
    ...
    function batchTransfer(
        ...
        uint256 _totalAmount = getTotalAmount(amounts);
        if (_totalAmount != totalAmount) {
            revert UnexpectedTotalSend();
        }
        ...
        emit BatchTransferred(token, totalAmount, recipients.length);
    }
