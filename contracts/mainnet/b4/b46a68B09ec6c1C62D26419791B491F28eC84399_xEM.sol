...
contract xEM is IxEM {
    ...
    bool public mintingEnabled = true; // Flag to enable/disable minting
    ...
    // No checks as it's meant to be once off to set minting rights to BaseV1 Minter
    ...
    function initialMint(address _recipient) external {
        ...
        mintingEnabled = false; // Disable minting after initial minting
    }
    ...
    function mint(address _to, uint256 amount) external returns (bool) {
        require(msg.sender == minter && mintingEnabled, 'Minting not allowed');
        _mint(_to, amount);
        return false;
    }
