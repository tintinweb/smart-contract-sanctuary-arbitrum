...
contract RABBITNFT is ERC721, Ownable {
    ...
    bool  private typeSell1;
    bool  private typeSell2;
    bool  private typeSell3;
    bool  private typeSell4;
    bool  private typeSell5;

    bool public isSaleActive;

    constructor()
    public
    ERC721("RABBIT", "RABBIT")
    {
        maxNumber = 60000;
        maxPerTx = 10;
        // ship
        ...
        priceShip[3] = 500 * 10 ** 18;
        priceShipBnb[1] = 5 * 10 ** 16;
        priceShipBnb[2] = 15 * 10 ** 16;
        priceShipBnb[3] = 25 * 10 ** 16;
        priceShipBnb[4] = 35 * 10 ** 16;
        priceShipBnb[5] = 50 * 10 ** 16;
        ...
        amountWork[1] = 40000;
        amountWork[2] = 50000;
        priceWork[1] = 700 * 10 ** 18;
        priceWork[2] = 1000 * 10 ** 18;
        powerWork[1] = 100;
        powerWork[2] = 200;
    }
    ...
    function updateSell(bool ty1, bool ty2, bool ty3, bool ty4, bool ty5) public onlyOwner {
        typeSell1 = ty1;
        typeSell2 = ty2;
        typeSell3 = ty3;
        typeSell4 = ty4;
    ...
    // mint cardOnly
    function mintCardOnly(uint256 tpe,address toaddr) public onlyOwner{
    ...
    function mintCard(uint256 tpe) public {
        ...
        if (tpe == 1) {//ship one star
            require(amountShipOneTotal().add(1) <= amountShip[1], "Purchase would exceed max supply of Martial");
            require(!typeSell1, "can not buy");
            mintIndex = amountShipOneTotal().add(1);
            price = priceShip[1];
            _amountShipOneSet(msg.sender, mintIndex);
        } else if (tpe == 2) {//ship two star
            require(!typeSell2, "can not buy");
    ...
    // mint card bnb
    function mintCardETH(uint256 tpe) public payable {
        require(isSaleActive, "Sale is not active");
        require(totalSupply().add(1) <= maxNumber, "Purchase would exceed max supply of Martial");
        uint256 mintIndex;
        uint256 price;
    ...
    function setPriceETH(uint256[] memory prices) public onlyOwner {
