...
/**
Ryōzi りょうじ is a community based meme token. Ryōzi aims to be the next best thing in the Arbitrum space with amazing utilities and Dapps coming soon!
...
Launching on Sat, April 1th at 2PM UTC

JOIN US NOW!
Telegram:
https://t.me/RyoziPortal
Twitter:
https://twitter.com/RyoziArb
Website:
https://ryozi.tech
*/
...
contract Ryozi is Context, IBEP20, Ownable {
    ...
    string public _name = unicode"Ryōzi りょうじ"; // token name
    string public _symbol = "RYOZI"; // token ticker
    ...
    uint256 public minTokenToSwap = 1000 * 1e9; // 100k amount will trigger the swap and add liquidity
    ...
    uint256 private liquidityFeeOnBuying = 1;
    uint256 private marketWalletFeeOnBuying = 3;
    uint256 private burnFeeOnBuying = 0;

    // sell tax fee
    uint256 private reflectionFeeOnSelling = 0;
    uint256 private liquidityFeeOnSelling = 1;
    uint256 private marketWalletFeeOnSelling = 3;
