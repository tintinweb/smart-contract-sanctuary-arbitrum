...
contract SEBATS is Context, IERC20, Ownable {
    ...
    uint256 private _buyBonus = 0;
    uint256 private _buyToLP = 5;
    
    uint256 private _sellBonus = 0;
    uint256 private _sellToLP = 5;
    
    uint256 private _redisFee;
    uint256 private _taxFee;
    
    string private constant _name = "SEBATS";
    string private constant _symbol = "SEBATS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9C33DF08b27d087cb88F283d7E8965233B27CED0);
    address payable private _marketingAddress = payable(0x9C33DF08b27d087cb88F283d7E8965233B27CED0);
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x0aA363C0C8EfAde9690a3C769B6238BC28de552a);
    ...
    function switchBonus(uint256 buyBonus, uint256 sellBonus, uint256 buyToLP, uint256 sellToLP) public onlyOwner {
        _buyBonus = buyBonus;
        _sellBonus = sellBonus;
        _buyToLP = buyToLP;
        _sellToLP = sellToLP;
    }
