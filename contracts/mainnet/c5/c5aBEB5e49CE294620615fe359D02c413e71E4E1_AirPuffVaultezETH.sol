    ...
    function executeClosePosition(
        ...
        if (!cpr.isLiquidation) {
            ...
            if (amountOut >= _userInfo.leverageAmount) {
                ...
                cpr.toLeverageUser = leftovers - liquidatorReward;
            } else {
                toLending = amountOut;
            }
        ...
        emit Withdraw(_userInfo.user, cpr.toLeverageUser, userPos, block.timestamp, cpr.userPositionID, _userInfo.leverage, kcd.posBorrow);
    }
