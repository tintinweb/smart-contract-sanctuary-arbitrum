...
import '../../interface/exclusive/ILinearVestingExclusiveFactory.sol';
import '../../interface/exclusive/ILinearVestingExclusive.sol';
import '../../vesting/exclusive/LinearVestingExclusive.sol';

contract LinearVestingExclusiveFactory is
  Initializable,
  UUPSUpgradeable,
  OwnableUpgradeable,
  PausableUpgradeable,
  AdminProxyManager,
  ILinearVestingExclusiveFactory
{
   ...
   * @dev Get owner
   */
  function owner() public view virtual override(ILinearVestingExclusiveFactory, OwnableUpgradeable) returns (address) {
    return super.owner();
  }
...
interface ILinearVestingExclusive {
  function init(
    address _token,
    address _stable,
    address _projectOwner,
...
interface ILinearVestingExclusiveFactory {
  event VestingCreated(address indexed vesting, uint index);
