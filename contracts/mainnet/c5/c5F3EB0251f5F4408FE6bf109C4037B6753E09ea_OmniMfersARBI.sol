...
contract OmniMfersARBI is ERC721Burnable, ERC721Enumerable, Ownable, LayerZeroable {
    ...
    function reserve(uint256 num) external onlyOwner {
        require(mintedSupply+num <= (MAX_SUPPLY+lastTokId), "Exceed max supply");
    ...
    function freeMint(uint256 numOfTokens) external payable {
        ...
        require(mintedSupply + numOfTokens <= (MAX_SUPPLY+lastTokId), "Exceed max supply");
