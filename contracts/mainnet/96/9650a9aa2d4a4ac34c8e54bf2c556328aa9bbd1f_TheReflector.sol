...
// The reflector is Live on Arbitrum
// 5% max buy and 5% max wallet.
// Tax : 6/6
// Earn USDC token by holding REFLECT !
// Sell one token to earn your token
// Stealth launch
// Wait for liquidity lock
// Telegram : https://t.me/thearbireflector
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8); // reward address USDC
...
contract TheReflector is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The reflector";
    string constant _symbol = "REFLECT";
    ...
    uint256 reflectionFee = 400; // 4 % Rewards in Goblin
    uint256 marketingFee = 200; // 2% buy back and marketing
    uint256 totalFee = 600;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x58564DbD5243bA79402ab6fe70899f8b12828eC3; //liq address
    address public marketingFeeReceiver=0x58564DbD5243bA79402ab6fe70899f8b12828eC3; // marketing address
