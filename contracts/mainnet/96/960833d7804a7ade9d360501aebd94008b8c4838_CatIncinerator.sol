...
contract CatIncinerator is AxelarExecutable {
    ...
    address public axlUSDCArbitrum = 0xEB466342C4d449BC9f53A865D5Cb90586f405215; // arbitrum
    address public wethArbitrum = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    address public usdceArbitrum = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8; // usdce
    address public daiArbitrum = 0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1; // dai arbitrum
    address public usdcArbitrum = 0xaf88d065e77c8cC2239327C5EDb3A432268e5831; // circle
    ...
    function swapAxlUSDCForMingus(uint256 amount) public returns (uint256) {
        ERC20(axlUSDCArbitrum).approve(UNISWAP_V3_ROUTER, amount);
        ISwapRouterV3.ExactInputParams memory params = ISwapRouterV3.ExactInputParams({
            path: abi.encodePacked(axlUSDCArbitrum, uint24(500), usdcArbitrum, uint24(500), wethArbitrum),
        ...
        uint256 amountWeth = ISwapRouterV3(UNISWAP_V3_ROUTER).exactInput(params);
        ...
        ERC20(wethArbitrum).approve(CAMELOT_ROUTER, amountWeth);
        // TODO: set reasonable minAmountOut

        ICamelotRouter(CAMELOT_ROUTER).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            amountWeth, 0, path, address(this), address(0), block.timestamp // use 0 address for referrer
        );

        return ERC20(mingus).balanceOf(address(this));
    }
    ...
    function _executeWithToken(
        ...
        uint256 mingusAmount = swapAxlUSDCForMingus(amount);

        IERC20(mingus).transfer(recipient, mingusAmount);
    }
