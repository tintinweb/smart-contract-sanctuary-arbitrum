...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public amazonSwapLottery;
     ...
     * @param _seed: seed provided by the AmazonSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == amazonSwapLottery, "Only AmazonSwapLottery");
    ...
    /**
     * @notice Set the address for the AmazonSwapLottery
     * @param _amazonSwapLottery: address of the AmazonSwap lottery
     */
    function setLotteryAddress(address _amazonSwapLottery) external onlyOwner {
        amazonSwapLottery = _amazonSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAmazonSwapLottery(amazonSwapLottery).viewCurrentLotteryId();
    }
}