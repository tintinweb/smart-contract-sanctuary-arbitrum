...
contract ADoge is ERC20,Ownable {
    ...
    uint256 public deadRate=0;
    address public fundAddress;//营销地址
    uint256 public fhCount;
    address private admin;
    
    constructor()ERC20("Test", "TTT") {
        admin=0x836f91e623ea27141E550Be4c19db2B1AB3c9C3a;
        usdt=0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9;
        fundAddress=0x836f91e623ea27141E550Be4c19db2B1AB3c9C3a;
    ...
    function initPari()external onlyOwner{
        address swap=0xc873fEcbd354f5A56E00E710B90EF4201db2448d;
    ...
    function setDeadRate(uint256 _rate) external onlyOwner{
        deadRate=_rate;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair) {
            ...
            fhCount+=amount.mul(rate).div(100);
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * deadRate / 100;
        if(feeAmount>0){
            super._transfer(sender,address(this),feeAmount);
            swapToken(feeAmount,fundAddress);
        }
        super._transfer(sender, recipient, tAmount - feeAmount);
    }
    function _funTransfer2(
        address sender,
        address recipient,
        uint256 tAmount
    ) private {
