...
import "../templates/MoongateERC721Airdrop.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract MoongateERC721AirdropFactory is Ownable, AccessControl {
    ...
    event ContractCreated(string name_, string symbol_, address address_);
    ...
    function createContract(
        ...
        MoongateERC721Airdrop contract_ = new MoongateERC721Airdrop(
            name_,
            symbol_,
            uri_,
            royaltyReceiver,
        ...
        contract_.grantAdmin(owner());
        contract_.grantAdmin(_msgSender());
        contract_.transferOwnership(owner());

        address _address = address(contract_);
        emit ContractCreated(name_, symbol_, _address);
        return _address;
    }
}
