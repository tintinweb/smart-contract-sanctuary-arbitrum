...
import "./IReStakeApy.sol";

contract ReStakeApy is IReStakeApy, Ownable {
     ...
     */
    function setStakeApy(uint256 _poolId, uint256 _apy) external override onlyOwner {
    ...
    function setStakeApyExactly(uint256 _poolId, uint256[] calldata _startTime, uint256[] calldata _endTime, uint256[] calldata _apy) external override onlyOwner {
