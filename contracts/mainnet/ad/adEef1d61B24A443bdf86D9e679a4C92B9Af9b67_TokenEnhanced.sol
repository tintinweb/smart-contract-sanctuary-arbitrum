...
abstract contract ERC404Enhanced is Ownable {
    // Events
    event ERC20Transfer(
...
import {ERC404Enhanced} from "./ERC404Enhanced.sol";

contract TokenEnhanced is ERC404Enhanced {
    constructor(address _owner) ERC404Enhanced("Test", "Test", 18, 10000, _owner){}
}