...
// File: cobosafe-master/contracts/auth/FarmingBaseACL.sol
...
// File: cobosafe-master/contracts/acls/Umami/Umami_auth.sol


pragma solidity ^0.8.19;


contract UmamiAuthorizer is FarmingBaseACL {

    bytes32 public constant NAME = "UmamiAuthorizer_usdc";
    uint256 public constant VERSION = 1;

    address public constant gmUSDC_WETH = 0x959f3807f0Aa7921E18c78B00B2819ba91E52FeF;
    address public constant gmUSDC_WBTC = 0x5f851F67D24419982EcD7b7765deFD64fBb50a97;
    

    constructor(address _owner, address _caller) FarmingBaseACL(_owner, _caller) {}

    function _checkReciever(address _reciever) internal view{
        require(_reciever == owner);
    }
    ...
    function deposit(
        uint256 _asset,
        uint256 _minOutAfterFees, 
        address _receiver
    ) external view onlyContract(gmUSDC_WETH) onlyContract(gmUSDC_WBTC){
        _checkReciever(_receiver);
    }
    ...
    function contracts() public view override returns (address[] memory _contracts) {
        ...
        _contracts[0] = gmUSDC_WETH;
        _contracts[1] = gmUSDC_WBTC;
    }
