...
contract TheAlchemist is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 5; // 100% of supply
    uint256 public maxTxAmountSell = _tTotal / 2; // 100% of supply
    uint256 public maxWalletAmount = _tTotal / 5; // 100% of supply
