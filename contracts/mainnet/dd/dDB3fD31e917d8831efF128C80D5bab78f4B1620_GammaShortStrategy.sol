...
contract GammaShortStrategy is BaseStrategy, ReentrancyGuard, IStrategyVault, IPredyTradeCallback {
    ...
    function refresh(
        ...
        int256 tradeAmount = -vault.openPositions[0].perp.amount * _ratio / 1e18;
        int256 tradeAmountSqrt = -vault.openPositions[0].sqrtPerp.amount * _ratio / 1e18;
    ...
    function reset(
        ...
        controller.tradePerp(strategy.vaultId, strategy.pairId, TradePerpLogic.TradeParams(
            -vault.openPositions[0].perp.amount,
            -vault.openPositions[0].sqrtPerp.amount,
            _tradeParams.lowerSqrtPrice,
            _tradeParams.upperSqrtPrice,
            _tradeParams.deadline,
            false,
