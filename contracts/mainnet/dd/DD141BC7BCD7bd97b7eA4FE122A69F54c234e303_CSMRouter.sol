...
contract CSMRouter is ICSMRouter, AccessControl, ReentrancyGuard {
    ...
    {
        console.log("Chain ", chainId_);
        console.log("addre ", assetAddress_);
    ...
    function estimateFee() public view override returns (uint256) {
        console.log("es fee ", deBridgeGate.globalFixedNativeFee());
    ...
    function route(
        ...
        // console.log(" fee ", executionFee_ + deBridgeGate.globalFixedNativeFee());
        // console.log("  msg.value ", msg.value);
        // console.log("  executionFee_ ", executionFee_);
        // console.log("  amountAfterBridge ", amountAfterBridge);
    ...
    function routerReceive(
        ...
        // verify if the tx originates from the router on src chain meaning approved router == senderAddress
        ...
        _poolsPerAssets[dstAsset_].receiveSwapCrossChain(sender_, chainIdFrom, srcAsset_, dstAsset_, amount_, haircut_);
