...
/*
The PixelDogeArb  token is a meme token poised to revolutionize the crypto space with a diverse set of services built for the community.

Telegram: https://t.me/PixelDogeArb
*/
...
contract PixelDoge is IBEP20, Auth {
    ...
    address constant DEV = 0x89d9047716F927bD642E9385d495f7C72728F93d;


    string constant _name = "PIXEL DOGE";
    string constant _symbol = "$PXLDG";
