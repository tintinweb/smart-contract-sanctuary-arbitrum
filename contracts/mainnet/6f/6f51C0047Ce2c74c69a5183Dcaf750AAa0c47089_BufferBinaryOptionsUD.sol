...
contract BufferBinaryOptionsUD is
    IBufferBinaryOptionsUD,
    ReentrancyGuard,
    ERC721,
    AccessControl
{
    ...
    IOptionsConfigUD public override config;
    ...
    function ownerOf(
        ...
        view
        virtual
        override(ERC721, IBufferBinaryOptionsUD)
        returns (address)
    {
