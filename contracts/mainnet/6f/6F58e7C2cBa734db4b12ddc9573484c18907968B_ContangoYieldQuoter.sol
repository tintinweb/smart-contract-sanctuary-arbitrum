...
import {IContangoWitchListener} from "@yield-protocol/vault-v2/contracts/other/contango/interfaces/IContangoWitchListener.sol";
import {IPoolView} from "./internal/IPoolView.sol";
...
library Yield {
    ...
    event PositionCreated(PositionId indexed positionId, Symbol indexed symbol, address indexed trader);
    ...
    function createPosition(
        ...
        emit PositionCreated(positionId, symbol, trader);
