...
contract ARBIKING is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ArbiKing", "ARK") {

        address _dexRouter;
        address pairedTokenAddress;

        if(block.chainid == 42161){
            _dexRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // SushiSwap Router
            pairedTokenAddress = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1; //  Arbi WETH
        } else {
    ...
    function swapBack() private {
        ...
        if(REWARDTOKEN.balanceOf(address(this)) > 0){
            REWARDTOKEN.transfer(marketingWallet, REWARDTOKEN.balanceOf(address(this)) );
        }
    }
}