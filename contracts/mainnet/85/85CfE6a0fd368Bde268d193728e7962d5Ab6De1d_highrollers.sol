...
contract highrollers is Ownable {
    ...
    function getRollerId(address _friends,uint256 _friendId) external view returns(uint256){
        return rollerId[_friends][_friendId]>0 ? rollerId[_friends][_friendId] :1000000000;
    }
