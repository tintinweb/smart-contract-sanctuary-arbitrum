...
import '../../interface/exclusive/IFixedVestingExclusiveFactory.sol';
import '../../interface/exclusive/IFixedVestingExclusive.sol';
import '../../vesting/exclusive/FixedVestingExclusive.sol';

contract FixedVestingExclusiveFactory is
  Initializable,
  UUPSUpgradeable,
  OwnableUpgradeable,
  PausableUpgradeable,
  AdminProxyManager,
  IFixedVestingExclusiveFactory
{
   ...
   * @dev Get owner
   */
  function owner() public view virtual override(IFixedVestingExclusiveFactory, OwnableUpgradeable) returns (address) {
    return super.owner();
  }
...
interface IFixedVestingExclusive {
  function init(
    address _token,
    address _stable,
    address _projectOwner,
...
interface IFixedVestingExclusiveFactory {
  event VestingCreated(address indexed vesting, uint index);
