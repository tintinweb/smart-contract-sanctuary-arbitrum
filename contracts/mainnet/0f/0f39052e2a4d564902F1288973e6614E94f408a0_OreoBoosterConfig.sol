...
contract OreoBoosterConfig is IOreoBoosterConfig, Ownable, ReentrancyGuard {
  ...
  mapping(address => mapping(uint256 => OreoBoosterEnergyInfo)) public shipboosterEnergyInfo;
  ...
  {
    OreoBoosterEnergyInfo memory shipboosterInfo = shipboosterEnergyInfo[_nftAddress][_nftTokenId];
  ...
  function consumeEnergy(
    ...
    OreoBoosterEnergyInfo storage energy = shipboosterEnergyInfo[_nftAddress][_nftTokenId];
  ...
  function _setOreoBoosterNFTEnergyInfo(OreoBoosterNFTParams calldata _param) internal {
    shipboosterEnergyInfo[_param.nftAddress][_param.nftTokenId] = OreoBoosterEnergyInfo({
