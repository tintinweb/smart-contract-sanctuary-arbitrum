...
// GMCash FINANCE
contract GMC is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 3000 ether; //  3000 GMC
    ...
    /**
     * @notice Constructs the GMC ERC-20 contract.
     */
    constructor() public ERC20("GMCash", "GMC") {
        _mint(msg.sender, 10 ether); // for initial liquidity deployment
    }

    /**
     * @notice Operator mints GMC to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of GMC to mint to
