...
/**
 *Submitted for verification at Sepolia.Arbiscan.io on 2024-05-16
*/
...
contract YFXMerkleDistributor is IMerkleDistributor {
    ...
    constructor(address _gov, address token_, uint256 _stratTime, bytes32 merkleRoot_) public {
        token = token_;
