...
interface ITreasury {
    ...
    function getParbPrice() external view returns (uint256);
...
contract ShareWrapper {
    ...
    function stake(uint256 amount) public virtual {
        ...
        sarb.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        sarb.safeTransfer(msg.sender, amount);
    }
}
...
contract Masonry is ShareWrapper, ContractGuard, Operator {
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            parb.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        parb.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 _amount, address _to) external onlyOperator {
        ...
        require(address(_token) != address(sarb), "sarb");
